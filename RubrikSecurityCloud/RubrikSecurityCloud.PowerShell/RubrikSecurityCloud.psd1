...
Description = 'PowerShell Module for Rubrik Security Cloud. GraphQL schema version: v20251215-43 .'
...
FormatsToProcess = @(
  ...
  "Toolkit/Format/MssqlAvailabilityGroup.Format.ps1xml",

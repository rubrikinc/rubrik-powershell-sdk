// Invoke-RscGqlQueryNutanixPrismCentrals.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query nutanixPrismCentrals
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryNutanixPrismCentrals")
    ]
    public class Invoke_RscGqlQueryNutanixPrismCentrals : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("nutanixPrismCentrals");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_nutanixPrismCentrals();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_nutanixPrismCentrals()
        {
            this._logger.name += " -nutanixPrismCentrals";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryNutanixPrismCentrals
}
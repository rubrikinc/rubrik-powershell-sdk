...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// BrowseSnapshot, Category, CategoryValue, Cluster, ClusterAsyncRequestStatus, ClusterContainers, ClusterNetworks, Clusters, Mounts, PrismCentral, PrismCentralAsyncRequestStatus, PrismCentrals, SearchVm, SnapshotDetail, SnapshotVdisks, TopLevelDescendants, VDiskMountableVms, Vm, VmAsyncRequestStatus, VmMissedSnapshots, or Vms.
    /// </summary>
    /// <description>
    ...
    /// -Operation parameter;
    /// one of: BrowseSnapshot, Category, CategoryValue, Cluster, ClusterAsyncRequestStatus, ClusterContainers, ClusterNetworks, Clusters, Mounts, PrismCentral, PrismCentralAsyncRequestStatus, PrismCentrals, SearchVm, SnapshotDetail, SnapshotVdisks, TopLevelDescendants, VDiskMountableVms, Vm, VmAsyncRequestStatus, VmMissedSnapshots, or Vms.
    ...
    ///
    /// <example>
    /// Runs the PrismCentralAsyncRequestStatus operation
    /// of the 'Nutanix' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Nutanix
    /// # API Operation: PrismCentralAsyncRequestStatus
    /// 
    /// $query = New-RscQueryNutanix -PrismCentralAsyncRequestStatus
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    public class New_RscQueryNutanix : RscGqlPSCmdlet
    {
        ...
        internal void ProcessRecord_PrismCentralAsyncRequestStatus()
        {
            ...
            // Create new graphql operation nutanixPrismCentralAsyncRequestStatus
            InitQueryNutanixPrismCentralAsyncRequestStatus();
        }
...
$query.Var.fid = $someString"
        ...
        internal void InitQueryNutanixPrismCentralAsyncRequestStatus()
        {
            Tuple<string, string>[] argDefs = {
            ...
            Initialize(
                ...
                "AsyncRequestStatus",
                Query.NutanixPrismCentralAsyncRequestStatus,
                Query.NutanixPrismCentralAsyncRequestStatusFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterUuid = $someString

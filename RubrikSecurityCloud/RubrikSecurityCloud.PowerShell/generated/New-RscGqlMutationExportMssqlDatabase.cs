// New-RscGqlMutationExportMssqlDatabase.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation exportMssqlDatabase
    /// exportMssqlDatabase(input: ExportMssqlDatabaseInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationExportMssqlDatabase")
    ]
    public class New_RscGqlMutationExportMssqlDatabase : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationExportMssqlDatabase
}
// Invoke-RscGqlQueryO365SharepointObjects.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365SharepointObjects
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365SharepointObjects")
    ]
    public class Invoke_RscGqlQueryO365SharepointObjects : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365SharepointObjects");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365SharepointObjects();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365SharepointObjects()
        {
            this._logger.name += " -o365SharepointObjects";
...
$inputs.Var.fid = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365SharepointObjects
}
...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    ///
    /// <example>
    /// Runs the HostVirtualSwitches operation
    /// of the 'Microsoft Hyper-V' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Hyperv
    /// # API Operation: HostVirtualSwitches
    /// 
    /// $query = New-RscQueryHyperv -Operation HostVirtualSwitches
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    public class New_RscQueryHyperv : RscGqlPSCmdlet
    {
        ...
        internal void ProcessRecord_HostVirtualSwitches()
        {
...
$query.Var.input = @{
	...
	id = $someString
        ...
        // Create new GraphQL Query:
        // hypervHostVirtualSwitches(input: GetHypervHostVirtualSwitchesInput!): HypervVirtualSwitchesResponse!
        internal void InitQueryHypervHostVirtualSwitches()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetHypervHostVirtualSwitchesInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryHypervHostVirtualSwitches",
                "($input: GetHypervHostVirtualSwitchesInput!)",
                "HypervVirtualSwitchesResponse",
                Query.HypervHostVirtualSwitches,
                Query.HypervHostVirtualSwitchesFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	id = $someString

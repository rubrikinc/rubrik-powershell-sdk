// Invoke-RscGqlMutateCreateAwsReaderTarget.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createAwsReaderTarget
    /// createAwsReaderTarget(input: CreateAwsReaderTargetInput!): Target!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateAwsReaderTarget")
    ]
    public class Invoke_RscGqlMutateCreateAwsReaderTarget : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateAwsReaderTarget
}
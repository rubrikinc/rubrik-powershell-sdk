// New-RscGqlQueryOracleDatabases.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query oracleDatabases
    /// oracleDatabases(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryOracleDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryOracleDatabases
}
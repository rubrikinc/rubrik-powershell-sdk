// New-RscGqlMutationRecoverMongodbSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation recoverMongodbSource
    /// recoverMongodbSource(input: MosaicRestoreDataInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRecoverMongodbSource")
    ]
    public class New_RscGqlMutationRecoverMongodbSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRecoverMongodbSource
}
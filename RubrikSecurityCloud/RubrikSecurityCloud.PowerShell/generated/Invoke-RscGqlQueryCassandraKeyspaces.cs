// Invoke-RscGqlQueryCassandraKeyspaces.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query cassandraKeyspaces
    /// cassandraKeyspaces(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryCassandraKeyspaces")
    ]
    public class Invoke_RscGqlQueryCassandraKeyspaces : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("cassandraKeyspaces");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_cassandraKeyspaces();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_cassandraKeyspaces()
        {
            this._logger.name += " -cassandraKeyspaces";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryCassandraKeyspaces
}
// Invoke-RscGqlQueryVSphereComputeClusters.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereComputeClusters
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryVSphereComputeClusters")
    ]
    public class Invoke_RscGqlQueryVSphereComputeClusters : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("vSphereComputeClusters");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_vSphereComputeClusters();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_vSphereComputeClusters()
        {
            this._logger.name += " -vSphereComputeClusters";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereComputeClusters
}
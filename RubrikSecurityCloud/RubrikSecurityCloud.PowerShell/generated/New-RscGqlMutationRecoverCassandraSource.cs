// New-RscGqlMutationRecoverCassandraSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation recoverCassandraSource
    /// recoverCassandraSource(input: MosaicRestoreDataInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRecoverCassandraSource")
    ]
    public class New_RscGqlMutationRecoverCassandraSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRecoverCassandraSource
}
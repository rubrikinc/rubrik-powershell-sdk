// New-RscGqlMutationStartExportAzureNativeVirtualMachineJob.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation startExportAzureNativeVirtualMachineJob
    /// startExportAzureNativeVirtualMachineJob(input: StartExportAzureNativeVirtualMachineJobInput!): AsyncJobStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationStartExportAzureNativeVirtualMachineJob")
    ]
    public class New_RscGqlMutationStartExportAzureNativeVirtualMachineJob : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationStartExportAzureNativeVirtualMachineJob
}
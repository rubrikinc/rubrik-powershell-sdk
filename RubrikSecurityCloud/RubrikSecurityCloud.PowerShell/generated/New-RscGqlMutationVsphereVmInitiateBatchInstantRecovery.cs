// New-RscGqlMutationVsphereVmInitiateBatchInstantRecovery.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmInitiateBatchInstantRecovery
    /// vsphereVmInitiateBatchInstantRecovery(input: VsphereVmInitiateBatchInstantRecoveryInput!): BatchAsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmInitiateBatchInstantRecovery")
    ]
    public class New_RscGqlMutationVsphereVmInitiateBatchInstantRecovery : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmInitiateBatchInstantRecovery
}
// New-RscGqlMutationExportSlaManagedVolumeSnapshot.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation exportSlaManagedVolumeSnapshot
    /// exportSlaManagedVolumeSnapshot(input: ExportSlaManagedVolumeSnapshotInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationExportSlaManagedVolumeSnapshot")
    ]
    public class New_RscGqlMutationExportSlaManagedVolumeSnapshot : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationExportSlaManagedVolumeSnapshot
}
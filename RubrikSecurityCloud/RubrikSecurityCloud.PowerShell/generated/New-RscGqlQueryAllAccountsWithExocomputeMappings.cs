// New-RscGqlQueryAllAccountsWithExocomputeMappings.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAccountsWithExocomputeMappings
    ...
    public class New_RscGqlQueryAllAccountsWithExocomputeMappings : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.exocomputeAccountIdsFilter = @(
    ...
    } // class New-RscGqlQueryAllAccountsWithExocomputeMappings
}
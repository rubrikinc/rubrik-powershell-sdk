// New-RscGqlMutationRestoreMssqlDatabase.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation restoreMssqlDatabase
    /// restoreMssqlDatabase(input: RestoreMssqlDatabaseInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRestoreMssqlDatabase")
    ]
    public class New_RscGqlMutationRestoreMssqlDatabase : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRestoreMssqlDatabase
}
// Invoke-RscGqlMutateCreateCassandraSource.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createCassandraSource
    /// createCassandraSource(input: AddMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateCassandraSource")
    ]
    public class Invoke_RscGqlMutateCreateCassandraSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateCassandraSource
}
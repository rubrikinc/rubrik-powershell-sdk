...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// Cancel, QuarantineMatches, Start, StartBulk, StartTurbo, or StartV2.
    /// </summary>
    /// <description>
    ...
    /// -Operation parameter;
    /// one of: Cancel, QuarantineMatches, Start, StartBulk, StartTurbo, or StartV2.
    ...
    ///
    /// <example>
    /// Runs the QuarantineMatches operation
    /// of the 'ThreatHunt' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    ThreatHunt
    /// # API Operation: QuarantineMatches
    /// 
    /// $query = New-RscMutationThreatHunt -Operation QuarantineMatches
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    public class New_RscMutationThreatHunt : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    case "Cancel":
                        ...
                        break;
                    case "QuarantineMatches":
                        this.ProcessRecord_QuarantineMatches();
                        break;
                    case "Start":
        ...
        internal void ProcessRecord_QuarantineMatches()
        {
            this._logger.name += " -QuarantineMatches";

// Invoke-RscGqlMutateCreateMssqlLogShippingConfiguration.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createMssqlLogShippingConfiguration
    /// createMssqlLogShippingConfiguration(input: CreateMssqlLogShippingConfigurationInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateMssqlLogShippingConfiguration")
    ]
    public class Invoke_RscGqlMutateCreateMssqlLogShippingConfiguration : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateMssqlLogShippingConfiguration
}
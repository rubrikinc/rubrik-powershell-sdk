// Invoke-RscGqlMutateCreateMssqlLiveMount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createMssqlLiveMount
    /// createMssqlLiveMount(input: CreateMssqlLiveMountInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateMssqlLiveMount")
    ]
    public class Invoke_RscGqlMutateCreateMssqlLiveMount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateMssqlLiveMount
}
// Invoke-RscGqlQueryHypervMounts.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query hypervMounts
    /// hypervMounts(
    ///     first: Int
    ///     after: String
    ...
    public class Invoke_RscGqlQueryHypervMounts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.sortBy = @{
    ...
    } // class Invoke-RscGqlQueryHypervMounts
}
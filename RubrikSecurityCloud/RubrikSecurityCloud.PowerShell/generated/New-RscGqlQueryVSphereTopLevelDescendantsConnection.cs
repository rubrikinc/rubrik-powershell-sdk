// New-RscGqlQueryVSphereTopLevelDescendantsConnection.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query vSphereTopLevelDescendantsConnection
    ...
    public class New_RscGqlQueryVSphereTopLevelDescendantsConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryVSphereTopLevelDescendantsConnection
}
...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// (New-RscMutationGcp -AddCloudAccountManualAuthProject).Info().
    ...
    ///
    /// <example>
    /// Runs the AddCloudAccountManualAuthProject operation
    ...
    /// # API Domain:    Gcp
    /// # API Operation: AddCloudAccountManualAuthProject
    /// 
    /// $query = New-RscMutationGcp -Operation AddCloudAccountManualAuthProject
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 
    /// Write-Host $result.GetType().Name # prints: AddGcpCloudAccountManualAuthProjectReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CloudAccountDeleteProjectsV2 operation
    /// of the 'Google Cloud Platform' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Gcp
    /// # API Operation: CloudAccountDeleteProjectsV2
    /// 
    /// $query = New-RscMutationGcp -Operation CloudAccountDeleteProjectsV2
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    ///
    /// <example>
    /// Runs the SetExocomputeConfigs operation
    /// of the 'Google Cloud Platform' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Gcp
    /// # API Operation: SetExocomputeConfigs
    /// 
    /// $query = New-RscMutationGcp -Operation SetExocomputeConfigs
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    public class New_RscMutationGcp : RscGqlPSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    case "AddCloudAccountManualAuthProject":
                        this.ProcessRecord_AddCloudAccountManualAuthProject();
                        break;
                    case "BulkSetCloudAccountProperties":
                        this.ProcessRecord_BulkSetCloudAccountProperties();
                        break;
                    ...
                    case "SetDefaultServiceAccountJwtConfig":
                        ...
                        break;
                    case "SetExocomputeConfigs":
                        this.ProcessRecord_SetExocomputeConfigs();
                        break;
                    case "UpdateTarget":
        ...
        internal void ProcessRecord_AddCloudAccountManualAuthProject()
        {
            this._logger.name += " -AddCloudAccountManualAuthProject";
            // Create new graphql operation addGcpCloudAccountManualAuthProject
            InitMutationAddGcpCloudAccountManualAuthProject();
        }

        // This parameter set invokes a single graphql operation:
        // gcpBulkSetCloudAccountProperties.
        internal void ProcessRecord_BulkSetCloudAccountProperties()
        {
            this._logger.name += " -BulkSetCloudAccountProperties";
            // Create new graphql operation gcpBulkSetCloudAccountProperties
            InitMutationGcpBulkSetCloudAccountProperties();
        }
        ...
        internal void ProcessRecord_CloudAccountDeleteProjectsV2()
        {
            this._logger.name += " -CloudAccountDeleteProjectsV2";
            // Create new graphql operation gcpCloudAccountDeleteProjectsV2
            InitMutationGcpCloudAccountDeleteProjectsV2();
        }
        ...
        internal void ProcessRecord_SetExocomputeConfigs()
        {
            this._logger.name += " -SetExocomputeConfigs";
            // Create new graphql operation setGcpExocomputeConfigs
            InitMutationSetGcpExocomputeConfigs();
        }
        ...
        // addGcpCloudAccountManualAuthProject(input: AddGcpCloudAccountManualAuthProjectInput!): AddGcpCloudAccountManualAuthProjectReply!
        internal void InitMutationAddGcpCloudAccountManualAuthProject()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "AddGcpCloudAccountManualAuthProjectInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationAddGcpCloudAccountManualAuthProject",
                "($input: AddGcpCloudAccountManualAuthProjectInput!)",
                "AddGcpCloudAccountManualAuthProjectReply",
                Mutation.AddGcpCloudAccountManualAuthProject,
                Mutation.AddGcpCloudAccountManualAuthProjectFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	gcpNativeProjectId = $someString
	...
	featuresWithPermissionGroups = @(
        ...
        // Create new GraphQL Mutation:
        // gcpBulkSetCloudAccountProperties(input: GcpBulkSetCloudAccountPropertiesInput!): Boolean!
        internal void InitMutationGcpBulkSetCloudAccountProperties()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GcpBulkSetCloudAccountPropertiesInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationGcpBulkSetCloudAccountProperties",
                "($input: GcpBulkSetCloudAccountPropertiesInput!)",
                "System.Boolean",
                Mutation.GcpBulkSetCloudAccountProperties,
                Mutation.GcpBulkSetCloudAccountPropertiesFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	cloudAccountIds = @(
...
$query.Var.input = @{
	...
	features = @(
        ...
        // Create new GraphQL Mutation:
        // gcpCloudAccountDeleteProjectsV2(input: GcpCloudAccountDeleteProjectsV2Input!): BatchAsyncJobStatus!
        internal void InitMutationGcpCloudAccountDeleteProjectsV2()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GcpCloudAccountDeleteProjectsV2Input!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationGcpCloudAccountDeleteProjectsV2",
                "($input: GcpCloudAccountDeleteProjectsV2Input!)",
                "BatchAsyncJobStatus",
                Mutation.GcpCloudAccountDeleteProjectsV2,
                Mutation.GcpCloudAccountDeleteProjectsV2FieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	features = @(
...
$query.Var.input = @{
	...
	serviceAccountJwtConfig = $someString
        ...
        // Create new GraphQL Mutation:
        // setGcpExocomputeConfigs(input: SetGcpExocomputeConfigsInput!): Void
        internal void InitMutationSetGcpExocomputeConfigs()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "SetGcpExocomputeConfigsInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationSetGcpExocomputeConfigs",
                "($input: SetGcpExocomputeConfigsInput!)",
                "System.String",
                Mutation.SetGcpExocomputeConfigs,
                Mutation.SetGcpExocomputeConfigsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	cloudAccountId = $someString

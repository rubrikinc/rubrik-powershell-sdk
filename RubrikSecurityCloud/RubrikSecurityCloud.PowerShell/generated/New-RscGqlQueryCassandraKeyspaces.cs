// New-RscGqlQueryCassandraKeyspaces.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query cassandraKeyspaces
    /// cassandraKeyspaces(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryCassandraKeyspaces : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryCassandraKeyspaces
}
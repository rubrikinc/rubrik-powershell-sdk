// Invoke-RscGqlQueryDb2Instances.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query db2Instances
    /// db2Instances(
    ///     first: Int
    ///     after: String
    ...
    public class Invoke_RscGqlQueryDb2Instances : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryDb2Instances
}
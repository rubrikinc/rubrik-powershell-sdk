// New-RscGqlQueryMongodbCollections.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongodbCollections
    /// mongodbCollections(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryMongodbCollections : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongodbCollections
}
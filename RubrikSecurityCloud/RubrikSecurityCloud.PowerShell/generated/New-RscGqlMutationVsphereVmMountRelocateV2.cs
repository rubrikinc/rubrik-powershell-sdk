// New-RscGqlMutationVsphereVmMountRelocateV2.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmMountRelocateV2
    /// vsphereVmMountRelocateV2(input: VsphereVmMountRelocateV2Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmMountRelocateV2")
    ]
    public class New_RscGqlMutationVsphereVmMountRelocateV2 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmMountRelocateV2
}
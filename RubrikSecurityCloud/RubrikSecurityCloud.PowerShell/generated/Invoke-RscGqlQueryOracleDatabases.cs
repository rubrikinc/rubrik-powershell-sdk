// Invoke-RscGqlQueryOracleDatabases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query oracleDatabases
    /// oracleDatabases(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryOracleDatabases")
    ]
    public class Invoke_RscGqlQueryOracleDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("oracleDatabases");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_oracleDatabases();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_oracleDatabases()
        {
            this._logger.name += " -oracleDatabases";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryOracleDatabases
}
// New-RscGqlQueryO365TeamChannels.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query o365TeamChannels
    /// o365TeamChannels(
    ///     first: Int
    ///     after: String
    ///     snappableFid: UUID!
    ...
    public class New_RscGqlQueryO365TeamChannels : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.nameFilter = <System.String>"
    ...
    } // class New-RscGqlQueryO365TeamChannels
}
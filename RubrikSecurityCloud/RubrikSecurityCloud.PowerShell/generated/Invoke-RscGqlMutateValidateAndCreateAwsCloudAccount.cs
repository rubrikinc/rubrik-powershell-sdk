// Invoke-RscGqlMutateValidateAndCreateAwsCloudAccount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation validateAndCreateAwsCloudAccount
    /// validateAndCreateAwsCloudAccount(input: ValidateAndCreateAwsCloudAccountInput!): ValidateAndCreateAwsCloudAccountReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateValidateAndCreateAwsCloudAccount")
    ]
    public class Invoke_RscGqlMutateValidateAndCreateAwsCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateValidateAndCreateAwsCloudAccount
}
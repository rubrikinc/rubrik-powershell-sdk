// New-RscGqlMutationUpdateCassandraSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateCassandraSource
    /// updateCassandraSource(input: ModifyMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateCassandraSource")
    ]
    public class New_RscGqlMutationUpdateCassandraSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateCassandraSource
}
// New-RscGqlMutationUpgradeAzureCloudAccount.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation upgradeAzureCloudAccount
    /// upgradeAzureCloudAccount(input: UpgradeAzureCloudAccountInput!): UpgradeAzureCloudAccountReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpgradeAzureCloudAccount")
    ]
    public class New_RscGqlMutationUpgradeAzureCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpgradeAzureCloudAccount
}
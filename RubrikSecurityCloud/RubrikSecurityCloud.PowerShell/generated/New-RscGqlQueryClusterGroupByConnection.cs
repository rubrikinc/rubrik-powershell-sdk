// New-RscGqlQueryClusterGroupByConnection.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query clusterGroupByConnection
    ...
    public class New_RscGqlQueryClusterGroupByConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.timezoneOffset = <System.Single>"
    ...
    } // class New-RscGqlQueryClusterGroupByConnection
}
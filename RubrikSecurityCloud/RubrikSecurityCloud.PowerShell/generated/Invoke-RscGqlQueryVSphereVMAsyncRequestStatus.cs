// Invoke-RscGqlQueryVSphereVMAsyncRequestStatus.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereVMAsyncRequestStatus
    ...
    public class Invoke_RscGqlQueryVSphereVMAsyncRequestStatus : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.id = <System.String>"
    ...
    } // class Invoke-RscGqlQueryVSphereVMAsyncRequestStatus
}
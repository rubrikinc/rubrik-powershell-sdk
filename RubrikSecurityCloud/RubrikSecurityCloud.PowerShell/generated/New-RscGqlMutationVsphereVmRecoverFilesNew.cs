// New-RscGqlMutationVsphereVmRecoverFilesNew.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmRecoverFilesNew
    /// vsphereVmRecoverFilesNew(input: VsphereVmRecoverFilesNewInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmRecoverFilesNew")
    ]
    public class New_RscGqlMutationVsphereVmRecoverFilesNew : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmRecoverFilesNew
}
// Invoke-RscGqlQueryAzureNativeResourceGroups.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureNativeResourceGroups
    ...
    public class Invoke_RscGqlQueryAzureNativeResourceGroups : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.azureNativeProtectionFeatures = @(
    ...
    } // class Invoke-RscGqlQueryAzureNativeResourceGroups
}
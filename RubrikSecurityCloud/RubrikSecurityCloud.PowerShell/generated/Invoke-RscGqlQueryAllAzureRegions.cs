// Invoke-RscGqlQueryAllAzureRegions.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allAzureRegions
    ...
    public class Invoke_RscGqlQueryAllAzureRegions : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.cloudAccountId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryAllAzureRegions
}
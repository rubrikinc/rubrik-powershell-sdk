// Invoke-RscGqlQueryVSphereDatastoreClusters.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereDatastoreClusters
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryVSphereDatastoreClusters")
    ]
    public class Invoke_RscGqlQueryVSphereDatastoreClusters : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("vSphereDatastoreClusters");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_vSphereDatastoreClusters();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_vSphereDatastoreClusters()
        {
            this._logger.name += " -vSphereDatastoreClusters";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereDatastoreClusters
}
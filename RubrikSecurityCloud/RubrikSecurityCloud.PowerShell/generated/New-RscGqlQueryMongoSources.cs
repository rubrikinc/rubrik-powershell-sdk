// New-RscGqlQueryMongoSources.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongoSources
    /// mongoSources(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "New",
        "RscGqlQueryMongoSources")
    ]
    public class New_RscGqlQueryMongoSources : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongoSources");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongoSources();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongoSources()
        {
            this._logger.name += " -mongoSources";
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongoSources
}
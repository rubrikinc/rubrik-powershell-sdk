// Invoke-RscGqlQueryOracleRecoverableRanges.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query oracleRecoverableRanges
    ...
    public class Invoke_RscGqlQueryOracleRecoverableRanges : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlQueryOracleRecoverableRanges
}
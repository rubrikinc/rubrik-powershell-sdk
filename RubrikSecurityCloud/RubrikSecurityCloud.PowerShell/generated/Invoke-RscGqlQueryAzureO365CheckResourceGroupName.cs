// Invoke-RscGqlQueryAzureO365CheckResourceGroupName.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureO365CheckResourceGroupName
    ...
    public class Invoke_RscGqlQueryAzureO365CheckResourceGroupName : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.groupName = <System.String>"
    ...
    } // class Invoke-RscGqlQueryAzureO365CheckResourceGroupName
}
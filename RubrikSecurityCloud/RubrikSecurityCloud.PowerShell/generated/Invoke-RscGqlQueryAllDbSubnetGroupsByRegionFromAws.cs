// Invoke-RscGqlQueryAllDbSubnetGroupsByRegionFromAws.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allDbSubnetGroupsByRegionFromAws
    ...
    public class Invoke_RscGqlQueryAllDbSubnetGroupsByRegionFromAws : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.region = <AwsNativeRegion> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AwsNativeRegion]) for enum values."
    ...
    } // class Invoke-RscGqlQueryAllDbSubnetGroupsByRegionFromAws
}
// Invoke-RscGqlQueryAzureNativeManagedDisks.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureNativeManagedDisks
    ...
    public class Invoke_RscGqlQueryAzureNativeManagedDisks : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.diskFilters = @{
    ...
    } // class Invoke-RscGqlQueryAzureNativeManagedDisks
}
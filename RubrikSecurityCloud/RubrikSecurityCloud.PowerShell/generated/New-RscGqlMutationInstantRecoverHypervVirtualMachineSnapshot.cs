// New-RscGqlMutationInstantRecoverHypervVirtualMachineSnapshot.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation instantRecoverHypervVirtualMachineSnapshot
    /// instantRecoverHypervVirtualMachineSnapshot(input: InstantRecoverHypervVirtualMachineSnapshotInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationInstantRecoverHypervVirtualMachineSnapshot")
    ]
    public class New_RscGqlMutationInstantRecoverHypervVirtualMachineSnapshot : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationInstantRecoverHypervVirtualMachineSnapshot
}
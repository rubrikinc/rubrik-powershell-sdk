// Invoke-RscGqlMutateAzureOauthConsentKickoff.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation azureOauthConsentKickoff
    /// azureOauthConsentKickoff: AzureOauthConsentKickoffReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateAzureOauthConsentKickoff")
    ]
    public class Invoke_RscGqlMutateAzureOauthConsentKickoff : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
    ...
    } // class Invoke-RscGqlMutateAzureOauthConsentKickoff
}
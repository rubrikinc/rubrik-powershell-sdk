// Invoke-RscGqlMutateDeleteAzureCluster.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation deleteAzureCluster
    /// deleteAzureCluster(input: DeleteAzureClusterInput!): CcProvisionJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateDeleteAzureCluster")
    ]
    public class Invoke_RscGqlMutateDeleteAzureCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateDeleteAzureCluster
}
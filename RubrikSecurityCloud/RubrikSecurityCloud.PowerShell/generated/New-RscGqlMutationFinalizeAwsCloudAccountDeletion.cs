// New-RscGqlMutationFinalizeAwsCloudAccountDeletion.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation finalizeAwsCloudAccountDeletion
    /// finalizeAwsCloudAccountDeletion(input: FinalizeAwsCloudAccountDeletionInput!): FinalizeAwsCloudAccountDeletionReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationFinalizeAwsCloudAccountDeletion")
    ]
    public class New_RscGqlMutationFinalizeAwsCloudAccountDeletion : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationFinalizeAwsCloudAccountDeletion
}
// New-RscGqlMutationStartExportAzureNativeManagedDiskJob.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation startExportAzureNativeManagedDiskJob
    /// startExportAzureNativeManagedDiskJob(input: StartExportAzureNativeManagedDiskJobInput!): AsyncJobStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationStartExportAzureNativeManagedDiskJob")
    ]
    public class New_RscGqlMutationStartExportAzureNativeManagedDiskJob : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationStartExportAzureNativeManagedDiskJob
}
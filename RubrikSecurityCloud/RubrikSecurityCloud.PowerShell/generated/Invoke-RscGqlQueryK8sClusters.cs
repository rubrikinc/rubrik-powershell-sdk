// Invoke-RscGqlQueryK8sClusters.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query k8sClusters
    /// k8sClusters(
    ///     first: Int
    ///     after: String
    ...
    public class Invoke_RscGqlQueryK8sClusters : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryK8sClusters
}
// New-RscGqlMutationUpdateGlobalSla.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateGlobalSla
    /// updateGlobalSla(input: UpdateGlobalSlaInput!): GlobalSlaReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateGlobalSla")
    ]
    public class New_RscGqlMutationUpdateGlobalSla : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("updateGlobalSla");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_updateGlobalSla();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_updateGlobalSla()
        {
            this._logger.name += " -updateGlobalSla";
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateGlobalSla
}
...
namespace Rubrik.SecurityCloud.PowerShell.Cmdlets
{
    [Cmdlet(
        "Query",
        "RscAws",
        DefaultParameterSetName = "allRegion")
    ]
    public class Query_RscAws : RscPSCmdlet
    {
        ...
        public SwitchParameter allVpcsByRegionFrom { get; set; }
        ...
        public SwitchParameter allVpcsFrom { get; set; }
        ...
        public SwitchParameter allAvailabilityZonesByRegionFrom { get; set; }

        
        // -------------------------------------------------------------------
        // allKmsEncryptionKeysByRegionFrom parameter set
        //
        // GraphQL operation: allKmsEncryptionKeysByRegionFromAws(awsAccountRubrikId: UUID!, region: AwsNativeRegion!):[KmsEncryptionKey!]!
        //
        [Parameter(
            ParameterSetName = "allKmsEncryptionKeysByRegionFrom",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter allKmsEncryptionKeysByRegionFrom { get; set; }
        ...
        public SwitchParameter allS3BucketsFrom { get; set; }
        ...
        // -------------------------------------------------------------------
        // rdsInstanceDetailsFrom parameter set
        //
        ...
        //
        [Parameter(
            ParameterSetName = "rdsInstanceDetailsFrom",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter rdsInstanceDetailsFrom { get; set; }
        ...
        // -------------------------------------------------------------------
        // allOptionGroupsByRegionFrom parameter set
        //
        ...
        //
        [Parameter(
            ParameterSetName = "allOptionGroupsByRegionFrom",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter allOptionGroupsByRegionFrom { get; set; }
        ...
        // -------------------------------------------------------------------
        // allDbParameterGroupsByRegionFrom parameter set
        //
        ...
        //
        [Parameter(
            ParameterSetName = "allDbParameterGroupsByRegionFrom",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter allDbParameterGroupsByRegionFrom { get; set; }
        ...
        public SwitchParameter allDbSubnetGroupsByRegionFrom { get; set; }
        ...
        public SwitchParameter allEc2KeyPairsByRegionFrom { get; set; }
            ...
            try
            {
                switch(Op)
                {
                    ...
                    case "NativeEbsVolumesByName":
                        ...
                        break;
                    case "allVpcsByRegionFrom":
                        this.ProcessRecord_allVpcsByRegionFrom();
                        break;
                    case "allVpcsFrom":
                        this.ProcessRecord_allVpcsFrom();
                        break;
                    case "isNativeEbsVolumeSnapshotRestorable":
                        this.ProcessRecord_isNativeEbsVolumeSnapshotRestorable();
                        break;
                    case "allAvailabilityZonesByRegionFrom":
                        this.ProcessRecord_allAvailabilityZonesByRegionFrom();
                        break;
                    case "allKmsEncryptionKeysByRegionFrom":
                        this.ProcessRecord_allKmsEncryptionKeysByRegionFrom();
                        break;
                    case "isS3BucketNameAvailable":
                        this.ProcessRecord_isS3BucketNameAvailable();
                        break;
                    case "allS3BucketsFrom":
                        this.ProcessRecord_allS3BucketsFrom();
                        break;
                    ...
                    case "NativeRdsPointInTimeRestoreWindow":
                        ...
                        break;
                    case "rdsInstanceDetailsFrom":
                        this.ProcessRecord_rdsInstanceDetailsFrom();
                        break;
                    case "isNativeRdsInstanceLaunchConfigurationValid":
                        this.ProcessRecord_isNativeRdsInstanceLaunchConfigurationValid();
                        break;
                    case "allOptionGroupsByRegionFrom":
                        this.ProcessRecord_allOptionGroupsByRegionFrom();
                        break;
                    case "allDbParameterGroupsByRegionFrom":
                        this.ProcessRecord_allDbParameterGroupsByRegionFrom();
                        break;
                    case "allDbSubnetGroupsByRegionFrom":
                        this.ProcessRecord_allDbSubnetGroupsByRegionFrom();
                        break;
                    ...
                    case "NativeRdsExportDefault":
                        ...
                        break;
                    case "allEc2KeyPairsByRegionFrom":
                        this.ProcessRecord_allEc2KeyPairsByRegionFrom();
                        break;
        ...
        protected void ProcessRecord_allVpcsByRegionFrom()
        {
            this._logger.name += " -allVpcsByRegionFrom";
        ...
        // This parameter set invokes a single graphql operation:
        // allVpcsFromAws.
        protected void ProcessRecord_allVpcsFrom()
        {
            this._logger.name += " -allVpcsFrom";
        ...
        protected void ProcessRecord_allAvailabilityZonesByRegionFrom()
        {
            this._logger.name += " -allAvailabilityZonesByRegionFrom";
        ...
        protected void ProcessRecord_allKmsEncryptionKeysByRegionFrom()
        {
            this._logger.name += " -allKmsEncryptionKeysByRegionFrom";
        ...
        // This parameter set invokes a single graphql operation:
        // allS3BucketsFromAws.
        protected void ProcessRecord_allS3BucketsFrom()
        {
            this._logger.name += " -allS3BucketsFrom";
        ...
        protected void ProcessRecord_rdsInstanceDetailsFrom()
        {
            this._logger.name += " -rdsInstanceDetailsFrom";
        ...
        protected void ProcessRecord_allOptionGroupsByRegionFrom()
        {
            this._logger.name += " -allOptionGroupsByRegionFrom";
        ...
        protected void ProcessRecord_allDbParameterGroupsByRegionFrom()
        {
            this._logger.name += " -allDbParameterGroupsByRegionFrom";
        ...
        protected void ProcessRecord_allDbSubnetGroupsByRegionFrom()
        {
            this._logger.name += " -allDbSubnetGroupsByRegionFrom";
        ...
        protected void ProcessRecord_allEc2KeyPairsByRegionFrom()
        {
            this._logger.name += " -allEc2KeyPairsByRegionFrom";

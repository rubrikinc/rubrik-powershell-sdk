// New-RscGqlMutationMountOracleDatabase.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation mountOracleDatabase
    /// mountOracleDatabase(input: MountOracleDatabaseInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationMountOracleDatabase")
    ]
    public class New_RscGqlMutationMountOracleDatabase : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationMountOracleDatabase
}
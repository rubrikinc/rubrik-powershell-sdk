// Invoke-RscGqlMutateUpdateGlobalSla.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateGlobalSla
    /// updateGlobalSla(input: UpdateGlobalSlaInput!): GlobalSlaReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateGlobalSla")
    ]
    public class Invoke_RscGqlMutateUpdateGlobalSla : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateGlobalSla
}
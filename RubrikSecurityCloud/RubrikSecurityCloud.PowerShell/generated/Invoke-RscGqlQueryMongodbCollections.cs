// Invoke-RscGqlQueryMongodbCollections.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mongodbCollections
    /// mongodbCollections(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryMongodbCollections")
    ]
    public class Invoke_RscGqlQueryMongodbCollections : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongodbCollections");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongodbCollections();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongodbCollections()
        {
            this._logger.name += " -mongodbCollections";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryMongodbCollections
}
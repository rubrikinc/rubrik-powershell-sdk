// Invoke-RscGqlMutatePatchNutanixMountV1.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation patchNutanixMountV1
    /// patchNutanixMountV1(input: PatchNutanixMountV1Input!): PatchNutanixMountV1Reply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutatePatchNutanixMountV1")
    ]
    public class Invoke_RscGqlMutatePatchNutanixMountV1 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutatePatchNutanixMountV1
}
// Invoke-RscGqlQueryMssqlDatabases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mssqlDatabases
    /// mssqlDatabases(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryMssqlDatabases")
    ]
    public class Invoke_RscGqlQueryMssqlDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mssqlDatabases");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mssqlDatabases();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mssqlDatabases()
        {
            this._logger.name += " -mssqlDatabases";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryMssqlDatabases
}
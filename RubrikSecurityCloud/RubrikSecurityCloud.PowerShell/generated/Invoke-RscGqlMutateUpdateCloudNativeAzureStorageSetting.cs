// Invoke-RscGqlMutateUpdateCloudNativeAzureStorageSetting.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateCloudNativeAzureStorageSetting
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateCloudNativeAzureStorageSetting")
    ]
    public class Invoke_RscGqlMutateUpdateCloudNativeAzureStorageSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateCloudNativeAzureStorageSetting
}
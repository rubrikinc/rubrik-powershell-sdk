...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    ///
    /// <example>
    /// Runs the GetListFilters operation
    /// of the 'Cloud Account' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    CloudAccount
    /// # API Operation: GetListFilters
    /// 
    /// $query = New-RscQueryCloudAccount -Operation GetListFilters
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// 	# OPTIONAL
    /// 	filterTypes = @(
    /// 		$someCloudAccountFilterType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudAccountFilterType]) for enum values.
    /// 	)
    /// }
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudAccountsGetListFiltersReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ListCertificateUsages operation
    /// of the 'Cloud Account' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    CloudAccount
    /// # API Operation: ListCertificateUsages
    /// 
    /// $query = New-RscQueryCloudAccount -Operation ListCertificateUsages
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ListCertificateUsagesForCloudAccountResp
    /// 
    /// 
    /// 
    /// </code>
    ...
    public class New_RscQueryCloudAccount : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "ExocomputeMappings":
                        ...
                        break;
                    case "GetListFilters":
                        this.ProcessRecord_GetListFilters();
                        break;
                    ...
                    case "LatestFeaturePermissions":
                        ...
                        break;
                    case "ListCertificateUsages":
                        this.ProcessRecord_ListCertificateUsages();
                        break;
        ...
        internal void ProcessRecord_GetListFilters()
        {
            this._logger.name += " -GetListFilters";
            // Create new graphql operation cloudAccountsGetListFilters
            InitQueryCloudAccountsGetListFilters();
        }
        ...
        internal void ProcessRecord_ListCertificateUsages()
        {
            this._logger.name += " -ListCertificateUsages";
            // Create new graphql operation listCertificateUsagesForCloudAccount
            InitQueryListCertificateUsagesForCloudAccount();
        }
...
$query.Var.exocomputeAccountIdsFilter = @(
	$someString
        ...
        // Create new GraphQL Query:
        // cloudAccountsGetListFilters(input: CloudAccountsGetListFiltersReq!): CloudAccountsGetListFiltersReply!
        internal void InitQueryCloudAccountsGetListFilters()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CloudAccountsGetListFiltersReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCloudAccountsGetListFilters",
                "($input: CloudAccountsGetListFiltersReq!)",
                "CloudAccountsGetListFiltersReply",
                Query.CloudAccountsGetListFilters,
                Query.CloudAccountsGetListFiltersFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	cloudVendor = $someCloudVendor # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudVendor]) for enum values.
...
$query.Var.featuresWithPermissionsGroups = @(
	@{
        ...
        // Create new GraphQL Query:
        // listCertificateUsagesForCloudAccount(input: ListCertificateUsagesForCloudAccountInput!): ListCertificateUsagesForCloudAccountResp!
        internal void InitQueryListCertificateUsagesForCloudAccount()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ListCertificateUsagesForCloudAccountInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryListCertificateUsagesForCloudAccount",
                "($input: ListCertificateUsagesForCloudAccountInput!)",
                "ListCertificateUsagesForCloudAccountResp",
                Query.ListCertificateUsagesForCloudAccount,
                Query.ListCertificateUsagesForCloudAccountFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	cloudAccountId = $someString

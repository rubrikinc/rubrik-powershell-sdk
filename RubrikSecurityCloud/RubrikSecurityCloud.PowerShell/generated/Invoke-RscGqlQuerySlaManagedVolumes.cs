// Invoke-RscGqlQuerySlaManagedVolumes.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query slaManagedVolumes
    /// slaManagedVolumes(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQuerySlaManagedVolumes")
    ]
    public class Invoke_RscGqlQuerySlaManagedVolumes : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("slaManagedVolumes");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_slaManagedVolumes();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_slaManagedVolumes()
        {
            this._logger.name += " -slaManagedVolumes";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQuerySlaManagedVolumes
}
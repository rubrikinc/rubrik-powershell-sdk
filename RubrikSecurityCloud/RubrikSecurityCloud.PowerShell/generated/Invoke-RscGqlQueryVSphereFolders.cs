// Invoke-RscGqlQueryVSphereFolders.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereFolders
    /// vSphereFolders(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryVSphereFolders")
    ]
    public class Invoke_RscGqlQueryVSphereFolders : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("vSphereFolders");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_vSphereFolders();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_vSphereFolders()
        {
            this._logger.name += " -vSphereFolders";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereFolders
}
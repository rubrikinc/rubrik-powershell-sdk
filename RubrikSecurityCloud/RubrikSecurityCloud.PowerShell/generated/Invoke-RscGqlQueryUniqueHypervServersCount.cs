// Invoke-RscGqlQueryUniqueHypervServersCount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query uniqueHypervServersCount
    ...
    public class Invoke_RscGqlQueryUniqueHypervServersCount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryUniqueHypervServersCount
}
// New-RscGqlMutationCreateAutomaticAwsTargetMapping.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation createAutomaticAwsTargetMapping
    /// createAutomaticAwsTargetMapping(input: CreateAutomaticAwsTargetMappingInput!): TargetMapping!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationCreateAutomaticAwsTargetMapping")
    ]
    public class New_RscGqlMutationCreateAutomaticAwsTargetMapping : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationCreateAutomaticAwsTargetMapping
}
// New-RscGqlQueryRdsInstanceDetailsFromAws.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query rdsInstanceDetailsFromAws
    ...
    public class New_RscGqlQueryRdsInstanceDetailsFromAws : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.rdsDatabaseRubrikId = <System.String>"
    ...
    } // class New-RscGqlQueryRdsInstanceDetailsFromAws
}
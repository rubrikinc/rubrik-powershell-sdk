// New-RscGqlMutationBrowseMssqlDatabaseSnapshot.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation browseMssqlDatabaseSnapshot
    /// browseMssqlDatabaseSnapshot(input: BrowseMssqlDatabaseSnapshotInput!): BrowseMssqlDatabaseSnapshotReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationBrowseMssqlDatabaseSnapshot")
    ]
    public class New_RscGqlMutationBrowseMssqlDatabaseSnapshot : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationBrowseMssqlDatabaseSnapshot
}
// New-RscGqlMutationBatchExportHypervVm.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation batchExportHypervVm
    /// batchExportHypervVm(input: BatchExportHypervVmInput!): BatchExportHypervVmReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationBatchExportHypervVm")
    ]
    public class New_RscGqlMutationBatchExportHypervVm : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationBatchExportHypervVm
}
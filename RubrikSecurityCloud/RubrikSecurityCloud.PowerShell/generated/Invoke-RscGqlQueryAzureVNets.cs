// Invoke-RscGqlQueryAzureVNets.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureVNets
    ...
    public class Invoke_RscGqlQueryAzureVNets : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.regionName = <System.String>"
    ...
    } // class Invoke-RscGqlQueryAzureVNets
}
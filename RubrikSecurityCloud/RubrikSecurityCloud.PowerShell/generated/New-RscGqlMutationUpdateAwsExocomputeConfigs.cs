// New-RscGqlMutationUpdateAwsExocomputeConfigs.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateAwsExocomputeConfigs
    /// updateAwsExocomputeConfigs(input: UpdateAwsExocomputeConfigsInput!): UpdateAwsExocomputeConfigsReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateAwsExocomputeConfigs")
    ]
    public class New_RscGqlMutationUpdateAwsExocomputeConfigs : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateAwsExocomputeConfigs
}
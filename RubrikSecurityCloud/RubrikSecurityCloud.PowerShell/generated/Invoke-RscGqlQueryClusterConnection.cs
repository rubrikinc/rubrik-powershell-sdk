// Invoke-RscGqlQueryClusterConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterConnection
    /// clusterConnection(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class Invoke_RscGqlQueryClusterConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.sortBy = <ClusterSortByEnum> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ClusterSortByEnum]) for enum values."
    ...
    } // class Invoke-RscGqlQueryClusterConnection
}
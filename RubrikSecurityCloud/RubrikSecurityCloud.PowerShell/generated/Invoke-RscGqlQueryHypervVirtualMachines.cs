// Invoke-RscGqlQueryHypervVirtualMachines.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query hypervVirtualMachines
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryHypervVirtualMachines")
    ]
    public class Invoke_RscGqlQueryHypervVirtualMachines : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("hypervVirtualMachines");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_hypervVirtualMachines();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_hypervVirtualMachines()
        {
            this._logger.name += " -hypervVirtualMachines";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryHypervVirtualMachines
}
// New-RscGqlMutationAddMongoSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation addMongoSource
    /// addMongoSource(input: AddMongoSourceInput!): AddMongoSourceReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationAddMongoSource")
    ]
    public class New_RscGqlMutationAddMongoSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationAddMongoSource
}
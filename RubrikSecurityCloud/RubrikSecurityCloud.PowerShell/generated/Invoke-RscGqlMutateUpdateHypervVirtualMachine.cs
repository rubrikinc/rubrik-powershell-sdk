// Invoke-RscGqlMutateUpdateHypervVirtualMachine.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateHypervVirtualMachine
    /// updateHypervVirtualMachine(input: UpdateHypervVirtualMachineInput!): UpdateHypervVirtualMachineReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateHypervVirtualMachine")
    ]
    public class Invoke_RscGqlMutateUpdateHypervVirtualMachine : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateHypervVirtualMachine
}
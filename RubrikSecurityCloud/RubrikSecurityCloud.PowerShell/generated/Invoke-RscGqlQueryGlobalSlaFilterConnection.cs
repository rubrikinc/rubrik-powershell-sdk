// Invoke-RscGqlQueryGlobalSlaFilterConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query globalSlaFilterConnection
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryGlobalSlaFilterConnection")
    ]
    public class Invoke_RscGqlQueryGlobalSlaFilterConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("globalSlaFilterConnection");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_globalSlaFilterConnection();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_globalSlaFilterConnection()
        {
            this._logger.name += " -globalSlaFilterConnection";
...
$inputs.Var.shouldShowPausedClusters = <System.Boolean>"
    ...
    } // class Invoke-RscGqlQueryGlobalSlaFilterConnection
}
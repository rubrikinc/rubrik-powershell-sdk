// New-RscGqlMutationVsphereVmBatchExportV3.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmBatchExportV3
    /// vsphereVmBatchExportV3(input: VsphereVmBatchExportV3Input!): BatchAsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmBatchExportV3")
    ]
    public class New_RscGqlMutationVsphereVmBatchExportV3 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmBatchExportV3
}
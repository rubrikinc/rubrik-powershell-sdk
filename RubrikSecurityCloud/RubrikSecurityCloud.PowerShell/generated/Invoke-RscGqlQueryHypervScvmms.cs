// Invoke-RscGqlQueryHypervScvmms.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query hypervScvmms
    /// hypervScvmms(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryHypervScvmms")
    ]
    public class Invoke_RscGqlQueryHypervScvmms : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("hypervScvmms");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_hypervScvmms();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_hypervScvmms()
        {
            this._logger.name += " -hypervScvmms";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryHypervScvmms
}
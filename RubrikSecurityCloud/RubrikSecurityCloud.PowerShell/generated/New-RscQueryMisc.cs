...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// $query.Var.input = @{
    /// 	# REQUIRED
    /// 	protocol = $someCloudDirectCheckShareProtocolType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudDirectCheckShareProtocolType]) for enum values.
    /// 	# REQUIRED
    /// 	host = $someString
    /// 	# REQUIRED
    /// 	path = $someString

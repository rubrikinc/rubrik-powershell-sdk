...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// 	)
    /// 	# OPTIONAL
    /// 	scopedTargetEntities = @(
    /// 		@{
    /// 			# REQUIRED
    /// 			id = $someString
    /// 			# REQUIRED
    /// 			scope = $someLambdaTargetScope # Call [Enum]::GetValues([RubrikSecurityCloud.Types.LambdaTargetScope]) for enum values.
    /// 		}
    /// 	)
    /// 	# OPTIONAL
    /// 	actorIpAddresses = @(
    ...
    ///
    /// <example>
    /// Runs the CapSettingsData operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CapSettingsData
    /// 
    /// $query = New-RscQueryMisc -Operation CapSettingsData
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CapSettingsData
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CcProvisionMetadata operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CcProvisionMetadata
    /// 
    /// $query = New-RscQueryMisc -Operation CcProvisionMetadata
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the CloudDirectCheckSharePath operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CloudDirectCheckSharePath
    /// 
    /// $query = New-RscQueryMisc -Operation CloudDirectCheckSharePath
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 	# REQUIRED
    /// 	protocol = $someCloudDirectNasProtocolType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudDirectNasProtocolType]) for enum values.
    /// 	# REQUIRED
    /// 	host = $someString
    /// 	# REQUIRED
    /// 	path = $someString
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudDirectCheckSharePathResp
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CloudDirectGlobalSearch operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CloudDirectGlobalSearch
    /// 
    /// $query = New-RscQueryMisc -Operation CloudDirectGlobalSearch
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudDirectGlobalSearchResult
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CloudDirectNasBucket operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CloudDirectNasBucket
    /// 
    /// $query = New-RscQueryMisc -Operation CloudDirectNasBucket
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudDirectNasBucket
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CloudDirectNasBuckets operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CloudDirectNasBuckets
    /// 
    /// $query = New-RscQueryMisc -Operation CloudDirectNasBuckets
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudDirectNasBucketConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CloudDirectSiteSettings operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CloudDirectSiteSettings
    /// 
    /// $query = New-RscQueryMisc -Operation CloudDirectSiteSettings
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ListCloudDirectSiteSettingsResp
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CoordinatorLabels operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CoordinatorLabels
    /// 
    /// $query = New-RscQueryMisc -Operation CoordinatorLabels
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CoordinatorLabelsReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the CrowdStrikeIngestionStatus operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: CrowdStrikeIngestionStatus
    /// 
    /// $query = New-RscQueryMisc -Operation CrowdStrikeIngestionStatus
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CrowdStrikeIngestionStatus
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the DataPreview operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: DataPreview
    /// 
    /// $query = New-RscQueryMisc -Operation DataPreview
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// 					# OPTIONAL
    /// 					dataTypeDisplayName = $someString
    /// 					# OPTIONAL
    /// 					requestedField = $someString
    /// 				}
    /// 			)
    /// 		}
    /// 	}
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetDataPreviewReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the DevOpsBackupJobInformation operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: DevOpsBackupJobInformation
    /// 
    /// $query = New-RscQueryMisc -Operation DevOpsBackupJobInformation
    /// 
    /// # REQUIRED
    /// $query.Var.devopsOrgType = $someDevopsOrgType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.DevopsOrgType]) for enum values.
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: DevOpsBackupJobInformation
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the DevOpsProtectedObjectCountSummary operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: DevOpsProtectedObjectCountSummary
    /// 
    /// $query = New-RscQueryMisc -Operation DevOpsProtectedObjectCountSummary
    /// 
    /// # REQUIRED
    /// $query.Var.objectType = $someManagedObjectType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ManagedObjectType]) for enum values.
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: DevOpsProtectedObjectCountSummary
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ExocomputeGetSupportedHealthChecks operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ExocomputeGetSupportedHealthChecks
    /// 
    /// $query = New-RscQueryMisc -Operation ExocomputeGetSupportedHealthChecks
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    /// 	cloudType = $someExocomputeCloudType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ExocomputeCloudType]) for enum values.
    /// }
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ExocomputeGetSupportedHealthChecksReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ExocomputeHealthChecks operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ExocomputeHealthChecks
    /// 
    /// $query = New-RscQueryMisc -Operation ExocomputeHealthChecks
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ExocomputeHealthChecksReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FailoverGroupWorkloads operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FailoverGroupWorkloads
    /// 
    /// $query = New-RscQueryMisc -Operation FailoverGroupWorkloads
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// 	# OPTIONAL
    /// 	objectStatus = @(
    /// 		$someFailoverGroupObjectStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.FailoverGroupObjectStatus]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	host = @(
    /// 		$someString
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FailoverGroupWorkloadConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeDatastore operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeDatastore
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeDatastore
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeDatastore
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeDatastores operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeDatastores
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeDatastores
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeDatastoreConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeEcho operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeEcho
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeEcho
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeEchoResponse
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeMounts operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeMounts
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeMounts
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// 	@{
    /// 		# OPTIONAL
    /// 		field = $someQueryFusionComputeMountsFilterField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.QueryFusionComputeMountsFilterField]) for enum values.
    /// 		# OPTIONAL
    /// 		text = @(
    /// 			$someString
    /// 		)
    ...
    /// )
    /// # OPTIONAL
    /// $query.Var.sortBy = $someFusionComputeMountsSortByField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.FusionComputeMountsSortByField]) for enum values.
    /// # OPTIONAL
    /// $query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeMountDetailConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeNetwork operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeNetwork
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeNetwork
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeNetwork
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeNetworks operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeNetworks
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeNetworks
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeNetworkConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeRecoverableDatastores operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeRecoverableDatastores
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeRecoverableDatastores
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the FusionComputeRecoverableNetworks operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeRecoverableNetworks
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeRecoverableNetworks
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the FusionComputeSite operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeSite
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeSite
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeSite
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeSites operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeSites
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeSites
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeSiteConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVirtualDisks operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVirtualDisks
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVirtualDisks
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.before = $someString
    /// # REQUIRED
    /// $query.Var.fusionComputeVirtualMachineFid = $someString
    /// # OPTIONAL
    /// $query.Var.filter = @(
    /// 	@{
    /// 		# OPTIONAL
    /// 		field = $someQueryFusionComputeVirtualDisksFilterField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.QueryFusionComputeVirtualDisksFilterField]) for enum values.
    /// 		# OPTIONAL
    /// 		text = @(
    /// 			$someString
    /// 		)
    ...
    /// )
    /// # OPTIONAL
    /// $query.Var.sortBy = $someFusionComputeVirtualDisksSortByField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.FusionComputeVirtualDisksSortByField]) for enum values.
    /// # OPTIONAL
    /// $query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeVirtualDiskConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVirtualMachine operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVirtualMachine
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVirtualMachine
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeVirtualMachine
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVirtualMachines operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVirtualMachines
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVirtualMachines
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeVirtualMachineConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVmRequestStatus operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVmRequestStatus
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVmRequestStatus
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVrm operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVrm
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVrm
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeVrm
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the FusionComputeVrms operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: FusionComputeVrms
    /// 
    /// $query = New-RscQueryMisc -Operation FusionComputeVrms
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: FusionComputeVrmConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// )
    /// # OPTIONAL
    /// $query.Var.syncedClustersFilter = $someString
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    ...
    ///
    /// <example>
    /// Runs the GitHubConnectionStatusSummary operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: GitHubConnectionStatusSummary
    /// 
    /// $query = New-RscQueryMisc -Operation GitHubConnectionStatusSummary
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GitHubConnectionStatusSummaryReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the GitHubOrganization operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: GitHubOrganization
    /// 
    /// $query = New-RscQueryMisc -Operation GitHubOrganization
    /// 
    /// # REQUIRED
    /// $query.Var.workloadId = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GithubOrganization
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the GitHubOrganizations operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: GitHubOrganizations
    /// 
    /// $query = New-RscQueryMisc -Operation GitHubOrganizations
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GithubOrganizationConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the GitHubRepositories operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: GitHubRepositories
    /// 
    /// $query = New-RscQueryMisc -Operation GitHubRepositories
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GithubRepositoryConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the GitHubRepository operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: GitHubRepository
    /// 
    /// $query = New-RscQueryMisc -Operation GitHubRepository
    /// 
    /// # REQUIRED
    /// $query.Var.workloadId = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GithubRepository
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the IdentityDataLocationsEncryptionInfo operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: IdentityDataLocationsEncryptionInfo
    /// 
    /// $query = New-RscQueryMisc -Operation IdentityDataLocationsEncryptionInfo
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.sortBy = @{
    /// 	# OPTIONAL
    /// 	field = $someIdentityDataLocationSortField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IdentityDataLocationSortField]) for enum values.
    /// 	# OPTIONAL
    /// 	sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
    /// }
    /// # OPTIONAL
    ...
    /// 	# OPTIONAL
    /// 	workloadTypes = @(
    /// 		$someIdentityWorkloadType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IdentityWorkloadType]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	encryptionTypes = @(
    /// 		$someEncryptionType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.EncryptionType]) for enum values.
    /// 	)
    /// }
    /// # OPTIONAL
    /// $query.Var.pagination = @{
    /// 	# OPTIONAL
    /// 	offset = $someInt
    /// 	# OPTIONAL
    /// 	limit = $someInt
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: IdentityDataLocationEncryptionInfoConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation IocFeedEntries
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the IpWhitelistEntries operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: IpWhitelistEntries
    /// 
    /// $query = New-RscQueryMisc -Operation IpWhitelistEntries
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.filter = @{
    /// 	# OPTIONAL
    /// 	ipCidrFilter = $someString
    /// 	# REQUIRED
    /// 	ipEntrySourceFilter = $someIpEntrySource # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IpEntrySource]) for enum values.
    /// }
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: IpInfoConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the IpWhitelistSettings operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: IpWhitelistSettings
    /// 
    /// $query = New-RscQueryMisc -Operation IpWhitelistSettings
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: IpWhitelistSettings
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the IsCloudDirectSharePathValid operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: IsCloudDirectSharePathValid
    /// 
    /// $query = New-RscQueryMisc -Operation IsCloudDirectSharePathValid
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: CloudDirectValidateSharePathResp
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the LacpConfigurations operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: LacpConfigurations
    /// 
    /// $query = New-RscQueryMisc -Operation LacpConfigurations
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: LacpPresenceCheckConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the LatestGpoSettings operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: LatestGpoSettings
    /// 
    /// $query = New-RscQueryMisc -Operation LatestGpoSettings
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    /// 	gpoFid = $someString
    /// 	# OPTIONAL
    /// 	shouldReturnXml = $someBoolean
    /// 	# OPTIONAL
    /// 	returnUniformJson = $someBoolean
    /// 	# OPTIONAL
    /// 	jsonDisplayFieldsOnly = $someBoolean
    /// }
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetLatestGpoSettingsRes
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ListAllUploadRecords operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ListAllUploadRecords
    /// 
    /// $query = New-RscQueryMisc -Operation ListAllUploadRecords
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ListAllUploadRecordsReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MicrosoftGroups operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MicrosoftGroups
    /// 
    /// $query = New-RscQueryMisc -Operation MicrosoftGroups
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// # REQUIRED
    /// $query.Var.microsoftObjectType = $someManagedObjectType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ManagedObjectType]) for enum values.
    /// # REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MicrosoftGroupConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MultiHopUpgradePath operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MultiHopUpgradePath
    /// 
    /// $query = New-RscQueryMisc -Operation MultiHopUpgradePath
    /// 
    /// # REQUIRED
    /// $query.Var.clusterUuid = $someString
    /// # OPTIONAL
    ...
    /// # OPTIONAL
    /// $query.Var.shouldIncludeFullVersionName = $someBoolean
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MultiHopUpgradePathReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MysqlDatabase operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MysqlDatabase
    /// 
    /// $query = New-RscQueryMisc -Operation MysqlDatabase
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MysqldbDatabase
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MysqlDatabases operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MysqlDatabases
    /// 
    /// $query = New-RscQueryMisc -Operation MysqlDatabases
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MysqldbDatabaseConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MysqlInstance operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MysqlInstance
    /// 
    /// $query = New-RscQueryMisc -Operation MysqlInstance
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MysqldbInstance
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the MysqlInstanceLiveMounts operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MysqlInstanceLiveMounts
    /// 
    /// $query = New-RscQueryMisc -Operation MysqlInstanceLiveMounts
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the MysqlInstances operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: MysqlInstances
    /// 
    /// $query = New-RscQueryMisc -Operation MysqlInstances
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: MysqldbInstanceConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the NodesToRemoveByCount operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: NodesToRemoveByCount
    /// 
    /// $query = New-RscQueryMisc -Operation NodesToRemoveByCount
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.clusterUuid = $someString
    /// # REQUIRED
    /// $query.Var.nodeCount = $someInt
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: NodeToRemoveByCountConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// # OPTIONAL
    /// $query.Var.mfaStatusFilter = $someMfaStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.MfaStatus]) for enum values.
    /// # OPTIONAL
    /// $query.Var.mfaStatusesFilter = @(
    /// 	$someMfaStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.MfaStatus]) for enum values.
    /// )
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the PausedObjects operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: PausedObjects
    /// 
    /// $query = New-RscQueryMisc -Operation PausedObjects
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.sortBy = @{
    /// 	# OPTIONAL
    /// 	field = $someGetObjectPauseListSortByField # Call [Enum]::GetValues([RubrikSecurityCloud.Types.GetObjectPauseListSortByField]) for enum values.
    /// 	# OPTIONAL
    /// 	order = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
    /// }
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetPausedObjectResConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// # OPTIONAL
    /// $query.Var.dataCategoryFilter = $someDataCategoryFilter # Call [Enum]::GetValues([RubrikSecurityCloud.Types.DataCategoryFilter]) for enum values.
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    ...
    ///
    /// <example>
    /// Runs the PolicyViolations operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: PolicyViolations
    /// 
    /// $query = New-RscQueryMisc -Operation PolicyViolations
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// }
    /// # OPTIONAL
    /// $query.Var.includeResourceCounts = $someBoolean
    /// # OPTIONAL
    ...
    /// 	)
    /// 	# OPTIONAL
    /// 	privilegeTypesFilter = @(
    /// 		$somePrivilegeType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.PrivilegeType]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	idpTypesFilter = @(
    /// 		$someIdpType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IdpType]) for enum values.
    ...
    /// 	)
    /// 	# OPTIONAL
    /// 	featureFilter = $somePrincipalFeature # Call [Enum]::GetValues([RubrikSecurityCloud.Types.PrincipalFeature]) for enum values.
    /// 	# OPTIONAL
    /// 	statusFilter = $somePrincipalStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.PrincipalStatus]) for enum values.
    /// 	# OPTIONAL
    /// 	entityIds = @(
    /// 		$someString
    /// 	)
    ...
    /// 	)
    /// 	# OPTIONAL
    /// 	directParentOfPrincipal = $someString
    /// 	# OPTIONAL
    /// 	accessTypeFilter = @(
    /// 		$someAccessVia # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AccessVia]) for enum values.
    /// 	)
    ...
    /// 		$someIdentityStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IdentityStatus]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	nativeTypes = @(
    /// 		$someNativeType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.NativeType]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	newlyAdded = $someBoolean
    /// 	# OPTIONAL
    /// 	entraMfaStrength = @(
    /// 		$someMfaStrength # Call [Enum]::GetValues([RubrikSecurityCloud.Types.MfaStrength]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	linkedPrincipalId = $someString
    /// 	# OPTIONAL
    /// 	ownerPrincipalIds = @(
    /// 		$someString
    /// 	)
    /// 	# OPTIONAL
    /// 	includeDeletedPrincipals = $someBoolean
    /// 	# OPTIONAL
    /// 	gpoStatusFilter = @(
    /// 		$someGpoStatusEnum # Call [Enum]::GetValues([RubrikSecurityCloud.Types.GpoStatusEnum]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	gpoLinkingStatusFilter = @(
    /// 		$someGPOLinkingStatusEnum # Call [Enum]::GetValues([RubrikSecurityCloud.Types.GPOLinkingStatusEnum]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	departments = @(
    /// 		$someString
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: PolicyViolationConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation PostgreSQLDatabase
    /// 
    /// # REQUIRED
    /// $query.Var.fid = $someString
    /// 
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation PostgreSQLDatabases
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the ProtectionSummaryV2 operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ProtectionSummaryV2
    /// 
    /// $query = New-RscQueryMisc -Operation ProtectionSummaryV2
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ProtectionSummaryV2
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: Recoveries
    /// 
    /// $query = New-RscQueryMisc -Operation Recoveries
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $query.Var.before = $someString
    /// # OPTIONAL
    /// $query.Var.recoveryIds = @(
    /// 	$someString
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryType = @(
    /// 	$someRecoveryType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.RecoveryType]) for enum values.
    /// )
    /// # OPTIONAL
    /// $query.Var.endTime = $someDateTime
    /// # OPTIONAL
    ...
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryStatuses = @(
    /// 	$someRecoveryStatus # Call [Enum]::GetValues([RubrikSecurityCloud.Types.RecoveryStatus]) for enum values.
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryOutcomes = @(
    /// 	$someRecoveryOutcome # Call [Enum]::GetValues([RubrikSecurityCloud.Types.RecoveryOutcome]) for enum values.
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryNames = @(
    /// 	$someString
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryTriggeredFrom = @(
    /// 	$someRecoveryTriggeredFrom # Call [Enum]::GetValues([RubrikSecurityCloud.Types.RecoveryTriggeredFrom]) for enum values.
    /// )
    /// # OPTIONAL
    /// $query.Var.recoveryPlanIds = @(
    /// 	$someString
    /// )
    /// # OPTIONAL
    /// $query.Var.workloadTypeFilter = $someManagedObjectType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ManagedObjectType]) for enum values.
    /// # OPTIONAL
    /// $query.Var.recoveryNameSubstring = $someString
    /// # OPTIONAL
    /// $query.Var.sortParam = @{
    /// 	# OPTIONAL
    /// 	sortType = $someRecoverySortType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.RecoverySortType]) for enum values.
    /// 	# OPTIONAL
    /// 	sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
    /// }
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: RecoveryConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ResetTypeOfRemovalJob operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ResetTypeOfRemovalJob
    /// 
    /// $query = New-RscQueryMisc -Operation ResetTypeOfRemovalJob
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation SaasAppOrganizations
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the SaasWorkloadMetadataTypes operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SaasWorkloadMetadataTypes
    /// 
    /// $query = New-RscQueryMisc -Operation SaasWorkloadMetadataTypes
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SaasWorkloadMetadataTypesReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation SalesforceObjects
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the ScriptsForManualPermissionValidation operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ScriptsForManualPermissionValidation
    /// 
    /// $query = New-RscQueryMisc -Operation ScriptsForManualPermissionValidation
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetScriptsForManualPermissionValidationReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SearchCloudDirectWorkload operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SearchCloudDirectWorkload
    /// 
    /// $query = New-RscQueryMisc -Operation SearchCloudDirectWorkload
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// # OPTIONAL
    /// $query.Var.versionLimit = $someInt
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SearchCloudDirectWorkloadEntryConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SelfServeRollingUpgrade operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SelfServeRollingUpgrade
    /// 
    /// $query = New-RscQueryMisc -Operation SelfServeRollingUpgrade
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetSelfServeRollingUpgradeReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SigninLogDetails operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SigninLogDetails
    /// 
    /// $query = New-RscQueryMisc -Operation SigninLogDetails
    /// 
    /// # REQUIRED
    /// $query.Var.eventId = $someString
    /// # OPTIONAL
    /// $query.Var.eventDate = $someDateTime
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SigninLogDetails
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SigninLogFilterValues operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SigninLogFilterValues
    /// 
    /// $query = New-RscQueryMisc -Operation SigninLogFilterValues
    /// 
    /// # REQUIRED
    /// $query.Var.filterType = $someSigninLogFilterType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SigninLogFilterType]) for enum values.
    /// # REQUIRED
    /// $query.Var.timeRange = @{
    /// 	# REQUIRED
    /// 	start = $someDateTime
    ...
    /// 	# OPTIONAL
    /// 	results = @(
    /// 		$someSigninLogResult # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SigninLogResult]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	tenantIds = @(
    /// 		$someString
    ...
    /// 	# OPTIONAL
    /// 	riskLevels = @(
    /// 		$someSigninLogRiskLevel # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SigninLogRiskLevel]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	applicationNames = @(
    /// 		$someString
    ...
    /// 	# OPTIONAL
    /// 	failureCategories = @(
    /// 		$someSigninLogFailureCategory # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SigninLogFailureCategory]) for enum values.
    /// 	)
    /// 	# OPTIONAL
    /// 	eventIds = @(
    /// 		$someString
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SigninLogFilterValuesResponse
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SigninLogs
    /// 
    /// $query = New-RscQueryMisc -Operation SigninLogs
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SigninLogSummaryConnection
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SqlServerSetupScriptsBulk operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SqlServerSetupScriptsBulk
    /// 
    /// $query = New-RscQueryMisc -Operation SqlServerSetupScriptsBulk
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetSqlServerSetupScriptsReplyBulk
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the SsmDocumentForEc2 operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SsmDocumentForEc2
    /// 
    /// $query = New-RscQueryMisc -Operation SsmDocumentForEc2
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: SsmDocumentForEc2Reply
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: SupportCaseComments
    /// 
    ...
    /// 	# OPTIONAL
    /// 	hasDownloadedSnapshots = $someBoolean
    /// 	# OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the UpgradePathEligibility operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: UpgradePathEligibility
    /// 
    /// $query = New-RscQueryMisc -Operation UpgradePathEligibility
    /// 
    /// # REQUIRED
    /// $query.Var.clusterUuid = $someString
    /// # REQUIRED
    /// $query.Var.targetVersion = $someString
    /// # REQUIRED
    /// $query.Var.operation = $someString
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: UpgradePathEligibilityReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 	)
    /// 	# OPTIONAL
    /// 	lockoutReasonsFilter = @(
    /// 		$someLockMethod # Call [Enum]::GetValues([RubrikSecurityCloud.Types.LockMethod]) for enum values.
    /// 	)
    /// }
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the ValidRegionsForDynamoDbRecovery operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidRegionsForDynamoDbRecovery
    /// 
    /// $query = New-RscQueryMisc -Operation ValidRegionsForDynamoDbRecovery
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    /// 	targetAwsAccountId = $someString
    /// 	# OPTIONAL
    /// 	archivalLocationAwsAccountId = $someString
    /// 	# REQUIRED
    /// 	sourceAwsAccountId = $someString
    /// }
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetValidRegionsForDynamoDbRecoveryReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ValidateAdForestTransition operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidateAdForestTransition
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateAdForestTransition
    /// 
    /// # No variables for this query.
    /// 
    /// # Execute the query
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ValidateAdForestTransition
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateIocEntry
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// 	iocDetail = @{
    /// 		# REQUIRED
    /// 		yaraVersion = $someYaraVersion # Call [Enum]::GetValues([RubrikSecurityCloud.Types.YaraVersion]) for enum values.
    /// 	}
    /// }
    /// 
    /// # Execute the query
    ...
    ///
    /// <example>
    /// Runs the ValidateOutpostAccountNetwork operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidateOutpostAccountNetwork
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateOutpostAccountNetwork
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    /// 	outpostAccountId = $someString
    /// 	# OPTIONAL
    /// 	region = $someString
    /// }
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ValidateOutpostAccountNetworkReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ValidateRdsExportExocomputePort operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidateRdsExportExocomputePort
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateRdsExportExocomputePort
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 	# REQUIRED
    /// 	sourceSnapshotId = $someString
    /// 	# OPTIONAL
    /// 	archivedSnapshotId = $someString
    /// 	# REQUIRED
    /// 	destinationRegion = $someString
    /// 	# REQUIRED
    /// 	targetAwsNativeAccountId = $someString
    /// 	# REQUIRED
    /// 	port = $someInt64
    /// }
    /// 
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ValidateRdsExportExocomputePortReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ValidateRoleName operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidateRoleName
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateRoleName
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ValidateRoleNameReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    ///
    /// <example>
    /// Runs the ValidateScriptOutputForManualPermissionValidation operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: ValidateScriptOutputForManualPermissionValidation
    /// 
    /// $query = New-RscQueryMisc -Operation ValidateScriptOutputForManualPermissionValidation
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# OPTIONAL
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: ValidateScriptOutputForManualPermissionValidationReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation VcdOrgs
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation VcdTopLevelDescendants
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    /// 
    /// $query = New-RscQueryMisc -Operation VcdVapps
    /// 
    /// # OPTIONAL
    /// $query.Var.first = $someInt
    /// # OPTIONAL
    ...
    ///
    /// <example>
    /// Runs the WorkloadResourceSpecs operation
    /// of the 'Miscellaneous' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Misc
    /// # API Operation: WorkloadResourceSpecs
    /// 
    ...
    public class New_RscQueryMisc : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "BrowseTeamsDrive":
                        ...
                        break;
                    case "CapSettingsData":
                        this.ProcessRecord_CapSettingsData();
                        break;
                    ...
                    case "CheckLatestVersionMgmtAppExists":
                        ...
                        break;
                    case "CloudDirectCheckSharePath":
                        this.ProcessRecord_CloudDirectCheckSharePath();
                        break;
                    case "CloudDirectGlobalSearch":
                        this.ProcessRecord_CloudDirectGlobalSearch();
                        break;
                    case "CloudDirectNasBucket":
                        this.ProcessRecord_CloudDirectNasBucket();
                        break;
                    case "CloudDirectNasBuckets":
                        this.ProcessRecord_CloudDirectNasBuckets();
                        break;
                    ...
                    case "CloudDirectShares":
                        ...
                        break;
                    case "CloudDirectSiteSettings":
                        this.ProcessRecord_CloudDirectSiteSettings();
                        break;
                    ...
                    case "ConfiguredGroupMembers":
                        ...
                        break;
                    case "CoordinatorLabels":
                        this.ProcessRecord_CoordinatorLabels();
                        break;
                    case "Crawl":
                    ...
                    case "CrossAccountPairs":
                        ...
                        break;
                    case "CrowdStrikeIngestionStatus":
                        this.ProcessRecord_CrowdStrikeIngestionStatus();
                        break;
                    ...
                    case "DashboardSummary":
                        ...
                        break;
                    case "DataPreview":
                        this.ProcessRecord_DataPreview();
                        break;
                    case "DatagovSecDesc":
                    ...
                    case "DeploymentVersion":
                        ...
                        break;
                    case "DevOpsBackupJobInformation":
                        this.ProcessRecord_DevOpsBackupJobInformation();
                        break;
                    case "DevOpsProtectedObjectCountSummary":
                        this.ProcessRecord_DevOpsProtectedObjectCountSummary();
                        break;
                    ...
                    case "EventDigests":
                        ...
                        break;
                    case "ExocomputeGetSupportedHealthChecks":
                        this.ProcessRecord_ExocomputeGetSupportedHealthChecks();
                        break;
                    ...
                    case "FailedRestoreItemsInfo":
                        ...
                        break;
                    case "FailoverGroupWorkloads":
                        this.ProcessRecord_FailoverGroupWorkloads();
                        break;
                    ...
                    case "FusionComputeDatastore":
                        this.ProcessRecord_FusionComputeDatastore();
                        break;
                    case "FusionComputeDatastores":
                        this.ProcessRecord_FusionComputeDatastores();
                        break;
                    case "FusionComputeEcho":
                        this.ProcessRecord_FusionComputeEcho();
                        break;
                    case "FusionComputeMounts":
                        this.ProcessRecord_FusionComputeMounts();
                        break;
                    case "FusionComputeNetwork":
                        this.ProcessRecord_FusionComputeNetwork();
                        break;
                    case "FusionComputeNetworks":
                        this.ProcessRecord_FusionComputeNetworks();
                        break;
                    case "FusionComputeRecoverableDatastores":
                        this.ProcessRecord_FusionComputeRecoverableDatastores();
                        break;
                    case "FusionComputeRecoverableNetworks":
                        this.ProcessRecord_FusionComputeRecoverableNetworks();
                        break;
                    case "FusionComputeSite":
                        this.ProcessRecord_FusionComputeSite();
                        break;
                    case "FusionComputeSites":
                        this.ProcessRecord_FusionComputeSites();
                        break;
                    case "FusionComputeVirtualDisks":
                        this.ProcessRecord_FusionComputeVirtualDisks();
                        break;
                    case "FusionComputeVirtualMachine":
                        this.ProcessRecord_FusionComputeVirtualMachine();
                        break;
                    case "FusionComputeVirtualMachines":
                        this.ProcessRecord_FusionComputeVirtualMachines();
                        break;
                    case "FusionComputeVmRequestStatus":
                        this.ProcessRecord_FusionComputeVmRequestStatus();
                        break;
                    case "FusionComputeVrm":
                        this.ProcessRecord_FusionComputeVrm();
                        break;
                    case "FusionComputeVrms":
                        this.ProcessRecord_FusionComputeVrms();
                        break;
                    ...
                    case "GetUserDownloads":
                        ...
                        break;
                    case "GitHubConnectionStatusSummary":
                        this.ProcessRecord_GitHubConnectionStatusSummary();
                        break;
                    case "GitHubOrganization":
                        this.ProcessRecord_GitHubOrganization();
                        break;
                    case "GitHubOrganizations":
                        this.ProcessRecord_GitHubOrganizations();
                        break;
                    case "GitHubRepositories":
                        this.ProcessRecord_GitHubRepositories();
                        break;
                    case "GitHubRepository":
                        this.ProcessRecord_GitHubRepository();
                        break;
                    ...
                    case "HierarchyObjects":
                        ...
                        break;
                    case "IdentityDataLocationsEncryptionInfo":
                        this.ProcessRecord_IdentityDataLocationsEncryptionInfo();
                        break;
                    ...
                    case "IpWhitelist":
                        ...
                        break;
                    case "IpWhitelistEntries":
                        this.ProcessRecord_IpWhitelistEntries();
                        break;
                    case "IpWhitelistSettings":
                        this.ProcessRecord_IpWhitelistSettings();
                        break;
                    case "IsCloudDirectSharePathValid":
                        this.ProcessRecord_IsCloudDirectSharePathValid();
                        break;
                    case "IsIpmiEnabled":
                    ...
                    case "KnowledgeBaseArticle":
                        ...
                        break;
                    case "LacpConfigurations":
                        this.ProcessRecord_LacpConfigurations();
                        break;
                    case "LambdaSettings":
                        this.ProcessRecord_LambdaSettings();
                        break;
                    case "LatestGpoSettings":
                        this.ProcessRecord_LatestGpoSettings();
                        break;
                    case "LicensedProducts":
                        this.ProcessRecord_LicensedProducts();
                        break;
                    case "ListAllUploadRecords":
                        this.ProcessRecord_ListAllUploadRecords();
                        break;
                    case "LockoutConfig":
                    ...
                    case "MfaSetting":
                        ...
                        break;
                    case "MicrosoftGroups":
                        this.ProcessRecord_MicrosoftGroups();
                        break;
                    case "MicrosoftSites":
                    ...
                    case "MipLabels":
                        ...
                        break;
                    case "MultiHopUpgradePath":
                        this.ProcessRecord_MultiHopUpgradePath();
                        break;
                    case "MysqlDatabase":
                        this.ProcessRecord_MysqlDatabase();
                        break;
                    case "MysqlDatabases":
                        this.ProcessRecord_MysqlDatabases();
                        break;
                    case "MysqlInstance":
                        this.ProcessRecord_MysqlInstance();
                        break;
                    case "MysqlInstanceLiveMounts":
                        this.ProcessRecord_MysqlInstanceLiveMounts();
                        break;
                    case "MysqlInstances":
                        this.ProcessRecord_MysqlInstances();
                        break;
                    ...
                    case "PasskeyInfo":
                        ...
                        break;
                    case "PausedObjects":
                        this.ProcessRecord_PausedObjects();
                        break;
                    case "PendingAction":
                    ...
                    case "ProtectedVolumesCount":
                        ...
                        break;
                    case "ProtectionSummaryV2":
                        this.ProcessRecord_ProtectionSummaryV2();
                        break;
                    ...
                    case "SaasAppOrganizations":
                        ...
                        break;
                    case "SaasWorkloadMetadataTypes":
                        this.ProcessRecord_SaasWorkloadMetadataTypes();
                        break;
                    case "SalesforceObjects":
                        this.ProcessRecord_SalesforceObjects();
                        break;
                    case "ScriptsForManualPermissionValidation":
                        this.ProcessRecord_ScriptsForManualPermissionValidation();
                        break;
                    case "SearchCloudDirectWorkload":
                        this.ProcessRecord_SearchCloudDirectWorkload();
                        break;
                    case "SearchFileByPrefix":
                        this.ProcessRecord_SearchFileByPrefix();
                        break;
                    case "SelfServeRollingUpgrade":
                        this.ProcessRecord_SelfServeRollingUpgrade();
                        break;
                    case "SigninLogDetails":
                        this.ProcessRecord_SigninLogDetails();
                        break;
                    case "SigninLogFilterValues":
                        this.ProcessRecord_SigninLogFilterValues();
                        break;
                    case "SigninLogs":
                        this.ProcessRecord_SigninLogs();
                        break;
                    case "SnoozedDirectories":
                        this.ProcessRecord_SnoozedDirectories();
                        break;
                    case "SqlServerSetupScriptsBulk":
                        this.ProcessRecord_SqlServerSetupScriptsBulk();
                        break;
                    case "SsmDocumentForEc2":
                        this.ProcessRecord_SsmDocumentForEc2();
                        break;
                    ...
                    case "UnmanagedObjectsSupportedTypes":
                        ...
                        break;
                    case "UpgradePathEligibility":
                        this.ProcessRecord_UpgradePathEligibility();
                        break;
                    case "UpgradeStatus":
                    ...
                    case "UsersOnAccountList":
                        ...
                        break;
                    case "ValidRegionsForDynamoDbRecovery":
                        this.ProcessRecord_ValidRegionsForDynamoDbRecovery();
                        break;
                    case "ValidateAdForestTransition":
                        this.ProcessRecord_ValidateAdForestTransition();
                        break;
                    ...
                    case "ValidateOrgName":
                        ...
                        break;
                    case "ValidateOutpostAccountNetwork":
                        this.ProcessRecord_ValidateOutpostAccountNetwork();
                        break;
                    case "ValidateRdsExportExocomputePort":
                        this.ProcessRecord_ValidateRdsExportExocomputePort();
                        break;
                    case "ValidateRoleName":
                        this.ProcessRecord_ValidateRoleName();
                        break;
                    case "ValidateScriptOutputForManualPermissionValidation":
                        this.ProcessRecord_ValidateScriptOutputForManualPermissionValidation();
                        break;
                    case "VcdOrgs":
        ...
        // This parameter set invokes a single graphql operation:
        // capSettingsData.
        internal void ProcessRecord_CapSettingsData()
        {
            this._logger.name += " -CapSettingsData";
            // Create new graphql operation capSettingsData
            InitQueryCapSettingsData();
        }

        // This parameter set invokes a single graphql operation:
        // ccProvisionMetadata.
        internal void ProcessRecord_CcProvisionMetadata()
        {
            this._logger.name += " -CcProvisionMetadata";
            // Create new graphql operation ccProvisionMetadata
            InitQueryCcProvisionMetadata();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // cloudDirectCheckSharePath.
        internal void ProcessRecord_CloudDirectCheckSharePath()
        {
            this._logger.name += " -CloudDirectCheckSharePath";
            // Create new graphql operation cloudDirectCheckSharePath
            InitQueryCloudDirectCheckSharePath();
        }

        // This parameter set invokes a single graphql operation:
        // cloudDirectGlobalSearch.
        internal void ProcessRecord_CloudDirectGlobalSearch()
        {
            this._logger.name += " -CloudDirectGlobalSearch";
            // Create new graphql operation cloudDirectGlobalSearch
            InitQueryCloudDirectGlobalSearch();
        }

        // This parameter set invokes a single graphql operation:
        // cloudDirectNasBucket.
        internal void ProcessRecord_CloudDirectNasBucket()
        {
            this._logger.name += " -CloudDirectNasBucket";
            // Create new graphql operation cloudDirectNasBucket
            InitQueryCloudDirectNasBucket();
        }

        // This parameter set invokes a single graphql operation:
        // cloudDirectNasBuckets.
        internal void ProcessRecord_CloudDirectNasBuckets()
        {
            this._logger.name += " -CloudDirectNasBuckets";
            // Create new graphql operation cloudDirectNasBuckets
            InitQueryCloudDirectNasBuckets();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // cloudDirectSiteSettings.
        internal void ProcessRecord_CloudDirectSiteSettings()
        {
            this._logger.name += " -CloudDirectSiteSettings";
            // Create new graphql operation cloudDirectSiteSettings
            InitQueryCloudDirectSiteSettings();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // coordinatorLabels.
        internal void ProcessRecord_CoordinatorLabels()
        {
            this._logger.name += " -CoordinatorLabels";
            // Create new graphql operation coordinatorLabels
            InitQueryCoordinatorLabels();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // crowdStrikeIngestionStatus.
        internal void ProcessRecord_CrowdStrikeIngestionStatus()
        {
            this._logger.name += " -CrowdStrikeIngestionStatus";
            // Create new graphql operation crowdStrikeIngestionStatus
            InitQueryCrowdStrikeIngestionStatus();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // dataPreview.
        internal void ProcessRecord_DataPreview()
        {
            this._logger.name += " -DataPreview";
            // Create new graphql operation dataPreview
            InitQueryDataPreview();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // devOpsBackupJobInformation.
        internal void ProcessRecord_DevOpsBackupJobInformation()
        {
            this._logger.name += " -DevOpsBackupJobInformation";
            // Create new graphql operation devOpsBackupJobInformation
            InitQueryDevOpsBackupJobInformation();
        }

        // This parameter set invokes a single graphql operation:
        // devOpsProtectedObjectCountSummary.
        internal void ProcessRecord_DevOpsProtectedObjectCountSummary()
        {
            this._logger.name += " -DevOpsProtectedObjectCountSummary";
            // Create new graphql operation devOpsProtectedObjectCountSummary
            InitQueryDevOpsProtectedObjectCountSummary();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // exocomputeGetSupportedHealthChecks.
        internal void ProcessRecord_ExocomputeGetSupportedHealthChecks()
        {
            this._logger.name += " -ExocomputeGetSupportedHealthChecks";
            // Create new graphql operation exocomputeGetSupportedHealthChecks
            InitQueryExocomputeGetSupportedHealthChecks();
        }

        // This parameter set invokes a single graphql operation:
        // exocomputeHealthChecks.
        internal void ProcessRecord_ExocomputeHealthChecks()
        {
        ...
        // This parameter set invokes a single graphql operation:
        // failoverGroupWorkloads.
        internal void ProcessRecord_FailoverGroupWorkloads()
        {
            this._logger.name += " -FailoverGroupWorkloads";
            // Create new graphql operation failoverGroupWorkloads
            InitQueryFailoverGroupWorkloads();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // fusionComputeDatastore.
        internal void ProcessRecord_FusionComputeDatastore()
        {
            this._logger.name += " -FusionComputeDatastore";
            // Create new graphql operation fusionComputeDatastore
            InitQueryFusionComputeDatastore();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeDatastores.
        internal void ProcessRecord_FusionComputeDatastores()
        {
            this._logger.name += " -FusionComputeDatastores";
            // Create new graphql operation fusionComputeDatastores
            InitQueryFusionComputeDatastores();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeEcho.
        internal void ProcessRecord_FusionComputeEcho()
        {
            this._logger.name += " -FusionComputeEcho";
            // Create new graphql operation fusionComputeEcho
            InitQueryFusionComputeEcho();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeMounts.
        internal void ProcessRecord_FusionComputeMounts()
        {
            this._logger.name += " -FusionComputeMounts";
            // Create new graphql operation fusionComputeMounts
            InitQueryFusionComputeMounts();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeNetwork.
        internal void ProcessRecord_FusionComputeNetwork()
        {
            this._logger.name += " -FusionComputeNetwork";
            // Create new graphql operation fusionComputeNetwork
            InitQueryFusionComputeNetwork();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeNetworks.
        internal void ProcessRecord_FusionComputeNetworks()
        {
            this._logger.name += " -FusionComputeNetworks";
            // Create new graphql operation fusionComputeNetworks
            InitQueryFusionComputeNetworks();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeRecoverableDatastores.
        internal void ProcessRecord_FusionComputeRecoverableDatastores()
        {
            this._logger.name += " -FusionComputeRecoverableDatastores";
            // Create new graphql operation fusionComputeRecoverableDatastores
            InitQueryFusionComputeRecoverableDatastores();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeRecoverableNetworks.
        internal void ProcessRecord_FusionComputeRecoverableNetworks()
        {
            this._logger.name += " -FusionComputeRecoverableNetworks";
            // Create new graphql operation fusionComputeRecoverableNetworks
            InitQueryFusionComputeRecoverableNetworks();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeSite.
        internal void ProcessRecord_FusionComputeSite()
        {
            this._logger.name += " -FusionComputeSite";
            // Create new graphql operation fusionComputeSite
            InitQueryFusionComputeSite();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeSites.
        internal void ProcessRecord_FusionComputeSites()
        {
            this._logger.name += " -FusionComputeSites";
            // Create new graphql operation fusionComputeSites
            InitQueryFusionComputeSites();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVirtualDisks.
        internal void ProcessRecord_FusionComputeVirtualDisks()
        {
            this._logger.name += " -FusionComputeVirtualDisks";
            // Create new graphql operation fusionComputeVirtualDisks
            InitQueryFusionComputeVirtualDisks();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVirtualMachine.
        internal void ProcessRecord_FusionComputeVirtualMachine()
        {
            this._logger.name += " -FusionComputeVirtualMachine";
            // Create new graphql operation fusionComputeVirtualMachine
            InitQueryFusionComputeVirtualMachine();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVirtualMachines.
        internal void ProcessRecord_FusionComputeVirtualMachines()
        {
            this._logger.name += " -FusionComputeVirtualMachines";
            // Create new graphql operation fusionComputeVirtualMachines
            InitQueryFusionComputeVirtualMachines();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVmRequestStatus.
        internal void ProcessRecord_FusionComputeVmRequestStatus()
        {
            this._logger.name += " -FusionComputeVmRequestStatus";
            // Create new graphql operation fusionComputeVmRequestStatus
            InitQueryFusionComputeVmRequestStatus();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVrm.
        internal void ProcessRecord_FusionComputeVrm()
        {
            this._logger.name += " -FusionComputeVrm";
            // Create new graphql operation fusionComputeVrm
            InitQueryFusionComputeVrm();
        }

        // This parameter set invokes a single graphql operation:
        // fusionComputeVrms.
        internal void ProcessRecord_FusionComputeVrms()
        {
            this._logger.name += " -FusionComputeVrms";
            // Create new graphql operation fusionComputeVrms
            InitQueryFusionComputeVrms();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // gitHubConnectionStatusSummary.
        internal void ProcessRecord_GitHubConnectionStatusSummary()
        {
            this._logger.name += " -GitHubConnectionStatusSummary";
            // Create new graphql operation gitHubConnectionStatusSummary
            InitQueryGitHubConnectionStatusSummary();
        }

        // This parameter set invokes a single graphql operation:
        // gitHubOrganization.
        internal void ProcessRecord_GitHubOrganization()
        {
            this._logger.name += " -GitHubOrganization";
            // Create new graphql operation gitHubOrganization
            InitQueryGitHubOrganization();
        }

        // This parameter set invokes a single graphql operation:
        // gitHubOrganizations.
        internal void ProcessRecord_GitHubOrganizations()
        {
            this._logger.name += " -GitHubOrganizations";
            // Create new graphql operation gitHubOrganizations
            InitQueryGitHubOrganizations();
        }

        // This parameter set invokes a single graphql operation:
        // gitHubRepositories.
        internal void ProcessRecord_GitHubRepositories()
        {
            this._logger.name += " -GitHubRepositories";
            // Create new graphql operation gitHubRepositories
            InitQueryGitHubRepositories();
        }

        // This parameter set invokes a single graphql operation:
        // gitHubRepository.
        internal void ProcessRecord_GitHubRepository()
        {
            this._logger.name += " -GitHubRepository";
            // Create new graphql operation gitHubRepository
            InitQueryGitHubRepository();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // identityDataLocationsEncryptionInfo.
        internal void ProcessRecord_IdentityDataLocationsEncryptionInfo()
        {
            this._logger.name += " -IdentityDataLocationsEncryptionInfo";
            // Create new graphql operation identityDataLocationsEncryptionInfo
            InitQueryIdentityDataLocationsEncryptionInfo();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // ipWhitelistEntries.
        internal void ProcessRecord_IpWhitelistEntries()
        {
            this._logger.name += " -IpWhitelistEntries";
            // Create new graphql operation ipWhitelistEntries
            InitQueryIpWhitelistEntries();
        }

        // This parameter set invokes a single graphql operation:
        // ipWhitelistSettings.
        internal void ProcessRecord_IpWhitelistSettings()
        {
            this._logger.name += " -IpWhitelistSettings";
            // Create new graphql operation ipWhitelistSettings
            InitQueryIpWhitelistSettings();
        }

        // This parameter set invokes a single graphql operation:
        // isCloudDirectSharePathValid.
        internal void ProcessRecord_IsCloudDirectSharePathValid()
        {
            this._logger.name += " -IsCloudDirectSharePathValid";
            // Create new graphql operation isCloudDirectSharePathValid
            InitQueryIsCloudDirectSharePathValid();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // lacpConfigurations.
        internal void ProcessRecord_LacpConfigurations()
        {
            this._logger.name += " -LacpConfigurations";
            // Create new graphql operation lacpConfigurations
            InitQueryLacpConfigurations();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // latestGpoSettings.
        internal void ProcessRecord_LatestGpoSettings()
        {
            this._logger.name += " -LatestGpoSettings";
            // Create new graphql operation latestGpoSettings
            InitQueryLatestGpoSettings();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // listAllUploadRecords.
        internal void ProcessRecord_ListAllUploadRecords()
        {
            this._logger.name += " -ListAllUploadRecords";
            // Create new graphql operation listAllUploadRecords
            InitQueryListAllUploadRecords();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // microsoftGroups.
        internal void ProcessRecord_MicrosoftGroups()
        {
            this._logger.name += " -MicrosoftGroups";
            // Create new graphql operation microsoftGroups
            InitQueryMicrosoftGroups();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // multiHopUpgradePath.
        internal void ProcessRecord_MultiHopUpgradePath()
        {
            this._logger.name += " -MultiHopUpgradePath";
            // Create new graphql operation multiHopUpgradePath
            InitQueryMultiHopUpgradePath();
        }

        // This parameter set invokes a single graphql operation:
        // mysqlDatabase.
        internal void ProcessRecord_MysqlDatabase()
        {
            this._logger.name += " -MysqlDatabase";
            // Create new graphql operation mysqlDatabase
            InitQueryMysqlDatabase();
        }

        // This parameter set invokes a single graphql operation:
        // mysqlDatabases.
        internal void ProcessRecord_MysqlDatabases()
        {
            this._logger.name += " -MysqlDatabases";
            // Create new graphql operation mysqlDatabases
            InitQueryMysqlDatabases();
        }

        // This parameter set invokes a single graphql operation:
        // mysqlInstance.
        internal void ProcessRecord_MysqlInstance()
        {
            this._logger.name += " -MysqlInstance";
            // Create new graphql operation mysqlInstance
            InitQueryMysqlInstance();
        }

        // This parameter set invokes a single graphql operation:
        // mysqlInstanceLiveMounts.
        internal void ProcessRecord_MysqlInstanceLiveMounts()
        {
            this._logger.name += " -MysqlInstanceLiveMounts";
            // Create new graphql operation mysqlInstanceLiveMounts
            InitQueryMysqlInstanceLiveMounts();
        }

        // This parameter set invokes a single graphql operation:
        // mysqlInstances.
        internal void ProcessRecord_MysqlInstances()
        {
            this._logger.name += " -MysqlInstances";
            // Create new graphql operation mysqlInstances
            InitQueryMysqlInstances();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // nodesToRemoveByCount.
        internal void ProcessRecord_NodesToRemoveByCount()
        {
            this._logger.name += " -NodesToRemoveByCount";
            // Create new graphql operation nodesToRemoveByCount
            InitQueryNodesToRemoveByCount();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // pausedObjects.
        internal void ProcessRecord_PausedObjects()
        {
            this._logger.name += " -PausedObjects";
            // Create new graphql operation pausedObjects
            InitQueryPausedObjects();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // protectionSummaryV2.
        internal void ProcessRecord_ProtectionSummaryV2()
        {
            this._logger.name += " -ProtectionSummaryV2";
            // Create new graphql operation protectionSummaryV2
            InitQueryProtectionSummaryV2();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // recoveries.
        internal void ProcessRecord_Recoveries()
        {
            this._logger.name += " -Recoveries";
            // Create new graphql operation recoveries
            InitQueryRecoveries();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // resetTypeOfRemovalJob.
        internal void ProcessRecord_ResetTypeOfRemovalJob()
        {
        ...
        // This parameter set invokes a single graphql operation:
        // saasWorkloadMetadataTypes.
        internal void ProcessRecord_SaasWorkloadMetadataTypes()
        {
            this._logger.name += " -SaasWorkloadMetadataTypes";
            // Create new graphql operation saasWorkloadMetadataTypes
            InitQuerySaasWorkloadMetadataTypes();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // scriptsForManualPermissionValidation.
        internal void ProcessRecord_ScriptsForManualPermissionValidation()
        {
            this._logger.name += " -ScriptsForManualPermissionValidation";
            // Create new graphql operation scriptsForManualPermissionValidation
            InitQueryScriptsForManualPermissionValidation();
        }

        // This parameter set invokes a single graphql operation:
        // searchCloudDirectWorkload.
        internal void ProcessRecord_SearchCloudDirectWorkload()
        {
            this._logger.name += " -SearchCloudDirectWorkload";
            // Create new graphql operation searchCloudDirectWorkload
            InitQuerySearchCloudDirectWorkload();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // selfServeRollingUpgrade.
        internal void ProcessRecord_SelfServeRollingUpgrade()
        {
            this._logger.name += " -SelfServeRollingUpgrade";
            // Create new graphql operation selfServeRollingUpgrade
            InitQuerySelfServeRollingUpgrade();
        }

        // This parameter set invokes a single graphql operation:
        // signinLogDetails.
        internal void ProcessRecord_SigninLogDetails()
        {
            this._logger.name += " -SigninLogDetails";
            // Create new graphql operation signinLogDetails
            InitQuerySigninLogDetails();
        }

        // This parameter set invokes a single graphql operation:
        // signinLogFilterValues.
        internal void ProcessRecord_SigninLogFilterValues()
        {
            this._logger.name += " -SigninLogFilterValues";
            // Create new graphql operation signinLogFilterValues
            InitQuerySigninLogFilterValues();
        }

        // This parameter set invokes a single graphql operation:
        // signinLogs.
        internal void ProcessRecord_SigninLogs()
        {
            this._logger.name += " -SigninLogs";
            // Create new graphql operation signinLogs
            InitQuerySigninLogs();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // sqlServerSetupScriptsBulk.
        internal void ProcessRecord_SqlServerSetupScriptsBulk()
        {
            this._logger.name += " -SqlServerSetupScriptsBulk";
            // Create new graphql operation sqlServerSetupScriptsBulk
            InitQuerySqlServerSetupScriptsBulk();
        }

        // This parameter set invokes a single graphql operation:
        // ssmDocumentForEc2.
        internal void ProcessRecord_SsmDocumentForEc2()
        {
            this._logger.name += " -SsmDocumentForEc2";
            // Create new graphql operation ssmDocumentForEc2
            InitQuerySsmDocumentForEc2();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // upgradePathEligibility.
        internal void ProcessRecord_UpgradePathEligibility()
        {
            this._logger.name += " -UpgradePathEligibility";
            // Create new graphql operation upgradePathEligibility
            InitQueryUpgradePathEligibility();
        }
        ...
        internal void ProcessRecord_ValidRegionsForDynamoDbRecovery()
        {
            this._logger.name += " -ValidRegionsForDynamoDbRecovery";
            // Create new graphql operation allValidRegionsForDynamoDbRecovery
            InitQueryAllValidRegionsForDynamoDbRecovery();
        }

        // This parameter set invokes a single graphql operation:
        // validateAdForestTransition.
        internal void ProcessRecord_ValidateAdForestTransition()
        {
            this._logger.name += " -ValidateAdForestTransition";
            // Create new graphql operation validateAdForestTransition
            InitQueryValidateAdForestTransition();
        }
        ...
        // This parameter set invokes a single graphql operation:
        // validateOutpostAccountNetwork.
        internal void ProcessRecord_ValidateOutpostAccountNetwork()
        {
            this._logger.name += " -ValidateOutpostAccountNetwork";
            // Create new graphql operation validateOutpostAccountNetwork
            InitQueryValidateOutpostAccountNetwork();
        }

        // This parameter set invokes a single graphql operation:
        // validateRdsExportExocomputePort.
        internal void ProcessRecord_ValidateRdsExportExocomputePort()
        {
            this._logger.name += " -ValidateRdsExportExocomputePort";
            // Create new graphql operation validateRdsExportExocomputePort
            InitQueryValidateRdsExportExocomputePort();
        }

        // This parameter set invokes a single graphql operation:
        // validateRoleName.
        internal void ProcessRecord_ValidateRoleName()
        {
            this._logger.name += " -ValidateRoleName";
            // Create new graphql operation validateRoleName
            InitQueryValidateRoleName();
        }

        // This parameter set invokes a single graphql operation:
        // validateScriptOutputForManualPermissionValidation.
        internal void ProcessRecord_ValidateScriptOutputForManualPermissionValidation()
        {
            this._logger.name += " -ValidateScriptOutputForManualPermissionValidation";
            // Create new graphql operation validateScriptOutputForManualPermissionValidation
            InitQueryValidateScriptOutputForManualPermissionValidation();
        }
        ...
        internal void ProcessRecord_WorkloadResourceSpecs()
        {
...
$query.Var.before = $someString"
        ...
        internal void InitQueryAnalyzerUsages()
        {
            ...
            Initialize(
                ...
                "query",
                "QueryAnalyzerUsages",
                "($first: Int,$after: String,$last: Int,$before: String,$dataCategoryIdsFilter: [String!],$riskLevelsFilter: [RiskLevelType!],$sortBy: AnalyzerUsagesSortBy,$sortOrder: SortOrder,$dataTypeSourceFilter: DataTypeSource,$dataTypeNameSearchFilter: String,$analyzerStatusFilter: AnalyzerStatusFilter)",
                "AnalyzerUsageConnection",
...
$query.Var.orgId = $someString"
        ...
        // Create new GraphQL Query:
        // capSettingsData(input: CapSettingsDataInput!): CapSettingsData!
        internal void InitQueryCapSettingsData()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CapSettingsDataInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCapSettingsData",
                "($input: CapSettingsDataInput!)",
                "CapSettingsData",
                Query.CapSettingsData,
                Query.CapSettingsDataFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	principalId = $someString
        ...
        // Create new GraphQL Query:
        // ccProvisionMetadata(input: CcProvisionMetadataReq!): CcProvisionMetadataReply!
        internal void InitQueryCcProvisionMetadata()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CcProvisionMetadataReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCcProvisionMetadata",
                "($input: CcProvisionMetadataReq!)",
                "CcProvisionMetadataReply",
                Query.CcProvisionMetadata,
                Query.CcProvisionMetadataFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	clusterUuid = $someString
...
$query.Var.input = @{
	...
	o365OrgId = $someString
        ...
        // Create new GraphQL Query:
        // cloudDirectCheckSharePath(input: CloudDirectCheckSharePathReq!): CloudDirectCheckSharePathResp!
        internal void InitQueryCloudDirectCheckSharePath()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CloudDirectCheckSharePathReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCloudDirectCheckSharePath",
                "($input: CloudDirectCheckSharePathReq!)",
                "CloudDirectCheckSharePathResp",
                Query.CloudDirectCheckSharePath,
                Query.CloudDirectCheckSharePathFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterId = $someString
	...
	password = $someString
        ...
        // Create new GraphQL Query:
        // cloudDirectGlobalSearch(input: CloudDirectGlobalSearchReq!): CloudDirectGlobalSearchResult!
        internal void InitQueryCloudDirectGlobalSearch()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CloudDirectGlobalSearchReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCloudDirectGlobalSearch",
                "($input: CloudDirectGlobalSearchReq!)",
                "CloudDirectGlobalSearchResult",
                Query.CloudDirectGlobalSearch,
                Query.CloudDirectGlobalSearchFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterUuid = $someString
	...
	prefix = $someString
        ...
        // Create new GraphQL Query:
        // cloudDirectNasBucket(fid: UUID!): CloudDirectNasBucket!
        internal void InitQueryCloudDirectNasBucket()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCloudDirectNasBucket",
                "($fid: UUID!)",
                "CloudDirectNasBucket",
                Query.CloudDirectNasBucket,
                Query.CloudDirectNasBucketFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryCloudDirectNasBuckets()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryCloudDirectNasBuckets",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "CloudDirectNasBucketConnection",
                Query.CloudDirectNasBuckets,
                Query.CloudDirectNasBucketsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.input = @{
	...
	exportType = $someShareTypeEnum # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ShareTypeEnum]) for enum values.
        ...
        // Create new GraphQL Query:
        // cloudDirectSiteSettings(input: ListCloudDirectSiteSettingsReq!): ListCloudDirectSiteSettingsResp!
        internal void InitQueryCloudDirectSiteSettings()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ListCloudDirectSiteSettingsReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCloudDirectSiteSettings",
                "($input: ListCloudDirectSiteSettingsReq!)",
                "ListCloudDirectSiteSettingsResp",
                Query.CloudDirectSiteSettings,
                Query.CloudDirectSiteSettingsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	clusterUuid = $someString
...
$query.Var.groupFilterAttributes = @(
	@{
        ...
        // Create new GraphQL Query:
        // coordinatorLabels(input: GetCoordinatorLabelsReq!): CoordinatorLabelsReply!
        internal void InitQueryCoordinatorLabels()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetCoordinatorLabelsReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryCoordinatorLabels",
                "($input: GetCoordinatorLabelsReq!)",
                "CoordinatorLabelsReply",
                Query.CoordinatorLabels,
                Query.CoordinatorLabelsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterUuid = $someString
...
$query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values."
        ...
        // Create new GraphQL Query:
        // crowdStrikeIngestionStatus: CrowdStrikeIngestionStatus
        internal void InitQueryCrowdStrikeIngestionStatus()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QueryCrowdStrikeIngestionStatus",
                "",
                "CrowdStrikeIngestionStatus",
                Query.CrowdStrikeIngestionStatus,
                Query.CrowdStrikeIngestionStatusFieldSpec,
                @""
            );
        }
...
$query.Var.getWhitelistedResults = $someBoolean"
        ...
        // Create new GraphQL Query:
        // dataPreview(input: GetDataPreviewRequest!): GetDataPreviewReply!
        internal void InitQueryDataPreview()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetDataPreviewRequest!"),
            };
            Initialize(
                argDefs,
                "query",
...
$query.Var.exportUrlSpecsEnc = $someString"
        ...
        // Create new GraphQL Query:
        // devOpsBackupJobInformation(devopsOrgType: DevopsOrgType!): DevOpsBackupJobInformation!
        internal void InitQueryDevOpsBackupJobInformation()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("devopsOrgType", "DevopsOrgType!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryDevOpsBackupJobInformation",
                "($devopsOrgType: DevopsOrgType!)",
                "DevOpsBackupJobInformation",
                Query.DevOpsBackupJobInformation,
                Query.DevOpsBackupJobInformationFieldSpec,
                @"# REQUIRED
$query.Var.devopsOrgType = $someDevopsOrgType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.DevopsOrgType]) for enum values."
            );
        }
        ...
        // Create new GraphQL Query:
        // devOpsProtectedObjectCountSummary(objectType: ManagedObjectType!): DevOpsProtectedObjectCountSummary!
        internal void InitQueryDevOpsProtectedObjectCountSummary()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("objectType", "ManagedObjectType!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryDevOpsProtectedObjectCountSummary",
                "($objectType: ManagedObjectType!)",
                "DevOpsProtectedObjectCountSummary",
                Query.DevOpsProtectedObjectCountSummary,
                Query.DevOpsProtectedObjectCountSummaryFieldSpec,
                @"# REQUIRED
$query.Var.objectType = $someManagedObjectType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ManagedObjectType]) for enum values."
            );
        }
...
$query.Var.input = @{
	...
	recipientUserIds = @(
        ...
        // Create new GraphQL Query:
        // exocomputeGetSupportedHealthChecks(input: ExocomputeGetSupportedHealthChecksReq!): ExocomputeGetSupportedHealthChecksReply!
        internal void InitQueryExocomputeGetSupportedHealthChecks()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ExocomputeGetSupportedHealthChecksReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryExocomputeGetSupportedHealthChecks",
                "($input: ExocomputeGetSupportedHealthChecksReq!)",
                "ExocomputeGetSupportedHealthChecksReply",
                Query.ExocomputeGetSupportedHealthChecks,
                Query.ExocomputeGetSupportedHealthChecksFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	cloudType = $someExocomputeCloudType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ExocomputeCloudType]) for enum values.
        ...
        // Create new GraphQL Query:
        // exocomputeHealthChecks(input: ExocomputeHealthChecksReq!): ExocomputeHealthChecksReply!
        internal void InitQueryExocomputeHealthChecks()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ExocomputeHealthChecksReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryExocomputeHealthChecks",
                "($input: ExocomputeHealthChecksReq!)",
                "ExocomputeHealthChecksReply",
                Query.ExocomputeHealthChecks,
                Query.ExocomputeHealthChecksFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	exocomputeConfigId = $someString
...
$query.Var.failedItemsInstanceId = $someString"
        ...
        //     filter: FailoverGroupWorkloadFilter
        //   ): FailoverGroupWorkloadConnection!
        internal void InitQueryFailoverGroupWorkloads()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                ...
                Tuple.Create("filter", "FailoverGroupWorkloadFilter"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFailoverGroupWorkloads",
                "($first: Int,$after: String,$last: Int,$before: String,$failoverGroupId: UUID!,$filter: FailoverGroupWorkloadFilter)",
                "FailoverGroupWorkloadConnection",
                Query.FailoverGroupWorkloads,
                Query.FailoverGroupWorkloadsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.before = $someString"
        ...
        // Create new GraphQL Query:
        // fusionComputeDatastore(fid: UUID!): FusionComputeDatastore!
        internal void InitQueryFusionComputeDatastore()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeDatastore",
                "($fid: UUID!)",
                "FusionComputeDatastore",
                Query.FusionComputeDatastore,
                Query.FusionComputeDatastoreFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryFusionComputeDatastores()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeDatastores",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeDatastoreConnection",
                Query.FusionComputeDatastores,
                Query.FusionComputeDatastoresFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        // Create new GraphQL Query:
        // fusionComputeEcho(input: FusionComputeEchoRequest!): FusionComputeEchoResponse!
        internal void InitQueryFusionComputeEcho()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "FusionComputeEchoRequest!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeEcho",
                "($input: FusionComputeEchoRequest!)",
                "FusionComputeEchoResponse",
                Query.FusionComputeEcho,
                Query.FusionComputeEchoFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	arg1 = $someString
        ...
        //     last: Int
        //     before: String
        //     filter: [QueryFusionComputeMountsFilter!]
        //     sortBy: FusionComputeMountsSortByField
        //     sortOrder: SortOrder
        //   ): FusionComputeMountDetailConnection!
        internal void InitQueryFusionComputeMounts()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("filter", "[QueryFusionComputeMountsFilter!]"),
                Tuple.Create("sortBy", "FusionComputeMountsSortByField"),
                Tuple.Create("sortOrder", "SortOrder"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeMounts",
                "($first: Int,$after: String,$last: Int,$before: String,$filter: [QueryFusionComputeMountsFilter!],$sortBy: FusionComputeMountsSortByField,$sortOrder: SortOrder)",
                "FusionComputeMountDetailConnection",
                Query.FusionComputeMounts,
                Query.FusionComputeMountsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values."
        ...
        // Create new GraphQL Query:
        // fusionComputeNetwork(fid: UUID!): FusionComputeNetwork!
        internal void InitQueryFusionComputeNetwork()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeNetwork",
                "($fid: UUID!)",
                "FusionComputeNetwork",
                Query.FusionComputeNetwork,
                Query.FusionComputeNetworkFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryFusionComputeNetworks()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeNetworks",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeNetworkConnection",
                Query.FusionComputeNetworks,
                Query.FusionComputeNetworksFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        //     filter: [Filter!]
        //   ): FusionComputeDatastoreConnection!
        internal void InitQueryFusionComputeRecoverableDatastores()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeRecoverableDatastores",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeDatastoreConnection",
                Query.FusionComputeRecoverableDatastores,
                Query.FusionComputeRecoverableDatastoresFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        //     filter: [Filter!]
        //   ): FusionComputeNetworkConnection!
        internal void InitQueryFusionComputeRecoverableNetworks()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeRecoverableNetworks",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeNetworkConnection",
                Query.FusionComputeRecoverableNetworks,
                Query.FusionComputeRecoverableNetworksFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        // Create new GraphQL Query:
        // fusionComputeSite(fid: UUID!): FusionComputeSite!
        internal void InitQueryFusionComputeSite()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeSite",
                "($fid: UUID!)",
                "FusionComputeSite",
                Query.FusionComputeSite,
                Query.FusionComputeSiteFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryFusionComputeSites()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeSites",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeSiteConnection",
                Query.FusionComputeSites,
                Query.FusionComputeSitesFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        //     last: Int
        //     before: String
        //     fusionComputeVirtualMachineFid: UUID!
        //     filter: [QueryFusionComputeVirtualDisksFilter!]
        //     sortBy: FusionComputeVirtualDisksSortByField
        //     sortOrder: SortOrder
        //   ): FusionComputeVirtualDiskConnection!
        internal void InitQueryFusionComputeVirtualDisks()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("fusionComputeVirtualMachineFid", "UUID!"),
                Tuple.Create("filter", "[QueryFusionComputeVirtualDisksFilter!]"),
                Tuple.Create("sortBy", "FusionComputeVirtualDisksSortByField"),
                Tuple.Create("sortOrder", "SortOrder"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVirtualDisks",
                "($first: Int,$after: String,$last: Int,$before: String,$fusionComputeVirtualMachineFid: UUID!,$filter: [QueryFusionComputeVirtualDisksFilter!],$sortBy: FusionComputeVirtualDisksSortByField,$sortOrder: SortOrder)",
                "FusionComputeVirtualDiskConnection",
                Query.FusionComputeVirtualDisks,
                Query.FusionComputeVirtualDisksFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values."
        ...
        // Create new GraphQL Query:
        // fusionComputeVirtualMachine(fid: UUID!): FusionComputeVirtualMachine!
        internal void InitQueryFusionComputeVirtualMachine()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVirtualMachine",
                "($fid: UUID!)",
                "FusionComputeVirtualMachine",
                Query.FusionComputeVirtualMachine,
                Query.FusionComputeVirtualMachineFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryFusionComputeVirtualMachines()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVirtualMachines",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeVirtualMachineConnection",
                Query.FusionComputeVirtualMachines,
                Query.FusionComputeVirtualMachinesFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        // Create new GraphQL Query:
        // fusionComputeVmRequestStatus(input: FusionComputeVmRequestStatusInput!): AsyncRequestStatus!
        internal void InitQueryFusionComputeVmRequestStatus()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "FusionComputeVmRequestStatusInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVmRequestStatus",
                "($input: FusionComputeVmRequestStatusInput!)",
                "AsyncRequestStatus",
                Query.FusionComputeVmRequestStatus,
                Query.FusionComputeVmRequestStatusFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	id = $someString
	...
	clusterUuid = $someString
        ...
        // Create new GraphQL Query:
        // fusionComputeVrm(fid: UUID!): FusionComputeVrm!
        internal void InitQueryFusionComputeVrm()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVrm",
                "($fid: UUID!)",
                "FusionComputeVrm",
                Query.FusionComputeVrm,
                Query.FusionComputeVrmFieldSpec,
                @"# REQUIRED
$query.Var.fid = $someString"
            );
        }
        ...
        internal void InitQueryFusionComputeVrms()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryFusionComputeVrms",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!])",
                "FusionComputeVrmConnection",
                Query.FusionComputeVrms,
                Query.FusionComputeVrmsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.roleId = $someString"
        ...
        // Create new GraphQL Query:
        // getRolesByIds(roleIds: [String!]!, syncedClustersFilter: String): [Role!]!
        internal void InitQueryGetRolesByIds()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("roleIds", "[String!]!"),
                Tuple.Create("syncedClustersFilter", "String"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryGetRolesByIds",
                "($roleIds: [String!]!,$syncedClustersFilter: String)",
                "List<Role>",
                Query.GetRolesByIds,
...
$query.Var.before = $someString"
        ...
        internal void InitQueryGitHubConnectionStatusSummary()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QueryGitHubConnectionStatusSummary",
                "",
                "GitHubConnectionStatusSummaryReply",
                Query.GitHubConnectionStatusSummary,
                Query.GitHubConnectionStatusSummaryFieldSpec,
                @""
            );
        }

        // Create new GraphQL Query:
        // gitHubOrganization(workloadId: UUID!): GithubOrganization!
        internal void InitQueryGitHubOrganization()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("workloadId", "UUID!"),
            };
            Initialize(
                ...
                Query.GitHubOrganizationFieldSpec,
                @"# REQUIRED
$query.Var.workloadId = $someString"
            );
        }
        ...
        internal void InitQueryGitHubOrganizations()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
...
$query.Var.workloadHierarchy = $someWorkloadLevelHierarchy # Call [Enum]::GetValues([RubrikSecurityCloud.Types.WorkloadLevelHierarchy]) for enum values."
        ...
        internal void InitQueryGitHubRepositories()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                ...
                Query.GitHubRepositoriesFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.workloadHierarchy = $someWorkloadLevelHierarchy # Call [Enum]::GetValues([RubrikSecurityCloud.Types.WorkloadLevelHierarchy]) for enum values."
        ...
        // Create new GraphQL Query:
        // gitHubRepository(workloadId: UUID!): GithubRepository!
        internal void InitQueryGitHubRepository()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("workloadId", "UUID!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryGitHubRepository",
                "($workloadId: UUID!)",
                "GithubRepository",
                Query.GitHubRepository,
                Query.GitHubRepositoryFieldSpec,
                @"# REQUIRED
$query.Var.workloadId = $someString"
            );
        }
	...
	clusterUuid = $someString
        ...
        internal void InitQueryGlobalSearchResults()
        {
            Tuple<string, string>[] argDefs = {
                ...
                Tuple.Create("sortOrder", "SortOrder"),
                Tuple.Create("filter", "[Filter!]"),
                Tuple.Create("objectTypeFilterParams", "[ManagedObjectType!]"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryGlobalSearchResults",
                "($first: Int,$after: String,$last: Int,$before: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$filter: [Filter!],$objectTypeFilterParams: [ManagedObjectType!])",
                "HierarchyObjectConnection",
...
$query.Var.filter = @(
	@{
        ...
        //     last: Int
        //     before: String
        //     sortBy: IdentityDataLocationSortByField
        //     filter: IdentityDataLocationsFilter
        //     pagination: Pagination
        //   ): IdentityDataLocationEncryptionInfoConnection!
        internal void InitQueryIdentityDataLocationsEncryptionInfo()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("sortBy", "IdentityDataLocationSortByField"),
                Tuple.Create("filter", "IdentityDataLocationsFilter"),
                Tuple.Create("pagination", "Pagination"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryIdentityDataLocationsEncryptionInfo",
                "($first: Int,$after: String,$last: Int,$before: String,$sortBy: IdentityDataLocationSortByField,$filter: IdentityDataLocationsFilter,$pagination: Pagination)",
                "IdentityDataLocationEncryptionInfoConnection",
                Query.IdentityDataLocationsEncryptionInfo,
                Query.IdentityDataLocationsEncryptionInfoFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.feedEntrySort = @{
	...
	sort = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
        ...
        //     last: Int
        //     before: String
        //     filter: IpWhitelistEntryFilterInput
        //   ): IpInfoConnection!
        internal void InitQueryIpWhitelistEntries()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("filter", "IpWhitelistEntryFilterInput"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryIpWhitelistEntries",
                "($first: Int,$after: String,$last: Int,$before: String,$filter: IpWhitelistEntryFilterInput)",
                "IpInfoConnection",
                Query.IpWhitelistEntries,
                Query.IpWhitelistEntriesFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @{
	...
	ipEntrySourceFilter = $someIpEntrySource # Call [Enum]::GetValues([RubrikSecurityCloud.Types.IpEntrySource]) for enum values.
        ...
        internal void InitQueryIpWhitelistSettings()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QueryIpWhitelistSettings",
                "",
                "IpWhitelistSettings",
                Query.IpWhitelistSettings,
                Query.IpWhitelistSettingsFieldSpec,
                @""
            );
        }

        // Create new GraphQL Query:
        // isCloudDirectSharePathValid(input: CloudDirectValidateSharePathReq!): CloudDirectValidateSharePathResp!
        internal void InitQueryIsCloudDirectSharePathValid()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CloudDirectValidateSharePathReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryIsCloudDirectSharePathValid",
                "($input: CloudDirectValidateSharePathReq!)",
                "CloudDirectValidateSharePathResp",
                Query.IsCloudDirectSharePathValid,
                Query.IsCloudDirectSharePathValidFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterId = $someString
...
$query.Var.clusterUuid = $someString"
        ...
        // Create new GraphQL Query:
        // isSfdcReachable(hostname: String! = "rubrik.force.com"): Boolean!
...
$query.Var.id = $someString"
        ...
        internal void InitQueryLacpConfigurations()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryLacpConfigurations",
                "($first: Int,$after: String,$last: Int,$before: String,$clusterUuids: [UUID!]!)",
                "LacpPresenceCheckConnection",
                Query.LacpConfigurations,
                Query.LacpConfigurationsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.clusterUuids = @(
	$someString
        ...
        // Create new GraphQL Query:
        // latestGpoSettings(input: GetLatestGpoSettingsReq!): GetLatestGpoSettingsRes!
        internal void InitQueryLatestGpoSettings()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetLatestGpoSettingsReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryLatestGpoSettings",
                "($input: GetLatestGpoSettingsReq!)",
                "GetLatestGpoSettingsRes",
                Query.LatestGpoSettings,
                Query.LatestGpoSettingsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	gpoFid = $someString
	...
	jsonDisplayFieldsOnly = $someBoolean
        ...
        // Create new GraphQL Query:
        // listAllUploadRecords(input: ListAllUploadRecordsInput!): ListAllUploadRecordsReply!
        internal void InitQueryListAllUploadRecords()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ListAllUploadRecordsInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryListAllUploadRecords",
                "($input: ListAllUploadRecordsInput!)",
                "ListAllUploadRecordsReply",
                Query.ListAllUploadRecords,
                Query.ListAllUploadRecordsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	clusterUuids = @(
        ...
        internal void InitQueryMicrosoftGroups()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                ...
                Tuple.Create("microsoftObjectType", "ManagedObjectType!"),
...
$query.Var.tenantIdFilter = $someString"
        ...
        internal void InitQueryMultiHopUpgradePath()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("clusterUuid", "UUID!"),
                Tuple.Create("sourceVersion", "String"),
                Tuple.Create("targetVersion", "String!"),
                Tuple.Create("shouldIncludeFullVersionName", "Boolean"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryMultiHopUpgradePath",
                "($clusterUuid: UUID!,$sourceVersion: String,$targetVersion: String!,$shouldIncludeFullVersionName: Boolean)",
                "MultiHopUpgradePathReply",
                Query.MultiHopUpgradePath,
                Query.MultiHopUpgradePathFieldSpec,
                @"# REQUIRED
$query.Var.clusterUuid = $someString
# OPTIONAL
$query.Var.sourceVersion = $someString
...
$query.Var.shouldIncludeFullVersionName = $someBoolean"
        ...
        // Create new GraphQL Query:
        // mysqlDatabase(fid: UUID!): MysqldbDatabase!
        internal void InitQueryMysqlDatabase()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
...
$query.Var.fid = $someString"
        ...
        internal void InitQueryMysqlDatabases()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
...
$query.Var.filter = @(
	@{
        ...
        // Create new GraphQL Query:
        // mysqlInstance(fid: UUID!): MysqldbInstance!
        internal void InitQueryMysqlInstance()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("fid", "UUID!"),
            };
...
$query.Var.fid = $someString"
        ...
        internal void InitQueryMysqlInstanceLiveMounts()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
...
$query.Var.sortBy = @{
	...
	sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values.
        ...
        internal void InitQueryMysqlInstances()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
...
$query.Var.input = @{
	...
	clusterUuid = $someString
        ...
        internal void InitQueryNodesToRemoveByCount()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                ...
                Tuple.Create("before", "String"),
                Tuple.Create("clusterUuid", "UUID!"),
                Tuple.Create("nodeCount", "Int!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryNodesToRemoveByCount",
                "($first: Int,$after: String,$last: Int,$before: String,$clusterUuid: UUID!,$nodeCount: Int!)",
                "NodeToRemoveByCountConnection",
                Query.NodesToRemoveByCount,
                Query.NodesToRemoveByCountFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.orgId = $someString"
        ...
        //     mfaStatusFilter: MfaStatus
        //     mfaStatusesFilter: [MfaStatus!]
        ...
        internal void InitQueryOrgs()
        {
            Tuple<string, string>[] argDefs = {
                ...
                Tuple.Create("mfaStatusFilter", "MfaStatus"),
                Tuple.Create("mfaStatusesFilter", "[MfaStatus!]"),
            ...
            Initialize(
                ...
                "query",
                "QueryOrgs",
                "($first: Int,$after: String,$last: Int,$before: String,$sortOrder: SortOrder,$sortBy: OrgField,$nameFilter: String,$mfaEnforcedFilter: Boolean,$mfaStatusFilter: MfaStatus,$mfaStatusesFilter: [MfaStatus!],$crossAccountEnabledFilter: Boolean)",
                "OrgConnection",
                Query.Orgs,
                Query.OrgsFieldSpec,
                @"# OPTIONAL
...
$query.Var.orgSearchFilter = $someString"
        ...
        //     last: Int
        //     before: String
        //     sortBy: GetObjectPauseListSortByParams
        //     filter: GetObjectPauseListFilterParams
        //   ): GetPausedObjectResConnection!
        internal void InitQueryPausedObjects()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("sortBy", "GetObjectPauseListSortByParams"),
                Tuple.Create("filter", "GetObjectPauseListFilterParams"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryPausedObjects",
                "($first: Int,$after: String,$last: Int,$before: String,$sortBy: GetObjectPauseListSortByParams,$filter: GetObjectPauseListFilterParams)",
                "GetPausedObjectResConnection",
                Query.PausedObjects,
                Query.PausedObjectsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.pendingActionId = $someString"
        ...
        //     historyOnly: Boolean
        //     limit: Long = 9223372036854775807
        //   ): [pendingAction!]!
...
$query.Var.rootEnum = $someInventorySubHierarchyRootEnum # Call [Enum]::GetValues([RubrikSecurityCloud.Types.InventorySubHierarchyRootEnum]) for enum values."
        ...
        internal void InitQueryPolicyDetails()
        {
            Tuple<string, string>[] argDefs = {
                ...
                Tuple.Create("dataCategoryFilter", "DataCategoryFilter"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryPolicyDetails",
                "($dataCategoryIds: [String!],$dataTypeIds: [String!],$dataCategoryType: DataCategoryType,$documentTypeIds: [UUID!],$sortBy: PoliciesDetailSortByField,$sortOrder: SortOrder,$includeInactiveDataCategories: Boolean,$dataCategoryFilter: DataCategoryFilter)",
                "PolicyDetailConnection",
                Query.PolicyDetails,
...
$query.Var.before = $someString"
        ...
        internal void InitQueryPolicyViolations()
        {
            Tuple<string, string>[] argDefs = {
                ...
                Tuple.Create("includeResourceCounts", "Boolean"),
                ...
                Tuple.Create("sortOrder", "SortOrder"),
                Tuple.Create("principalFilter", "PrincipalSummariesFilterInput"),
                Tuple.Create("policyViolationNameSearch", "String"),
                Tuple.Create("policyFrameworks", "[String!]"),
                Tuple.Create("ticketNumbers", "[String!]"),
            ...
            Initialize(
                ...
                "($first: Int,$after: String,$last: Int,$before: String,$policyIds: [UUID!],$resourceIds: [String!],$statuses: [PolicyViolationStatus!],$statusReasons: [PolicyViolationStatusReason!],$policyTypes: [PolicyType!]!,$policyViolationIds: [UUID!],$policySeverities: [Severity!],$policyCategories: [Category!],$includeDeletedPolicies: Boolean,$resourceTypes: [PolicyResourceType!],$sensitivityLevels: [SensitivityLevel!],$detectionDate: TimeRangeInput,$updateDate: TimeRangeInput,$includeResourceCounts: Boolean,$resourceMetadataFilter: ResourceMetadataFiltersInput,$parentViolationId: UUID,$dataTypeIds: [String!],$documentTypeIds: [UUID!],$dataCategoryIds: [String!],$sortBy: PolicyViolationSortField,$sortOrder: SortOrder,$principalFilter: PrincipalSummariesFilterInput,$policyViolationNameSearch: String,$policyFrameworks: [String!],$ticketNumbers: [String!],$violationNames: [String!])",
                "PolicyViolationConnection",
                Query.PolicyViolations,
                Query.PolicyViolationsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filter = @(
	@{
        ...
        // Create new GraphQL Query:
        // protectionSummaryV2: ProtectionSummaryV2!
        internal void InitQueryProtectionSummaryV2()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QueryProtectionSummaryV2",
                "",
                "ProtectionSummaryV2",
                Query.ProtectionSummaryV2,
                Query.ProtectionSummaryV2FieldSpec,
                @""
            );
        }
...
$query.Var.queryDatastoreFreespaceThresholdsInput = @(
	@{
        ...
        //     workloadTypeFilter: ManagedObjectType
        //     recoveryNameSubstring: String
        //     sortParam: RecoverySortParamInput
        //   ): RecoveryConnection!
        internal void InitQueryRecoveries()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                Tuple.Create("last", "Int"),
                Tuple.Create("before", "String"),
                Tuple.Create("recoveryIds", "[UUID!]"),
                Tuple.Create("recoveryType", "[RecoveryType!]"),
                Tuple.Create("endTime", "DateTime"),
                Tuple.Create("startTime", "DateTime"),
                Tuple.Create("recoveryPlanNames", "[String!]"),
                Tuple.Create("workloadIds", "[UUID!]"),
                Tuple.Create("recoveryStatuses", "[RecoveryStatus!]"),
                Tuple.Create("recoveryOutcomes", "[RecoveryOutcome!]"),
                Tuple.Create("recoveryNames", "[String!]"),
                Tuple.Create("recoveryTriggeredFrom", "[RecoveryTriggeredFrom!]"),
                Tuple.Create("recoveryPlanIds", "[UUID!]"),
                Tuple.Create("workloadTypeFilter", "ManagedObjectType"),
                Tuple.Create("recoveryNameSubstring", "String"),
                Tuple.Create("sortParam", "RecoverySortParamInput"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryRecoveries",
                "($first: Int,$after: String,$last: Int,$before: String,$recoveryIds: [UUID!],$recoveryType: [RecoveryType!],$endTime: DateTime,$startTime: DateTime,$recoveryPlanNames: [String!],$workloadIds: [UUID!],$recoveryStatuses: [RecoveryStatus!],$recoveryOutcomes: [RecoveryOutcome!],$recoveryNames: [String!],$recoveryTriggeredFrom: [RecoveryTriggeredFrom!],$recoveryPlanIds: [UUID!],$workloadTypeFilter: ManagedObjectType,$recoveryNameSubstring: String,$sortParam: RecoverySortParamInput)",
                "RecoveryConnection",
                Query.Recoveries,
                Query.RecoveriesFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.input = @{
	...
	nodeNames = @(
        ...
        // Create new GraphQL Query:
        // resetTypeOfRemovalJob(input: ResetTypeOfRemovalJobInput!): ResetTypeOfRemovalJob!
        internal void InitQueryResetTypeOfRemovalJob()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ResetTypeOfRemovalJobInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryResetTypeOfRemovalJob",
                "($input: ResetTypeOfRemovalJobInput!)",
                "ResetTypeOfRemovalJob",
                Query.ResetTypeOfRemovalJob,
                Query.ResetTypeOfRemovalJobFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	clusterUuid = $someString
...
$query.Var.nameFilter = $someString"
        ...
        internal void InitQueryRscPermsToCdmInfo()
        {
            ...
            Initialize(
                ...
                "($roleId: String,$protectableClusters: [String!]!,$permissions: [PermissionInput!]!,$first: Int,$after: String,$last: Int,$before: String)",
                "RscPermsToCdmInfoOut",
...
$query.Var.recoveryTargetFilter = @{
	...
	sourceOrganizationId = $someString
        ...
        // Create new GraphQL Query:
        // saasWorkloadMetadataTypes(input: SaasWorkloadMetadataTypesReq!): SaasWorkloadMetadataTypesReply!
        internal void InitQuerySaasWorkloadMetadataTypes()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "SaasWorkloadMetadataTypesReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QuerySaasWorkloadMetadataTypes",
                "($input: SaasWorkloadMetadataTypesReq!)",
                "SaasWorkloadMetadataTypesReply",
                Query.SaasWorkloadMetadataTypes,
                Query.SaasWorkloadMetadataTypesFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	workloadId = $someString
...
$query.Var.sortOrder = $someSortOrder # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SortOrder]) for enum values."
        ...
        // Create new GraphQL Query:
        // scriptsForManualPermissionValidation(input: GetScriptsForManualPermissionValidationReq!): GetScriptsForManualPermissionValidationReply!
        internal void InitQueryScriptsForManualPermissionValidation()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetScriptsForManualPermissionValidationReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryScriptsForManualPermissionValidation",
                "($input: GetScriptsForManualPermissionValidationReq!)",
                "GetScriptsForManualPermissionValidationReply",
                Query.ScriptsForManualPermissionValidation,
                Query.ScriptsForManualPermissionValidationFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	cloudVendor = $someCloudVendor # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudVendor]) for enum values.
	...
	cloudAccountIds = @(
        ...
        internal void InitQuerySearchCloudDirectWorkload()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
                ...
                Tuple.Create("versionLimit", "Int"),
            };
            Initialize(
                argDefs,
                "query",
                "QuerySearchCloudDirectWorkload",
                "($first: Int,$after: String,$last: Int,$before: String,$workloadFid: UUID!,$searchQuery: String!,$versionLimit: Int)",
                "SearchCloudDirectWorkloadEntryConnection",
                Query.SearchCloudDirectWorkload,
                Query.SearchCloudDirectWorkloadFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString
...
$query.Var.filenamePrefix = $someString"
        ...
        // Create new GraphQL Query:
        // selfServeRollingUpgrade: GetSelfServeRollingUpgradeReply!
        internal void InitQuerySelfServeRollingUpgrade()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QuerySelfServeRollingUpgrade",
                "",
                "GetSelfServeRollingUpgradeReply",
                Query.SelfServeRollingUpgrade,
                Query.SelfServeRollingUpgradeFieldSpec,
                @""
            );
        }

        // Create new GraphQL Query:
        // signinLogDetails(eventId: String!, eventDate: DateTime): SigninLogDetails
        internal void InitQuerySigninLogDetails()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("eventId", "String!"),
                Tuple.Create("eventDate", "DateTime"),
            };
            Initialize(
                argDefs,
                "query",
                "QuerySigninLogDetails",
                "($eventId: String!,$eventDate: DateTime)",
                "SigninLogDetails",
                Query.SigninLogDetails,
                Query.SigninLogDetailsFieldSpec,
                @"# REQUIRED
$query.Var.eventId = $someString
# OPTIONAL
$query.Var.eventDate = $someDateTime"
        ...
        // Create new GraphQL Query:
        // signinLogFilterValues(
        //     filterType: SigninLogFilterType!
        //     timeRange: TimeRangeInput!
        //     searchTerm: String
        //     limit: Int
        //     existingFilters: SigninLogsFilters
        //   ): SigninLogFilterValuesResponse!
        internal void InitQuerySigninLogFilterValues()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("filterType", "SigninLogFilterType!"),
                Tuple.Create("timeRange", "TimeRangeInput!"),
                Tuple.Create("searchTerm", "String"),
                Tuple.Create("limit", "Int"),
                Tuple.Create("existingFilters", "SigninLogsFilters"),
            };
            Initialize(
                argDefs,
                "query",
                "QuerySigninLogFilterValues",
                "($filterType: SigninLogFilterType!,$timeRange: TimeRangeInput!,$searchTerm: String,$limit: Int,$existingFilters: SigninLogsFilters)",
                "SigninLogFilterValuesResponse",
                Query.SigninLogFilterValues,
                Query.SigninLogFilterValuesFieldSpec,
                @"# REQUIRED
$query.Var.filterType = $someSigninLogFilterType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SigninLogFilterType]) for enum values.
# REQUIRED
$query.Var.timeRange = @{
...
$query.Var.falsePositiveTypeFilter = @(
	$someAnomalyFalsePositiveType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AnomalyFalsePositiveType]) for enum values.
        ...
        // Create new GraphQL Query:
        // sqlServerSetupScriptsBulk(input: GetSqlServerSetupScriptsReqBulk!): GetSqlServerSetupScriptsReplyBulk!
        internal void InitQuerySqlServerSetupScriptsBulk()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetSqlServerSetupScriptsReqBulk!"),
            };
            Initialize(
                argDefs,
                "query",
                "QuerySqlServerSetupScriptsBulk",
                "($input: GetSqlServerSetupScriptsReqBulk!)",
                "GetSqlServerSetupScriptsReplyBulk",
                Query.SqlServerSetupScriptsBulk,
                Query.SqlServerSetupScriptsBulkFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	serverIds = @(
        ...
        // Create new GraphQL Query:
        // ssmDocumentForEc2: SsmDocumentForEc2Reply!
        internal void InitQuerySsmDocumentForEc2()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QuerySsmDocumentForEc2",
                "",
                "SsmDocumentForEc2Reply",
                Query.SsmDocumentForEc2,
                Query.SsmDocumentForEc2FieldSpec,
                @""
            );
        }
...
$query.Var.snapshotManagementType = $someSnapshotManagementType # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SnapshotManagementType]) for enum values."
        ...
        // Create new GraphQL Query:
        // upgradePathEligibility(clusterUuid: UUID!, targetVersion: String!, operation: String!): UpgradePathEligibilityReply!
        internal void InitQueryUpgradePathEligibility()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("clusterUuid", "UUID!"),
                Tuple.Create("targetVersion", "String!"),
                Tuple.Create("operation", "String!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryUpgradePathEligibility",
                "($clusterUuid: UUID!,$targetVersion: String!,$operation: String!)",
                "UpgradePathEligibilityReply",
                Query.UpgradePathEligibility,
                Query.UpgradePathEligibilityFieldSpec,
                @"# REQUIRED
$query.Var.clusterUuid = $someString
# REQUIRED
$query.Var.targetVersion = $someString
...
$query.Var.externalId = $someString"
        ...
        internal void InitQueryAllUserFiles()
        {
            ...
            Initialize(
                ...
                "query",
                "QueryAllUserFiles",
                "($first: Int,$after: String,$last: Int,$before: String,$filenamePrefix: String)",
...
$query.Var.userDomainsFilter = @(
	$someUserDomainEnum # Call [Enum]::GetValues([RubrikSecurityCloud.Types.UserDomainEnum]) for enum values.
        ...
        // Create new GraphQL Query:
        // allValidRegionsForDynamoDbRecovery(input: GetValidRegionsForDynamoDbRecoveryReq!): GetValidRegionsForDynamoDbRecoveryReply!
        internal void InitQueryAllValidRegionsForDynamoDbRecovery()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetValidRegionsForDynamoDbRecoveryReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryAllValidRegionsForDynamoDbRecovery",
                "($input: GetValidRegionsForDynamoDbRecoveryReq!)",
                "GetValidRegionsForDynamoDbRecoveryReply",
                Query.AllValidRegionsForDynamoDbRecovery,
                Query.AllValidRegionsForDynamoDbRecoveryFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	targetAwsAccountId = $someString
	...
	sourceAwsAccountId = $someString
        ...
        // Create new GraphQL Query:
        // validateAdForestTransition: ValidateAdForestTransition!
        internal void InitQueryValidateAdForestTransition()
        {
            Tuple<string, string>[] argDefs = {
            };
            Initialize(
                argDefs,
                "query",
                "QueryValidateAdForestTransition",
                "",
                "ValidateAdForestTransition",
                Query.ValidateAdForestTransition,
                Query.ValidateAdForestTransitionFieldSpec,
                @""
            );
        }

        // Create new GraphQL Query:
        // validateIocEntry(input: ValidateIocEntryInput!): ValidateEntryReply!
        internal void InitQueryValidateIocEntry()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ValidateIocEntryInput!"),
            };
            Initialize(
                argDefs,
                "query",
...
$query.Var.input = @{
	...
	fullName = $someString
        ...
        // Create new GraphQL Query:
        // validateOutpostAccountNetwork(input: ValidateOutpostAccountNetworkInput!): ValidateOutpostAccountNetworkReply!
        internal void InitQueryValidateOutpostAccountNetwork()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ValidateOutpostAccountNetworkInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryValidateOutpostAccountNetwork",
                "($input: ValidateOutpostAccountNetworkInput!)",
                "ValidateOutpostAccountNetworkReply",
                Query.ValidateOutpostAccountNetwork,
                Query.ValidateOutpostAccountNetworkFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	outpostAccountId = $someString
	...
	region = $someString
        ...
        // Create new GraphQL Query:
        // validateRdsExportExocomputePort(input: ValidateRdsExportExocomputePortReq!): ValidateRdsExportExocomputePortReply!
        internal void InitQueryValidateRdsExportExocomputePort()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ValidateRdsExportExocomputePortReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryValidateRdsExportExocomputePort",
                "($input: ValidateRdsExportExocomputePortReq!)",
                "ValidateRdsExportExocomputePortReply",
                Query.ValidateRdsExportExocomputePort,
                Query.ValidateRdsExportExocomputePortFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	instanceId = $someString
	...
	port = $someInt64
        ...
        // Create new GraphQL Query:
        // validateRoleName(input: ValidateRoleNameReq!): ValidateRoleNameReply!
        internal void InitQueryValidateRoleName()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ValidateRoleNameReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryValidateRoleName",
                "($input: ValidateRoleNameReq!)",
                "ValidateRoleNameReply",
                Query.ValidateRoleName,
                Query.ValidateRoleNameFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	roleName = $someString
	...
	roleId = $someString
        ...
        // Create new GraphQL Query:
        // validateScriptOutputForManualPermissionValidation(input: ValidateScriptOutputForManualPermissionValidationReq!): ValidateScriptOutputForManualPermissionValidationReply!
        internal void InitQueryValidateScriptOutputForManualPermissionValidation()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ValidateScriptOutputForManualPermissionValidationReq!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryValidateScriptOutputForManualPermissionValidation",
                "($input: ValidateScriptOutputForManualPermissionValidationReq!)",
                "ValidateScriptOutputForManualPermissionValidationReply",
                Query.ValidateScriptOutputForManualPermissionValidation,
                Query.ValidateScriptOutputForManualPermissionValidationFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	cloudVendor = $someCloudVendor # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudVendor]) for enum values.
...
$query.Var.managedId = $someString"
        ...
        // Create new GraphQL Query:
        // allWorkloadResourceSpecs(input: ListWorkloadResourceSpecsInput!): [WorkloadResourceSpec!]!
        internal void InitQueryAllWorkloadResourceSpecs()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "ListWorkloadResourceSpecsInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryAllWorkloadResourceSpecs",
                "($input: ListWorkloadResourceSpecsInput!)",
                "List<WorkloadResourceSpec>",
                Query.AllWorkloadResourceSpecs,
                Query.AllWorkloadResourceSpecsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# OPTIONAL
	workloadRecoveryPoints = @(

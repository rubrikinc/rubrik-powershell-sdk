// New-RscGqlQueryMongodbDatabases.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongodbDatabases
    /// mongodbDatabases(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryMongodbDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongodbDatabases
}
// New-RscGqlMutationVsphereVmRecoverFiles.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmRecoverFiles
    /// vsphereVmRecoverFiles(input: VsphereVmRecoverFilesInput!): VsphereAsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmRecoverFiles")
    ]
    public class New_RscGqlMutationVsphereVmRecoverFiles : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmRecoverFiles
}
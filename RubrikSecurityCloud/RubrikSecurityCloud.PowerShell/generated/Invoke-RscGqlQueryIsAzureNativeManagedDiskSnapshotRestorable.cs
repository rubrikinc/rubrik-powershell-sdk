// Invoke-RscGqlQueryIsAzureNativeManagedDiskSnapshotRestorable.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query isAzureNativeManagedDiskSnapshotRestorable
    ...
    public class Invoke_RscGqlQueryIsAzureNativeManagedDiskSnapshotRestorable : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.diskSnapshotId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryIsAzureNativeManagedDiskSnapshotRestorable
}
...
namespace Rubrik.SecurityCloud.PowerShell.Cmdlets
{
    ...
    public class Query_RscSla : RscPSCmdlet
    {
        ...
        // -------------------------------------------------------------------
        // countOfObjectsProtectedBy parameter set
        //
        ...
        //
        [Parameter(
            ParameterSetName = "countOfObjectsProtectedBy",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter countOfObjectsProtectedBy { get; set; }
            ...
            try
            {
                switch(Op)
                {
                    case "Domain":
                        ...
                        break;
                    case "countOfObjectsProtectedBy":
                        this.ProcessRecord_countOfObjectsProtectedBy();
                        break;
                    case "AuditDetail":
        ...
        protected void ProcessRecord_countOfObjectsProtectedBy()
        {
            this._logger.name += " -countOfObjectsProtectedBy";

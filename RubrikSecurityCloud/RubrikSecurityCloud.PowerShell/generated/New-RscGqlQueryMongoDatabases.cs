// New-RscGqlQueryMongoDatabases.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongoDatabases
    /// mongoDatabases(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryMongoDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongoDatabases
}
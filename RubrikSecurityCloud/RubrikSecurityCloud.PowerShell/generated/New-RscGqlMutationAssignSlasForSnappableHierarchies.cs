// New-RscGqlMutationAssignSlasForSnappableHierarchies.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation assignSlasForSnappableHierarchies
    ...
    [Cmdlet(
        "New",
        "RscGqlMutationAssignSlasForSnappableHierarchies")
    ]
    public class New_RscGqlMutationAssignSlasForSnappableHierarchies : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.userNote = <System.String>"
    ...
    } // class New-RscGqlMutationAssignSlasForSnappableHierarchies
}
// New-RscGqlMutationUpdateCloudNativeAwsStorageSetting.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateCloudNativeAwsStorageSetting
    /// updateCloudNativeAwsStorageSetting(input: UpdateCloudNativeAwsStorageSettingInput!): UpdateCloudNativeAwsStorageSettingReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateCloudNativeAwsStorageSetting")
    ]
    public class New_RscGqlMutationUpdateCloudNativeAwsStorageSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateCloudNativeAwsStorageSetting
}
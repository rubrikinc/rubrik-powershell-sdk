// Invoke-RscGqlMutateVsphereExportSnapshotToStandaloneHostV2.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereExportSnapshotToStandaloneHostV2
    /// vsphereExportSnapshotToStandaloneHostV2(input: VsphereExportSnapshotToStandaloneHostV2Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereExportSnapshotToStandaloneHostV2")
    ]
    public class Invoke_RscGqlMutateVsphereExportSnapshotToStandaloneHostV2 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateVsphereExportSnapshotToStandaloneHostV2
}
// New-RscGqlQueryGlobalSlaStatuses.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query globalSlaStatuses
    /// globalSlaStatuses(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class New_RscGqlQueryGlobalSlaStatuses : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.SlaId = <System.String>"
    ...
    } // class New-RscGqlQueryGlobalSlaStatuses
}
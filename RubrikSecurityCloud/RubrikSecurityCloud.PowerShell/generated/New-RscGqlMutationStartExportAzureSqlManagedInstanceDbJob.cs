// New-RscGqlMutationStartExportAzureSqlManagedInstanceDbJob.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation startExportAzureSqlManagedInstanceDbJob
    /// startExportAzureSqlManagedInstanceDbJob(input: StartExportAzureSqlManagedInstanceDbJobInput!): AsyncJobStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationStartExportAzureSqlManagedInstanceDbJob")
    ]
    public class New_RscGqlMutationStartExportAzureSqlManagedInstanceDbJob : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationStartExportAzureSqlManagedInstanceDbJob
}
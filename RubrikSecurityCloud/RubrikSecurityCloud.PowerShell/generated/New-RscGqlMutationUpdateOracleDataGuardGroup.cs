// New-RscGqlMutationUpdateOracleDataGuardGroup.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateOracleDataGuardGroup
    /// updateOracleDataGuardGroup(input: UpdateOracleDataGuardGroupInput!): OracleDbDetail!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateOracleDataGuardGroup")
    ]
    public class New_RscGqlMutationUpdateOracleDataGuardGroup : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateOracleDataGuardGroup
}
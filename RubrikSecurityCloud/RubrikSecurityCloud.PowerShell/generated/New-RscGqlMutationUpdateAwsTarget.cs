// New-RscGqlMutationUpdateAwsTarget.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateAwsTarget
    /// updateAwsTarget(input: UpdateAwsTargetInput!): Target!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateAwsTarget")
    ]
    public class New_RscGqlMutationUpdateAwsTarget : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateAwsTarget
}
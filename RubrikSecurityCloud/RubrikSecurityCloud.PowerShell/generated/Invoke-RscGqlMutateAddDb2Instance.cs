// Invoke-RscGqlMutateAddDb2Instance.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation addDb2Instance
    /// addDb2Instance(input: AddDb2InstanceInput!): AddDb2InstanceReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateAddDb2Instance")
    ]
    public class Invoke_RscGqlMutateAddDb2Instance : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateAddDb2Instance
}
// Invoke-RscGqlMutateRestoreO365TeamsFiles.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation restoreO365TeamsFiles
    /// restoreO365TeamsFiles(input: RestoreO365TeamsFilesInput!): CreateOnDemandJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateRestoreO365TeamsFiles")
    ]
    public class Invoke_RscGqlMutateRestoreO365TeamsFiles : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateRestoreO365TeamsFiles
}
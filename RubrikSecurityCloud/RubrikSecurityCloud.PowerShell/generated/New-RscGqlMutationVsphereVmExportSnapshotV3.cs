// New-RscGqlMutationVsphereVmExportSnapshotV3.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmExportSnapshotV3
    /// vsphereVmExportSnapshotV3(input: VsphereVmExportSnapshotV3Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmExportSnapshotV3")
    ]
    public class New_RscGqlMutationVsphereVmExportSnapshotV3 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmExportSnapshotV3
}
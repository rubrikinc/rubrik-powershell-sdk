// Invoke-RscGqlQueryMongodbDatabases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mongodbDatabases
    /// mongodbDatabases(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryMongodbDatabases")
    ]
    public class Invoke_RscGqlQueryMongodbDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongodbDatabases");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongodbDatabases();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongodbDatabases()
        {
            this._logger.name += " -mongodbDatabases";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryMongodbDatabases
}
// New-RscGqlQueryDb2Instances.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query db2Instances
    /// db2Instances(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "New",
        "RscGqlQueryDb2Instances")
    ]
    public class New_RscGqlQueryDb2Instances : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("db2Instances");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_db2Instances();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_db2Instances()
        {
            this._logger.name += " -db2Instances";
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryDb2Instances
}
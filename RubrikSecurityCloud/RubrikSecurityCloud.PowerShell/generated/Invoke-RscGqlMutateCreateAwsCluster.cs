// Invoke-RscGqlMutateCreateAwsCluster.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createAwsCluster
    /// createAwsCluster(input: CreateAwsClusterInput!): CcProvisionJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateAwsCluster")
    ]
    public class Invoke_RscGqlMutateCreateAwsCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateAwsCluster
}
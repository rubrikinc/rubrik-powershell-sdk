...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    ///
    /// <example>
    /// Runs the TopLevelRecoveryTargets operation
    /// of the 'VMware vSphere' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    public class New_RscQueryVsphere : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "TopLevelDescendantsList":
                        ...
                        break;
                    case "TopLevelRecoveryTargets":
                        this.ProcessRecord_TopLevelRecoveryTargets();
                        break;
                    case "VmsByFids":
        ...
        internal void ProcessRecord_TopLevelRecoveryTargets()
        {
            this._logger.name += " -TopLevelRecoveryTargets";
            // Create new graphql operation vSphereTopLevelRecoveryTargets
            InitQueryVsphereTopLevelRecoveryTargets();
        }
...
$query.Var.filter = @(
	@{
        ...
        //     filter: [Filter!]
        //   ): CdmHierarchyObjectConnection!
        internal void InitQueryVsphereTopLevelRecoveryTargets()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("first", "Int"),
                Tuple.Create("after", "String"),
            ...
            Initialize(
                argDefs,
                "query",
                "QueryVsphereTopLevelRecoveryTargets",
                "($first: Int,$after: String,$sortBy: HierarchySortByField,$sortOrder: SortOrder,$typeFilter: [HierarchyObjectTypeEnum!],$filter: [Filter!])",
                "CdmHierarchyObjectConnection",
                Query.VsphereTopLevelRecoveryTargets,
                Query.VsphereTopLevelRecoveryTargetsFieldSpec,
                @"# OPTIONAL
$query.Var.first = $someInt
# OPTIONAL
$query.Var.after = $someString

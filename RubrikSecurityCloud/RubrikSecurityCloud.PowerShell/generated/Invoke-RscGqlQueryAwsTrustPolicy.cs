// Invoke-RscGqlQueryAwsTrustPolicy.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query awsTrustPolicy
    ...
    public class Invoke_RscGqlQueryAwsTrustPolicy : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlQueryAwsTrustPolicy
}
// Invoke-RscGqlMutateUpdateVsphereVm.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateVsphereVm
    /// updateVsphereVm(input: UpdateVsphereVmInput!): RequestSuccess!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateVsphereVm")
    ]
    public class Invoke_RscGqlMutateUpdateVsphereVm : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateVsphereVm
}
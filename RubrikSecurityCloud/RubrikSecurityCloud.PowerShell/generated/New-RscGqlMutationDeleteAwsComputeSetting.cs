// New-RscGqlMutationDeleteAwsComputeSetting.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation deleteAwsComputeSetting
    /// deleteAwsComputeSetting(input: DeleteAwsComputeSettingInput!): Void
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationDeleteAwsComputeSetting")
    ]
    public class New_RscGqlMutationDeleteAwsComputeSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationDeleteAwsComputeSetting
}
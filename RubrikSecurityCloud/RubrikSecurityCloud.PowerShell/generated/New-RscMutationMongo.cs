...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// 
    /// $query = New-RscMutationMongo -Operation AddOpsManagerManagedSource
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 
    /// $query = New-RscMutationMongo -Operation CreateOnDemandDatabaseBackup
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    ///
    /// <example>
    /// Runs the CreateOpsManagerManagedSourceOnDemandSnapshot operation
    /// of the 'Mongo' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Mongo
    /// # API Operation: CreateOpsManagerManagedSourceOnDemandSnapshot
    /// 
    /// $query = New-RscMutationMongo -Operation CreateOpsManagerManagedSourceOnDemandSnapshot
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 
    /// $query = New-RscMutationMongo -Operation PatchOpsManagerManagedSource
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    ///
    /// <example>
    /// Runs the RecoverOpsManagerManagedSource operation
    /// of the 'Mongo' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Mongo
    /// # API Operation: RecoverOpsManagerManagedSource
    /// 
    /// $query = New-RscMutationMongo -Operation RecoverOpsManagerManagedSource
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// 
    /// $query = New-RscMutationMongo -Operation RetryAddOpsManagerManagedSource
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    public class New_RscMutationMongo : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "PatchSource":
                        ...
                        break;
                    case "RecoverOpsManagerManagedSource":
                        this.ProcessRecord_RecoverOpsManagerManagedSource();
                        break;
                    case "RecoverSource":
        ...
        internal void ProcessRecord_CreateOpsManagerManagedSourceOnDemandSnapshot()
        {
            this._logger.name += " -CreateOpsManagerManagedSourceOnDemandSnapshot";
            // Create new graphql operation createOpsManagerManagedMongoSourceOnDemandSnapshot
            InitMutationCreateOpsManagerManagedMongoSourceOnDemandSnapshot();
        }
        ...
        internal void ProcessRecord_RecoverOpsManagerManagedSource()
        {
            this._logger.name += " -RecoverOpsManagerManagedSource";
            // Create new graphql operation recoverOpsManagerManagedMongoSource
            InitMutationRecoverOpsManagerManagedMongoSource();
        }
...
$query.Var.input = @{
	...
	config = @{
        ...
        // Create new GraphQL Mutation:
        // createOpsManagerManagedMongoSourceOnDemandSnapshot(input: CreateOpsManagerManagedSourceOnDemandSnapshotInput!): AsyncRequestStatus!
        internal void InitMutationCreateOpsManagerManagedMongoSourceOnDemandSnapshot()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "CreateOpsManagerManagedSourceOnDemandSnapshotInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationCreateOpsManagerManagedMongoSourceOnDemandSnapshot",
                "($input: CreateOpsManagerManagedSourceOnDemandSnapshotInput!)",
                "AsyncRequestStatus",
                Mutation.CreateOpsManagerManagedMongoSourceOnDemandSnapshot,
                Mutation.CreateOpsManagerManagedMongoSourceOnDemandSnapshotFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	id = $someString
...
$query.Var.input = @{
	...
	id = $someString
        ...
        // Create new GraphQL Mutation:
        // recoverOpsManagerManagedMongoSource(input: RecoverOpsManagerManagedMongoSourceInput!): AsyncRequestStatus!
        internal void InitMutationRecoverOpsManagerManagedMongoSource()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "RecoverOpsManagerManagedMongoSourceInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationRecoverOpsManagerManagedMongoSource",
                "($input: RecoverOpsManagerManagedMongoSourceInput!)",
                "AsyncRequestStatus",
                Mutation.RecoverOpsManagerManagedMongoSource,
                Mutation.RecoverOpsManagerManagedMongoSourceFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	config = @{

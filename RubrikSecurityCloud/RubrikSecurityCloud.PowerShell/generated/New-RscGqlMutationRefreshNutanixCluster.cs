// New-RscGqlMutationRefreshNutanixCluster.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation refreshNutanixCluster
    /// refreshNutanixCluster(input: RefreshNutanixClusterInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRefreshNutanixCluster")
    ]
    public class New_RscGqlMutationRefreshNutanixCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRefreshNutanixCluster
}
// Invoke-RscGqlMutateVsphereExcludeVmDisks.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereExcludeVmDisks
    /// vsphereExcludeVmDisks(input: [VsphereExcludeVmDisksInput!]!): RequestSuccess!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereExcludeVmDisks")
    ]
    public class Invoke_RscGqlMutateVsphereExcludeVmDisks : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @(
    ...
    } // class Invoke-RscGqlMutateVsphereExcludeVmDisks
}
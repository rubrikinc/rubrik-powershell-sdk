// New-RscGqlQuerySlaManagedVolumes.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query slaManagedVolumes
    /// slaManagedVolumes(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQuerySlaManagedVolumes : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQuerySlaManagedVolumes
}
// Invoke-RscGqlQueryMongoCollections.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mongoCollections
    /// mongoCollections(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryMongoCollections")
    ]
    public class Invoke_RscGqlQueryMongoCollections : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongoCollections");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongoCollections();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongoCollections()
        {
            this._logger.name += " -mongoCollections";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryMongoCollections
}
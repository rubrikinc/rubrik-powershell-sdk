// Invoke-RscGqlQueryO365Onedrives.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365Onedrives
    /// o365Onedrives(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365Onedrives")
    ]
    public class Invoke_RscGqlQueryO365Onedrives : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365Onedrives");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365Onedrives();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365Onedrives()
        {
            this._logger.name += " -o365Onedrives";
...
$inputs.Var.o365OrgId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365Onedrives
}
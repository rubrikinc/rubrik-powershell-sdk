// Invoke-RscGqlQueryO365SharepointObjectList.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365SharepointObjectList
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365SharepointObjectList")
    ]
    public class Invoke_RscGqlQueryO365SharepointObjectList : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365SharepointObjectList");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365SharepointObjectList();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365SharepointObjectList()
        {
            this._logger.name += " -o365SharepointObjectList";
...
$inputs.Var.fid = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365SharepointObjectList
}
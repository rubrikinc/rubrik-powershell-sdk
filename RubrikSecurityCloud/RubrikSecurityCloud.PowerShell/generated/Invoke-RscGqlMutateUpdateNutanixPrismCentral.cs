// Invoke-RscGqlMutateUpdateNutanixPrismCentral.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateNutanixPrismCentral
    /// updateNutanixPrismCentral(input: UpdateNutanixPrismCentralInput!): UpdateNutanixPrismCentralReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateNutanixPrismCentral")
    ]
    public class Invoke_RscGqlMutateUpdateNutanixPrismCentral : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateNutanixPrismCentral
}
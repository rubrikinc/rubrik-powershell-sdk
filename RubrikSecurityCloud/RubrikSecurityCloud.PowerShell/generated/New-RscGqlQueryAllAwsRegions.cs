// New-RscGqlQueryAllAwsRegions.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAwsRegions
    ...
    public class New_RscGqlQueryAllAwsRegions : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.cloudAccountId = <System.String>"
    ...
    } // class New-RscGqlQueryAllAwsRegions
}
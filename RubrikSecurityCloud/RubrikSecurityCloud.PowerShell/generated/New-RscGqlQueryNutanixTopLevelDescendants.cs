// New-RscGqlQueryNutanixTopLevelDescendants.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query nutanixTopLevelDescendants
    ...
    public class New_RscGqlQueryNutanixTopLevelDescendants : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryNutanixTopLevelDescendants
}
// New-RscGqlMutationCreateAwsComputeSetting.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation createAwsComputeSetting
    /// createAwsComputeSetting(input: CreateAwsComputeSettingInput!): AwsComputeSettings!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationCreateAwsComputeSetting")
    ]
    public class New_RscGqlMutationCreateAwsComputeSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationCreateAwsComputeSetting
}
...
namespace Rubrik.SecurityCloud.PowerShell.Cmdlets
{
    ...
    public class Mutate_RscMongo : RscPSCmdlet
    {
        ...
        [Parameter(
            ...
            HelpMessage = "GraphQL operation: addMongoSource(input: AddMongoSourceInput!):AddMongoSourceReply!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL argument input: AddMongoSourceInput!"
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: deleteMongoSource(input: DeleteMongoSourceInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: discoverMongoSource(input: DiscoverMongoSourceInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: patchMongoSource(input: PatchMongoSourceInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: retryAddMongoSource(input: RetryAddMongoSourceInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: assignSlaToMongoDbCollection(input: AssignSlaToMongoDbCollectionInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: recoverMongoSource(input: RecoverMongoSourceInput!):AsyncRequestStatus!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: createMongodbSource(input: AddMosaicSourceInput!):MosaicAsyncResponse!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: updateMongodbSource(input: ModifyMosaicSourceInput!):MosaicAsyncResponse!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: deleteMongodbSource(input: DeleteMosaicSourceInput!):MosaicAsyncResponse!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: bulkDeleteMongodbSources(input: BulkDeleteMosaicSourcesInput!):MosaicAsyncResponse!",
            Position = 0
        )]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage = "GraphQL operation: recoverMongodbSource(input: MosaicRestoreDataInput!):MosaicAsyncResponse!",
            Position = 0
        )]
        ...
        protected void InvokeMutationAddMongoSource()
        {
            ...
            Task<AddMongoSourceReply> task = this._rbkClient.InvokeGenericCallAsync<AddMongoSourceReply>(request, vars, this._logger);
            task.Wait();
            this._logger.Flush();

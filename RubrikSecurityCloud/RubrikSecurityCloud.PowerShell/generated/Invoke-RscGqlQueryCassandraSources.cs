// Invoke-RscGqlQueryCassandraSources.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query cassandraSources
    /// cassandraSources(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryCassandraSources")
    ]
    public class Invoke_RscGqlQueryCassandraSources : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("cassandraSources");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_cassandraSources();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_cassandraSources()
        {
            this._logger.name += " -cassandraSources";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryCassandraSources
}
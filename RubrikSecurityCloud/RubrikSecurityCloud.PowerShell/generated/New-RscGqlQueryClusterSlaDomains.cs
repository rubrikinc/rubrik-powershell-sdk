// New-RscGqlQueryClusterSlaDomains.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query clusterSlaDomains
    /// clusterSlaDomains(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class New_RscGqlQueryClusterSlaDomains : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.before = <System.String>"
    ...
    } // class New-RscGqlQueryClusterSlaDomains
}
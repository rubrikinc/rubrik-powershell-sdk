// Invoke-RscGqlQueryAllAccountProducts.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allAccountProducts
    /// allAccountProducts(
    ...
    public class Invoke_RscGqlQueryAllAccountProducts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.endDateArg = <DateTime>"
    ...
    } // class Invoke-RscGqlQueryAllAccountProducts
}
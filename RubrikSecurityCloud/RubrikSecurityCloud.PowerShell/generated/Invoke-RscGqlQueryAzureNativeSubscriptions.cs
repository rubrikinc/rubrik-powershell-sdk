// Invoke-RscGqlQueryAzureNativeSubscriptions.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureNativeSubscriptions
    ...
    public class Invoke_RscGqlQueryAzureNativeSubscriptions : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.azureNativeProtectionFeature = <AzureNativeProtectionFeature> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AzureNativeProtectionFeature]) for enum values."
    ...
    } // class Invoke-RscGqlQueryAzureNativeSubscriptions
}
// New-RscGqlQueryDoesAzureNativeResourceGroupExist.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query doesAzureNativeResourceGroupExist
    ...
    public class New_RscGqlQueryDoesAzureNativeResourceGroupExist : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.feature = <CloudAccountFeature> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudAccountFeature]) for enum values."
    ...
    } // class New-RscGqlQueryDoesAzureNativeResourceGroupExist
}
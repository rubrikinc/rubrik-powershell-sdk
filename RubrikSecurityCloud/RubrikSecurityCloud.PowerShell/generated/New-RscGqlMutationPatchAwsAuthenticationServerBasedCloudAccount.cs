// New-RscGqlMutationPatchAwsAuthenticationServerBasedCloudAccount.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation patchAwsAuthenticationServerBasedCloudAccount
    /// patchAwsAuthenticationServerBasedCloudAccount(input: PatchAwsAuthenticationServerBasedCloudAccountInput!): Boolean!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationPatchAwsAuthenticationServerBasedCloudAccount")
    ]
    public class New_RscGqlMutationPatchAwsAuthenticationServerBasedCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationPatchAwsAuthenticationServerBasedCloudAccount
}
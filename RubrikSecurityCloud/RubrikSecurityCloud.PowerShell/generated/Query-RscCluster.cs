...
namespace Rubrik.SecurityCloud.PowerShell.Cmdlets
{
    ...
    public class Query_RscCluster : RscPSCmdlet
    {
        ...
        // -------------------------------------------------------------------
        // IsTotpAckNecessaryFor parameter set
        //
        // GraphQL operation: isTotpAckNecessaryForCluster(clusterUuid: UUID!):Boolean!
        //
        [Parameter(
            ParameterSetName = "IsTotpAckNecessaryFor",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
        ...
        public SwitchParameter IsTotpAckNecessaryFor { get; set; }
            ...
            try
            {
                switch(Op)
                {
                    ...
                    case "RegistrationProductInfo":
                        ...
                        break;
                    case "IsTotpAckNecessaryFor":
                        this.ProcessRecord_IsTotpAckNecessaryFor();
                        break;
                    case "TotpAckStatus":
        ...
        protected void ProcessRecord_IsTotpAckNecessaryFor()
        {
            this._logger.name += " -IsTotpAckNecessaryFor";

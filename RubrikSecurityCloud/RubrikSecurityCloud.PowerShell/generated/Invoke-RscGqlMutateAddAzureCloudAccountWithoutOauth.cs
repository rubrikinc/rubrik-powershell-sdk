// Invoke-RscGqlMutateAddAzureCloudAccountWithoutOauth.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation addAzureCloudAccountWithoutOauth
    /// addAzureCloudAccountWithoutOauth(input: AddAzureCloudAccountWithoutOauthInput!): AddAzureCloudAccountWithoutOauthReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateAddAzureCloudAccountWithoutOauth")
    ]
    public class Invoke_RscGqlMutateAddAzureCloudAccountWithoutOauth : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateAddAzureCloudAccountWithoutOauth
}
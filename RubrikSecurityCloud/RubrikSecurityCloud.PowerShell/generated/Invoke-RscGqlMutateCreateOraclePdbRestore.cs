// Invoke-RscGqlMutateCreateOraclePdbRestore.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createOraclePdbRestore
    /// createOraclePdbRestore(input: CreateOraclePdbRestoreInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateOraclePdbRestore")
    ]
    public class Invoke_RscGqlMutateCreateOraclePdbRestore : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateOraclePdbRestore
}
// New-RscGqlQueryValidateAzureNativeSqlManagedInstanceDbNameForExport.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query validateAzureNativeSqlManagedInstanceDbNameForExport
    ...
    public class New_RscGqlQueryValidateAzureNativeSqlManagedInstanceDbNameForExport : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.azureSqlManagedInstanceServerRubrikId = <System.String>"
    ...
    } // class New-RscGqlQueryValidateAzureNativeSqlManagedInstanceDbNameForExport
}
// New-RscGqlMutationUpdateMongodbSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateMongodbSource
    /// updateMongodbSource(input: ModifyMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateMongodbSource")
    ]
    public class New_RscGqlMutationUpdateMongodbSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("updateMongodbSource");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_updateMongodbSource();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_updateMongodbSource()
        {
            this._logger.name += " -updateMongodbSource";
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateMongodbSource
}
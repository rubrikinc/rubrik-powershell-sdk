// Invoke-RscGqlMutateUpdateMongodbSource.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateMongodbSource
    /// updateMongodbSource(input: ModifyMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateMongodbSource")
    ]
    public class Invoke_RscGqlMutateUpdateMongodbSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateMongodbSource
}
// New-RscGqlQueryAllAzureCloudAccountSubscriptionsByFeature.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAzureCloudAccountSubscriptionsByFeature
    ...
    public class New_RscGqlQueryAllAzureCloudAccountSubscriptionsByFeature : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.subscriptionStatusFilters = @(
    ...
    } // class New-RscGqlQueryAllAzureCloudAccountSubscriptionsByFeature
}
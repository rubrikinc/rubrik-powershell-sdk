// Invoke-RscGqlQueryVSphereVmNewConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereVmNewConnection
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryVSphereVmNewConnection")
    ]
    public class Invoke_RscGqlQueryVSphereVmNewConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("vSphereVmNewConnection");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_vSphereVmNewConnection();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_vSphereVmNewConnection()
        {
            this._logger.name += " -vSphereVmNewConnection";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereVmNewConnection
}
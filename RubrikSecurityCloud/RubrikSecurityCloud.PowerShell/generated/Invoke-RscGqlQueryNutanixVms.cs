// Invoke-RscGqlQueryNutanixVms.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query nutanixVms
    /// nutanixVms(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryNutanixVms")
    ]
    public class Invoke_RscGqlQueryNutanixVms : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("nutanixVms");
        }
        ...
        internal void ProcessRecord_nutanixVms()
        {
            this._logger.name += " -nutanixVms";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryNutanixVms
}
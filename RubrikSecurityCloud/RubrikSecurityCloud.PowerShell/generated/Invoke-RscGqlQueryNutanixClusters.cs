// Invoke-RscGqlQueryNutanixClusters.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query nutanixClusters
    /// nutanixClusters(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryNutanixClusters")
    ]
    public class Invoke_RscGqlQueryNutanixClusters : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("nutanixClusters");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_nutanixClusters();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_nutanixClusters()
        {
            this._logger.name += " -nutanixClusters";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryNutanixClusters
}
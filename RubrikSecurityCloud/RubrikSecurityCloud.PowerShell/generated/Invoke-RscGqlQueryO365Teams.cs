// Invoke-RscGqlQueryO365Teams.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365Teams
    /// o365Teams(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365Teams")
    ]
    public class Invoke_RscGqlQueryO365Teams : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365Teams");
        }
        ...
        internal void ProcessRecord_o365Teams()
        {
            this._logger.name += " -o365Teams";
...
$inputs.Var.o365OrgId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365Teams
}
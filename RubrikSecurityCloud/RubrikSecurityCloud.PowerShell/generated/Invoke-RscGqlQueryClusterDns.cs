// Invoke-RscGqlQueryClusterDns.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterDns
    ...
    public class Invoke_RscGqlQueryClusterDns : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.clusterUuid = <System.String>"
    ...
    } // class Invoke-RscGqlQueryClusterDns
}
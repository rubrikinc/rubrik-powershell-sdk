// Invoke-RscGqlMutateBatchExportNutanixVm.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation batchExportNutanixVm
    /// batchExportNutanixVm(input: BatchExportNutanixVmInput!): BatchExportNutanixVmReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateBatchExportNutanixVm")
    ]
    public class Invoke_RscGqlMutateBatchExportNutanixVm : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateBatchExportNutanixVm
}
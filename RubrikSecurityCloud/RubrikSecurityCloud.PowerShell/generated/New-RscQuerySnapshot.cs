...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// # API Operation: ByIds
    /// 
    /// $query = New-RscQuerySnapshot -Operation ByIds
    /// 
    /// # REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: List&lt;GenericSnapshot&gt;
    /// 
    /// 
    /// 
    /// </code>
    ...
    /// )
    /// # OPTIONAL
    /// $query.Var.archivalLocationId = $someString
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    ...
    ///
    /// <example>
    /// Runs the PossibleLocationsForObjects operation
    /// of the 'Snapshot' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Snapshot
    /// # API Operation: PossibleLocationsForObjects
    /// 
    /// $query = New-RscQuerySnapshot -Operation PossibleLocationsForObjects
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: GetPossibleSnapshotLocationsForObjectsResp
    /// 
    /// 
    /// 
    /// </code>
    ...
    public class New_RscQuerySnapshot : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "Polaris":
                        ...
                        break;
                    case "PossibleLocationsForObjects":
                        this.ProcessRecord_PossibleLocationsForObjects();
                        break;
                    case "Pvcs":
        ...
        // This parameter set invokes a single graphql operation:
        // allSnapshotsByIds.
        internal void ProcessRecord_ByIds()
        {
            this._logger.name += " -ByIds";
            // Create new graphql operation allSnapshotsByIds
            InitQueryAllSnapshotsByIds();
        }
        ...
        internal void ProcessRecord_PossibleLocationsForObjects()
        {
            this._logger.name += " -PossibleLocationsForObjects";
            // Create new graphql operation possibleSnapshotLocationsForObjects
            InitQueryPossibleSnapshotLocationsForObjects();
        }
	...
	o365SharepointDelta = @{
        ...
        internal void InitQuerySnapshotFilesDeltaV2()
        {
            ...
            Initialize(
                ...
                "($first: Int,$after: String,$path: String!,$snapshotFid: UUID!,$filter: SnapshotDeltaFilterInput,$searchPrefix: String,$quarantineFilters: [QuarantineFilter!],$sensitiveDataDiscoveryFilters: SensitiveDataDiscoveryFiltersInput,$sort: FileResultSortInput,$workloadFieldsArg: WorkloadFieldsInput)",
                "SnapshotFileDeltaV2Connection",
...
$query.Var.snapshotFid = $someString"
        ...
        // Create new GraphQL Query:
        // possibleSnapshotLocationsForObjects(input: GetPossibleSnapshotLocationsForObjectsInput!): GetPossibleSnapshotLocationsForObjectsResp!
        internal void InitQueryPossibleSnapshotLocationsForObjects()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GetPossibleSnapshotLocationsForObjectsInput!"),
            };
            Initialize(
                argDefs,
                "query",
                "QueryPossibleSnapshotLocationsForObjects",
                "($input: GetPossibleSnapshotLocationsForObjectsInput!)",
                "GetPossibleSnapshotLocationsForObjectsResp",
                Query.PossibleSnapshotLocationsForObjects,
                Query.PossibleSnapshotLocationsForObjectsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	objectIds = @(

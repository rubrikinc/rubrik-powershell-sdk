// Invoke-RscGqlMutateDeleteMongodbSource.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation deleteMongodbSource
    /// deleteMongodbSource(input: DeleteMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateDeleteMongodbSource")
    ]
    public class Invoke_RscGqlMutateDeleteMongodbSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateDeleteMongodbSource
}
// New-RscGqlMutationValidateOracleDatabaseBackups.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation validateOracleDatabaseBackups
    /// validateOracleDatabaseBackups(input: ValidateOracleDatabaseBackupsInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationValidateOracleDatabaseBackups")
    ]
    public class New_RscGqlMutationValidateOracleDatabaseBackups : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationValidateOracleDatabaseBackups
}
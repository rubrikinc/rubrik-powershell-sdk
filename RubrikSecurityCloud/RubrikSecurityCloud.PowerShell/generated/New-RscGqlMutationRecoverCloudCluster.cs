// New-RscGqlMutationRecoverCloudCluster.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation recoverCloudCluster
    /// recoverCloudCluster(input: RecoverCloudClusterInput!): CcProvisionJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRecoverCloudCluster")
    ]
    public class New_RscGqlMutationRecoverCloudCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRecoverCloudCluster
}
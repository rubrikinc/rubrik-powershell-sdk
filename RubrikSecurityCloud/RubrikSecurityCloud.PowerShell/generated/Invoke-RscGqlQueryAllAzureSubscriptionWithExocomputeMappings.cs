// Invoke-RscGqlQueryAllAzureSubscriptionWithExocomputeMappings.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allAzureSubscriptionWithExocomputeMappings
    ...
    public class Invoke_RscGqlQueryAllAzureSubscriptionWithExocomputeMappings : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.exocomputeSubscriptionIdsFilter = @(
    ...
    } // class Invoke-RscGqlQueryAllAzureSubscriptionWithExocomputeMappings
}
...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    public class Invoke_RscGqlQueryO365Orgs : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365Orgs");
        }
        ...
        internal void ProcessRecord_o365Orgs()
        {
            this._logger.name += " -o365Orgs";
...
$inputs.Var.workloadHierarchy = <WorkloadLevelHierarchy> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.WorkloadLevelHierarchy]) for enum values."
    ...
    } // class Invoke-RscGqlQueryO365Orgs
}
...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// one of: -TriggerDetection.
    /// Alternatively, you can specify the operation by setting the
    /// -Op parameter, for example: -Op TriggerDetection,
    /// which is equivalent to specifying -TriggerDetection.
    /// Each operation has its own set of variables that can be set with
    /// the -Var parameter. For more info about the variables, 
    /// call Info() on the object returned by this cmdlet, for example:
    /// (New-RscMutationRansomware -TriggerDetection).Info().
    ...
    [Cmdlet(
        ...
        DefaultParameterSetName = "TriggerDetection")
    ]
    public class New_RscMutationRansomware : RscGqlPSCmdlet
    {
        
        [Parameter(
            ParameterSetName = "TriggerDetection",
            Mandatory = false,
            ValueFromPipelineByPropertyName = true,
            ValueFromPipeline = false,
            HelpMessage =
@"Create a mutation object for the 'TriggerDetection' operation
in the 'Ransomware' API domain.
Description of the operation:
Trigger detect ransomware job for given snapshot.
[GraphQL: https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/triggerransomwaredetection.doc.html]"
            // No Position -> named parameter only.
        )]
        public SwitchParameter TriggerDetection { get; set; }

// New-RscGqlQueryAllAwsComputeSettings.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAwsComputeSettings
    ...
    public class New_RscGqlQueryAllAwsComputeSettings : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.contextFilter = <ContextFilterTypeEnum> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.ContextFilterTypeEnum]) for enum values."
    ...
    } // class New-RscGqlQueryAllAwsComputeSettings
}
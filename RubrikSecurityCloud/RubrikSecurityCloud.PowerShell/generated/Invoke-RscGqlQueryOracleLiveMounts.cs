// Invoke-RscGqlQueryOracleLiveMounts.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query oracleLiveMounts
    /// oracleLiveMounts(
    ///     first: Int
    ///     after: String
    ...
    public class Invoke_RscGqlQueryOracleLiveMounts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.sortBy = @{
    ...
    } // class Invoke-RscGqlQueryOracleLiveMounts
}
// New-RscGqlMutationUpdateVcenter.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateVcenter
    /// updateVcenter(input: UpdateVcenterInput!): UpdateVcenterReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateVcenter")
    ]
    public class New_RscGqlMutationUpdateVcenter : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateVcenter
}
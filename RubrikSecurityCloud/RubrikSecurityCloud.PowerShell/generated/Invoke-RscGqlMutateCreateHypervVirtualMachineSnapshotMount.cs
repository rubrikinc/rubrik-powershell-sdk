// Invoke-RscGqlMutateCreateHypervVirtualMachineSnapshotMount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createHypervVirtualMachineSnapshotMount
    /// createHypervVirtualMachineSnapshotMount(input: CreateHypervVirtualMachineSnapshotMountInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateHypervVirtualMachineSnapshotMount")
    ]
    public class Invoke_RscGqlMutateCreateHypervVirtualMachineSnapshotMount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateHypervVirtualMachineSnapshotMount
}
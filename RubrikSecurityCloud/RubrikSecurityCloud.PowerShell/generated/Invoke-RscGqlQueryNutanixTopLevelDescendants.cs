// Invoke-RscGqlQueryNutanixTopLevelDescendants.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query nutanixTopLevelDescendants
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryNutanixTopLevelDescendants")
    ]
    public class Invoke_RscGqlQueryNutanixTopLevelDescendants : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("nutanixTopLevelDescendants");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_nutanixTopLevelDescendants();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_nutanixTopLevelDescendants()
        {
            this._logger.name += " -nutanixTopLevelDescendants";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryNutanixTopLevelDescendants
}
// New-RscGqlMutationO365SaasSetupComplete.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation o365SaasSetupComplete
    /// o365SaasSetupComplete(input: O365SaasSetupCompleteInput!): AddO365OrgResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationO365SaasSetupComplete")
    ]
    public class New_RscGqlMutationO365SaasSetupComplete : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationO365SaasSetupComplete
}
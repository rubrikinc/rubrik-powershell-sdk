// Invoke-RscGqlMutateVsphereVmExportSnapshotV2.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereVmExportSnapshotV2
    /// vsphereVmExportSnapshotV2(input: VsphereVmExportSnapshotV2Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereVmExportSnapshotV2")
    ]
    public class Invoke_RscGqlMutateVsphereVmExportSnapshotV2 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateVsphereVmExportSnapshotV2
}
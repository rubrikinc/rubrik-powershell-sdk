// Invoke-RscGqlQueryO365Mailboxes.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365Mailboxes
    /// o365Mailboxes(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365Mailboxes")
    ]
    public class Invoke_RscGqlQueryO365Mailboxes : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365Mailboxes");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365Mailboxes();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365Mailboxes()
        {
            this._logger.name += " -o365Mailboxes";
...
$inputs.Var.o365OrgId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365Mailboxes
}
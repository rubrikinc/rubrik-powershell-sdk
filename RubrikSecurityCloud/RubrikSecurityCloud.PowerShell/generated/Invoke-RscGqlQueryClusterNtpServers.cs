// Invoke-RscGqlQueryClusterNtpServers.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterNtpServers
    ...
    public class Invoke_RscGqlQueryClusterNtpServers : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlQueryClusterNtpServers
}
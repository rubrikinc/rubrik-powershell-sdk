// Invoke-RscGqlMutateAddAwsAuthenticationServerBasedCloudAccount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation addAwsAuthenticationServerBasedCloudAccount
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlMutateAddAwsAuthenticationServerBasedCloudAccount")
    ]
    public class Invoke_RscGqlMutateAddAwsAuthenticationServerBasedCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateAddAwsAuthenticationServerBasedCloudAccount
}
// New-RscGqlQueryO365SharepointLists.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query o365SharepointLists
    /// o365SharepointLists(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "New",
        "RscGqlQueryO365SharepointLists")
    ]
    public class New_RscGqlQueryO365SharepointLists : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365SharepointLists");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365SharepointLists();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365SharepointLists()
        {
            this._logger.name += " -o365SharepointLists";
...
$inputs.Var.o365OrgId = <System.String>"
    ...
    } // class New-RscGqlQueryO365SharepointLists
}
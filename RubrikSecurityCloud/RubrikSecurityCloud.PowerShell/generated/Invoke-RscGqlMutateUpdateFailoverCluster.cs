// Invoke-RscGqlMutateUpdateFailoverCluster.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateFailoverCluster
    /// updateFailoverCluster(input: UpdateFailoverClusterInput!): UpdateFailoverClusterReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateFailoverCluster")
    ]
    public class Invoke_RscGqlMutateUpdateFailoverCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateFailoverCluster
}
// Invoke-RscGqlMutateSetLdapMfaSetting.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation setLdapMfaSetting
    /// setLdapMfaSetting(input: SetLdapMfaSettingInput!): Boolean!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateSetLdapMfaSetting")
    ]
    public class Invoke_RscGqlMutateSetLdapMfaSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateSetLdapMfaSetting
}
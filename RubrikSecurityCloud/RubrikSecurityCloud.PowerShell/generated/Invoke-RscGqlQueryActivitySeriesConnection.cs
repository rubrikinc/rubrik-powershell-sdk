// Invoke-RscGqlQueryActivitySeriesConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query activitySeriesConnection
    ...
    public class Invoke_RscGqlQueryActivitySeriesConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filters = @{
    ...
    } // class Invoke-RscGqlQueryActivitySeriesConnection
}
// New-RscGqlQueryAllAzureNativeSecurityGroupsByRegionFromAzure.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAzureNativeSecurityGroupsByRegionFromAzure
    ...
    public class New_RscGqlQueryAllAzureNativeSecurityGroupsByRegionFromAzure : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.region = <AzureNativeRegion> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AzureNativeRegion]) for enum values."
    ...
    } // class New-RscGqlQueryAllAzureNativeSecurityGroupsByRegionFromAzure
}
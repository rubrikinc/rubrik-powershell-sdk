// New-RscGqlMutationRestoreO365Snappable.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation restoreO365Snappable
    /// restoreO365Snappable(input: RestoreO365SnappableInput!): CreateOnDemandJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRestoreO365Snappable")
    ]
    public class New_RscGqlMutationRestoreO365Snappable : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRestoreO365Snappable
}
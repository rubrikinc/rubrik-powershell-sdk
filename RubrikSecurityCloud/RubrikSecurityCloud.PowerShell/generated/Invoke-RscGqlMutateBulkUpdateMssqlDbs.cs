// Invoke-RscGqlMutateBulkUpdateMssqlDbs.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation bulkUpdateMssqlDbs
    /// bulkUpdateMssqlDbs(input: BulkUpdateMssqlDbsInput!): BulkUpdateMssqlDbsReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateBulkUpdateMssqlDbs")
    ]
    public class Invoke_RscGqlMutateBulkUpdateMssqlDbs : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateBulkUpdateMssqlDbs
}
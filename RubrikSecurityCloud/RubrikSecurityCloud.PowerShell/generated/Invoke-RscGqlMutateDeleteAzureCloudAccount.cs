// Invoke-RscGqlMutateDeleteAzureCloudAccount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation deleteAzureCloudAccount
    /// deleteAzureCloudAccount(input: DeleteAzureCloudAccountInput!): DeleteAzureCloudAccountReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateDeleteAzureCloudAccount")
    ]
    public class Invoke_RscGqlMutateDeleteAzureCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateDeleteAzureCloudAccount
}
// Invoke-RscGqlQueryListO365Apps.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query listO365Apps
    /// listO365Apps(
    ///     first: Int
    ///     after: String
    ...
    public class Invoke_RscGqlQueryListO365Apps : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.o365AppSortByParam = @{
    ...
    } // class Invoke-RscGqlQueryListO365Apps
}
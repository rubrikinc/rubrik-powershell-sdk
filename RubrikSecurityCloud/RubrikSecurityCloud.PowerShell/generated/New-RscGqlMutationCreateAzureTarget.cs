// New-RscGqlMutationCreateAzureTarget.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation createAzureTarget
    /// createAzureTarget(input: CreateAzureTargetInput!): Target!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationCreateAzureTarget")
    ]
    public class New_RscGqlMutationCreateAzureTarget : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationCreateAzureTarget
}
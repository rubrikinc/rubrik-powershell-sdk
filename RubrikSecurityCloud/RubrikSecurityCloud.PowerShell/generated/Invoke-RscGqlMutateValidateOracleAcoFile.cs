// Invoke-RscGqlMutateValidateOracleAcoFile.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation validateOracleAcoFile
    /// validateOracleAcoFile(input: ValidateOracleAcoFileInput!): ValidateOracleAcoFileReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateValidateOracleAcoFile")
    ]
    public class Invoke_RscGqlMutateValidateOracleAcoFile : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateValidateOracleAcoFile
}
// Invoke-RscGqlMutateCreateAzureCluster.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createAzureCluster
    /// createAzureCluster(input: CreateAzureClusterInput!): CcProvisionJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateAzureCluster")
    ]
    public class Invoke_RscGqlMutateCreateAzureCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateAzureCluster
}
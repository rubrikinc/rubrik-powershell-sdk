// New-RscGqlQueryMssqlDatabases.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mssqlDatabases
    /// mssqlDatabases(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryMssqlDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMssqlDatabases
}
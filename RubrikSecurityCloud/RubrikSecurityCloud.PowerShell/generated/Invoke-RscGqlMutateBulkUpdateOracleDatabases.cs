// Invoke-RscGqlMutateBulkUpdateOracleDatabases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation bulkUpdateOracleDatabases
    /// bulkUpdateOracleDatabases(input: BulkUpdateOracleDatabasesInput!): BulkUpdateOracleDatabasesReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateBulkUpdateOracleDatabases")
    ]
    public class Invoke_RscGqlMutateBulkUpdateOracleDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateBulkUpdateOracleDatabases
}
// Invoke-RscGqlQueryClusterReportMigrationCount.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterReportMigrationCount
    ...
    public class Invoke_RscGqlQueryClusterReportMigrationCount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.status = @(
    ...
    } // class Invoke-RscGqlQueryClusterReportMigrationCount
}
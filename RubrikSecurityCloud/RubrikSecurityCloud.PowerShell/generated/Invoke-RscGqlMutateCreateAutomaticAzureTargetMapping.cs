// Invoke-RscGqlMutateCreateAutomaticAzureTargetMapping.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createAutomaticAzureTargetMapping
    /// createAutomaticAzureTargetMapping(input: CreateAutomaticAzureTargetMappingInput!): TargetMapping!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateAutomaticAzureTargetMapping")
    ]
    public class Invoke_RscGqlMutateCreateAutomaticAzureTargetMapping : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateAutomaticAzureTargetMapping
}
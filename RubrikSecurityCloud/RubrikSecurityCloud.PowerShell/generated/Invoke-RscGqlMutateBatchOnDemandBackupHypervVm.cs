// Invoke-RscGqlMutateBatchOnDemandBackupHypervVm.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation batchOnDemandBackupHypervVm
    /// batchOnDemandBackupHypervVm(input: BatchOnDemandBackupHypervVmInput!): BatchOnDemandBackupHypervVmReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateBatchOnDemandBackupHypervVm")
    ]
    public class Invoke_RscGqlMutateBatchOnDemandBackupHypervVm : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateBatchOnDemandBackupHypervVm
}
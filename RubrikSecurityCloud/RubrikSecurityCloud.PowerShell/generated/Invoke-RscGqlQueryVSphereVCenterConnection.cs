// Invoke-RscGqlQueryVSphereVCenterConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereVCenterConnection
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryVSphereVCenterConnection")
    ]
    public class Invoke_RscGqlQueryVSphereVCenterConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("vSphereVCenterConnection");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_vSphereVCenterConnection();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_vSphereVCenterConnection()
        {
            this._logger.name += " -vSphereVCenterConnection";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereVCenterConnection
}
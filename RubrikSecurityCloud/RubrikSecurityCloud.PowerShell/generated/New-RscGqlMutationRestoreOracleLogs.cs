// New-RscGqlMutationRestoreOracleLogs.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation restoreOracleLogs
    /// restoreOracleLogs(input: RestoreOracleLogsInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRestoreOracleLogs")
    ]
    public class New_RscGqlMutationRestoreOracleLogs : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRestoreOracleLogs
}
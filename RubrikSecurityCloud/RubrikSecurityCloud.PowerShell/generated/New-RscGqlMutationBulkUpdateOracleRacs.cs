// New-RscGqlMutationBulkUpdateOracleRacs.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation bulkUpdateOracleRacs
    /// bulkUpdateOracleRacs(input: BulkUpdateOracleRacsInput!): BulkUpdateOracleRacsReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationBulkUpdateOracleRacs")
    ]
    public class New_RscGqlMutationBulkUpdateOracleRacs : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationBulkUpdateOracleRacs
}
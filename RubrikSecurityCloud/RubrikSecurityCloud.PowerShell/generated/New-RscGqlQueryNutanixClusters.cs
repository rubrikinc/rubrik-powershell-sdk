// New-RscGqlQueryNutanixClusters.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query nutanixClusters
    /// nutanixClusters(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryNutanixClusters : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryNutanixClusters
}
// Invoke-RscGqlMutateO365PdlGroups.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation o365PdlGroups
    /// o365PdlGroups(input: O365PdlGroupsInput!): O365PdlGroupsReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateO365PdlGroups")
    ]
    public class Invoke_RscGqlMutateO365PdlGroups : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateO365PdlGroups
}
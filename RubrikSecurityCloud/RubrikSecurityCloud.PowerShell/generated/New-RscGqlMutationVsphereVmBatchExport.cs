// New-RscGqlMutationVsphereVmBatchExport.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmBatchExport
    /// vsphereVmBatchExport(input: VsphereVmBatchExportInput!): BatchAsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmBatchExport")
    ]
    public class New_RscGqlMutationVsphereVmBatchExport : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmBatchExport
}
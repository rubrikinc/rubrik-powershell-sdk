// Invoke-RscGqlMutateCreateNutanixCluster.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createNutanixCluster
    /// createNutanixCluster(input: CreateNutanixClusterInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateNutanixCluster")
    ]
    public class Invoke_RscGqlMutateCreateNutanixCluster : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateNutanixCluster
}
// Invoke-RscGqlMutateUpdateNutanixVm.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateNutanixVm
    /// updateNutanixVm(input: UpdateNutanixVmInput!): Void
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateNutanixVm")
    ]
    public class Invoke_RscGqlMutateUpdateNutanixVm : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateNutanixVm
}
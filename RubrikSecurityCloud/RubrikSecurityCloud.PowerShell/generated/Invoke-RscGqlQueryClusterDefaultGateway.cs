// Invoke-RscGqlQueryClusterDefaultGateway.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterDefaultGateway
    ...
    public class Invoke_RscGqlQueryClusterDefaultGateway : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlQueryClusterDefaultGateway
}
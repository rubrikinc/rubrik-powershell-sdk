...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// -Op parameter, for example: -Op Webhook,
    /// which is equivalent to specifying -Webhook.
    ...
    public class New_RscQueryWebhook : RscGqlPSCmdlet
    {
        ...
        [Parameter(
            ...
            HelpMessage =
@"Create a query object for the 'Webhook' operation
in the 'Webhook' API domain.
Description of the operation:
All webhooks in the account.
[GraphQL: https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/allwebhooks.doc.html]"
            // No Position -> named parameter only.
        )]
        public SwitchParameter Webhook { get; set; }

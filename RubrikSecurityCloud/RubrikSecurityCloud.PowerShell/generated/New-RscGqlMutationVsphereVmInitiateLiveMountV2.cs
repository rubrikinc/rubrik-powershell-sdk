// New-RscGqlMutationVsphereVmInitiateLiveMountV2.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation vsphereVmInitiateLiveMountV2
    /// vsphereVmInitiateLiveMountV2(input: VsphereVmInitiateLiveMountV2Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationVsphereVmInitiateLiveMountV2")
    ]
    public class New_RscGqlMutationVsphereVmInitiateLiveMountV2 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationVsphereVmInitiateLiveMountV2
}
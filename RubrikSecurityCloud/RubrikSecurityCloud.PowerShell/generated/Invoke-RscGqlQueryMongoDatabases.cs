// Invoke-RscGqlQueryMongoDatabases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mongoDatabases
    /// mongoDatabases(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryMongoDatabases")
    ]
    public class Invoke_RscGqlQueryMongoDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongoDatabases");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongoDatabases();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongoDatabases()
        {
            this._logger.name += " -mongoDatabases";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryMongoDatabases
}
...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    public class New_RscMutationFileset : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "BulkUpdateTemplate":
                        ...
                        break;
                    case "GenerateBackupReport":
                        this.ProcessRecord_GenerateBackupReport();
                        break;
                    case "RecoverFiles":
        ...
        internal void ProcessRecord_GenerateBackupReport()
        {
            this._logger.name += " -GenerateBackupReport";
            // Create new graphql operation generateFilesetBackupReport
            InitMutationGenerateFilesetBackupReport();
        }
...
$query.Var.input = @{
	...
	definitions = @(
        ...
        // Create new GraphQL Mutation:
        // generateFilesetBackupReport(input: GenerateFilesetBackupReportInput!): AsyncRequestStatus!
        internal void InitMutationGenerateFilesetBackupReport()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "GenerateFilesetBackupReportInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationGenerateFilesetBackupReport",
                "($input: GenerateFilesetBackupReportInput!)",
                "AsyncRequestStatus",
                Mutation.GenerateFilesetBackupReport,
                Mutation.GenerateFilesetBackupReportFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	id = $someString

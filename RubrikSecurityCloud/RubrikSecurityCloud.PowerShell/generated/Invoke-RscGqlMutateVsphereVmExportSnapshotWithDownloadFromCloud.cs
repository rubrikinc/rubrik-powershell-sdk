// Invoke-RscGqlMutateVsphereVmExportSnapshotWithDownloadFromCloud.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereVmExportSnapshotWithDownloadFromCloud
    /// vsphereVmExportSnapshotWithDownloadFromCloud(input: VsphereVmExportSnapshotWithDownloadFromCloudInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereVmExportSnapshotWithDownloadFromCloud")
    ]
    public class Invoke_RscGqlMutateVsphereVmExportSnapshotWithDownloadFromCloud : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateVsphereVmExportSnapshotWithDownloadFromCloud
}
// New-RscGqlQueryMssqlTopLevelDescendants.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mssqlTopLevelDescendants
    ...
    public class New_RscGqlQueryMssqlTopLevelDescendants : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMssqlTopLevelDescendants
}
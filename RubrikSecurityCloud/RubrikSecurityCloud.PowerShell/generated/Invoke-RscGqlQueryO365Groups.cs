// Invoke-RscGqlQueryO365Groups.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365Groups
    /// o365Groups(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365Groups")
    ]
    public class Invoke_RscGqlQueryO365Groups : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365Groups");
        }
        ...
        internal void ProcessRecord_o365Groups()
        {
            this._logger.name += " -o365Groups";
...
$inputs.Var.snappableType = <SnappableType> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.SnappableType]) for enum values."
    ...
    } // class Invoke-RscGqlQueryO365Groups
}
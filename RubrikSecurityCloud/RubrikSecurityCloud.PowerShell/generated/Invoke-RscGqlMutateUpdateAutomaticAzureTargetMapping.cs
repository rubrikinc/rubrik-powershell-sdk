// Invoke-RscGqlMutateUpdateAutomaticAzureTargetMapping.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateAutomaticAzureTargetMapping
    /// updateAutomaticAzureTargetMapping(input: UpdateAutomaticAzureTargetMappingInput!): TargetMapping!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateAutomaticAzureTargetMapping")
    ]
    public class Invoke_RscGqlMutateUpdateAutomaticAzureTargetMapping : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateUpdateAutomaticAzureTargetMapping
}
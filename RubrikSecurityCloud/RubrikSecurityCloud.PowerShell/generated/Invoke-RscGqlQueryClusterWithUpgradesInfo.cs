// Invoke-RscGqlQueryClusterWithUpgradesInfo.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query clusterWithUpgradesInfo
    ...
    public class Invoke_RscGqlQueryClusterWithUpgradesInfo : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.sortBy = <UpgradeInfoSortByEnum> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.UpgradeInfoSortByEnum]) for enum values."
    ...
    } // class Invoke-RscGqlQueryClusterWithUpgradesInfo
}
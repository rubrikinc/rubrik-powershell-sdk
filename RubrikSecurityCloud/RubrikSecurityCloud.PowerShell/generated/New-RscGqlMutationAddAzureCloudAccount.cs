// New-RscGqlMutationAddAzureCloudAccount.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation addAzureCloudAccount
    /// addAzureCloudAccount(input: AddAzureCloudAccountInput!): AddAzureCloudAccountReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationAddAzureCloudAccount")
    ]
    public class New_RscGqlMutationAddAzureCloudAccount : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationAddAzureCloudAccount
}
// New-RscGqlMutationRestoreO365TeamsConversations.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation restoreO365TeamsConversations
    /// restoreO365TeamsConversations(input: RestoreO365TeamsConversationsInput!): CreateOnDemandJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRestoreO365TeamsConversations")
    ]
    public class New_RscGqlMutationRestoreO365TeamsConversations : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRestoreO365TeamsConversations
}
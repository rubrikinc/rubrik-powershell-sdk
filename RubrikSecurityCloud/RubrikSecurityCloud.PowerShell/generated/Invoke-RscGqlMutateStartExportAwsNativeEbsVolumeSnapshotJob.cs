// Invoke-RscGqlMutateStartExportAwsNativeEbsVolumeSnapshotJob.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation startExportAwsNativeEbsVolumeSnapshotJob
    /// startExportAwsNativeEbsVolumeSnapshotJob(input: StartExportAwsNativeEbsVolumeSnapshotJobInput!): AsyncJobStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateStartExportAwsNativeEbsVolumeSnapshotJob")
    ]
    public class Invoke_RscGqlMutateStartExportAwsNativeEbsVolumeSnapshotJob : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateStartExportAwsNativeEbsVolumeSnapshotJob
}
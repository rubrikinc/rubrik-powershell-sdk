// New-RscGqlMutationSetupAzureO365Exocompute.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation setupAzureO365Exocompute
    ...
    [Cmdlet(
        "New",
        "RscGqlMutationSetupAzureO365Exocompute")
    ]
    public class New_RscGqlMutationSetupAzureO365Exocompute : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.exocomputeConfig = @{
    ...
    } // class New-RscGqlMutationSetupAzureO365Exocompute
}
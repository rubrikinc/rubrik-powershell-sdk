// Invoke-RscGqlMutateCreateMongodbSource.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createMongodbSource
    /// createMongodbSource(input: AddMosaicSourceInput!): MosaicAsyncResponse!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateMongodbSource")
    ]
    public class Invoke_RscGqlMutateCreateMongodbSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateMongodbSource
}
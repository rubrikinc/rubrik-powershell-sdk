...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    /// Create, CreateV2, Delete, DeleteV2, GeneratePreviewMessageForTemplate, SendTestMessageTo, SendTestMessageToExisting, Test, TestExisting, Update, UpdateStatus, or UpdateV2.
    /// </summary>
    /// <description>
    ...
    /// -Operation parameter;
    /// one of: Create, CreateV2, Delete, DeleteV2, GeneratePreviewMessageForTemplate, SendTestMessageTo, SendTestMessageToExisting, Test, TestExisting, Update, UpdateStatus, or UpdateV2.
    ...
    ///
    /// <example>
    /// Runs the UpdateStatus operation
    /// of the 'Webhook' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Webhook
    /// # API Operation: UpdateStatus
    /// 
    /// $query = New-RscMutationWebhook -Operation UpdateStatus
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    /// 	id = $someInt
    /// 	# REQUIRED
    /// 	status = $someWebhookStatusV2 # Call [Enum]::GetValues([RubrikSecurityCloud.Types.WebhookStatusV2]) for enum values.
    /// }
    /// 
    /// # Execute the query
    /// 
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: UpdateWebhookStatusReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    public class New_RscMutationWebhook : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "Update":
                        ...
                        break;
                    case "UpdateStatus":
                        this.ProcessRecord_UpdateStatus();
                        break;
                    case "UpdateV2":
        ...
        // This parameter set invokes a single graphql operation:
        // updateWebhookStatus.
        internal void ProcessRecord_UpdateStatus()
        {
            this._logger.name += " -UpdateStatus";
            // Create new graphql operation updateWebhookStatus
            InitMutationUpdateWebhookStatus();
        }
...
$query.Var.input = @{
	...
	shouldSendTestEvent = $someBoolean
        ...
        // Create new GraphQL Mutation:
        // updateWebhookStatus(input: UpdateWebhookStatusInput!): UpdateWebhookStatusReply!
        internal void InitMutationUpdateWebhookStatus()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "UpdateWebhookStatusInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationUpdateWebhookStatus",
                "($input: UpdateWebhookStatusInput!)",
                "UpdateWebhookStatusReply",
                Mutation.UpdateWebhookStatus,
                Mutation.UpdateWebhookStatusFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	id = $someInt

// New-RscGqlMutationRetryAddMongoSource.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation retryAddMongoSource
    /// retryAddMongoSource(input: RetryAddMongoSourceInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationRetryAddMongoSource")
    ]
    public class New_RscGqlMutationRetryAddMongoSource : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationRetryAddMongoSource
}
// Invoke-RscGqlQueryHypervTopLevelDescendants.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query hypervTopLevelDescendants
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryHypervTopLevelDescendants")
    ]
    public class Invoke_RscGqlQueryHypervTopLevelDescendants : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("hypervTopLevelDescendants");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_hypervTopLevelDescendants();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_hypervTopLevelDescendants()
        {
            this._logger.name += " -hypervTopLevelDescendants";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryHypervTopLevelDescendants
}
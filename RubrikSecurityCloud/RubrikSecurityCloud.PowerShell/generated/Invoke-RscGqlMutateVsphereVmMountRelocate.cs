// Invoke-RscGqlMutateVsphereVmMountRelocate.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereVmMountRelocate
    /// vsphereVmMountRelocate(input: VsphereVmMountRelocateInput!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereVmMountRelocate")
    ]
    public class Invoke_RscGqlMutateVsphereVmMountRelocate : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateVsphereVmMountRelocate
}
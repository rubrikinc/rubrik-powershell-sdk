// Invoke-RscGqlQueryVSphereHostsByFids.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereHostsByFids
    ...
    public class Invoke_RscGqlQueryVSphereHostsByFids : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.fids = @(
    ...
    } // class Invoke-RscGqlQueryVSphereHostsByFids
}
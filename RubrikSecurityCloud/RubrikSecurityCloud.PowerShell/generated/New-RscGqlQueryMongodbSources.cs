// New-RscGqlQueryMongodbSources.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongodbSources
    /// mongodbSources(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "New",
        "RscGqlQueryMongodbSources")
    ]
    public class New_RscGqlQueryMongodbSources : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("mongodbSources");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_mongodbSources();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_mongodbSources()
        {
            this._logger.name += " -mongodbSources";
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongodbSources
}
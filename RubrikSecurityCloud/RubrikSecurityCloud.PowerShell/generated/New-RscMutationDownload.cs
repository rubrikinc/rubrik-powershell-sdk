...
namespace RubrikSecurityCloud.PowerShell.Cmdlets
{
    ...
    ///
    /// <example>
    /// Runs the SalesforceArchivedRecords operation
    /// of the 'Report Download' API domain.
    /// <code>
    /// PS &gt;
    ///
    ...
    /// # Create an RscQuery object for:
    /// # API Domain:    Download
    /// # API Operation: SalesforceArchivedRecords
    /// 
    /// $query = New-RscMutationDownload -Operation SalesforceArchivedRecords
    /// 
    /// # REQUIRED
    /// $query.Var.input = @{
    /// 	# REQUIRED
    ...
    /// $result = $query | Invoke-Rsc
    /// 
    /// Write-Host $result.GetType().Name # prints: DownloadSalesforceArchivedRecordsReply
    /// 
    /// 
    /// 
    /// </code>
    ...
    public class New_RscMutationDownload : RscGqlPSCmdlet
    {
            ...
            try
            {
                switch(this.GetOp().OpName())
                {
                    ...
                    case "ResultsCsv":
                        ...
                        break;
                    case "SalesforceArchivedRecords":
                        this.ProcessRecord_SalesforceArchivedRecords();
                        break;
        ...
        internal void ProcessRecord_SalesforceArchivedRecords()
        {
            this._logger.name += " -SalesforceArchivedRecords";
            // Create new graphql operation downloadSalesforceArchivedRecords
            InitMutationDownloadSalesforceArchivedRecords();
        }
...
$query.Var.downloadFilter = @{
	...
	policyViolationId = $someString
        ...
        // Create new GraphQL Mutation:
        // downloadSalesforceArchivedRecords(input: DownloadSalesforceArchivedRecordsInput!): DownloadSalesforceArchivedRecordsReply!
        internal void InitMutationDownloadSalesforceArchivedRecords()
        {
            Tuple<string, string>[] argDefs = {
                Tuple.Create("input", "DownloadSalesforceArchivedRecordsInput!"),
            };
            Initialize(
                argDefs,
                "mutation",
                "MutationDownloadSalesforceArchivedRecords",
                "($input: DownloadSalesforceArchivedRecordsInput!)",
                "DownloadSalesforceArchivedRecordsReply",
                Mutation.DownloadSalesforceArchivedRecords,
                Mutation.DownloadSalesforceArchivedRecordsFieldSpec,
                @"# REQUIRED
$query.Var.input = @{
	# REQUIRED
	orgId = $someString

// Invoke-RscGqlQueryDb2Databases.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query db2Databases
    /// db2Databases(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryDb2Databases")
    ]
    public class Invoke_RscGqlQueryDb2Databases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("db2Databases");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_db2Databases();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_db2Databases()
        {
            this._logger.name += " -db2Databases";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryDb2Databases
}
// Invoke-RscGqlQueryAllO365AdGroups.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allO365AdGroups
    ...
    public class Invoke_RscGqlQueryAllO365AdGroups : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.adGroupSearchFilter = <System.String>"
    ...
    } // class Invoke-RscGqlQueryAllO365AdGroups
}
// Invoke-RscGqlQueryAzureNativeVirtualMachines.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureNativeVirtualMachines
    ...
    public class Invoke_RscGqlQueryAzureNativeVirtualMachines : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.virtualMachineFilters = @{
    ...
    } // class Invoke-RscGqlQueryAzureNativeVirtualMachines
}
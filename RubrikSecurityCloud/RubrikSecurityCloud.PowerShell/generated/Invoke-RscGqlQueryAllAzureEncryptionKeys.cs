// Invoke-RscGqlQueryAllAzureEncryptionKeys.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allAzureEncryptionKeys
    ...
    public class Invoke_RscGqlQueryAllAzureEncryptionKeys : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.azureEncryptionKeysInput = @{
    ...
    } // class Invoke-RscGqlQueryAllAzureEncryptionKeys
}
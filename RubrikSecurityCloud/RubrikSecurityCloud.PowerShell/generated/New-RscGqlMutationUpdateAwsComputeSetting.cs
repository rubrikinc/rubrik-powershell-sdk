// New-RscGqlMutationUpdateAwsComputeSetting.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation updateAwsComputeSetting
    /// updateAwsComputeSetting(input: UpdateAwsComputeSettingInput!): AwsComputeSettings!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationUpdateAwsComputeSetting")
    ]
    public class New_RscGqlMutationUpdateAwsComputeSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationUpdateAwsComputeSetting
}
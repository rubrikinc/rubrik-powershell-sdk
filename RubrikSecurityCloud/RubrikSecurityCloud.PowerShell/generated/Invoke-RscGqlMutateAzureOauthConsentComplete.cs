// Invoke-RscGqlMutateAzureOauthConsentComplete.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation azureOauthConsentComplete
    /// azureOauthConsentComplete(input: AzureOauthConsentCompleteInput!): RequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateAzureOauthConsentComplete")
    ]
    public class Invoke_RscGqlMutateAzureOauthConsentComplete : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateAzureOauthConsentComplete
}
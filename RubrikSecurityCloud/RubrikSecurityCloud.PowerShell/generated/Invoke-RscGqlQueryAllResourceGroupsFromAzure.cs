// Invoke-RscGqlQueryAllResourceGroupsFromAzure.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query allResourceGroupsFromAzure
    ...
    public class Invoke_RscGqlQueryAllResourceGroupsFromAzure : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.feature = <CloudAccountFeature> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.CloudAccountFeature]) for enum values."
    ...
    } // class Invoke-RscGqlQueryAllResourceGroupsFromAzure
}
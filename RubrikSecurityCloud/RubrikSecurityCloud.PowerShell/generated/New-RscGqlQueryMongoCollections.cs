// New-RscGqlQueryMongoCollections.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query mongoCollections
    /// mongoCollections(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryMongoCollections : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryMongoCollections
}
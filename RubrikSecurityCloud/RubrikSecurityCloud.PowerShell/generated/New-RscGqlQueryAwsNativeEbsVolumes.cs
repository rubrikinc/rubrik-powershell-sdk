// New-RscGqlQueryAwsNativeEbsVolumes.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query awsNativeEbsVolumes
    /// awsNativeEbsVolumes(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class New_RscGqlQueryAwsNativeEbsVolumes : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.ebsVolumeFilters = @{
    ...
    } // class New-RscGqlQueryAwsNativeEbsVolumes
}
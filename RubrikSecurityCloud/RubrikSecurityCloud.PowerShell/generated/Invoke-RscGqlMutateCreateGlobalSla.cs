// Invoke-RscGqlMutateCreateGlobalSla.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createGlobalSla
    /// createGlobalSla(input: CreateGlobalSlaInput!): GlobalSlaReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateGlobalSla")
    ]
    public class Invoke_RscGqlMutateCreateGlobalSla : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateGlobalSla
}
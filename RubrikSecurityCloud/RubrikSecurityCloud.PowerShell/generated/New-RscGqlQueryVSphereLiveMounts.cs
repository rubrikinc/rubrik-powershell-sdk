// New-RscGqlQueryVSphereLiveMounts.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query vSphereLiveMounts
    /// vSphereLiveMounts(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryVSphereLiveMounts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.sortBy = @{
    ...
    } // class New-RscGqlQueryVSphereLiveMounts
}
// New-RscGqlQueryAzureSqlDatabases.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query azureSqlDatabases
    /// azureSqlDatabases(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class New_RscGqlQueryAzureSqlDatabases : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.azureSqlDatabaseFilters = @{
    ...
    } // class New-RscGqlQueryAzureSqlDatabases
}
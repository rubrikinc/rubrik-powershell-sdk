// Invoke-RscGqlQueryVSphereHostConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query vSphereHostConnection
    ...
    public class Invoke_RscGqlQueryVSphereHostConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryVSphereHostConnection
}
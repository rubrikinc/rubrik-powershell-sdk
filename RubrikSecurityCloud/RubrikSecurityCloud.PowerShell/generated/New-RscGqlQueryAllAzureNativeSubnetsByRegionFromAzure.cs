// New-RscGqlQueryAllAzureNativeSubnetsByRegionFromAzure.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query allAzureNativeSubnetsByRegionFromAzure
    ...
    public class New_RscGqlQueryAllAzureNativeSubnetsByRegionFromAzure : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.region = <AzureNativeRegion> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AzureNativeRegion]) for enum values."
    ...
    } // class New-RscGqlQueryAllAzureNativeSubnetsByRegionFromAzure
}
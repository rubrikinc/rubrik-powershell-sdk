// New-RscGqlQuerySlaAuditDetail.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query slaAuditDetail
    /// slaAuditDetail(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class New_RscGqlQuerySlaAuditDetail : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.timezone = <System.String>"
    ...
    } // class New-RscGqlQuerySlaAuditDetail
}
// Invoke-RscGqlMutateCreateAwsTarget.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createAwsTarget
    /// createAwsTarget(input: CreateAwsTargetInput!): Target!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateAwsTarget")
    ]
    public class Invoke_RscGqlMutateCreateAwsTarget : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateAwsTarget
}
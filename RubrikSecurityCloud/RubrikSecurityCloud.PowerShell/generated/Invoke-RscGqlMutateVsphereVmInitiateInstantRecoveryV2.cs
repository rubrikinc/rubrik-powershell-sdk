// Invoke-RscGqlMutateVsphereVmInitiateInstantRecoveryV2.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation vsphereVmInitiateInstantRecoveryV2
    /// vsphereVmInitiateInstantRecoveryV2(input: VsphereVmInitiateInstantRecoveryV2Input!): AsyncRequestStatus!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateVsphereVmInitiateInstantRecoveryV2")
    ]
    public class Invoke_RscGqlMutateVsphereVmInitiateInstantRecoveryV2 : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateVsphereVmInitiateInstantRecoveryV2
}
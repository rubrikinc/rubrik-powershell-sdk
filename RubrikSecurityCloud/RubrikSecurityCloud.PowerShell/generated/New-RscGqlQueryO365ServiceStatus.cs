// New-RscGqlQueryO365ServiceStatus.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query o365ServiceStatus
    ...
    public class New_RscGqlQueryO365ServiceStatus : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.orgID = <System.String>"
    ...
    } // class New-RscGqlQueryO365ServiceStatus
}
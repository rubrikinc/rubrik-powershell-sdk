// Invoke-RscGqlMutateExportO365Mailbox.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation exportO365Mailbox
    /// exportO365Mailbox(exportConfig: ExportO365MailboxInput!): CreateOnDemandJobReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateExportO365Mailbox")
    ]
    public class Invoke_RscGqlMutateExportO365Mailbox : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.exportConfig = @{
    ...
    } // class Invoke-RscGqlMutateExportO365Mailbox
}
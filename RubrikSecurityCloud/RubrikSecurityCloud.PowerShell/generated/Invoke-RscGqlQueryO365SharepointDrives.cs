// Invoke-RscGqlQueryO365SharepointDrives.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365SharepointDrives
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365SharepointDrives")
    ]
    public class Invoke_RscGqlQueryO365SharepointDrives : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365SharepointDrives");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365SharepointDrives();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365SharepointDrives()
        {
            this._logger.name += " -o365SharepointDrives";
...
$inputs.Var.o365OrgId = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365SharepointDrives
}
// New-RscGqlMutationCompleteAzureCloudAccountOauth.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Mutation completeAzureCloudAccountOauth
    /// completeAzureCloudAccountOauth(input: CompleteAzureCloudAccountOauthInput!): CompleteAzureCloudAccountOauthReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "New",
        "RscGqlMutationCompleteAzureCloudAccountOauth")
    ]
    public class New_RscGqlMutationCompleteAzureCloudAccountOauth : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class New-RscGqlMutationCompleteAzureCloudAccountOauth
}
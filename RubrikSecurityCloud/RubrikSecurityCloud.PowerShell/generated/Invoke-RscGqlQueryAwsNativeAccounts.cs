// Invoke-RscGqlQueryAwsNativeAccounts.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query awsNativeAccounts
    /// awsNativeAccounts(
    ///     first: Int
    ///     after: String
    ///     last: Int
    ...
    public class Invoke_RscGqlQueryAwsNativeAccounts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.awsNativeProtectionFeature = <AwsNativeProtectionFeature> # Call [Enum]::GetValues([RubrikSecurityCloud.Types.AwsNativeProtectionFeature]) for enum values."
    ...
    } // class Invoke-RscGqlQueryAwsNativeAccounts
}
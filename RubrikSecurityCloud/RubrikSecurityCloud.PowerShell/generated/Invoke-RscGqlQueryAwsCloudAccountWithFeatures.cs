// Invoke-RscGqlQueryAwsCloudAccountWithFeatures.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query awsCloudAccountWithFeatures
    ...
    public class Invoke_RscGqlQueryAwsCloudAccountWithFeatures : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.awsCloudAccountArg = @{
    ...
    } // class Invoke-RscGqlQueryAwsCloudAccountWithFeatures
}
// Invoke-RscGqlMutateCreateCloudNativeAwsStorageSetting.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation createCloudNativeAwsStorageSetting
    /// createCloudNativeAwsStorageSetting(input: CreateCloudNativeAwsStorageSettingInput!): CreateCloudNativeAwsStorageSettingReply!
    /// </summary>
    [CmdletBinding()]
    [Cmdlet(
        "Invoke",
        "RscGqlMutateCreateCloudNativeAwsStorageSetting")
    ]
    public class Invoke_RscGqlMutateCreateCloudNativeAwsStorageSetting : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.input = @{
    ...
    } // class Invoke-RscGqlMutateCreateCloudNativeAwsStorageSetting
}
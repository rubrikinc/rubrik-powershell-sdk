// Invoke-RscGqlMutateUpdateLdapIntegration.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Mutation updateLdapIntegration
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlMutateUpdateLdapIntegration")
    ]
    public class Invoke_RscGqlMutateUpdateLdapIntegration : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.groupMemberAttr = <System.String>"
    ...
    } // class Invoke-RscGqlMutateUpdateLdapIntegration
}
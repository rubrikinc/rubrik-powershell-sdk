// New-RscGqlQueryCassandraSources.cs
//
...
{
    /// <summary>
    /// Create new GraphQL Query cassandraSources
    /// cassandraSources(
    ///     first: Int
    ///     after: String
    ...
    public class New_RscGqlQueryCassandraSources : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filter = @(
    ...
    } // class New-RscGqlQueryCassandraSources
}
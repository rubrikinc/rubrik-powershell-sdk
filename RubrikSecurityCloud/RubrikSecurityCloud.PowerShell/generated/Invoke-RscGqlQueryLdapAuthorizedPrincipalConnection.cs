// Invoke-RscGqlQueryLdapAuthorizedPrincipalConnection.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query ldapAuthorizedPrincipalConnection
    ...
    public class Invoke_RscGqlQueryLdapAuthorizedPrincipalConnection : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.roleIds = @(
    ...
    } // class Invoke-RscGqlQueryLdapAuthorizedPrincipalConnection
}
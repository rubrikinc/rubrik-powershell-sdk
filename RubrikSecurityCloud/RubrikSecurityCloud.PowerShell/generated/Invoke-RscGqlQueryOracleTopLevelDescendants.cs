// Invoke-RscGqlQueryOracleTopLevelDescendants.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query oracleTopLevelDescendants
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryOracleTopLevelDescendants")
    ]
    public class Invoke_RscGqlQueryOracleTopLevelDescendants : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("oracleTopLevelDescendants");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_oracleTopLevelDescendants();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_oracleTopLevelDescendants()
        {
            this._logger.name += " -oracleTopLevelDescendants";
...
$inputs.Var.filter = @(
    ...
    } // class Invoke-RscGqlQueryOracleTopLevelDescendants
}
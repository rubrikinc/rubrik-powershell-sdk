// Invoke-RscGqlQueryO365UserObjects.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query o365UserObjects
    /// o365UserObjects(
    ///     first: Int
    ///     after: String
    ...
    [Cmdlet(
        "Invoke",
        "RscGqlQueryO365UserObjects")
    ]
    public class Invoke_RscGqlQueryO365UserObjects : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
        ...
        {
            return SchemaMeta.RscOpLookupByGqlRootField("o365UserObjects");
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                this.ProcessRecord_o365UserObjects();
            }
            catch (Exception ex)
            {
        ...
        internal void ProcessRecord_o365UserObjects()
        {
            this._logger.name += " -o365UserObjects";
...
$inputs.Var.fid = <System.String>"
    ...
    } // class Invoke-RscGqlQueryO365UserObjects
}
// Invoke-RscGqlQueryAzureO365GetNetworkSubnetUnusedAddr.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query azureO365GetNetworkSubnetUnusedAddr
    ...
    public class Invoke_RscGqlQueryAzureO365GetNetworkSubnetUnusedAddr : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.strict_addr_check = <System.Boolean>"
    ...
    } // class Invoke-RscGqlQueryAzureO365GetNetworkSubnetUnusedAddr
}
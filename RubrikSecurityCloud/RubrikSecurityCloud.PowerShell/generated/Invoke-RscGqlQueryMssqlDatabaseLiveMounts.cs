// Invoke-RscGqlQueryMssqlDatabaseLiveMounts.cs
//
...
{
    /// <summary>
    /// Invoke GraphQL Query mssqlDatabaseLiveMounts
    ...
    public class Invoke_RscGqlQueryMssqlDatabaseLiveMounts : RscGqlPSCmdlet
    {
        // ~~~~~~~~~~~~~~~~~~~~~
        // Under the covers,
...
$inputs.Var.filters = @(
    ...
    } // class Invoke-RscGqlQueryMssqlDatabaseLiveMounts
}
// HostFailoverClusterDescendantType.cs
//
...
{
    #region HostFailoverClusterDescendantType

    public interface HostFailoverClusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHostFailoverClusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HostFailoverClusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HostFailoverClusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HostFailoverClusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HostFailoverClusterDescendantType>(
                        list, 

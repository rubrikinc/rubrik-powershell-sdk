...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HostFailoverClusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HostFailoverClusterDescendantType
    #endregion
    ...
    public static class ListHostFailoverClusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HostFailoverClusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostFailoverClusterDescendantType));
            list.Add(item);

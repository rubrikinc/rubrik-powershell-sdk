...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleHostDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleHostDescendantType
    #endregion
    ...
    public static class ListOracleHostDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleHostDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleHostDescendantType));
            list.Add(item);

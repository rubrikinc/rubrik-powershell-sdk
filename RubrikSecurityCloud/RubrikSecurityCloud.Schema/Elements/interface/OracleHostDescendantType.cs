...
{
    #region OracleHostDescendantType

    public interface OracleHostDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleHostDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleHostDescendantType> list)
        {

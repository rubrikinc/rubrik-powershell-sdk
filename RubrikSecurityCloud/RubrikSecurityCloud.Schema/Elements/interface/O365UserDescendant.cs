...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface O365UserDescendant: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    public static class ListO365UserDescendantExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (O365UserDescendant)InterfaceHelper.CreateInstanceOfFirstType(typeof(O365UserDescendant));
            list.Add(item);

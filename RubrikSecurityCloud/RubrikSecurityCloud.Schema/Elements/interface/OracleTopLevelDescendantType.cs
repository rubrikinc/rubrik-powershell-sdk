...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleTopLevelDescendantType
    #endregion
    ...
    public static class ListOracleTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleTopLevelDescendantType));
            list.Add(item);

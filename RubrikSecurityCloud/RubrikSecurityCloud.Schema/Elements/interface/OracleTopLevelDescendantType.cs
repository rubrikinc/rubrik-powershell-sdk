// OracleTopLevelDescendantType.cs
//
...
{
    #region OracleTopLevelDescendantType

    public interface OracleTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleTopLevelDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleTopLevelDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleTopLevelDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleTopLevelDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleTopLevelDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleTopLevelDescendantType> list)
        {

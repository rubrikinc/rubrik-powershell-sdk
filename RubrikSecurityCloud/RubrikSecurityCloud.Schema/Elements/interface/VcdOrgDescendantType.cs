...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdOrgDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdOrgDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdOrgDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdOrgDescendantType));
            list.Add(item);

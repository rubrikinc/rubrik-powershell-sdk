...
{
    #region VcdOrgDescendantType

    public interface VcdOrgDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdOrgDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdOrgDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdOrgDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdOrgDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdOrgDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdOrgDescendantType> list)
        {

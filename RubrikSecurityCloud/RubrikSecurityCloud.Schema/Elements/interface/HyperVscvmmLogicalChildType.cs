// HyperVscvmmLogicalChildType.cs
//
...
{
    #region HyperVscvmmLogicalChildType

    public interface HyperVscvmmLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListHyperVscvmmLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HyperVscvmmLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HyperVscvmmLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HyperVscvmmLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HyperVscvmmLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HyperVscvmmLogicalChildType> list)
        {

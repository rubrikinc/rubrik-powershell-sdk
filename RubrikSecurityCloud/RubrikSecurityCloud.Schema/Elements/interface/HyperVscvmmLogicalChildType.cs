...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HyperVscvmmLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HyperVscvmmLogicalChildType
    #endregion
    ...
    public static class ListHyperVscvmmLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HyperVscvmmLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HyperVscvmmLogicalChildType));
            list.Add(item);

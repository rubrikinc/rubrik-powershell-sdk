...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereTagCategoryDescendantTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereTagCategoryDescendantType> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereTagCategoryDescendantType> list)
        {

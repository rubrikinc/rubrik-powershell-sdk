...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereTagCategoryDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereTagCategoryDescendantType
    #endregion
    ...
    public static class ListVsphereTagCategoryDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereTagCategoryDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagCategoryDescendantType));
            list.Add(item);

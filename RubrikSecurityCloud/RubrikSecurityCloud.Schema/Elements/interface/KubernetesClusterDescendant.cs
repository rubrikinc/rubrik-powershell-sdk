// KubernetesClusterDescendant.cs
//
...
{
    #region KubernetesClusterDescendant

    public interface KubernetesClusterDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface KubernetesClusterDescendant

    #endregion



    public static class ListKubernetesClusterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesClusterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KubernetesClusterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KubernetesClusterDescendant> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KubernetesClusterDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KubernetesClusterDescendant> list)
        {

// FusionComputeHostDescendant.cs
//
...
{
    #region FusionComputeHostDescendant

    public interface FusionComputeHostDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeHostDescendant

    #endregion



    public static class ListFusionComputeHostDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeHostDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeHostDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeHostDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeHostDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeHostDescendant> list)
        {

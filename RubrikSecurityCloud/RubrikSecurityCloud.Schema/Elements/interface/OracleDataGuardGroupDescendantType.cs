// OracleDataGuardGroupDescendantType.cs
//
...
{
    #region OracleDataGuardGroupDescendantType

    public interface OracleDataGuardGroupDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleDataGuardGroupDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleDataGuardGroupDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleDataGuardGroupDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleDataGuardGroupDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleDataGuardGroupDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleDataGuardGroupDescendantType> list)
        {

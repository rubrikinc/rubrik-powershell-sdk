...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleDataGuardGroupDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleDataGuardGroupDescendantType
    #endregion
    ...
    public static class ListOracleDataGuardGroupDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleDataGuardGroupDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleDataGuardGroupDescendantType));
            list.Add(item);

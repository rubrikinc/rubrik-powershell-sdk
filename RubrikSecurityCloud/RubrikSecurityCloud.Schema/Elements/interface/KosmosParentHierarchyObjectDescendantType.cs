// KosmosParentHierarchyObjectDescendantType.cs
//
...
{
    #region KosmosParentHierarchyObjectDescendantType

    public interface KosmosParentHierarchyObjectDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface KosmosParentHierarchyObjectDescendantType

    #endregion



    public static class ListKosmosParentHierarchyObjectDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosParentHierarchyObjectDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosParentHierarchyObjectDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosParentHierarchyObjectDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosParentHierarchyObjectDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosParentHierarchyObjectDescendantType> list)
        {

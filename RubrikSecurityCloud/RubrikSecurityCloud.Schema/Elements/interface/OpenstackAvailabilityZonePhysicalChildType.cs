// OpenstackAvailabilityZonePhysicalChildType.cs
//
...
{
    #region OpenstackAvailabilityZonePhysicalChildType

    public interface OpenstackAvailabilityZonePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackAvailabilityZonePhysicalChildType

    #endregion



    public static class ListOpenstackAvailabilityZonePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackAvailabilityZonePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackAvailabilityZonePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackAvailabilityZonePhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackAvailabilityZonePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackAvailabilityZonePhysicalChildType> list)
        {

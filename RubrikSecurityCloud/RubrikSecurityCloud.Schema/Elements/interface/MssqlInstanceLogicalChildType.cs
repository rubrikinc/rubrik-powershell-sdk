...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MssqlInstanceLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MssqlInstanceLogicalChildType
    #endregion
    ...
    public static class ListMssqlInstanceLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MssqlInstanceLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlInstanceLogicalChildType));
            list.Add(item);

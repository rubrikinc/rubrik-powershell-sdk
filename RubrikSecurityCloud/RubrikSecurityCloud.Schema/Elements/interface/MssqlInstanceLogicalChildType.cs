// MssqlInstanceLogicalChildType.cs
//
...
{
    #region MssqlInstanceLogicalChildType

    public interface MssqlInstanceLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMssqlInstanceLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlInstanceLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlInstanceLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlInstanceLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlInstanceLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlInstanceLogicalChildType> list)
        {

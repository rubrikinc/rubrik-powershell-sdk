...
{
    #region MicrosoftOnedrive

    public interface MicrosoftOnedrive: IFieldSpec
    {
        #region members
    ...
    public static class ListMicrosoftOnedriveExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MicrosoftOnedrive> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MicrosoftOnedrive item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MicrosoftOnedrive> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MicrosoftOnedrive>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MicrosoftOnedrive> list)
        {

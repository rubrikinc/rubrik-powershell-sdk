...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface MongodbSourcePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongodbSourcePhysicalChildTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbSourcePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongodbSourcePhysicalChildType>(
                        ref list, 

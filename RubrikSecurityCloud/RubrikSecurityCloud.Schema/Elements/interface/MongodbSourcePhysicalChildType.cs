// MongodbSourcePhysicalChildType.cs
//
...
{
    #region MongodbSourcePhysicalChildType
    public interface MongodbSourcePhysicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class MongodbSourcePhysicalChildType
    #endregion

    public static class ListMongodbSourcePhysicalChildTypeExtensions
    {
        ...
        public static string AsFragment(
            this List<MongodbSourcePhysicalChildType> list,
            int indent=0)
        {
            string fragments = "";
            foreach (MongodbSourcePhysicalChildType item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongodbSourcePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbSourcePhysicalChildType));
            list.Add(item);

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface Db2InstanceDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class Db2InstanceDescendantType
    #endregion
    ...
    public static class ListDb2InstanceDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (Db2InstanceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(Db2InstanceDescendantType));
            list.Add(item);

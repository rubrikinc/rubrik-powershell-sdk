...
{
    #region Db2InstanceDescendantType

    public interface Db2InstanceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListDb2InstanceDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<Db2InstanceDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (Db2InstanceDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<Db2InstanceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<Db2InstanceDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<Db2InstanceDescendantType> list)
        {

...
{
    #region VsphereVcenterTagChildType

    public interface VsphereVcenterTagChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereVcenterTagChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterTagChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereVcenterTagChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterTagChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereVcenterTagChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterTagChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereVcenterTagChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereVcenterTagChildType
    #endregion
    ...
    public static class ListVsphereVcenterTagChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereVcenterTagChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereVcenterTagChildType));
            list.Add(item);

// OpenstackDomainLogicalChildType.cs
//
...
{
    #region OpenstackDomainLogicalChildType

    public interface OpenstackDomainLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackDomainLogicalChildType

    #endregion



    public static class ListOpenstackDomainLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackDomainLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackDomainLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackDomainLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackDomainLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackDomainLogicalChildType> list)
        {

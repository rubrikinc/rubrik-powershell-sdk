...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSpecificArchivalLocationWarningDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SpecificArchivalLocationWarningDetails> list)
        {
        ...
        public static void SelectForRetrieval(this List<SpecificArchivalLocationWarningDetails> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface GcpNativeProjectLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListGcpNativeProjectLogicalChildTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GcpNativeProjectLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<GcpNativeProjectLogicalChildType>(
                        list, 

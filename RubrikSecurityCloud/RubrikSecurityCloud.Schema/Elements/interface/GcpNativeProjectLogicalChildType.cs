// GcpNativeProjectLogicalChildType.cs
//
...
{
    #region GcpNativeProjectLogicalChildType
    public interface GcpNativeProjectLogicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class GcpNativeProjectLogicalChildType
    #endregion

    public static class ListGcpNativeProjectLogicalChildTypeExtensions
    {
        ...
        public static string AsFragment(
            this List<GcpNativeProjectLogicalChildType> list,
            int indent=0)
        {
            string fragments = "";
            foreach (GcpNativeProjectLogicalChildType item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (GcpNativeProjectLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(GcpNativeProjectLogicalChildType));
            list.Add(item);

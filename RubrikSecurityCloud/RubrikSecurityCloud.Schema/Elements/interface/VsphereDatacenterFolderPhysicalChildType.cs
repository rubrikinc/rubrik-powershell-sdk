// VsphereDatacenterFolderPhysicalChildType.cs
//
...
{
    #region VsphereDatacenterFolderPhysicalChildType

    public interface VsphereDatacenterFolderPhysicalChildType: IFieldSpec
    {
        #region members
        ...
        RscInterfaceList<CdmHierarchyObject> ReplicatedObjects { get; set; }
    ...
    } // interface VsphereDatacenterFolderPhysicalChildType

    #endregion



    public static class ListVsphereDatacenterFolderPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterFolderPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatacenterFolderPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolderPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatacenterFolderPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereDatacenterFolderPhysicalChildType> list)
        {

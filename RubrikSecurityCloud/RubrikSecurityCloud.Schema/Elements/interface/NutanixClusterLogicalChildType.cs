// NutanixClusterLogicalChildType.cs
//
...
{
    #region NutanixClusterLogicalChildType

    public interface NutanixClusterLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixClusterLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixClusterLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixClusterLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixClusterLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixClusterLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixClusterLogicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NutanixClusterLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NutanixClusterLogicalChildType
    #endregion
    ...
    public static class ListNutanixClusterLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NutanixClusterLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NutanixClusterLogicalChildType));
            list.Add(item);

...
{
    #region OlvmDatacenterDescendant

    public interface OlvmDatacenterDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmDatacenterDescendant

    #endregion



    public static class ListOlvmDatacenterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmDatacenterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmDatacenterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmDatacenterDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmDatacenterDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmDatacenterDescendant> list)
        {

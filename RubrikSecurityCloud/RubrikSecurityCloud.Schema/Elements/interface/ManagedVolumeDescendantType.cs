// ManagedVolumeDescendantType.cs
//
...
{
    #region ManagedVolumeDescendantType

    public interface ManagedVolumeDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListManagedVolumeDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ManagedVolumeDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ManagedVolumeDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ManagedVolumeDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeDescendantType> list)
        {

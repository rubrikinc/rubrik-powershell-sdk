...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ManagedVolumeDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ManagedVolumeDescendantType
    #endregion
    ...
    public static class ListManagedVolumeDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ManagedVolumeDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ManagedVolumeDescendantType));
            list.Add(item);

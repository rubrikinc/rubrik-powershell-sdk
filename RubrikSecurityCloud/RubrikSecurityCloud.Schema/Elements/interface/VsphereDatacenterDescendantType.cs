...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereDatacenterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereDatacenterDescendantType
    #endregion
    ...
    public static class ListVsphereDatacenterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereDatacenterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatacenterDescendantType));
            list.Add(item);

// OpenstackAvailabilityZoneDescendantType.cs
//
...
{
    #region OpenstackAvailabilityZoneDescendantType

    public interface OpenstackAvailabilityZoneDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackAvailabilityZoneDescendantType

    #endregion



    public static class ListOpenstackAvailabilityZoneDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackAvailabilityZoneDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackAvailabilityZoneDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackAvailabilityZoneDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackAvailabilityZoneDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackAvailabilityZoneDescendantType> list)
        {

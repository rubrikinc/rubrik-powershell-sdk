// CassandraKeyspacePhysicalChildType.cs
//
...
{
    #region CassandraKeyspacePhysicalChildType

    public interface CassandraKeyspacePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListCassandraKeyspacePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CassandraKeyspacePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CassandraKeyspacePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CassandraKeyspacePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CassandraKeyspacePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CassandraKeyspacePhysicalChildType> list)
        {

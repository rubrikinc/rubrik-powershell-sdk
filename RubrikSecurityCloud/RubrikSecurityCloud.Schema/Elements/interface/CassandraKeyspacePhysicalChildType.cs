...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface CassandraKeyspacePhysicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class CassandraKeyspacePhysicalChildType
    #endregion
    ...
    public static class ListCassandraKeyspacePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CassandraKeyspacePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(CassandraKeyspacePhysicalChildType));
            list.Add(item);

// HyperVclusterDescendantType.cs
//
...
{
    #region HyperVclusterDescendantType

    public interface HyperVclusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHyperVclusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HyperVclusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HyperVclusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HyperVclusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HyperVclusterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HyperVclusterDescendantType> list)
        {

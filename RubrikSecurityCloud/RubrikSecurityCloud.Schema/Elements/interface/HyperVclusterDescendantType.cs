...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HyperVclusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HyperVclusterDescendantType
    #endregion
    ...
    public static class ListHyperVclusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HyperVclusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HyperVclusterDescendantType));
            list.Add(item);

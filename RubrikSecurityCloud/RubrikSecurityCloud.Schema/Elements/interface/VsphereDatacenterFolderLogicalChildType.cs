// VsphereDatacenterFolderLogicalChildType.cs
//
...
{
    #region VsphereDatacenterFolderLogicalChildType

    public interface VsphereDatacenterFolderLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatacenterFolderLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterFolderLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatacenterFolderLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolderLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatacenterFolderLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereDatacenterFolderLogicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface PhysicalHostPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class PhysicalHostPhysicalChildType
    #endregion
    ...
    public static class ListPhysicalHostPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (PhysicalHostPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(PhysicalHostPhysicalChildType));
            list.Add(item);

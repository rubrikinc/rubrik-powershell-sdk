// PhysicalHostPhysicalChildType.cs
//
...
{
    #region PhysicalHostPhysicalChildType

    public interface PhysicalHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListPhysicalHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PhysicalHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (PhysicalHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<PhysicalHostPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<PhysicalHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<PhysicalHostPhysicalChildType> list)
        {

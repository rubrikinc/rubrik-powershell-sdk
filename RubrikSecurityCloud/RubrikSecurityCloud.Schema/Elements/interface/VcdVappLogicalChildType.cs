...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdVappLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdVappLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdVappLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdVappLogicalChildType));
            list.Add(item);

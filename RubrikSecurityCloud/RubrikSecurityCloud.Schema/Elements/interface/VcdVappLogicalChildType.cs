...
{
    #region VcdVappLogicalChildType

    public interface VcdVappLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdVappLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdVappLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdVappLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdVappLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdVappLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdVappLogicalChildType> list)
        {

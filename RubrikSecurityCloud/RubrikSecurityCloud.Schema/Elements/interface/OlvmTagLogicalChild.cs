...
{
    #region OlvmTagLogicalChild

    public interface OlvmTagLogicalChild: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmTagLogicalChild

    #endregion



    public static class ListOlvmTagLogicalChildExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmTagLogicalChild> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmTagLogicalChild item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmTagLogicalChild> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmTagLogicalChild>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmTagLogicalChild> list)
        {

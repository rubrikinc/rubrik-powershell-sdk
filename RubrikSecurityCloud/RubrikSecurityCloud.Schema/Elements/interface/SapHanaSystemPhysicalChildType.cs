// SapHanaSystemPhysicalChildType.cs
//
...
{
    #region SapHanaSystemPhysicalChildType

    public interface SapHanaSystemPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListSapHanaSystemPhysicalChildTypeExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (SapHanaSystemPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<SapHanaSystemPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<SapHanaSystemPhysicalChildType>(
                        list, 

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface SapHanaSystemPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class SapHanaSystemPhysicalChildType
    #endregion
    ...
    public static class ListSapHanaSystemPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (SapHanaSystemPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(SapHanaSystemPhysicalChildType));
            list.Add(item);

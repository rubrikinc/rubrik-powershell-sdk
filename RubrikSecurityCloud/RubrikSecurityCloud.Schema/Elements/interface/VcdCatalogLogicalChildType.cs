...
{
    #region VcdCatalogLogicalChildType

    public interface VcdCatalogLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdCatalogLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdCatalogLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdCatalogLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdCatalogLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdCatalogLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdCatalogLogicalChildType> list)
        {

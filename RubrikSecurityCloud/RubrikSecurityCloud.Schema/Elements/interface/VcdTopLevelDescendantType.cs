...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VcdTopLevelDescendantType
    #endregion
    ...
    public static class ListVcdTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdTopLevelDescendantType));
            list.Add(item);

...
{
    #region VcdTopLevelDescendantType

    public interface VcdTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdTopLevelDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdTopLevelDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdTopLevelDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdTopLevelDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdTopLevelDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdTopLevelDescendantType> list)
        {

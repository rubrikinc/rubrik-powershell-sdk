...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface FailoverClusterTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class FailoverClusterTopLevelDescendantType
    #endregion
    ...
    public static class ListFailoverClusterTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (FailoverClusterTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FailoverClusterTopLevelDescendantType));
            list.Add(item);

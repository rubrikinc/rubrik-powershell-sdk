// FailoverClusterTopLevelDescendantType.cs
//
...
{
    #region FailoverClusterTopLevelDescendantType

    public interface FailoverClusterTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListFailoverClusterTopLevelDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FailoverClusterTopLevelDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FailoverClusterTopLevelDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FailoverClusterTopLevelDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FailoverClusterTopLevelDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FailoverClusterTopLevelDescendantType> list)
        {

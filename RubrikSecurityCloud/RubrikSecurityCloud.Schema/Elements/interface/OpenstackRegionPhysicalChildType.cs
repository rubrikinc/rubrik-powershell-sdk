// OpenstackRegionPhysicalChildType.cs
//
...
{
    #region OpenstackRegionPhysicalChildType

    public interface OpenstackRegionPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackRegionPhysicalChildType

    #endregion



    public static class ListOpenstackRegionPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackRegionPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackRegionPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackRegionPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackRegionPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackRegionPhysicalChildType> list)
        {

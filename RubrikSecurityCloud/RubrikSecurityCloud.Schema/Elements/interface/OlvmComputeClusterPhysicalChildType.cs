// OlvmComputeClusterPhysicalChildType.cs
//
...
{
    #region OlvmComputeClusterPhysicalChildType

    public interface OlvmComputeClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmComputeClusterPhysicalChildType

    #endregion



    public static class ListOlvmComputeClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmComputeClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmComputeClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmComputeClusterPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmComputeClusterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmComputeClusterPhysicalChildType> list)
        {

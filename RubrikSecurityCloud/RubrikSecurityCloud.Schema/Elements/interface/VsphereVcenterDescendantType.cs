...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereVcenterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereVcenterDescendantType
    #endregion
    ...
    public static class ListVsphereVcenterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereVcenterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereVcenterDescendantType));
            list.Add(item);

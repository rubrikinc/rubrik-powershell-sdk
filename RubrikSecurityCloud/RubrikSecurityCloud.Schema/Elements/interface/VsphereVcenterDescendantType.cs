// VsphereVcenterDescendantType.cs
//
...
{
    #region VsphereVcenterDescendantType

    public interface VsphereVcenterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereVcenterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereVcenterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereVcenterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterDescendantType> list)
        {

// FilesetTemplateDescendantType.cs
//
...
{
    #region FilesetTemplateDescendantType

    public interface FilesetTemplateDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListFilesetTemplateDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FilesetTemplateDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FilesetTemplateDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FilesetTemplateDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FilesetTemplateDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FilesetTemplateDescendantType> list)
        {

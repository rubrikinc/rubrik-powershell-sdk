...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface FilesetTemplateDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class FilesetTemplateDescendantType
    #endregion
    ...
    public static class ListFilesetTemplateDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (FilesetTemplateDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FilesetTemplateDescendantType));
            list.Add(item);

...
{
    #region HierarchyObject

    public interface HierarchyObject: IFieldSpec
    {
        #region members
    ...
    public static class ListHierarchyObjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HierarchyObject> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HierarchyObject item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HierarchyObject> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HierarchyObject>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HierarchyObject> list)
        {

// CloudDirectNasSystemDescendantType.cs
//
...
{
    #region CloudDirectNasSystemDescendantType

    public interface CloudDirectNasSystemDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface CloudDirectNasSystemDescendantType

    #endregion



    public static class ListCloudDirectNasSystemDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectNasSystemDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CloudDirectNasSystemDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasSystemDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectNasSystemDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CloudDirectNasSystemDescendantType> list)
        {

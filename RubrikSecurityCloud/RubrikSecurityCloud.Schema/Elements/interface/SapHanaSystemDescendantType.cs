// SapHanaSystemDescendantType.cs
//
...
{
    #region SapHanaSystemDescendantType

    public interface SapHanaSystemDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListSapHanaSystemDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SapHanaSystemDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (SapHanaSystemDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<SapHanaSystemDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<SapHanaSystemDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<SapHanaSystemDescendantType> list)
        {

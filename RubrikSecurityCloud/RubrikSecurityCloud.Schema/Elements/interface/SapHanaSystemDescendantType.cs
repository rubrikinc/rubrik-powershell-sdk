...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface SapHanaSystemDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class SapHanaSystemDescendantType
    #endregion
    ...
    public static class ListSapHanaSystemDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (SapHanaSystemDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(SapHanaSystemDescendantType));
            list.Add(item);

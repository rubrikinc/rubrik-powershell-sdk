// OracleDataGuardGroupLogicalChildType.cs
//
...
{
    #region OracleDataGuardGroupLogicalChildType

    public interface OracleDataGuardGroupLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleDataGuardGroupLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleDataGuardGroupLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleDataGuardGroupLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleDataGuardGroupLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleDataGuardGroupLogicalChildType>(
                        list, 

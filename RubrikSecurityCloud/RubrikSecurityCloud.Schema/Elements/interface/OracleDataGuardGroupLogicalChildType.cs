...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleDataGuardGroupLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleDataGuardGroupLogicalChildType
    #endregion
    ...
    public static class ListOracleDataGuardGroupLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleDataGuardGroupLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleDataGuardGroupLogicalChildType));
            list.Add(item);

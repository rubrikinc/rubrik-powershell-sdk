// OlvmComputeClusterDescendant.cs
//
...
{
    #region OlvmComputeClusterDescendant

    public interface OlvmComputeClusterDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmComputeClusterDescendant

    #endregion



    public static class ListOlvmComputeClusterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmComputeClusterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmComputeClusterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmComputeClusterDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmComputeClusterDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmComputeClusterDescendant> list)
        {

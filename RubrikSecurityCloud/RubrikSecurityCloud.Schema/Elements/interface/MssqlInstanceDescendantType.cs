// MssqlInstanceDescendantType.cs
//
...
{
    #region MssqlInstanceDescendantType

    public interface MssqlInstanceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMssqlInstanceDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlInstanceDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlInstanceDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlInstanceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlInstanceDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlInstanceDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MssqlInstanceDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MssqlInstanceDescendantType
    #endregion
    ...
    public static class ListMssqlInstanceDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MssqlInstanceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlInstanceDescendantType));
            list.Add(item);

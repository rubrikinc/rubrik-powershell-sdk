// GcpNativeProjectDescendantType.cs
//
...
{
    #region GcpNativeProjectDescendantType

    public interface GcpNativeProjectDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListGcpNativeProjectDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpNativeProjectDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (GcpNativeProjectDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<GcpNativeProjectDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<GcpNativeProjectDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<GcpNativeProjectDescendantType> list)
        {

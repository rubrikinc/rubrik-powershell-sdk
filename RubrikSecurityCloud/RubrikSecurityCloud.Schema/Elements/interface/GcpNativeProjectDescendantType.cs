...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface GcpNativeProjectDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class GcpNativeProjectDescendantType
    #endregion
    ...
    public static class ListGcpNativeProjectDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (GcpNativeProjectDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(GcpNativeProjectDescendantType));
            list.Add(item);

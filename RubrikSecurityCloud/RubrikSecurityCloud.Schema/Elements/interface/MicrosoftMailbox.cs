...
{
    #region MicrosoftMailbox

    public interface MicrosoftMailbox: IFieldSpec
    {
        #region members
    ...
    public static class ListMicrosoftMailboxExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MicrosoftMailbox> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MicrosoftMailbox item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MicrosoftMailbox> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MicrosoftMailbox>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MicrosoftMailbox> list)
        {

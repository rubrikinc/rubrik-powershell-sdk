// OpenstackEnvironmentPhysicalChildType.cs
//
...
{
    #region OpenstackEnvironmentPhysicalChildType

    public interface OpenstackEnvironmentPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackEnvironmentPhysicalChildType

    #endregion



    public static class ListOpenstackEnvironmentPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackEnvironmentPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackEnvironmentPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackEnvironmentPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackEnvironmentPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackEnvironmentPhysicalChildType> list)
        {

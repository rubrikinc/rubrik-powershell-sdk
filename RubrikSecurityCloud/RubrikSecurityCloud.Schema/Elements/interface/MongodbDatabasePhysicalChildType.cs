...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongodbDatabasePhysicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class MongodbDatabasePhysicalChildType
    #endregion
    ...
    public static class ListMongodbDatabasePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongodbDatabasePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbDatabasePhysicalChildType));
            list.Add(item);

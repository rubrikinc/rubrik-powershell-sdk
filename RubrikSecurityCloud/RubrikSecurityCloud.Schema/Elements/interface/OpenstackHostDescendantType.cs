// OpenstackHostDescendantType.cs
//
...
{
    #region OpenstackHostDescendantType

    public interface OpenstackHostDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackHostDescendantType

    #endregion



    public static class ListOpenstackHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackHostDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackHostDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongodbSourceDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class MongodbSourceDescendantType
    #endregion
    ...
    public static class ListMongodbSourceDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongodbSourceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbSourceDescendantType));
            list.Add(item);

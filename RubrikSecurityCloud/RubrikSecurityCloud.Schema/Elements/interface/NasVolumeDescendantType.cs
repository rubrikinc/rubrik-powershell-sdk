...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasVolumeDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListNasVolumeDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasVolumeDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasVolumeDescendantType));
            list.Add(item);

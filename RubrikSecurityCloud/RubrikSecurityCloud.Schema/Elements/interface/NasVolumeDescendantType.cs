...
{
    #region NasVolumeDescendantType

    public interface NasVolumeDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasVolumeDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasVolumeDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasVolumeDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasVolumeDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasVolumeDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasVolumeDescendantType> list)
        {

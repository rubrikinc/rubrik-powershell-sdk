...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereComputeClusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereComputeClusterDescendantType
    #endregion
    ...
    public static class ListVsphereComputeClusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereComputeClusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereComputeClusterDescendantType));
            list.Add(item);

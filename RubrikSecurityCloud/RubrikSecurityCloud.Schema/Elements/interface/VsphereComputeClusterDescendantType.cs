// VsphereComputeClusterDescendantType.cs
//
...
{
    #region VsphereComputeClusterDescendantType

    public interface VsphereComputeClusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereComputeClusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereComputeClusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereComputeClusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereComputeClusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereComputeClusterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereComputeClusterDescendantType> list)
        {

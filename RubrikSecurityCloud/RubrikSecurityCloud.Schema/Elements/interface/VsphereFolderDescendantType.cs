// VsphereFolderDescendantType.cs
//
...
{
    #region VsphereFolderDescendantType

    public interface VsphereFolderDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereFolderDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereFolderDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereFolderDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereFolderDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereFolderDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereFolderDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereFolderDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereFolderDescendantType
    #endregion
    ...
    public static class ListVsphereFolderDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereFolderDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereFolderDescendantType));
            list.Add(item);

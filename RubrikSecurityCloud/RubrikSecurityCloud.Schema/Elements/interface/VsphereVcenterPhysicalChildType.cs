// VsphereVcenterPhysicalChildType.cs
//
...
{
    #region VsphereVcenterPhysicalChildType

    public interface VsphereVcenterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereVcenterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereVcenterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereVcenterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterPhysicalChildType> list)
        {

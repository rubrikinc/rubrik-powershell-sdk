...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereVcenterPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereVcenterPhysicalChildType
    #endregion
    ...
    public static class ListVsphereVcenterPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereVcenterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereVcenterPhysicalChildType));
            list.Add(item);

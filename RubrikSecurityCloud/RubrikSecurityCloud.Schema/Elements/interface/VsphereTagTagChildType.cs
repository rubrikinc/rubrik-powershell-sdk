...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereTagTagChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVsphereTagTagChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereTagTagChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagTagChildType));
            list.Add(item);

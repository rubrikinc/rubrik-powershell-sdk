...
{
    #region VsphereTagTagChildType

    public interface VsphereTagTagChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereTagTagChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereTagTagChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereTagTagChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereTagTagChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereTagTagChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereTagTagChildType> list)
        {

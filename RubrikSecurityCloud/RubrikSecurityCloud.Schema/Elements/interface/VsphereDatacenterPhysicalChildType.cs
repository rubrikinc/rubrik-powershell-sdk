// VsphereDatacenterPhysicalChildType.cs
//
...
{
    #region VsphereDatacenterPhysicalChildType

    public interface VsphereDatacenterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatacenterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatacenterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatacenterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereDatacenterPhysicalChildType> list)
        {

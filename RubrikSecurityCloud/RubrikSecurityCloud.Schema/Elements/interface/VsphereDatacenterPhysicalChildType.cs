...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereDatacenterPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereDatacenterPhysicalChildType
    #endregion
    ...
    public static class ListVsphereDatacenterPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereDatacenterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatacenterPhysicalChildType));
            list.Add(item);

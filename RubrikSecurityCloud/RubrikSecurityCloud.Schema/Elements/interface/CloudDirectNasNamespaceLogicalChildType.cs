// CloudDirectNasNamespaceLogicalChildType.cs
//
...
{
    #region CloudDirectNasNamespaceLogicalChildType

    public interface CloudDirectNasNamespaceLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface CloudDirectNasNamespaceLogicalChildType

    #endregion



    public static class ListCloudDirectNasNamespaceLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectNasNamespaceLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CloudDirectNasNamespaceLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasNamespaceLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectNasNamespaceLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CloudDirectNasNamespaceLogicalChildType> list)
        {

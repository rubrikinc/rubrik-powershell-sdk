...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface MicrosoftOrg: IFieldSpec
    {
        #region members
    ...
    } // interface MicrosoftOrg

    #endregion



    public static class ListMicrosoftOrgExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (MicrosoftOrg item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MicrosoftOrg> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MicrosoftOrg>(
                        list, 

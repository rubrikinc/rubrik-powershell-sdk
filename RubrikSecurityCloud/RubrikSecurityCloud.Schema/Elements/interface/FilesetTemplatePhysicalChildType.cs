...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface FilesetTemplatePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class FilesetTemplatePhysicalChildType
    #endregion
    ...
    public static class ListFilesetTemplatePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (FilesetTemplatePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FilesetTemplatePhysicalChildType));
            list.Add(item);

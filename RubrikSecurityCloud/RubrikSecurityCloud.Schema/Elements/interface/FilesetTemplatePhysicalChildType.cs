// FilesetTemplatePhysicalChildType.cs
//
...
{
    #region FilesetTemplatePhysicalChildType

    public interface FilesetTemplatePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListFilesetTemplatePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FilesetTemplatePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FilesetTemplatePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FilesetTemplatePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FilesetTemplatePhysicalChildType>(
                        list, 

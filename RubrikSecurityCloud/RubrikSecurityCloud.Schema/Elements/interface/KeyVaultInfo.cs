...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface KeyVaultInfo: IFieldSpec
    {
        #region members
    ...
    public static class ListKeyVaultInfoExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KeyVaultInfo> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KeyVaultInfo item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KeyVaultInfo> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KeyVaultInfo>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KeyVaultInfo> list)
        {

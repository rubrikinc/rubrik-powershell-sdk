// VsphereVcenterLibraryChildType.cs
//
...
{
    #region VsphereVcenterLibraryChildType

    public interface VsphereVcenterLibraryChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereVcenterLibraryChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterLibraryChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereVcenterLibraryChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterLibraryChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereVcenterLibraryChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterLibraryChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HostSharePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HostSharePhysicalChildType
    #endregion
    ...
    public static class ListHostSharePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HostSharePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostSharePhysicalChildType));
            list.Add(item);

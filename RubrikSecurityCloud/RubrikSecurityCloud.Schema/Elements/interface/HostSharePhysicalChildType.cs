...
{
    #region HostSharePhysicalChildType

    public interface HostSharePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListHostSharePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HostSharePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HostSharePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HostSharePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HostSharePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HostSharePhysicalChildType> list)
        {

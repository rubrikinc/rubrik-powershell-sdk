// OpenstackEnvironmentDescendantType.cs
//
...
{
    #region OpenstackEnvironmentDescendantType

    public interface OpenstackEnvironmentDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackEnvironmentDescendantType

    #endregion



    public static class ListOpenstackEnvironmentDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackEnvironmentDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackEnvironmentDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackEnvironmentDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackEnvironmentDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackEnvironmentDescendantType> list)
        {

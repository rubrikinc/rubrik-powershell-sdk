...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ManagedVolumeMountDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ManagedVolumeMountDescendantType
    #endregion
    ...
    public static class ListManagedVolumeMountDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ManagedVolumeMountDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ManagedVolumeMountDescendantType));
            list.Add(item);

// ManagedVolumeMountDescendantType.cs
//
...
{
    #region ManagedVolumeMountDescendantType

    public interface ManagedVolumeMountDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListManagedVolumeMountDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ManagedVolumeMountDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ManagedVolumeMountDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeMountDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ManagedVolumeMountDescendantType>(
                        ref list, 
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeMountDescendantType> list)
        {

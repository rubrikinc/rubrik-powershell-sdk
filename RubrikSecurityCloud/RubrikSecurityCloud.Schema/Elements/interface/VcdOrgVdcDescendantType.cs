...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdOrgVdcDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdOrgVdcDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdOrgVdcDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdOrgVdcDescendantType));
            list.Add(item);

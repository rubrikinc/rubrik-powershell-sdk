...
{
    #region VcdOrgVdcDescendantType

    public interface VcdOrgVdcDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdOrgVdcDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdOrgVdcDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdOrgVdcDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdOrgVdcDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdOrgVdcDescendantType>(
                        list, 

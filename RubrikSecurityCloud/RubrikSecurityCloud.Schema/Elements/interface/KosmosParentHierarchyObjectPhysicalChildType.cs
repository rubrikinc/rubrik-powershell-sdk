// KosmosParentHierarchyObjectPhysicalChildType.cs
//
...
{
    #region KosmosParentHierarchyObjectPhysicalChildType

    public interface KosmosParentHierarchyObjectPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface KosmosParentHierarchyObjectPhysicalChildType

    #endregion



    public static class ListKosmosParentHierarchyObjectPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosParentHierarchyObjectPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosParentHierarchyObjectPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosParentHierarchyObjectPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosParentHierarchyObjectPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosParentHierarchyObjectPhysicalChildType> list)
        {

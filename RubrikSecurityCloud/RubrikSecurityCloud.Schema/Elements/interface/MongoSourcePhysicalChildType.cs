// MongoSourcePhysicalChildType.cs
//
...
{
    #region MongoSourcePhysicalChildType

    public interface MongoSourcePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoSourcePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoSourcePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoSourcePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoSourcePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoSourcePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MongoSourcePhysicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoSourcePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoSourcePhysicalChildType
    #endregion
    ...
    public static class ListMongoSourcePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoSourcePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoSourcePhysicalChildType));
            list.Add(item);

// ActiveDirectoryForestPhysicalChildType.cs
//
...
{
    #region ActiveDirectoryForestPhysicalChildType

    public interface ActiveDirectoryForestPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface ActiveDirectoryForestPhysicalChildType

    #endregion



    public static class ListActiveDirectoryForestPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryForestPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ActiveDirectoryForestPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryForestPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ActiveDirectoryForestPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ActiveDirectoryForestPhysicalChildType> list)
        {

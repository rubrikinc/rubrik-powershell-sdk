...
{
    #region SaasAppsOrganization

    public interface SaasAppsOrganization: IFieldSpec
    {
        #region members
    ...
    } // interface SaasAppsOrganization

    #endregion



    public static class ListSaasAppsOrganizationExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SaasAppsOrganization> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (SaasAppsOrganization item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<SaasAppsOrganization> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<SaasAppsOrganization>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<SaasAppsOrganization> list)
        {

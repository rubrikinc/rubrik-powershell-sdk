...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBlueprintFailoverInstanceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BlueprintFailoverInstance> list)
        {
        ...
        public static void SelectForRetrieval(this List<BlueprintFailoverInstance> list)
        {

...
{
    #region NasShareDescendantType

    public interface NasShareDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasShareDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasShareDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasShareDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasShareDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasShareDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasShareDescendantType> list)
        {

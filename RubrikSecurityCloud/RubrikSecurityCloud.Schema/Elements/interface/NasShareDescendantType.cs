...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasShareDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListNasShareDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasShareDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasShareDescendantType));
            list.Add(item);

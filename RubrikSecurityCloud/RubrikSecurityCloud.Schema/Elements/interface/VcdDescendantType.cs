...
{
    #region VcdDescendantType

    public interface VcdDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdDescendantType> list)
        {

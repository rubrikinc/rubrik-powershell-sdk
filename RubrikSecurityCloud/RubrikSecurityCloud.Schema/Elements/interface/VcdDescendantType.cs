...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdDescendantType));
            list.Add(item);

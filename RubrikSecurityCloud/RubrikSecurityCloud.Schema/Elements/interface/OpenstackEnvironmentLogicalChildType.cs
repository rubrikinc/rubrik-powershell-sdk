// OpenstackEnvironmentLogicalChildType.cs
//
...
{
    #region OpenstackEnvironmentLogicalChildType

    public interface OpenstackEnvironmentLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackEnvironmentLogicalChildType

    #endregion



    public static class ListOpenstackEnvironmentLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackEnvironmentLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackEnvironmentLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackEnvironmentLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackEnvironmentLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackEnvironmentLogicalChildType> list)
        {

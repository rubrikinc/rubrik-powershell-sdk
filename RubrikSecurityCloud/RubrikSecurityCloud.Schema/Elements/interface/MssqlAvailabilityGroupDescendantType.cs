// MssqlAvailabilityGroupDescendantType.cs
//
...
{
    #region MssqlAvailabilityGroupDescendantType

    public interface MssqlAvailabilityGroupDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMssqlAvailabilityGroupDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlAvailabilityGroupDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlAvailabilityGroupDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlAvailabilityGroupDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlAvailabilityGroupDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlAvailabilityGroupDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MssqlAvailabilityGroupDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MssqlAvailabilityGroupDescendantType
    #endregion
    ...
    public static class ListMssqlAvailabilityGroupDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MssqlAvailabilityGroupDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlAvailabilityGroupDescendantType));
            list.Add(item);

// OpenstackDomainDescendantType.cs
//
...
{
    #region OpenstackDomainDescendantType

    public interface OpenstackDomainDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackDomainDescendantType

    #endregion



    public static class ListOpenstackDomainDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackDomainDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackDomainDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackDomainDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackDomainDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackDomainDescendantType> list)
        {

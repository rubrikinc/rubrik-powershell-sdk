// VsphereTagCategoryTagChildType.cs
//
...
{
    #region VsphereTagCategoryTagChildType

    public interface VsphereTagCategoryTagChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereTagCategoryTagChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereTagCategoryTagChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereTagCategoryTagChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereTagCategoryTagChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereTagCategoryTagChildType>(
                        list, 

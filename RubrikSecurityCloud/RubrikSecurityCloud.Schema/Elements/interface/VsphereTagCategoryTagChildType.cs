...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereTagCategoryTagChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereTagCategoryTagChildType
    #endregion
    ...
    public static class ListVsphereTagCategoryTagChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereTagCategoryTagChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagCategoryTagChildType));
            list.Add(item);

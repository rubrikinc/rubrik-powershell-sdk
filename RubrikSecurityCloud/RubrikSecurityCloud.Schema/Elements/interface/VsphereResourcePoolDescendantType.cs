...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereResourcePoolDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereResourcePoolDescendantType
    #endregion
    ...
    public static class ListVsphereResourcePoolDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereResourcePoolDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereResourcePoolDescendantType));
            list.Add(item);

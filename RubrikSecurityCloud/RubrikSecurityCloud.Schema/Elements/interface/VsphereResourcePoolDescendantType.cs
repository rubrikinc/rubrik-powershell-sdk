// VsphereResourcePoolDescendantType.cs
//
...
{
    #region VsphereResourcePoolDescendantType

    public interface VsphereResourcePoolDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereResourcePoolDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereResourcePoolDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereResourcePoolDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereResourcePoolDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereResourcePoolDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereResourcePoolDescendantType> list)
        {

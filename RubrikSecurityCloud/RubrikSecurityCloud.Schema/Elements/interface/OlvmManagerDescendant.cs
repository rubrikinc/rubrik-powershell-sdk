...
{
    #region OlvmManagerDescendant

    public interface OlvmManagerDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmManagerDescendant

    #endregion



    public static class ListOlvmManagerDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmManagerDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmManagerDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmManagerDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmManagerDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmManagerDescendant> list)
        {

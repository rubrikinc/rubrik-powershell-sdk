// HyperVclusterLogicalChildType.cs
//
...
{
    #region HyperVclusterLogicalChildType

    public interface HyperVclusterLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListHyperVclusterLogicalChildTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVclusterLogicalChildType> list)
        {
        ...
        public static void SelectForRetrieval(this List<HyperVclusterLogicalChildType> list)
        {

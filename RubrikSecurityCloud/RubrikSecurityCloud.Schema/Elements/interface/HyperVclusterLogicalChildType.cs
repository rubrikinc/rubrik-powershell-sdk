...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HyperVclusterLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HyperVclusterLogicalChildType
    #endregion
    ...
    public static class ListHyperVclusterLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HyperVclusterLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HyperVclusterLogicalChildType));
            list.Add(item);

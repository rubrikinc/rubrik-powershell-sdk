// OpenstackHostPhysicalChildType.cs
//
...
{
    #region OpenstackHostPhysicalChildType

    public interface OpenstackHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackHostPhysicalChildType

    #endregion



    public static class ListOpenstackHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackHostPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackHostPhysicalChildType> list)
        {

...
{
    #region MssqlHostPhysicalChildType

    public interface MssqlHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface MssqlHostPhysicalChildType

    #endregion



    public static class ListMssqlHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlHostPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlHostPhysicalChildType> list)
        {

// AwsNativeAccountLogicalChildType.cs
//
...
{
    #region AwsNativeAccountLogicalChildType

    public interface AwsNativeAccountLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListAwsNativeAccountLogicalChildTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeAccountLogicalChildType> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsNativeAccountLogicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface AwsNativeAccountLogicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class AwsNativeAccountLogicalChildType
    #endregion
    ...
    public static class ListAwsNativeAccountLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (AwsNativeAccountLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(AwsNativeAccountLogicalChildType));
            list.Add(item);

// OpenstackTagLogicalChildType.cs
//
...
{
    #region OpenstackTagLogicalChildType

    public interface OpenstackTagLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackTagLogicalChildType

    #endregion



    public static class ListOpenstackTagLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackTagLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackTagLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackTagLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackTagLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackTagLogicalChildType> list)
        {

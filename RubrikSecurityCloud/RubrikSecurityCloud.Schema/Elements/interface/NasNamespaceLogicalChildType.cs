...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasNamespaceLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NasNamespaceLogicalChildType
    #endregion
    ...
    public static class ListNasNamespaceLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasNamespaceLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasNamespaceLogicalChildType));
            list.Add(item);

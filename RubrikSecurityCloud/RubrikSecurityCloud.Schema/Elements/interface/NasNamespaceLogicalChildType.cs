// NasNamespaceLogicalChildType.cs
//
...
{
    #region NasNamespaceLogicalChildType

    public interface NasNamespaceLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasNamespaceLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasNamespaceLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasNamespaceLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasNamespaceLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasNamespaceLogicalChildType>(
                        list, 

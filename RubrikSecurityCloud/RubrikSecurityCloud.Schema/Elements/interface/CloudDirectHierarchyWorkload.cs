...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface CloudDirectHierarchyWorkload: IFieldSpec
    {
        #region members
    ...
    public static class ListCloudDirectHierarchyWorkloadExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CloudDirectHierarchyWorkload> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectHierarchyWorkload>(
                        ref list, 

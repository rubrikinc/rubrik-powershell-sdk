// CloudDirectHierarchyWorkload.cs
//
...
{
    #region CloudDirectHierarchyWorkload
    public interface CloudDirectHierarchyWorkload: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class CloudDirectHierarchyWorkload
    #endregion

    public static class ListCloudDirectHierarchyWorkloadExtensions
    {
        ...
        public static string AsFragment(
            this List<CloudDirectHierarchyWorkload> list,
            int indent=0)
        {
            string fragments = "";
            foreach (CloudDirectHierarchyWorkload item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CloudDirectHierarchyWorkload)InterfaceHelper.CreateInstanceOfFirstType(typeof(CloudDirectHierarchyWorkload));
            list.Add(item);

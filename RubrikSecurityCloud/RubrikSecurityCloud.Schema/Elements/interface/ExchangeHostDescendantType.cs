...
{
    #region ExchangeHostDescendantType

    public interface ExchangeHostDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface ExchangeHostDescendantType

    #endregion



    public static class ListExchangeHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ExchangeHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ExchangeHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ExchangeHostDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ExchangeHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ExchangeHostDescendantType> list)
        {

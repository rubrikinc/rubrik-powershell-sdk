...
{
    #region FusionComputeVrmDescendant

    public interface FusionComputeVrmDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeVrmDescendant

    #endregion



    public static class ListFusionComputeVrmDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeVrmDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeVrmDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeVrmDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeVrmDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeVrmDescendant> list)
        {

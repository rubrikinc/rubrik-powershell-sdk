// MongoCollectionSetPhysicalChildType.cs
//
...
{
    #region MongoCollectionSetPhysicalChildType

    public interface MongoCollectionSetPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoCollectionSetPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoCollectionSetPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoCollectionSetPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoCollectionSetPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoCollectionSetPhysicalChildType>(
                        list, 

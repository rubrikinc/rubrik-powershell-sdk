...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoCollectionSetPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoCollectionSetPhysicalChildType
    #endregion
    ...
    public static class ListMongoCollectionSetPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoCollectionSetPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoCollectionSetPhysicalChildType));
            list.Add(item);

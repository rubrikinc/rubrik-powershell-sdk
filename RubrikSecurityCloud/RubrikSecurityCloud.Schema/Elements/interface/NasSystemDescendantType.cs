...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasSystemDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListNasSystemDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasSystemDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasSystemDescendantType));
            list.Add(item);

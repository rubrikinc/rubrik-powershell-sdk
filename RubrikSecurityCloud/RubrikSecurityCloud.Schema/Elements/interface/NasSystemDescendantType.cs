...
{
    #region NasSystemDescendantType

    public interface NasSystemDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasSystemDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasSystemDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasSystemDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasSystemDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasSystemDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasSystemDescendantType> list)
        {

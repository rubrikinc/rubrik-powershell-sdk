// OpenstackProjectDescendantType.cs
//
...
{
    #region OpenstackProjectDescendantType

    public interface OpenstackProjectDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackProjectDescendantType

    #endregion



    public static class ListOpenstackProjectDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackProjectDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackProjectDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackProjectDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackProjectDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackProjectDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ManagedVolumePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ManagedVolumePhysicalChildType
    #endregion
    ...
    public static class ListManagedVolumePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ManagedVolumePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ManagedVolumePhysicalChildType));
            list.Add(item);

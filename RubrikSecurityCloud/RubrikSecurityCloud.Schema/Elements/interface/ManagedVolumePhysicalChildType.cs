// ManagedVolumePhysicalChildType.cs
//
...
{
    #region ManagedVolumePhysicalChildType

    public interface ManagedVolumePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListManagedVolumePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ManagedVolumePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ManagedVolumePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ManagedVolumePhysicalChildType>(
                        list, 

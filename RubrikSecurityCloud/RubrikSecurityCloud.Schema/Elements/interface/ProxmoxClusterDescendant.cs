...
{
    #region ProxmoxClusterDescendant

    public interface ProxmoxClusterDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxClusterDescendant

    #endregion



    public static class ListProxmoxClusterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxClusterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxClusterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxClusterDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxClusterDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxClusterDescendant> list)
        {

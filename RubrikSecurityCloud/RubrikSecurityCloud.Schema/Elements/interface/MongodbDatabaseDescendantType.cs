...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongodbDatabaseDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class MongodbDatabaseDescendantType
    #endregion
    ...
    public static class ListMongodbDatabaseDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongodbDatabaseDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbDatabaseDescendantType));
            list.Add(item);

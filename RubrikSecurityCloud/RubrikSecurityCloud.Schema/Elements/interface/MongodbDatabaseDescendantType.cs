// MongodbDatabaseDescendantType.cs
//
...
{
    #region MongodbDatabaseDescendantType

    public interface MongodbDatabaseDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongodbDatabaseDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongodbDatabaseDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongodbDatabaseDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongodbDatabaseDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongodbDatabaseDescendantType>(
                        ref list, 
        ...
        public static void SelectForRetrieval(this List<MongodbDatabaseDescendantType> list)
        {

// VsphereDatacenterFolderDescendantType.cs
//
...
{
    #region VsphereDatacenterFolderDescendantType

    public interface VsphereDatacenterFolderDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatacenterFolderDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterFolderDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatacenterFolderDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolderDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatacenterFolderDescendantType>(
                        list, 

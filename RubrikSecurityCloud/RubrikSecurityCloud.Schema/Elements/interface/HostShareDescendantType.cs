...
{
    #region HostShareDescendantType

    public interface HostShareDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHostShareDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HostShareDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HostShareDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HostShareDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HostShareDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HostShareDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HostShareDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListHostShareDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HostShareDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostShareDescendantType));
            list.Add(item);

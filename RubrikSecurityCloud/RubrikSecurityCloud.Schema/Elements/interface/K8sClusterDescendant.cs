...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface K8sClusterDescendant: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    public static class ListK8sClusterDescendantExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (K8sClusterDescendant)InterfaceHelper.CreateInstanceOfFirstType(typeof(K8sClusterDescendant));
            list.Add(item);

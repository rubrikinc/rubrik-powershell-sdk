...
{
    #region K8sClusterDescendant

    public interface K8sClusterDescendant: IFieldSpec
    {
        #region members
    ...
    public static class ListK8sClusterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<K8sClusterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (K8sClusterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<K8sClusterDescendant> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<K8sClusterDescendant>(
                        list, 

// NutanixCategoryValueDescendantType.cs
//
...
{
    #region NutanixCategoryValueDescendantType

    public interface NutanixCategoryValueDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixCategoryValueDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixCategoryValueDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixCategoryValueDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryValueDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixCategoryValueDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixCategoryValueDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoDatabasePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoDatabasePhysicalChildType
    #endregion
    ...
    public static class ListMongoDatabasePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoDatabasePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoDatabasePhysicalChildType));
            list.Add(item);

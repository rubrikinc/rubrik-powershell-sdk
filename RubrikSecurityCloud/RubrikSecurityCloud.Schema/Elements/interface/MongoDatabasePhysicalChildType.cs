// MongoDatabasePhysicalChildType.cs
//
...
{
    #region MongoDatabasePhysicalChildType

    public interface MongoDatabasePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoDatabasePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoDatabasePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoDatabasePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoDatabasePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoDatabasePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MongoDatabasePhysicalChildType> list)
        {

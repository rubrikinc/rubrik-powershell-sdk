...
{
    #region PhysicalHostDescendantType

    public interface PhysicalHostDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListPhysicalHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PhysicalHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (PhysicalHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<PhysicalHostDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<PhysicalHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<PhysicalHostDescendantType> list)
        {

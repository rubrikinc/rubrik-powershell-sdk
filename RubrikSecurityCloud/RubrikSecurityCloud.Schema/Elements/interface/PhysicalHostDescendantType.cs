...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface PhysicalHostDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class PhysicalHostDescendantType
    #endregion
    ...
    public static class ListPhysicalHostDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (PhysicalHostDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(PhysicalHostDescendantType));
            list.Add(item);

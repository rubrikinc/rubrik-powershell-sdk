...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListPolarisHierarchyObjectExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PolarisHierarchyObject> list)
        {
        ...
        public static void SelectForRetrieval(this List<PolarisHierarchyObject> list)
        {

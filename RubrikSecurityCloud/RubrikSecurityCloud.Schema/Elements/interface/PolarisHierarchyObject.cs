...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface PolarisHierarchyObject: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    public static class ListPolarisHierarchyObjectExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (PolarisHierarchyObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(PolarisHierarchyObject));
            list.Add(item);

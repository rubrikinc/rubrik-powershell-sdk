// VsphereDatacenterLogicalChildType.cs
//
...
{
    #region VsphereDatacenterLogicalChildType

    public interface VsphereDatacenterLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatacenterLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatacenterLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatacenterLogicalChildType>(
                        list, 

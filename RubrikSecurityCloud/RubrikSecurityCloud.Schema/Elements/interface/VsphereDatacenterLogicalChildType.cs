...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereDatacenterLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereDatacenterLogicalChildType
    #endregion
    ...
    public static class ListVsphereDatacenterLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereDatacenterLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatacenterLogicalChildType));
            list.Add(item);

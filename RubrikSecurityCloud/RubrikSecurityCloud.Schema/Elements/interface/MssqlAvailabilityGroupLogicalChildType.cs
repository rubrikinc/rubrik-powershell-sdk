...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MssqlAvailabilityGroupLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MssqlAvailabilityGroupLogicalChildType
    #endregion
    ...
    public static class ListMssqlAvailabilityGroupLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MssqlAvailabilityGroupLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlAvailabilityGroupLogicalChildType));
            list.Add(item);

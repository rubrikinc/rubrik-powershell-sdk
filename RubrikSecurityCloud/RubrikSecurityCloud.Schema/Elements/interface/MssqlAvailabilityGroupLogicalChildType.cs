// MssqlAvailabilityGroupLogicalChildType.cs
//
...
{
    #region MssqlAvailabilityGroupLogicalChildType

    public interface MssqlAvailabilityGroupLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListMssqlAvailabilityGroupLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlAvailabilityGroupLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlAvailabilityGroupLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlAvailabilityGroupLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlAvailabilityGroupLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlAvailabilityGroupLogicalChildType> list)
        {

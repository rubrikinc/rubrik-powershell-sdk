// FusionComputeClusterPhysicalChildType.cs
//
...
{
    #region FusionComputeClusterPhysicalChildType

    public interface FusionComputeClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeClusterPhysicalChildType

    #endregion



    public static class ListFusionComputeClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeClusterPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeClusterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeClusterPhysicalChildType> list)
        {

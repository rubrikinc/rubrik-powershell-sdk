...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereResourcePoolPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereResourcePoolPhysicalChildType
    #endregion
    ...
    public static class ListVsphereResourcePoolPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereResourcePoolPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereResourcePoolPhysicalChildType));
            list.Add(item);

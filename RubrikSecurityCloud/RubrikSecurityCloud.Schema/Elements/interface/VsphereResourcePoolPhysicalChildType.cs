// VsphereResourcePoolPhysicalChildType.cs
//
...
{
    #region VsphereResourcePoolPhysicalChildType

    public interface VsphereResourcePoolPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereResourcePoolPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereResourcePoolPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereResourcePoolPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereResourcePoolPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereResourcePoolPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereResourcePoolPhysicalChildType> list)
        {

// FusionComputeSiteDescendant.cs
//
...
{
    #region FusionComputeSiteDescendant

    public interface FusionComputeSiteDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeSiteDescendant

    #endregion



    public static class ListFusionComputeSiteDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeSiteDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeSiteDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeSiteDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeSiteDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeSiteDescendant> list)
        {

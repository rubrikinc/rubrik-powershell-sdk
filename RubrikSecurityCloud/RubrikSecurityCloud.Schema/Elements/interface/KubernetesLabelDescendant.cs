...
{
    #region KubernetesLabelDescendant

    public interface KubernetesLabelDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface KubernetesLabelDescendant

    #endregion



    public static class ListKubernetesLabelDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesLabelDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KubernetesLabelDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KubernetesLabelDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KubernetesLabelDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KubernetesLabelDescendant> list)
        {

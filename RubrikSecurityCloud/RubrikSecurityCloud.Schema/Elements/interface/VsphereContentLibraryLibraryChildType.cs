// VsphereContentLibraryLibraryChildType.cs
//
...
{
    #region VsphereContentLibraryLibraryChildType

    public interface VsphereContentLibraryLibraryChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereContentLibraryLibraryChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereContentLibraryLibraryChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereContentLibraryLibraryChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereContentLibraryLibraryChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereContentLibraryLibraryChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereContentLibraryLibraryChildType> list)
        {

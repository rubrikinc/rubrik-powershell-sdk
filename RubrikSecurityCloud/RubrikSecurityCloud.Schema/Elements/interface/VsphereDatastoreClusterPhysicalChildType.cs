// VsphereDatastoreClusterPhysicalChildType.cs
//
...
{
    #region VsphereDatastoreClusterPhysicalChildType

    public interface VsphereDatastoreClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatastoreClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatastoreClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatastoreClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatastoreClusterPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatastoreClusterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereDatastoreClusterPhysicalChildType> list)
        {

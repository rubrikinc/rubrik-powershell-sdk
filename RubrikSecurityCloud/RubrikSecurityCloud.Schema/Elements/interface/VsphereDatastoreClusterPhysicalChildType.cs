...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereDatastoreClusterPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereDatastoreClusterPhysicalChildType
    #endregion
    ...
    public static class ListVsphereDatastoreClusterPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereDatastoreClusterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatastoreClusterPhysicalChildType));
            list.Add(item);

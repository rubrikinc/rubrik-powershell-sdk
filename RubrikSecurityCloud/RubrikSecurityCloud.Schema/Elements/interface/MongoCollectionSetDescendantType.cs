...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoCollectionSetDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoCollectionSetDescendantType
    #endregion
    ...
    public static class ListMongoCollectionSetDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoCollectionSetDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoCollectionSetDescendantType));
            list.Add(item);

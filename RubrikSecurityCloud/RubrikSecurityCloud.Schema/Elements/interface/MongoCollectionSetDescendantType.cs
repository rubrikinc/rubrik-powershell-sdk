// MongoCollectionSetDescendantType.cs
//
...
{
    #region MongoCollectionSetDescendantType

    public interface MongoCollectionSetDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoCollectionSetDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoCollectionSetDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoCollectionSetDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoCollectionSetDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoCollectionSetDescendantType>(
                        list, 

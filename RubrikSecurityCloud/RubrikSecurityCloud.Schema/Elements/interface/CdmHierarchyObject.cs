...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface CdmHierarchyObject: IFieldSpec
    {
        #region members
    ...
    public static class ListCdmHierarchyObjectExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmHierarchyObject> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CdmHierarchyObject>(
                        list, 

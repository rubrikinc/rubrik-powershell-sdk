...
{
    #region NasSystemLogicalChildType

    public interface NasSystemLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasSystemLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasSystemLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasSystemLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasSystemLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasSystemLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasSystemLogicalChildType> list)
        {

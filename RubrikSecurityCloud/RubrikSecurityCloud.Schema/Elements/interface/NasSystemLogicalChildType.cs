...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasSystemLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NasSystemLogicalChildType
    #endregion
    ...
    public static class ListNasSystemLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasSystemLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasSystemLogicalChildType));
            list.Add(item);

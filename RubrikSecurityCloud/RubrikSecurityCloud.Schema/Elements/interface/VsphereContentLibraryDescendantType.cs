// VsphereContentLibraryDescendantType.cs
//
...
{
    #region VsphereContentLibraryDescendantType

    public interface VsphereContentLibraryDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereContentLibraryDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereContentLibraryDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereContentLibraryDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereContentLibraryDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereContentLibraryDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereContentLibraryDescendantType> list)
        {

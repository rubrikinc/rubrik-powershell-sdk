// ProxmoxClusterPhysicalChildType.cs
//
...
{
    #region ProxmoxClusterPhysicalChildType

    public interface ProxmoxClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxClusterPhysicalChildType

    #endregion



    public static class ListProxmoxClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxClusterPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxClusterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxClusterPhysicalChildType> list)
        {

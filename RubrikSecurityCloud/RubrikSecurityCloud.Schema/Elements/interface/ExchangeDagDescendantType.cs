...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ExchangeDagDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ExchangeDagDescendantType
    #endregion
    ...
    public static class ListExchangeDagDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ExchangeDagDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ExchangeDagDescendantType));
            list.Add(item);

...
{
    #region ExchangeDagDescendantType

    public interface ExchangeDagDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListExchangeDagDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ExchangeDagDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ExchangeDagDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ExchangeDagDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ExchangeDagDescendantType>(
                        list, 

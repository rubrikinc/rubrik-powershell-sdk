// ActiveDirectoryForestDescendantType.cs
//
...
{
    #region ActiveDirectoryForestDescendantType

    public interface ActiveDirectoryForestDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface ActiveDirectoryForestDescendantType

    #endregion



    public static class ListActiveDirectoryForestDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryForestDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ActiveDirectoryForestDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryForestDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ActiveDirectoryForestDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ActiveDirectoryForestDescendantType> list)
        {

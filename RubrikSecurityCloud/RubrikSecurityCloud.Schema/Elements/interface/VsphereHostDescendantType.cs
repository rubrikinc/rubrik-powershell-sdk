...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereHostDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereHostDescendantType
    #endregion
    ...
    public static class ListVsphereHostDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereHostDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereHostDescendantType));
            list.Add(item);

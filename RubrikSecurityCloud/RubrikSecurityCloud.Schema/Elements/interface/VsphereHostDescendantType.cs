...
{
    #region VsphereHostDescendantType

    public interface VsphereHostDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereHostDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereHostDescendantType> list)
        {

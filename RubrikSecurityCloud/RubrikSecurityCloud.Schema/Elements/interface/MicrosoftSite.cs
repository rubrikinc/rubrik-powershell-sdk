...
{
    #region MicrosoftSite

    public interface MicrosoftSite: IFieldSpec
    {
        #region members
    ...
    } // interface MicrosoftSite

    #endregion



    public static class ListMicrosoftSiteExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (MicrosoftSite item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MicrosoftSite> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MicrosoftSite>(
                        list, 

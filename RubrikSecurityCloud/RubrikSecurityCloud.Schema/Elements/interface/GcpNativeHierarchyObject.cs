...
{
    #region GcpNativeHierarchyObject

    public interface GcpNativeHierarchyObject: IFieldSpec
    {
        #region members
    ...
    } // interface GcpNativeHierarchyObject

    #endregion



    public static class ListGcpNativeHierarchyObjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpNativeHierarchyObject> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (GcpNativeHierarchyObject item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<GcpNativeHierarchyObject> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<GcpNativeHierarchyObject>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<GcpNativeHierarchyObject> list)
        {

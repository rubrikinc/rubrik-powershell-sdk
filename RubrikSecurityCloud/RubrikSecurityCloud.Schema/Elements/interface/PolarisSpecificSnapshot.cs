...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListPolarisSpecificSnapshotExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PolarisSpecificSnapshot> list)
        {
        ...
        public static void SelectForRetrieval(this List<PolarisSpecificSnapshot> list)
        {

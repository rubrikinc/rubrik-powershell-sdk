...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdLogicalChildType));
            list.Add(item);

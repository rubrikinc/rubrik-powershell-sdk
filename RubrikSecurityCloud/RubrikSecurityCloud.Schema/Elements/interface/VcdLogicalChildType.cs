...
{
    #region VcdLogicalChildType

    public interface VcdLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdLogicalChildType> list)
        {

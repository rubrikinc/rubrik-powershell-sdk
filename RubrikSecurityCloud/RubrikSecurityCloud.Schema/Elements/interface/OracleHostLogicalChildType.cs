...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleHostLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleHostLogicalChildType
    #endregion
    ...
    public static class ListOracleHostLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleHostLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleHostLogicalChildType));
            list.Add(item);

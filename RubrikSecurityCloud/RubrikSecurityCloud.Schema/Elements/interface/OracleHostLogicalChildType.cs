...
{
    #region OracleHostLogicalChildType

    public interface OracleHostLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleHostLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleHostLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleHostLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleHostLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleHostLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleHostLogicalChildType> list)
        {

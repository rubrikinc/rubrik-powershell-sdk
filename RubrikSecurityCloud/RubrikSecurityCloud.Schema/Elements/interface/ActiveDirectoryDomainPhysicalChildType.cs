// ActiveDirectoryDomainPhysicalChildType.cs
//
...
{
    #region ActiveDirectoryDomainPhysicalChildType

    public interface ActiveDirectoryDomainPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListActiveDirectoryDomainPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryDomainPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ActiveDirectoryDomainPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryDomainPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ActiveDirectoryDomainPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ActiveDirectoryDomainPhysicalChildType> list)
        {

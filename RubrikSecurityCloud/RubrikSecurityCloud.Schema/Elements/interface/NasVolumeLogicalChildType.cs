...
{
    #region NasVolumeLogicalChildType

    public interface NasVolumeLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasVolumeLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasVolumeLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasVolumeLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasVolumeLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasVolumeLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasVolumeLogicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasVolumeLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NasVolumeLogicalChildType
    #endregion
    ...
    public static class ListNasVolumeLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasVolumeLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasVolumeLogicalChildType));
            list.Add(item);

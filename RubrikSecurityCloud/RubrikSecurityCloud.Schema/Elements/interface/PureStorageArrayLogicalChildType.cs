// PureStorageArrayLogicalChildType.cs
//
...
{
    #region PureStorageArrayLogicalChildType

    public interface PureStorageArrayLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface PureStorageArrayLogicalChildType

    #endregion



    public static class ListPureStorageArrayLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageArrayLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (PureStorageArrayLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<PureStorageArrayLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<PureStorageArrayLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<PureStorageArrayLogicalChildType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HostFailoverClusterPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HostFailoverClusterPhysicalChildType
    #endregion
    ...
    public static class ListHostFailoverClusterPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HostFailoverClusterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostFailoverClusterPhysicalChildType));
            list.Add(item);

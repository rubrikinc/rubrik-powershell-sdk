// HostFailoverClusterPhysicalChildType.cs
//
...
{
    #region HostFailoverClusterPhysicalChildType

    public interface HostFailoverClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListHostFailoverClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HostFailoverClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HostFailoverClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HostFailoverClusterPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HostFailoverClusterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HostFailoverClusterPhysicalChildType> list)
        {

// VsphereFolderLogicalChildType.cs
//
...
{
    #region VsphereFolderLogicalChildType

    public interface VsphereFolderLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereFolderLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereFolderLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereFolderLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereFolderLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereFolderLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereFolderLogicalChildType> list)
        {

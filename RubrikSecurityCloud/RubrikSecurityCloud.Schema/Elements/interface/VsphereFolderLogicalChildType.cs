...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereFolderLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereFolderLogicalChildType
    #endregion
    ...
    public static class ListVsphereFolderLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereFolderLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereFolderLogicalChildType));
            list.Add(item);

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface WindowsClusterLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class WindowsClusterLogicalChildType
    #endregion
    ...
    public static class ListWindowsClusterLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (WindowsClusterLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(WindowsClusterLogicalChildType));
            list.Add(item);

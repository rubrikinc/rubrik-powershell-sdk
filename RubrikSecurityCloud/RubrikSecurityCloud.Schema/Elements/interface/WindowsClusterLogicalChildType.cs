// WindowsClusterLogicalChildType.cs
//
...
{
    #region WindowsClusterLogicalChildType

    public interface WindowsClusterLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListWindowsClusterLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<WindowsClusterLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (WindowsClusterLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<WindowsClusterLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<WindowsClusterLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<WindowsClusterLogicalChildType> list)
        {

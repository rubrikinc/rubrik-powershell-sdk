...
{
    #region OracleRacDescendantType

    public interface OracleRacDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleRacDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleRacDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleRacDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleRacDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleRacDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleRacDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleRacDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListOracleRacDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleRacDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleRacDescendantType));
            list.Add(item);

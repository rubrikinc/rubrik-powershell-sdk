// FusionComputeHostPhysicalChildType.cs
//
...
{
    #region FusionComputeHostPhysicalChildType

    public interface FusionComputeHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeHostPhysicalChildType

    #endregion



    public static class ListFusionComputeHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeHostPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeHostPhysicalChildType> list)
        {

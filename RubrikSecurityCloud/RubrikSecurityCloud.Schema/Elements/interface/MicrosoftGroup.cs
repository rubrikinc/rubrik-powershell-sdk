...
{
    #region MicrosoftGroup

    public interface MicrosoftGroup: IFieldSpec
    {
        #region members
    ...
    public static class ListMicrosoftGroupExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MicrosoftGroup> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MicrosoftGroup item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MicrosoftGroup> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MicrosoftGroup>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MicrosoftGroup> list)
        {

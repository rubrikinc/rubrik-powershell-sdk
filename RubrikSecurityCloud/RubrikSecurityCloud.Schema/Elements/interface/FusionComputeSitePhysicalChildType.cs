// FusionComputeSitePhysicalChildType.cs
//
...
{
    #region FusionComputeSitePhysicalChildType

    public interface FusionComputeSitePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeSitePhysicalChildType

    #endregion



    public static class ListFusionComputeSitePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeSitePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeSitePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeSitePhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeSitePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeSitePhysicalChildType> list)
        {

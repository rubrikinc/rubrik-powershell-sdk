...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface AzureNativeHierarchyObjectType: IFragment
    {
        #region members
    ...
    } // class AzureNativeHierarchyObjectType
    #endregion
    ...
    public static class ListAzureNativeHierarchyObjectTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (AzureNativeHierarchyObjectType)InterfaceHelper.CreateInstanceOfFirstType(typeof(AzureNativeHierarchyObjectType));
            list.Add(item);

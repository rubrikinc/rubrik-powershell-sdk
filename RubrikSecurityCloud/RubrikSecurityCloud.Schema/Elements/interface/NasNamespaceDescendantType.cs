...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasNamespaceDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NasNamespaceDescendantType
    #endregion
    ...
    public static class ListNasNamespaceDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasNamespaceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasNamespaceDescendantType));
            list.Add(item);

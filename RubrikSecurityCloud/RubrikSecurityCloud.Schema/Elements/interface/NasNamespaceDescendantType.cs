...
{
    #region NasNamespaceDescendantType

    public interface NasNamespaceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasNamespaceDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasNamespaceDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasNamespaceDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasNamespaceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasNamespaceDescendantType>(
                        list, 

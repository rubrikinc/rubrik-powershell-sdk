// VsphereVcenterLogicalChildType.cs
//
...
{
    #region VsphereVcenterLogicalChildType

    public interface VsphereVcenterLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereVcenterLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereVcenterLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereVcenterLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterLogicalChildType> list)
        {

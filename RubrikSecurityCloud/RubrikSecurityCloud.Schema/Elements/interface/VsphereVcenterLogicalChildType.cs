...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereVcenterLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereVcenterLogicalChildType
    #endregion
    ...
    public static class ListVsphereVcenterLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereVcenterLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereVcenterLogicalChildType));
            list.Add(item);

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoSourceDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoSourceDescendantType
    #endregion
    ...
    public static class ListMongoSourceDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoSourceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoSourceDescendantType));
            list.Add(item);

...
{
    #region MongoSourceDescendantType

    public interface MongoSourceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoSourceDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoSourceDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoSourceDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoSourceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoSourceDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MongoSourceDescendantType> list)
        {

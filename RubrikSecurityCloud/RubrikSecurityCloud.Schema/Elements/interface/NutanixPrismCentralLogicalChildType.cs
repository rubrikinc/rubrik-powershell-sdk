// NutanixPrismCentralLogicalChildType.cs
//
...
{
    #region NutanixPrismCentralLogicalChildType

    public interface NutanixPrismCentralLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixPrismCentralLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixPrismCentralLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixPrismCentralLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixPrismCentralLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixPrismCentralLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixPrismCentralLogicalChildType> list)
        {

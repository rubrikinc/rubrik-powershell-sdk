...
{
    #region VcdCatalogDescendantType

    public interface VcdCatalogDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdCatalogDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdCatalogDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdCatalogDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdCatalogDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdCatalogDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdCatalogDescendantType> list)
        {

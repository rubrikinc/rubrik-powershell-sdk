...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ManagedVolumeMountPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ManagedVolumeMountPhysicalChildType
    #endregion
    ...
    public static class ListManagedVolumeMountPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ManagedVolumeMountPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ManagedVolumeMountPhysicalChildType));
            list.Add(item);

// ManagedVolumeMountPhysicalChildType.cs
//
...
{
    #region ManagedVolumeMountPhysicalChildType

    public interface ManagedVolumeMountPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListManagedVolumeMountPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ManagedVolumeMountPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ManagedVolumeMountPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeMountPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ManagedVolumeMountPhysicalChildType>(
                        ref list, 
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeMountPhysicalChildType> list)
        {

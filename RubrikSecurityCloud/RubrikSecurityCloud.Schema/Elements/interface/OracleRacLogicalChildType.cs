...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface OracleRacLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class OracleRacLogicalChildType
    #endregion
    ...
    public static class ListOracleRacLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (OracleRacLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleRacLogicalChildType));
            list.Add(item);

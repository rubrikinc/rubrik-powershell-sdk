...
{
    #region OracleRacLogicalChildType

    public interface OracleRacLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListOracleRacLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleRacLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OracleRacLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OracleRacLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OracleRacLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OracleRacLogicalChildType> list)
        {

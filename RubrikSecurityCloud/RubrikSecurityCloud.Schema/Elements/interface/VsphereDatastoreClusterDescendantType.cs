// VsphereDatastoreClusterDescendantType.cs
//
...
{
    #region VsphereDatastoreClusterDescendantType

    public interface VsphereDatastoreClusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereDatastoreClusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatastoreClusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereDatastoreClusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereDatastoreClusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereDatastoreClusterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereDatastoreClusterDescendantType> list)
        {

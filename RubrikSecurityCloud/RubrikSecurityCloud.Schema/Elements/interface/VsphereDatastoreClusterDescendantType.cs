...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereDatastoreClusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereDatastoreClusterDescendantType
    #endregion
    ...
    public static class ListVsphereDatastoreClusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereDatastoreClusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatastoreClusterDescendantType));
            list.Add(item);

// ProxmoxEnvironmentDescendant.cs
//
...
{
    #region ProxmoxEnvironmentDescendant

    public interface ProxmoxEnvironmentDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxEnvironmentDescendant

    #endregion



    public static class ListProxmoxEnvironmentDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxEnvironmentDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxEnvironmentDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxEnvironmentDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxEnvironmentDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxEnvironmentDescendant> list)
        {

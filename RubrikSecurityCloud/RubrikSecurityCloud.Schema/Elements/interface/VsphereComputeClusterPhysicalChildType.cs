// VsphereComputeClusterPhysicalChildType.cs
//
...
{
    #region VsphereComputeClusterPhysicalChildType

    public interface VsphereComputeClusterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereComputeClusterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereComputeClusterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereComputeClusterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereComputeClusterPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereComputeClusterPhysicalChildType>(
                        list, 

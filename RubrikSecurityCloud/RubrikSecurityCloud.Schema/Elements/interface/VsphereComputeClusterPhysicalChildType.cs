...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereComputeClusterPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereComputeClusterPhysicalChildType
    #endregion
    ...
    public static class ListVsphereComputeClusterPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereComputeClusterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereComputeClusterPhysicalChildType));
            list.Add(item);

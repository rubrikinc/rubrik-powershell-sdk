// FusionComputeClusterDescendant.cs
//
...
{
    #region FusionComputeClusterDescendant

    public interface FusionComputeClusterDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeClusterDescendant

    #endregion



    public static class ListFusionComputeClusterDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeClusterDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeClusterDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeClusterDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeClusterDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeClusterDescendant> list)
        {

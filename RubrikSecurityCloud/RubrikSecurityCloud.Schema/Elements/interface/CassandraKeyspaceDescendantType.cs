...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface CassandraKeyspaceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListCassandraKeyspaceDescendantTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraKeyspaceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CassandraKeyspaceDescendantType>(
                        list, 

// CassandraKeyspaceDescendantType.cs
//
...
{
    #region CassandraKeyspaceDescendantType
    public interface CassandraKeyspaceDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class CassandraKeyspaceDescendantType
    #endregion

    public static class ListCassandraKeyspaceDescendantTypeExtensions
    {
        ...
        public static string AsFragment(
            this List<CassandraKeyspaceDescendantType> list,
            int indent=0)
        {
            string fragments = "";
            foreach (CassandraKeyspaceDescendantType item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CassandraKeyspaceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(CassandraKeyspaceDescendantType));
            list.Add(item);

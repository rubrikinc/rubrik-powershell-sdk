...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HyperVscvmmDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HyperVscvmmDescendantType
    #endregion
    ...
    public static class ListHyperVscvmmDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HyperVscvmmDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HyperVscvmmDescendantType));
            list.Add(item);

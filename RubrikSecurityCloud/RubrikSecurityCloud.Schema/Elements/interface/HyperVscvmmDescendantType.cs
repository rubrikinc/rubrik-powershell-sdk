...
{
    #region HyperVscvmmDescendantType

    public interface HyperVscvmmDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHyperVscvmmDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HyperVscvmmDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HyperVscvmmDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HyperVscvmmDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HyperVscvmmDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HyperVscvmmDescendantType> list)
        {

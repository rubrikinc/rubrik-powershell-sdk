...
{
    #region HierarchySnappable

    public interface HierarchySnappable: IFieldSpec
    {
        #region members
    ...
    public static class ListHierarchySnappableExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HierarchySnappable> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (HierarchySnappable item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<HierarchySnappable> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HierarchySnappable>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HierarchySnappable> list)
        {

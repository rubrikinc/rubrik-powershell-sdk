...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HierarchySnappable: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    public static class ListHierarchySnappableExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HierarchySnappable)InterfaceHelper.CreateInstanceOfFirstType(typeof(HierarchySnappable));
            list.Add(item);

// PureStorageArrayDescendantV1.cs
//
...
{
    #region PureStorageArrayDescendantV1

    public interface PureStorageArrayDescendantV1: IFieldSpec
    {
        #region members
    ...
    } // interface PureStorageArrayDescendantV1

    #endregion



    public static class ListPureStorageArrayDescendantV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageArrayDescendantV1> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (PureStorageArrayDescendantV1 item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<PureStorageArrayDescendantV1> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<PureStorageArrayDescendantV1>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<PureStorageArrayDescendantV1> list)
        {

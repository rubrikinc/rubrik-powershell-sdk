...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HypervServerDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HypervServerDescendantType
    #endregion
    ...
    public static class ListHypervServerDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HypervServerDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HypervServerDescendantType));
            list.Add(item);

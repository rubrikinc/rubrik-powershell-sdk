...
{
    #region HypervServerDescendantType

    public interface HypervServerDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHypervServerDescendantTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HypervServerDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HypervServerDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HypervServerDescendantType> list)
        {

// KosmosParentHierarchyObjectType.cs
//
...
{
    #region KosmosParentHierarchyObjectType

    public interface KosmosParentHierarchyObjectType: IFieldSpec
    {
        #region members
        ...
        KosmosParentHierarchyObjectDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        KosmosParentHierarchyObjectPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    } // interface KosmosParentHierarchyObjectType

    #endregion



    public static class ListKosmosParentHierarchyObjectTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosParentHierarchyObjectType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosParentHierarchyObjectType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosParentHierarchyObjectType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosParentHierarchyObjectType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosParentHierarchyObjectType> list)
        {

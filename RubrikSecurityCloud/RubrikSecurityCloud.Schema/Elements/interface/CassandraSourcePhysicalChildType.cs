...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface CassandraSourcePhysicalChildType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class CassandraSourcePhysicalChildType
    #endregion
    ...
    public static class ListCassandraSourcePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CassandraSourcePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(CassandraSourcePhysicalChildType));
            list.Add(item);

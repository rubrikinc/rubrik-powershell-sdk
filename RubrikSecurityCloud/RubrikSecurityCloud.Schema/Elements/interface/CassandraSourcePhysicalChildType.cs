// CassandraSourcePhysicalChildType.cs
//
...
{
    #region CassandraSourcePhysicalChildType

    public interface CassandraSourcePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListCassandraSourcePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CassandraSourcePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CassandraSourcePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CassandraSourcePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CassandraSourcePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CassandraSourcePhysicalChildType> list)
        {

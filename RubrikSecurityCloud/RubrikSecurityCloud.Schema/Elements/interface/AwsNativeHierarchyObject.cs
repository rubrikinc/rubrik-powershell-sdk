...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface AwsNativeHierarchyObject: IFragment
    {
        #region members
    ...
    } // class AwsNativeHierarchyObject
    #endregion
    ...
    public static class ListAwsNativeHierarchyObjectExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (AwsNativeHierarchyObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(AwsNativeHierarchyObject));
            list.Add(item);

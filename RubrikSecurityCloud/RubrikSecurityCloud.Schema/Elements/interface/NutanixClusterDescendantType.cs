// NutanixClusterDescendantType.cs
//
...
{
    #region NutanixClusterDescendantType

    public interface NutanixClusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixClusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixClusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixClusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixClusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixClusterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixClusterDescendantType> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NutanixClusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NutanixClusterDescendantType
    #endregion
    ...
    public static class ListNutanixClusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NutanixClusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NutanixClusterDescendantType));
            list.Add(item);

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface Db2InstancePhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class Db2InstancePhysicalChildType
    #endregion
    ...
    public static class ListDb2InstancePhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (Db2InstancePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(Db2InstancePhysicalChildType));
            list.Add(item);

// Db2InstancePhysicalChildType.cs
//
...
{
    #region Db2InstancePhysicalChildType

    public interface Db2InstancePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListDb2InstancePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<Db2InstancePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (Db2InstancePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<Db2InstancePhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<Db2InstancePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<Db2InstancePhysicalChildType> list)
        {

// OlvmDatacenterPhysicalChildType.cs
//
...
{
    #region OlvmDatacenterPhysicalChildType

    public interface OlvmDatacenterPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmDatacenterPhysicalChildType

    #endregion



    public static class ListOlvmDatacenterPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmDatacenterPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmDatacenterPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmDatacenterPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmDatacenterPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmDatacenterPhysicalChildType> list)
        {

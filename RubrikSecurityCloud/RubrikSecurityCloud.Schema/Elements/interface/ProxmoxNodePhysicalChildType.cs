// ProxmoxNodePhysicalChildType.cs
//
...
{
    #region ProxmoxNodePhysicalChildType

    public interface ProxmoxNodePhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxNodePhysicalChildType

    #endregion



    public static class ListProxmoxNodePhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxNodePhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxNodePhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxNodePhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxNodePhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxNodePhysicalChildType> list)
        {

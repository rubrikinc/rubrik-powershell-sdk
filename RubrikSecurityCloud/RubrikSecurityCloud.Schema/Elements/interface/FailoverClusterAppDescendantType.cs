...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface FailoverClusterAppDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class FailoverClusterAppDescendantType
    #endregion
    ...
    public static class ListFailoverClusterAppDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (FailoverClusterAppDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FailoverClusterAppDescendantType));
            list.Add(item);

// FailoverClusterAppDescendantType.cs
//
...
{
    #region FailoverClusterAppDescendantType

    public interface FailoverClusterAppDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListFailoverClusterAppDescendantTypeExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (FailoverClusterAppDescendantType item in list) 
            {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FailoverClusterAppDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FailoverClusterAppDescendantType> list)
        {

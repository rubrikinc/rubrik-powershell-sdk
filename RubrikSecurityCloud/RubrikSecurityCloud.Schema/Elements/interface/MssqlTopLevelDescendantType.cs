// MssqlTopLevelDescendantType.cs
//
...
{
    #region MssqlTopLevelDescendantType

    public interface MssqlTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMssqlTopLevelDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlTopLevelDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlTopLevelDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlTopLevelDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlTopLevelDescendantType>(
                        list, 

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MssqlTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MssqlTopLevelDescendantType
    #endregion
    ...
    public static class ListMssqlTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MssqlTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlTopLevelDescendantType));
            list.Add(item);

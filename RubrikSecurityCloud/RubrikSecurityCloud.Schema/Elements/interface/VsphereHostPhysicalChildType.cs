// VsphereHostPhysicalChildType.cs
//
...
{
    #region VsphereHostPhysicalChildType

    public interface VsphereHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereHostPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereHostPhysicalChildType> list)
        {

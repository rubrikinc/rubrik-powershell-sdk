...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereHostPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereHostPhysicalChildType
    #endregion
    ...
    public static class ListVsphereHostPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereHostPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereHostPhysicalChildType));
            list.Add(item);

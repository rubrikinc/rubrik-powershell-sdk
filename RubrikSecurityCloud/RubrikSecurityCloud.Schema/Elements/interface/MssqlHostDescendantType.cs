...
{
    #region MssqlHostDescendantType

    public interface MssqlHostDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface MssqlHostDescendantType

    #endregion



    public static class ListMssqlHostDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlHostDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MssqlHostDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MssqlHostDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MssqlHostDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MssqlHostDescendantType> list)
        {

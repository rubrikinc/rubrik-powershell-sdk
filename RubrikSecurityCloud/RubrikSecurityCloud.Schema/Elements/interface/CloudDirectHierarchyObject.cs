...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface CloudDirectHierarchyObject: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class CloudDirectHierarchyObject
    #endregion
    ...
    public static class ListCloudDirectHierarchyObjectExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CloudDirectHierarchyObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(CloudDirectHierarchyObject));
            list.Add(item);

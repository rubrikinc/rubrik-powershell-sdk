...
{
    #region CloudDirectHierarchyObject

    public interface CloudDirectHierarchyObject: IFieldSpec
    {
        #region members
    ...
    public static class ListCloudDirectHierarchyObjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectHierarchyObject> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CloudDirectHierarchyObject item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CloudDirectHierarchyObject> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectHierarchyObject>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CloudDirectHierarchyObject> list)
        {

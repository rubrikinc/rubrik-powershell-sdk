...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRequestedChangesTemplateExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RequestedChangesTemplate> list)
        {
        ...
        public static void SelectForRetrieval(this List<RequestedChangesTemplate> list)
        {

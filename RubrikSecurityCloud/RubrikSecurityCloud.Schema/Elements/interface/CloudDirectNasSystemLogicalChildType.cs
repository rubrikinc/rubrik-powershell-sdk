// CloudDirectNasSystemLogicalChildType.cs
//
...
{
    #region CloudDirectNasSystemLogicalChildType

    public interface CloudDirectNasSystemLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface CloudDirectNasSystemLogicalChildType

    #endregion



    public static class ListCloudDirectNasSystemLogicalChildTypeExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (CloudDirectNasSystemLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasSystemLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectNasSystemLogicalChildType>(
                        list, 

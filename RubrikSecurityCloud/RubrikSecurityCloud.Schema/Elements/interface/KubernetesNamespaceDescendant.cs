// KubernetesNamespaceDescendant.cs
//
...
{
    #region KubernetesNamespaceDescendant

    public interface KubernetesNamespaceDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface KubernetesNamespaceDescendant

    #endregion



    public static class ListKubernetesNamespaceDescendantExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (KubernetesNamespaceDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KubernetesNamespaceDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KubernetesNamespaceDescendant>(
                        list, 

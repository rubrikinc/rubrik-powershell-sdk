...
{
    #region O365OrgDescendant
    public interface O365OrgDescendant: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class O365OrgDescendant
    #endregion

    public static class ListO365OrgDescendantExtensions
    {
        ...
        public static string AsFragment(
            this List<O365OrgDescendant> list,
            int indent=0)
        {
            string fragments = "";
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (O365OrgDescendant)InterfaceHelper.CreateInstanceOfFirstType(typeof(O365OrgDescendant));
            list.Add(item);

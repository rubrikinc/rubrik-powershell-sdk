...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface PolarisHierarchySnappable: IFragment
    {
        #region members
    ...
    } // class PolarisHierarchySnappable
    #endregion
    ...
    public static class ListPolarisHierarchySnappableExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (PolarisHierarchySnappable)InterfaceHelper.CreateInstanceOfFirstType(typeof(PolarisHierarchySnappable));
            list.Add(item);

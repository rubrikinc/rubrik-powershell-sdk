...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface ExchangeServerDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class ExchangeServerDescendantType
    #endregion
    ...
    public static class ListExchangeServerDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (ExchangeServerDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ExchangeServerDescendantType));
            list.Add(item);

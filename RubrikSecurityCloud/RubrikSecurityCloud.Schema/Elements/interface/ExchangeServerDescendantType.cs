// ExchangeServerDescendantType.cs
//
...
{
    #region ExchangeServerDescendantType

    public interface ExchangeServerDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListExchangeServerDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ExchangeServerDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ExchangeServerDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ExchangeServerDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ExchangeServerDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ExchangeServerDescendantType> list)
        {

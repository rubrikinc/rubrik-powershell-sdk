// FusionComputeVrmPhysicalChildType.cs
//
...
{
    #region FusionComputeVrmPhysicalChildType

    public interface FusionComputeVrmPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface FusionComputeVrmPhysicalChildType

    #endregion



    public static class ListFusionComputeVrmPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeVrmPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FusionComputeVrmPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FusionComputeVrmPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FusionComputeVrmPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FusionComputeVrmPhysicalChildType> list)
        {

// FailoverClusterAppPhysicalChildType.cs
//
...
{
    #region FailoverClusterAppPhysicalChildType

    public interface FailoverClusterAppPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListFailoverClusterAppPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FailoverClusterAppPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (FailoverClusterAppPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<FailoverClusterAppPhysicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<FailoverClusterAppPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<FailoverClusterAppPhysicalChildType> list)
        {

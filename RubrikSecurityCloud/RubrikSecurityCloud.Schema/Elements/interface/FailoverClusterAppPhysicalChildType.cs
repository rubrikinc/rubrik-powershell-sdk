...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface FailoverClusterAppPhysicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class FailoverClusterAppPhysicalChildType
    #endregion
    ...
    public static class ListFailoverClusterAppPhysicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (FailoverClusterAppPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FailoverClusterAppPhysicalChildType));
            list.Add(item);

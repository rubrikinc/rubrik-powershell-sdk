// ExchangeHostPhysicalChildType.cs
//
...
{
    #region ExchangeHostPhysicalChildType

    public interface ExchangeHostPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface ExchangeHostPhysicalChildType

    #endregion



    public static class ListExchangeHostPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ExchangeHostPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ExchangeHostPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ExchangeHostPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ExchangeHostPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ExchangeHostPhysicalChildType> list)
        {

// OpenstackProjectLogicalChildType.cs
//
...
{
    #region OpenstackProjectLogicalChildType

    public interface OpenstackProjectLogicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackProjectLogicalChildType

    #endregion



    public static class ListOpenstackProjectLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackProjectLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackProjectLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackProjectLogicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackProjectLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackProjectLogicalChildType> list)
        {

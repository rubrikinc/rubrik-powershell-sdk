...
{
    #region KosmosHierarchyObjectType

    public interface KosmosHierarchyObjectType: IFieldSpec
    {
        #region members
    ...
    } // interface KosmosHierarchyObjectType

    #endregion



    public static class ListKosmosHierarchyObjectTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosHierarchyObjectType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosHierarchyObjectType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosHierarchyObjectType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosHierarchyObjectType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosHierarchyObjectType> list)
        {

// HypervTopLevelDescendantType.cs
//
...
{
    #region HypervTopLevelDescendantType

    public interface HypervTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListHypervTopLevelDescendantTypeExtensions
    {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<HypervTopLevelDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<HypervTopLevelDescendantType> list)
        {

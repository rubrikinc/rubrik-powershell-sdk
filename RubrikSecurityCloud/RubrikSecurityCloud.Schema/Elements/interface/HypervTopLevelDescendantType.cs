...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HypervTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HypervTopLevelDescendantType
    #endregion
    ...
    public static class ListHypervTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HypervTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HypervTopLevelDescendantType));
            list.Add(item);

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface HypervServerLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class HypervServerLogicalChildType
    #endregion
    ...
    public static class ListHypervServerLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (HypervServerLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HypervServerLogicalChildType));
            list.Add(item);

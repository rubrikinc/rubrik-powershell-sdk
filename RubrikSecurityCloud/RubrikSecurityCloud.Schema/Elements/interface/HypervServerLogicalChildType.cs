// HypervServerLogicalChildType.cs
//
...
{
    #region HypervServerLogicalChildType

    public interface HypervServerLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListHypervServerLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HypervServerLogicalChildType> list,
        ...
        public static List<string> SelectedFields(this List<HypervServerLogicalChildType> list)
        {
        ...
        public static void SelectForRetrieval(this List<HypervServerLogicalChildType> list)
        {

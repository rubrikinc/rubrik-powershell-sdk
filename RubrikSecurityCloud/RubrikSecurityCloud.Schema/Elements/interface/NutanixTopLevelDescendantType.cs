...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NutanixTopLevelDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NutanixTopLevelDescendantType
    #endregion
    ...
    public static class ListNutanixTopLevelDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NutanixTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NutanixTopLevelDescendantType));
            list.Add(item);

// NutanixTopLevelDescendantType.cs
//
...
{
    #region NutanixTopLevelDescendantType

    public interface NutanixTopLevelDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixTopLevelDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixTopLevelDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixTopLevelDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixTopLevelDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixTopLevelDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixTopLevelDescendantType> list)
        {

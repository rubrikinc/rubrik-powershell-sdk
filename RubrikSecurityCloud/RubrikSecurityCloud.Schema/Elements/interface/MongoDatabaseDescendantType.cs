// MongoDatabaseDescendantType.cs
//
...
{
    #region MongoDatabaseDescendantType

    public interface MongoDatabaseDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListMongoDatabaseDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoDatabaseDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (MongoDatabaseDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MongoDatabaseDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MongoDatabaseDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<MongoDatabaseDescendantType> list)
        {

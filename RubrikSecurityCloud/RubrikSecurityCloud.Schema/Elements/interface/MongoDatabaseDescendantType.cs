...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface MongoDatabaseDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class MongoDatabaseDescendantType
    #endregion
    ...
    public static class ListMongoDatabaseDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (MongoDatabaseDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoDatabaseDescendantType));
            list.Add(item);

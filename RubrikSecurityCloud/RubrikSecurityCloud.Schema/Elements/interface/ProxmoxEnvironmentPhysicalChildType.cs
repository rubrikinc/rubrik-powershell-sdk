// ProxmoxEnvironmentPhysicalChildType.cs
//
...
{
    #region ProxmoxEnvironmentPhysicalChildType

    public interface ProxmoxEnvironmentPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxEnvironmentPhysicalChildType

    #endregion



    public static class ListProxmoxEnvironmentPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxEnvironmentPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxEnvironmentPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxEnvironmentPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxEnvironmentPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxEnvironmentPhysicalChildType> list)
        {

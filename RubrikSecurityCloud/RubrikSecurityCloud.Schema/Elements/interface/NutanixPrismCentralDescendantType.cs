// NutanixPrismCentralDescendantType.cs
//
...
{
    #region NutanixPrismCentralDescendantType

    public interface NutanixPrismCentralDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixPrismCentralDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixPrismCentralDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixPrismCentralDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixPrismCentralDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixPrismCentralDescendantType>(
                        list, 

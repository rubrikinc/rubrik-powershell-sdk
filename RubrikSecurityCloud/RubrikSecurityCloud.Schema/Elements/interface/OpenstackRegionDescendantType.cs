// OpenstackRegionDescendantType.cs
//
...
{
    #region OpenstackRegionDescendantType

    public interface OpenstackRegionDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackRegionDescendantType

    #endregion



    public static class ListOpenstackRegionDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackRegionDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackRegionDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackRegionDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackRegionDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackRegionDescendantType> list)
        {

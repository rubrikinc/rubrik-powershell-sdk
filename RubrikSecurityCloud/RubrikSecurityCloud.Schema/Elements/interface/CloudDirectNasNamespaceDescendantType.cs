// CloudDirectNasNamespaceDescendantType.cs
//
...
{
    #region CloudDirectNasNamespaceDescendantType

    public interface CloudDirectNasNamespaceDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface CloudDirectNasNamespaceDescendantType

    #endregion



    public static class ListCloudDirectNasNamespaceDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectNasNamespaceDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (CloudDirectNasNamespaceDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasNamespaceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CloudDirectNasNamespaceDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<CloudDirectNasNamespaceDescendantType> list)
        {

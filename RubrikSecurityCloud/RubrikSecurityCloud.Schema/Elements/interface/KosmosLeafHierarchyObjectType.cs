// KosmosLeafHierarchyObjectType.cs
//
...
{
    #region KosmosLeafHierarchyObjectType

    public interface KosmosLeafHierarchyObjectType: IFieldSpec
    {
        #region members
        ...
        KosmosParentHierarchyObjectType? ParentEntity { get; set; }
    ...
    } // interface KosmosLeafHierarchyObjectType

    #endregion



    public static class ListKosmosLeafHierarchyObjectTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosLeafHierarchyObjectType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosLeafHierarchyObjectType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosLeafHierarchyObjectType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosLeafHierarchyObjectType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosLeafHierarchyObjectType> list)
        {

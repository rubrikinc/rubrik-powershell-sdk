...
{
    #region ProxmoxNodeDescendant

    public interface ProxmoxNodeDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface ProxmoxNodeDescendant

    #endregion



    public static class ListProxmoxNodeDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxNodeDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ProxmoxNodeDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ProxmoxNodeDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ProxmoxNodeDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ProxmoxNodeDescendant> list)
        {

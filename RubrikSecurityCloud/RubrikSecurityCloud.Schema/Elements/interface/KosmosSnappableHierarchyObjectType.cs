// KosmosSnappableHierarchyObjectType.cs
//
...
{
    #region KosmosSnappableHierarchyObjectType

    public interface KosmosSnappableHierarchyObjectType: IFieldSpec
    {
        #region members
        ...
        KosmosWorkloadLiveMountConnection? LiveMounts { get; set; }
    ...
    } // interface KosmosSnappableHierarchyObjectType

    #endregion



    public static class ListKosmosSnappableHierarchyObjectTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosSnappableHierarchyObjectType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (KosmosSnappableHierarchyObjectType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<KosmosSnappableHierarchyObjectType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<KosmosSnappableHierarchyObjectType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<KosmosSnappableHierarchyObjectType> list)
        {

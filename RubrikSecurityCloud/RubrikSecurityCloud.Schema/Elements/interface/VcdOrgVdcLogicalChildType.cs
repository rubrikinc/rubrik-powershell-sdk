...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdOrgVdcLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VcdOrgVdcLogicalChildType
    #endregion
    ...
    public static class ListVcdOrgVdcLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdOrgVdcLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdOrgVdcLogicalChildType));
            list.Add(item);

...
{
    #region VcdOrgVdcLogicalChildType

    public interface VcdOrgVdcLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdOrgVdcLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdOrgVdcLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdOrgVdcLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdOrgVdcLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdOrgVdcLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdOrgVdcLogicalChildType> list)
        {

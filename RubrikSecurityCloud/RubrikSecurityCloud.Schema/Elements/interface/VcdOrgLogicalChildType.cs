...
{
    #region VcdOrgLogicalChildType

    public interface VcdOrgLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdOrgLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdOrgLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdOrgLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdOrgLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdOrgLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdOrgLogicalChildType> list)
        {

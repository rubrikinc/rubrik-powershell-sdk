...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdOrgLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdOrgLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdOrgLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdOrgLogicalChildType));
            list.Add(item);

// NutanixCategoryValueLogicalChildType.cs
//
...
{
    #region NutanixCategoryValueLogicalChildType

    public interface NutanixCategoryValueLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixCategoryValueLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixCategoryValueLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixCategoryValueLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryValueLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixCategoryValueLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixCategoryValueLogicalChildType> list)
        {

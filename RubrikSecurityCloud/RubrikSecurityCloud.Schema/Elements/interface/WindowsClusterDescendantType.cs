// WindowsClusterDescendantType.cs
//
...
{
    #region WindowsClusterDescendantType

    public interface WindowsClusterDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListWindowsClusterDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<WindowsClusterDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (WindowsClusterDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<WindowsClusterDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<WindowsClusterDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<WindowsClusterDescendantType> list)
        {

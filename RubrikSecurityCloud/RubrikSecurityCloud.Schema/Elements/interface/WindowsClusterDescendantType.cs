...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface WindowsClusterDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class WindowsClusterDescendantType
    #endregion
    ...
    public static class ListWindowsClusterDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (WindowsClusterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(WindowsClusterDescendantType));
            list.Add(item);

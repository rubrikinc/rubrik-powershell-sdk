...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface CassandraSourceDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListCassandraSourceDescendantTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourceDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CassandraSourceDescendantType>(
                        list, 

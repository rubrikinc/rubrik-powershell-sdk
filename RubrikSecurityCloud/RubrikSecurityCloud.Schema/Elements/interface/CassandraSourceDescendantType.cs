// CassandraSourceDescendantType.cs
//
...
{
    #region CassandraSourceDescendantType
    public interface CassandraSourceDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class CassandraSourceDescendantType
    #endregion

    public static class ListCassandraSourceDescendantTypeExtensions
    {
        ...
        {
            string fragments = "";
            foreach (CassandraSourceDescendantType item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (CassandraSourceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(CassandraSourceDescendantType));
            list.Add(item);

// OlvmManagerPhysicalChildType.cs
//
...
{
    #region OlvmManagerPhysicalChildType

    public interface OlvmManagerPhysicalChildType: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmManagerPhysicalChildType

    #endregion



    public static class ListOlvmManagerPhysicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmManagerPhysicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmManagerPhysicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmManagerPhysicalChildType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmManagerPhysicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmManagerPhysicalChildType> list)
        {

...
{
    #region NasShareLogicalChildType

    public interface NasShareLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNasShareLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NasShareLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NasShareLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NasShareLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NasShareLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NasShareLogicalChildType> list)
        {

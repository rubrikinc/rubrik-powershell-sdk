...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface NasShareLogicalChildType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class NasShareLogicalChildType
    #endregion
    ...
    public static class ListNasShareLogicalChildTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (NasShareLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasShareLogicalChildType));
            list.Add(item);

// NutanixCategoryDescendantType.cs
//
...
{
    #region NutanixCategoryDescendantType

    public interface NutanixCategoryDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixCategoryDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixCategoryDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixCategoryDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixCategoryDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixCategoryDescendantType> list)
        {

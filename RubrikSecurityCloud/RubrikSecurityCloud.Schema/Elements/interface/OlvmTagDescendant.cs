...
{
    #region OlvmTagDescendant

    public interface OlvmTagDescendant: IFieldSpec
    {
        #region members
    ...
    } // interface OlvmTagDescendant

    #endregion



    public static class ListOlvmTagDescendantExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmTagDescendant> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OlvmTagDescendant item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OlvmTagDescendant> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OlvmTagDescendant>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OlvmTagDescendant> list)
        {

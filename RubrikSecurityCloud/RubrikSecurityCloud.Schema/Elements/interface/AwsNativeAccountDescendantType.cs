// AwsNativeAccountDescendantType.cs
//
...
{
    #region AwsNativeAccountDescendantType
    public interface AwsNativeAccountDescendantType: IFragment
    {
        #region members
        //      C# -> System.String? Id
    ...
    } // class AwsNativeAccountDescendantType
    #endregion

    public static class ListAwsNativeAccountDescendantTypeExtensions
    {
        ...
        public static string AsFragment(
            this List<AwsNativeAccountDescendantType> list,
            int indent=0)
        {
            string fragments = "";
            foreach (AwsNativeAccountDescendantType item in list) 
            {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (AwsNativeAccountDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(AwsNativeAccountDescendantType));
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface AwsNativeAccountDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListAwsNativeAccountDescendantTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeAccountDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<AwsNativeAccountDescendantType>(
                        ref list, 

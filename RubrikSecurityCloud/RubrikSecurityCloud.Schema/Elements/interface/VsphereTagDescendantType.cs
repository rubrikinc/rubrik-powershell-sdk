...
{
    #region VsphereTagDescendantType

    public interface VsphereTagDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVsphereTagDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereTagDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VsphereTagDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VsphereTagDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VsphereTagDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VsphereTagDescendantType> list)
        {

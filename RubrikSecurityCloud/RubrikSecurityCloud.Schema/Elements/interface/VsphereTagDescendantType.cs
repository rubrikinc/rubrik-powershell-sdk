...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VsphereTagDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    } // class VsphereTagDescendantType
    #endregion
    ...
    public static class ListVsphereTagDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VsphereTagDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagDescendantType));
            list.Add(item);

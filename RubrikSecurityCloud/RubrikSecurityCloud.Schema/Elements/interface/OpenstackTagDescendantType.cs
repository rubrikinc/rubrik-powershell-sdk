...
{
    #region OpenstackTagDescendantType

    public interface OpenstackTagDescendantType: IFieldSpec
    {
        #region members
    ...
    } // interface OpenstackTagDescendantType

    #endregion



    public static class ListOpenstackTagDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackTagDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (OpenstackTagDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<OpenstackTagDescendantType> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<OpenstackTagDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<OpenstackTagDescendantType> list)
        {

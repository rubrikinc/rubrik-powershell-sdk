...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public interface VcdVappDescendantType: IFragment
    {
        #region members
        //      C# -> Cluster? Cluster
    ...
    public static class ListVcdVappDescendantTypeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = (VcdVappDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VcdVappDescendantType));
            list.Add(item);

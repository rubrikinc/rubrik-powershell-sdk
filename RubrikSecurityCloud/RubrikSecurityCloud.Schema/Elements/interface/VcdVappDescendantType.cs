...
{
    #region VcdVappDescendantType

    public interface VcdVappDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListVcdVappDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VcdVappDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (VcdVappDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<VcdVappDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<VcdVappDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<VcdVappDescendantType> list)
        {

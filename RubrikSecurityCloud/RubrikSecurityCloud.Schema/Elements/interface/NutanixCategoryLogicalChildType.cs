// NutanixCategoryLogicalChildType.cs
//
...
{
    #region NutanixCategoryLogicalChildType

    public interface NutanixCategoryLogicalChildType: IFieldSpec
    {
        #region members
    ...
    public static class ListNutanixCategoryLogicalChildTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixCategoryLogicalChildType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (NutanixCategoryLogicalChildType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryLogicalChildType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<NutanixCategoryLogicalChildType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<NutanixCategoryLogicalChildType> list)
        {

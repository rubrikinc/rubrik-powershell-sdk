// ActiveDirectoryDomainDescendantType.cs
//
...
{
    #region ActiveDirectoryDomainDescendantType

    public interface ActiveDirectoryDomainDescendantType: IFieldSpec
    {
        #region members
    ...
    public static class ListActiveDirectoryDomainDescendantTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryDomainDescendantType> list,
            FieldSpecConfig? conf=null)
        {
            conf=(conf==null)?new FieldSpecConfig():conf;
            string ind = conf.IndentStr();
            string fieldspecs = "";
            foreach (ActiveDirectoryDomainDescendantType item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryDomainDescendantType> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ActiveDirectoryDomainDescendantType>(
                        list, 
        ...
        public static void SelectForRetrieval(this List<ActiveDirectoryDomainDescendantType> list)
        {

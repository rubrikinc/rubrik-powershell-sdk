...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Query
    {
        ...
        public static object MaxProtectedAppsCountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object RestoreObjectsDryRunFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }

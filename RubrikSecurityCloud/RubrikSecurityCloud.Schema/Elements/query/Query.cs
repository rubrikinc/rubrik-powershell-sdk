...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Query
    {
        ...
        //      C# -> List<FilterType>? AllPolicyFilterTypes
        // GraphQL -> allPolicyFilterTypes: [FilterType!]! (enum)
        public static string AllPolicyFilterTypes(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nresourceType: $resourceType\npolicyType: $policyType\nidpTypes: $idpTypes\n)";
            return "allPolicyFilterTypes" + args + "\n";
        }
        public static object AllPolicyFilterTypesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<GenericSnapshot>? AllSnapshotsByIds
        // GraphQL -> allSnapshotsByIds: [GenericSnapshot!]! (interface)
        public static string AllSnapshotsByIds(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            ...
            return "allSnapshotsByIds" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllSnapshotsByIdsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<GenericSnapshot>();
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<System.String>? AllM365OrgOutboundIps
        // GraphQL -> allM365OrgOutboundIps: [String!]! (scalar)
        public static string AllM365OrgOutboundIps(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\norgId: $orgId\n)";
            return "allM365OrgOutboundIps" + args + "\n";
        }
        public static object AllM365OrgOutboundIpsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? AllPolicyFrameworks
        // GraphQL -> allPolicyFrameworks: [String!]! (scalar)
        public static string AllPolicyFrameworks(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyTypes: $policyTypes\n)";
            return "allPolicyFrameworks" + args + "\n";
        }
        public static object AllPolicyFrameworksFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? AllPolicyViolationTicketNumbers
        // GraphQL -> allPolicyViolationTicketNumbers: [String!]! (scalar)
        public static string AllPolicyViolationTicketNumbers(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyTypes: $policyTypes\nsearchTerm: $searchTerm\n)";
            return "allPolicyViolationTicketNumbers" + args + "\n";
        }
        public static object AllPolicyViolationTicketNumbersFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> System.String? CoordinatorLabelsValidation
        // GraphQL -> coordinatorLabelsValidation: Void (scalar)
        public static string CoordinatorLabelsValidation(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nclusterUuid: $clusterUuid\n)";
            return "coordinatorLabelsValidation" + args + "\n";
        }
        public static object CoordinatorLabelsValidationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> System.Boolean? IsAppAccessGraphReady
        // GraphQL -> isAppAccessGraphReady: Boolean! (scalar)
        public static string IsAppAccessGraphReady(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ndomainId: $domainId\n)";
            return "isAppAccessGraphReady" + args + "\n";
        }
        public static object IsAppAccessGraphReadyFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> System.Boolean? IsIdPsetupComplete
        // GraphQL -> isIdPSetupComplete: Boolean! (scalar)
        public static string IsIdPsetupComplete(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nobjectTypes: $objectTypes\n)";
            return "isIdPSetupComplete" + args + "\n";
        }
        public static object IsIdPsetupCompleteFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> System.Boolean? IsIdentitySecurityRoleAssignmentComplete
        // GraphQL -> isIdentitySecurityRoleAssignmentComplete: Boolean! (scalar)
        public static string IsIdentitySecurityRoleAssignmentComplete(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "isIdentitySecurityRoleAssignmentComplete" + args + "\n";
        }
        public static object IsIdentitySecurityRoleAssignmentCompleteFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? ObjectTagKeys
        // GraphQL -> objectTagKeys: [String!]! (scalar)
        public static string ObjectTagKeys(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "objectTagKeys" + args + "\n";
        }
        public static object ObjectTagKeysFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? ObjectTagValues
        // GraphQL -> objectTagValues: [String!]! (scalar)
        public static string ObjectTagValues(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nkey: $key\n)";
            return "objectTagValues" + args + "\n";
        }
        public static object ObjectTagValuesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? PrincipalDepartments
        // GraphQL -> principalDepartments: [String!]! (scalar)
        public static string PrincipalDepartments(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nsearchTerm: $searchTerm\n)";
            return "principalDepartments" + args + "\n";
        }
        public static object PrincipalDepartmentsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<System.String>? PrincipalTitles
        // GraphQL -> principalTitles: [String!]! (scalar)
        public static string PrincipalTitles(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfilter: $filter\n)";
            return "principalTitles" + args + "\n";
        }
        public static object PrincipalTitlesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object RegionsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> System.String? ValidateBackupLocationUsableForAzureDevOps
        // GraphQL -> validateBackupLocationUsableForAzureDevOps: Void (scalar)
        public static string ValidateBackupLocationUsableForAzureDevOps(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "validateBackupLocationUsableForAzureDevOps" + args + "\n";
        }
        public static object ValidateBackupLocationUsableForAzureDevOpsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<ArchivalLocationForecast>? AllArchivalLocationForecasts
        // GraphQL -> allArchivalLocationForecasts: [ArchivalLocationForecast!]! (type)
        public static string AllArchivalLocationForecasts(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nlocationIds: $locationIds\n)";
            return "allArchivalLocationForecasts" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllArchivalLocationForecastsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<ArchivalLocationForecast>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> ArchivalObjectInfoConnection? AllArchivalPerObjectInfo
        // GraphQL -> allArchivalPerObjectInfo: ArchivalObjectInfoConnection! (type)
        public static string AllArchivalPerObjectInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortOrder: $sortOrder\nsortBy: $sortBy\nfilter: $filter\nactiveOnly: $activeOnly\nuseCase: $useCase\n)";
            return "allArchivalPerObjectInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllArchivalPerObjectInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<AzureDevOpsOrgInfo>? AllAzureDevOpsOrgsInTenant
        // GraphQL -> allAzureDevOpsOrgsInTenant: [AzureDevOpsOrgInfo!]! (type)
        public static string AllAzureDevOpsOrgsInTenant(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nsessionId: $sessionId\n)";
            return "allAzureDevOpsOrgsInTenant" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllAzureDevOpsOrgsInTenantFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<AzureDevOpsOrgInfo>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ncdmClusterUUID: $cdmClusterUUID\nonlyWithProtectedObjects: $onlyWithProtectedObjects\n)";
        ...
        //      C# -> List<DefenderIngestionStatus>? AllDefenderIngestionStatuses
        // GraphQL -> allDefenderIngestionStatuses: [DefenderIngestionStatus!]! (type)
        public static string AllDefenderIngestionStatuses(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "allDefenderIngestionStatuses" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllDefenderIngestionStatusesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<DefenderIngestionStatus>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<DocumentAttribute>? AllDocumentTypes
        // GraphQL -> allDocumentTypes: [DocumentAttribute!]! (type)
        public static string AllDocumentTypes(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "allDocumentTypes" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllDocumentTypesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<DocumentAttribute>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetPossibleCategoriesType? AllPolicyCategories
        // GraphQL -> allPolicyCategories: GetPossibleCategoriesType! (type)
        public static string AllPolicyCategories(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyTypes: $policyTypes\n)";
            return "allPolicyCategories" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllPolicyCategoriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPossibleCategoriesType() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GetPolicyFilterValuesType? AllPolicyFilterValues
        // GraphQL -> allPolicyFilterValues: GetPolicyFilterValuesType! (type)
        public static string AllPolicyFilterValues(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyFilterType: $policyFilterType\nsearchTerm: $searchTerm\npolicyType: $policyType\npolicyTypeFilter: $policyTypeFilter\neventProviders: $eventProviders\n)";
            return "allPolicyFilterValues" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllPolicyFilterValuesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPolicyFilterValuesType() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object AllPolicyRiskSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object AllPrincipalRiskSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<RcvEntitlementRunway>? AllRcvEntitlementRunways
        // GraphQL -> allRcvEntitlementRunways: [RcvEntitlementRunway!]! (type)
        public static string AllRcvEntitlementRunways(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ngroups: $groups\n)";
            return "allRcvEntitlementRunways" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllRcvEntitlementRunwaysFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<RcvEntitlementRunway>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetRemediationTypesType? AllRemediationTypes
        // GraphQL -> allRemediationTypes: GetRemediationTypesType! (type)
        public static string AllRemediationTypes(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nviolationId: $violationId\ntargets: $targets\nlocation: $location\nresourceType: $resourceType\nresourceId: $resourceId\n)";
            return "allRemediationTypes" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllRemediationTypesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetRemediationTypesType() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<WorkloadResourceSpec>? AllResourceSpecs
        // GraphQL -> allResourceSpecs: [WorkloadResourceSpec!]! (type)
        public static string AllResourceSpecs(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "allResourceSpecs" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllResourceSpecsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<WorkloadResourceSpec>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> List<CdmOvaDetail>? AllRvcLsOvaDetails
        // GraphQL -> allRvcLsOvaDetails: [CdmOvaDetail!]! (type)
        public static string AllRvcLsOvaDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "allRvcLsOvaDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllRvcLsOvaDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<CdmOvaDetail>? AllRvcSsOvaDetails
        // GraphQL -> allRvcSsOvaDetails: [CdmOvaDetail!]! (type)
        public static string AllRvcSsOvaDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "allRvcSsOvaDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllRvcSsOvaDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<PolicyResult>? AllSecurityPolicies
        // GraphQL -> allSecurityPolicies: [PolicyResult!]! (type)
        ...
        public static object AllSecurityPoliciesFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new List<PolicyResult>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<SourceChildRecoverySpecMapV2>? AllSourceRecoverySpecsV2
        // GraphQL -> allSourceRecoverySpecsV2: [SourceChildRecoverySpecMapV2!]! (type)
        public static string AllSourceRecoverySpecsV2(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "allSourceRecoverySpecsV2" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllSourceRecoverySpecsV2FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<SourceChildRecoverySpecMapV2>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetValidRegionsForDynamoDbRecoveryReply? AllValidRegionsForDynamoDbRecovery
        // GraphQL -> allValidRegionsForDynamoDbRecovery: GetValidRegionsForDynamoDbRecoveryReply! (type)
        public static string AllValidRegionsForDynamoDbRecovery(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "allValidRegionsForDynamoDbRecovery" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllValidRegionsForDynamoDbRecoveryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetValidRegionsForDynamoDbRecoveryReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<WorkloadResourceSpec>? AllWorkloadResourceSpecs
        // GraphQL -> allWorkloadResourceSpecs: [WorkloadResourceSpec!]! (type)
        public static string AllWorkloadResourceSpecs(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "allWorkloadResourceSpecs" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllWorkloadResourceSpecsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> AllWorkloadsRecoveryInfoReply? AllWorkloadsRecoveryInfo
        // GraphQL -> allWorkloadsRecoveryInfo: AllWorkloadsRecoveryInfoReply! (type)
        public static string AllWorkloadsRecoveryInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "allWorkloadsRecoveryInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object AllWorkloadsRecoveryInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AllWorkloadsRecoveryInfoReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> AppAccessGraph? AppAccessGraph
        // GraphQL -> appAccessGraph: AppAccessGraph! (type)
        public static string AppAccessGraph(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "appAccessGraph" + args + "\n{\n" + fs + "}\n";
        }
        public static object AppAccessGraphFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AppAccessGraph() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AppAccessImpact? AppAccessImpact
        // GraphQL -> appAccessImpact: AppAccessImpact (type)
        public static string AppAccessImpact(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "appAccessImpact" + args + "\n{\n" + fs + "}\n";
        }
        public static object AppAccessImpactFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AppAccessImpact() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AppAccessPrincipalConnection? AppAccessPrincipals
        // GraphQL -> appAccessPrincipals: AppAccessPrincipalConnection! (type)
        public static string AppAccessPrincipals(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\n)";
            return "appAccessPrincipals" + args + "\n{\n" + fs + "}\n";
        }
        public static object AppAccessPrincipalsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AppAccessPrincipalConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object ArchivalEntitiesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> ArchivalLocationForecastRefreshStatus? ArchivalLocationForecastRefreshStatus
        // GraphQL -> archivalLocationForecastRefreshStatus: ArchivalLocationForecastRefreshStatus! (type)
        public static string ArchivalLocationForecastRefreshStatus(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "archivalLocationForecastRefreshStatus" + args + "\n{\n" + fs + "}\n";
        }
        public static object ArchivalLocationForecastRefreshStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ArchivalLocationForecastRefreshStatus() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetArchivalReaderInfoResp? ArchivalReaderInfo
        // GraphQL -> archivalReaderInfo: GetArchivalReaderInfoResp! (type)
        public static string ArchivalReaderInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "archivalReaderInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object ArchivalReaderInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetArchivalReaderInfoResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CheckAwsMarketplaceSubscriptionReply? AwsMarketplaceSubscriptionInfo
        // GraphQL -> awsMarketplaceSubscriptionInfo: CheckAwsMarketplaceSubscriptionReply! (type)
        public static string AwsMarketplaceSubscriptionInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "awsMarketplaceSubscriptionInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object AwsMarketplaceSubscriptionInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CheckAwsMarketplaceSubscriptionReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> AwsValidatePermissionsReply? AwsValidatePermissions
        // GraphQL -> awsValidatePermissions: AwsValidatePermissionsReply! (type)
        public static string AwsValidatePermissions(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "awsValidatePermissions" + args + "\n{\n" + fs + "}\n";
        }
        public static object AwsValidatePermissionsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AwsValidatePermissionsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> AzureClusterStorageAccountRedundancyReply? AzureClusterStorageAccountRedundancy
        // GraphQL -> azureClusterStorageAccountRedundancy: AzureClusterStorageAccountRedundancyReply! (type)
        public static string AzureClusterStorageAccountRedundancy(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "azureClusterStorageAccountRedundancy" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureClusterStorageAccountRedundancyFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureClusterStorageAccountRedundancyReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsConnectionStatusSummaryReply? AzureDevOpsConnectionStatusSummary
        // GraphQL -> azureDevOpsConnectionStatusSummary: AzureDevOpsConnectionStatusSummaryReply! (type)
        public static string AzureDevOpsConnectionStatusSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "azureDevOpsConnectionStatusSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsConnectionStatusSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsConnectionStatusSummaryReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsOrganization? AzureDevOpsOrganization
        // GraphQL -> azureDevOpsOrganization: AzureDevOpsOrganization! (type)
        public static string AzureDevOpsOrganization(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\n)";
            return "azureDevOpsOrganization" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsOrganizationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsOrganization() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsOrganizationConnection? AzureDevOpsOrganizations
        // GraphQL -> azureDevOpsOrganizations: AzureDevOpsOrganizationConnection! (type)
        public static string AzureDevOpsOrganizations(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nqueryType: $queryType\nancestorId: $ancestorId\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\nworkloadHierarchy: $workloadHierarchy\n)";
            return "azureDevOpsOrganizations" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsOrganizationsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsOrganizationConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsProject? AzureDevOpsProject
        // GraphQL -> azureDevOpsProject: AzureDevOpsProject! (type)
        public static string AzureDevOpsProject(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\n)";
            return "azureDevOpsProject" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsProjectFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsProject() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsProjectConnection? AzureDevOpsProjects
        // GraphQL -> azureDevOpsProjects: AzureDevOpsProjectConnection! (type)
        public static string AzureDevOpsProjects(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nqueryType: $queryType\nancestorId: $ancestorId\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\nworkloadHierarchy: $workloadHierarchy\n)";
            return "azureDevOpsProjects" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsProjectsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsProjectConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsRepositoryConnection? AzureDevOpsRepositories
        // GraphQL -> azureDevOpsRepositories: AzureDevOpsRepositoryConnection! (type)
        public static string AzureDevOpsRepositories(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nqueryType: $queryType\nancestorId: $ancestorId\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\nworkloadHierarchy: $workloadHierarchy\n)";
            return "azureDevOpsRepositories" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsRepositoriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsRepositoryConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzureDevOpsRepository? AzureDevOpsRepository
        // GraphQL -> azureDevOpsRepository: AzureDevOpsRepository! (type)
        public static string AzureDevOpsRepository(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\n)";
            return "azureDevOpsRepository" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureDevOpsRepositoryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzureDevOpsRepository() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static string AzureMarketplaceTermsInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "azureMarketplaceTermsInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzureMarketplaceTermsInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CheckAzureMarketplaceTermsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> AzurePostgresFlexibleServer? AzurePostgresFlexibleServer
        // GraphQL -> azurePostgresFlexibleServer: AzurePostgresFlexibleServer! (type)
        public static string AzurePostgresFlexibleServer(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nazurePostgresFlexibleServerRubrikId: $azurePostgresFlexibleServerRubrikId\n)";
            return "azurePostgresFlexibleServer" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzurePostgresFlexibleServerFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzurePostgresFlexibleServer() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AzurePostgresFlexibleServerConnection? AzurePostgresFlexibleServers
        // GraphQL -> azurePostgresFlexibleServers: AzurePostgresFlexibleServerConnection! (type)
        public static string AzurePostgresFlexibleServers(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortBy: $sortBy\nsortOrder: $sortOrder\nazurePostgresFlexibleServerFilters: $azurePostgresFlexibleServerFilters\n)";
            return "azurePostgresFlexibleServers" + args + "\n{\n" + fs + "}\n";
        }
        public static object AzurePostgresFlexibleServersFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AzurePostgresFlexibleServerConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> List<RdsInstanceClassBatchResult>? BatchSupportedAwsRdsDatabaseInstanceClasses
        // GraphQL -> batchSupportedAwsRdsDatabaseInstanceClasses: [RdsInstanceClassBatchResult!]! (type)
        public static string BatchSupportedAwsRdsDatabaseInstanceClasses(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nawsAccountRubrikId: $awsAccountRubrikId\nregion: $region\nrequests: $requests\n)";
            return "batchSupportedAwsRdsDatabaseInstanceClasses" + args + "\n{\n" + fs + "}\n";
        }
        public static object BatchSupportedAwsRdsDatabaseInstanceClassesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<RdsInstanceClassBatchResult>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CapSettingsData? CapSettingsData
        // GraphQL -> capSettingsData: CapSettingsData! (type)
        public static string CapSettingsData(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "capSettingsData" + args + "\n{\n" + fs + "}\n";
        }
        public static object CapSettingsDataFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetCdmUserResponse? CdmAdminUser
        // GraphQL -> cdmAdminUser: GetCdmUserResponse! (type)
        public static string CdmAdminUser(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "cdmAdminUser" + args + "\n{\n" + fs + "}\n";
        }
        public static object CdmAdminUserFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object ClassifiableAssetCountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object CloudAccountsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> ThreatHuntCloudDirectClusterConnection? CloudDirectClusterLambdaConfig
        // GraphQL -> cloudDirectClusterLambdaConfig: ThreatHuntCloudDirectClusterConnection! (type)
        public static string CloudDirectClusterLambdaConfig(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\nsortOrder: $sortOrder\nsortBy: $sortBy\n)";
            return "cloudDirectClusterLambdaConfig" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudDirectClusterLambdaConfigFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ThreatHuntCloudDirectClusterConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> CloudDirectEventSeriesTaskReportReply? CloudDirectEventSeriesTaskReport
        // GraphQL -> cloudDirectEventSeriesTaskReport: CloudDirectEventSeriesTaskReportReply! (type)
        public static string CloudDirectEventSeriesTaskReport(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\neventSeriesId: $eventSeriesId\nclusterId: $clusterId\nobjectId: $objectId\n)";
            return "cloudDirectEventSeriesTaskReport" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudDirectEventSeriesTaskReportFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CloudDirectEventSeriesTaskReportReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CloudDirectJobRecentErrorsReportReply? CloudDirectJobRecentErrorsReport
        // GraphQL -> cloudDirectJobRecentErrorsReport: CloudDirectJobRecentErrorsReportReply! (type)
        public static string CloudDirectJobRecentErrorsReport(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\neventSeriesId: $eventSeriesId\nclusterId: $clusterId\nobjectId: $objectId\n)";
            return "cloudDirectJobRecentErrorsReport" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudDirectJobRecentErrorsReportFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CloudDirectJobRecentErrorsReportReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> ListCloudDirectSiteSettingsResp? CloudDirectSiteSettings
        // GraphQL -> cloudDirectSiteSettings: ListCloudDirectSiteSettingsResp! (type)
        public static string CloudDirectSiteSettings(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "cloudDirectSiteSettings" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudDirectSiteSettingsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ListCloudDirectSiteSettingsResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetCloudNativeApplicationSnapshotsReply? CloudNativeApplicationSnapshots
        // GraphQL -> cloudNativeApplicationSnapshots: GetCloudNativeApplicationSnapshotsReply! (type)
        public static string CloudNativeApplicationSnapshots(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\napplicationId: $applicationId\ntimeFilter: $timeFilter\nqualityFilter: $qualityFilter\ngetFullDetails: $getFullDetails\npreferredLocationType: $preferredLocationType\n)";
            return "cloudNativeApplicationSnapshots" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudNativeApplicationSnapshotsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetCloudNativeApplicationSnapshotsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CloudNativeCustomerSettings? CloudNativeCustomerSettings
        // GraphQL -> cloudNativeCustomerSettings: CloudNativeCustomerSettings! (type)
        public static string CloudNativeCustomerSettings(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "cloudNativeCustomerSettings" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudNativeCustomerSettingsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CloudNativeCustomerSettings() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetCloudNativeTagRulesObjectTypeReply? CloudNativeTagRulesObjectType
        // GraphQL -> cloudNativeTagRulesObjectType: GetCloudNativeTagRulesObjectTypeReply! (type)
        public static string CloudNativeTagRulesObjectType(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "cloudNativeTagRulesObjectType" + args + "\n{\n" + fs + "}\n";
        }
        public static object CloudNativeTagRulesObjectTypeFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetCloudNativeTagRulesObjectTypeReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object ClusterEncryptionInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> CoordinatorLabelsReply? CoordinatorLabels
        // GraphQL -> coordinatorLabels: CoordinatorLabelsReply! (type)
        public static string CoordinatorLabels(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "coordinatorLabels" + args + "\n{\n" + fs + "}\n";
        }
        public static object CoordinatorLabelsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CoordinatorLabelsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CrowdStrikeIngestionStatus? CrowdStrikeIngestionStatus
        // GraphQL -> crowdStrikeIngestionStatus: CrowdStrikeIngestionStatus (type)
        public static string CrowdStrikeIngestionStatus(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "crowdStrikeIngestionStatus" + args + "\n{\n" + fs + "}\n";
        }
        public static object CrowdStrikeIngestionStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CrowdStrikeIngestionStatus() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> CrowdstrikeAlertActivitySummary? CrowdstrikeAlertActivitySummary
        // GraphQL -> crowdstrikeAlertActivitySummary: CrowdstrikeAlertActivitySummary (type)
        public static string CrowdstrikeAlertActivitySummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ndetectionId: $detectionId\n)";
            return "crowdstrikeAlertActivitySummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object CrowdstrikeAlertActivitySummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CrowdstrikeAlertActivitySummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> CrowdstrikeCaseActivitySummary? CrowdstrikeCaseActivitySummary
        // GraphQL -> crowdstrikeCaseActivitySummary: CrowdstrikeCaseActivitySummary (type)
        public static string CrowdstrikeCaseActivitySummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ndetectionIds: $detectionIds\n)";
            return "crowdstrikeCaseActivitySummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object CrowdstrikeCaseActivitySummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CrowdstrikeCaseActivitySummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CustomReportInfoConnection? CustomReports
        // GraphQL -> customReports: CustomReportInfoConnection! (type)
        public static string CustomReports(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\n)";
            return "customReports" + args + "\n{\n" + fs + "}\n";
        }
        public static object CustomReportsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CustomReportInfoConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> DailyViolationsSummary? DailyViolationsSummary
        // GraphQL -> dailyViolationsSummary: DailyViolationsSummary! (type)
        ...
        public static object DailyViolationsSummaryFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new DailyViolationsSummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> DataAccessStatsResponse? DataAccessStats
        // GraphQL -> dataAccessStats: DataAccessStatsResponse! (type)
        public static string DataAccessStats(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "dataAccessStats" + args + "\n{\n" + fs + "}\n";
        }
        public static object DataAccessStatsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new DataAccessStatsResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object DataDiscoveryObjectsCountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetDataPreviewReply? DataPreview
        // GraphQL -> dataPreview: GetDataPreviewReply! (type)
        public static string DataPreview(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "dataPreview" + args + "\n{\n" + fs + "}\n";
        }
        public static object DataPreviewFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetDataPreviewReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> DataProtectionCoverageSummary? DataProtectionCoverageSummary
        // GraphQL -> dataProtectionCoverageSummary: DataProtectionCoverageSummary! (type)
        public static string DataProtectionCoverageSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nhistoricalDeltaDays: $historicalDeltaDays\n)";
            return "dataProtectionCoverageSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object DataProtectionCoverageSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new DataProtectionCoverageSummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> DevOpsBackupJobInformation? DevOpsBackupJobInformation
        // GraphQL -> devOpsBackupJobInformation: DevOpsBackupJobInformation! (type)
        ...
        public static object DevOpsBackupJobInformationFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new DevOpsBackupJobInformation() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> DevOpsCloudAccountListCurrentPermissionsReply? DevOpsCloudAccountListCurrentPermissions
        // GraphQL -> devOpsCloudAccountListCurrentPermissions: DevOpsCloudAccountListCurrentPermissionsReply! (type)
        public static string DevOpsCloudAccountListCurrentPermissions(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "devOpsCloudAccountListCurrentPermissions" + args + "\n{\n" + fs + "}\n";
        }
        public static object DevOpsCloudAccountListCurrentPermissionsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new DevOpsCloudAccountListCurrentPermissionsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> DevOpsCloudAccountListLatestPermissionsReply? DevOpsCloudAccountListLatestPermissions
        // GraphQL -> devOpsCloudAccountListLatestPermissions: DevOpsCloudAccountListLatestPermissionsReply! (type)
        public static string DevOpsCloudAccountListLatestPermissions(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "devOpsCloudAccountListLatestPermissions" + args + "\n{\n" + fs + "}\n";
        }
        public static object DevOpsCloudAccountListLatestPermissionsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new DevOpsCloudAccountListLatestPermissionsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> DevOpsProtectedObjectCountSummary? DevOpsProtectedObjectCountSummary
        // GraphQL -> devOpsProtectedObjectCountSummary: DevOpsProtectedObjectCountSummary! (type)
        public static string DevOpsProtectedObjectCountSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nobjectType: $objectType\n)";
            return "devOpsProtectedObjectCountSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object DevOpsProtectedObjectCountSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new DevOpsProtectedObjectCountSummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> ListDocumentTypesDetailsReply? DocumentTypesDetails
        // GraphQL -> documentTypesDetails: ListDocumentTypesDetailsReply! (type)
        public static string DocumentTypesDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nstatusFilter: $statusFilter\n)";
            return "documentTypesDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object DocumentTypesDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ListDocumentTypesDetailsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object EntityInsightsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object ExotaskImageBundleFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> FailoverGroupArchivalLocationConnection? FailoverGroupArchivalLocations
        // GraphQL -> failoverGroupArchivalLocations: FailoverGroupArchivalLocationConnection! (type)
        public static string FailoverGroupArchivalLocations(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfailoverGroupId: $failoverGroupId\nfilter: $filter\n)";
            return "failoverGroupArchivalLocations" + args + "\n{\n" + fs + "}\n";
        }
        public static object FailoverGroupArchivalLocationsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FailoverGroupArchivalLocationConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FailoverGroupHostConnection? FailoverGroupHosts
        // GraphQL -> failoverGroupHosts: FailoverGroupHostConnection! (type)
        public static string FailoverGroupHosts(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfailoverGroupId: $failoverGroupId\nfilter: $filter\n)";
            return "failoverGroupHosts" + args + "\n{\n" + fs + "}\n";
        }
        public static object FailoverGroupHostsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FailoverGroupHostConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FailoverGroupWorkloadConnection? FailoverGroupWorkloads
        // GraphQL -> failoverGroupWorkloads: FailoverGroupWorkloadConnection! (type)
        public static string FailoverGroupWorkloads(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfailoverGroupId: $failoverGroupId\nfilter: $filter\n)";
            return "failoverGroupWorkloads" + args + "\n{\n" + fs + "}\n";
        }
        public static object FailoverGroupWorkloadsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FailoverGroupWorkloadConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> AnalyzedColumnConnection? FileSchemaResults
        // GraphQL -> fileSchemaResults: AnalyzedColumnConnection! (type)
        public static string FileSchemaResults(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\ndataTypeIdsFilter: $dataTypeIdsFilter\nsnapshotFid: $snapshotFid\nsnappableFid: $snappableFid\nstdPath: $stdPath\nfilter: $filter\nsort: $sort\n)";
            return "fileSchemaResults" + args + "\n{\n" + fs + "}\n";
        }
        public static object FileSchemaResultsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new AnalyzedColumnConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object FileSummariesCountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> FusionComputeCluster? FusionComputeCluster
        // GraphQL -> fusionComputeCluster: FusionComputeCluster! (type)
        public static string FusionComputeCluster(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeCluster" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeClusterFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeCluster() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeClusterConnection? FusionComputeClusters
        // GraphQL -> fusionComputeClusters: FusionComputeClusterConnection! (type)
        ...
        public static object FusionComputeClustersFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeClusterConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> CdmHierarchyObjectConnection? FusionComputeClustersAndHosts
        // GraphQL -> fusionComputeClustersAndHosts: CdmHierarchyObjectConnection! (type)
        ...
        //      C# -> FusionComputeDatastore? FusionComputeDatastore
        // GraphQL -> fusionComputeDatastore: FusionComputeDatastore! (type)
        public static string FusionComputeDatastore(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeDatastore" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeDatastoreFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeDatastore() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeDatastoreConnection? FusionComputeDatastores
        // GraphQL -> fusionComputeDatastores: FusionComputeDatastoreConnection! (type)
        ...
        public static object FusionComputeDatastoresFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeDatastoreConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeEchoResponse? FusionComputeEcho
        // GraphQL -> fusionComputeEcho: FusionComputeEchoResponse! (type)
        public static string FusionComputeEcho(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "fusionComputeEcho" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeEchoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeEchoResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeHost? FusionComputeHost
        // GraphQL -> fusionComputeHost: FusionComputeHost! (type)
        public static string FusionComputeHost(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeHost" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeHostFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeHost() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeHostConnection? FusionComputeHosts
        // GraphQL -> fusionComputeHosts: FusionComputeHostConnection! (type)
        ...
        public static object FusionComputeHostsFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeHostConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> MissedSnapshotListResponse? FusionComputeMissedSnapshots
        // GraphQL -> fusionComputeMissedSnapshots: MissedSnapshotListResponse! (type)
        public static string FusionComputeMissedSnapshots(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "fusionComputeMissedSnapshots" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeMissedSnapshotsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> FusionComputeMountDetailConnection? FusionComputeMounts
        // GraphQL -> fusionComputeMounts: FusionComputeMountDetailConnection! (type)
        public static string FusionComputeMounts(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\n)";
            return "fusionComputeMounts" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeMountsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeMountDetailConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeNetwork? FusionComputeNetwork
        // GraphQL -> fusionComputeNetwork: FusionComputeNetwork! (type)
        public static string FusionComputeNetwork(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeNetwork" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeNetworkFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeNetwork() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeNetworkConnection? FusionComputeNetworks
        // GraphQL -> fusionComputeNetworks: FusionComputeNetworkConnection! (type)
        ...
        public static object FusionComputeNetworksFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeNetworkConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> CdmHierarchyObjectConnection? FusionComputeRecoverableClustersAndHosts
        // GraphQL -> fusionComputeRecoverableClustersAndHosts: CdmHierarchyObjectConnection! (type)
        ...
        //      C# -> FusionComputeDatastoreConnection? FusionComputeRecoverableDatastores
        // GraphQL -> fusionComputeRecoverableDatastores: FusionComputeDatastoreConnection! (type)
        ...
        //      C# -> FusionComputeNetworkConnection? FusionComputeRecoverableNetworks
        // GraphQL -> fusionComputeRecoverableNetworks: FusionComputeNetworkConnection! (type)
        ...
        //      C# -> FusionComputeSite? FusionComputeSite
        // GraphQL -> fusionComputeSite: FusionComputeSite! (type)
        public static string FusionComputeSite(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeSite" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeSiteFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeSite() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeSiteConnection? FusionComputeSites
        // GraphQL -> fusionComputeSites: FusionComputeSiteConnection! (type)
        ...
        public static object FusionComputeSitesFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeSiteConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeSnapshotResourceSpecReply? FusionComputeSnapshotResourceSpec
        // GraphQL -> fusionComputeSnapshotResourceSpec: FusionComputeSnapshotResourceSpecReply! (type)
        public static string FusionComputeSnapshotResourceSpec(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "fusionComputeSnapshotResourceSpec" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeSnapshotResourceSpecFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeSnapshotResourceSpecReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeVirtualDiskConnection? FusionComputeVirtualDisks
        // GraphQL -> fusionComputeVirtualDisks: FusionComputeVirtualDiskConnection! (type)
        public static string FusionComputeVirtualDisks(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfusionComputeVirtualMachineFid: $fusionComputeVirtualMachineFid\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\n)";
            return "fusionComputeVirtualDisks" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeVirtualDisksFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeVirtualDiskConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeVirtualMachine? FusionComputeVirtualMachine
        // GraphQL -> fusionComputeVirtualMachine: FusionComputeVirtualMachine! (type)
        public static string FusionComputeVirtualMachine(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeVirtualMachine" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeVirtualMachineFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeVirtualMachine() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeVirtualMachineConnection? FusionComputeVirtualMachines
        // GraphQL -> fusionComputeVirtualMachines: FusionComputeVirtualMachineConnection! (type)
        ...
        public static object FusionComputeVirtualMachinesFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeVirtualMachineConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> AsyncRequestStatus? FusionComputeVmRequestStatus
        // GraphQL -> fusionComputeVmRequestStatus: AsyncRequestStatus! (type)
        public static string FusionComputeVmRequestStatus(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "fusionComputeVmRequestStatus" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeVmRequestStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> FusionComputeVrm? FusionComputeVrm
        // GraphQL -> fusionComputeVrm: FusionComputeVrm! (type)
        public static string FusionComputeVrm(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfid: $fid\n)";
            return "fusionComputeVrm" + args + "\n{\n" + fs + "}\n";
        }
        public static object FusionComputeVrmFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new FusionComputeVrm() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> FusionComputeVrmConnection? FusionComputeVrms
        // GraphQL -> fusionComputeVrms: FusionComputeVrmConnection! (type)
        ...
        public static object FusionComputeVrmsFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new FusionComputeVrmConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GcpCloudAccountGetProjectResponse? GcpCloudAccountGetProject
        // GraphQL -> gcpCloudAccountGetProject: GcpCloudAccountGetProjectResponse! (type)
        public static string GcpCloudAccountGetProject(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "gcpCloudAccountGetProject" + args + "\n{\n" + fs + "}\n";
        }
        public static object GcpCloudAccountGetProjectFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GcpCloudAccountGetProjectResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GcpCloudSqlInstance? GcpCloudSqlInstance
        // GraphQL -> gcpCloudSqlInstance: GcpCloudSqlInstance! (type)
        public static string GcpCloudSqlInstance(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ngcpCloudSqlInstanceRubrikId: $gcpCloudSqlInstanceRubrikId\n)";
            return "gcpCloudSqlInstance" + args + "\n{\n" + fs + "}\n";
        }
        public static object GcpCloudSqlInstanceFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GcpGetExocomputeConfigsReply? GcpExocomputeConfigs
        // GraphQL -> gcpExocomputeConfigs: GcpGetExocomputeConfigsReply! (type)
        public static string GcpExocomputeConfigs(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "gcpExocomputeConfigs" + args + "\n{\n" + fs + "}\n";
        }
        public static object GcpExocomputeConfigsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GcpGetExocomputeConfigsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GcpGetResourceSetupTemplateReply? GcpGetResourceSetupTemplate
        // GraphQL -> gcpGetResourceSetupTemplate: GcpGetResourceSetupTemplateReply! (type)
        public static string GcpGetResourceSetupTemplate(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "gcpGetResourceSetupTemplate" + args + "\n{\n" + fs + "}\n";
        }
        public static object GcpGetResourceSetupTemplateFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GcpGetResourceSetupTemplateReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GcpNativeRoot? GcpNativeRoot
        // GraphQL -> gcpNativeRoot: GcpNativeRoot! (type)
        public static string GcpNativeRoot(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "gcpNativeRoot" + args + "\n{\n" + fs + "}\n";
        }
        public static object GcpNativeRootFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GcpNativeRoot() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadTypes: $workloadTypes\nawsServiceTypeFilter: $awsServiceTypeFilter\n)";
            return "getCloudObjectsCountByRegion" + args + "\n{\n" + fs + "}\n";
        }
        public static object GetCloudObjectsCountByRegionFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object GetLaminarFeatureStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object GetObjectProtectionAndSensitivitySummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GitHubConnectionStatusSummaryReply? GitHubConnectionStatusSummary
        // GraphQL -> gitHubConnectionStatusSummary: GitHubConnectionStatusSummaryReply! (type)
        public static string GitHubConnectionStatusSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "gitHubConnectionStatusSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object GitHubConnectionStatusSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GitHubConnectionStatusSummaryReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GithubOrganization? GitHubOrganization
        // GraphQL -> gitHubOrganization: GithubOrganization! (type)
        public static string GitHubOrganization(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\n)";
            return "gitHubOrganization" + args + "\n{\n" + fs + "}\n";
        }
        public static object GitHubOrganizationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GithubOrganization() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GithubOrganizationConnection? GitHubOrganizations
        // GraphQL -> gitHubOrganizations: GithubOrganizationConnection! (type)
        ...
        public static object GitHubOrganizationsFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new GithubOrganizationConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GithubRepositoryConnection? GitHubRepositories
        // GraphQL -> gitHubRepositories: GithubRepositoryConnection! (type)
        public static string GitHubRepositories(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nqueryType: $queryType\nancestorId: $ancestorId\nfilter: $filter\nsortBy: $sortBy\nsortOrder: $sortOrder\nworkloadHierarchy: $workloadHierarchy\n)";
            return "gitHubRepositories" + args + "\n{\n" + fs + "}\n";
        }
        public static object GitHubRepositoriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GithubRepositoryConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GithubRepository? GitHubRepository
        // GraphQL -> gitHubRepository: GithubRepository! (type)
        public static string GitHubRepository(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\n)";
            return "gitHubRepository" + args + "\n{\n" + fs + "}\n";
        }
        public static object GitHubRepositoryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GithubRepository() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortBy: $sortBy\nsortOrder: $sortOrder\nfilter: $filter\nobjectTypeFilterParams: $objectTypeFilterParams\n)";
        ...
        //      C# -> GlueIcebergInventoryStatsReply? GlueIcebergInventoryStats
        // GraphQL -> glueIcebergInventoryStats: GlueIcebergInventoryStatsReply! (type)
        public static string GlueIcebergInventoryStats(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "glueIcebergInventoryStats" + args + "\n{\n" + fs + "}\n";
        }
        public static object GlueIcebergInventoryStatsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GlueIcebergInventoryStatsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GlueIcebergTable? GlueIcebergTable
        // GraphQL -> glueIcebergTable: GlueIcebergTable! (type)
        public static string GlueIcebergTable(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nglueIcebergTableRubrikId: $glueIcebergTableRubrikId\nincludeSecurityMetadata: $includeSecurityMetadata\n)";
            return "glueIcebergTable" + args + "\n{\n" + fs + "}\n";
        }
        public static object GlueIcebergTableFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GlueIcebergTable() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static string HasAccessToO365Objects(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "hasAccessToO365Objects" + args + "\n{\n" + fs + "}\n";
        }
        public static object HasAccessToO365ObjectsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new HasAccessToO365ObjectsResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetHitsExposureStatsReply? HitsExposureStats
        // GraphQL -> hitsExposureStats: GetHitsExposureStatsReply! (type)
        public static string HitsExposureStats(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "hitsExposureStats" + args + "\n{\n" + fs + "}\n";
        }
        public static object HitsExposureStatsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetHitsExposureStatsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> HypervVirtualSwitchesResponse? HypervHostVirtualSwitches
        // GraphQL -> hypervHostVirtualSwitches: HypervVirtualSwitchesResponse! (type)
        public static string HypervHostVirtualSwitches(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "hypervHostVirtualSwitches" + args + "\n{\n" + fs + "}\n";
        }
        public static object HypervHostVirtualSwitchesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new HypervVirtualSwitchesResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> HypervHostsVirtualSwitchesReply? HypervHostsVirtualSwitches
        // GraphQL -> hypervHostsVirtualSwitches: HypervHostsVirtualSwitchesReply! (type)
        public static string HypervHostsVirtualSwitches(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nhostIds: $hostIds\n)";
            return "hypervHostsVirtualSwitches" + args + "\n{\n" + fs + "}\n";
        }
        public static object HypervHostsVirtualSwitchesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new HypervHostsVirtualSwitchesReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> IdentityDataLocationEncryptionInfoConnection? IdentityDataLocationsEncryptionInfo
        // GraphQL -> identityDataLocationsEncryptionInfo: IdentityDataLocationEncryptionInfoConnection! (type)
        public static string IdentityDataLocationsEncryptionInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortBy: $sortBy\nfilter: $filter\npagination: $pagination\n)";
            return "identityDataLocationsEncryptionInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object IdentityDataLocationsEncryptionInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new IdentityDataLocationEncryptionInfoConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> IpInfoConnection? IpWhitelistEntries
        // GraphQL -> ipWhitelistEntries: IpInfoConnection! (type)
        public static string IpWhitelistEntries(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\n)";
            return "ipWhitelistEntries" + args + "\n{\n" + fs + "}\n";
        }
        public static object IpWhitelistEntriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new IpInfoConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> IpWhitelistSettings? IpWhitelistSettings
        // GraphQL -> ipWhitelistSettings: IpWhitelistSettings! (type)
        public static string IpWhitelistSettings(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "ipWhitelistSettings" + args + "\n{\n" + fs + "}\n";
        }
        public static object IpWhitelistSettingsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new IpWhitelistSettings() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CloudDirectValidateSharePathResp? IsCloudDirectSharePathValid
        // GraphQL -> isCloudDirectSharePathValid: CloudDirectValidateSharePathResp! (type)
        public static string IsCloudDirectSharePathValid(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "isCloudDirectSharePathValid" + args + "\n{\n" + fs + "}\n";
        }
        public static object IsCloudDirectSharePathValidFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new CloudDirectValidateSharePathResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> LacpPresenceCheckConnection? LacpConfigurations
        // GraphQL -> lacpConfigurations: LacpPresenceCheckConnection! (type)
        public static string LacpConfigurations(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nclusterUuids: $clusterUuids\n)";
            return "lacpConfigurations" + args + "\n{\n" + fs + "}\n";
        }
        public static object LacpConfigurationsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new LacpPresenceCheckConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetLaminarSsoDetailsReply? LaminarSsoDetails
        // GraphQL -> laminarSsoDetails: GetLaminarSSODetailsReply! (type)
        public static string LaminarSsoDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "laminarSsoDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object LaminarSsoDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetLaminarSsoDetailsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GetLatestGpoSettingsRes? LatestGpoSettings
        // GraphQL -> latestGpoSettings: GetLatestGpoSettingsRes! (type)
        public static string LatestGpoSettings(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "latestGpoSettings" + args + "\n{\n" + fs + "}\n";
        }
        public static object LatestGpoSettingsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetLatestGpoSettingsRes() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> PrincipalSummaryConnection? ListAccessGrantingIdentities
        // GraphQL -> listAccessGrantingIdentities: PrincipalSummaryConnection! (type)
        public static string ListAccessGrantingIdentities(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\n)";
            return "listAccessGrantingIdentities" + args + "\n{\n" + fs + "}\n";
        }
        public static object ListAccessGrantingIdentitiesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> ListCertificateUsagesForCloudAccountResp? ListCertificateUsagesForCloudAccount
        // GraphQL -> listCertificateUsagesForCloudAccount: ListCertificateUsagesForCloudAccountResp! (type)
        public static string ListCertificateUsagesForCloudAccount(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "listCertificateUsagesForCloudAccount" + args + "\n{\n" + fs + "}\n";
        }
        public static object ListCertificateUsagesForCloudAccountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ListCertificateUsagesForCloudAccountResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PrincipalSummaryConnection? ListDataAccessIdentities
        // GraphQL -> listDataAccessIdentities: PrincipalSummaryConnection! (type)
        public static string ListDataAccessIdentities(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\n)";
            return "listDataAccessIdentities" + args + "\n{\n" + fs + "}\n";
        }
        public static object ListDataAccessIdentitiesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> LinkedEntityConnection? ListLinkedEntitiesForGpo
        // GraphQL -> listLinkedEntitiesForGpo: LinkedEntityConnection! (type)
        public static string ListLinkedEntitiesForGpo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\ngpoId: $gpoId\n)";
            return "listLinkedEntitiesForGpo" + args + "\n{\n" + fs + "}\n";
        }
        public static object ListLinkedEntitiesForGpoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new LinkedEntityConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> MssqlHostConfiguration? MssqlHostConfiguration
        // GraphQL -> mssqlHostConfiguration: MssqlHostConfiguration! (type)
        public static string MssqlHostConfiguration(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "mssqlHostConfiguration" + args + "\n{\n" + fs + "}\n";
        }
        public static object MssqlHostConfigurationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new MssqlHostConfiguration() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> MultiHopUpgradePathReply? MultiHopUpgradePath
        // GraphQL -> multiHopUpgradePath: MultiHopUpgradePathReply! (type)
        public static string MultiHopUpgradePath(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nclusterUuid: $clusterUuid\nsourceVersion: $sourceVersion\ntargetVersion: $targetVersion\nshouldIncludeFullVersionName: $shouldIncludeFullVersionName\n)";
            return "multiHopUpgradePath" + args + "\n{\n" + fs + "}\n";
        }
        public static object MultiHopUpgradePathFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new MultiHopUpgradePathReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CloudDirectSnapshot? NewestSnapshotForCloudDirectObject
        // GraphQL -> newestSnapshotForCloudDirectObject: CloudDirectSnapshot (type)
        public static string NewestSnapshotForCloudDirectObject(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\ncloudDirectTargetId: $cloudDirectTargetId\n)";
            return "newestSnapshotForCloudDirectObject" + args + "\n{\n" + fs + "}\n";
        }
        public static object NewestSnapshotForCloudDirectObjectFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> NodeToRemoveByCountConnection? NodesToRemoveByCount
        // GraphQL -> nodesToRemoveByCount: NodeToRemoveByCountConnection! (type)
        public static string NodesToRemoveByCount(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nclusterUuid: $clusterUuid\nnodeCount: $nodeCount\n)";
            return "nodesToRemoveByCount" + args + "\n{\n" + fs + "}\n";
        }
        public static object NodesToRemoveByCountFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new NodeToRemoveByCountConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> CloudDirectSnapshot? OldestSnapshotForCloudDirectObject
        // GraphQL -> oldestSnapshotForCloudDirectObject: CloudDirectSnapshot (type)
        public static string OldestSnapshotForCloudDirectObject(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nworkloadId: $workloadId\ncloudDirectTargetId: $cloudDirectTargetId\n)";
            return "oldestSnapshotForCloudDirectObject" + args + "\n{\n" + fs + "}\n";
        }
        public static object OldestSnapshotForCloudDirectObjectFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetOwnersFilterValuesReply? OwnersFilterValues
        // GraphQL -> ownersFilterValues: GetOwnersFilterValuesReply! (type)
        public static string OwnersFilterValues(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "ownersFilterValues" + args + "\n{\n" + fs + "}\n";
        }
        public static object OwnersFilterValuesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetOwnersFilterValuesReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetPausedObjectResConnection? PausedObjects
        // GraphQL -> pausedObjects: GetPausedObjectResConnection! (type)
        public static string PausedObjects(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortBy: $sortBy\nfilter: $filter\n)";
            return "pausedObjects" + args + "\n{\n" + fs + "}\n";
        }
        public static object PausedObjectsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPausedObjectResConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetPoliciesMaxLastEvaluatedAtType? PoliciesMaxLastEvaluatedAt
        // GraphQL -> policiesMaxLastEvaluatedAt: GetPoliciesMaxLastEvaluatedAtType! (type)
        public static string PoliciesMaxLastEvaluatedAt(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyTypes: $policyTypes\n)";
            return "policiesMaxLastEvaluatedAt" + args + "\n{\n" + fs + "}\n";
        }
        public static object PoliciesMaxLastEvaluatedAtFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPoliciesMaxLastEvaluatedAtType() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> FileResultConnection? PolicyObjFolderChildren
        // GraphQL -> policyObjFolderChildren: FileResultConnection! (type)
        ...
        public static object PolicyObjOptFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> PolicyViolation? PolicyViolation
        // GraphQL -> policyViolation: PolicyViolation (type)
        public static string PolicyViolation(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nviolationId: $violationId\npolicyTypes: $policyTypes\n)";
            return "policyViolation" + args + "\n{\n" + fs + "}\n";
        }
        public static object PolicyViolationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PolicyViolation() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PolicyViolationHistoryEntryConnection? PolicyViolationHistoryEntries
        // GraphQL -> policyViolationHistoryEntries: PolicyViolationHistoryEntryConnection! (type)
        public static string PolicyViolationHistoryEntries(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nviolationId: $violationId\npolicyType: $policyType\n)";
            return "policyViolationHistoryEntries" + args + "\n{\n" + fs + "}\n";
        }
        public static object PolicyViolationHistoryEntriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PolicyViolationHistoryEntryConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PolicyViolationConnection? PolicyViolations
        // GraphQL -> policyViolations: PolicyViolationConnection! (type)
        ...
        public static object PolicyViolationsFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new PolicyViolationConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PolicyViolationsByResourceConnection? PolicyViolationsByResource
        // GraphQL -> policyViolationsByResource: PolicyViolationsByResourceConnection! (type)
        public static string PolicyViolationsByResource(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\npolicyIds: $policyIds\nresourceIds: $resourceIds\nstatuses: $statuses\nstatusReasons: $statusReasons\npolicyTypes: $policyTypes\npolicyViolationIds: $policyViolationIds\npolicySeverities: $policySeverities\npolicyCategories: $policyCategories\nincludeDeletedPolicies: $includeDeletedPolicies\nresourceTypes: $resourceTypes\nsensitivityLevels: $sensitivityLevels\ndetectionDate: $detectionDate\nupdateDate: $updateDate\nparentViolationId: $parentViolationId\ndataTypeIds: $dataTypeIds\ndocumentTypeIds: $documentTypeIds\ndataCategoryIds: $dataCategoryIds\nsortBy: $sortBy\nsortOrder: $sortOrder\npolicyViolationNameSearch: $policyViolationNameSearch\nprincipalMetadataFilters: $principalMetadataFilters\npolicyFrameworks: $policyFrameworks\nviolationNames: $violationNames\n)";
            return "policyViolationsByResource" + args + "\n{\n" + fs + "}\n";
        }
        public static object PolicyViolationsByResourceFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PolicyViolationsByResourceConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object PostgreSqlDatabaseFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object PostgreSqlDbClusterFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> AsyncRequestStatus? PostgresDbClusterAsyncRequestStatus
        // GraphQL -> postgresDbClusterAsyncRequestStatus: AsyncRequestStatus! (type)
        public static string PostgresDbClusterAsyncRequestStatus(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nclusterUuid: $clusterUuid\nid: $id\n)";
            return "postgresDbClusterAsyncRequestStatus" + args + "\n{\n" + fs + "}\n";
        }
        public static object PostgresDbClusterAsyncRequestStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> PrincipalApiPermissionsReply? PrincipalApiPermissions
        // GraphQL -> principalApiPermissions: PrincipalApiPermissionsReply! (type)
        public static string PrincipalApiPermissions(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "principalApiPermissions" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalApiPermissionsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetPrincipalCountsReply? PrincipalCountsSummaries
        // GraphQL -> principalCountsSummaries: GetPrincipalCountsReply! (type)
        public static string PrincipalCountsSummaries(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfilter: $filter\nhistoricalDeltaDays: $historicalDeltaDays\n)";
            return "principalCountsSummaries" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalCountsSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPrincipalCountsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object PrincipalDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> List<PrincipalEntity>? PrincipalEntities
        // GraphQL -> principalEntities: [PrincipalEntity!]! (type)
        public static string PrincipalEntities(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfilter: $filter\n)";
            return "principalEntities" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalEntitiesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new List<PrincipalEntity>() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object PrincipalObjectSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object PrincipalRiskChangesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object PrincipalRiskTrendFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nfilter: $filter\ntimelineDate: $timelineDate\nsort: $sort\nincludeCount: $includeCount\nhistoricalDeltaDays: $historicalDeltaDays\nincludeWhitelistedResults: $includeWhitelistedResults\ninsightsMetadataId: $insightsMetadataId\nincludeInsightsMarker: $includeInsightsMarker\nincludeAdditionalMetadata: $includeAdditionalMetadata\n)";
            return "principalSummaries" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetPrincipalSummaryReply? PrincipalSummary
        // GraphQL -> principalSummary: GetPrincipalSummaryReply! (type)
        public static string PrincipalSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "principalSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPrincipalSummaryReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> GetPrincipalTagStatsReply? PrincipalTagStats
        // GraphQL -> principalTagStats: GetPrincipalTagStatsReply! (type)
        public static string PrincipalTagStats(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "principalTagStats" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrincipalTagStatsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPrincipalTagStatsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetPrivilegedPrincipalsSummaryResp? PrivilegedPrincipalSummaries
        // GraphQL -> privilegedPrincipalSummaries: GetPrivilegedPrincipalsSummaryResp! (type)
        public static string PrivilegedPrincipalSummaries(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfilter: $filter\nhistoricalDeltaDays: $historicalDeltaDays\n)";
            return "privilegedPrincipalSummaries" + args + "\n{\n" + fs + "}\n";
        }
        public static object PrivilegedPrincipalSummariesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetPrivilegedPrincipalsSummaryResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> ProtectionSummaryV2? ProtectionSummaryV2
        // GraphQL -> protectionSummaryV2: ProtectionSummaryV2! (type)
        public static string ProtectionSummaryV2(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "protectionSummaryV2" + args + "\n{\n" + fs + "}\n";
        }
        public static object ProtectionSummaryV2FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ProtectionSummaryV2() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageArrayV1? PureStorageArrayV1
        // GraphQL -> pureStorageArrayV1: PureStorageArrayV1! (type)
        public static string PureStorageArrayV1(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nid: $id\n)";
            return "pureStorageArrayV1" + args + "\n{\n" + fs + "}\n";
        }
        public static object PureStorageArrayV1FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PureStorageArrayV1() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageArrayV1Connection? PureStorageArraysV1
        // GraphQL -> pureStorageArraysV1: PureStorageArrayV1Connection! (type)
        ...
        public static object PureStorageArraysV1FieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new PureStorageArrayV1Connection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> QuiesceCandidateListResponse? PureStorageProtectionGroupQuiesceCandidates
        // GraphQL -> pureStorageProtectionGroupQuiesceCandidates: QuiesceCandidateListResponse! (type)
        public static string PureStorageProtectionGroupQuiesceCandidates(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "pureStorageProtectionGroupQuiesceCandidates" + args + "\n{\n" + fs + "}\n";
        }
        public static object PureStorageProtectionGroupQuiesceCandidatesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new QuiesceCandidateListResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageProtectionGroupV1? PureStorageProtectionGroupV1
        // GraphQL -> pureStorageProtectionGroupV1: PureStorageProtectionGroupV1! (type)
        public static string PureStorageProtectionGroupV1(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nid: $id\n)";
            return "pureStorageProtectionGroupV1" + args + "\n{\n" + fs + "}\n";
        }
        public static object PureStorageProtectionGroupV1FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PureStorageProtectionGroupV1() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageProtectionGroupV1Connection? PureStorageProtectionGroupsV1
        // GraphQL -> pureStorageProtectionGroupsV1: PureStorageProtectionGroupV1Connection! (type)
        ...
        public static object PureStorageProtectionGroupsV1FieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new PureStorageProtectionGroupV1Connection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageVolumeV1? PureStorageVolumeV1
        // GraphQL -> pureStorageVolumeV1: PureStorageVolumeV1! (type)
        public static string PureStorageVolumeV1(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nid: $id\n)";
            return "pureStorageVolumeV1" + args + "\n{\n" + fs + "}\n";
        }
        public static object PureStorageVolumeV1FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PureStorageVolumeV1() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageVolumeV1Connection? PureStorageVolumesV1
        // GraphQL -> pureStorageVolumesV1: PureStorageVolumeV1Connection! (type)
        ...
        public static object PureStorageVolumesV1FieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new PureStorageVolumeV1Connection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> GetRecoveryAnalysisResultResp? QueryO365RecoveryAnalysisResult
        // GraphQL -> queryO365RecoveryAnalysisResult: GetRecoveryAnalysisResultResp! (type)
        public static string QueryO365RecoveryAnalysisResult(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "queryO365RecoveryAnalysisResult" + args + "\n{\n" + fs + "}\n";
        }
        public static object QueryO365RecoveryAnalysisResultFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetRecoveryAnalysisResultResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> PureStorageProtectionGroupSnapshotSummaryListResponse? QueryPureStorageProtectionGroupSnapshot
        // GraphQL -> queryPureStorageProtectionGroupSnapshot: PureStorageProtectionGroupSnapshotSummaryListResponse! (type)
        public static string QueryPureStorageProtectionGroupSnapshot(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "queryPureStorageProtectionGroupSnapshot" + args + "\n{\n" + fs + "}\n";
        }
        public static object QueryPureStorageProtectionGroupSnapshotFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PureStorageProtectionGroupSnapshotSummaryListResponse() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> RcvBliMigrationDetailsConnection? RcvAzureBliMigrationDetails
        // GraphQL -> rcvAzureBliMigrationDetails: RcvBliMigrationDetailsConnection! (type)
        public static string RcvAzureBliMigrationDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nBliMigrationDetailsFilter: $BliMigrationDetailsFilter\nsortBy: $sortBy\nsortOrder: $sortOrder\n)";
            return "rcvAzureBliMigrationDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object RcvAzureBliMigrationDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new RcvBliMigrationDetailsConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> RecoveryConnection? Recoveries
        // GraphQL -> recoveries: RecoveryConnection! (type)
        public static string Recoveries(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nrecoveryIds: $recoveryIds\nrecoveryType: $recoveryType\nendTime: $endTime\nstartTime: $startTime\nrecoveryPlanNames: $recoveryPlanNames\nworkloadIds: $workloadIds\nrecoveryStatuses: $recoveryStatuses\nrecoveryOutcomes: $recoveryOutcomes\nrecoveryNames: $recoveryNames\nrecoveryTriggeredFrom: $recoveryTriggeredFrom\nrecoveryPlanIds: $recoveryPlanIds\nworkloadTypeFilter: $workloadTypeFilter\nrecoveryNameSubstring: $recoveryNameSubstring\nsortParam: $sortParam\n)";
            return "recoveries" + args + "\n{\n" + fs + "}\n";
        }
        public static object RecoveriesFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new RecoveryConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static string RecoveryReport(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "recoveryReport" + args + "\n{\n" + fs + "}\n";
        }
        public static object RecoveryReportFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new RecoveryReport() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static string RecoverySpecs(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "recoverySpecs" + args + "\n{\n" + fs + "}\n";
        }
        public static object RecoverySpecsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new RecoverySpecsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object ResourceGroupsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static string RvcDeploymentToolLink(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "rvcDeploymentToolLink" + args + "\n{\n" + fs + "}\n";
        }
        public static object RvcDeploymentToolLinkFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new RvcDeploymentToolLink() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object SaasAppOrganizationsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object SalesforceObjectsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetScriptsForManualPermissionValidationReply? ScriptsForManualPermissionValidation
        // GraphQL -> scriptsForManualPermissionValidation: GetScriptsForManualPermissionValidationReply! (type)
        public static string ScriptsForManualPermissionValidation(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "scriptsForManualPermissionValidation" + args + "\n{\n" + fs + "}\n";
        }
        public static object ScriptsForManualPermissionValidationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetScriptsForManualPermissionValidationReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> PolicyResult? SecurityPolicy
        // GraphQL -> securityPolicy: PolicyResult! (type)
        public static string SecurityPolicy(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\npolicyId: $policyId\nincludeViolationInsights: $includeViolationInsights\npolicyType: $policyType\n)";
            return "securityPolicy" + args + "\n{\n" + fs + "}\n";
        }
        public static object SecurityPolicyFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new PolicyResult() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> SensitiveDataSummary? SensitiveDataSummary
        // GraphQL -> sensitiveDataSummary: SensitiveDataSummary! (type)
        public static string SensitiveDataSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "sensitiveDataSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object SensitiveDataSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new SensitiveDataSummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> SensitiveFileDetailsReply? SensitiveFileDetails
        // GraphQL -> sensitiveFileDetails: SensitiveFileDetailsReply! (type)
        public static string SensitiveFileDetails(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "sensitiveFileDetails" + args + "\n{\n" + fs + "}\n";
        }
        public static object SensitiveFileDetailsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new SensitiveFileDetailsReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nsids: $sids\nday: $day\nhistoricalDeltaDays: $historicalDeltaDays\npolicyId: $policyId\nobjectIdsFilter: $objectIdsFilter\nincludeWhitelistedResults: $includeWhitelistedResults\nsortBy: $sortBy\nplatformCategoryFilter: $platformCategoryFilter\nsortOrder: $sortOrder\nshouldCalculateAggregatedDataTypeLevelResults: $shouldCalculateAggregatedDataTypeLevelResults\n)";
            return "sidsPolicyHitsSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object SidsPolicyHitsSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> GetSkippedTeamsSiteReportResp? SkippedTeamsSiteReport
        // GraphQL -> skippedTeamsSiteReport: GetSkippedTeamsSiteReportResp! (type)
        public static string SkippedTeamsSiteReport(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "skippedTeamsSiteReport" + args + "\n{\n" + fs + "}\n";
        }
        public static object SkippedTeamsSiteReportFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new GetSkippedTeamsSiteReportResp() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> SnapshotSecurityInfoConnection? SnapshotsSecurityInfo
        // GraphQL -> snapshotsSecurityInfo: SnapshotSecurityInfoConnection! (type)
        public static string SnapshotsSecurityInfo(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nworkloadIds: $workloadIds\nstartTime: $startTime\nendTime: $endTime\nsortOrder: $sortOrder\nincludeThreatHunts: $includeThreatHunts\n)";
            return "snapshotsSecurityInfo" + args + "\n{\n" + fs + "}\n";
        }
        public static object SnapshotsSecurityInfoFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new SnapshotSecurityInfoConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> SsmDocumentForEc2Reply? SsmDocumentForEc2
        // GraphQL -> ssmDocumentForEc2: SsmDocumentForEc2Reply! (type)
        public static string SsmDocumentForEc2(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "ssmDocumentForEc2" + args + "\n{\n" + fs + "}\n";
        }
        public static object SsmDocumentForEc2FieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new SsmDocumentForEc2Reply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static string SupportCaseComments(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ncaseId: $caseId\n)";
            return "supportCaseComments" + args + "\n{\n" + fs + "}\n";
        }
        public static object SupportCaseCommentsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object TopRiskPrincipalsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> UnregisteredDomainControllerWithDomainConnection? UnifiedUnregisteredDomainControllers
        // GraphQL -> unifiedUnregisteredDomainControllers: UnregisteredDomainControllerWithDomainConnection! (type)
        public static string UnifiedUnregisteredDomainControllers(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nfirst: $first\nafter: $after\nlast: $last\nbefore: $before\nsortBy: $sortBy\nsortOrder: $sortOrder\nfilter: $filter\n)";
            return "unifiedUnregisteredDomainControllers" + args + "\n{\n" + fs + "}\n";
        }
        public static object UnifiedUnregisteredDomainControllersFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new UnregisteredDomainControllerWithDomainConnection() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> UpgradePathEligibilityReply? UpgradePathEligibility
        // GraphQL -> upgradePathEligibility: UpgradePathEligibilityReply! (type)
        public static string UpgradePathEligibility(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nclusterUuid: $clusterUuid\ntargetVersion: $targetVersion\noperation: $operation\n)";
            return "upgradePathEligibility" + args + "\n{\n" + fs + "}\n";
        }
        public static object UpgradePathEligibilityFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new UpgradePathEligibilityReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        public static object UserAccessInsightsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object UserAccessMetricsFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        public static object UsersSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> ValidateOutpostAccountNetworkReply? ValidateOutpostAccountNetwork
        // GraphQL -> validateOutpostAccountNetwork: ValidateOutpostAccountNetworkReply! (type)
        public static string ValidateOutpostAccountNetwork(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "validateOutpostAccountNetwork" + args + "\n{\n" + fs + "}\n";
        }
        public static object ValidateOutpostAccountNetworkFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ValidateOutpostAccountNetworkReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> ValidateRdsExportExocomputePortReply? ValidateRdsExportExocomputePort
        // GraphQL -> validateRdsExportExocomputePort: ValidateRdsExportExocomputePortReply! (type)
        public static string ValidateRdsExportExocomputePort(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "validateRdsExportExocomputePort" + args + "\n{\n" + fs + "}\n";
        }
        public static object ValidateRdsExportExocomputePortFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
        ...
        //      C# -> ValidateScriptOutputForManualPermissionValidationReply? ValidateScriptOutputForManualPermissionValidation
        // GraphQL -> validateScriptOutputForManualPermissionValidation: ValidateScriptOutputForManualPermissionValidationReply! (type)
        public static string ValidateScriptOutputForManualPermissionValidation(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\ninput: $input\n)";
            return "validateScriptOutputForManualPermissionValidation" + args + "\n{\n" + fs + "}\n";
        }
        public static object ValidateScriptOutputForManualPermissionValidationFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ValidateScriptOutputForManualPermissionValidationReply() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> ViolationsCategorySummary? ViolationsCategorySummary
        // GraphQL -> violationsCategorySummary: ViolationsCategorySummary! (type)
        ...
        public static object ViolationsCategorySummaryFieldSpec(AutofieldContext? ec=null)
        {
            ...
            var fieldSpecObj = new ViolationsCategorySummary() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

        //      C# -> ViolationsEnvironmentSummaries? ViolationsEnvironmentSummary
        // GraphQL -> violationsEnvironmentSummary: ViolationsEnvironmentSummaries! (type)
        public static string ViolationsEnvironmentSummary(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "\n(\nhistoricalDays: $historicalDays\npolicyTypes: $policyTypes\n)";
            return "violationsEnvironmentSummary" + args + "\n{\n" + fs + "}\n";
        }
        public static object ViolationsEnvironmentSummaryFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new ViolationsEnvironmentSummaries() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }
        ...
        //      C# -> IntegrationIngestionStatus? WorkdayIngestionStatus
        // GraphQL -> workdayIngestionStatus: IntegrationIngestionStatus (type)
        public static string WorkdayIngestionStatus(object fsObj)
        {
            var fs = ReflectionUtils.GetObjFieldSpec(fsObj);
            string args = "";
            return "workdayIngestionStatus" + args + "\n{\n" + fs + "}\n";
        }
        public static object WorkdayIngestionStatusFieldSpec(AutofieldContext? ec=null)
        {
            if(ec==null) {
                ec = new AutofieldContext();
            }
            var fieldSpecObj = new IntegrationIngestionStatus() ;
            fieldSpecObj.ApplyExploratoryFieldSpec(ec);
            return fieldSpecObj;
        }

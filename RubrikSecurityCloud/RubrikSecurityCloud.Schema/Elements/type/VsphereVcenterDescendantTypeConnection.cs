...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereVcenterDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereVcenterDescendantTypeConnection";
    }

    public VsphereVcenterDescendantTypeConnection Set(
        RscInterfaceList<VsphereVcenterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereVcenterDescendantType>();
    ...
    public static class ListVsphereVcenterDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterDescendantTypeConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<VsphereVcenterDescendantType> Nodes { get; set; }
    ...
    public VsphereVcenterDescendantTypeConnection Set(
        RscInterface<VsphereVcenterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<VsphereVcenterDescendantType>();

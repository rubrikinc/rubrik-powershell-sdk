...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixPrismCentralDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<NutanixPrismCentralDescendantType> Node { get; set; }
    ...
    public NutanixPrismCentralDescendantTypeEdge Set(
        RscInterface<NutanixPrismCentralDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<NutanixPrismCentralDescendantType>();
    ...
    public static class ListNutanixPrismCentralDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NutanixPrismCentralDescendantTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "DownloadResultsCsvReply";
    }
    ...
    public static class ListDownloadResultsCsvReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DownloadResultsCsvReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DownloadResultsCsvReply> list)
        {

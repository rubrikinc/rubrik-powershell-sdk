...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListOracleLiveMountConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleLiveMountConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleLiveMountConnection> list)
        {

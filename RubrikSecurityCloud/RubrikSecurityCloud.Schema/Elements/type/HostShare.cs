...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostShare: BaseType, CdmHierarchyObject, HierarchyObject, PhysicalHostDescendantType, PhysicalHostPhysicalChildType
    {
        #region members
        ...
        [JsonProperty("nasShareType")]
        public System.String? NasShareType { get; set; }
        ...
        //      C# -> HostShareDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: HostShareDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public HostShareDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> HostSharePhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: HostSharePhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public HostSharePhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public HostShare Set(
        ...
        System.String? NasShareType = null,
        System.Int32? NumWorkloadDescendants = null,
        System.Int32? ReplicatedObjectCount = null,
        System.Boolean? SlaPauseStatus = null,
        List<Org>? AllOrgs = null,
        Cluster? Cluster = null,
        HostShareDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        HostSharePhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( NasShareType != null ) {
            this.NasShareType = NasShareType;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostShare_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostShare_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostShare_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostShare_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostShare_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
        ...
        //      C# -> System.String? NasShareType
        // GraphQL -> nasShareType: String! (scalar)
        if (this.NasShareType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "nasShareType\n" ;
            } else {
                s += ind + "nasShareType\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? NasShareType
        // GraphQL -> nasShareType: String! (scalar)
        if (ec.Includes("nasShareType",true))
        {
            if(this.NasShareType == null) {
        ...
        else if (this.NasShareType != null && ec.Excludes("nasShareType",true))
        {
            this.NasShareType = null;
        }
        //      C# -> System.Int32? NumWorkloadDescendants
        // GraphQL -> numWorkloadDescendants: Int! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new HostShareDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new HostSharePhysicalChildTypeConnection();
    ...
    public static class ListHostShareExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HostShare> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HostShare());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HostShare> list)
        {

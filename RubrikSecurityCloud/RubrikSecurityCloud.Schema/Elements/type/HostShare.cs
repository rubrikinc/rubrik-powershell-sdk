...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostShare: IFragment, CdmHierarchyObject, HierarchyObject, PhysicalHostDescendantType, PhysicalHostPhysicalChildType
    {
        #region members
        //      C# -> System.String? Id
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.String? NasShareType
            // GraphQL -> nasShareType: String! (scalar)
            if (this.NasShareType == null && Exploration.Includes(parent + ".nasShareType$"))
            {

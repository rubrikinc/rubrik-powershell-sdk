...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbSource: BaseType, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongodbSource_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongodbSource_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongodbSource_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? BackupCount
        ...
        if (this.ConfigParams != null) {
            var fspec = this.ConfigParams.AsFieldSpec(conf.Child("configParams"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.NodeCount != null && ec.Excludes("nodeCount",true))
        {
            this.NodeCount = null;
        }
        //      C# -> System.Int32? NumWorkloadDescendants
        ...
        //      C# -> MongodbSourceConfigParams? ConfigParams
        // GraphQL -> configParams: MongodbSourceConfigParams (type)
        if (ec.Includes("configParams",false))
        {
            if(this.ConfigParams == null) {
        ...
        else if (this.ConfigParams != null && ec.Excludes("configParams",false))
        {
    ...
    public static class ListMongodbSourceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbSource> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongodbSource());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongodbSource> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereDatacenterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereDatacenterDescendantType> Nodes { get; set; }
    ...
    public VsphereDatacenterDescendantTypeConnection Set(
        RscInterfaceList<VsphereDatacenterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereDatacenterDescendantType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleFileDownloadLink: BaseType
    {
        #region members
    ...
    public static class ListOracleFileDownloadLinkExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleFileDownloadLink> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OracleFileDownloadLink());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OracleFileDownloadLink> list)
        {

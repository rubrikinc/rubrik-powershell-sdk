...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365Site: BaseType, HierarchyObject, HierarchySnappable, O365OrgDescendant, O365SharepointObject, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Site_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Site_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Site_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? HierarchyLevel
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? HierarchyLevel
        // GraphQL -> hierarchyLevel: Int! (scalar)
        if (ec.Includes("hierarchyLevel",true))
        {
            if(this.HierarchyLevel == null) {

                this.HierarchyLevel = Int32.MinValue;
        ...
        else if (this.HierarchyLevel != null && ec.Excludes("hierarchyLevel",true))
        {
    ...
    public static class ListO365SiteExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365Site> list)
        {

// AzureSubscriptionThreatMonitoringEnablement.cs
//
...
{
    #region AzureSubscriptionThreatMonitoringEnablement
    public class AzureSubscriptionThreatMonitoringEnablement: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureSubscriptionThreatMonitoringEnablement";
    }

    public AzureSubscriptionThreatMonitoringEnablement Set(
    ...
    } // class AzureSubscriptionThreatMonitoringEnablement
    
    #endregion

    public static class ListAzureSubscriptionThreatMonitoringEnablementExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureSubscriptionThreatMonitoringEnablement> list,
        ...
        public static List<string> SelectedFields(this List<AzureSubscriptionThreatMonitoringEnablement> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureSubscriptionThreatMonitoringEnablement());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureSubscriptionThreatMonitoringEnablement> list)
        {

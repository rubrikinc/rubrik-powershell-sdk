...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListReplicationPairConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReplicationPairConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReplicationPairConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSnapMirrorCloudExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnapMirrorCloud> list)
        {
        ...
        public static void SelectForRetrieval(this List<SnapMirrorCloud> list)
        {

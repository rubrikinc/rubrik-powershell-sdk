// CassandraSourcePhysicalChildTypeEdge.cs
//
...
{
    #region CassandraSourcePhysicalChildTypeEdge
    public class CassandraSourcePhysicalChildTypeEdge: BaseType
    {
        #region members
        ...
        [JsonProperty("node")]
        public CassandraSourcePhysicalChildType? Node { get; set; }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "CassandraSourcePhysicalChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<CassandraSourcePhysicalChildType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (CassandraSourcePhysicalChildType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    } // class CassandraSourcePhysicalChildTypeEdge
    
    #endregion

    public static class ListCassandraSourcePhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourcePhysicalChildTypeEdge> list)
        {

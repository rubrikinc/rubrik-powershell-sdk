...
{
    #region ViolationCategorySummary
    public class ViolationCategorySummary: BaseType
    {
        #region members

        //      C# -> Category? Category
        // GraphQL -> category: Category! (enum)
    ...
    public override string GetGqlTypeName() {
        return "ViolationCategorySummary";
    }

    public ViolationCategorySummary Set(
    ...
    } // class ViolationCategorySummary
    
    #endregion

    public static class ListViolationCategorySummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ViolationCategorySummary> list,
        ...
        public static List<string> SelectedFields(this List<ViolationCategorySummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ViolationCategorySummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ViolationCategorySummary> list)
        {

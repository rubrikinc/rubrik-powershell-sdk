...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereHostEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereHostEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereHostEdge> list)
        {

...
{
    #region RegionEdge
    public class RegionEdge: BaseType
    {
        #region members
    ...
    public static class ListRegionEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RegionEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RegionEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RegionEdge> list)
        {

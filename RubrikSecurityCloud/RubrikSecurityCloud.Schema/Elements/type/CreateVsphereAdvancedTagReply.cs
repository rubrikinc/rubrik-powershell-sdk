...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateVsphereAdvancedTagReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateVsphereAdvancedTagReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateVsphereAdvancedTagReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixCategoryValueDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NutanixCategoryValueDescendantType> Nodes { get; set; }
    ...
    public NutanixCategoryValueDescendantTypeConnection Set(
        RscInterfaceList<NutanixCategoryValueDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NutanixCategoryValueDescendantType>();
    ...
    public static class ListNutanixCategoryValueDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryValueDescendantTypeConnection> list)
        {

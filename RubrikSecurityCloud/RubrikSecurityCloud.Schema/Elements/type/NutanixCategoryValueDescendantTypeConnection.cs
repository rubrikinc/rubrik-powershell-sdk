...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixCategoryValueDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NutanixCategoryValueDescendantType> Nodes { get; set; }
    ...
    public NutanixCategoryValueDescendantTypeConnection Set(
        RscInterface<NutanixCategoryValueDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NutanixCategoryValueDescendantType>();

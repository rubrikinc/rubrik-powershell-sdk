...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.Boolean? IsLoginEnabled
        // GraphQL -> isLoginEnabled: Boolean! (scalar)
        if (ec.Includes("isLoginEnabled",true))
        {
            if(this.IsLoginEnabled == null) {
        ...
        else if (this.IsLoginEnabled != null && ec.Excludes("isLoginEnabled",true))
        {
            this.IsLoginEnabled = null;
        }
        //      C# -> System.String? LoginText
        // GraphQL -> loginText: String! (scalar)
        if (ec.Includes("loginText",true))
        {
            if(this.LoginText == null) {
        ...
        else if (this.LoginText != null && ec.Excludes("loginText",true))
        {
            this.LoginText = null;
        }
    }
    ...
    public static class ListClassificationLoginSettingsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ClassificationLoginSettings> list)
        {
        ...
        public static void SelectForRetrieval(this List<ClassificationLoginSettings> list)
        {

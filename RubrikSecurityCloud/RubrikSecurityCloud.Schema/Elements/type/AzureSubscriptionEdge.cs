...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAzureSubscriptionEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureSubscriptionEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureSubscriptionEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        //      C# -> System.Int32? PartitionNum
        // GraphQL -> partitionNum: Int! (scalar)
        if (ec.Includes("partitionNum",true))
        {
            if(this.PartitionNum == null) {
        ...
        else if (this.PartitionNum != null && ec.Excludes("partitionNum",true))
        {
    ...
    public static class ListDb2WorkloadDataBackupFileExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2WorkloadDataBackupFile> list)
        {
        ...
        public static void SelectForRetrieval(this List<Db2WorkloadDataBackupFile> list)
        {

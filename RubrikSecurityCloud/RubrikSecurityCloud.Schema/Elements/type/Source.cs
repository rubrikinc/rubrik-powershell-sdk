...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Source: BaseType, FailoverGroupByInfo
    {
        #region members
    ...
    public static class ListSourceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Source> list)
        {
        ...
        public static void SelectForRetrieval(this List<Source> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "O365SharepointListConnection";
    }
    ...
    public static class ListO365SharepointListConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365SharepointListConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365SharepointListConnection> list)
        {

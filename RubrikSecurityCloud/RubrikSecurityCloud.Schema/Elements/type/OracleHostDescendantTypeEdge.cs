...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleHostDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<OracleHostDescendantType> Node { get; set; }
    ...
    public OracleHostDescendantTypeEdge Set(
        RscInterface<OracleHostDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<OracleHostDescendantType>();
    ...
    public static class ListOracleHostDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleHostDescendantTypeEdge> list)
        {

// CloudArchivalLocationTprReqChangesTemplate.cs
//
...
{
    #region CloudArchivalLocationTprReqChangesTemplate
 
    public class CloudArchivalLocationTprReqChangesTemplate: BaseType, RequestedChangesTemplate
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CloudArchivalLocationTprReqChangesTemplate";
    }

    public CloudArchivalLocationTprReqChangesTemplate Set(
    ...
    } // class CloudArchivalLocationTprReqChangesTemplate
    
    #endregion

    public static class ListCloudArchivalLocationTprReqChangesTemplateExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudArchivalLocationTprReqChangesTemplate> list,
        ...
        public static List<string> SelectedFields(this List<CloudArchivalLocationTprReqChangesTemplate> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudArchivalLocationTprReqChangesTemplate());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudArchivalLocationTprReqChangesTemplate> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> DateTime? CreateDate
        // GraphQL -> createDate: DateTime! (scalar)
        if (ec.Includes("createDate",true))
        {
            if(this.CreateDate == null) {
        ...
        else if (this.CreateDate != null && ec.Excludes("createDate",true))
        {
    ...
    public static class ListDataLocationExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DataLocation> list)
        {
        ...
        public static void SelectForRetrieval(this List<DataLocation> list)
        {

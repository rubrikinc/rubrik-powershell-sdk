...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MapAzureCloudAccountToPersistentStorageLocationReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MapAzureCloudAccountToPersistentStorageLocationReply";
    }
    ...
    public static class ListMapAzureCloudAccountToPersistentStorageLocationReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MapAzureCloudAccountToPersistentStorageLocationReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MapAzureCloudAccountToPersistentStorageLocationReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MapAzureCloudAccountToPersistentStorageLocationReply> list)
        {

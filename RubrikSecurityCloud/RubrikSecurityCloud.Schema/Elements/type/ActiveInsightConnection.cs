...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListActiveInsightConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ActiveInsightConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ActiveInsightConnection> list)
        {

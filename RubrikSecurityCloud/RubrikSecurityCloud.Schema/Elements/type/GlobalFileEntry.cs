...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.FileData != null) {
            var fspec = this.FileData.AsFieldSpec(conf.Child("fileData"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> GlobalSearchFile? FileData
        // GraphQL -> fileData: GlobalSearchFile (type)
        if (ec.Includes("fileData",false))
        {
            if(this.FileData == null) {

                this.FileData = new GlobalSearchFile();
                this.FileData.ApplyExploratoryFieldSpec(ec.NewChild("fileData"));
        ...
        else if (this.FileData != null && ec.Excludes("fileData",false))
        {
            this.FileData = null;
        }
    }
    ...
    public static class ListGlobalFileEntryExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GlobalFileEntry> list)
        {
        ...
        public static void SelectForRetrieval(this List<GlobalFileEntry> list)
        {

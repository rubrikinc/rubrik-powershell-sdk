...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasNamespaceLogicalChildTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "NasNamespaceLogicalChildTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespaceLogicalChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<NasNamespaceLogicalChildType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (NasNamespaceLogicalChildType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    public static class ListNasNamespaceLogicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasNamespaceLogicalChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NasNamespaceLogicalChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NasNamespaceLogicalChildTypeEdge> list)
        {

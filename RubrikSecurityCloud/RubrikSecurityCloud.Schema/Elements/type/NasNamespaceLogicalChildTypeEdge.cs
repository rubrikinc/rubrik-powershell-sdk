...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasNamespaceLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<NasNamespaceLogicalChildType> Node { get; set; }
    ...
    public NasNamespaceLogicalChildTypeEdge Set(
        RscInterface<NasNamespaceLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<NasNamespaceLogicalChildType>();

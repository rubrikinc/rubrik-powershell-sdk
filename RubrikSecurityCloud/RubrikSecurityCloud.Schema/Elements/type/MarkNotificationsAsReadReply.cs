...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.Int64? UpdatedCount
        // GraphQL -> updatedCount: Long! (scalar)
        if (ec.Includes("updatedCount",true))
        {
            if(this.UpdatedCount == null) {
        ...
        else if (this.UpdatedCount != null && ec.Excludes("updatedCount",true))
        {
    ...
    public static class ListMarkNotificationsAsReadReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MarkNotificationsAsReadReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<MarkNotificationsAsReadReply> list)
        {

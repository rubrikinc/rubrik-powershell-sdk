...
namespace RubrikSecurityCloud.Types
{
    ...
    public class K8sNamespace: BaseType, HierarchyObject, HierarchySnappable, K8sClusterDescendant, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> System.Boolean? ClusterScoped
        // GraphQL -> clusterScoped: Boolean! (scalar)
        [JsonProperty("clusterScoped")]
        public System.Boolean? ClusterScoped { get; set; }
        ...
        // GraphQL -> k8sClusterId: String! (scalar)
        ...
        //      C# -> System.Int32? NumPvcs
        // GraphQL -> numPvcs: Int! (scalar)
        [JsonProperty("numPvcs")]
        public System.Int32? NumPvcs { get; set; }
        ...
        //      C# -> System.Int32? NumWorkloads
        // GraphQL -> numWorkloads: Int! (scalar)
        [JsonProperty("numWorkloads")]
        public System.Int32? NumWorkloads { get; set; }
        ...
        //      C# -> System.String? ResourceVersion
        // GraphQL -> resourceVersion: String! (scalar)
        [JsonProperty("resourceVersion")]
        public System.String? ResourceVersion { get; set; }
    ...
    public K8sNamespace Set(
        ...
        System.Boolean? ClusterScoped = null,
        System.String? Id = null,
        System.Boolean? IsRelic = null,
        System.String? K8sClusterId = null,
        System.String? Name = null,
        System.String? NamespaceName = null,
        System.Int32? NumPvcs = null,
        System.Int32? NumWorkloadDescendants = null,
        System.Int32? NumWorkloads = null,
        System.Int32? OnDemandSnapshotCount = null,
        System.String? ResourceVersion = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "K8sNamespace_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "K8sNamespace_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "K8sNamespace_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? ApiVersion
        ...
        //      C# -> System.String? K8sClusterId
        // GraphQL -> k8sClusterId: String! (scalar)
        if (this.K8sClusterId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "k8sClusterId\n" ;
            } else {
                s += ind + "k8sClusterId\n" ;
            }
        }
        ...
        //      C# -> System.Int32? NumPvcs
        // GraphQL -> numPvcs: Int! (scalar)
        if (this.NumPvcs != null) {
            if (conf.Flat) {
                s += conf.Prefix + "numPvcs\n" ;
            } else {
                s += ind + "numPvcs\n" ;
            }
        }
        ...
        if (this.ResourceVersion != null) {
            if (conf.Flat) {
                s += conf.Prefix + "resourceVersion\n" ;
            } else {
                s += ind + "resourceVersion\n" ;
            }
        }
        //      C# -> System.Boolean? SlaPauseStatus
        // GraphQL -> slaPauseStatus: Boolean! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? ClusterScoped
        // GraphQL -> clusterScoped: Boolean! (scalar)
        if (ec.Includes("clusterScoped",true))
        {
            if(this.ClusterScoped == null) {
        ...
        else if (this.ClusterScoped != null && ec.Excludes("clusterScoped",true))
        {
        ...
        //      C# -> System.String? K8sClusterId
        // GraphQL -> k8sClusterId: String! (scalar)
        if (ec.Includes("k8sClusterId",true))
        {
            if(this.K8sClusterId == null) {

                this.K8sClusterId = "FETCH";
        ...
        else if (this.K8sClusterId != null && ec.Excludes("k8sClusterId",true))
        {
            this.K8sClusterId = null;
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
        ...
        //      C# -> System.Int32? NumPvcs
        // GraphQL -> numPvcs: Int! (scalar)
        if (ec.Includes("numPvcs",true))
        {
            if(this.NumPvcs == null) {

                this.NumPvcs = Int32.MinValue;
        ...
        else if (this.NumPvcs != null && ec.Excludes("numPvcs",true))
        {
            this.NumPvcs = null;
        }
        //      C# -> System.Int32? NumWorkloadDescendants
        ...
        if (ec.Includes("numWorkloads",true))
        {
            if(this.NumWorkloads == null) {
                ...
                this.NumWorkloads = Int32.MinValue;
        ...
        //      C# -> System.String? ResourceVersion
        // GraphQL -> resourceVersion: String! (scalar)
        if (ec.Includes("resourceVersion",true))
        {
            if(this.ResourceVersion == null) {

                this.ResourceVersion = "FETCH";
        ...
        else if (this.ResourceVersion != null && ec.Excludes("resourceVersion",true))
        {
    ...
    public static class ListK8sNamespaceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<K8sNamespace> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new K8sNamespace());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<K8sNamespace> list)
        {

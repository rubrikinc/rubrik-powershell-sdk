...
namespace Rubrik.SecurityCloud.Types
{
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? ClusterScoped
            // GraphQL -> clusterScoped: Boolean! (scalar)
            if (this.ClusterScoped == null && Exploration.Includes(parent + ".clusterScoped$"))
            {
                this.ClusterScoped = new System.Boolean();
            }
            //      C# -> System.String? Id
            // GraphQL -> id: UUID! (scalar)
            ...
            //      C# -> System.String? K8sClusterId
            // GraphQL -> k8sClusterId: String! (scalar)
            if (this.K8sClusterId == null && Exploration.Includes(parent + ".k8sClusterId$"))
            {
            ...
            //      C# -> System.String? NamespaceName
            // GraphQL -> namespaceName: String! (scalar)
            if (this.NamespaceName == null && Exploration.Includes(parent + ".namespaceName$"))
            {
                this.NamespaceName = new System.String("FETCH");
            }
            //      C# -> System.Int32? NumPvcs
            // GraphQL -> numPvcs: Int! (scalar)
            if (this.NumPvcs == null && Exploration.Includes(parent + ".numPvcs$"))
            {
            ...
            //      C# -> System.Int32? NumWorkloads
            // GraphQL -> numWorkloads: Int! (scalar)
            if (this.NumWorkloads == null && Exploration.Includes(parent + ".numWorkloads$"))
            {
            ...
            //      C# -> System.String? ResourceVersion
            // GraphQL -> resourceVersion: String! (scalar)
            if (this.ResourceVersion == null && Exploration.Includes(parent + ".resourceVersion$"))
            {

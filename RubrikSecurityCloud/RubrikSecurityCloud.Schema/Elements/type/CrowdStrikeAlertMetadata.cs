...
{
    #region CrowdStrikeAlertMetadata
 
    public class CrowdStrikeAlertMetadata: BaseType, ResourceMetadataUnion
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CrowdStrikeAlertMetadata";
    }

    public CrowdStrikeAlertMetadata Set(
    ...
    } // class CrowdStrikeAlertMetadata
    
    #endregion

    public static class ListCrowdStrikeAlertMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CrowdStrikeAlertMetadata> list,
        ...
        public static List<string> SelectedFields(this List<CrowdStrikeAlertMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CrowdStrikeAlertMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CrowdStrikeAlertMetadata> list)
        {

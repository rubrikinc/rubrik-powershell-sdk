...
namespace RubrikSecurityCloud.Types
{
        ...
        if (this.Nodes != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "AwsNativeHierarchyObjectConnection_INTERFACE_FIELD_nodes: nodes{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? Count
    ...
    public static class ListAwsNativeHierarchyObjectConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeHierarchyObjectConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsNativeHierarchyObjectConnection> list)
        {

...
{
    #region AwsExoTaskImageBundle
    public class AwsExoTaskImageBundle: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AWSExoTaskImageBundle";
    }

    public AwsExoTaskImageBundle Set(
    ...
    } // class AwsExoTaskImageBundle
    
    #endregion

    public static class ListAwsExoTaskImageBundleExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AwsExoTaskImageBundle> list,
        ...
        public static List<string> SelectedFields(this List<AwsExoTaskImageBundle> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsExoTaskImageBundle());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AwsExoTaskImageBundle> list)
        {

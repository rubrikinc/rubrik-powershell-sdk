...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.AppFid != null && ec.Excludes("appFid",true))
        {
            this.AppFid = null;
        }
        //      C# -> System.String? Id
    ...
    public static class ListResultExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Result> list)
        {
        ...
        public static void SelectForRetrieval(this List<Result> list)
        {

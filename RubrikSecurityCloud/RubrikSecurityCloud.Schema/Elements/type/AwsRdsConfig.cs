...
{
    #region AwsRdsConfig
    public class AwsRdsConfig: BaseType
    {
        #region members
    ...
    public static class ListAwsRdsConfigExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsRdsConfig> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsRdsConfig> list)
        {

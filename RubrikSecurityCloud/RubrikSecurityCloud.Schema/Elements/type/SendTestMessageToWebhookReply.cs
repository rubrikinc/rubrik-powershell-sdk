// SendTestMessageToWebhookReply.cs
//
...
{
    #region SendTestMessageToWebhookReply
    public class SendTestMessageToWebhookReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SendTestMessageToWebhookReply";
    }

    public SendTestMessageToWebhookReply Set(
    ...
    } // class SendTestMessageToWebhookReply
    
    #endregion

    public static class ListSendTestMessageToWebhookReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SendTestMessageToWebhookReply> list,
        ...
        public static List<string> SelectedFields(this List<SendTestMessageToWebhookReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SendTestMessageToWebhookReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SendTestMessageToWebhookReply> list)
        {

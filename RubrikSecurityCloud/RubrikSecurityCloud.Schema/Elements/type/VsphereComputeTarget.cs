...
{
    #region VsphereComputeTarget
    public class VsphereComputeTarget: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "VsphereComputeTarget";
    }

    public VsphereComputeTarget Set(
    ...
    } // class VsphereComputeTarget
    
    #endregion

    public static class ListVsphereComputeTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereComputeTarget> list,
        ...
        public static List<string> SelectedFields(this List<VsphereComputeTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereComputeTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereComputeTarget> list)
        {

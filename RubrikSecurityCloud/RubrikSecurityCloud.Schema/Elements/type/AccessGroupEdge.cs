...
{
    #region AccessGroupEdge
    public class AccessGroupEdge: BaseType
    {
        #region members
        ...
        [JsonProperty("node")]
        public AccessGroup? Node { get; set; }
    ...
    public AccessGroupEdge Set(
        System.String? Cursor = null,
        AccessGroup? Node = null
    ) 
    {
        if ( Cursor != null ) {
            this.Cursor = Cursor;
    ...
    public static class ListAccessGroupEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AccessGroupEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AccessGroupEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AccessGroupEdge> list)
        {

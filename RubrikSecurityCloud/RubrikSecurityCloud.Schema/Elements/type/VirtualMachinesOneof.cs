...
{
    #region VirtualMachinesOneof
    public class VirtualMachinesOneof: BaseType
    {
        #region members
        ...
        public ProxmoxVirtualMachineDetails? Proxmox { get; set; }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("proxmox",false))
        {
            if(this.Proxmox == null) {
                ...
                this.Proxmox = new ProxmoxVirtualMachineDetails();
    ...
    } // class VirtualMachinesOneof
    
    #endregion

    public static class ListVirtualMachinesOneofExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VirtualMachinesOneof> list,
        ...
        public static List<string> SelectedFields(this List<VirtualMachinesOneof> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VirtualMachinesOneof());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VirtualMachinesOneof> list)
        {

...
{
    #region SlaUpgradeIneligibility
    public class SlaUpgradeIneligibility: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SLAUpgradeIneligibility";
    }

    public SlaUpgradeIneligibility Set(
    ...
    } // class SlaUpgradeIneligibility
    
    #endregion

    public static class ListSlaUpgradeIneligibilityExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SlaUpgradeIneligibility> list,
        ...
        public static List<string> SelectedFields(this List<SlaUpgradeIneligibility> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SlaUpgradeIneligibility());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SlaUpgradeIneligibility> list)
        {

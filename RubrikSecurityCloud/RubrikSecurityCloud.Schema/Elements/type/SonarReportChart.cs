...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SonarReportChart: BaseType, ReportChartType
    {
        #region members
    ...
    public static class ListSonarReportChartExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SonarReportChart> list)
        {

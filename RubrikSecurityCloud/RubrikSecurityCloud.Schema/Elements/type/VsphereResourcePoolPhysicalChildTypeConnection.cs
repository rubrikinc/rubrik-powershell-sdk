...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereResourcePoolPhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereResourcePoolPhysicalChildType> Nodes { get; set; }
    ...
    public VsphereResourcePoolPhysicalChildTypeConnection Set(
        RscInterfaceList<VsphereResourcePoolPhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereResourcePoolPhysicalChildType>();
    ...
    public static class ListVsphereResourcePoolPhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereResourcePoolPhysicalChildTypeConnection> list)
        {

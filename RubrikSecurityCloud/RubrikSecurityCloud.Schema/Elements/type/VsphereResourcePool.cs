...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereResourcePool: BaseType, CdmHierarchyObject, HierarchyObject, VsphereComputeClusterDescendantType, VsphereComputeClusterPhysicalChildType, VsphereDatacenterDescendantType, VsphereHostDescendantType, VsphereHostPhysicalChildType, VsphereResourcePoolDescendantType, VsphereResourcePoolPhysicalChildType, VsphereVcenterDescendantType
    {
        ...
        //      C# -> VsphereResourcePoolDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VsphereResourcePoolDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VsphereResourcePoolDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VsphereResourcePoolPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: VsphereResourcePoolPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public VsphereResourcePoolPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereResourcePool";
    }

    public VsphereResourcePool Set(
        ...
        VsphereResourcePoolDescendantTypeConnection? DescendantConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VsphereResourcePoolDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new VsphereResourcePoolPhysicalChildTypeConnection();
    ...
    public static class ListVsphereResourcePoolExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereResourcePool> list,
        ...
        public static List<string> SelectedFields(this List<VsphereResourcePool> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereResourcePool());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereResourcePool> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class GetAnomalyDetailsReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int64? BytesSuspiciousCount
            // GraphQL -> bytesSuspiciousCount: Long! (scalar)
            if (this.BytesSuspiciousCount == null && Exploration.Includes(parent + ".bytesSuspiciousCount$"))
            {
    ...
    public static class ListGetAnomalyDetailsReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new GetAnomalyDetailsReply();
            list.Add(item);

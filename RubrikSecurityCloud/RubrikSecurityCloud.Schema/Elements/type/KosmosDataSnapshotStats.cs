...
{
    #region KosmosDataSnapshotStats
    public class KosmosDataSnapshotStats: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "KosmosDataSnapshotStats";
    }

    public KosmosDataSnapshotStats Set(
    ...
    } // class KosmosDataSnapshotStats
    
    #endregion

    public static class ListKosmosDataSnapshotStatsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosDataSnapshotStats> list,
        ...
        public static List<string> SelectedFields(this List<KosmosDataSnapshotStats> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KosmosDataSnapshotStats());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KosmosDataSnapshotStats> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CloudDirectNasExport: BaseType, CloudDirectHierarchyObject, CloudDirectHierarchyWorkload, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? ExportFid
        // GraphQL -> exportFid: UUID! (scalar)
        [JsonProperty("exportFid")]
        public System.String? ExportFid { get; set; }
        ...
        //      C# -> System.String? ExportType
        // GraphQL -> exportType: String! (scalar)
        ...
        //      C# -> System.Boolean? IsProtected
        // GraphQL -> isProtected: Boolean! (scalar)
    ...
    public CloudDirectNasExport Set(
        ...
        System.String? ExportType = null,
        System.String? Id = null,
        System.Boolean? IsArchived = null,
        System.Boolean? IsProtected = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "CloudDirectNasExport_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "CloudDirectNasExport_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "CloudDirectNasExport_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CloudDirectId
        ...
        //      C# -> System.String? ExportFid
        // GraphQL -> exportFid: UUID! (scalar)
        if (this.ExportFid != null) {
            if (conf.Flat) {
                s += conf.Prefix + "exportFid\n" ;
            } else {
                s += ind + "exportFid\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? ExportFid
        // GraphQL -> exportFid: UUID! (scalar)
        if (ec.Includes("exportFid",true))
        {
            if(this.ExportFid == null) {

                this.ExportFid = "FETCH";
        ...
        else if (this.ExportFid != null && ec.Excludes("exportFid",true))
        {
            this.ExportFid = null;
        }
        //      C# -> System.String? ExportPath
        ...
        //      C# -> System.String? ExportType
        // GraphQL -> exportType: String! (scalar)
        if (ec.Includes("exportType",true))
        {
            if(this.ExportType == null) {

                this.ExportType = "FETCH";
        ...
        else if (this.ExportType != null && ec.Excludes("exportType",true))
        {
        ...
        //      C# -> System.Boolean? IsProtected
        // GraphQL -> isProtected: Boolean! (scalar)
        if (ec.Includes("isProtected",true))
        {
            if(this.IsProtected == null) {
        ...
        else if (this.IsProtected != null && ec.Excludes("isProtected",true))
        {
        ...
        //      C# -> System.String? SystemName
        // GraphQL -> systemName: String! (scalar)
        if (ec.Includes("systemName",true))
        {
            if(this.SystemName == null) {

                this.SystemName = "FETCH";
    ...
    } // class CloudDirectNasExport
    
    #endregion

    public static class ListCloudDirectNasExportExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectNasExport> list,
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasExport> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudDirectNasExport());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudDirectNasExport> list)
        {

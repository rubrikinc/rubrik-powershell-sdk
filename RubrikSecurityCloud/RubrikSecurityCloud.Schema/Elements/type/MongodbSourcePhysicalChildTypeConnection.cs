...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbSourcePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MongodbSourcePhysicalChildType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MongodbSourcePhysicalChildTypeConnection";
    }

    public MongodbSourcePhysicalChildTypeConnection Set(
        RscInterfaceList<MongodbSourcePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MongodbSourcePhysicalChildType>();
    ...
    public static class ListMongodbSourcePhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbSourcePhysicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongodbSourcePhysicalChildTypeConnection> list)
        {

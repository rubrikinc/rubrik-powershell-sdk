...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbSourcePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<MongodbSourcePhysicalChildType> Nodes { get; set; }
    ...
    public MongodbSourcePhysicalChildTypeConnection Set(
        RscInterface<MongodbSourcePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<MongodbSourcePhysicalChildType>();

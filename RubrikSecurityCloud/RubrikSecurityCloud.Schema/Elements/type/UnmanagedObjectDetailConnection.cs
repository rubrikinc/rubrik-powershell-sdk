...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUnmanagedObjectDetailConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UnmanagedObjectDetailConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<UnmanagedObjectDetailConnection> list)
        {

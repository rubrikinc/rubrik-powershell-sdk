// FusionComputeVirtualMachine.cs
//
...
{
    #region FusionComputeVirtualMachine
 
    public class FusionComputeVirtualMachine: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, FusionComputeClusterDescendant, FusionComputeClusterPhysicalChildType, FusionComputeHostDescendant, FusionComputeHostPhysicalChildType, FusionComputeSiteDescendant, FusionComputeSitePhysicalChildType, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject, HierarchySnappable
    {
        #region members
        ...
        //      C# -> System.String? FcVmId
        // GraphQL -> fcVmId: String! (scalar)
        [JsonProperty("fcVmId")]
        public System.String? FcVmId { get; set; }
    ...
    public FusionComputeVirtualMachine()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeVirtualMachine";
    }

    public FusionComputeVirtualMachine Set(
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.FcVmId != null && ec.Excludes("fcVmId",true))
        {
            this.FcVmId = null;
        }
        //      C# -> System.String? GuestOsName
    ...
    } // class FusionComputeVirtualMachine
    
    #endregion

    public static class ListFusionComputeVirtualMachineExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeVirtualMachine> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeVirtualMachine> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeVirtualMachine());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeVirtualMachine> list)
        {

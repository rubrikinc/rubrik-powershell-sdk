...
{
    #region CloudDirectNasNamespace
 
    public class CloudDirectNasNamespace: BaseType, CloudDirectHierarchyObject, CloudDirectNasSystemDescendantType, CloudDirectNasSystemLogicalChildType, HierarchyObject
    {
        #region members
        ...
        //      C# -> CloudDirectNasNamespaceDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: CloudDirectNasNamespaceDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public CloudDirectNasNamespaceDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> CloudDirectNasNamespaceLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: CloudDirectNasNamespaceLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public CloudDirectNasNamespaceLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> NamespaceOverrides? Overrides
        // GraphQL -> overrides: NamespaceOverrides (type)
        [JsonProperty("overrides")]
        public NamespaceOverrides? Overrides { get; set; }
    ...
    public CloudDirectNasNamespace()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "CloudDirectNasNamespace";
    }

    public CloudDirectNasNamespace Set(
        ...
        NamespaceOverrides? Overrides = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new CloudDirectNasNamespaceDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new CloudDirectNasNamespaceLogicalChildTypeConnection();
        ...
        if (ec.Includes("overrides",false))
        {
            if(this.Overrides == null) {
                ...
                this.Overrides = new NamespaceOverrides();
    ...
    } // class CloudDirectNasNamespace
    
    #endregion

    public static class ListCloudDirectNasNamespaceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectNasNamespace> list,
        ...
        public static List<string> SelectedFields(this List<CloudDirectNasNamespace> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudDirectNasNamespace());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudDirectNasNamespace> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class IsVolumeSnapshotRestorableReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Boolean? IsRestorable
            // GraphQL -> isRestorable: Boolean! (scalar)
            if (this.IsRestorable == null && Exploration.Includes(parent + ".isRestorable$"))
            {
                this.IsRestorable = new System.Boolean();
            }
        }
    ...
    public static class ListIsVolumeSnapshotRestorableReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new IsVolumeSnapshotRestorableReply();
            list.Add(item);

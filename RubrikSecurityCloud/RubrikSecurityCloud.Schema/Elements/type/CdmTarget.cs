...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CdmTarget: BaseType, Target
    {
        #region members
    ...
    public static class ListCdmTargetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmTarget> list)
        {

...
{
    #region CdmManagedGlacierTarget
 
    public class CdmManagedGlacierTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedGlacierTarget";
    }

    public CdmManagedGlacierTarget Set(
    ...
    } // class CdmManagedGlacierTarget
    
    #endregion

    public static class ListCdmManagedGlacierTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CdmManagedGlacierTarget> list,
        ...
        public static List<string> SelectedFields(this List<CdmManagedGlacierTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedGlacierTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmManagedGlacierTarget> list)
        {

...
{
    #region OwnerInfo
    public class OwnerInfo: BaseType
    {
        #region members
    ...
    public static class ListOwnerInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OwnerInfo> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OwnerInfo());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OwnerInfo> list)
        {

...
{
    #region ClusterDetails
    public class ClusterDetails: BaseType
    {
        #region members
    ...
    public static class ListClusterDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ClusterDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ClusterDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ClusterDetails> list)
        {

...
{
    #region MysqldbDatabase
 
    public class MysqldbDatabase: BaseType, CdmHierarchyObject, HierarchyObject, KosmosHierarchyObjectType, KosmosLeafHierarchyObjectType, KosmosParentHierarchyObjectDescendantType, KosmosParentHierarchyObjectPhysicalChildType
    {
        #region members
        ...
        //      C# -> MysqldbDatabaseMetadata? Metadata
        // GraphQL -> metadata: MysqldbDatabaseMetadata! (type)
        [JsonProperty("metadata")]
        public MysqldbDatabaseMetadata? Metadata { get; set; }
    ...
    public MysqldbDatabase Set(
        ...
        MysqldbDatabaseMetadata? Metadata = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new MysqldbDatabaseMetadata();
    ...
    } // class MysqldbDatabase
    
    #endregion

    public static class ListMysqldbDatabaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MysqldbDatabase> list,
        ...
        public static List<string> SelectedFields(this List<MysqldbDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MysqldbDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MysqldbDatabase> list)
        {

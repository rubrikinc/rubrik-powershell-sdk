...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoSourceDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MongoSourceDescendantType> Nodes { get; set; }
    ...
    public MongoSourceDescendantTypeConnection Set(
        RscInterfaceList<MongoSourceDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MongoSourceDescendantType>();

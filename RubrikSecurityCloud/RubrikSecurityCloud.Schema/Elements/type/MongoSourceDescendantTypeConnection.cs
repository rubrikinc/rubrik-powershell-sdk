...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoSourceDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<MongoSourceDescendantType> Nodes { get; set; }
    ...
    public MongoSourceDescendantTypeConnection Set(
        RscInterface<MongoSourceDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<MongoSourceDescendantType>();

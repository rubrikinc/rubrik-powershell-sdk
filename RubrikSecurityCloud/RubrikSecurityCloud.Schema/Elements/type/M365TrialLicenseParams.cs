...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListM365TrialLicenseParamsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<M365TrialLicenseParams> list)
        {
        ...
        public static void SelectForRetrieval(this List<M365TrialLicenseParams> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class TaskDetailClusterType: BaseType, TaskDetailGroupByInfo
    {
        #region members
    ...
    public static class ListTaskDetailClusterTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TaskDetailClusterType> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TaskDetailClusterType());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TaskDetailClusterType> list)
        {

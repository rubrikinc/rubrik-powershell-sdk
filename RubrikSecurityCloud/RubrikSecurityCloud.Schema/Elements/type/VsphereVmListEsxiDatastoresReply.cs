// VsphereVmListEsxiDatastoresReply.cs
//
...
{
    #region VsphereVmListEsxiDatastoresReply
    public class VsphereVmListEsxiDatastoresReply: BaseType
    {
        #region members
        ...
        //      C# -> List<Datastore>? Data
        // GraphQL -> data: [Datastore!]! (type)
        [JsonProperty("data")]
    ...
    public override string GetGqlTypeName() {
        return "VsphereVmListEsxiDatastoresReply";
    }

    public VsphereVmListEsxiDatastoresReply Set(
    ...
    } // class VsphereVmListEsxiDatastoresReply
    
    #endregion

    public static class ListVsphereVmListEsxiDatastoresReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVmListEsxiDatastoresReply> list,
        ...
        public static List<string> SelectedFields(this List<VsphereVmListEsxiDatastoresReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereVmListEsxiDatastoresReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereVmListEsxiDatastoresReply> list)
        {

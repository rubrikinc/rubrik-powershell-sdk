...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListGroupedReleaseNoteEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GroupedReleaseNoteEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<GroupedReleaseNoteEdge> list)
        {

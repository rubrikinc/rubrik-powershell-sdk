...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleDataGuardGroupDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<OracleDataGuardGroupDescendantType> Node { get; set; }
    ...
    public OracleDataGuardGroupDescendantTypeEdge Set(
        RscInterface<OracleDataGuardGroupDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<OracleDataGuardGroupDescendantType>();
    ...
    public static class ListOracleDataGuardGroupDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleDataGuardGroupDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleDataGuardGroupDescendantTypeEdge> list)
        {

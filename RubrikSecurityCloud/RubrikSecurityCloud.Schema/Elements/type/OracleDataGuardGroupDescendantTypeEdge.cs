...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class OracleDataGuardGroupDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (OracleDataGuardGroupDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleDataGuardGroupDescendantType));
    ...
    public static class ListOracleDataGuardGroupDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new OracleDataGuardGroupDescendantTypeEdge();
            list.Add(item);

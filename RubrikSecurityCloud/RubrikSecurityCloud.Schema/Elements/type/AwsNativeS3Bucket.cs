...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "AwsNativeS3Bucket_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "AwsNativeS3Bucket_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "AwsNativeS3Bucket_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? AwsAccountRubrikId
        ...
        if (this.EarliestRestoreTime != null) {
            if (conf.Flat) {
                s += conf.Prefix + "earliestRestoreTime\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> DateTime? EarliestRestoreTime
        // GraphQL -> earliestRestoreTime: DateTime (scalar)
        if (ec.Includes("earliestRestoreTime",true))
        {
            if(this.EarliestRestoreTime == null) {
        ...
        else if (this.EarliestRestoreTime != null && ec.Excludes("earliestRestoreTime",true))
        {
            this.EarliestRestoreTime = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
    ...
    public static class ListAwsNativeS3BucketExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeS3Bucket> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsNativeS3Bucket());
            }

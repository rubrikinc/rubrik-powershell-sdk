...
namespace RubrikSecurityCloud.Types
{
    ...
    public class GroupConnection: BaseType
    {
        #region members
        ...
        //      C# -> List<GroupEdge>? Edges
        // GraphQL -> edges: [GroupEdge!]! (type)
        [JsonProperty("edges")]
        public List<GroupEdge>? Edges { get; set; }

        //      C# -> List<Group>? Nodes
        // GraphQL -> nodes: [Group!]! (type)
        [JsonProperty("nodes")]
    ...
    public GroupConnection Set(
        System.Int32? Count = null,
        List<GroupEdge>? Edges = null,
        List<Group>? Nodes = null,
    ...
    public static class ListGroupConnectionExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GroupConnection> list,
        ...
        public static List<string> SelectedFields(this List<GroupConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GroupConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GroupConnection> list)
        {

...
{
    #region TprFilesetOptions
    public class TprFilesetOptions: BaseType
    {
        #region members
    ...
    } // class TprFilesetOptions
    
    #endregion

    public static class ListTprFilesetOptionsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<TprFilesetOptions> list,
        ...
        public static List<string> SelectedFields(this List<TprFilesetOptions> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TprFilesetOptions());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TprFilesetOptions> list)
        {

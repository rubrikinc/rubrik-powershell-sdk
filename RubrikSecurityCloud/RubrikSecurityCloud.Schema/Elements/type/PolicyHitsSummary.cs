...
namespace RubrikSecurityCloud.Types
{
    ...
    public class PolicyHitsSummary: BaseType
    {
        ...
        //      C# -> List<AnalyzerResults>? AnalyzerResults
        // GraphQL -> analyzerResults: [AnalyzerResults!]! (type)
        [JsonProperty("analyzerResults")]
        public List<AnalyzerResults>? AnalyzerResults { get; set; }
    ...
    public PolicyHitsSummary Set(
        ...
        List<AnalyzerResults>? AnalyzerResults = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("analyzerResults",false))
        {
            if(this.AnalyzerResults == null) {
                ...
                this.AnalyzerResults = new List<AnalyzerResults>();

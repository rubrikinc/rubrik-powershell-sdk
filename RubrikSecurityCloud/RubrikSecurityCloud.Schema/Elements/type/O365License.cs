...
{
    #region O365License
    public class O365License: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.LicenseDetails != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.LicenseDetails.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.LicenseDetails == null && Exploration.Includes(parent + ".licenseDetails"))
            {
                ...
                this.LicenseDetails.ApplyExploratoryFragment(parent + ".licenseDetails");
            }
        }

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ProtectedObjectsEdge: BaseType
    {
        #region members
    ...
    public static class ListProtectedObjectsEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ProtectedObjectsEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProtectedObjectsEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProtectedObjectsEdge> list)
        {

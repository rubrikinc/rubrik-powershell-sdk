...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListActiveInsightClusterMetadataExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ActiveInsightClusterMetadata> list)
        {
        ...
        public static void SelectForRetrieval(this List<ActiveInsightClusterMetadata> list)
        {

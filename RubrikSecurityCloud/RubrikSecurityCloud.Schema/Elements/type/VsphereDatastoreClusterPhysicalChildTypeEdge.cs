...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereDatastoreClusterPhysicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereDatastoreClusterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatastoreClusterPhysicalChildType));
    ...
    public static class ListVsphereDatastoreClusterPhysicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereDatastoreClusterPhysicalChildTypeEdge();
            list.Add(item);

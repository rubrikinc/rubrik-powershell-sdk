...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereDatastoreClusterPhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereDatastoreClusterPhysicalChildType> Node { get; set; }
    ...
    public VsphereDatastoreClusterPhysicalChildTypeEdge Set(
        RscInterface<VsphereDatastoreClusterPhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereDatastoreClusterPhysicalChildType>();

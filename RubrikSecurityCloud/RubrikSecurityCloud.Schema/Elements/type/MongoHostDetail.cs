...
{
    #region MongoHostDetail
    public class MongoHostDetail: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MongoHostDetail";
    }

    public MongoHostDetail Set(
    ...
    } // class MongoHostDetail
    
    #endregion

    public static class ListMongoHostDetailExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoHostDetail> list,
        ...
        public static List<string> SelectedFields(this List<MongoHostDetail> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongoHostDetail());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongoHostDetail> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasShareDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NasShareDescendantType> Nodes { get; set; }
    ...
    public NasShareDescendantTypeConnection Set(
        RscInterfaceList<NasShareDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NasShareDescendantType>();
    ...
    public static class ListNasShareDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasShareDescendantTypeConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasShareDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NasShareDescendantType> Nodes { get; set; }
    ...
    public NasShareDescendantTypeConnection Set(
        RscInterface<NasShareDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NasShareDescendantType>();

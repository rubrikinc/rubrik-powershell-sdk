...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdVappLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VcdVappLogicalChildType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VcdVappLogicalChildTypeConnection";
    }

    public VcdVappLogicalChildTypeConnection Set(
        RscInterfaceList<VcdVappLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VcdVappLogicalChildType>();
    ...
    public static class ListVcdVappLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdVappLogicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VcdVappLogicalChildTypeConnection> list)
        {

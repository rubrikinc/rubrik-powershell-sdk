...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereComputeClusterPhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereComputeClusterPhysicalChildType> Nodes { get; set; }
    ...
    public VsphereComputeClusterPhysicalChildTypeConnection Set(
        RscInterfaceList<VsphereComputeClusterPhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereComputeClusterPhysicalChildType>();
    ...
    public static class ListVsphereComputeClusterPhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereComputeClusterPhysicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereComputeClusterPhysicalChildTypeConnection> list)
        {

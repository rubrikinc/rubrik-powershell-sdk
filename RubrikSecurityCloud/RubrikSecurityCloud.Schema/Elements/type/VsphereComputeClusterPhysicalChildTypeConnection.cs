...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereComputeClusterPhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<VsphereComputeClusterPhysicalChildType> Nodes { get; set; }
    ...
    public VsphereComputeClusterPhysicalChildTypeConnection Set(
        RscInterface<VsphereComputeClusterPhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<VsphereComputeClusterPhysicalChildType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SlaAssignResult: BaseType
    {
        #region members
    ...
    public static class ListSlaAssignResultExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SlaAssignResult> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SlaAssignResult());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SlaAssignResult> list)
        {

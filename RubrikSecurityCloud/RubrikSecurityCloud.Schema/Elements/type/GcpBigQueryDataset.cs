...
{
    #region GcpBigQueryDataset
 
    public class GcpBigQueryDataset: BaseType, GcpNativeHierarchyObject, GcpNativeProjectDescendantType, GcpNativeProjectLogicalChildType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> GcpBigQueryLocation? Location
        // GraphQL -> location: GcpBigQueryLocation! (enum)
        [JsonProperty("location")]
        public GcpBigQueryLocation? Location { get; set; }
        ...
        //      C# -> List<GcpBigQueryModel>? Models
        // GraphQL -> models: [GcpBigQueryModel!]! (type)
        [JsonProperty("models")]
        public List<GcpBigQueryModel>? Models { get; set; }
        ...
        //      C# -> List<GcpBigQueryRoutine>? Routines
        // GraphQL -> routines: [GcpBigQueryRoutine!]! (type)
        [JsonProperty("routines")]
        public List<GcpBigQueryRoutine>? Routines { get; set; }
        ...
        //      C# -> List<GcpBigQueryTable>? Tables
        // GraphQL -> tables: [GcpBigQueryTable!]! (type)
        [JsonProperty("tables")]
        public List<GcpBigQueryTable>? Tables { get; set; }

        //      C# -> List<GcpBigQueryView>? Views
        // GraphQL -> views: [GcpBigQueryView!]! (type)
        [JsonProperty("views")]
        public List<GcpBigQueryView>? Views { get; set; }
    ...
    public GcpBigQueryDataset Set(
        ...
        List<GcpBigQueryModel>? Models = null,
        ...
        List<GcpBigQueryRoutine>? Routines = null,
        ...
        List<GcpBigQueryTable>? Tables = null,
        List<GcpBigQueryView>? Views = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        // GraphQL -> models: [GcpBigQueryModel!]! (type)
        if (this.Models != null) {
            var fspec = this.Models.AsFieldSpec(conf.Child("models"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        if (this.Routines != null) {
            var fspec = this.Routines.AsFieldSpec(conf.Child("routines"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        // GraphQL -> views: [GcpBigQueryView!]! (type)
        if (this.Views != null) {
            var fspec = this.Views.AsFieldSpec(conf.Child("views"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("location",true))
        {
            if(this.Location == null) {
                ...
                this.Location = new GcpBigQueryLocation();
        ...
        //      C# -> List<GcpBigQueryModel>? Models
        // GraphQL -> models: [GcpBigQueryModel!]! (type)
        if (ec.Includes("models",false))
        {
            if(this.Models == null) {

                this.Models = new List<GcpBigQueryModel>();
                this.Models.ApplyExploratoryFieldSpec(ec.NewChild("models"));
        ...
        else if (this.Models != null && ec.Excludes("models",false))
        {
            this.Models = null;
        }
        //      C# -> PolarisSnapshot? NewestIndexedSnapshot
        ...
        //      C# -> List<GcpBigQueryRoutine>? Routines
        // GraphQL -> routines: [GcpBigQueryRoutine!]! (type)
        if (ec.Includes("routines",false))
        {
            if(this.Routines == null) {

                this.Routines = new List<GcpBigQueryRoutine>();
                this.Routines.ApplyExploratoryFieldSpec(ec.NewChild("routines"));
        ...
        else if (this.Routines != null && ec.Excludes("routines",false))
        {
            this.Routines = null;
        }
        //      C# -> CompactSlaDomain? RscNativeObjectPendingSla
        ...
        if (ec.Includes("tables",false))
        {
            if(this.Tables == null) {
                ...
                this.Tables = new List<GcpBigQueryTable>();
        ...
        //      C# -> List<GcpBigQueryView>? Views
        // GraphQL -> views: [GcpBigQueryView!]! (type)
        if (ec.Includes("views",false))
        {
            if(this.Views == null) {

                this.Views = new List<GcpBigQueryView>();
                this.Views.ApplyExploratoryFieldSpec(ec.NewChild("views"));
        ...
        else if (this.Views != null && ec.Excludes("views",false))
        {
            this.Views = null;
        }
        //      C# -> GenericSnapshotConnection? WorkloadSnapshotConnection
    ...
    public static class ListGcpBigQueryDatasetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpBigQueryDataset> list,
        ...
        public static List<string> SelectedFields(this List<GcpBigQueryDataset> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpBigQueryDataset());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpBigQueryDataset> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "HotAddProxyVmInfoListResponse";
    }
    ...
    public static class ListHotAddProxyVmInfoListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HotAddProxyVmInfoListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<HotAddProxyVmInfoListResponse> list)
        {

...
{
    #region AzureAdServicePrincipal
    public class AzureAdServicePrincipal: BaseType
    {
        #region members

        //      C# -> AzureAdServicePrincipalEnumType? ServicePrincipalType
        // GraphQL -> servicePrincipalType: AzureAdServicePrincipalEnumType! (enum)
        [JsonProperty("servicePrincipalType")]
        public AzureAdServicePrincipalEnumType? ServicePrincipalType { get; set; }
    ...
    public AzureAdServicePrincipal Set(
        AzureAdServicePrincipalEnumType? ServicePrincipalType = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ServicePrincipalType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "servicePrincipalType\n" ;
            } else {
                s += ind + "servicePrincipalType\n" ;
            }
        }
        //      C# -> System.String? AppId
        // GraphQL -> appId: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> AzureAdServicePrincipalEnumType? ServicePrincipalType
        // GraphQL -> servicePrincipalType: AzureAdServicePrincipalEnumType! (enum)
        if (ec.Includes("servicePrincipalType",true))
        {
            if(this.ServicePrincipalType == null) {

                this.ServicePrincipalType = new AzureAdServicePrincipalEnumType();
        ...
        else if (this.ServicePrincipalType != null && ec.Excludes("servicePrincipalType",true))
        {
    ...
    public static class ListAzureAdServicePrincipalExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureAdServicePrincipal> list,
        ...
        public static List<string> SelectedFields(this List<AzureAdServicePrincipal> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureAdServicePrincipal());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureAdServicePrincipal> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostSharePhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HostSharePhysicalChildType> Node { get; set; }
    ...
    public HostSharePhysicalChildTypeEdge Set(
        RscInterface<HostSharePhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HostSharePhysicalChildType>();

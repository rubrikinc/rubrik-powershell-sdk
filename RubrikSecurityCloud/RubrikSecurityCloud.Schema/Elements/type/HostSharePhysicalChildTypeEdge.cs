...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostSharePhysicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HostSharePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostSharePhysicalChildType));
    ...
    public static class ListHostSharePhysicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HostSharePhysicalChildTypeEdge();
            list.Add(item);

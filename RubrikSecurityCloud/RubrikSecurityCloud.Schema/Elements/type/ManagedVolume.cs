...
namespace RubrikSecurityCloud.Types
{
    ...
    public class InlineVars {
        ...
        public RscGqlVars QueuedSnapshotGroupBys { get; set; }

        public RscGqlVars QueuedSnapshots { get; set; }
        ...
        public InlineVars() {
            ...
            Tuple<string, string>[] queuedSnapshotGroupBysArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
                    Tuple.Create("last", "Int"),
                    Tuple.Create("before", "String"),
            ...
            Tuple<string, string>[] queuedSnapshotsArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
                    Tuple.Create("filter", "ManagedVolumeQueuedSnapshotFilterInput"),
                    Tuple.Create("timezoneOffset", "Float"),

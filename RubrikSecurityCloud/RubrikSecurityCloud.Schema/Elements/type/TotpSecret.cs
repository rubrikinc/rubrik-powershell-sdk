...
{
    #region TotpSecret
    public class TotpSecret: BaseType
    {
        #region members
    ...
    public static class ListTotpSecretExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TotpSecret> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TotpSecret());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TotpSecret> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.VcdInstances != null) {
            var fspec = this.VcdInstances.AsFieldSpec(conf.Child("vcdInstances"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<VcdInstanceDetailType>? VcdInstances
        // GraphQL -> vcdInstances: [VcdInstanceDetailType!]! (type)
        if (ec.Includes("vcdInstances",false))
        {
            if(this.VcdInstances == null) {
        ...
        else if (this.VcdInstances != null && ec.Excludes("vcdInstances",false))
        {
            this.VcdInstances = null;
        }
    }
    ...
    public static class ListUpdateVcdInstancesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateVcdInstancesReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateVcdInstancesReply> list)
        {

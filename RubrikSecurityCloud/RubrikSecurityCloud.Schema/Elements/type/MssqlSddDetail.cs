...
{
    #region MssqlSddDetail
    public class MssqlSddDetail: BaseType
    {
        #region members
    ...
    } // class MssqlSddDetail
    
    #endregion

    public static class ListMssqlSddDetailExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlSddDetail> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MssqlSddDetail());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MssqlSddDetail> list)
        {

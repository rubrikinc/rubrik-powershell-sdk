...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereAsyncRequestStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereAsyncRequestStatus> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereAsyncRequestStatus> list)
        {

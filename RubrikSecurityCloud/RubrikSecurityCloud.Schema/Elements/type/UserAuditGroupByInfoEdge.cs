...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUserAuditGroupByInfoEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserAuditGroupByInfoEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<UserAuditGroupByInfoEdge> list)
        {

...
{
    #region MariadbInstanceStatus
    public class MariadbInstanceStatus: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MariadbInstanceStatus";
    }

    public MariadbInstanceStatus Set(
    ...
    } // class MariadbInstanceStatus
    
    #endregion

    public static class ListMariadbInstanceStatusExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MariadbInstanceStatus> list,
        ...
        public static List<string> SelectedFields(this List<MariadbInstanceStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MariadbInstanceStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MariadbInstanceStatus> list)
        {

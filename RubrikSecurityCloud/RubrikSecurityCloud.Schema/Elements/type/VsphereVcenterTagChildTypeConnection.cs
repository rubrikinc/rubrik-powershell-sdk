...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterTagChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<VsphereVcenterTagChildType> Nodes { get; set; }
    ...
    public VsphereVcenterTagChildTypeConnection Set(
        RscInterface<VsphereVcenterTagChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<VsphereVcenterTagChildType>();

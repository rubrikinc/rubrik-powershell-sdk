...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterTagChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereVcenterTagChildType> Nodes { get; set; }
    ...
    public VsphereVcenterTagChildTypeConnection Set(
        RscInterfaceList<VsphereVcenterTagChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereVcenterTagChildType>();
    ...
    public static class ListVsphereVcenterTagChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterTagChildTypeConnection> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongoSource: IFragment, HierarchyObject, CdmHierarchyObject
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.IgnoreSecondaryNodes != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.IgnoreSecondaryNodes.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
            ...
            if (this.SourceNodes != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.SourceNodes.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> CdmMongoSslParams? SslParams
            // GraphQL -> sslParams: CdmMongoSslParams (type)
            if (this.SslParams != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.SslParams.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> List<Operation>? AuthorizedOperations
            // GraphQL -> authorizedOperations: [Operation!]! (enum)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.IgnoreSecondaryNodes == null && Exploration.Includes(parent + ".ignoreSecondaryNodes"))
            {
                ...
                this.IgnoreSecondaryNodes.ApplyExploratoryFragment(parent + ".ignoreSecondaryNodes");
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
            ...
            if (this.SourceNodes == null && Exploration.Includes(parent + ".sourceNodes"))
            {
                ...
                this.SourceNodes.ApplyExploratoryFragment(parent + ".sourceNodes");
            }
            //      C# -> CdmMongoSslParams? SslParams
            // GraphQL -> sslParams: CdmMongoSslParams (type)
            if (this.SslParams == null && Exploration.Includes(parent + ".sslParams"))
            {
                ...
                this.SslParams.ApplyExploratoryFragment(parent + ".sslParams");
            }
            //      C# -> List<Operation>? AuthorizedOperations
            // GraphQL -> authorizedOperations: [Operation!]! (enum)

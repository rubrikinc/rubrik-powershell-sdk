...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "DownloadThreatHuntCsvReply";
    }
    ...
    public static class ListDownloadThreatHuntCsvReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DownloadThreatHuntCsvReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DownloadThreatHuntCsvReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "PendingEvaluationResultsReply";
    }
    ...
    public static class ListPendingEvaluationResultsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PendingEvaluationResultsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<PendingEvaluationResultsReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "AzureSqlManagedInstanceServerConnection";
    }
    ...
    public static class ListAzureSqlManagedInstanceServerConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureSqlManagedInstanceServerConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureSqlManagedInstanceServerConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoCollectionSet: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, MongoDatabaseDescendantType, MongoDatabasePhysicalChildType, MongoSourceDescendantType
    {
        #region members
        ...
        //      C# -> MongoCollectionSetDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: MongoCollectionSetDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public MongoCollectionSetDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> MongoCollectionSetPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: MongoCollectionSetPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public MongoCollectionSetPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MongoCollectionSet";
    }

    public MongoCollectionSet Set(
        ...
        MongoCollectionSetDescendantTypeConnection? DescendantConnection = null,
        ...
        MongoCollectionSetPhysicalChildTypeConnection? PhysicalChildConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollectionSet_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollectionSet_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollectionSet_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollectionSet_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollectionSet_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new MongoCollectionSetDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new MongoCollectionSetPhysicalChildTypeConnection();
    ...
    } // class MongoCollectionSet
    
    #endregion

    public static class ListMongoCollectionSetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MongoCollectionSet> list,
        ...
        public static List<string> SelectedFields(this List<MongoCollectionSet> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongoCollectionSet());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongoCollectionSet> list)
        {

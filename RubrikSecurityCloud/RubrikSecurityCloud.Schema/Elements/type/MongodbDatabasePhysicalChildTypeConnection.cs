...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbDatabasePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<MongodbDatabasePhysicalChildType> Nodes { get; set; }
    ...
    public MongodbDatabasePhysicalChildTypeConnection Set(
        RscInterface<MongodbDatabasePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<MongodbDatabasePhysicalChildType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbDatabasePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MongodbDatabasePhysicalChildType> Nodes { get; set; }
    ...
    public MongodbDatabasePhysicalChildTypeConnection Set(
        RscInterfaceList<MongodbDatabasePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MongodbDatabasePhysicalChildType>();
    ...
    public static class ListMongodbDatabasePhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbDatabasePhysicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongodbDatabasePhysicalChildTypeConnection> list)
        {

...
{
    #region UpdateWebhookStatusReply
    public class UpdateWebhookStatusReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UpdateWebhookStatusReply";
    }

    public UpdateWebhookStatusReply Set(
    ...
    } // class UpdateWebhookStatusReply
    
    #endregion

    public static class ListUpdateWebhookStatusReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<UpdateWebhookStatusReply> list,
        ...
        public static List<string> SelectedFields(this List<UpdateWebhookStatusReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UpdateWebhookStatusReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UpdateWebhookStatusReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "EnableAutomaticFmdUploadReply";
    }
    ...
    public static class ListEnableAutomaticFmdUploadReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<EnableAutomaticFmdUploadReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<EnableAutomaticFmdUploadReply> list)
        {

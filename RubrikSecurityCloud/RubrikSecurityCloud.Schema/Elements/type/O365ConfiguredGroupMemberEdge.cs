...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365ConfiguredGroupMemberEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "O365ConfiguredGroupMemberEdge";
    }
    ...
    public static class ListO365ConfiguredGroupMemberEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365ConfiguredGroupMemberEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365ConfiguredGroupMemberEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365ConfiguredGroupMemberEdge> list)
        {

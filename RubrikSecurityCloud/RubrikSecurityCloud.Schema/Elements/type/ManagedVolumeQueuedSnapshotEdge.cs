...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListManagedVolumeQueuedSnapshotEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeQueuedSnapshotEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeQueuedSnapshotEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.LastSuccessfulSync != null) {
            if (conf.Flat) {
                s += conf.Prefix + "lastSuccessfulSync\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> DateTime? LastSuccessfulSync
        // GraphQL -> lastSuccessfulSync: DateTime (scalar)
        if (ec.Includes("lastSuccessfulSync",true))
        {
            if(this.LastSuccessfulSync == null) {
        ...
        else if (this.LastSuccessfulSync != null && ec.Excludes("lastSuccessfulSync",true))
        {
    ...
    public static class ListGetLastInsightSyncReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetLastInsightSyncReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<GetLastInsightSyncReply> list)
        {

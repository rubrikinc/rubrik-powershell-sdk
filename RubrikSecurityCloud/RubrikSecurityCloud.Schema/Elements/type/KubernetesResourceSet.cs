...
{
    #region KubernetesResourceSet
 
    public class KubernetesResourceSet: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, KubernetesClusterDescendant
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "KubernetesResourceSet";
    }

    public KubernetesResourceSet Set(
    ...
    public static class ListKubernetesResourceSetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesResourceSet> list,
            int indent=0)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesResourceSet());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void Fetch(this List<KubernetesResourceSet> list)
        {

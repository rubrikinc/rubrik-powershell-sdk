...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListExchangeLiveMountEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeLiveMountEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<ExchangeLiveMountEdge> list)
        {

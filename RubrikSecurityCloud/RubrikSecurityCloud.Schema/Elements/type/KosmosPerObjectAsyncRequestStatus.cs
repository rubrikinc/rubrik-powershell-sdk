// KosmosPerObjectAsyncRequestStatus.cs
//
...
{
    #region KosmosPerObjectAsyncRequestStatus
    public class KosmosPerObjectAsyncRequestStatus: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "KosmosPerObjectAsyncRequestStatus";
    }

    public KosmosPerObjectAsyncRequestStatus Set(
    ...
    } // class KosmosPerObjectAsyncRequestStatus
    
    #endregion

    public static class ListKosmosPerObjectAsyncRequestStatusExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KosmosPerObjectAsyncRequestStatus> list,
        ...
        public static List<string> SelectedFields(this List<KosmosPerObjectAsyncRequestStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KosmosPerObjectAsyncRequestStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KosmosPerObjectAsyncRequestStatus> list)
        {

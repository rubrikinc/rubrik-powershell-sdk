...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdOrg: BaseType, CdmHierarchyObject, HierarchyObject, VcdDescendantType, VcdLogicalChildType, VcdTopLevelDescendantType
    {
        #region members
        ...
        //      C# -> VcdOrgDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VcdOrgDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VcdOrgDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VcdOrgLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: VcdOrgLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public VcdOrgLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> VcdOrgLogicalChildTypeConnection? RecoveryLogicalChildConnection
        // GraphQL -> recoveryLogicalChildConnection: VcdOrgLogicalChildTypeConnection! (type)
        [JsonProperty("recoveryLogicalChildConnection")]
        public VcdOrgLogicalChildTypeConnection? RecoveryLogicalChildConnection { get; set; }
    ...
    public VcdOrg Set(
        ...
        VcdOrgDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        VcdOrgLogicalChildTypeConnection? LogicalChildConnection = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        VcdOrgLogicalChildTypeConnection? RecoveryLogicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VcdOrgDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new VcdOrgLogicalChildTypeConnection();
        ...
        if (ec.Includes("recoveryLogicalChildConnection",false))
        {
            if(this.RecoveryLogicalChildConnection == null) {
                ...
                this.RecoveryLogicalChildConnection = new VcdOrgLogicalChildTypeConnection();
    ...
    public static class ListVcdOrgExtensions
    {
        ...
        public static void SelectForRetrieval(this List<VcdOrg> list)
        {

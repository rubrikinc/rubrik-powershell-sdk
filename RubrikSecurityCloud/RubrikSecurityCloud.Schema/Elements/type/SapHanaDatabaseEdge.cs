...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SapHanaDatabaseEdge: BaseType
    {
        #region members
    ...
    public static class ListSapHanaDatabaseEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SapHanaDatabaseEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SapHanaDatabaseEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SapHanaDatabaseEdge> list)
        {

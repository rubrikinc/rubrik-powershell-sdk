...
{
    #region InfrastructureChart
 
    public class InfrastructureChart: BaseType, ReportChartType
    {
        #region members
    ...
    } // class InfrastructureChart
    
    #endregion

    public static class ListInfrastructureChartExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<InfrastructureChart> list,
        ...
        public static List<string> SelectedFields(this List<InfrastructureChart> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new InfrastructureChart());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<InfrastructureChart> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateCloudNativeAzureStorageSettingReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateCloudNativeAzureStorageSettingReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateCloudNativeAzureStorageSettingReply> list)
        {

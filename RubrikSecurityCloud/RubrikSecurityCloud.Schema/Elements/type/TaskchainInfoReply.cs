...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? PlatformConfig
        // GraphQL -> platformConfig: String (scalar)
        if (ec.Includes("platformConfig",true))
        {
            if(this.PlatformConfig == null) {
        ...
        else if (this.PlatformConfig != null && ec.Excludes("platformConfig",true))
        {
    ...
    public static class ListTaskchainInfoReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TaskchainInfoReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<TaskchainInfoReply> list)
        {

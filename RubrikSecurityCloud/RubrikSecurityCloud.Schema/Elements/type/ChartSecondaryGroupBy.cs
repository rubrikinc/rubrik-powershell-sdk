...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListChartSecondaryGroupByExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ChartSecondaryGroupBy> list)
        {
        ...
        public static void SelectForRetrieval(this List<ChartSecondaryGroupBy> list)
        {

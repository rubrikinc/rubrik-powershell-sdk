...
{
    #region IntegrationIngestionStatus
    public class IntegrationIngestionStatus: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "IntegrationIngestionStatus";
    }

    public IntegrationIngestionStatus Set(
    ...
    } // class IntegrationIngestionStatus
    
    #endregion

    public static class ListIntegrationIngestionStatusExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<IntegrationIngestionStatus> list,
        ...
        public static List<string> SelectedFields(this List<IntegrationIngestionStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new IntegrationIngestionStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<IntegrationIngestionStatus> list)
        {

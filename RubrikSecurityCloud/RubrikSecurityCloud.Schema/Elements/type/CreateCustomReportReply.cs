...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateCustomReportReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateCustomReportReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateCustomReportReply> list)
        {

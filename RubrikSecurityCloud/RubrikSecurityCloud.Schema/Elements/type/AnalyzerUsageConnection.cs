...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AnalyzerUsageConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AnalyzerUsageConnection";
    }
    ...
    public static class ListAnalyzerUsageConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnalyzerUsageConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AnalyzerUsageConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AnalyzerUsageConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAppSearchResponseConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AppSearchResponseConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AppSearchResponseConnection> list)
        {

...
{
    #region PostgreSqlDatabase
 
    public class PostgreSqlDatabase: BaseType, CdmHierarchyObject, HierarchyObject, KosmosHierarchyObjectType, KosmosLeafHierarchyObjectType, KosmosParentHierarchyObjectDescendantType, KosmosParentHierarchyObjectPhysicalChildType
    {
        #region members
        ...
        //      C# -> KosmosParentHierarchyObjectType? ParentEntity
        // GraphQL -> parentEntity: KosmosParentHierarchyObjectType! (interface)
        [JsonProperty("parentEntity")]
        public KosmosParentHierarchyObjectType? ParentEntity { get; set; }
        ...
        //      C# -> PostgreSqlDatabaseMetadata? Metadata
        // GraphQL -> metadata: PostgreSQLDatabaseMetadata! (type)
        [JsonProperty("metadata")]
        public PostgreSqlDatabaseMetadata? Metadata { get; set; }
    ...
    public PostgreSqlDatabase Set(
        ...
        KosmosParentHierarchyObjectType? ParentEntity = null,
        ...
        PostgreSqlDatabaseMetadata? Metadata = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ParentEntity != null) {
                var fspec = InterfaceHelper.CompositeAsFieldSpec((BaseType)this.ParentEntity, conf.Child("parentEntity"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 && !trimmedFspec.Contains("{}")) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> KosmosParentHierarchyObjectType? ParentEntity
        // GraphQL -> parentEntity: KosmosParentHierarchyObjectType! (interface)
        if (ec.Includes("parentEntity",false))
        {
            if(this.ParentEntity == null) {

                var impls = new List<KosmosParentHierarchyObjectType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("parentEntity"));
                this.ParentEntity = (KosmosParentHierarchyObjectType)InterfaceHelper.MakeCompositeFromList(impls);
        ...
        else if (this.ParentEntity != null && ec.Excludes("parentEntity",false))
        {
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new PostgreSqlDatabaseMetadata();
    ...
    public static class ListPostgreSqlDatabaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgreSqlDatabase> list,
        ...
        public static List<string> SelectedFields(this List<PostgreSqlDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgreSqlDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgreSqlDatabase> list)
        {

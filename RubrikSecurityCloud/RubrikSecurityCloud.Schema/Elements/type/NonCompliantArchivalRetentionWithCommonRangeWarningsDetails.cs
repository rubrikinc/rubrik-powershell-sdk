...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.MaxArchivalRetentionInDaysExpected != null) {
            if (conf.Flat) {
                s += conf.Prefix + "maxArchivalRetentionInDaysExpected\n" ;
            } else {
        ...
        if (this.MinArchivalRetentionInDaysExpected != null) {
            if (conf.Flat) {
                s += conf.Prefix + "minArchivalRetentionInDaysExpected\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? MaxArchivalRetentionInDaysExpected
        // GraphQL -> maxArchivalRetentionInDaysExpected: Int! (scalar)
        if (ec.Includes("maxArchivalRetentionInDaysExpected",true))
        {
            if(this.MaxArchivalRetentionInDaysExpected == null) {
        ...
        else if (this.MaxArchivalRetentionInDaysExpected != null && ec.Excludes("maxArchivalRetentionInDaysExpected",true))
        {
            this.MaxArchivalRetentionInDaysExpected = null;
        }
        //      C# -> System.Int32? MinArchivalRetentionInDaysExpected
        // GraphQL -> minArchivalRetentionInDaysExpected: Int! (scalar)
        if (ec.Includes("minArchivalRetentionInDaysExpected",true))
        {
            if(this.MinArchivalRetentionInDaysExpected == null) {
        ...
        else if (this.MinArchivalRetentionInDaysExpected != null && ec.Excludes("minArchivalRetentionInDaysExpected",true))
        {
            this.MinArchivalRetentionInDaysExpected = null;
        }
    }
    ...
    public static class ListNonCompliantArchivalRetentionWithCommonRangeWarningsDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NonCompliantArchivalRetentionWithCommonRangeWarningsDetails> list)
        {
        ...
        public static void SelectForRetrieval(this List<NonCompliantArchivalRetentionWithCommonRangeWarningsDetails> list)
        {

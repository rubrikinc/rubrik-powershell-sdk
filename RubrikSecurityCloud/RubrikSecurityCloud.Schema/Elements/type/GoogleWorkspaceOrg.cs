...
{
    #region GoogleWorkspaceOrg
 
    public class GoogleWorkspaceOrg: BaseType, HierarchyObject, PolarisHierarchyObject, SaasAppsOrganization
    {
        #region members
        ...
        //      C# -> List<SaasRbacHierarchyNode>? RbacHierarchyNodes
        // GraphQL -> rbacHierarchyNodes: [SaasRbacHierarchyNode!]! (type)
        [JsonProperty("rbacHierarchyNodes")]
        public List<SaasRbacHierarchyNode>? RbacHierarchyNodes { get; set; }
        ...
        //      C# -> SaasAppsOrgStorageLocations? StorageRegions
        // GraphQL -> storageRegions: SaasAppsOrgStorageLocations! (type)
        [JsonProperty("storageRegions")]
        public SaasAppsOrgStorageLocations? StorageRegions { get; set; }
    ...
    public GoogleWorkspaceOrg()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "GoogleWorkspaceOrg";
    }

    public GoogleWorkspaceOrg Set(
    ...
    ) 
    {
        ...
        if ( RbacHierarchyNodes != null ) {
            this.RbacHierarchyNodes = RbacHierarchyNodes;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> List<SaasRbacHierarchyNode>? RbacHierarchyNodes
        // GraphQL -> rbacHierarchyNodes: [SaasRbacHierarchyNode!]! (type)
        if (this.RbacHierarchyNodes != null) {
            var fspec = this.RbacHierarchyNodes.AsFieldSpec(conf.Child("rbacHierarchyNodes"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "rbacHierarchyNodes" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> CompactSlaDomain? RscNativeObjectPendingSla
        ...
        //      C# -> SaasAppsOrgStorageLocations? StorageRegions
        // GraphQL -> storageRegions: SaasAppsOrgStorageLocations! (type)
        if (this.StorageRegions != null) {
            var fspec = this.StorageRegions.AsFieldSpec(conf.Child("storageRegions"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "storageRegions" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        return s;
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> List<SaasRbacHierarchyNode>? RbacHierarchyNodes
        // GraphQL -> rbacHierarchyNodes: [SaasRbacHierarchyNode!]! (type)
        if (ec.Includes("rbacHierarchyNodes",false))
        {
            if(this.RbacHierarchyNodes == null) {

                this.RbacHierarchyNodes = new List<SaasRbacHierarchyNode>();
                this.RbacHierarchyNodes.ApplyExploratoryFieldSpec(ec.NewChild("rbacHierarchyNodes"));
        ...
        else if (this.RbacHierarchyNodes != null && ec.Excludes("rbacHierarchyNodes",false))
        {
            this.RbacHierarchyNodes = null;
        }
        //      C# -> CompactSlaDomain? RscNativeObjectPendingSla
        // GraphQL -> rscNativeObjectPendingSla: CompactSlaDomain (type)
        ...
        //      C# -> SaasAppsOrgStorageLocations? StorageRegions
        // GraphQL -> storageRegions: SaasAppsOrgStorageLocations! (type)
        if (ec.Includes("storageRegions",false))
        {
            if(this.StorageRegions == null) {

                this.StorageRegions = new SaasAppsOrgStorageLocations();
                this.StorageRegions.ApplyExploratoryFieldSpec(ec.NewChild("storageRegions"));
        ...
        else if (this.StorageRegions != null && ec.Excludes("storageRegions",false))
        {
    ...
    } // class GoogleWorkspaceOrg
    
    #endregion

    public static class ListGoogleWorkspaceOrgExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GoogleWorkspaceOrg> list,
        ...
        public static List<string> SelectedFields(this List<GoogleWorkspaceOrg> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GoogleWorkspaceOrg());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GoogleWorkspaceOrg> list)
        {

// ClusterNodeInstanceProperties.cs
//
...
{
    #region ClusterNodeInstanceProperties
    public class ClusterNodeInstanceProperties: BaseType
    {
        #region members
        ...
        //      C# -> InstanceProperties? InstanceProperties
    ...
    public override string GetGqlTypeName() {
        return "ClusterNodeInstanceProperties";
    }

    public ClusterNodeInstanceProperties Set(
    ...
    } // class ClusterNodeInstanceProperties
    
    #endregion

    public static class ListClusterNodeInstancePropertiesExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ClusterNodeInstanceProperties> list,
        ...
        public static List<string> SelectedFields(this List<ClusterNodeInstanceProperties> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ClusterNodeInstanceProperties());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ClusterNodeInstanceProperties> list)
        {

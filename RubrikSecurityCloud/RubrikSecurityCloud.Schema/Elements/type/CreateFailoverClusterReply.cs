...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateFailoverClusterReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateFailoverClusterReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateFailoverClusterReply> list)
        {

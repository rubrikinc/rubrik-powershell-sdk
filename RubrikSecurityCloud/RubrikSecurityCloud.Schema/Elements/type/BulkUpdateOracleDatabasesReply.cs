...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "BulkUpdateOracleDatabasesReply";
    }
    ...
    public static class ListBulkUpdateOracleDatabasesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BulkUpdateOracleDatabasesReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BulkUpdateOracleDatabasesReply> list)
        {

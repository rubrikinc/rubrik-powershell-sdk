...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.AllVcenterConnectionStatuses != null) {
            var fspec = this.AllVcenterConnectionStatuses.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        if (this.AllVcenterConnectionsInfo != null) {
            var fspec = this.AllVcenterConnectionsInfo.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        if (this.VcdConnectionStatus != null) {
            var fspec = this.VcdConnectionStatus.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> List<VcdVcenterConnectionState>? AllVcenterConnectionStatuses
        // GraphQL -> allVcenterConnectionStatuses: [VcdVcenterConnectionState!]! (type)
        if (this.AllVcenterConnectionStatuses == null && Exploration.Includes(parent + ".allVcenterConnectionStatuses"))
        {
            this.AllVcenterConnectionStatuses = new List<VcdVcenterConnectionState>();
            this.AllVcenterConnectionStatuses.ApplyExploratoryFieldSpec(parent + ".allVcenterConnectionStatuses");
        }
        //      C# -> List<VcdVcenterConnectionInfo>? AllVcenterConnectionsInfo
        // GraphQL -> allVcenterConnectionsInfo: [VcdVcenterConnectionInfo!]! (type)
        if (this.AllVcenterConnectionsInfo == null && Exploration.Includes(parent + ".allVcenterConnectionsInfo"))
        {
            this.AllVcenterConnectionsInfo = new List<VcdVcenterConnectionInfo>();
            this.AllVcenterConnectionsInfo.ApplyExploratoryFieldSpec(parent + ".allVcenterConnectionsInfo");
        }
        //      C# -> Cluster? Cluster
        // GraphQL -> cluster: Cluster! (type)
        ...
        //      C# -> HostConnectionStatus? VcdConnectionStatus
        // GraphQL -> vcdConnectionStatus: HostConnectionStatus (type)
        if (this.VcdConnectionStatus == null && Exploration.Includes(parent + ".vcdConnectionStatus"))
        {
            this.VcdConnectionStatus = new HostConnectionStatus();
            this.VcdConnectionStatus.ApplyExploratoryFieldSpec(parent + ".vcdConnectionStatus");
        }
    }

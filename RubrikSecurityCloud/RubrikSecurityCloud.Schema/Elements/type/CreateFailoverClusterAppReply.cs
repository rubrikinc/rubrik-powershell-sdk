...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateFailoverClusterAppReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateFailoverClusterAppReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateFailoverClusterAppReply> list)
        {

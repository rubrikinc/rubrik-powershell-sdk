...
{
    #region RcvGcpTargetTemplate
 
    public class RcvGcpTargetTemplate: BaseType, TargetTemplate
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RcvGcpTargetTemplate";
    }

    public RcvGcpTargetTemplate Set(
    ...
    } // class RcvGcpTargetTemplate
    
    #endregion

    public static class ListRcvGcpTargetTemplateExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RcvGcpTargetTemplate> list,
        ...
        public static List<string> SelectedFields(this List<RcvGcpTargetTemplate> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RcvGcpTargetTemplate());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RcvGcpTargetTemplate> list)
        {

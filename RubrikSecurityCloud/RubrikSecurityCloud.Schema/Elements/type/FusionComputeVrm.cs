...
{
    #region FusionComputeVrm
 
    public class FusionComputeVrm: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.Boolean? IsRefreshed
        // GraphQL -> isRefreshed: Boolean! (scalar)
        [JsonProperty("isRefreshed")]
        public System.Boolean? IsRefreshed { get; set; }
        ...
        //      C# -> FusionComputeVrmDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: FusionComputeVrmDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public FusionComputeVrmDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> FusionComputeVrmPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: FusionComputeVrmPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public FusionComputeVrmPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public FusionComputeVrm()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeVrm";
    }

    public FusionComputeVrm Set(
        ...
        System.Boolean? IsRefreshed = null,
        ...
        FusionComputeVrmDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        FusionComputeVrmPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.Boolean? IsRefreshed
        // GraphQL -> isRefreshed: Boolean! (scalar)
        if (ec.Includes("isRefreshed",true))
        {
            if(this.IsRefreshed == null) {
        ...
        else if (this.IsRefreshed != null && ec.Excludes("isRefreshed",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new FusionComputeVrmDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new FusionComputeVrmPhysicalChildTypeConnection();
    ...
    } // class FusionComputeVrm
    
    #endregion

    public static class ListFusionComputeVrmExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeVrm> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeVrm> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeVrm());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeVrm> list)
        {

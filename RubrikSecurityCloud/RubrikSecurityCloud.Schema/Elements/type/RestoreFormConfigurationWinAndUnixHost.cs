...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRestoreFormConfigurationWinAndUnixHostExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RestoreFormConfigurationWinAndUnixHost> list)
        {
        ...
        public static void SelectForRetrieval(this List<RestoreFormConfigurationWinAndUnixHost> list)
        {

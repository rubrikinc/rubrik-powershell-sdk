...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class CreateCloudNativeLabelRuleReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.String? LabelRuleId
            // GraphQL -> labelRuleId: String! (scalar)
            if (this.LabelRuleId == null && Exploration.Includes(parent + ".labelRuleId$"))
            {
                this.LabelRuleId = new System.String("FETCH");
            }
        }
    ...
    public static class ListCreateCloudNativeLabelRuleReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new CreateCloudNativeLabelRuleReply();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class InlineVars {
        public RscGqlVars ScheduledReports { get; set; }


        public InlineVars() {
            Tuple<string, string>[] scheduledReportsArgs = {
            ...
            this.ScheduledReports =
                new RscGqlVars(null, scheduledReportsArgs, null, true);
        }
    }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ScheduledReports != null) {
            var fspec = this.ScheduledReports.AsFieldSpec(conf.Child("scheduledReports"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "scheduledReports" + "\n(" + this.Vars.ScheduledReports.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> List<ReportChartType>? Charts
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> ScheduledReportConnection? ScheduledReports
        // GraphQL -> scheduledReports: ScheduledReportConnection! (type)
        if (ec.Includes("scheduledReports",false))
        {
            if(this.ScheduledReports == null) {
        ...
        else if (this.ScheduledReports != null && ec.Excludes("scheduledReports",false))
        {
    ...
    public static class ListCustomReportExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CustomReport> list)
        {
        ...
        public static void SelectForRetrieval(this List<CustomReport> list)
        {

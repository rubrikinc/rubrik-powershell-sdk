...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "ProtectedObjectsConnection";
    }
    ...
    public static class ListProtectedObjectsConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ProtectedObjectsConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ProtectedObjectsConnection> list)
        {

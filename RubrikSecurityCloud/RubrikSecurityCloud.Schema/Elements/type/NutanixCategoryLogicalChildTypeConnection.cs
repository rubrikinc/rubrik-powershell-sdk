...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixCategoryLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NutanixCategoryLogicalChildType> Nodes { get; set; }
    ...
    public NutanixCategoryLogicalChildTypeConnection Set(
        RscInterface<NutanixCategoryLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NutanixCategoryLogicalChildType>();

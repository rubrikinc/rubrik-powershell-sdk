...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixCategoryLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NutanixCategoryLogicalChildType> Nodes { get; set; }
    ...
    public NutanixCategoryLogicalChildTypeConnection Set(
        RscInterfaceList<NutanixCategoryLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NutanixCategoryLogicalChildType>();
    ...
    public static class ListNutanixCategoryLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NutanixCategoryLogicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<NutanixCategoryLogicalChildTypeConnection> list)
        {

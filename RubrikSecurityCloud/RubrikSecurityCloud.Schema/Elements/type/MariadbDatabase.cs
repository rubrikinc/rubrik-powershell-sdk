...
{
    #region MariadbDatabase
 
    public class MariadbDatabase: BaseType, CdmHierarchyObject, HierarchyObject, KosmosHierarchyObjectType, KosmosLeafHierarchyObjectType, KosmosParentHierarchyObjectDescendantType, KosmosParentHierarchyObjectPhysicalChildType
    {
        #region members
        ...
        //      C# -> MariadbDatabaseMetadata? Metadata
        // GraphQL -> metadata: MariadbDatabaseMetadata! (type)
        [JsonProperty("metadata")]
        public MariadbDatabaseMetadata? Metadata { get; set; }
    ...
    public MariadbDatabase Set(
        ...
        MariadbDatabaseMetadata? Metadata = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new MariadbDatabaseMetadata();
    ...
    public static class ListMariadbDatabaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MariadbDatabase> list,
        ...
        public static List<string> SelectedFields(this List<MariadbDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MariadbDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MariadbDatabase> list)
        {

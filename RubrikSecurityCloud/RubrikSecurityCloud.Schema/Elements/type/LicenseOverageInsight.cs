...
{
    #region LicenseOverageInsight
    public class LicenseOverageInsight: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "LicenseOverageInsight";
    }

    public LicenseOverageInsight Set(
    ...
    } // class LicenseOverageInsight
    
    #endregion

    public static class ListLicenseOverageInsightExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<LicenseOverageInsight> list,
        ...
        public static List<string> SelectedFields(this List<LicenseOverageInsight> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new LicenseOverageInsight());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<LicenseOverageInsight> list)
        {

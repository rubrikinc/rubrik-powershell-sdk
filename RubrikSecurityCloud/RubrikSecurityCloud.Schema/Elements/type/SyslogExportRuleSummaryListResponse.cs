// SyslogExportRuleSummaryListResponse.cs
//
...
{
    #region SyslogExportRuleSummaryListResponse
    public class SyslogExportRuleSummaryListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<SyslogExportRuleSummary>? Data
        // GraphQL -> data: [SyslogExportRuleSummary!]! (type)
        [JsonProperty("data")]
        public List<SyslogExportRuleSummary>? Data { get; set; }
    ...
    public SyslogExportRuleSummaryListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<SyslogExportRuleSummary>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<SyslogExportRuleSummary>();
    ...
    public static class ListSyslogExportRuleSummaryListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SyslogExportRuleSummaryListResponse> list,
        ...
        public static List<string> SelectedFields(this List<SyslogExportRuleSummaryListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SyslogExportRuleSummaryListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SyslogExportRuleSummaryListResponse> list)
        {

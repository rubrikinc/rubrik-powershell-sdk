...
{
    #region MysqldbInstanceMetadata
    public class MysqldbInstanceMetadata: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MysqldbInstanceMetadata";
    }

    public MysqldbInstanceMetadata Set(
    ...
    } // class MysqldbInstanceMetadata
    
    #endregion

    public static class ListMysqldbInstanceMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MysqldbInstanceMetadata> list,
        ...
        public static List<string> SelectedFields(this List<MysqldbInstanceMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MysqldbInstanceMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MysqldbInstanceMetadata> list)
        {

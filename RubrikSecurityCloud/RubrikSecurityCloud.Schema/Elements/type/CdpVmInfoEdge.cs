...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCdpVmInfoEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdpVmInfoEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<CdpVmInfoEdge> list)
        {

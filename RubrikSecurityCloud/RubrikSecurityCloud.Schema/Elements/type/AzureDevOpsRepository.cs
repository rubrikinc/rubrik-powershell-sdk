...
{
    #region AzureDevOpsRepository
 
    public class AzureDevOpsRepository: BaseType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public AzureDevOpsRepository Set(
    ...
    public static class ListAzureDevOpsRepositoryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureDevOpsRepository> list,
        ...
        public static List<string> SelectedFields(this List<AzureDevOpsRepository> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureDevOpsRepository());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureDevOpsRepository> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class PostgreSqlDbCluster: BaseType, CdmHierarchyObject, HierarchyObject, KosmosDiscoverableEntityType, KosmosHierarchyObjectType, KosmosParentHierarchyObjectType, KosmosSnappableHierarchyObjectType
    {
        ...
        //      C# -> KosmosParentHierarchyObjectDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: KosmosParentHierarchyObjectDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public KosmosParentHierarchyObjectDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        public List<HostDiscoverableInfo>? HostsInfo { get; set; }
        ...
        //      C# -> KosmosWorkloadLiveMountConnection? LiveMounts
        // GraphQL -> liveMounts: KosmosWorkloadLiveMountConnection! (type)
        [JsonProperty("liveMounts")]
        public KosmosWorkloadLiveMountConnection? LiveMounts { get; set; }
        ...
        //      C# -> PostgreSqlDbClusterMetadata? Metadata
        // GraphQL -> metadata: PostgreSQLDbClusterMetadata! (type)
        [JsonProperty("metadata")]
        public PostgreSqlDbClusterMetadata? Metadata { get; set; }
        ...
        //      C# -> KosmosParentHierarchyObjectPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: KosmosParentHierarchyObjectPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public KosmosParentHierarchyObjectPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
        ...
        //      C# -> PostgresHaClusterInfo? PostgresHaClusterInfo
        // GraphQL -> postgresHaClusterInfo: PostgresHaClusterInfo (type)
        [JsonProperty("postgresHaClusterInfo")]
        public PostgresHaClusterInfo? PostgresHaClusterInfo { get; set; }
        ...
        //      C# -> List<KosmosWorkloadRecoverableRange>? RecoverableRanges
        // GraphQL -> recoverableRanges: [KosmosWorkloadRecoverableRange!]! (type)
        [JsonProperty("recoverableRanges")]
        public List<KosmosWorkloadRecoverableRange>? RecoverableRanges { get; set; }
        ...
        //      C# -> PostgreSqlDbClusterStatus? Status
        // GraphQL -> status: PostgreSQLDbClusterStatus! (type)
        [JsonProperty("status")]
        public PostgreSqlDbClusterStatus? Status { get; set; }

        //      C# -> PostgreSqlDbClusterUserDetails? UserDetails
        // GraphQL -> userDetails: PostgreSQLDbClusterUserDetails! (type)
        [JsonProperty("userDetails")]
        public PostgreSqlDbClusterUserDetails? UserDetails { get; set; }
    ...
    public PostgreSqlDbCluster()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "PostgreSQLDbCluster";
    }

    public PostgreSqlDbCluster Set(
        ...
        PostgreSqlDbClusterMetadata? Metadata = null,
        ...
        KosmosParentHierarchyObjectPhysicalChildTypeConnection? PhysicalChildConnection = null,
        List<PathNode>? PhysicalPath = null,
        PostgresHaClusterInfo? PostgresHaClusterInfo = null,
        DataLocation? PrimaryClusterLocation = null,
        List<KosmosWorkloadRecoverableRange>? RecoverableRanges = null,
        ...
        PostgreSqlDbClusterStatus? Status = null,
        PostgreSqlDbClusterUserDetails? UserDetails = null
    ) 
    {
        ...
        if ( PostgresHaClusterInfo != null ) {
            this.PostgresHaClusterInfo = PostgresHaClusterInfo;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.EntityInfo != null) {
            var fspec = this.EntityInfo.AsFieldSpec(conf.Child("entityInfo"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        //      C# -> PostgresHaClusterInfo? PostgresHaClusterInfo
        // GraphQL -> postgresHaClusterInfo: PostgresHaClusterInfo (type)
        if (this.PostgresHaClusterInfo != null) {
            var fspec = this.PostgresHaClusterInfo.AsFieldSpec(conf.Child("postgresHaClusterInfo"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "postgresHaClusterInfo" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> DataLocation? PrimaryClusterLocation
        ...
        if (this.UserDetails != null) {
            var fspec = this.UserDetails.AsFieldSpec(conf.Child("userDetails"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new KosmosParentHierarchyObjectDescendantTypeConnection();
        ...
        //      C# -> EntityInfo? EntityInfo
        // GraphQL -> entityInfo: EntityInfo! (type)
        if (ec.Includes("entityInfo",false))
        {
            if(this.EntityInfo == null) {

                this.EntityInfo = new EntityInfo();
                this.EntityInfo.ApplyExploratoryFieldSpec(ec.NewChild("entityInfo"));
        ...
        if (ec.Includes("hostsInfo",false))
        {
            if(this.HostsInfo == null) {
                ...
                this.HostsInfo = new List<HostDiscoverableInfo>();
        ...
        if (ec.Includes("liveMounts",false))
        {
            if(this.LiveMounts == null) {
                ...
                this.LiveMounts = new KosmosWorkloadLiveMountConnection();
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new PostgreSqlDbClusterMetadata();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new KosmosParentHierarchyObjectPhysicalChildTypeConnection();
        ...
        //      C# -> PostgresHaClusterInfo? PostgresHaClusterInfo
        // GraphQL -> postgresHaClusterInfo: PostgresHaClusterInfo (type)
        if (ec.Includes("postgresHaClusterInfo",false))
        {
            if(this.PostgresHaClusterInfo == null) {

                this.PostgresHaClusterInfo = new PostgresHaClusterInfo();
                this.PostgresHaClusterInfo.ApplyExploratoryFieldSpec(ec.NewChild("postgresHaClusterInfo"));
        ...
        else if (this.PostgresHaClusterInfo != null && ec.Excludes("postgresHaClusterInfo",false))
        {
            this.PostgresHaClusterInfo = null;
        }
        //      C# -> DataLocation? PrimaryClusterLocation
        // GraphQL -> primaryClusterLocation: DataLocation! (type)
        ...
        if (ec.Includes("recoverableRanges",false))
        {
            if(this.RecoverableRanges == null) {
                ...
                this.RecoverableRanges = new List<KosmosWorkloadRecoverableRange>();
        ...
        if (ec.Includes("status",false))
        {
            if(this.Status == null) {
                ...
                this.Status = new PostgreSqlDbClusterStatus();
        ...
        //      C# -> PostgreSqlDbClusterUserDetails? UserDetails
        // GraphQL -> userDetails: PostgreSQLDbClusterUserDetails! (type)
        if (ec.Includes("userDetails",false))
        {
            if(this.UserDetails == null) {

                this.UserDetails = new PostgreSqlDbClusterUserDetails();
                this.UserDetails.ApplyExploratoryFieldSpec(ec.NewChild("userDetails"));
        ...
        else if (this.UserDetails != null && ec.Excludes("userDetails",false))
        {
    ...
    } // class PostgreSqlDbCluster
    
    #endregion

    public static class ListPostgreSqlDbClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgreSqlDbCluster> list,
        ...
        public static List<string> SelectedFields(this List<PostgreSqlDbCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgreSqlDbCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgreSqlDbCluster> list)
        {

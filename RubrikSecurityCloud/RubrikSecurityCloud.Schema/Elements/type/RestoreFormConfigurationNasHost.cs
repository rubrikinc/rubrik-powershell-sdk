...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRestoreFormConfigurationNasHostExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RestoreFormConfigurationNasHost> list)
        {
        ...
        public static void SelectForRetrieval(this List<RestoreFormConfigurationNasHost> list)
        {

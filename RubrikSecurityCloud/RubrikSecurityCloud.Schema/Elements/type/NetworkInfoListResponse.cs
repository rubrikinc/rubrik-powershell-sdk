...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "NetworkInfoListResponse";
    }
    ...
    public static class ListNetworkInfoListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NetworkInfoListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<NetworkInfoListResponse> list)
        {

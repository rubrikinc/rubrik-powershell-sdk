...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVscvmmDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HyperVscvmmDescendantType> Node { get; set; }
    ...
    public HyperVscvmmDescendantTypeEdge Set(
        RscInterface<HyperVscvmmDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HyperVscvmmDescendantType>();
    ...
    public static class ListHyperVscvmmDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVscvmmDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<HyperVscvmmDescendantTypeEdge> list)
        {

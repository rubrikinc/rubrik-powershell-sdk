...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class NasVolume: IFragment, CdmHierarchyObject, HierarchyObject, NasNamespaceDescendantType, NasNamespaceLogicalChildType, NasSystemDescendantType, NasSystemLogicalChildType
    {
        #region members
        //      C# -> System.String? Id
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.NasNamespace != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.NasNamespace.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> NasSystem? NasSystem
            // GraphQL -> nasSystem: NasSystem! (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int64? SizeUsedInBytes
            // GraphQL -> sizeUsedInBytes: Long! (scalar)
            if (this.SizeUsedInBytes == null && Exploration.Includes(parent + ".sizeUsedInBytes$"))
            {
            ...
            //      C# -> List<System.String>? SnapMirrorLabels
            // GraphQL -> snapMirrorLabels: [String!]! (scalar)
            if (this.SnapMirrorLabels == null && Exploration.Includes(parent + ".snapMirrorLabels$"))
            {
            ...
            if (this.NasNamespace == null && Exploration.Includes(parent + ".nasNamespace"))
            {
                ...
                this.NasNamespace.ApplyExploratoryFragment(parent + ".nasNamespace");
            }
            //      C# -> NasSystem? NasSystem
            // GraphQL -> nasSystem: NasSystem! (type)

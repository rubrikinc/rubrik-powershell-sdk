...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolume: BaseType, CdmHierarchyObject, HierarchyObject, NasNamespaceDescendantType, NasNamespaceLogicalChildType, NasSystemDescendantType, NasSystemLogicalChildType
    {
        #region members
        ...
        //      C# -> System.Int64? SizeUsedInBytes
        // GraphQL -> sizeUsedInBytes: Long! (scalar)
        [JsonProperty("sizeUsedInBytes")]
        public System.Int64? SizeUsedInBytes { get; set; }
        ...
        //      C# -> List<System.String>? SnapMirrorLabels
        // GraphQL -> snapMirrorLabels: [String!]! (scalar)
        [JsonProperty("snapMirrorLabels")]
        public List<System.String>? SnapMirrorLabels { get; set; }
        ...
        //      C# -> NasVolumeDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: NasVolumeDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public NasVolumeDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> NasVolumeLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: NasVolumeLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public NasVolumeLogicalChildTypeConnection? LogicalChildConnection { get; set; }
    ...
    public NasVolume Set(
        ...
        System.Int64? SizeUsedInBytes = null,
        System.Boolean? SlaPauseStatus = null,
        List<System.String>? SnapMirrorLabels = null,
        List<Org>? AllOrgs = null,
        Cluster? Cluster = null,
        NasVolumeDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        NasVolumeLogicalChildTypeConnection? LogicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( SizeUsedInBytes != null ) {
            this.SizeUsedInBytes = SizeUsedInBytes;
        }
        if ( SlaPauseStatus != null ) {
            this.SlaPauseStatus = SlaPauseStatus;
        }
        if ( SnapMirrorLabels != null ) {
            this.SnapMirrorLabels = SnapMirrorLabels;
        }
        if ( AllOrgs != null ) {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasVolume_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasVolume_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasVolume_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasVolume_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasVolume_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
        ...
        //      C# -> System.Int64? SizeUsedInBytes
        // GraphQL -> sizeUsedInBytes: Long! (scalar)
        if (this.SizeUsedInBytes != null) {
            if (conf.Flat) {
                s += conf.Prefix + "sizeUsedInBytes\n" ;
            } else {
                s += ind + "sizeUsedInBytes\n" ;
            }
        }
        //      C# -> System.Boolean? SlaPauseStatus
        // GraphQL -> slaPauseStatus: Boolean! (scalar)
        ...
        //      C# -> List<System.String>? SnapMirrorLabels
        // GraphQL -> snapMirrorLabels: [String!]! (scalar)
        if (this.SnapMirrorLabels != null) {
            if (conf.Flat) {
                s += conf.Prefix + "snapMirrorLabels\n" ;
            } else {
                s += ind + "snapMirrorLabels\n" ;
            }
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int64? SizeUsedInBytes
        // GraphQL -> sizeUsedInBytes: Long! (scalar)
        if (ec.Includes("sizeUsedInBytes",true))
        {
            if(this.SizeUsedInBytes == null) {

                this.SizeUsedInBytes = new System.Int64();
        ...
        else if (this.SizeUsedInBytes != null && ec.Excludes("sizeUsedInBytes",true))
        {
            this.SizeUsedInBytes = null;
        }
        //      C# -> System.Boolean? SlaPauseStatus
        // GraphQL -> slaPauseStatus: Boolean! (scalar)
        ...
        //      C# -> List<System.String>? SnapMirrorLabels
        // GraphQL -> snapMirrorLabels: [String!]! (scalar)
        if (ec.Includes("snapMirrorLabels",true))
        {
            if(this.SnapMirrorLabels == null) {

                this.SnapMirrorLabels = new List<System.String>();
        ...
        else if (this.SnapMirrorLabels != null && ec.Excludes("snapMirrorLabels",true))
        {
            this.SnapMirrorLabels = null;
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new NasVolumeDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new NasVolumeLogicalChildTypeConnection();
    ...
    public static class ListNasVolumeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasVolume> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NasVolume());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NasVolume> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.NasNamespace != null) {
            s += ind + "nasNamespace {\n" + this.NasNamespace.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> NasSystem? NasSystem
        // GraphQL -> nasSystem: NasSystem! (type)
        if (this.NasSystem != null) {
            s += ind + "nasSystem {\n" + this.NasSystem.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Int64? SizeUsedInBytes
        // GraphQL -> sizeUsedInBytes: Long! (scalar)
        if (this.SizeUsedInBytes == null && Exploration.Includes(parent + ".sizeUsedInBytes", true))
        {
        ...
        //      C# -> List<System.String>? SnapMirrorLabels
        // GraphQL -> snapMirrorLabels: [String!]! (scalar)
        if (this.SnapMirrorLabels == null && Exploration.Includes(parent + ".snapMirrorLabels", true))
        {
        ...
        //      C# -> NasNamespace? NasNamespace
        // GraphQL -> nasNamespace: NasNamespace (type)
        if (this.NasNamespace == null && Exploration.Includes(parent + ".nasNamespace"))
        {
            this.NasNamespace = new NasNamespace();
            this.NasNamespace.ApplyExploratoryFieldSpec(parent + ".nasNamespace");
        }
        //      C# -> NasSystem? NasSystem
        // GraphQL -> nasSystem: NasSystem! (type)
        if (this.NasSystem == null && Exploration.Includes(parent + ".nasSystem"))
        {
            ...
            this.NasSystem.ApplyExploratoryFieldSpec(parent + ".nasSystem");
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)

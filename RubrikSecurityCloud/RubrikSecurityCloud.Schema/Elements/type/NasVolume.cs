...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int64? SizeUsedInBytes
        // GraphQL -> sizeUsedInBytes: Long! (scalar)
        if (this.SizeUsedInBytes == null && ec.Includes("sizeUsedInBytes",true))
        {
        ...
        //      C# -> List<System.String>? SnapMirrorLabels
        // GraphQL -> snapMirrorLabels: [String!]! (scalar)
        if (this.SnapMirrorLabels == null && ec.Includes("snapMirrorLabels",true))
        {
        ...
        //      C# -> NasNamespace? NasNamespace
        // GraphQL -> nasNamespace: NasNamespace (type)
        if (this.NasNamespace == null && ec.Includes("nasNamespace",false))
        {

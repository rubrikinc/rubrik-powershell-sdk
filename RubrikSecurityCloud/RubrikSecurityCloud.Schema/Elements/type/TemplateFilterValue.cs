...
{
    #region TemplateFilterValue
    public class TemplateFilterValue: BaseType
    {
        #region members
    ...
    public TemplateFilterValue Set(
    ...
    } // class TemplateFilterValue
    
    #endregion

    public static class ListTemplateFilterValueExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<TemplateFilterValue> list,
        ...
        public static List<string> SelectedFields(this List<TemplateFilterValue> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TemplateFilterValue());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TemplateFilterValue> list)
        {

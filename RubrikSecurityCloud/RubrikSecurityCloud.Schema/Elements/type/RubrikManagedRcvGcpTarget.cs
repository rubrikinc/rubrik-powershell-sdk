...
{
    #region RubrikManagedRcvGcpTarget
 
    public class RubrikManagedRcvGcpTarget: BaseType, Target
    {
        #region members
        ...
        //      C# -> System.String? ExocloudId
        // GraphQL -> exocloudId: String! (scalar)
        [JsonProperty("exocloudId")]
        public System.String? ExocloudId { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "RubrikManagedRcvGcpTarget";
    }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? ExocloudId
        // GraphQL -> exocloudId: String! (scalar)
        if (this.ExocloudId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "exocloudId\n" ;
            } else {
                s += ind + "exocloudId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? ExocloudId
        // GraphQL -> exocloudId: String! (scalar)
        if (ec.Includes("exocloudId",true))
        {
            if(this.ExocloudId == null) {

                this.ExocloudId = "FETCH";
        ...
        else if (this.ExocloudId != null && ec.Excludes("exocloudId",true))
        {
            this.ExocloudId = null;
        }
        //      C# -> System.Int32? FailedTasks
        // GraphQL -> failedTasks: Int (scalar)
    ...
    } // class RubrikManagedRcvGcpTarget
    
    #endregion

    public static class ListRubrikManagedRcvGcpTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RubrikManagedRcvGcpTarget> list,
        ...
        public static List<string> SelectedFields(this List<RubrikManagedRcvGcpTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RubrikManagedRcvGcpTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RubrikManagedRcvGcpTarget> list)
        {

// PatchPostgresDbClusterResponse.cs
//
...
{
    #region PatchPostgresDbClusterResponse
    public class PatchPostgresDbClusterResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PatchPostgresDbClusterResponse";
    }

    public PatchPostgresDbClusterResponse Set(
    ...
    } // class PatchPostgresDbClusterResponse
    
    #endregion

    public static class ListPatchPostgresDbClusterResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PatchPostgresDbClusterResponse> list,
        ...
        public static List<string> SelectedFields(this List<PatchPostgresDbClusterResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PatchPostgresDbClusterResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PatchPostgresDbClusterResponse> list)
        {

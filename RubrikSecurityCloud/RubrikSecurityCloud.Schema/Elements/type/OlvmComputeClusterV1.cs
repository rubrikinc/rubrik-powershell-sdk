...
{
    #region OlvmComputeClusterV1
 
    public class OlvmComputeClusterV1: BaseType, CdmHierarchyObject, HierarchyObject, OlvmDatacenterDescendant, OlvmDatacenterPhysicalChildType, OlvmManagerDescendant, OlvmManagerPhysicalChildType
    {
        #region members
        ...
        //      C# -> System.String? ComputerClusterName
        // GraphQL -> computerClusterName: String! (scalar)
        [JsonProperty("computerClusterName")]
        public System.String? ComputerClusterName { get; set; }
        ...
        //      C# -> OlvmComputeClusterDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: OlvmComputeClusterDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public OlvmComputeClusterDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> OlvmComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: OlvmComputeClusterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public OlvmComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public OlvmComputeClusterV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "OlvmComputeClusterV1";
    }

    public OlvmComputeClusterV1 Set(
        ...
        System.String? ComputerClusterName = null,
        ...
        OlvmComputeClusterDescendantConnection? DescendantConnection = null,
        ...
        OlvmComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? ComputerClusterName
        // GraphQL -> computerClusterName: String! (scalar)
        if (this.ComputerClusterName != null) {
            if (conf.Flat) {
                s += conf.Prefix + "computerClusterName\n" ;
            } else {
                s += ind + "computerClusterName\n" ;
            }
        }
        //      C# -> System.String? DatacenterId
        // GraphQL -> datacenterId: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? ComputerClusterName
        // GraphQL -> computerClusterName: String! (scalar)
        if (ec.Includes("computerClusterName",true))
        {
            if(this.ComputerClusterName == null) {

                this.ComputerClusterName = "FETCH";
        ...
        else if (this.ComputerClusterName != null && ec.Excludes("computerClusterName",true))
        {
            this.ComputerClusterName = null;
        }
        //      C# -> System.String? DatacenterId
        // GraphQL -> datacenterId: String! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new OlvmComputeClusterDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new OlvmComputeClusterPhysicalChildTypeConnection();
    ...
    } // class OlvmComputeClusterV1
    
    #endregion

    public static class ListOlvmComputeClusterV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmComputeClusterV1> list,
        ...
        public static List<string> SelectedFields(this List<OlvmComputeClusterV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmComputeClusterV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmComputeClusterV1> list)
        {

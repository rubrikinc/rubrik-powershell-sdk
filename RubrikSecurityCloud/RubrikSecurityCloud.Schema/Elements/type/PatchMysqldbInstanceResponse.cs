// PatchMysqldbInstanceResponse.cs
//
...
{
    #region PatchMysqldbInstanceResponse
    public class PatchMysqldbInstanceResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PatchMysqldbInstanceResponse";
    }

    public PatchMysqldbInstanceResponse Set(
    ...
    } // class PatchMysqldbInstanceResponse
    
    #endregion

    public static class ListPatchMysqldbInstanceResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PatchMysqldbInstanceResponse> list,
        ...
        public static List<string> SelectedFields(this List<PatchMysqldbInstanceResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PatchMysqldbInstanceResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PatchMysqldbInstanceResponse> list)
        {

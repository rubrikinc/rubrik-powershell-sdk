...
{
    #region ProxmoxClusterV1
 
    public class ProxmoxClusterV1: BaseType, CdmHierarchyObject, HierarchyObject, ProxmoxEnvironmentDescendant, ProxmoxEnvironmentPhysicalChildType
    {
        #region members
        ...
        //      C# -> ProxmoxClusterDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: ProxmoxClusterDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public ProxmoxClusterDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> ProxmoxClusterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: ProxmoxClusterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public ProxmoxClusterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public ProxmoxClusterV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "ProxmoxClusterV1";
    }

    public ProxmoxClusterV1 Set(
        ...
        ProxmoxClusterDescendantConnection? DescendantConnection = null,
        ...
        ProxmoxClusterPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ProxmoxClusterDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new ProxmoxClusterPhysicalChildTypeConnection();
    ...
    } // class ProxmoxClusterV1
    
    #endregion

    public static class ListProxmoxClusterV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxClusterV1> list,
        ...
        public static List<string> SelectedFields(this List<ProxmoxClusterV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProxmoxClusterV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProxmoxClusterV1> list)
        {

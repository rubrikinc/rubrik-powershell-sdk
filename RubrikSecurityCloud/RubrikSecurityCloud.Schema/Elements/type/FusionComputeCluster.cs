...
{
    #region FusionComputeCluster
 
    public class FusionComputeCluster: BaseType, CdmHierarchyObject, FusionComputeSiteDescendant, FusionComputeSitePhysicalChildType, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? FcClusterId
        // GraphQL -> fcClusterId: String! (scalar)
        [JsonProperty("fcClusterId")]
        public System.String? FcClusterId { get; set; }
        ...
        //      C# -> System.String? VrmId
        // GraphQL -> vrmId: String! (scalar)
        [JsonProperty("vrmId")]
        public System.String? VrmId { get; set; }
        ...
        //      C# -> FusionComputeClusterDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: FusionComputeClusterDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public FusionComputeClusterDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> FusionComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: FusionComputeClusterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public FusionComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public FusionComputeCluster()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeCluster";
    }

    public FusionComputeCluster Set(
        ...
        System.String? FcClusterId = null,
        ...
        System.String? VrmId = null,
        List<Org>? AllOrgs = null,
        List<AssignedRscTag>? AllTags = null,
        Cluster? Cluster = null,
        List<CrossAccountReplicatedObjectInfo>? CrossAccountReplicatedObjectInfos = null,
        FusionComputeClusterDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        FusionComputeClusterPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? FcClusterId
        // GraphQL -> fcClusterId: String! (scalar)
        if (this.FcClusterId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "fcClusterId\n" ;
            } else {
                s += ind + "fcClusterId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? FcClusterId
        // GraphQL -> fcClusterId: String! (scalar)
        if (ec.Includes("fcClusterId",true))
        {
            if(this.FcClusterId == null) {

                this.FcClusterId = "FETCH";
        ...
        else if (this.FcClusterId != null && ec.Excludes("fcClusterId",true))
        {
            this.FcClusterId = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
        ...
        else if (this.VrmId != null && ec.Excludes("vrmId",true))
        {
            this.VrmId = null;
        }
        //      C# -> List<Org>? AllOrgs
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new FusionComputeClusterDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new FusionComputeClusterPhysicalChildTypeConnection();
    ...
    } // class FusionComputeCluster
    
    #endregion

    public static class ListFusionComputeClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeCluster> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeCluster> list)
        {

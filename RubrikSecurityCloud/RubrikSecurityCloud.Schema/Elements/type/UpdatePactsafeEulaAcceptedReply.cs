...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.IsValidSignature != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isValidSignature\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.Boolean? IsValidSignature
        // GraphQL -> isValidSignature: Boolean! (scalar)
        if (ec.Includes("isValidSignature",true))
        {
            if(this.IsValidSignature == null) {
        ...
        else if (this.IsValidSignature != null && ec.Excludes("isValidSignature",true))
        {
    ...
    public static class ListUpdatePactsafeEulaAcceptedReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdatePactsafeEulaAcceptedReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdatePactsafeEulaAcceptedReply> list)
        {

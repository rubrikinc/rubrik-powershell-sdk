...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class ExchangeDag: IFragment, CdmHierarchyObject, HierarchyObject
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int32? TotalHosts
            // GraphQL -> totalHosts: Int! (scalar)
            if (this.TotalHosts == null && Exploration.Includes(parent + ".totalHosts$"))
            {

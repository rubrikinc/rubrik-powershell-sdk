...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ExchangeDag: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? BackupPreference
        // GraphQL -> backupPreference: String! (scalar)
        [JsonProperty("backupPreference")]
        public System.String? BackupPreference { get; set; }
        ...
        //      C# -> System.Int32? TotalHosts
        // GraphQL -> totalHosts: Int! (scalar)
        [JsonProperty("totalHosts")]
        public System.Int32? TotalHosts { get; set; }
        ...
        //      C# -> ExchangeDagDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: ExchangeDagDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public ExchangeDagDescendantTypeConnection? DescendantConnection { get; set; }
    ...
    public ExchangeDag Set(
        ...
        System.String? BackupPreference = null,
        ...
        System.Int32? TotalHosts = null,
        List<Org>? AllOrgs = null,
        Cluster? Cluster = null,
        ExchangeDagDescendantTypeConnection? DescendantConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDag_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDag_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDag_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDag_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDag_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? BackupPreference
        ...
        //      C# -> System.Int32? TotalHosts
        // GraphQL -> totalHosts: Int! (scalar)
        if (this.TotalHosts != null) {
            if (conf.Flat) {
                s += conf.Prefix + "totalHosts\n" ;
            } else {
                s += ind + "totalHosts\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? TotalHosts
        // GraphQL -> totalHosts: Int! (scalar)
        if (ec.Includes("totalHosts",true))
        {
            if(this.TotalHosts == null) {

                this.TotalHosts = Int32.MinValue;
        ...
        else if (this.TotalHosts != null && ec.Excludes("totalHosts",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ExchangeDagDescendantTypeConnection();
    ...
    public static class ListExchangeDagExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeDag> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ExchangeDag());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ExchangeDag> list)
        {

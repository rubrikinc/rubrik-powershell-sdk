...
{
    #region TprConfiguration
    public class TprConfiguration: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "TprConfiguration";
    }

    public TprConfiguration Set(
    ...
    } // class TprConfiguration
    
    #endregion

    public static class ListTprConfigurationExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TprConfiguration> list)
        {

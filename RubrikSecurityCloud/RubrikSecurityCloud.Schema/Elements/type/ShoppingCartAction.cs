...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ShoppingCartAction: BaseType, ActionTypes
    {
        #region members
    ...
    public static class ListShoppingCartActionExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ShoppingCartAction> list,
        ...
        public static List<string> SelectedFields(this List<ShoppingCartAction> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ShoppingCartAction());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ShoppingCartAction> list)
        {

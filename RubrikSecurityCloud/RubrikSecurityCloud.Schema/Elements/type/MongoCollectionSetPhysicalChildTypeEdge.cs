...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoCollectionSetPhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MongoCollectionSetPhysicalChildType> Node { get; set; }
    ...
    public MongoCollectionSetPhysicalChildTypeEdge Set(
        RscInterface<MongoCollectionSetPhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MongoCollectionSetPhysicalChildType>();

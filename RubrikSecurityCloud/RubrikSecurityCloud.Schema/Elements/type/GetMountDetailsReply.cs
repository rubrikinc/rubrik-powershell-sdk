...
namespace RubrikSecurityCloud.Types
{
    ...
    public class GetMountDetailsReply: BaseType
    {
        ...
        //      C# -> LiveMountDetails? MountDetails
        // GraphQL -> mountDetails: LiveMountDetails (type)
        [JsonProperty("mountDetails")]
        public LiveMountDetails? MountDetails { get; set; }
    ...
    public GetMountDetailsReply Set(
        LiveMountDetails? MountDetails = null
    ) 
    {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.MountDetails != null) {
            var fspec = this.MountDetails.AsFieldSpec(conf.Child("mountDetails"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> LiveMountDetails? MountDetails
        // GraphQL -> mountDetails: LiveMountDetails (type)
        if (ec.Includes("mountDetails",false))
        {
            if(this.MountDetails == null) {

                this.MountDetails = new LiveMountDetails();
        ...
        else if (this.MountDetails != null && ec.Excludes("mountDetails",false))
        {
    ...
    public static class ListGetMountDetailsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetMountDetailsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<GetMountDetailsReply> list)
        {

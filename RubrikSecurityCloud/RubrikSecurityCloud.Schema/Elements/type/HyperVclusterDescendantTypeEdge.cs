// HyperVclusterDescendantTypeEdge.cs
//
...
{
    #region HyperVclusterDescendantTypeEdge
    public class HyperVclusterDescendantTypeEdge: BaseType
    {
        #region members
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HyperVclusterDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class HyperVclusterDescendantTypeEdge
    
    #endregion

    public static class ListHyperVclusterDescendantTypeEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HyperVclusterDescendantTypeEdge> list,
        ...
        public static List<string> SelectedFields(this List<HyperVclusterDescendantTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HyperVclusterDescendantTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HyperVclusterDescendantTypeEdge> list)
        {

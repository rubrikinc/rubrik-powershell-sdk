...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NodeStatusListResponse: BaseType
    {
        #region members
    ...
    public static class ListNodeStatusListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NodeStatusListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NodeStatusListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NodeStatusListResponse> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoCollectionSetDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MongoCollectionSetDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MongoCollectionSetDescendantTypeConnection";
    }

    public MongoCollectionSetDescendantTypeConnection Set(
        RscInterfaceList<MongoCollectionSetDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MongoCollectionSetDescendantType>();
    ...
    public static class ListMongoCollectionSetDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoCollectionSetDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongoCollectionSetDescendantTypeConnection> list)
        {

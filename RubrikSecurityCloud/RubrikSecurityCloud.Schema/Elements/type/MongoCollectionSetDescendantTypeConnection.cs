...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoCollectionSetDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<MongoCollectionSetDescendantType> Nodes { get; set; }
    ...
    public MongoCollectionSetDescendantTypeConnection Set(
        RscInterface<MongoCollectionSetDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<MongoCollectionSetDescendantType>();

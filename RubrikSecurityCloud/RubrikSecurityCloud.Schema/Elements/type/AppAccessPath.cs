...
{
    #region AppAccessPath
    public class AppAccessPath: BaseType
    {
        #region members
    ...
    public static class ListAppAccessPathExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AppAccessPath> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AppAccessPath());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AppAccessPath> list)
        {

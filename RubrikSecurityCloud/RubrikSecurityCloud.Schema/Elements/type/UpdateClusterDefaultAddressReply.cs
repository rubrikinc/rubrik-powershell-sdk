...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateClusterDefaultAddressReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateClusterDefaultAddressReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateClusterDefaultAddressReply> list)
        {

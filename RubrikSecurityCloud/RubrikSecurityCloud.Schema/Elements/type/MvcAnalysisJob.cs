...
{
    #region MvcAnalysisJob
    public class MvcAnalysisJob: BaseType
    {
        #region members
    ...
    } // class MvcAnalysisJob
    
    #endregion

    public static class ListMvcAnalysisJobExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MvcAnalysisJob> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MvcAnalysisJob());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MvcAnalysisJob> list)
        {

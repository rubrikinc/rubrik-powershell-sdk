// SaaSorgTprReqChangesTemplate.cs
//
...
{
    #region SaaSorgTprReqChangesTemplate
 
    public class SaaSorgTprReqChangesTemplate: BaseType, RequestedChangesTemplate
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SaaSOrgTprReqChangesTemplate";
    }

    public SaaSorgTprReqChangesTemplate Set(
    ...
    } // class SaaSorgTprReqChangesTemplate
    
    #endregion

    public static class ListSaaSorgTprReqChangesTemplateExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SaaSorgTprReqChangesTemplate> list,
        ...
        public static List<string> SelectedFields(this List<SaaSorgTprReqChangesTemplate> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SaaSorgTprReqChangesTemplate());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SaaSorgTprReqChangesTemplate> list)
        {

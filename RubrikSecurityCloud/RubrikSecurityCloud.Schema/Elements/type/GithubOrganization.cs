...
namespace RubrikSecurityCloud.Types
{
    ...
    public class GithubOrganization: BaseType, HierarchyObject, PolarisHierarchyObject
    {
        #region members
        ...
        //      C# -> DevOpsCloudNativeExocompute? Exocompute
        // GraphQL -> exocompute: DevOpsCloudNativeExocompute (type)
        [JsonProperty("exocompute")]
        public DevOpsCloudNativeExocompute? Exocompute { get; set; }
    ...
    public GithubOrganization Set(
        ...
        DevOpsCloudNativeExocompute? Exocompute = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> DevOpsCloudNativeExocompute? Exocompute
        // GraphQL -> exocompute: DevOpsCloudNativeExocompute (type)
        if (this.Exocompute != null) {
            var fspec = this.Exocompute.AsFieldSpec(conf.Child("exocompute"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> DevOpsCloudNativeExocompute? Exocompute
        // GraphQL -> exocompute: DevOpsCloudNativeExocompute (type)
        if (ec.Includes("exocompute",false))
        {
            if(this.Exocompute == null) {

                this.Exocompute = new DevOpsCloudNativeExocompute();
                this.Exocompute.ApplyExploratoryFieldSpec(ec.NewChild("exocompute"));
        ...
        else if (this.Exocompute != null && ec.Excludes("exocompute",false))
        {
            this.Exocompute = null;
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)
    ...
    public static class ListGithubOrganizationExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GithubOrganization> list,
        ...
        public static List<string> SelectedFields(this List<GithubOrganization> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GithubOrganization());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GithubOrganization> list)
        {

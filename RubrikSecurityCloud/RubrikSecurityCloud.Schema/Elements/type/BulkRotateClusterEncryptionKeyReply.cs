// BulkRotateClusterEncryptionKeyReply.cs
//
...
{
    #region BulkRotateClusterEncryptionKeyReply
    public class BulkRotateClusterEncryptionKeyReply: BaseType
    {
        #region members
    ...
    } // class BulkRotateClusterEncryptionKeyReply
    
    #endregion

    public static class ListBulkRotateClusterEncryptionKeyReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BulkRotateClusterEncryptionKeyReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BulkRotateClusterEncryptionKeyReply> list)
        {

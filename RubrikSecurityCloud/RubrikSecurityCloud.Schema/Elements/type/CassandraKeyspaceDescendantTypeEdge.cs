...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CassandraKeyspaceDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<CassandraKeyspaceDescendantType> Node { get; set; }
    ...
    public CassandraKeyspaceDescendantTypeEdge Set(
        RscInterface<CassandraKeyspaceDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<CassandraKeyspaceDescendantType>();
    ...
    public static class ListCassandraKeyspaceDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraKeyspaceDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<CassandraKeyspaceDescendantTypeEdge> list)
        {

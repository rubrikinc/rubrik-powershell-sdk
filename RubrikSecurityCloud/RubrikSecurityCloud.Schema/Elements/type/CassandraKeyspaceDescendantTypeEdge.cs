...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class CassandraKeyspaceDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (CassandraKeyspaceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(CassandraKeyspaceDescendantType));
    ...
    public static class ListCassandraKeyspaceDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new CassandraKeyspaceDescendantTypeEdge();
            list.Add(item);

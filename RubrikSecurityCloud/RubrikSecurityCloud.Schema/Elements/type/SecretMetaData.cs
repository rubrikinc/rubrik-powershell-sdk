...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SecretMetaData: BaseType
    {
        #region members
    ...
    public static class ListSecretMetaDataExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SecretMetaData> list)
        {
        ...
        public static void SelectForRetrieval(this List<SecretMetaData> list)
        {

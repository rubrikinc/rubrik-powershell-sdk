...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateCloudNativeAwsStorageSettingReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateCloudNativeAwsStorageSettingReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateCloudNativeAwsStorageSettingReply> list)
        {

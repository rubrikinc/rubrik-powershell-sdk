...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereComputeClusterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereComputeClusterDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereComputeClusterDescendantTypeConnection";
    }

    public VsphereComputeClusterDescendantTypeConnection Set(
        RscInterfaceList<VsphereComputeClusterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereComputeClusterDescendantType>();
    ...
    public static class ListVsphereComputeClusterDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereComputeClusterDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereComputeClusterDescendantTypeConnection> list)
        {

...
{
    #region CnpCloudUsage
    public class CnpCloudUsage: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CnpCloudUsage";
    }

    public CnpCloudUsage Set(
    ...
    public static class ListCnpCloudUsageExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CnpCloudUsage> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CnpCloudUsage());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CnpCloudUsage> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VsphereVcenterLogicalChildType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereVcenterLogicalChildTypeConnection";
    }

    public VsphereVcenterLogicalChildTypeConnection Set(
        RscInterfaceList<VsphereVcenterLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VsphereVcenterLogicalChildType>();
    ...
    public static class ListVsphereVcenterLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterLogicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereVcenterLogicalChildTypeConnection> list)
        {

...
{
    #region AlertInfo
    public class AlertInfo: BaseType
    {
        #region members
    ...
    public static class ListAlertInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AlertInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<AlertInfo> list)
        {

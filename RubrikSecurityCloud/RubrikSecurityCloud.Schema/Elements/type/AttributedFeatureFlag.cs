...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAttributedFeatureFlagExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AttributedFeatureFlag> list)
        {
        ...
        public static void SelectForRetrieval(this List<AttributedFeatureFlag> list)
        {

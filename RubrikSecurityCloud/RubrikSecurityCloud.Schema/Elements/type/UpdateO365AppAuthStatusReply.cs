...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateO365AppAuthStatusReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateO365AppAuthStatusReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateO365AppAuthStatusReply> list)
        {

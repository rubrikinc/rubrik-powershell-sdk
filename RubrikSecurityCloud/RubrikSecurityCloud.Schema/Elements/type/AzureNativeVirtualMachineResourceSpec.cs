// AzureNativeVirtualMachineResourceSpec.cs
//
...
{
    #region AzureNativeVirtualMachineResourceSpec
    public class AzureNativeVirtualMachineResourceSpec: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureNativeVirtualMachineResourceSpec";
    }

    public AzureNativeVirtualMachineResourceSpec Set(
    ...
    } // class AzureNativeVirtualMachineResourceSpec
    
    #endregion

    public static class ListAzureNativeVirtualMachineResourceSpecExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureNativeVirtualMachineResourceSpec> list,
        ...
        public static List<string> SelectedFields(this List<AzureNativeVirtualMachineResourceSpec> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureNativeVirtualMachineResourceSpec());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureNativeVirtualMachineResourceSpec> list)
        {

...
{
    #region SplunkIntegrationConfig
    public class SplunkIntegrationConfig: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SplunkIntegrationConfig";
    }

    public SplunkIntegrationConfig Set(
        SplunkIntegrationConfigType? ConfigType = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("configType",true))
        {
            if(this.ConfigType == null) {
                ...
                this.ConfigType = new SplunkIntegrationConfigType();
    ...
    public static class ListSplunkIntegrationConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SplunkIntegrationConfig> list,
        ...
        public static List<string> SelectedFields(this List<SplunkIntegrationConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SplunkIntegrationConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SplunkIntegrationConfig> list)
        {

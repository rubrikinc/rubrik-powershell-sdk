...
{
    #region Dynamics365Organization
 
    public class Dynamics365Organization: BaseType, HierarchyObject, PolarisHierarchyObject, SaasAppsOrganization
    {
        #region members
    ...
    public Dynamics365Organization()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "Dynamics365Organization";
    }

    public Dynamics365Organization Set(
    ...
    } // class Dynamics365Organization
    
    #endregion

    public static class ListDynamics365OrganizationExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<Dynamics365Organization> list,
        ...
        public static List<string> SelectedFields(this List<Dynamics365Organization> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new Dynamics365Organization());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<Dynamics365Organization> list)
        {

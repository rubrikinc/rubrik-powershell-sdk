...
{
    #region PureStorageArrayV1
 
    public class PureStorageArrayV1: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> PureStorageArrayDescendantV1Connection? DescendantConnection
        // GraphQL -> descendantConnection: PureStorageArrayDescendantV1Connection! (type)
        [JsonProperty("descendantConnection")]
        public PureStorageArrayDescendantV1Connection? DescendantConnection { get; set; }
        ...
        //      C# -> PureStorageArrayLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: PureStorageArrayLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public PureStorageArrayLogicalChildTypeConnection? LogicalChildConnection { get; set; }
    ...
    public PureStorageArrayV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "PureStorageArrayV1";
    }

    public PureStorageArrayV1 Set(
        ...
        PureStorageArrayDescendantV1Connection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        PureStorageArrayLogicalChildTypeConnection? LogicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new PureStorageArrayDescendantV1Connection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new PureStorageArrayLogicalChildTypeConnection();
    ...
    } // class PureStorageArrayV1
    
    #endregion

    public static class ListPureStorageArrayV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageArrayV1> list,
        ...
        public static List<string> SelectedFields(this List<PureStorageArrayV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PureStorageArrayV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PureStorageArrayV1> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CdmWorkloadSnapshotConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmWorkloadSnapshotConnection";
    }
    ...
    public static class ListCdmWorkloadSnapshotConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmWorkloadSnapshotConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmWorkloadSnapshotConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmWorkloadSnapshotConnection> list)
        {

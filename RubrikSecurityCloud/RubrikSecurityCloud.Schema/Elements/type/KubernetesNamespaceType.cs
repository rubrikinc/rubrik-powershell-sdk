...
{
    #region KubernetesNamespaceType
 
    public class KubernetesNamespaceType: BaseType, CdmHierarchyObject, HierarchyObject, KubernetesClusterDescendant, KubernetesLabelDescendant
    {
        #region members
        ...
        public System.String? K8sClusterName { get; set; }
        ...
        //      C# -> KubernetesNamespaceDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: KubernetesNamespaceDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public KubernetesNamespaceDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> KubernetesVirtualMachineConnection? KubernetesDescendantVirtualMachines
        // GraphQL -> kubernetesDescendantVirtualMachines: KubernetesVirtualMachineConnection! (type)
        [JsonProperty("kubernetesDescendantVirtualMachines")]
        public KubernetesVirtualMachineConnection? KubernetesDescendantVirtualMachines { get; set; }
    ...
    public class InlineVars {
        ...
        public RscGqlVars KubernetesDescendantVirtualMachines { get; set; }
        ...
        public InlineVars() {
            ...
            this.KubernetesDescendantVirtualMachines =
                new RscGqlVars(null, kubernetesDescendantVirtualMachinesArgs, null, true);
        }
    }

    public KubernetesNamespaceType()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "KubernetesNamespaceType";
    }

    public KubernetesNamespaceType Set(
        ...
        KubernetesNamespaceDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        KubernetesVirtualMachineConnection? KubernetesDescendantVirtualMachines = null,
    ...
    ) 
    {
        ...
        if ( KubernetesDescendantVirtualMachines != null ) {
            this.KubernetesDescendantVirtualMachines = KubernetesDescendantVirtualMachines;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.K8sClusterName != null) {
            if (conf.Flat) {
                s += conf.Prefix + "k8sClusterName\n" ;
            } else {
                s += ind + "k8sClusterName\n" ;
            }
        }
        //      C# -> System.String? K8sClusterUuid
        // GraphQL -> k8sClusterUuid: UUID! (scalar)
        ...
        //      C# -> KubernetesVirtualMachineConnection? KubernetesDescendantVirtualMachines
        // GraphQL -> kubernetesDescendantVirtualMachines: KubernetesVirtualMachineConnection! (type)
        if (this.KubernetesDescendantVirtualMachines != null) {
            var fspec = this.KubernetesDescendantVirtualMachines.AsFieldSpec(conf.Child("kubernetesDescendantVirtualMachines"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "kubernetesDescendantVirtualMachines" + "\n(" + this.Vars.KubernetesDescendantVirtualMachines.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> LatestUserNote? LatestUserNote
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.K8sClusterName != null && ec.Excludes("k8sClusterName",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new KubernetesNamespaceDescendantConnection();
        ...
        //      C# -> KubernetesVirtualMachineConnection? KubernetesDescendantVirtualMachines
        // GraphQL -> kubernetesDescendantVirtualMachines: KubernetesVirtualMachineConnection! (type)
        if (ec.Includes("kubernetesDescendantVirtualMachines",false))
        {
            if(this.KubernetesDescendantVirtualMachines == null) {

                this.KubernetesDescendantVirtualMachines = new KubernetesVirtualMachineConnection();
                this.KubernetesDescendantVirtualMachines.ApplyExploratoryFieldSpec(ec.NewChild("kubernetesDescendantVirtualMachines"));
        ...
        else if (this.KubernetesDescendantVirtualMachines != null && ec.Excludes("kubernetesDescendantVirtualMachines",false))
        {
            this.KubernetesDescendantVirtualMachines = null;
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
    ...
    } // class KubernetesNamespaceType
    
    #endregion

    public static class ListKubernetesNamespaceTypeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesNamespaceType> list,
        ...
        public static List<string> SelectedFields(this List<KubernetesNamespaceType> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesNamespaceType());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KubernetesNamespaceType> list)
        {

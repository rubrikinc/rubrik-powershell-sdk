...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRestoreFormConfigurationUserExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RestoreFormConfigurationUser> list)
        {
        ...
        public static void SelectForRetrieval(this List<RestoreFormConfigurationUser> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.Locations != null && ec.Excludes("locations",true))
        {
            this.Locations = null;
        }
    }
    ...
    public static class ListListLocationsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ListLocationsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<ListLocationsReply> list)
        {

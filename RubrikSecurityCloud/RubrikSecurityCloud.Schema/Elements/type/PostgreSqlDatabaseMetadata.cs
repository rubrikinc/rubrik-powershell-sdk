...
{
    #region PostgreSqlDatabaseMetadata
    public class PostgreSqlDatabaseMetadata: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PostgreSQLDatabaseMetadata";
    }

    public PostgreSqlDatabaseMetadata Set(
    ...
    } // class PostgreSqlDatabaseMetadata
    
    #endregion

    public static class ListPostgreSqlDatabaseMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgreSqlDatabaseMetadata> list,
        ...
        public static List<string> SelectedFields(this List<PostgreSqlDatabaseMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgreSqlDatabaseMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgreSqlDatabaseMetadata> list)
        {

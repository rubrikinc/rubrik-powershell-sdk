...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereTag: BaseType, CdmHierarchyObject, HierarchyObject, VsphereTagCategoryDescendantType, VsphereTagCategoryTagChildType, VsphereVcenterDescendantType
    {
        #region members
        ...
        //      C# -> System.Boolean? IsFilter
        // GraphQL -> isFilter: Boolean! (scalar)
        [JsonProperty("isFilter")]
        public System.Boolean? IsFilter { get; set; }
        ...
        //      C# -> VsphereTagTagChildTypeConnection? TagChildConnection
        // GraphQL -> tagChildConnection: VsphereTagTagChildTypeConnection! (type)
        [JsonProperty("tagChildConnection")]
        public VsphereTagTagChildTypeConnection? TagChildConnection { get; set; }
    ...
    public VsphereTag Set(
        ...
        VsphereTagTagChildTypeConnection? TagChildConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTag_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTag_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTag_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTag_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTag_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Condition
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.IsFilter != null && ec.Excludes("isFilter",true))
        {
            this.IsFilter = null;
        }
        //      C# -> System.String? Name
        ...
        if (ec.Includes("tagChildConnection",false))
        {
            if(this.TagChildConnection == null) {
                ...
                this.TagChildConnection = new VsphereTagTagChildTypeConnection();
    ...
    public static class ListVsphereTagExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereTag> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereTag());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereTag> list)
        {

// CertificateSummaryListResponse.cs
//
...
{
    #region CertificateSummaryListResponse
    public class CertificateSummaryListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<AddClusterCertificateReply>? Data
        // GraphQL -> data: [AddClusterCertificateReply!]! (type)
        [JsonProperty("data")]
        public List<AddClusterCertificateReply>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "CertificateSummaryListResponse";
    }

    public CertificateSummaryListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<AddClusterCertificateReply>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<AddClusterCertificateReply>();
    ...
    public static class ListCertificateSummaryListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CertificateSummaryListResponse> list,
        ...
        public static List<string> SelectedFields(this List<CertificateSummaryListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CertificateSummaryListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CertificateSummaryListResponse> list)
        {

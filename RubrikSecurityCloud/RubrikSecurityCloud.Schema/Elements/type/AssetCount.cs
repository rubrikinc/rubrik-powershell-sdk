...
{
    #region AssetCount
    public class AssetCount: BaseType
    {
        #region members
    ...
    public static class ListAssetCountExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AssetCount> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AssetCount());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AssetCount> list)
        {

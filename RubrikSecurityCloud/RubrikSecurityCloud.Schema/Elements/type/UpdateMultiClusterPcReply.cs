...
{
    #region UpdateMultiClusterPcReply
    public class UpdateMultiClusterPcReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UpdateMultiClusterPcReply";
    }

    public UpdateMultiClusterPcReply Set(
    ...
    } // class UpdateMultiClusterPcReply
    
    #endregion

    public static class ListUpdateMultiClusterPcReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<UpdateMultiClusterPcReply> list,
        ...
        public static List<string> SelectedFields(this List<UpdateMultiClusterPcReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UpdateMultiClusterPcReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UpdateMultiClusterPcReply> list)
        {

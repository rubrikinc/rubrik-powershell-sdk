...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2InstanceDescendantTypeEdge: BaseType
    {
        #region members
        ...
        [JsonProperty("node")]
        public RscInterface<Db2InstanceDescendantType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "Db2InstanceDescendantTypeEdge";
    }

    public Db2InstanceDescendantTypeEdge Set(
        RscInterface<Db2InstanceDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<Db2InstanceDescendantType>();
    ...
    public static class ListDb2InstanceDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2InstanceDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<Db2InstanceDescendantTypeEdge> list)
        {

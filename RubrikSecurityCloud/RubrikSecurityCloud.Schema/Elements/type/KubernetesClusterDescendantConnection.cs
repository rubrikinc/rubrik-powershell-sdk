...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KubernetesClusterDescendantConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<KubernetesClusterDescendant> Nodes { get; set; }
    ...
    public KubernetesClusterDescendantConnection Set(
        RscInterface<KubernetesClusterDescendant> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<KubernetesClusterDescendant>();

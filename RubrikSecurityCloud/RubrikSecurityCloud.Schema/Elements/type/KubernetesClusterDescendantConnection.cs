...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KubernetesClusterDescendantConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<KubernetesClusterDescendant> Nodes { get; set; }
    ...
    public KubernetesClusterDescendantConnection Set(
        RscInterfaceList<KubernetesClusterDescendant> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<KubernetesClusterDescendant>();
    ...
    public static class ListKubernetesClusterDescendantConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<KubernetesClusterDescendantConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<KubernetesClusterDescendantConnection> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class RansomwareInvestigationWorkloadScannedCountReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.WorkloadScannedCounts != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.WorkloadScannedCounts.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.WorkloadScannedCounts == null && Exploration.Includes(parent + ".workloadScannedCounts"))
            {
                ...
                this.WorkloadScannedCounts.ApplyExploratoryFragment(parent + ".workloadScannedCounts");
            }
        }
    ...
    public static class ListRansomwareInvestigationWorkloadScannedCountReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new RansomwareInvestigationWorkloadScannedCountReply();
            list.Add(item);

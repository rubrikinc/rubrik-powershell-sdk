...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRecoveryPlanPermissionCheckReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RecoveryPlanPermissionCheckReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<RecoveryPlanPermissionCheckReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class UpdateAwsCloudAccountFeatureReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UpdateAwsCloudAccountFeatureReply";
    }
    ...
    public static class ListUpdateAwsCloudAccountFeatureReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateAwsCloudAccountFeatureReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UpdateAwsCloudAccountFeatureReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UpdateAwsCloudAccountFeatureReply> list)
        {

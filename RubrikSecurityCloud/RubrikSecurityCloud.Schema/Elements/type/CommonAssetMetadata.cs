...
{
    #region CommonAssetMetadata
 
    public class CommonAssetMetadata: BaseType, ResourceMetadataUnion
    {
        #region members
        ...
        //      C# -> SensitivityLevel? SensitivityLevel
        // GraphQL -> sensitivityLevel: SensitivityLevel! (enum)
    ...
    public override string GetGqlTypeName() {
        return "CommonAssetMetadata";
    }

    public CommonAssetMetadata Set(
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.SensitivityLevel != null) {
            if (conf.Flat) {
                s += conf.Prefix + "sensitivityLevel\n" ;
            } else {
                s += ind + "sensitivityLevel\n" ;
            }
        }
        //      C# -> System.Int64? CreationTime
        // GraphQL -> creationTime: Long! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> SensitivityLevel? SensitivityLevel
        // GraphQL -> sensitivityLevel: SensitivityLevel! (enum)
        if (ec.Includes("sensitivityLevel",true))
        {
            if(this.SensitivityLevel == null) {

                this.SensitivityLevel = new SensitivityLevel();
        ...
        else if (this.SensitivityLevel != null && ec.Excludes("sensitivityLevel",true))
        {
    ...
    } // class CommonAssetMetadata
    
    #endregion

    public static class ListCommonAssetMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CommonAssetMetadata> list,
        ...
        public static List<string> SelectedFields(this List<CommonAssetMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CommonAssetMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CommonAssetMetadata> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereLiveMountConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereLiveMountConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereLiveMountConnection> list)
        {

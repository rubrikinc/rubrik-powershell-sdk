...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListMongoRecoverableRangeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoRecoverableRange> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongoRecoverableRange> list)
        {

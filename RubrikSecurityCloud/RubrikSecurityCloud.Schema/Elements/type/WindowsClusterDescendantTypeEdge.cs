// WindowsClusterDescendantTypeEdge.cs
//
...
{
    #region WindowsClusterDescendantTypeEdge
    public class WindowsClusterDescendantTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "WindowsClusterDescendantTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "WindowsClusterDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class WindowsClusterDescendantTypeEdge
    
    #endregion

    public static class ListWindowsClusterDescendantTypeEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<WindowsClusterDescendantTypeEdge> list,
        ...
        public static List<string> SelectedFields(this List<WindowsClusterDescendantTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new WindowsClusterDescendantTypeEdge());
            }

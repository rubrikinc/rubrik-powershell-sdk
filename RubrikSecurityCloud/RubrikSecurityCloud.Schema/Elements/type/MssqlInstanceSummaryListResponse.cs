// MssqlInstanceSummaryListResponse.cs
//
...
{
    #region MssqlInstanceSummaryListResponse
    public class MssqlInstanceSummaryListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<MssqlInstanceSummary>? Data
        // GraphQL -> data: [MssqlInstanceSummary!]! (type)
        [JsonProperty("data")]
        public List<MssqlInstanceSummary>? Data { get; set; }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<MssqlInstanceSummary>();
    ...
    public static class ListMssqlInstanceSummaryListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MssqlInstanceSummaryListResponse> list,
        ...
        public static List<string> SelectedFields(this List<MssqlInstanceSummaryListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MssqlInstanceSummaryListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MssqlInstanceSummaryListResponse> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateServiceAccountReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateServiceAccountReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateServiceAccountReply> list)
        {

...
{
    #region SmbConfig
    public class SmbConfig: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Boolean? EnforceSmbSecurity
            // GraphQL -> enforceSmbSecurity: Boolean! (scalar)
            if (this.EnforceSmbSecurity == null && Exploration.Includes(parent + ".enforceSmbSecurity$"))
            {
                this.EnforceSmbSecurity = new System.Boolean();
            }
        }

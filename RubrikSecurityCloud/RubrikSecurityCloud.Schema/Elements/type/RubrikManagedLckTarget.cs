...
{
    #region RubrikManagedLckTarget
 
    public class RubrikManagedLckTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RubrikManagedLckTarget";
    }

    public RubrikManagedLckTarget Set(
        ...
        System.String? GeoAxisEndpoint = null,
    ...
    ) 
    {
        ...
        if ( GeoAxisEndpoint != null ) {
            this.GeoAxisEndpoint = GeoAxisEndpoint;
        }
        if ( Id != null ) {
            this.Id = Id;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? GeoAxisEndpoint
        // GraphQL -> geoAxisEndpoint: String! (scalar)
        if (this.GeoAxisEndpoint != null) {
            if (conf.Flat) {
                s += conf.Prefix + "geoAxisEndpoint\n" ;
            } else {
                s += ind + "geoAxisEndpoint\n" ;
            }
        }
        //      C# -> System.String? Id
        // GraphQL -> id: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? GeoAxisEndpoint
        // GraphQL -> geoAxisEndpoint: String! (scalar)
        if (ec.Includes("geoAxisEndpoint",true))
        {
            if(this.GeoAxisEndpoint == null) {

                this.GeoAxisEndpoint = "FETCH";
        ...
        else if (this.GeoAxisEndpoint != null && ec.Excludes("geoAxisEndpoint",true))
        {
            this.GeoAxisEndpoint = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: String! (scalar)
    ...
    } // class RubrikManagedLckTarget
    
    #endregion

    public static class ListRubrikManagedLckTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RubrikManagedLckTarget> list,
        ...
        public static List<string> SelectedFields(this List<RubrikManagedLckTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RubrikManagedLckTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RubrikManagedLckTarget> list)
        {

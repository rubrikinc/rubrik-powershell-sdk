...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereDatacenterFolderLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolderLogicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereDatacenterFolderLogicalChildTypeConnection> list)
        {

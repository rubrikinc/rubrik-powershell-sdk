...
{
    #region PendingSlaOperations
    public class PendingSlaOperations: BaseType
    {
        #region members
    ...
    } // class PendingSlaOperations
    
    #endregion

    public static class ListPendingSlaOperationsExtensions
    {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PendingSlaOperations());
            }

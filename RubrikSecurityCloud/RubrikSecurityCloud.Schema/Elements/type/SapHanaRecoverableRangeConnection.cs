...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSapHanaRecoverableRangeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SapHanaRecoverableRangeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<SapHanaRecoverableRangeConnection> list)
        {

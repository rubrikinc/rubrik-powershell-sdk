// DeleteReplicationPairTprReqChangesTemplate.cs
//
...
{
    #region DeleteReplicationPairTprReqChangesTemplate
 
    public class DeleteReplicationPairTprReqChangesTemplate: BaseType, RequestedChangesTemplate
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DeleteReplicationPairTprReqChangesTemplate";
    }

    public DeleteReplicationPairTprReqChangesTemplate Set(
    ...
    } // class DeleteReplicationPairTprReqChangesTemplate
    
    #endregion

    public static class ListDeleteReplicationPairTprReqChangesTemplateExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DeleteReplicationPairTprReqChangesTemplate> list,
        ...
        public static List<string> SelectedFields(this List<DeleteReplicationPairTprReqChangesTemplate> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DeleteReplicationPairTprReqChangesTemplate());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DeleteReplicationPairTprReqChangesTemplate> list)
        {

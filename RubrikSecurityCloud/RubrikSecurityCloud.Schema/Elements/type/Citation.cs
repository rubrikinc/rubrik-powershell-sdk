...
{
    #region Citation
    public class Citation: BaseType
    {
        #region members
    ...
    public static class ListCitationExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Citation> list)
        {
        ...
        public static void SelectForRetrieval(this List<Citation> list)
        {

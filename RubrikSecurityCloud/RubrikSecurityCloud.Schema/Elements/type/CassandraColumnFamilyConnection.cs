...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCassandraColumnFamilyConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraColumnFamilyConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<CassandraColumnFamilyConnection> list)
        {

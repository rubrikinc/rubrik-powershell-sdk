// MissingEntityPrivilegesList.cs
//
...
{
    #region MissingEntityPrivilegesList
    public class MissingEntityPrivilegesList: BaseType
    {
        #region members
        ...
        //      C# -> List<MissingEntityPrivileges>? Data
        // GraphQL -> data: [MissingEntityPrivileges!]! (type)
        [JsonProperty("data")]
        public List<MissingEntityPrivileges>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MissingEntityPrivilegesList";
    }

    public MissingEntityPrivilegesList Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int32? Total = null,
        List<MissingEntityPrivileges>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<MissingEntityPrivileges>();
    ...
    } // class MissingEntityPrivilegesList
    
    #endregion

    public static class ListMissingEntityPrivilegesListExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MissingEntityPrivilegesList> list,
        ...
        public static List<string> SelectedFields(this List<MissingEntityPrivilegesList> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MissingEntityPrivilegesList());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MissingEntityPrivilegesList> list)
        {

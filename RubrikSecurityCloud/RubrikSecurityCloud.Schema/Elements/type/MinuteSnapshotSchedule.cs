...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListMinuteSnapshotScheduleExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MinuteSnapshotSchedule> list)
        {
        ...
        public static void SelectForRetrieval(this List<MinuteSnapshotSchedule> list)
        {

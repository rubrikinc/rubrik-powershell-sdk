...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FusionComputeNetwork: BaseType, CdmHierarchyObject, FusionComputeClusterDescendant, FusionComputeClusterPhysicalChildType, FusionComputeHostDescendant, FusionComputeHostPhysicalChildType, FusionComputeSiteDescendant, FusionComputeSitePhysicalChildType, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject
    {
        ...
        //      C# -> System.String? FcNetworkId
        // GraphQL -> fcNetworkId: String! (scalar)
        [JsonProperty("fcNetworkId")]
        public System.String? FcNetworkId { get; set; }

        //      C# -> System.String? HostIds
        // GraphQL -> hostIds: String! (scalar)
        [JsonProperty("hostIds")]
        public System.String? HostIds { get; set; }
        ...
        //      C# -> System.String? NetworkType
        // GraphQL -> networkType: String! (scalar)
    ...
    public FusionComputeNetwork()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeNetwork";
    }

    public FusionComputeNetwork Set(
        ...
        System.String? FcNetworkId = null,
        System.String? HostIds = null,
        System.String? Id = null,
        System.String? Name = null,
        System.String? NetworkName = null,
        System.String? NetworkType = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? FcNetworkId
        // GraphQL -> fcNetworkId: String! (scalar)
        if (this.FcNetworkId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "fcNetworkId\n" ;
            } else {
                s += ind + "fcNetworkId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? FcNetworkId
        // GraphQL -> fcNetworkId: String! (scalar)
        if (ec.Includes("fcNetworkId",true))
        {
            if(this.FcNetworkId == null) {

                this.FcNetworkId = "FETCH";
        ...
        else if (this.FcNetworkId != null && ec.Excludes("fcNetworkId",true))
        {
            this.FcNetworkId = null;
        }
        //      C# -> System.String? HostIds
        // GraphQL -> hostIds: String! (scalar)
    ...
    } // class FusionComputeNetwork
    
    #endregion

    public static class ListFusionComputeNetworkExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeNetwork> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeNetwork> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeNetwork());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeNetwork> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class InlineVars {
        ...
        public RscGqlVars SnappableGroupBy { get; set; }
        ...
        public InlineVars() {
            ...
            this.SnappableGroupBy =
                new RscGqlVars(null, snappableGroupByArgs, null, true);
        }
    }

    public SnappableGroupByAtSpecifiedTime()
    {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.SnappableGroupBy != null) {
            var fspec = this.SnappableGroupBy.AsFieldSpec(conf.Child("snappableGroupBy"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "snappableGroupBy" + "\n(" + this.Vars.SnappableGroupBy.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> SnappableGroupByInfo? GroupByInfo
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.SnappableGroupBy != null && ec.Excludes("snappableGroupBy",false))
        {
            this.SnappableGroupBy = null;
        }
        //      C# -> SnappableGroupByInfo? GroupByInfo
        // GraphQL -> groupByInfo: SnappableGroupByInfo! (union)
    ...
    public static class ListSnappableGroupByAtSpecifiedTimeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnappableGroupByAtSpecifiedTime> list)
        {
        ...
        public static void SelectForRetrieval(this List<SnappableGroupByAtSpecifiedTime> list)
        {

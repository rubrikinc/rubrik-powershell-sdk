...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class NcdSharesObjectProtectionStatusData: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Int64? NotProtected
            // GraphQL -> notProtected: Long! (scalar)
            if (this.NotProtected == null && Exploration.Includes(parent + ".notProtected$"))
            {
    ...
    public static class ListNcdSharesObjectProtectionStatusDataExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new NcdSharesObjectProtectionStatusData();
            list.Add(item);

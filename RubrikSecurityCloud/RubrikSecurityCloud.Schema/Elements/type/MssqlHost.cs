...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlHost: BaseType, CdmHierarchyObject, HierarchyObject, MssqlTopLevelDescendantType
    {
        #region members
        ...
        //      C# -> MssqlHostDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: MssqlHostDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public MssqlHostDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> MssqlHostPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: MssqlHostPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public MssqlHostPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public MssqlHost Set(
        ...
        MssqlHostDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        MssqlHostPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new MssqlHostDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new MssqlHostPhysicalChildTypeConnection();
    ...
    public static class ListMssqlHostExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlHost> list)
        {

...
{
    #region UsageDatapoint
    public class UsageDatapoint: BaseType
    {
        #region members
    ...
    public static class ListUsageDatapointExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UsageDatapoint> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UsageDatapoint());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UsageDatapoint> list)
        {

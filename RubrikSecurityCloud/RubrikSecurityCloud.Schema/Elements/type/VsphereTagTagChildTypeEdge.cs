...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereTagTagChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereTagTagChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagTagChildType));
    ...
    public static class ListVsphereTagTagChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereTagTagChildTypeEdge();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
        ...
        if (this.CloudAccount != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "RubrikManagedAzureTarget_INTERFACE_FIELD_cloudAccount: cloudAccount{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? AccessKey
    ...
    public static class ListRubrikManagedAzureTargetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RubrikManagedAzureTarget> list)
        {

...
{
    #region GetPasskeyConfigReply
    public class GetPasskeyConfigReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "GetPasskeyConfigReply";
    }

    public GetPasskeyConfigReply Set(
    ...
    } // class GetPasskeyConfigReply
    
    #endregion

    public static class ListGetPasskeyConfigReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GetPasskeyConfigReply> list,
        ...
        public static List<string> SelectedFields(this List<GetPasskeyConfigReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GetPasskeyConfigReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GetPasskeyConfigReply> list)
        {

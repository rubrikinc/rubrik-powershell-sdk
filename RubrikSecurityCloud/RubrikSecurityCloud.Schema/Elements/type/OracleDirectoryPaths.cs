...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.String? ArchiveDests
        // GraphQL -> archiveDests: String! (scalar)
        if (ec.Includes("archiveDests",true))
        {
            if(this.ArchiveDests == null) {
        ...
        else if (this.ArchiveDests != null && ec.Excludes("archiveDests",true))
        {
            this.ArchiveDests = null;
        }
    }
    ...
    public static class ListOracleDirectoryPathsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleDirectoryPaths> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleDirectoryPaths> list)
        {

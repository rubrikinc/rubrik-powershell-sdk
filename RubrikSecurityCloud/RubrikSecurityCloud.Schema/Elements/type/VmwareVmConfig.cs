...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.LogRetentionSeconds != null) {
            if (conf.Flat) {
                s += conf.Prefix + "logRetentionSeconds\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        //      C# -> System.Int64? LogRetentionSeconds
        // GraphQL -> logRetentionSeconds: Long! (scalar)
        if (ec.Includes("logRetentionSeconds",true))
        {
            if(this.LogRetentionSeconds == null) {
        ...
        else if (this.LogRetentionSeconds != null && ec.Excludes("logRetentionSeconds",true))
        {
            this.LogRetentionSeconds = null;
        }
    }
    ...
    public static class ListVmwareVmConfigExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VmwareVmConfig> list)
        {
        ...
        public static void SelectForRetrieval(this List<VmwareVmConfig> list)
        {

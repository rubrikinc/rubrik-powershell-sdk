...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OlvmTagV1: BaseType, CdmHierarchyObject, HierarchyObject, OlvmManagerDescendant, OlvmTagDescendant, OlvmTagLogicalChild
    {
        #region members
        ...
        //      C# -> System.String? ParentTagId
        // GraphQL -> parentTagId: UUID (scalar)
        [JsonProperty("parentTagId")]
        public System.String? ParentTagId { get; set; }
        ...
        //      C# -> OlvmTagDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: OlvmTagDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public OlvmTagDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> OlvmTagLogicalChildConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: OlvmTagLogicalChildConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public OlvmTagLogicalChildConnection? LogicalChildConnection { get; set; }
    ...
    public OlvmTagV1 Set(
        ...
        System.String? ParentTagId = null,
        ...
        OlvmTagDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        OlvmTagLogicalChildConnection? LogicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? ParentTagId
        // GraphQL -> parentTagId: UUID (scalar)
        if (ec.Includes("parentTagId",true))
        {
            if(this.ParentTagId == null) {

                this.ParentTagId = "FETCH";
        ...
        else if (this.ParentTagId != null && ec.Excludes("parentTagId",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new OlvmTagDescendantConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new OlvmTagLogicalChildConnection();
    ...
    public static class ListOlvmTagV1Extensions
    {
        ...
        public static List<string> SelectedFields(this List<OlvmTagV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmTagV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmTagV1> list)
        {

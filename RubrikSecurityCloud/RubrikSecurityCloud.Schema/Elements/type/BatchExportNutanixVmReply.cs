...
namespace RubrikSecurityCloud.Types
{
    ...
    public class BatchExportNutanixVmReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "BatchExportNutanixVmReply";
    }
    ...
    public static class ListBatchExportNutanixVmReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BatchExportNutanixVmReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BatchExportNutanixVmReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BatchExportNutanixVmReply> list)
        {

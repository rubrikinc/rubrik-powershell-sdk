...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostFailoverClusterPhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HostFailoverClusterPhysicalChildType> Node { get; set; }
    ...
    public HostFailoverClusterPhysicalChildTypeEdge Set(
        RscInterface<HostFailoverClusterPhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HostFailoverClusterPhysicalChildType>();
    ...
    public static class ListHostFailoverClusterPhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HostFailoverClusterPhysicalChildTypeEdge> list)
        {

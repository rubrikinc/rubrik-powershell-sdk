...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostFailoverClusterPhysicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HostFailoverClusterPhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostFailoverClusterPhysicalChildType));
    ...
    public static class ListHostFailoverClusterPhysicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HostFailoverClusterPhysicalChildTypeEdge();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostFailoverClusterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<HostFailoverClusterDescendantType> Nodes { get; set; }
    ...
    public HostFailoverClusterDescendantTypeConnection Set(
        RscInterface<HostFailoverClusterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<HostFailoverClusterDescendantType>();

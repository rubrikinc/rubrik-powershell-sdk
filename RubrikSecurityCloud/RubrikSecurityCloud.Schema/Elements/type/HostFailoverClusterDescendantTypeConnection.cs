...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostFailoverClusterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<HostFailoverClusterDescendantType> Nodes { get; set; }
    ...
    public HostFailoverClusterDescendantTypeConnection Set(
        RscInterfaceList<HostFailoverClusterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<HostFailoverClusterDescendantType>();
    ...
    public static class ListHostFailoverClusterDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HostFailoverClusterDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<HostFailoverClusterDescendantTypeConnection> list)
        {

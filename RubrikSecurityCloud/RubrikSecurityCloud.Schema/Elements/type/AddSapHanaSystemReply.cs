...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AddSapHanaSystemReply: BaseType
    {
        #region members
    ...
    public static class ListAddSapHanaSystemReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddSapHanaSystemReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddSapHanaSystemReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddSapHanaSystemReply> list)
        {

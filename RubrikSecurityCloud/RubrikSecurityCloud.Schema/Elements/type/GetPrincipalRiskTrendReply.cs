...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.PrincipalRisk != null) {
            var fspec = this.PrincipalRisk.AsFieldSpec(conf.Child("principalRisk"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<PrincipalRisk>? PrincipalRisk
        // GraphQL -> principalRisk: [PrincipalRisk!]! (type)
        if (ec.Includes("principalRisk",false))
        {
            if(this.PrincipalRisk == null) {
        ...
        else if (this.PrincipalRisk != null && ec.Excludes("principalRisk",false))
        {
            this.PrincipalRisk = null;
        }
    }
    ...
    public static class ListGetPrincipalRiskTrendReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetPrincipalRiskTrendReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<GetPrincipalRiskTrendReply> list)
        {

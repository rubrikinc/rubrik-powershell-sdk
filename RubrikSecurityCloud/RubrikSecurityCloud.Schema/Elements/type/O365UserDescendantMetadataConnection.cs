...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365UserDescendantMetadataConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<O365UserDescendantMetadata> Nodes { get; set; }
    ...
    public O365UserDescendantMetadataConnection Set(
        RscInterface<O365UserDescendantMetadata> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<O365UserDescendantMetadata>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365UserDescendantMetadataConnection: BaseType
    {
        #region members
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<O365UserDescendantMetadata> Nodes { get; set; }
    ...
    public O365UserDescendantMetadataConnection Set(
        RscInterfaceList<O365UserDescendantMetadata> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<O365UserDescendantMetadata>();
    ...
    public static class ListO365UserDescendantMetadataConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365UserDescendantMetadataConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365UserDescendantMetadataConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365UserDescendantMetadataConnection> list)
        {

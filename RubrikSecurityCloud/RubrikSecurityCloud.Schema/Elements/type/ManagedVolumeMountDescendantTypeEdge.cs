...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class ManagedVolumeMountDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (ManagedVolumeMountDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(ManagedVolumeMountDescendantType));
    ...
    public static class ListManagedVolumeMountDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new ManagedVolumeMountDescendantTypeEdge();
            list.Add(item);

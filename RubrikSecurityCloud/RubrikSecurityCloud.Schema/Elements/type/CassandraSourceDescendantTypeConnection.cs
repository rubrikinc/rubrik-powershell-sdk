...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CassandraSourceDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<CassandraSourceDescendantType> Nodes { get; set; }
    ...
    public CassandraSourceDescendantTypeConnection Set(
        RscInterfaceList<CassandraSourceDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<CassandraSourceDescendantType>();
    ...
    public static class ListCassandraSourceDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourceDescendantTypeConnection> list)
        {

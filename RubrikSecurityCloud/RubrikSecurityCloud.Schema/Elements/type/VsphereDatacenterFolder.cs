...
{
    #region VsphereDatacenterFolder
 
    public class VsphereDatacenterFolder: BaseType, CdmHierarchyObject, HierarchyObject, VsphereDatacenterFolderDescendantType, VsphereDatacenterFolderLogicalChildType, VsphereDatacenterFolderPhysicalChildType, VsphereVcenterDescendantType, VsphereVcenterLogicalChildType, VsphereVcenterPhysicalChildType
    {
        #region members
        ...
        //      C# -> VsphereDatacenterFolderDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VsphereDatacenterFolderDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VsphereDatacenterFolderDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VsphereDatacenterFolderLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: VsphereDatacenterFolderLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public VsphereDatacenterFolderLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> VsphereDatacenterFolderPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: VsphereDatacenterFolderPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public VsphereDatacenterFolderPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
        ...
        //      C# -> VsphereDatacenterFolderLogicalChildTypeConnection? RecoveryTargetChildConnection
        // GraphQL -> recoveryTargetChildConnection: VsphereDatacenterFolderLogicalChildTypeConnection! (type)
        [JsonProperty("recoveryTargetChildConnection")]
        public VsphereDatacenterFolderLogicalChildTypeConnection? RecoveryTargetChildConnection { get; set; }
    ...
    public class InlineVars {
        ...
        public InlineVars() {
            ...
            this.RecoveryTargetChildConnection =
                new RscGqlVars(null, recoveryTargetChildConnectionArgs, null, true);
        }
    }

    public VsphereDatacenterFolder()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "VsphereDatacenterFolder";
    }

    public VsphereDatacenterFolder Set(
        ...
        VsphereDatacenterFolderDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        VsphereDatacenterFolderLogicalChildTypeConnection? LogicalChildConnection = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        VsphereDatacenterFolderPhysicalChildTypeConnection? PhysicalChildConnection = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        VsphereDatacenterFolderLogicalChildTypeConnection? RecoveryTargetChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> VmwareFolderType? FolderType
        // GraphQL -> folderType: VmwareFolderType (enum)
        if (ec.Includes("folderType",true))
        {
            if(this.FolderType == null) {
        ...
        else if (this.FolderType != null && ec.Excludes("folderType",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VsphereDatacenterFolderDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new VsphereDatacenterFolderLogicalChildTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new VsphereDatacenterFolderPhysicalChildTypeConnection();
        ...
        if (ec.Includes("recoveryTargetChildConnection",false))
        {
            if(this.RecoveryTargetChildConnection == null) {
                ...
                this.RecoveryTargetChildConnection = new VsphereDatacenterFolderLogicalChildTypeConnection();
    ...
    } // class VsphereDatacenterFolder
    
    #endregion

    public static class ListVsphereDatacenterFolderExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatacenterFolder> list,
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolder> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereDatacenterFolder());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereDatacenterFolder> list)
        {

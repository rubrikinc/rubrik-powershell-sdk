...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CassandraKeyspacePhysicalChildTypeEdge: BaseType
    {
        #region members
        ...
        [JsonProperty("node")]
        public RscInterface<CassandraKeyspacePhysicalChildType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "CassandraKeyspacePhysicalChildTypeEdge";
    }

    public CassandraKeyspacePhysicalChildTypeEdge Set(
        RscInterface<CassandraKeyspacePhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<CassandraKeyspacePhysicalChildType>();
    ...
    public static class ListCassandraKeyspacePhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraKeyspacePhysicalChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CassandraKeyspacePhysicalChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CassandraKeyspacePhysicalChildTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "GcpNativeGceInstance_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "GcpNativeGceInstance_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "GcpNativeGceInstance_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
        ...
        if (this.AttachedDisks != null) {
            var fspec = this.AttachedDisks.AsFieldSpec(conf.Child("attachedDisks"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<GcpNativeAttachmentDetails>? AttachedDisks
        // GraphQL -> attachedDisks: [GcpNativeAttachmentDetails!]! (type)
        if (ec.Includes("attachedDisks",false))
        {
            if(this.AttachedDisks == null) {

                this.AttachedDisks = new List<GcpNativeAttachmentDetails>();
                this.AttachedDisks.ApplyExploratoryFieldSpec(ec.NewChild("attachedDisks"));
        ...
        else if (this.AttachedDisks != null && ec.Excludes("attachedDisks",false))
        {
    ...
    public static class ListGcpNativeGceInstanceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GcpNativeGceInstance> list)
        {
        ...
        public static void SelectForRetrieval(this List<GcpNativeGceInstance> list)
        {

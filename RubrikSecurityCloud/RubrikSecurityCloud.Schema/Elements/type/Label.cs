...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListLabelExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Label> list)
        {
        ...
        public static void SelectForRetrieval(this List<Label> list)
        {

...
{
    #region MigrationSupportCase
    public class MigrationSupportCase: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MigrationSupportCase";
    }

    public MigrationSupportCase Set(
    ...
    } // class MigrationSupportCase
    
    #endregion

    public static class ListMigrationSupportCaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MigrationSupportCase> list,
        ...
        public static List<string> SelectedFields(this List<MigrationSupportCase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MigrationSupportCase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MigrationSupportCase> list)
        {

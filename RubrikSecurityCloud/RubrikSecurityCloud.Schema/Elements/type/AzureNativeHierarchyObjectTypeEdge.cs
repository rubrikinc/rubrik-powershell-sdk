...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AzureNativeHierarchyObjectTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (AzureNativeHierarchyObjectType)InterfaceHelper.CreateInstanceOfFirstType(typeof(AzureNativeHierarchyObjectType));
    ...
    public static class ListAzureNativeHierarchyObjectTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new AzureNativeHierarchyObjectTypeEdge();
            list.Add(item);

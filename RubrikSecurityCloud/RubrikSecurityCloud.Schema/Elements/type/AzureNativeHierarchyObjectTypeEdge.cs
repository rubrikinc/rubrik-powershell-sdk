...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AzureNativeHierarchyObjectTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<AzureNativeHierarchyObjectType> Node { get; set; }
    ...
    public AzureNativeHierarchyObjectTypeEdge Set(
        RscInterface<AzureNativeHierarchyObjectType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<AzureNativeHierarchyObjectType>();
    ...
    public static class ListAzureNativeHierarchyObjectTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureNativeHierarchyObjectTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureNativeHierarchyObjectTypeEdge> list)
        {

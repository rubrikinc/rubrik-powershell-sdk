...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSonarContentReportConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SonarContentReportConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<SonarContentReportConnection> list)
        {

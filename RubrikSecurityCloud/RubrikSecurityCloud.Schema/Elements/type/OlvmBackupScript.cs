...
{
    #region OlvmBackupScript
    public class OlvmBackupScript: BaseType
    {
        #region members

        //      C# -> OlvmBackupScriptFailureHandling? FailureHandling
        // GraphQL -> failureHandling: OlvmBackupScriptFailureHandling! (enum)
        [JsonProperty("failureHandling")]
        public OlvmBackupScriptFailureHandling? FailureHandling { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "OlvmBackupScript";
    }

    public OlvmBackupScript Set(
        OlvmBackupScriptFailureHandling? FailureHandling = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("failureHandling",true))
        {
            if(this.FailureHandling == null) {
                ...
                this.FailureHandling = new OlvmBackupScriptFailureHandling();
    ...
    } // class OlvmBackupScript
    
    #endregion

    public static class ListOlvmBackupScriptExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmBackupScript> list,
        ...
        public static List<string> SelectedFields(this List<OlvmBackupScript> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmBackupScript());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmBackupScript> list)
        {

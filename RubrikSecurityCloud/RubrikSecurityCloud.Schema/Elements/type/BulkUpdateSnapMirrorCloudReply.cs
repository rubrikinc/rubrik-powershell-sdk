...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBulkUpdateSnapMirrorCloudReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BulkUpdateSnapMirrorCloudReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BulkUpdateSnapMirrorCloudReply> list)
        {

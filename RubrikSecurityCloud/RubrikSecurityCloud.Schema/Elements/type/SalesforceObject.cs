...
{
    #region SalesforceObject
 
    public class SalesforceObject: BaseType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> System.String? SalesforceObjectType
        // GraphQL -> salesforceObjectType: String! (scalar)
        [JsonProperty("salesforceObjectType")]
        public System.String? SalesforceObjectType { get; set; }
    ...
    public SalesforceObject Set(
        ...
        System.String? SalesforceObjectType = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? SalesforceObjectType
        // GraphQL -> salesforceObjectType: String! (scalar)
        if (this.SalesforceObjectType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "salesforceObjectType\n" ;
            } else {
                s += ind + "salesforceObjectType\n" ;
            }
        }
        //      C# -> System.Boolean? SlaPauseStatus
        // GraphQL -> slaPauseStatus: Boolean! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? SalesforceObjectType
        // GraphQL -> salesforceObjectType: String! (scalar)
        if (ec.Includes("salesforceObjectType",true))
        {
            if(this.SalesforceObjectType == null) {

                this.SalesforceObjectType = "FETCH";
        ...
        else if (this.SalesforceObjectType != null && ec.Excludes("salesforceObjectType",true))
        {
    ...
    public static class ListSalesforceObjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SalesforceObject> list,
        ...
        public static List<string> SelectedFields(this List<SalesforceObject> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SalesforceObject());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SalesforceObject> list)
        {

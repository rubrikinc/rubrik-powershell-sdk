...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListO365TeamConversationsSenderExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamConversationsSender> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365TeamConversationsSender> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class O365OnedriveObjectEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (O365OnedriveObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(O365OnedriveObject));
    ...
    public static class ListO365OnedriveObjectEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new O365OnedriveObjectEdge();
            list.Add(item);

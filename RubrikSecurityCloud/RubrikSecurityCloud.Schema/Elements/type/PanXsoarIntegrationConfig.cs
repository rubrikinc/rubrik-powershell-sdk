...
{
    #region PanXsoarIntegrationConfig
    public class PanXsoarIntegrationConfig: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PanXsoarIntegrationConfig";
    }

    public PanXsoarIntegrationConfig Set(
    ...
    } // class PanXsoarIntegrationConfig
    
    #endregion

    public static class ListPanXsoarIntegrationConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PanXsoarIntegrationConfig> list,
        ...
        public static List<string> SelectedFields(this List<PanXsoarIntegrationConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PanXsoarIntegrationConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PanXsoarIntegrationConfig> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class JiraProject: BaseType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> JiraProjectTypeKey? TypeKey
        // GraphQL -> typeKey: JiraProjectTypeKey! (enum)
        [JsonProperty("typeKey")]
        public JiraProjectTypeKey? TypeKey { get; set; }
    ...
    public JiraProject Set(
        List<Operation>? AuthorizedOperations = null,
        HierarchyObjectTypeEnum? ObjectType = null,
        SlaAssignmentTypeEnum? SlaAssignment = null,
        JiraProjectTypeKey? TypeKey = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        // GraphQL -> lead: AtlassianUser! (type)
        if (this.Lead != null) {
            var fspec = this.Lead.AsFieldSpec(conf.Child("lead"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> JiraProjectTypeKey? TypeKey
        // GraphQL -> typeKey: JiraProjectTypeKey! (enum)
        if (ec.Includes("typeKey",true))
        {
            if(this.TypeKey == null) {

                this.TypeKey = new JiraProjectTypeKey();
        ...
        else if (this.TypeKey != null && ec.Excludes("typeKey",true))
        {
            this.TypeKey = null;
        }
        //      C# -> SlaDomain? ConfiguredSlaDomain
        ...
        //      C# -> AtlassianUser? Lead
        // GraphQL -> lead: AtlassianUser! (type)
        if (ec.Includes("lead",false))
        {
            if(this.Lead == null) {

                this.Lead = new AtlassianUser();
                this.Lead.ApplyExploratoryFieldSpec(ec.NewChild("lead"));
        ...
        else if (this.Lead != null && ec.Excludes("lead",false))
        {
            this.Lead = null;
        }
        //      C# -> List<PathNode>? LogicalPath
    ...
    public static class ListJiraProjectExtensions
    {
        ...
        public static List<string> SelectedFields(this List<JiraProject> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new JiraProject());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<JiraProject> list)
        {

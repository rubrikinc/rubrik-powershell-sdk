...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAnomalyResultConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnomalyResultConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AnomalyResultConnection> list)
        {

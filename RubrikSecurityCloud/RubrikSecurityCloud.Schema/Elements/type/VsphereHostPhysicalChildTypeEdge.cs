...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereHostPhysicalChildTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "VsphereHostPhysicalChildTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereHostPhysicalChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<VsphereHostPhysicalChildType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (VsphereHostPhysicalChildType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    public static class ListVsphereHostPhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereHostPhysicalChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereHostPhysicalChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereHostPhysicalChildTypeEdge> list)
        {

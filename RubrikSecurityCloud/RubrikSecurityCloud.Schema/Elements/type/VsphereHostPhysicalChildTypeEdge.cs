...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereHostPhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereHostPhysicalChildType> Node { get; set; }
    ...
    public VsphereHostPhysicalChildTypeEdge Set(
        RscInterface<VsphereHostPhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereHostPhysicalChildType>();

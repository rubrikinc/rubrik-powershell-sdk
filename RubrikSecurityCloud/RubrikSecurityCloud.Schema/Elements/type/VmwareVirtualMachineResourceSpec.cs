// VmwareVirtualMachineResourceSpec.cs
//
...
{
    #region VmwareVirtualMachineResourceSpec
    public class VmwareVirtualMachineResourceSpec: BaseType
    {
        #region members
        ...
        //      C# -> List<VmwareVirtualMachineNic>? NetworkInterfaces
        // GraphQL -> networkInterfaces: [VmwareVirtualMachineNic!]! (type)
        [JsonProperty("networkInterfaces")]
        public List<VmwareVirtualMachineNic>? NetworkInterfaces { get; set; }

        //      C# -> List<VmwareVirtualMachineVolume>? StorageVolumes
        // GraphQL -> storageVolumes: [VmwareVirtualMachineVolume!]! (type)
        [JsonProperty("storageVolumes")]
        public List<VmwareVirtualMachineVolume>? StorageVolumes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VmwareVirtualMachineResourceSpec";
    }

    public VmwareVirtualMachineResourceSpec Set(
        ...
        List<VmwareVirtualMachineNic>? NetworkInterfaces = null,
        List<VmwareVirtualMachineVolume>? StorageVolumes = null
    ) 
    {
        if ( IsArchived != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("networkInterfaces",false))
        {
            if(this.NetworkInterfaces == null) {
                ...
                this.NetworkInterfaces = new List<VmwareVirtualMachineNic>();
        ...
        if (ec.Includes("storageVolumes",false))
        {
            if(this.StorageVolumes == null) {
                ...
                this.StorageVolumes = new List<VmwareVirtualMachineVolume>();
    ...
    } // class VmwareVirtualMachineResourceSpec
    
    #endregion

    public static class ListVmwareVirtualMachineResourceSpecExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VmwareVirtualMachineResourceSpec> list,
        ...
        public static List<string> SelectedFields(this List<VmwareVirtualMachineResourceSpec> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VmwareVirtualMachineResourceSpec());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VmwareVirtualMachineResourceSpec> list)
        {

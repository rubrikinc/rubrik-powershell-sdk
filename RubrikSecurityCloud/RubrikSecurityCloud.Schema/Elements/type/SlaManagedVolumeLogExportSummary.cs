...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ClientLogMountPath != null) {
            if (conf.Flat) {
                s += conf.Prefix + "clientLogMountPath\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.String? ClientLogMountPath
        // GraphQL -> clientLogMountPath: String! (scalar)
        if (ec.Includes("clientLogMountPath",true))
        {
            if(this.ClientLogMountPath == null) {
        ...
        else if (this.ClientLogMountPath != null && ec.Excludes("clientLogMountPath",true))
        {
            this.ClientLogMountPath = null;
        }
    }
    ...
    public static class ListSlaManagedVolumeLogExportSummaryExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SlaManagedVolumeLogExportSummary> list)
        {
        ...
        public static void SelectForRetrieval(this List<SlaManagedVolumeLogExportSummary> list)
        {

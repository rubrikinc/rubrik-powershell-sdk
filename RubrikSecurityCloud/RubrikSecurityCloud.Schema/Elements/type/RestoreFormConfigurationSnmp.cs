...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "RestoreFormConfigurationSnmp";
    }
    ...
    public static class ListRestoreFormConfigurationSnmpExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RestoreFormConfigurationSnmp> list)
        {
        ...
        public static void SelectForRetrieval(this List<RestoreFormConfigurationSnmp> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HypervAsyncRequestSuccessSummary: BaseType
    {
        #region members
    ...
    public static class ListHypervAsyncRequestSuccessSummaryExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HypervAsyncRequestSuccessSummary> list)
        {
        ...
        public static void SelectForRetrieval(this List<HypervAsyncRequestSuccessSummary> list)
        {

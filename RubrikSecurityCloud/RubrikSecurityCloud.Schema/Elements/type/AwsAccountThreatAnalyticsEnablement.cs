// AwsAccountThreatAnalyticsEnablement.cs
//
...
{
    #region AwsAccountThreatAnalyticsEnablement
    public class AwsAccountThreatAnalyticsEnablement: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AwsAccountThreatAnalyticsEnablement";
    }
    ...
    } // class AwsAccountThreatAnalyticsEnablement
    
    #endregion

    public static class ListAwsAccountThreatAnalyticsEnablementExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AwsAccountThreatAnalyticsEnablement> list,
        ...
        public static List<string> SelectedFields(this List<AwsAccountThreatAnalyticsEnablement> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsAccountThreatAnalyticsEnablement());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AwsAccountThreatAnalyticsEnablement> list)
        {

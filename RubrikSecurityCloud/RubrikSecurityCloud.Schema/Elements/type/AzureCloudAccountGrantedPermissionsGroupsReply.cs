...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.GrantedPermissionsGroups != null) {
            if (conf.Flat) {
                s += conf.Prefix + "grantedPermissionsGroups\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<PermissionsGroup>? GrantedPermissionsGroups
        // GraphQL -> grantedPermissionsGroups: [PermissionsGroup!]! (enum)
        if (ec.Includes("grantedPermissionsGroups",true))
        {
            if(this.GrantedPermissionsGroups == null) {
        ...
        else if (this.GrantedPermissionsGroups != null && ec.Excludes("grantedPermissionsGroups",true))
        {
            this.GrantedPermissionsGroups = null;
        }
    }
    ...
    public static class ListAzureCloudAccountGrantedPermissionsGroupsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureCloudAccountGrantedPermissionsGroupsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureCloudAccountGrantedPermissionsGroupsReply> list)
        {

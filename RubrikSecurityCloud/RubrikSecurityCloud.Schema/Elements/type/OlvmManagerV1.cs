...
{
    #region OlvmManagerV1
 
    public class OlvmManagerV1: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? OlvmAddress
        // GraphQL -> olvmAddress: String! (scalar)
        [JsonProperty("olvmAddress")]
        public System.String? OlvmAddress { get; set; }
        ...
        //      C# -> OlvmManagerDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: OlvmManagerDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public OlvmManagerDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> OlvmManagerDescendantConnection? OlvmDescendantDatacenters
        // GraphQL -> olvmDescendantDatacenters: OlvmManagerDescendantConnection! (type)
        [JsonProperty("olvmDescendantDatacenters")]
        public OlvmManagerDescendantConnection? OlvmDescendantDatacenters { get; set; }
        ...
        //      C# -> OlvmManagerPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: OlvmManagerPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public OlvmManagerPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public class InlineVars {
        ...
        public RscGqlVars OlvmDescendantDatacenters { get; set; }
        ...
        public InlineVars() {
            ...
            Tuple<string, string>[] olvmDescendantDatacentersArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
                    Tuple.Create("last", "Int"),
                    Tuple.Create("before", "String"),
            ...
            this.OlvmDescendantDatacenters =
                new RscGqlVars(null, olvmDescendantDatacentersArgs, null, true);
    ...
    public OlvmManagerV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "OlvmManagerV1";
    }

    public OlvmManagerV1 Set(
        ...
        System.String? OlvmAddress = null,
        ...
        OlvmManagerDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectBackupWindowStatus? ObjectBackupWindow = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        OlvmManagerDescendantConnection? OlvmDescendantDatacenters = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        OlvmManagerPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( OlvmDescendantDatacenters != null ) {
            this.OlvmDescendantDatacenters = OlvmDescendantDatacenters;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? OlvmAddress
        // GraphQL -> olvmAddress: String! (scalar)
        if (this.OlvmAddress != null) {
            if (conf.Flat) {
                s += conf.Prefix + "olvmAddress\n" ;
            } else {
                s += ind + "olvmAddress\n" ;
            }
        }
        ...
        //      C# -> OlvmManagerDescendantConnection? OlvmDescendantDatacenters
        // GraphQL -> olvmDescendantDatacenters: OlvmManagerDescendantConnection! (type)
        if (this.OlvmDescendantDatacenters != null) {
            var fspec = this.OlvmDescendantDatacenters.AsFieldSpec(conf.Child("olvmDescendantDatacenters"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "olvmDescendantDatacenters" + "\n(" + this.Vars.OlvmDescendantDatacenters.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? OlvmAddress
        // GraphQL -> olvmAddress: String! (scalar)
        if (ec.Includes("olvmAddress",true))
        {
            if(this.OlvmAddress == null) {

                this.OlvmAddress = "FETCH";
        ...
        else if (this.OlvmAddress != null && ec.Excludes("olvmAddress",true))
        {
            this.OlvmAddress = null;
        }
        //      C# -> System.String? PrimaryClusterUuid
        // GraphQL -> primaryClusterUuid: UUID! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new OlvmManagerDescendantConnection();
        ...
        //      C# -> OlvmManagerDescendantConnection? OlvmDescendantDatacenters
        // GraphQL -> olvmDescendantDatacenters: OlvmManagerDescendantConnection! (type)
        if (ec.Includes("olvmDescendantDatacenters",false))
        {
            if(this.OlvmDescendantDatacenters == null) {

                this.OlvmDescendantDatacenters = new OlvmManagerDescendantConnection();
                this.OlvmDescendantDatacenters.ApplyExploratoryFieldSpec(ec.NewChild("olvmDescendantDatacenters"));
        ...
        else if (this.OlvmDescendantDatacenters != null && ec.Excludes("olvmDescendantDatacenters",false))
        {
            this.OlvmDescendantDatacenters = null;
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new OlvmManagerPhysicalChildTypeConnection();
    ...
    public static class ListOlvmManagerV1Extensions
    {
        ...
        public static List<string> SelectedFields(this List<OlvmManagerV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmManagerV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmManagerV1> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "HyperVVirtualMachineConnection";
    }
    ...
    public static class ListHyperVvirtualMachineConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVvirtualMachineConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<HyperVvirtualMachineConnection> list)
        {

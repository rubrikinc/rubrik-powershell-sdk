...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AnomalyResultGroupedDataEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AnomalyResultGroupedDataEdge";
    }
    ...
    public static class ListAnomalyResultGroupedDataEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnomalyResultGroupedDataEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AnomalyResultGroupedDataEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AnomalyResultGroupedDataEdge> list)
        {

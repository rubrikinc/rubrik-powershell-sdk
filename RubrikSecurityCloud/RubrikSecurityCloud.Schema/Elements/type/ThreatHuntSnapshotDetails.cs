...
{
    #region ThreatHuntSnapshotDetails
    public class ThreatHuntSnapshotDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ThreatHuntSnapshotDetails";
    }

    public ThreatHuntSnapshotDetails Set(
    ...
    } // class ThreatHuntSnapshotDetails
    
    #endregion

    public static class ListThreatHuntSnapshotDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ThreatHuntSnapshotDetails> list,
        ...
        public static List<string> SelectedFields(this List<ThreatHuntSnapshotDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ThreatHuntSnapshotDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ThreatHuntSnapshotDetails> list)
        {

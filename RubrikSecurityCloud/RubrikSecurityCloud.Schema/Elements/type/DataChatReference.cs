...
{
    #region DataChatReference
 
    public class DataChatReference: BaseType, LlmReference
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DataChatReference";
    }

    public DataChatReference Set(
    ...
    } // class DataChatReference
    
    #endregion

    public static class ListDataChatReferenceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DataChatReference> list,
        ...
        public static List<string> SelectedFields(this List<DataChatReference> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DataChatReference());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DataChatReference> list)
        {

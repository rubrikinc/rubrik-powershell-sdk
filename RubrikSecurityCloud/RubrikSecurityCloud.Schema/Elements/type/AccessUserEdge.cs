...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AccessUserEdge: BaseType
    {
        #region members
    ...
    public static class ListAccessUserEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AccessUserEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AccessUserEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AccessUserEdge> list)
        {

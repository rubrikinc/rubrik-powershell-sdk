...
{
    #region IbmCosDetailsOutput
    public class IbmCosDetailsOutput: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "IbmCosDetailsOutput";
    }

    public IbmCosDetailsOutput Set(
    ...
    } // class IbmCosDetailsOutput
    
    #endregion

    public static class ListIbmCosDetailsOutputExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<IbmCosDetailsOutput> list,
        ...
        public static List<string> SelectedFields(this List<IbmCosDetailsOutput> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new IbmCosDetailsOutput());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<IbmCosDetailsOutput> list)
        {

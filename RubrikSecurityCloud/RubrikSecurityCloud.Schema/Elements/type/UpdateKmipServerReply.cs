...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateKmipServerReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateKmipServerReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateKmipServerReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoDatabase: BaseType, CdmHierarchyObject, HierarchyObject, MongoSourceDescendantType, MongoSourcePhysicalChildType
    {
        #region members
        ...
        //      C# -> MongoDatabaseDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: MongoDatabaseDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public MongoDatabaseDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> MongoDatabasePhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: MongoDatabasePhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public MongoDatabasePhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public MongoDatabase Set(
        ...
        MongoDatabaseDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        MongoDatabasePhysicalChildTypeConnection? PhysicalChildConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoDatabase_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoDatabase_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoDatabase_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoDatabase_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoDatabase_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? ActiveCollectionCount
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new MongoDatabaseDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new MongoDatabasePhysicalChildTypeConnection();
    ...
    public static class ListMongoDatabaseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongoDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongoDatabase> list)
        {

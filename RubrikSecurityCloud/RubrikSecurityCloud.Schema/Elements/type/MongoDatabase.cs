...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongoDatabase: IFragment, CdmHierarchyObject, HierarchyObject, MongoSourceDescendantType, MongoSourcePhysicalChildType
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int32? ProtectedCollectionCount
            // GraphQL -> protectedCollectionCount: Int! (scalar)
            if (this.ProtectedCollectionCount == null && Exploration.Includes(parent + ".protectedCollectionCount$"))
            {
                this.ProtectedCollectionCount = new System.Int32();
            }
            //      C# -> System.Int32? ReplicatedObjectCount
            // GraphQL -> replicatedObjectCount: Int! (scalar)

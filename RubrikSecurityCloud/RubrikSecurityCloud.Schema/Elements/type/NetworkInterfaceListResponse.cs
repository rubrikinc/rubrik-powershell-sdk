...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListNetworkInterfaceListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NetworkInterfaceListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<NetworkInterfaceListResponse> list)
        {

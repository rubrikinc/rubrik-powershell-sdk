...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListHierarchyObjectCommonExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HierarchyObjectCommon> list)
        {
        ...
        public static void SelectForRetrieval(this List<HierarchyObjectCommon> list)
        {

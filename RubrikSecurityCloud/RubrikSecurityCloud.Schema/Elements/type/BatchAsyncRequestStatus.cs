...
namespace RubrikSecurityCloud.Types
{
    ...
    public class BatchAsyncRequestStatus: BaseType
    {
        #region members
    ...
    public static class ListBatchAsyncRequestStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BatchAsyncRequestStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BatchAsyncRequestStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BatchAsyncRequestStatus> list)
        {

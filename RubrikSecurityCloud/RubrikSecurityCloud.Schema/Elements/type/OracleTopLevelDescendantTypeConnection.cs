...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleTopLevelDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<OracleTopLevelDescendantType> Nodes { get; set; }
    ...
    public OracleTopLevelDescendantTypeConnection Set(
        RscInterface<OracleTopLevelDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<OracleTopLevelDescendantType>();

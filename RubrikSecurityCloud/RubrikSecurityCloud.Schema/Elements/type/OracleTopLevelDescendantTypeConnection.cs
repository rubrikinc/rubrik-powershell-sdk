...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleTopLevelDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<OracleTopLevelDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "OracleTopLevelDescendantTypeConnection";
    }

    public OracleTopLevelDescendantTypeConnection Set(
        RscInterfaceList<OracleTopLevelDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<OracleTopLevelDescendantType>();
    ...
    public static class ListOracleTopLevelDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleTopLevelDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleTopLevelDescendantTypeConnection> list)
        {

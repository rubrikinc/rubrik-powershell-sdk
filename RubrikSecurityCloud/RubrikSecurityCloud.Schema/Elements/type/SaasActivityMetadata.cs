...
{
    #region SaasActivityMetadata
 
    public class SaasActivityMetadata: BaseType, ResourceMetadataUnion
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SaasActivityMetadata";
    }

    public SaasActivityMetadata Set(
    ...
    } // class SaasActivityMetadata
    
    #endregion

    public static class ListSaasActivityMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SaasActivityMetadata> list,
        ...
        public static List<string> SelectedFields(this List<SaasActivityMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SaasActivityMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SaasActivityMetadata> list)
        {

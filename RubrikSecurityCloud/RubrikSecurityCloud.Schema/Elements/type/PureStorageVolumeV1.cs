...
{
    #region PureStorageVolumeV1
 
    public class PureStorageVolumeV1: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, PureStorageArrayDescendantV1, PureStorageArrayLogicalChildType
    {
        #region members
        ...
        //      C# -> List<PureStorageProtectionGroupRefV1>? ProtectionGroupRefs
        // GraphQL -> protectionGroupRefs: [PureStorageProtectionGroupRefV1!]! (type)
        [JsonProperty("protectionGroupRefs")]
        public List<PureStorageProtectionGroupRefV1>? ProtectionGroupRefs { get; set; }
    ...
    public PureStorageVolumeV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "PureStorageVolumeV1";
    }

    public PureStorageVolumeV1 Set(
        ...
        List<PureStorageProtectionGroupRefV1>? ProtectionGroupRefs = null,
    ...
    ) 
    {
        ...
        if ( ProtectionGroupRefs != null ) {
            this.ProtectionGroupRefs = ProtectionGroupRefs;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> List<PureStorageProtectionGroupRefV1>? ProtectionGroupRefs
        // GraphQL -> protectionGroupRefs: [PureStorageProtectionGroupRefV1!]! (type)
        if (this.ProtectionGroupRefs != null) {
            var fspec = this.ProtectionGroupRefs.AsFieldSpec(conf.Child("protectionGroupRefs"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "protectionGroupRefs" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> Snappable? ReportWorkload
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> List<PureStorageProtectionGroupRefV1>? ProtectionGroupRefs
        // GraphQL -> protectionGroupRefs: [PureStorageProtectionGroupRefV1!]! (type)
        if (ec.Includes("protectionGroupRefs",false))
        {
            if(this.ProtectionGroupRefs == null) {

                this.ProtectionGroupRefs = new List<PureStorageProtectionGroupRefV1>();
                this.ProtectionGroupRefs.ApplyExploratoryFieldSpec(ec.NewChild("protectionGroupRefs"));
        ...
        else if (this.ProtectionGroupRefs != null && ec.Excludes("protectionGroupRefs",false))
        {
            this.ProtectionGroupRefs = null;
        }
        //      C# -> Snappable? ReportWorkload
        // GraphQL -> reportWorkload: Snappable (type)
    ...
    } // class PureStorageVolumeV1
    
    #endregion

    public static class ListPureStorageVolumeV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageVolumeV1> list,
        ...
        public static List<string> SelectedFields(this List<PureStorageVolumeV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PureStorageVolumeV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PureStorageVolumeV1> list)
        {

// PitRestoreMysqldbInstanceResponse.cs
//
...
{
    #region PitRestoreMysqldbInstanceResponse
    public class PitRestoreMysqldbInstanceResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PitRestoreMysqldbInstanceResponse";
    }

    public PitRestoreMysqldbInstanceResponse Set(
    ...
    } // class PitRestoreMysqldbInstanceResponse
    
    #endregion

    public static class ListPitRestoreMysqldbInstanceResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PitRestoreMysqldbInstanceResponse> list,
        ...
        public static List<string> SelectedFields(this List<PitRestoreMysqldbInstanceResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PitRestoreMysqldbInstanceResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PitRestoreMysqldbInstanceResponse> list)
        {

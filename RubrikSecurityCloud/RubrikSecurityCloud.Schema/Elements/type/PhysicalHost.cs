...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Boolean? DefaultCbt
        // GraphQL -> defaultCbt: Boolean (scalar)
        if (this.DefaultCbt == null && Exploration.Includes(parent + ".defaultCbt", true))
        {
        ...
        if (this.HostVolumes == null && Exploration.Includes(parent + ".hostVolumes"))
        {
            ...
            this.HostVolumes.ApplyExploratoryFieldSpec(parent + ".hostVolumes");
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        if (this.OracleUserDetails == null && Exploration.Includes(parent + ".oracleUserDetails"))
        {
            ...
            this.OracleUserDetails.ApplyExploratoryFieldSpec(parent + ".oracleUserDetails");
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)

    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.HostVolumes != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.HostVolumes.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
            ...
            if (this.OracleUserDetails != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.OracleUserDetails.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
            // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? DefaultCbt
            // GraphQL -> defaultCbt: Boolean (scalar)
            if (this.DefaultCbt == null && Exploration.Includes(parent + ".defaultCbt$"))
            {
                this.DefaultCbt = new System.Boolean();
            }
            //      C# -> System.String? Id
            // GraphQL -> id: UUID! (scalar)
            ...
            //      C# -> System.String? NasVendorType
            // GraphQL -> nasVendorType: String (scalar)
            if (this.NasVendorType == null && Exploration.Includes(parent + ".nasVendorType$"))
            {
            ...
            //      C# -> System.String? OsName
            // GraphQL -> osName: String (scalar)
            if (this.OsName == null && Exploration.Includes(parent + ".osName$"))
            {
            ...
            //      C# -> System.String? VfdState
            // GraphQL -> vfdState: String! (scalar)
            if (this.VfdState == null && Exploration.Includes(parent + ".vfdState$"))
            {
            ...
            //      C# -> List<CdmHostVolume>? HostVolumes
            // GraphQL -> hostVolumes: [CdmHostVolume!]! (type)
            if (this.HostVolumes == null && Exploration.Includes(parent + ".hostVolumes"))
            {
                this.HostVolumes = new List<CdmHostVolume>();
                this.HostVolumes.ApplyExploratoryFragment(parent + ".hostVolumes");
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
            ...
            //      C# -> OracleUserDetails? OracleUserDetails
            // GraphQL -> oracleUserDetails: OracleUserDetails (type)
            if (this.OracleUserDetails == null && Exploration.Includes(parent + ".oracleUserDetails"))
            {
                this.OracleUserDetails = new OracleUserDetails();
                this.OracleUserDetails.ApplyExploratoryFragment(parent + ".oracleUserDetails");
            }
            //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
            // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)

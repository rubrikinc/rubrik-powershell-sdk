...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBrowseMssqlDatabaseSnapshotReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BrowseMssqlDatabaseSnapshotReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BrowseMssqlDatabaseSnapshotReply> list)
        {

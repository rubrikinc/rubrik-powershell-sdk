...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class SnapshotSubObj: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.VolumeGroupSubObj != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.VolumeGroupSubObj.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.VolumeGroupSubObj == null && Exploration.Includes(parent + ".volumeGroupSubObj"))
            {
                ...
                this.VolumeGroupSubObj.ApplyExploratoryFragment(parent + ".volumeGroupSubObj");
            }
        }

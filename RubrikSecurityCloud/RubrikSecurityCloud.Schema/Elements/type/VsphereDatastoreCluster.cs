...
namespace Rubrik.SecurityCloud.Types
{
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? IsSdrsEnabled
            // GraphQL -> isSdrsEnabled: Boolean! (scalar)
            if (this.IsSdrsEnabled == null && Exploration.Includes(parent + ".isSdrsEnabled$"))
            {
                this.IsSdrsEnabled = new System.Boolean();
            }
            //      C# -> System.String? Name
            // GraphQL -> name: String! (scalar)
    ...
    public static class ListVsphereDatastoreClusterExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereDatastoreCluster();
            list.Add(item);

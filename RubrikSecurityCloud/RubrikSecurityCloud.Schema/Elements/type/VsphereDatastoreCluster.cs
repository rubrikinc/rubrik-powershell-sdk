...
{
    #region VsphereDatastoreCluster
 
    public class VsphereDatastoreCluster: BaseType, CdmHierarchyObject, HierarchyObject, VsphereComputeClusterDescendantType, VsphereDatacenterDescendantType, VsphereDatacenterPhysicalChildType, VsphereHostDescendantType, VsphereResourcePoolDescendantType, VsphereVcenterDescendantType, VsphereVcenterPhysicalChildType
    {
        #region members
        ...
        //      C# -> System.Boolean? IsSdrsEnabled
        // GraphQL -> isSdrsEnabled: Boolean! (scalar)
        [JsonProperty("isSdrsEnabled")]
        public System.Boolean? IsSdrsEnabled { get; set; }
        ...
        //      C# -> VsphereDatastoreClusterDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VsphereDatastoreClusterDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VsphereDatastoreClusterDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VsphereDatastoreClusterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: VsphereDatastoreClusterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public VsphereDatastoreClusterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereDatastoreCluster";
    }

    public VsphereDatastoreCluster Set(
        ...
        System.Boolean? IsSdrsEnabled = null,
        ...
        VsphereDatastoreClusterDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        VsphereDatastoreClusterPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( IsSdrsEnabled != null ) {
            this.IsSdrsEnabled = IsSdrsEnabled;
        }
        if ( Name != null ) {
            this.Name = Name;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreCluster_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreCluster_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreCluster_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreCluster_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreCluster_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int64? Capacity
        ...
        //      C# -> System.Boolean? IsSdrsEnabled
        // GraphQL -> isSdrsEnabled: Boolean! (scalar)
        if (this.IsSdrsEnabled != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isSdrsEnabled\n" ;
            } else {
                s += ind + "isSdrsEnabled\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.FreeSpace != null && ec.Excludes("freeSpace",true))
        {
            this.FreeSpace = null;
        }
        //      C# -> System.String? Id
        ...
        //      C# -> System.Boolean? IsSdrsEnabled
        // GraphQL -> isSdrsEnabled: Boolean! (scalar)
        if (ec.Includes("isSdrsEnabled",true))
        {
            if(this.IsSdrsEnabled == null) {

                this.IsSdrsEnabled = true;
        ...
        else if (this.IsSdrsEnabled != null && ec.Excludes("isSdrsEnabled",true))
        {
            this.IsSdrsEnabled = null;
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VsphereDatastoreClusterDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new VsphereDatastoreClusterPhysicalChildTypeConnection();
    ...
    } // class VsphereDatastoreCluster
    
    #endregion

    public static class ListVsphereDatastoreClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereDatastoreCluster> list,
        ...
        public static List<string> SelectedFields(this List<VsphereDatastoreCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereDatastoreCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereDatastoreCluster> list)
        {

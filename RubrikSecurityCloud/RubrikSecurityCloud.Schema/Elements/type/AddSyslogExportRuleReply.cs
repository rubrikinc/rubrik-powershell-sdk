...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAddSyslogExportRuleReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddSyslogExportRuleReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<AddSyslogExportRuleReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class RegionConnection: BaseType
    {
        #region members
        ...
        //      C# -> List<RegionEdge>? Edges
        // GraphQL -> edges: [RegionEdge!]! (type)
        [JsonProperty("edges")]
        public List<RegionEdge>? Edges { get; set; }

        //      C# -> List<Region>? Nodes
        // GraphQL -> nodes: [Region!]! (type)
        [JsonProperty("nodes")]
    ...
    public RegionConnection Set(
        System.Int32? Count = null,
        List<RegionEdge>? Edges = null,
        List<Region>? Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("edges",false))
        {
            if(this.Edges == null) {
                ...
                this.Edges = new List<RegionEdge>();
    ...
    public static class ListRegionConnectionExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RegionConnection> list,
        ...
        public static List<string> SelectedFields(this List<RegionConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RegionConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RegionConnection> list)
        {

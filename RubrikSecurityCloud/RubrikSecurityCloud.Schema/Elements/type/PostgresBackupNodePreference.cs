// PostgresBackupNodePreference.cs
//
...
{
    #region PostgresBackupNodePreference
    public class PostgresBackupNodePreference: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PostgresBackupNodePreference";
    }

    public PostgresBackupNodePreference Set(
    ...
    } // class PostgresBackupNodePreference
    
    #endregion

    public static class ListPostgresBackupNodePreferenceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgresBackupNodePreference> list,
        ...
        public static List<string> SelectedFields(this List<PostgresBackupNodePreference> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgresBackupNodePreference());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgresBackupNodePreference> list)
        {

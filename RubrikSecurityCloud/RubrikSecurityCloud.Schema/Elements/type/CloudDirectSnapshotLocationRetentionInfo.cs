// CloudDirectSnapshotLocationRetentionInfo.cs
//
...
{
    #region CloudDirectSnapshotLocationRetentionInfo
    public class CloudDirectSnapshotLocationRetentionInfo: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CloudDirectSnapshotLocationRetentionInfo";
    }

    public CloudDirectSnapshotLocationRetentionInfo Set(
    ...
    } // class CloudDirectSnapshotLocationRetentionInfo
    
    #endregion

    public static class ListCloudDirectSnapshotLocationRetentionInfoExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudDirectSnapshotLocationRetentionInfo> list,
        ...
        public static List<string> SelectedFields(this List<CloudDirectSnapshotLocationRetentionInfo> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudDirectSnapshotLocationRetentionInfo());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudDirectSnapshotLocationRetentionInfo> list)
        {

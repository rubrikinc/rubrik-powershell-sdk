...
{
    #region ActiveDirectoryForest
 
    public class ActiveDirectoryForest: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? ForestName
        // GraphQL -> forestName: String! (scalar)
        [JsonProperty("forestName")]
        public System.String? ForestName { get; set; }
        ...
        //      C# -> ActiveDirectoryForestDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: ActiveDirectoryForestDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public ActiveDirectoryForestDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> ActiveDirectoryForestPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: ActiveDirectoryForestPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public ActiveDirectoryForestPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "ActiveDirectoryForest";
    }

    public ActiveDirectoryForest Set(
        ...
        ActiveDirectoryForestDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        ActiveDirectoryForestPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? ForestName
        // GraphQL -> forestName: String! (scalar)
        if (this.ForestName != null) {
            if (conf.Flat) {
                s += conf.Prefix + "forestName\n" ;
            } else {
                s += ind + "forestName\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? ForestName
        // GraphQL -> forestName: String! (scalar)
        if (ec.Includes("forestName",true))
        {
            if(this.ForestName == null) {

                this.ForestName = "FETCH";
        ...
        else if (this.ForestName != null && ec.Excludes("forestName",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ActiveDirectoryForestDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new ActiveDirectoryForestPhysicalChildTypeConnection();
    ...
    } // class ActiveDirectoryForest
    
    #endregion

    public static class ListActiveDirectoryForestExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryForest> list,
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryForest> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ActiveDirectoryForest());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ActiveDirectoryForest> list)
        {

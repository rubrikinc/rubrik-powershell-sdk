...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.RiskSummary != null) {
            var fspec = this.RiskSummary.AsFieldSpec(conf.Child("riskSummary"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> RiskSummary? RiskSummary
        // GraphQL -> riskSummary: RiskSummary (type)
        if (ec.Includes("riskSummary",false))
        {
            if(this.RiskSummary == null) {
        ...
        else if (this.RiskSummary != null && ec.Excludes("riskSummary",false))
        {
    ...
    public static class ListGetPrincipalRiskSummaryReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetPrincipalRiskSummaryReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<GetPrincipalRiskSummaryReply> list)
        {

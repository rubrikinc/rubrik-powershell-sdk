// AzureAdPimEligibilityPrincipalObject.cs
//
...
{
    #region AzureAdPimEligibilityPrincipalObject
    public class AzureAdPimEligibilityPrincipalObject: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureAdPimEligibilityPrincipalObject";
    }

    public AzureAdPimEligibilityPrincipalObject Set(
    ...
    } // class AzureAdPimEligibilityPrincipalObject
    
    #endregion

    public static class ListAzureAdPimEligibilityPrincipalObjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureAdPimEligibilityPrincipalObject> list,
        ...
        public static List<string> SelectedFields(this List<AzureAdPimEligibilityPrincipalObject> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureAdPimEligibilityPrincipalObject());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureAdPimEligibilityPrincipalObject> list)
        {

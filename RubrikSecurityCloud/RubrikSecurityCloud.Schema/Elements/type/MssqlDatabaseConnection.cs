...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlDatabaseConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MssqlDatabaseConnection";
    }
    ...
    public static class ListMssqlDatabaseConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlDatabaseConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MssqlDatabaseConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MssqlDatabaseConnection> list)
        {

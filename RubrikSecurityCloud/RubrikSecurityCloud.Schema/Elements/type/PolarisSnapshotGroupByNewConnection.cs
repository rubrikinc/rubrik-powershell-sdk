...
namespace RubrikSecurityCloud.Types
{
    ...
    public class PolarisSnapshotGroupByNewConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PolarisSnapshotGroupByNewConnection";
    }
    ...
    public static class ListPolarisSnapshotGroupByNewConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PolarisSnapshotGroupByNewConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PolarisSnapshotGroupByNewConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PolarisSnapshotGroupByNewConnection> list)
        {

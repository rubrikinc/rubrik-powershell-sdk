...
{
    #region VsphereTagCategory
 
    public class VsphereTagCategory: BaseType, CdmHierarchyObject, HierarchyObject, VsphereVcenterDescendantType, VsphereVcenterTagChildType
    {
        #region members
        ...
        //      C# -> System.Boolean? IsFilterCategory
        // GraphQL -> isFilterCategory: Boolean! (scalar)
        [JsonProperty("isFilterCategory")]
        public System.Boolean? IsFilterCategory { get; set; }
        ...
        //      C# -> VsphereTagCategoryTagChildTypeConnection? TagChildConnection
        // GraphQL -> tagChildConnection: VsphereTagCategoryTagChildTypeConnection! (type)
        [JsonProperty("tagChildConnection")]
        public VsphereTagCategoryTagChildTypeConnection? TagChildConnection { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereTagCategory";
    }

    public VsphereTagCategory Set(
        ...
        System.Boolean? IsFilterCategory = null,
        ...
        VsphereTagCategoryTagChildTypeConnection? TagChildConnection = null,
    ...
    ) 
    {
        ...
        if ( IsFilterCategory != null ) {
            this.IsFilterCategory = IsFilterCategory;
        }
        if ( Name != null ) {
            this.Name = Name;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTagCategory_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTagCategory_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTagCategory_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTagCategory_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereTagCategory_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
        ...
        //      C# -> System.Boolean? IsFilterCategory
        // GraphQL -> isFilterCategory: Boolean! (scalar)
        if (this.IsFilterCategory != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isFilterCategory\n" ;
            } else {
                s += ind + "isFilterCategory\n" ;
            }
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? IsFilterCategory
        // GraphQL -> isFilterCategory: Boolean! (scalar)
        if (ec.Includes("isFilterCategory",true))
        {
            if(this.IsFilterCategory == null) {
        ...
        else if (this.IsFilterCategory != null && ec.Excludes("isFilterCategory",true))
        {
            this.IsFilterCategory = null;
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
        ...
        if (ec.Includes("tagChildConnection",false))
        {
            if(this.TagChildConnection == null) {
                ...
                this.TagChildConnection = new VsphereTagCategoryTagChildTypeConnection();
    ...
    } // class VsphereTagCategory
    
    #endregion

    public static class ListVsphereTagCategoryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereTagCategory> list,
        ...
        public static List<string> SelectedFields(this List<VsphereTagCategory> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereTagCategory());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereTagCategory> list)
        {

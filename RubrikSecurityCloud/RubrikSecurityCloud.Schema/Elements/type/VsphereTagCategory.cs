...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereTagCategory: IFragment, CdmHierarchyObject, HierarchyObject, VsphereVcenterDescendantType, VsphereVcenterTagChildType
    {
        #region members
        //      C# -> System.String? Id
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? IsFilterCategory
            // GraphQL -> isFilterCategory: Boolean! (scalar)
            if (this.IsFilterCategory == null && Exploration.Includes(parent + ".isFilterCategory$"))
            {
                this.IsFilterCategory = new System.Boolean();
            }
            //      C# -> System.String? Name
            // GraphQL -> name: String! (scalar)
    ...
    public static class ListVsphereTagCategoryExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereTagCategory();
            list.Add(item);

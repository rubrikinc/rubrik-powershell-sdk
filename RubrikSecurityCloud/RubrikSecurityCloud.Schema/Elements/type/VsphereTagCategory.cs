...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.TagChildConnection != null) {
            s += ind + "tagChildConnection {\n" + this.TagChildConnection.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> List<PathNode>? VsphereTagPath
        // GraphQL -> vsphereTagPath: [PathNode!]! (type)
        if (this.VsphereTagPath != null) {
            s += ind + "vsphereTagPath {\n" + this.VsphereTagPath.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        return s;
    }
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Boolean? IsFilterCategory
        // GraphQL -> isFilterCategory: Boolean! (scalar)
        if (this.IsFilterCategory == null && Exploration.Includes(parent + ".isFilterCategory", true))
        {

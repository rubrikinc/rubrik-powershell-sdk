...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoDatabasePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MongoDatabasePhysicalChildType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MongoDatabasePhysicalChildTypeConnection";
    }

    public MongoDatabasePhysicalChildTypeConnection Set(
        RscInterfaceList<MongoDatabasePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MongoDatabasePhysicalChildType>();
    ...
    public static class ListMongoDatabasePhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoDatabasePhysicalChildTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongoDatabasePhysicalChildTypeConnection> list)
        {

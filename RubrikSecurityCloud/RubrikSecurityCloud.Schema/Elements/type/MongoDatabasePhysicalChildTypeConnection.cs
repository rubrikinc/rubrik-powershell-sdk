...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoDatabasePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<MongoDatabasePhysicalChildType> Nodes { get; set; }
    ...
    public MongoDatabasePhysicalChildTypeConnection Set(
        RscInterface<MongoDatabasePhysicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<MongoDatabasePhysicalChildType>();

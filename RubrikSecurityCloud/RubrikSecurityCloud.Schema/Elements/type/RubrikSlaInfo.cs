...
{
    #region RubrikSlaInfo
    public class RubrikSlaInfo: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RubrikSlaInfo";
    }

    public RubrikSlaInfo Set(
    ...
    public static class ListRubrikSlaInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RubrikSlaInfo> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RubrikSlaInfo());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RubrikSlaInfo> list)
        {

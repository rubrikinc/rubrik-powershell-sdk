...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListClusterSlaDomainForFilterConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ClusterSlaDomainForFilterConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ClusterSlaDomainForFilterConnection> list)
        {

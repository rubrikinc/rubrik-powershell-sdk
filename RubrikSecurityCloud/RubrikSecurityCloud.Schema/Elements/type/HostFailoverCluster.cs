...
{
    #region HostFailoverCluster
 
    public class HostFailoverCluster: BaseType, CdmHierarchyObject, FailoverClusterTopLevelDescendantType, HierarchyObject
    {
        #region members
        ...
        //      C# -> GuestOsType? NodesOsType
        // GraphQL -> nodesOsType: GuestOsType (enum)
        [JsonProperty("nodesOsType")]
        public GuestOsType? NodesOsType { get; set; }
        ...
        //      C# -> List<PhysicalHost>? AllNodes
        // GraphQL -> allNodes: [PhysicalHost!]! (type)
        [JsonProperty("allNodes")]
        public List<PhysicalHost>? AllNodes { get; set; }
        ...
        //      C# -> HostFailoverClusterDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: HostFailoverClusterDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public HostFailoverClusterDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> HostFailoverClusterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: HostFailoverClusterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public HostFailoverClusterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
        ...
        //      C# -> FailoverClusterStatus? Status
        // GraphQL -> status: FailoverClusterStatus (type)
        [JsonProperty("status")]
        public FailoverClusterStatus? Status { get; set; }
    ...
    public HostFailoverCluster Set(
        ...
        List<PhysicalHost>? AllNodes = null,
        List<Org>? AllOrgs = null,
        Cluster? Cluster = null,
        HostFailoverClusterDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        HostFailoverClusterPhysicalChildTypeConnection? PhysicalChildConnection = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        SnapshotDistribution? SnapshotDistribution = null,
        FailoverClusterStatus? Status = null
    ) 
    {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> GuestOsType? NodesOsType
        // GraphQL -> nodesOsType: GuestOsType (enum)
        if (this.NodesOsType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "nodesOsType\n" ;
            } else {
                s += ind + "nodesOsType\n" ;
            }
        }
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostFailoverCluster_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostFailoverCluster_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostFailoverCluster_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostFailoverCluster_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HostFailoverCluster_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        if (this.AllNodes != null) {
            var fspec = this.AllNodes.AsFieldSpec(conf.Child("allNodes"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> GuestOsType? NodesOsType
        // GraphQL -> nodesOsType: GuestOsType (enum)
        if (ec.Includes("nodesOsType",true))
        {
            if(this.NodesOsType == null) {

                this.NodesOsType = new GuestOsType();
        ...
        else if (this.NodesOsType != null && ec.Excludes("nodesOsType",true))
        {
            this.NodesOsType = null;
        }
        //      C# -> HierarchyObjectTypeEnum? ObjectType
        // GraphQL -> objectType: HierarchyObjectTypeEnum! (enum)
        ...
        //      C# -> List<PhysicalHost>? AllNodes
        // GraphQL -> allNodes: [PhysicalHost!]! (type)
        if (ec.Includes("allNodes",false))
        {
            if(this.AllNodes == null) {

                this.AllNodes = new List<PhysicalHost>();
                this.AllNodes.ApplyExploratoryFieldSpec(ec.NewChild("allNodes"));
        ...
        else if (this.AllNodes != null && ec.Excludes("allNodes",false))
        {
            this.AllNodes = null;
        }
        //      C# -> List<Org>? AllOrgs
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new HostFailoverClusterDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new HostFailoverClusterPhysicalChildTypeConnection();
        ...
        if (ec.Includes("status",false))
        {
            if(this.Status == null) {
                ...
                this.Status = new FailoverClusterStatus();
    ...
    public static class ListHostFailoverClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HostFailoverCluster> list,
        ...
        public static List<string> SelectedFields(this List<HostFailoverCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HostFailoverCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HostFailoverCluster> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> GuestOsType? NodesOsType
        // GraphQL -> nodesOsType: GuestOsType (enum)
        if (this.NodesOsType == null && Exploration.Includes(parent + ".nodesOsType", true))
        {
        ...
        //      C# -> List<PhysicalHost>? AllNodes
        // GraphQL -> allNodes: [PhysicalHost!]! (type)
        if (this.AllNodes == null && Exploration.Includes(parent + ".allNodes"))
        {
            this.AllNodes = new List<PhysicalHost>();
            this.AllNodes.ApplyExploratoryFieldSpec(parent + ".allNodes");
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostFailoverCluster: IFragment, CdmHierarchyObject, HierarchyObject, FailoverClusterTopLevelDescendantType
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.AllNodes != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.AllNodes.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> List<Org>? AllOrgs
            // GraphQL -> allOrgs: [Org!]! (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.AllNodes == null && Exploration.Includes(parent + ".allNodes"))
            {
                ...
                this.AllNodes.ApplyExploratoryFragment(parent + ".allNodes");
            }
            //      C# -> List<Org>? AllOrgs
            // GraphQL -> allOrgs: [Org!]! (type)
            ...
            //      C# -> GuestOsType? NodesOsType
            // GraphQL -> nodesOsType: GuestOsType (enum)
            if (this.NodesOsType == null && Exploration.Includes(parent + ".nodesOsType$"))
            {
    ...
    public static class ListHostFailoverClusterExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HostFailoverCluster();
            list.Add(item);

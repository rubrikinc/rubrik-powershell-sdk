...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVmwareNetworkDeviceInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VmwareNetworkDeviceInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<VmwareNetworkDeviceInfo> list)
        {

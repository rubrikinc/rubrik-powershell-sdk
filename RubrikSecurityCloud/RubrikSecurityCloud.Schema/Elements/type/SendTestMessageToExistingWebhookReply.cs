// SendTestMessageToExistingWebhookReply.cs
//
...
{
    #region SendTestMessageToExistingWebhookReply
    public class SendTestMessageToExistingWebhookReply: BaseType
    {
        #region members
        ...
        public WebhookStatusV2? WebhookStatus { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "SendTestMessageToExistingWebhookReply";
    }

    public SendTestMessageToExistingWebhookReply Set(
        WebhookStatusV2? WebhookStatus = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("webhookStatus",true))
        {
            if(this.WebhookStatus == null) {
                ...
                this.WebhookStatus = new WebhookStatusV2();
    ...
    } // class SendTestMessageToExistingWebhookReply
    
    #endregion

    public static class ListSendTestMessageToExistingWebhookReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SendTestMessageToExistingWebhookReply> list)
        {

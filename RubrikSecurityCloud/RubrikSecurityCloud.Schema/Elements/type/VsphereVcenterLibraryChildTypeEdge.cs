...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereVcenterLibraryChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereVcenterLibraryChildType> Node { get; set; }
    ...
    public VsphereVcenterLibraryChildTypeEdge Set(
        RscInterface<VsphereVcenterLibraryChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereVcenterLibraryChildType>();

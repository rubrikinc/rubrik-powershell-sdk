// ActiveDirectorySnapshotStats.cs
//
...
{
    #region ActiveDirectorySnapshotStats
    public class ActiveDirectorySnapshotStats: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ActiveDirectorySnapshotStats";
    }

    public ActiveDirectorySnapshotStats Set(
    ...
    } // class ActiveDirectorySnapshotStats
    
    #endregion

    public static class ListActiveDirectorySnapshotStatsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectorySnapshotStats> list,
        ...
        public static List<string> SelectedFields(this List<ActiveDirectorySnapshotStats> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ActiveDirectorySnapshotStats());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ActiveDirectorySnapshotStats> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "ExchangeLiveMountConnection";
    }
    ...
    public static class ListExchangeLiveMountConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeLiveMountConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ExchangeLiveMountConnection> list)
        {

// PureStorageProtectionGroupV1.cs
//
...
{
    #region PureStorageProtectionGroupV1
 
    public class PureStorageProtectionGroupV1: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, PureStorageArrayDescendantV1, PureStorageArrayLogicalChildType
    {
        #region members
        ...
        //      C# -> List<System.String>? ExcludedVolumes
        // GraphQL -> excludedVolumes: [UUID!]! (scalar)
        [JsonProperty("excludedVolumes")]
        public List<System.String>? ExcludedVolumes { get; set; }
        ...
        //      C# -> System.Int32? NumVolumes
        // GraphQL -> numVolumes: Int! (scalar)
        [JsonProperty("numVolumes")]
        public System.Int32? NumVolumes { get; set; }
        ...
        //      C# -> System.String? PureStorageId
        // GraphQL -> pureStorageId: String! (scalar)
        [JsonProperty("pureStorageId")]
        public System.String? PureStorageId { get; set; }
        ...
        //      C# -> PureStorageVolumeV1Connection? Volumes
        // GraphQL -> volumes: PureStorageVolumeV1Connection! (type)
        [JsonProperty("volumes")]
        public PureStorageVolumeV1Connection? Volumes { get; set; }
    ...
    public class InlineVars {
        ...
        public RscGqlVars Volumes { get; set; }
        ...
        public InlineVars() {
            ...
            Tuple<string, string>[] volumesArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
            ...
            this.Volumes =
                new RscGqlVars(null, volumesArgs, null, true);
        }
    }

    public PureStorageProtectionGroupV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "PureStorageProtectionGroupV1";
    }

    public PureStorageProtectionGroupV1 Set(
        ...
        PureStorageVolumeV1Connection? Volumes = null
    ) 
    {
        ...
        if ( PureStorageId != null ) {
            this.PureStorageId = PureStorageId;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.Int32? NumVolumes
        // GraphQL -> numVolumes: Int! (scalar)
        if (this.NumVolumes != null) {
            if (conf.Flat) {
                s += conf.Prefix + "numVolumes\n" ;
            } else {
                s += ind + "numVolumes\n" ;
            }
        }
        ...
        //      C# -> System.String? PureStorageId
        // GraphQL -> pureStorageId: String! (scalar)
        if (this.PureStorageId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "pureStorageId\n" ;
            } else {
                s += ind + "pureStorageId\n" ;
            }
        }
        ...
        if (this.Volumes != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "volumes" + "\n(" + this.Vars.Volumes.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        return s;
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.ArrayId != null && ec.Excludes("arrayId",true))
        {
            this.ArrayId = null;
        }
        //      C# -> System.String? CdmId
        ...
        //      C# -> List<System.String>? ExcludedVolumes
        // GraphQL -> excludedVolumes: [UUID!]! (scalar)
        if (ec.Includes("excludedVolumes",true))
        {
            if(this.ExcludedVolumes == null) {

                this.ExcludedVolumes = new List<System.String>();
        ...
        else if (this.ExcludedVolumes != null && ec.Excludes("excludedVolumes",true))
        {
        ...
        //      C# -> System.Int32? NumVolumes
        // GraphQL -> numVolumes: Int! (scalar)
        if (ec.Includes("numVolumes",true))
        {
            if(this.NumVolumes == null) {

                this.NumVolumes = Int32.MinValue;
        ...
        else if (this.NumVolumes != null && ec.Excludes("numVolumes",true))
        {
        ...
        //      C# -> System.String? PureStorageId
        // GraphQL -> pureStorageId: String! (scalar)
        if (ec.Includes("pureStorageId",true))
        {
            if(this.PureStorageId == null) {

                this.PureStorageId = "FETCH";
        ...
        else if (this.PureStorageId != null && ec.Excludes("pureStorageId",true))
        {
            this.PureStorageId = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        if (ec.Includes("volumes",false))
        {
            if(this.Volumes == null) {
                ...
                this.Volumes = new PureStorageVolumeV1Connection();
    ...
    } // class PureStorageProtectionGroupV1
    
    #endregion

    public static class ListPureStorageProtectionGroupV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageProtectionGroupV1> list,
        ...
        public static List<string> SelectedFields(this List<PureStorageProtectionGroupV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PureStorageProtectionGroupV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PureStorageProtectionGroupV1> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSourceRecoverySpecsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SourceRecoverySpecsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<SourceRecoverySpecsReply> list)
        {

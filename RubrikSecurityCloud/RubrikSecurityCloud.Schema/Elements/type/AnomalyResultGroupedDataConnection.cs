...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAnomalyResultGroupedDataConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnomalyResultGroupedDataConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AnomalyResultGroupedDataConnection> list)
        {

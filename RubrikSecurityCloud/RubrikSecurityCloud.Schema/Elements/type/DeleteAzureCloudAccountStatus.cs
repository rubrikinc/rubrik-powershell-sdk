...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDeleteAzureCloudAccountStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DeleteAzureCloudAccountStatus> list)
        {
        ...
        public static void SelectForRetrieval(this List<DeleteAzureCloudAccountStatus> list)
        {

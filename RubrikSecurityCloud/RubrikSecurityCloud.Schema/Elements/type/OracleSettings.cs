...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleSettings: BaseType
    {
        #region members
    ...
    public static class ListOracleSettingsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleSettings> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OracleSettings());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OracleSettings> list)
        {

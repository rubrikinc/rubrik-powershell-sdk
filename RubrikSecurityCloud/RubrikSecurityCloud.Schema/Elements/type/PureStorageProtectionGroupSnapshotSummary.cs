// PureStorageProtectionGroupSnapshotSummary.cs
//
...
{
    #region PureStorageProtectionGroupSnapshotSummary
    public class PureStorageProtectionGroupSnapshotSummary: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PureStorageProtectionGroupSnapshotSummary";
    }

    public PureStorageProtectionGroupSnapshotSummary Set(
    ...
    } // class PureStorageProtectionGroupSnapshotSummary
    
    #endregion

    public static class ListPureStorageProtectionGroupSnapshotSummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PureStorageProtectionGroupSnapshotSummary> list,
        ...
        public static List<string> SelectedFields(this List<PureStorageProtectionGroupSnapshotSummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PureStorageProtectionGroupSnapshotSummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PureStorageProtectionGroupSnapshotSummary> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ValidReplicationTarget: BaseType
    {
        #region members
    ...
    public static class ListValidReplicationTargetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ValidReplicationTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ValidReplicationTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ValidReplicationTarget> list)
        {

...
{
    #region NutanixPrismCentral
 
    public class NutanixPrismCentral: BaseType, CdmHierarchyObject, HierarchyObject, NutanixMultiClusterObjectType, NutanixTopLevelDescendantType
    {
        #region members
        ...
        public RscInterface<CdmHierarchyObject> DuplicateObjects { get; set; }
        ...
        //      C# -> List<System.String>? NutanixClusterIds
        // GraphQL -> nutanixClusterIds: [String!]! (scalar)
        [JsonProperty("nutanixClusterIds")]
        public List<System.String>? NutanixClusterIds { get; set; }
        ...
        //      C# -> NutanixPrismCentralDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: NutanixPrismCentralDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public NutanixPrismCentralDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> NutanixPrismCentralLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: NutanixPrismCentralLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public NutanixPrismCentralLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> CdmHierarchyObjectConnection? NutanixClusters
    ...
    public class InlineVars {
        ...
        public RscGqlVars NutanixClusters { get; set; }
        ...
        public InlineVars() {
            ...
            this.NutanixClusters =
                new RscGqlVars(null, nutanixClustersArgs, null, true);
        }
    }

    public NutanixPrismCentral()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "NutanixPrismCentral";
    }

    public NutanixPrismCentral Set(
        List<Operation>? AuthorizedOperations = null,
        HierarchyObjectTypeEnum? ObjectType = null,
        SlaAssignmentTypeEnum? SlaAssignment = null,
        RscInterface<SlaDomain> ConfiguredSlaDomain = null,
        RscInterface<CdmHierarchyObject> DuplicateObjects = null,
        ...
        NutanixPrismCentralDescendantTypeConnection? DescendantConnection = null,
    ...
    ) 
    {
        ...
        if ( NutanixClusterIds != null ) {
            this.NutanixClusterIds = NutanixClusterIds;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> List<System.String>? NutanixClusterIds
        // GraphQL -> nutanixClusterIds: [String!]! (scalar)
        if (this.NutanixClusterIds != null) {
            if (conf.Flat) {
                s += conf.Prefix + "nutanixClusterIds\n" ;
            } else {
                s += ind + "nutanixClusterIds\n" ;
            }
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<System.String>? NutanixClusterIds
        // GraphQL -> nutanixClusterIds: [String!]! (scalar)
        if (ec.Includes("nutanixClusterIds",true))
        {
            if(this.NutanixClusterIds == null) {

                this.NutanixClusterIds = new List<System.String>();
        ...
        else if (this.NutanixClusterIds != null && ec.Excludes("nutanixClusterIds",true))
        {
            this.NutanixClusterIds = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new NutanixPrismCentralDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new NutanixPrismCentralLogicalChildTypeConnection();
        ...
        if (ec.Includes("nutanixClusters",false))
        {
            if(this.NutanixClusters == null) {
                ...
                this.NutanixClusters = new CdmHierarchyObjectConnection();
    ...
    public static class ListNutanixPrismCentralExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixPrismCentral> list,
        ...
        public static List<string> SelectedFields(this List<NutanixPrismCentral> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NutanixPrismCentral());
            }

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Boolean? ContainsHadrDatabase
        // GraphQL -> containsHadrDatabase: Boolean! (scalar)
        if (this.ContainsHadrDatabase == null && Exploration.Includes(parent + ".containsHadrDatabase", true))
        {
        ...
        //      C# -> DateTime? LastSyncTime
        // GraphQL -> lastSyncTime: DateTime (scalar)
        if (this.LastSyncTime == null && Exploration.Includes(parent + ".lastSyncTime", true))
        {

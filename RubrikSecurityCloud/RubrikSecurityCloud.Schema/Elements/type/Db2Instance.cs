...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class Db2Instance: IFragment, CdmHierarchyObject, HierarchyObject
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? ContainsHadrDatabase
            // GraphQL -> containsHadrDatabase: Boolean! (scalar)
            if (this.ContainsHadrDatabase == null && Exploration.Includes(parent + ".containsHadrDatabase$"))
            {
                this.ContainsHadrDatabase = new System.Boolean();
            }
            //      C# -> System.String? Id
            // GraphQL -> id: UUID! (scalar)
            ...
            //      C# -> DateTime? LastSyncTime
            // GraphQL -> lastSyncTime: DateTime (scalar)
            if (this.LastSyncTime == null && Exploration.Includes(parent + ".lastSyncTime$"))
            {

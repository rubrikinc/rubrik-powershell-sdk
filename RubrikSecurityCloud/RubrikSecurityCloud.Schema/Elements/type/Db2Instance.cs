...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2Instance: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> Db2Status? Status
        // GraphQL -> status: Db2Status! (enum)
        [JsonProperty("status")]
        public Db2Status? Status { get; set; }
        ...
        //      C# -> System.Boolean? ContainsHadrDatabase
        // GraphQL -> containsHadrDatabase: Boolean! (scalar)
        [JsonProperty("containsHadrDatabase")]
        public System.Boolean? ContainsHadrDatabase { get; set; }
        ...
        //      C# -> Db2InstanceDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: Db2InstanceDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public Db2InstanceDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> Db2InstancePhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: Db2InstancePhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public Db2InstancePhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public Db2Instance Set(
        ...
        System.Boolean? ContainsHadrDatabase = null,
        ...
        Db2InstancePhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( ContainsHadrDatabase != null ) {
            this.ContainsHadrDatabase = ContainsHadrDatabase;
        }
        if ( Id != null ) {
            this.Id = Id;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.Boolean? ContainsHadrDatabase
        // GraphQL -> containsHadrDatabase: Boolean! (scalar)
        if (this.ContainsHadrDatabase != null) {
            if (conf.Flat) {
                s += conf.Prefix + "containsHadrDatabase\n" ;
            } else {
                s += ind + "containsHadrDatabase\n" ;
            }
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? ContainsHadrDatabase
        // GraphQL -> containsHadrDatabase: Boolean! (scalar)
        if (ec.Includes("containsHadrDatabase",true))
        {
            if(this.ContainsHadrDatabase == null) {

                this.ContainsHadrDatabase = true;
        ...
        else if (this.ContainsHadrDatabase != null && ec.Excludes("containsHadrDatabase",true))
        {
            this.ContainsHadrDatabase = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
        ...
        //      C# -> DateTime? LastSyncTime
        // GraphQL -> lastSyncTime: DateTime (scalar)
        if (ec.Includes("lastSyncTime",true))
        {
            if(this.LastSyncTime == null) {
        ...
        else if (this.LastSyncTime != null && ec.Excludes("lastSyncTime",true))
        {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new Db2InstanceDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new Db2InstancePhysicalChildTypeConnection();
    ...
    public static class ListDb2InstanceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2Instance> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new Db2Instance());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<Db2Instance> list)
        {

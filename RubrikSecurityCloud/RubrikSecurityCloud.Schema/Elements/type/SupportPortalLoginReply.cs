...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "SupportPortalLoginReply";
    }
    ...
    public static class ListSupportPortalLoginReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SupportPortalLoginReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<SupportPortalLoginReply> list)
        {

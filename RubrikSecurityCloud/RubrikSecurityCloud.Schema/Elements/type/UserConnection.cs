...
namespace RubrikSecurityCloud.Types
{
    ...
    public class UserConnection: BaseType
    {
        #region members
        ...
        //      C# -> List<UserEdge>? Edges
        // GraphQL -> edges: [UserEdge!]! (type)
        [JsonProperty("edges")]
        public List<UserEdge>? Edges { get; set; }

        //      C# -> List<User>? Nodes
        // GraphQL -> nodes: [User!]! (type)
        [JsonProperty("nodes")]
    ...
    public UserConnection Set(
        System.Int32? Count = null,
        List<UserEdge>? Edges = null,
        List<User>? Nodes = null,
    ...
    public static class ListUserConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UserConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UserConnection> list)
        {

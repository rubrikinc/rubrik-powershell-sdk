// StartInPlaceDataMaskingReply.cs
//
...
{
    #region StartInPlaceDataMaskingReply
    public class StartInPlaceDataMaskingReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "StartInPlaceDataMaskingReply";
    }

    public StartInPlaceDataMaskingReply Set(
    ...
    } // class StartInPlaceDataMaskingReply
    
    #endregion

    public static class ListStartInPlaceDataMaskingReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<StartInPlaceDataMaskingReply> list,
        ...
        public static List<string> SelectedFields(this List<StartInPlaceDataMaskingReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new StartInPlaceDataMaskingReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<StartInPlaceDataMaskingReply> list)
        {

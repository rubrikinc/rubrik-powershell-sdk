...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FinalizeAwsCloudAccountDeletionReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "FinalizeAwsCloudAccountDeletionReply";
    }
    ...
    public static class ListFinalizeAwsCloudAccountDeletionReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FinalizeAwsCloudAccountDeletionReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FinalizeAwsCloudAccountDeletionReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FinalizeAwsCloudAccountDeletionReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRefreshVcdInstanceReplyTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RefreshVcdInstanceReplyType> list)
        {
        ...
        public static void SelectForRetrieval(this List<RefreshVcdInstanceReplyType> list)
        {

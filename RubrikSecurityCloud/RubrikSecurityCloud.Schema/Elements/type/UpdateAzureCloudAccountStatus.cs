...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateAzureCloudAccountStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateAzureCloudAccountStatus> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateAzureCloudAccountStatus> list)
        {

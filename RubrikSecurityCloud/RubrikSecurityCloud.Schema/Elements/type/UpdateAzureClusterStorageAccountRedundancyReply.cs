// UpdateAzureClusterStorageAccountRedundancyReply.cs
//
...
{
    #region UpdateAzureClusterStorageAccountRedundancyReply
    public class UpdateAzureClusterStorageAccountRedundancyReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UpdateAzureClusterStorageAccountRedundancyReply";
    }

    public UpdateAzureClusterStorageAccountRedundancyReply Set(
    ...
    } // class UpdateAzureClusterStorageAccountRedundancyReply
    
    #endregion

    public static class ListUpdateAzureClusterStorageAccountRedundancyReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<UpdateAzureClusterStorageAccountRedundancyReply> list,
        ...
        public static List<string> SelectedFields(this List<UpdateAzureClusterStorageAccountRedundancyReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UpdateAzureClusterStorageAccountRedundancyReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UpdateAzureClusterStorageAccountRedundancyReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListO365OnedriveConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365OnedriveConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365OnedriveConnection> list)
        {

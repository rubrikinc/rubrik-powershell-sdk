...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CassandraSourceEdge: BaseType
    {
        #region members
    ...
    public static class ListCassandraSourceEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourceEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CassandraSourceEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CassandraSourceEdge> list)
        {

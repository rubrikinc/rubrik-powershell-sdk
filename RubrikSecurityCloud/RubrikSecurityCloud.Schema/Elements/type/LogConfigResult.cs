...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class LogConfigResult: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.SlaLogFrequencyConfig != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.SlaLogFrequencyConfig.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.SlaLogFrequencyConfig == null && Exploration.Includes(parent + ".slaLogFrequencyConfig"))
            {
                ...
                this.SlaLogFrequencyConfig.ApplyExploratoryFragment(parent + ".slaLogFrequencyConfig");
            }
        }

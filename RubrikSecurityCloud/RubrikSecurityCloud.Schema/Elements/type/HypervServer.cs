...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HypervServer: BaseType, CdmHierarchyObject, HierarchyObject, HyperVclusterDescendantType, HyperVclusterLogicalChildType, HyperVscvmmDescendantType, HyperVscvmmLogicalChildType, HypervTopLevelDescendantType, PhysicalHostDescendantType, PhysicalHostPhysicalChildType
    {
        #region members
        ...
        //      C# -> HypervServerDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: HypervServerDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public HypervServerDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> HypervServerLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: HypervServerLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public HypervServerLogicalChildTypeConnection? LogicalChildConnection { get; set; }
    ...
    public HypervServer Set(
        ...
        HypervServerDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        HypervServerLogicalChildTypeConnection? LogicalChildConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HypervServer_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HypervServer_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HypervServer_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HypervServer_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "HypervServer_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new HypervServerDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new HypervServerLogicalChildTypeConnection();
    ...
    public static class ListHypervServerExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HypervServer> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HypervServer());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HypervServer> list)
        {

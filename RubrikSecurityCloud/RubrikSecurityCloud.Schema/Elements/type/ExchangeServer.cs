...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.ExchangeDag != null) {
            var fspec = this.ExchangeDag.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                s += ind + "exchangeDag {\n" + fspec + ind + "}\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? HasVgConflict
        // GraphQL -> hasVgConflict: Boolean! (scalar)
        if (this.HasVgConflict == null && ec.Includes("hasVgConflict",true))
        {
        ...
        //      C# -> System.Int32? TotalDbs
        // GraphQL -> totalDbs: Int! (scalar)
        if (this.TotalDbs == null && ec.Includes("totalDbs",true))
        {
        ...
        //      C# -> System.Boolean? VgConflictResolvedByUser
        // GraphQL -> vgConflictResolvedByUser: Boolean! (scalar)
        if (this.VgConflictResolvedByUser == null && ec.Includes("vgConflictResolvedByUser",true))
        {
        ...
        //      C# -> ExchangeDag? ExchangeDag
        // GraphQL -> exchangeDag: ExchangeDag (type)
        if (this.ExchangeDag == null && ec.Includes("exchangeDag",false))
        {

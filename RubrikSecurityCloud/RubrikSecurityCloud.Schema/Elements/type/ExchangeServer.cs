...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class ExchangeServer: IFragment, CdmHierarchyObject, HierarchyObject, PhysicalHostDescendantType, PhysicalHostPhysicalChildType
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.ExchangeDag != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.ExchangeDag.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> PhysicalHost? Host
            // GraphQL -> host: PhysicalHost! (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? HasVgConflict
            // GraphQL -> hasVgConflict: Boolean! (scalar)
            if (this.HasVgConflict == null && Exploration.Includes(parent + ".hasVgConflict$"))
            {
                this.HasVgConflict = new System.Boolean();
            }
            //      C# -> System.String? Id
            // GraphQL -> id: UUID! (scalar)
            ...
            //      C# -> System.Int32? TotalDbs
            // GraphQL -> totalDbs: Int! (scalar)
            if (this.TotalDbs == null && Exploration.Includes(parent + ".totalDbs$"))
            {
            ...
            //      C# -> System.Boolean? VgConflictResolvedByUser
            // GraphQL -> vgConflictResolvedByUser: Boolean! (scalar)
            if (this.VgConflictResolvedByUser == null && Exploration.Includes(parent + ".vgConflictResolvedByUser$"))
            {
                this.VgConflictResolvedByUser = new System.Boolean();
            }
            //      C# -> List<Org>? AllOrgs
            // GraphQL -> allOrgs: [Org!]! (type)
            ...
            if (this.ExchangeDag == null && Exploration.Includes(parent + ".exchangeDag"))
            {
                ...
                this.ExchangeDag.ApplyExploratoryFragment(parent + ".exchangeDag");
            }
            //      C# -> PhysicalHost? Host
            // GraphQL -> host: PhysicalHost! (type)

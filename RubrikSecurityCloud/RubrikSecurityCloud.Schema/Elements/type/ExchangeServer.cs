...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeServer_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeServer_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeServer_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeServer_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeServer_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        if (this.VgConflictResolvedByUser != null) {
            if (conf.Flat) {
                s += conf.Prefix + "vgConflictResolvedByUser\n" ;
            } else {
        ...
        if (this.ExchangeDag != null) {
            var fspec = this.ExchangeDag.AsFieldSpec(conf.Child("exchangeDag"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? HasVgConflict
        // GraphQL -> hasVgConflict: Boolean! (scalar)
        if (ec.Includes("hasVgConflict",true))
        {
            if(this.HasVgConflict == null) {
        ...
        else if (this.HasVgConflict != null && ec.Excludes("hasVgConflict",true))
        {
            this.HasVgConflict = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
        ...
        //      C# -> System.Int32? TotalDbs
        // GraphQL -> totalDbs: Int! (scalar)
        if (ec.Includes("totalDbs",true))
        {
            if(this.TotalDbs == null) {

                this.TotalDbs = Int32.MinValue;
        ...
        else if (this.TotalDbs != null && ec.Excludes("totalDbs",true))
        {
            this.TotalDbs = null;
        }
        //      C# -> System.String? Version
        ...
        //      C# -> System.Boolean? VgConflictResolvedByUser
        // GraphQL -> vgConflictResolvedByUser: Boolean! (scalar)
        if (ec.Includes("vgConflictResolvedByUser",true))
        {
            if(this.VgConflictResolvedByUser == null) {
        ...
        else if (this.VgConflictResolvedByUser != null && ec.Excludes("vgConflictResolvedByUser",true))
        {
            this.VgConflictResolvedByUser = null;
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        //      C# -> ExchangeDag? ExchangeDag
        // GraphQL -> exchangeDag: ExchangeDag (type)
        if (ec.Includes("exchangeDag",false))
        {
            if(this.ExchangeDag == null) {

                this.ExchangeDag = new ExchangeDag();
                this.ExchangeDag.ApplyExploratoryFieldSpec(ec.NewChild("exchangeDag"));
    ...
    public static class ListExchangeServerExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeServer> list)
        {
        ...
        public static void SelectForRetrieval(this List<ExchangeServer> list)
        {

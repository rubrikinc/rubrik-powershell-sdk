...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereDatacenterPhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereDatacenterPhysicalChildType> Node { get; set; }
    ...
    public VsphereDatacenterPhysicalChildTypeEdge Set(
        RscInterface<VsphereDatacenterPhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereDatacenterPhysicalChildType>();

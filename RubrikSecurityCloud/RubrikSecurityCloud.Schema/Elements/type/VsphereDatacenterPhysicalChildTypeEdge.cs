...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereDatacenterPhysicalChildTypeEdge: BaseType
    {
        #region members
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatacenterPhysicalChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<VsphereDatacenterPhysicalChildType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (VsphereDatacenterPhysicalChildType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    public static class ListVsphereDatacenterPhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterPhysicalChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereDatacenterPhysicalChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereDatacenterPhysicalChildTypeEdge> list)
        {

...
{
    #region AwsSubnet
    public class AwsSubnet: BaseType
    {
        #region members
    ...
    public static class ListAwsSubnetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsSubnet> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsSubnet> list)
        {

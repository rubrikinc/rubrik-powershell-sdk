...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDbLogReportSummaryListReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DbLogReportSummaryListReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DbLogReportSummaryListReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListPolarisSnapshotEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PolarisSnapshotEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<PolarisSnapshotEdge> list)
        {

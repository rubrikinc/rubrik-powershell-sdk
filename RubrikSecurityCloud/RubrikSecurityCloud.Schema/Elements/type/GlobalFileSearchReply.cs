...
{
    #region GlobalFileSearchReply
    public class GlobalFileSearchReply: BaseType
    {
        #region members
        ...
        //      C# -> List<GlobalSearchFile>? Data
        // GraphQL -> data: [GlobalSearchFile!]! (type)
        [JsonProperty("data")]
        public List<GlobalSearchFile>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "GlobalFileSearchReply";
    }

    public GlobalFileSearchReply Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<GlobalSearchFile>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<GlobalSearchFile>();
    ...
    } // class GlobalFileSearchReply
    
    #endregion

    public static class ListGlobalFileSearchReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GlobalFileSearchReply> list,
        ...
        public static List<string> SelectedFields(this List<GlobalFileSearchReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GlobalFileSearchReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GlobalFileSearchReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.TagRules != null) {
            var fspec = this.TagRules.AsFieldSpec(conf.Child("tagRules"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.TagRules != null && ec.Excludes("tagRules",false))
        {
            this.TagRules = null;
        }
    }
    ...
    public static class ListGetCloudNativeTagRulesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetCloudNativeTagRulesReply> list)
        {

...
{
    #region M365BackupStorageOnedrive
 
    public class M365BackupStorageOnedrive: BaseType, HierarchyObject, HierarchySnappable, MicrosoftOnedrive, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public M365BackupStorageOnedrive()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "M365BackupStorageOnedrive";
    }
    ...
    } // class M365BackupStorageOnedrive
    
    #endregion

    public static class ListM365BackupStorageOnedriveExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<M365BackupStorageOnedrive> list,
        ...
        public static List<string> SelectedFields(this List<M365BackupStorageOnedrive> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new M365BackupStorageOnedrive());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<M365BackupStorageOnedrive> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ManagedVolumeEdge: BaseType
    {
        #region members
    ...
    public static class ListManagedVolumeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ManagedVolumeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ManagedVolumeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolumeLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<NasVolumeLogicalChildType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "NasVolumeLogicalChildTypeEdge";
    }

    public NasVolumeLogicalChildTypeEdge Set(
        RscInterface<NasVolumeLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<NasVolumeLogicalChildType>();
    ...
    public static class ListNasVolumeLogicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasVolumeLogicalChildTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<NasVolumeLogicalChildTypeEdge> list)
        {

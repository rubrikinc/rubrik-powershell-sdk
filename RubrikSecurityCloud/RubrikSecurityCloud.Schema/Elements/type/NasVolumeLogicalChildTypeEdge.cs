...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class NasVolumeLogicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (NasVolumeLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(NasVolumeLogicalChildType));
    ...
    public static class ListNasVolumeLogicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new NasVolumeLogicalChildTypeEdge();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> ReportVersionType? ReportVersionField
        // GraphQL -> reportVersion: ReportVersionType! (enum)
        if (ec.Includes("reportVersion",true))
        {
            if(this.ReportVersionField == null) {
        ...
        else if (this.ReportVersionField != null && ec.Excludes("reportVersion",true))
        {
            this.ReportVersionField = null;
        }
    }
    ...
    public static class ListReportVersionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReportVersion> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReportVersion> list)
        {

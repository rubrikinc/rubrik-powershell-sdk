...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HypervServerDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HypervServerDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HypervServerDescendantType));
    ...
    public static class ListHypervServerDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HypervServerDescendantTypeEdge();
            list.Add(item);

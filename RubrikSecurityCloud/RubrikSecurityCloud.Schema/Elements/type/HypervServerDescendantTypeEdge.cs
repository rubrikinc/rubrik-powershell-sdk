...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HypervServerDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HypervServerDescendantType> Node { get; set; }
    ...
    public HypervServerDescendantTypeEdge Set(
        RscInterface<HypervServerDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HypervServerDescendantType>();

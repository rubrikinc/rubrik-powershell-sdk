// AzureNativeResourceGroupBase.cs
//
...
{
    #region AzureNativeResourceGroupBase
 
    public class AzureNativeResourceGroupBase: BaseType, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public AzureNativeResourceGroupBase()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "AzureNativeResourceGroupBase";
    }

    public AzureNativeResourceGroupBase Set(
    ...
    } // class AzureNativeResourceGroupBase
    
    #endregion

    public static class ListAzureNativeResourceGroupBaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureNativeResourceGroupBase> list,
        ...
        public static List<string> SelectedFields(this List<AzureNativeResourceGroupBase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureNativeResourceGroupBase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureNativeResourceGroupBase> list)
        {

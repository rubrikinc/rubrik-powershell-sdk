...
{
    #region ProxmoxNodeV1
 
    public class ProxmoxNodeV1: BaseType, CdmHierarchyObject, HierarchyObject, ProxmoxClusterDescendant, ProxmoxClusterPhysicalChildType, ProxmoxEnvironmentDescendant, ProxmoxEnvironmentPhysicalChildType
    {
        #region members
        ...
        //      C# -> System.Int32? NodeId
        // GraphQL -> nodeId: Int! (scalar)
        [JsonProperty("nodeId")]
        ...
        // GraphQL -> proxmoxClusterId: String! (scalar)
        [JsonProperty("proxmoxClusterId")]
        public System.String? ProxmoxClusterId { get; set; }

        //      C# -> System.String? ProxmoxEnvironmentId
        // GraphQL -> proxmoxEnvironmentId: String! (scalar)
        [JsonProperty("proxmoxEnvironmentId")]
        public System.String? ProxmoxEnvironmentId { get; set; }

        //      C# -> System.Boolean? RbsConfigured
        // GraphQL -> rbsConfigured: Boolean! (scalar)
        [JsonProperty("rbsConfigured")]
        public System.Boolean? RbsConfigured { get; set; }
        ...
        //      C# -> ProxmoxNodeDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: ProxmoxNodeDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public ProxmoxNodeDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> ProxmoxNodePhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: ProxmoxNodePhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public ProxmoxNodePhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
        ...
        //      C# -> List<ProxmoxStorageDomain>? StorageDomains
        // GraphQL -> storageDomains: [ProxmoxStorageDomain!]! (type)
        [JsonProperty("storageDomains")]
        public List<ProxmoxStorageDomain>? StorageDomains { get; set; }
    ...
    public ProxmoxNodeV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "ProxmoxNodeV1";
    }

    public ProxmoxNodeV1 Set(
        ...
        System.Boolean? RbsConfigured = null,
        ...
        ProxmoxNodeDescendantConnection? DescendantConnection = null,
        ...
        ProxmoxNodePhysicalChildTypeConnection? PhysicalChildConnection = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        SecurityMetadata? SecurityMetadata = null,
        SnapshotDistribution? SnapshotDistribution = null,
        List<ProxmoxStorageDomain>? StorageDomains = null
    ) 
    {
        ...
        if ( RbsConfigured != null ) {
            this.RbsConfigured = RbsConfigured;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.Boolean? RbsConfigured
        // GraphQL -> rbsConfigured: Boolean! (scalar)
        if (this.RbsConfigured != null) {
            if (conf.Flat) {
                s += conf.Prefix + "rbsConfigured\n" ;
            } else {
                s += ind + "rbsConfigured\n" ;
            }
        }
        ...
        if (this.StorageDomains != null) {
            var fspec = this.StorageDomains.AsFieldSpec(conf.Child("storageDomains"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "storageDomains" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        return s;
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.Boolean? RbsConfigured
        // GraphQL -> rbsConfigured: Boolean! (scalar)
        if (ec.Includes("rbsConfigured",true))
        {
            if(this.RbsConfigured == null) {

                this.RbsConfigured = true;
        ...
        else if (this.RbsConfigured != null && ec.Excludes("rbsConfigured",true))
        {
            this.RbsConfigured = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ProxmoxNodeDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new ProxmoxNodePhysicalChildTypeConnection();
        ...
        //      C# -> List<ProxmoxStorageDomain>? StorageDomains
        // GraphQL -> storageDomains: [ProxmoxStorageDomain!]! (type)
        if (ec.Includes("storageDomains",false))
        {
            if(this.StorageDomains == null) {

                this.StorageDomains = new List<ProxmoxStorageDomain>();
                this.StorageDomains.ApplyExploratoryFieldSpec(ec.NewChild("storageDomains"));
        ...
        else if (this.StorageDomains != null && ec.Excludes("storageDomains",false))
        {
    ...
    public static class ListProxmoxNodeV1Extensions
    {
        ...
        public static List<string> SelectedFields(this List<ProxmoxNodeV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProxmoxNodeV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProxmoxNodeV1> list)
        {

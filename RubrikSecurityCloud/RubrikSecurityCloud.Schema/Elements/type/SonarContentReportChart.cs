...
{
    #region SonarContentReportChart
 
    public class SonarContentReportChart: BaseType, ReportChartType
    {
        #region members
    ...
    } // class SonarContentReportChart
    
    #endregion

    public static class ListSonarContentReportChartExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SonarContentReportChart> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SonarContentReportChart());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SonarContentReportChart> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleRacDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<OracleRacDescendantType> Nodes { get; set; }
    ...
    public OracleRacDescendantTypeConnection Set(
        RscInterface<OracleRacDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<OracleRacDescendantType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleRacDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<OracleRacDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "OracleRacDescendantTypeConnection";
    }

    public OracleRacDescendantTypeConnection Set(
        RscInterfaceList<OracleRacDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<OracleRacDescendantType>();
    ...
    public static class ListOracleRacDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleRacDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleRacDescendantTypeConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdCatalog: BaseType, CdmHierarchyObject, HierarchyObject, VcdDescendantType, VcdLogicalChildType, VcdOrgDescendantType, VcdOrgLogicalChildType, VcdTopLevelDescendantType
    {
        #region members
    ...
    public static class ListVcdCatalogExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdCatalog> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VcdCatalog());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VcdCatalog> list)
        {

// PostgresDbClusterAppMetadata.cs
//
...
{
    #region PostgresDbClusterAppMetadata
    public class PostgresDbClusterAppMetadata: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PostgresDbClusterAppMetadata";
    }

    public PostgresDbClusterAppMetadata Set(
    ...
    } // class PostgresDbClusterAppMetadata
    
    #endregion

    public static class ListPostgresDbClusterAppMetadataExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgresDbClusterAppMetadata> list,
        ...
        public static List<string> SelectedFields(this List<PostgresDbClusterAppMetadata> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgresDbClusterAppMetadata());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgresDbClusterAppMetadata> list)
        {

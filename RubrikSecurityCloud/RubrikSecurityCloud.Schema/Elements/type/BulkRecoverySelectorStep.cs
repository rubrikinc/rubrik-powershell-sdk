...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBulkRecoverySelectorStepExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BulkRecoverySelectorStep> list)
        {
        ...
        public static void SelectForRetrieval(this List<BulkRecoverySelectorStep> list)
        {

// VmwareRecoverableRangeListResponse.cs
//
...
{
    #region VmwareRecoverableRangeListResponse
    public class VmwareRecoverableRangeListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<VmwareRecoverableRange>? Data
        // GraphQL -> data: [VmwareRecoverableRange!]! (type)
        [JsonProperty("data")]
        public List<VmwareRecoverableRange>? Data { get; set; }
    ...
    public VmwareRecoverableRangeListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<VmwareRecoverableRange>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<VmwareRecoverableRange>();
    ...
    public static class ListVmwareRecoverableRangeListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VmwareRecoverableRangeListResponse> list,
        ...
        public static List<string> SelectedFields(this List<VmwareRecoverableRangeListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VmwareRecoverableRangeListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VmwareRecoverableRangeListResponse> list)
        {

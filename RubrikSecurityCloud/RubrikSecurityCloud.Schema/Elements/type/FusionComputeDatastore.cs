...
{
    #region FusionComputeDatastore
 
    public class FusionComputeDatastore: BaseType, CdmHierarchyObject, FusionComputeClusterDescendant, FusionComputeClusterPhysicalChildType, FusionComputeHostDescendant, FusionComputeHostPhysicalChildType, FusionComputeSiteDescendant, FusionComputeSitePhysicalChildType, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? FcDatastoreId
        // GraphQL -> fcDatastoreId: String! (scalar)
        [JsonProperty("fcDatastoreId")]
        public System.String? FcDatastoreId { get; set; }
        ...
        //      C# -> System.String? Hosts
        // GraphQL -> hosts: String! (scalar)
        [JsonProperty("hosts")]
        public System.String? Hosts { get; set; }
    ...
    public FusionComputeDatastore()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeDatastore";
    }

    public FusionComputeDatastore Set(
        ...
        System.String? FcDatastoreId = null,
        System.Int64? FreeSpace = null,
        System.String? Hosts = null,
    ...
    ) 
    {
        ...
        if ( FcDatastoreId != null ) {
            this.FcDatastoreId = FcDatastoreId;
        }
        if ( FreeSpace != null ) {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? FcDatastoreId
        // GraphQL -> fcDatastoreId: String! (scalar)
        if (this.FcDatastoreId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "fcDatastoreId\n" ;
            } else {
                s += ind + "fcDatastoreId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? FcDatastoreId
        // GraphQL -> fcDatastoreId: String! (scalar)
        if (ec.Includes("fcDatastoreId",true))
        {
            if(this.FcDatastoreId == null) {

                this.FcDatastoreId = "FETCH";
        ...
        else if (this.FcDatastoreId != null && ec.Excludes("fcDatastoreId",true))
        {
            this.FcDatastoreId = null;
        }
        //      C# -> System.Int64? FreeSpace
        // GraphQL -> freeSpace: Long! (scalar)
    ...
    } // class FusionComputeDatastore
    
    #endregion

    public static class ListFusionComputeDatastoreExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeDatastore> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeDatastore> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeDatastore());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeDatastore> list)
        {

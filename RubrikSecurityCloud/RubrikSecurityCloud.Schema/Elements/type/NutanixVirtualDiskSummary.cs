...
{
    #region NutanixVirtualDiskSummary
    public class NutanixVirtualDiskSummary: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "NutanixVirtualDiskSummary";
    }

    public NutanixVirtualDiskSummary Set(
    ...
    } // class NutanixVirtualDiskSummary
    
    #endregion

    public static class ListNutanixVirtualDiskSummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixVirtualDiskSummary> list,
        ...
        public static List<string> SelectedFields(this List<NutanixVirtualDiskSummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NutanixVirtualDiskSummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NutanixVirtualDiskSummary> list)
        {

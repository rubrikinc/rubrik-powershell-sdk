...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListReportMigrationStatusEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReportMigrationStatusEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReportMigrationStatusEdge> list)
        {

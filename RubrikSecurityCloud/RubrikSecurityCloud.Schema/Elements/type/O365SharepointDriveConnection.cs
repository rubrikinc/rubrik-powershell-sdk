...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "O365SharepointDriveConnection";
    }
    ...
    public static class ListO365SharepointDriveConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365SharepointDriveConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365SharepointDriveConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.NasShare != null) {
            var fspec = this.NasShare.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                s += ind + "nasShare {\n" + fspec + ind + "}\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? HardlinkSupportEnabled
        // GraphQL -> hardlinkSupportEnabled: Boolean! (scalar)
        if (this.HardlinkSupportEnabled == null && ec.Includes("hardlinkSupportEnabled",true))
        {
        ...
        //      C# -> System.String? NasMigrationInfo
        // GraphQL -> nasMigrationInfo: String! (scalar)
        if (this.NasMigrationInfo == null && ec.Includes("nasMigrationInfo",true))
        {
        ...
        //      C# -> List<System.String>? PathsExceptions
        // GraphQL -> pathsExceptions: [String!]! (scalar)
        if (this.PathsExceptions == null && ec.Includes("pathsExceptions",true))
        {
            this.PathsExceptions = new List<System.String>();
        }
        //      C# -> List<System.String>? PathsExcluded
        // GraphQL -> pathsExcluded: [String!]! (scalar)
        if (this.PathsExcluded == null && ec.Includes("pathsExcluded",true))
        {
            this.PathsExcluded = new List<System.String>();
        }
        //      C# -> List<System.String>? PathsIncluded
        // GraphQL -> pathsIncluded: [String!]! (scalar)
        if (this.PathsIncluded == null && ec.Includes("pathsIncluded",true))
        {
        ...
        //      C# -> System.Boolean? SymlinkResolutionEnabled
        // GraphQL -> symlinkResolutionEnabled: Boolean! (scalar)
        if (this.SymlinkResolutionEnabled == null && ec.Includes("symlinkResolutionEnabled",true))
        {
            this.SymlinkResolutionEnabled = true;
        }
        //      C# -> System.String? TemplateFid
        // GraphQL -> templateFid: UUID! (scalar)
        if (this.TemplateFid == null && ec.Includes("templateFid",true))
        {
        ...
        //      C# -> NasShare? NasShare
        // GraphQL -> nasShare: NasShare (type)
        if (this.NasShare == null && ec.Includes("nasShare",false))
        {

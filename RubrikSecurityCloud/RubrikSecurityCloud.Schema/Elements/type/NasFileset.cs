...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasFileset: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, NasNamespaceDescendantType, NasShareDescendantType, NasShareLogicalChildType, NasSystemDescendantType
    {
        #region members
        ...
        //      C# -> List<System.String>? PathsExceptions
        // GraphQL -> pathsExceptions: [String!]! (scalar)
        [JsonProperty("pathsExceptions")]
        public List<System.String>? PathsExceptions { get; set; }

        //      C# -> List<System.String>? PathsExcluded
        // GraphQL -> pathsExcluded: [String!]! (scalar)
        [JsonProperty("pathsExcluded")]
        public List<System.String>? PathsExcluded { get; set; }

        //      C# -> List<System.String>? PathsIncluded
        // GraphQL -> pathsIncluded: [String!]! (scalar)
        [JsonProperty("pathsIncluded")]
        public List<System.String>? PathsIncluded { get; set; }
        ...
        //      C# -> System.String? TemplateFid
        // GraphQL -> templateFid: UUID! (scalar)
        [JsonProperty("templateFid")]
        public System.String? TemplateFid { get; set; }
        ...
        [JsonProperty("nasShare")]
        public NasShare? NasShare { get; set; }
    ...
    public NasFileset Set(
        ...
        List<System.String>? PathsExceptions = null,
        List<System.String>? PathsExcluded = null,
    ...
    ) 
    {
        ...
        if ( PathsExceptions != null ) {
            this.PathsExceptions = PathsExceptions;
        }
        if ( PathsExcluded != null ) {
            this.PathsExcluded = PathsExcluded;
        }
        if ( PathsIncluded != null ) {
            this.PathsIncluded = PathsIncluded;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasFileset_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasFileset_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasFileset_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasFileset_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasFileset_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        if (this.HardlinkSupportEnabled != null) {
            if (conf.Flat) {
                s += conf.Prefix + "hardlinkSupportEnabled\n" ;
            } else {
        ...
        //      C# -> List<System.String>? PathsExceptions
        // GraphQL -> pathsExceptions: [String!]! (scalar)
        if (this.PathsExceptions != null) {
            if (conf.Flat) {
                s += conf.Prefix + "pathsExceptions\n" ;
            } else {
                s += ind + "pathsExceptions\n" ;
            }
        }
        //      C# -> List<System.String>? PathsExcluded
        // GraphQL -> pathsExcluded: [String!]! (scalar)
        if (this.PathsExcluded != null) {
            if (conf.Flat) {
                s += conf.Prefix + "pathsExcluded\n" ;
            } else {
                s += ind + "pathsExcluded\n" ;
            }
        }
        //      C# -> List<System.String>? PathsIncluded
        // GraphQL -> pathsIncluded: [String!]! (scalar)
        if (this.PathsIncluded != null) {
            if (conf.Flat) {
                s += conf.Prefix + "pathsIncluded\n" ;
            } else {
                s += ind + "pathsIncluded\n" ;
            }
        }
        ...
        if (this.SymlinkResolutionEnabled != null) {
            if (conf.Flat) {
                s += conf.Prefix + "symlinkResolutionEnabled\n" ;
            } else {
        ...
        //      C# -> System.String? TemplateFid
        // GraphQL -> templateFid: UUID! (scalar)
        if (this.TemplateFid != null) {
            if (conf.Flat) {
                s += conf.Prefix + "templateFid\n" ;
            } else {
                s += ind + "templateFid\n" ;
            }
        }
        ...
        if (this.NasShare != null) {
            var fspec = this.NasShare.AsFieldSpec(conf.Child("nasShare"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? HardlinkSupportEnabled
        // GraphQL -> hardlinkSupportEnabled: Boolean! (scalar)
        if (ec.Includes("hardlinkSupportEnabled",true))
        {
            if(this.HardlinkSupportEnabled == null) {
        ...
        else if (this.HardlinkSupportEnabled != null && ec.Excludes("hardlinkSupportEnabled",true))
        {
            this.HardlinkSupportEnabled = null;
        }
        //      C# -> System.String? Id
        // GraphQL -> id: UUID! (scalar)
        ...
        //      C# -> List<System.String>? PathsExceptions
        // GraphQL -> pathsExceptions: [String!]! (scalar)
        if (ec.Includes("pathsExceptions",true))
        {
            if(this.PathsExceptions == null) {

                this.PathsExceptions = new List<System.String>();
        ...
        else if (this.PathsExceptions != null && ec.Excludes("pathsExceptions",true))
        {
            this.PathsExceptions = null;
        }
        //      C# -> List<System.String>? PathsExcluded
        // GraphQL -> pathsExcluded: [String!]! (scalar)
        if (ec.Includes("pathsExcluded",true))
        {
            if(this.PathsExcluded == null) {

                this.PathsExcluded = new List<System.String>();
        ...
        else if (this.PathsExcluded != null && ec.Excludes("pathsExcluded",true))
        {
            this.PathsExcluded = null;
        }
        //      C# -> List<System.String>? PathsIncluded
        // GraphQL -> pathsIncluded: [String!]! (scalar)
        if (ec.Includes("pathsIncluded",true))
        {
            if(this.PathsIncluded == null) {

                this.PathsIncluded = new List<System.String>();
        ...
        else if (this.PathsIncluded != null && ec.Excludes("pathsIncluded",true))
        {
            this.PathsIncluded = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        //      C# -> System.Boolean? SymlinkResolutionEnabled
        // GraphQL -> symlinkResolutionEnabled: Boolean! (scalar)
        if (ec.Includes("symlinkResolutionEnabled",true))
        {
            if(this.SymlinkResolutionEnabled == null) {
        ...
        else if (this.SymlinkResolutionEnabled != null && ec.Excludes("symlinkResolutionEnabled",true))
        {
            this.SymlinkResolutionEnabled = null;
        }
        //      C# -> System.String? TemplateFid
        // GraphQL -> templateFid: UUID! (scalar)
        if (ec.Includes("templateFid",true))
        {
            if(this.TemplateFid == null) {

                this.TemplateFid = "FETCH";
        ...
        else if (this.TemplateFid != null && ec.Excludes("templateFid",true))
        {
            this.TemplateFid = null;
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        //      C# -> NasShare? NasShare
        // GraphQL -> nasShare: NasShare (type)
        if (ec.Includes("nasShare",false))
        {
            if(this.NasShare == null) {

                this.NasShare = new NasShare();
                this.NasShare.ApplyExploratoryFieldSpec(ec.NewChild("nasShare"));
        ...
        else if (this.NasShare != null && ec.Excludes("nasShare",false))
        {
            this.NasShare = null;
        }
        //      C# -> CdmSnapshot? NewestArchivedSnapshot
    ...
    public static class ListNasFilesetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasFileset> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class NasFileset: IFragment, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, NasSystemDescendantType, NasNamespaceDescendantType, NasShareDescendantType, NasShareLogicalChildType
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.NasShare != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.NasShare.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> CdmSnapshot? NewestArchivedSnapshot
            // GraphQL -> newestArchivedSnapshot: CdmSnapshot (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? HardlinkSupportEnabled
            // GraphQL -> hardlinkSupportEnabled: Boolean! (scalar)
            if (this.HardlinkSupportEnabled == null && Exploration.Includes(parent + ".hardlinkSupportEnabled$"))
            {
                this.HardlinkSupportEnabled = new System.Boolean();
            }
            //      C# -> System.String? Id
            // GraphQL -> id: UUID! (scalar)
            ...
            //      C# -> System.String? NasMigrationInfo
            // GraphQL -> nasMigrationInfo: String! (scalar)
            if (this.NasMigrationInfo == null && Exploration.Includes(parent + ".nasMigrationInfo$"))
            {
            ...
            //      C# -> List<System.String>? PathsExceptions
            // GraphQL -> pathsExceptions: [String!]! (scalar)
            if (this.PathsExceptions == null && Exploration.Includes(parent + ".pathsExceptions$"))
            {
                this.PathsExceptions = new List<System.String>();
            }
            //      C# -> List<System.String>? PathsExcluded
            // GraphQL -> pathsExcluded: [String!]! (scalar)
            if (this.PathsExcluded == null && Exploration.Includes(parent + ".pathsExcluded$"))
            {
                this.PathsExcluded = new List<System.String>();
            }
            //      C# -> List<System.String>? PathsIncluded
            // GraphQL -> pathsIncluded: [String!]! (scalar)
            if (this.PathsIncluded == null && Exploration.Includes(parent + ".pathsIncluded$"))
            {
            ...
            //      C# -> System.Boolean? SymlinkResolutionEnabled
            // GraphQL -> symlinkResolutionEnabled: Boolean! (scalar)
            if (this.SymlinkResolutionEnabled == null && Exploration.Includes(parent + ".symlinkResolutionEnabled$"))
            {
                this.SymlinkResolutionEnabled = new System.Boolean();
            }
            //      C# -> System.String? TemplateFid
            // GraphQL -> templateFid: UUID! (scalar)
            if (this.TemplateFid == null && Exploration.Includes(parent + ".templateFid$"))
            {
                this.TemplateFid = new System.String("FETCH");
            }
            //      C# -> List<Org>? AllOrgs
            // GraphQL -> allOrgs: [Org!]! (type)
            ...
            //      C# -> NasShare? NasShare
            // GraphQL -> nasShare: NasShare (type)
            if (this.NasShare == null && Exploration.Includes(parent + ".nasShare"))
            {
                this.NasShare = new NasShare();
                this.NasShare.ApplyExploratoryFragment(parent + ".nasShare");
            }
            //      C# -> CdmSnapshot? NewestArchivedSnapshot
            // GraphQL -> newestArchivedSnapshot: CdmSnapshot (type)

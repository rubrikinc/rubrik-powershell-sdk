// VsphereVcenterTagChildTypeEdge.cs
//
...
{
    #region VsphereVcenterTagChildTypeEdge
    public class VsphereVcenterTagChildTypeEdge: BaseType
    {
        #region members
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereVcenterTagChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class VsphereVcenterTagChildTypeEdge
    
    #endregion

    public static class ListVsphereVcenterTagChildTypeEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereVcenterTagChildTypeEdge> list,
        ...
        public static List<string> SelectedFields(this List<VsphereVcenterTagChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereVcenterTagChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereVcenterTagChildTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ApplicationContainers != null) {
            var fspec = this.ApplicationContainers.AsFieldSpec(conf.Child("applicationContainers"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<System.String>? RegularPdbs
        // GraphQL -> regularPdbs: [String!]! (scalar)
        if (ec.Includes("regularPdbs",true))
        {
            if(this.RegularPdbs == null) {
        ...
        else if (this.RegularPdbs != null && ec.Excludes("regularPdbs",true))
        {
            this.RegularPdbs = null;
        }
        //      C# -> List<OraclePdbApplicationContainer>? ApplicationContainers
        // GraphQL -> applicationContainers: [OraclePdbApplicationContainer!]! (type)
        if (ec.Includes("applicationContainers",false))
        {
            if(this.ApplicationContainers == null) {
        ...
        else if (this.ApplicationContainers != null && ec.Excludes("applicationContainers",false))
        {
            this.ApplicationContainers = null;
        }
    }
    ...
    public static class ListOraclePdbDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OraclePdbDetails> list)
        {
        ...
        public static void SelectForRetrieval(this List<OraclePdbDetails> list)
        {

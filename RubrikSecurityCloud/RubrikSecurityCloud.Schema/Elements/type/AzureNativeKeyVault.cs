...
{
    #region AzureNativeKeyVault
    public class AzureNativeKeyVault: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureNativeKeyVault";
    }

    public AzureNativeKeyVault Set(
    ...
    } // class AzureNativeKeyVault
    
    #endregion

    public static class ListAzureNativeKeyVaultExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureNativeKeyVault> list,
        ...
        public static List<string> SelectedFields(this List<AzureNativeKeyVault> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureNativeKeyVault());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureNativeKeyVault> list)
        {

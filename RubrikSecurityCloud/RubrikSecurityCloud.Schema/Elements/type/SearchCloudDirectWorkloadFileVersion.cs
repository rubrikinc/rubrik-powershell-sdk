// SearchCloudDirectWorkloadFileVersion.cs
//
...
{
    #region SearchCloudDirectWorkloadFileVersion
    public class SearchCloudDirectWorkloadFileVersion: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SearchCloudDirectWorkloadFileVersion";
    }

    public SearchCloudDirectWorkloadFileVersion Set(
    ...
    } // class SearchCloudDirectWorkloadFileVersion
    
    #endregion

    public static class ListSearchCloudDirectWorkloadFileVersionExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SearchCloudDirectWorkloadFileVersion> list,
        ...
        public static List<string> SelectedFields(this List<SearchCloudDirectWorkloadFileVersion> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SearchCloudDirectWorkloadFileVersion());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SearchCloudDirectWorkloadFileVersion> list)
        {

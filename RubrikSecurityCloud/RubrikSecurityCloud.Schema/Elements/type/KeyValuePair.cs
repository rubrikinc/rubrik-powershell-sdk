...
{
    #region KeyValuePair
    public class KeyValuePair: BaseType
    {
        #region members
    ...
    public static class ListKeyValuePairExtensions
    {
        ...
        public static List<string> SelectedFields(this List<KeyValuePair> list)
        {
        ...
        public static void SelectForRetrieval(this List<KeyValuePair> list)
        {

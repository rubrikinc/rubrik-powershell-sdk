// PitRestorePostgresDbClusterResponse.cs
//
...
{
    #region PitRestorePostgresDbClusterResponse
    public class PitRestorePostgresDbClusterResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PitRestorePostgresDbClusterResponse";
    }

    public PitRestorePostgresDbClusterResponse Set(
    ...
    } // class PitRestorePostgresDbClusterResponse
    
    #endregion

    public static class ListPitRestorePostgresDbClusterResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PitRestorePostgresDbClusterResponse> list,
        ...
        public static List<string> SelectedFields(this List<PitRestorePostgresDbClusterResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PitRestorePostgresDbClusterResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PitRestorePostgresDbClusterResponse> list)
        {

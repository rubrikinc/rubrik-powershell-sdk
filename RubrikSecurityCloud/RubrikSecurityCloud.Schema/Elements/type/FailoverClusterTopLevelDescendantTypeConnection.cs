...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FailoverClusterTopLevelDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<FailoverClusterTopLevelDescendantType> Nodes { get; set; }
    ...
    public FailoverClusterTopLevelDescendantTypeConnection Set(
        RscInterfaceList<FailoverClusterTopLevelDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<FailoverClusterTopLevelDescendantType>();
    ...
    public static class ListFailoverClusterTopLevelDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FailoverClusterTopLevelDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<FailoverClusterTopLevelDescendantTypeConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FailoverClusterTopLevelDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<FailoverClusterTopLevelDescendantType> Nodes { get; set; }
    ...
    public FailoverClusterTopLevelDescendantTypeConnection Set(
        RscInterface<FailoverClusterTopLevelDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<FailoverClusterTopLevelDescendantType>();

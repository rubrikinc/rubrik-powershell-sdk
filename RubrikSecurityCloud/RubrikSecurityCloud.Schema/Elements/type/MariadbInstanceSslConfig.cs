...
{
    #region MariadbInstanceSslConfig
    public class MariadbInstanceSslConfig: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MariadbInstanceSslConfig";
    }

    public MariadbInstanceSslConfig Set(
    ...
    } // class MariadbInstanceSslConfig
    
    #endregion

    public static class ListMariadbInstanceSslConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MariadbInstanceSslConfig> list,
        ...
        public static List<string> SelectedFields(this List<MariadbInstanceSslConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MariadbInstanceSslConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MariadbInstanceSslConfig> list)
        {

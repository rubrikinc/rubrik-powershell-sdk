...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUserAuditGroupByInfoConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserAuditGroupByInfoConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<UserAuditGroupByInfoConnection> list)
        {

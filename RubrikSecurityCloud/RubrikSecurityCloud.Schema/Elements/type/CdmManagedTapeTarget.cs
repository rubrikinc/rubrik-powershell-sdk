...
{
    #region CdmManagedTapeTarget
 
    public class CdmManagedTapeTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedTapeTarget";
    }

    public CdmManagedTapeTarget Set(
    ...
    } // class CdmManagedTapeTarget
    
    #endregion

    public static class ListCdmManagedTapeTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CdmManagedTapeTarget> list,
        ...
        public static List<string> SelectedFields(this List<CdmManagedTapeTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedTapeTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmManagedTapeTarget> list)
        {

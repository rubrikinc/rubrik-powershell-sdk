...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ExchangeHost: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> ExchangeHostDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: ExchangeHostDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public ExchangeHostDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> ExchangeHostPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: ExchangeHostPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public ExchangeHostPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }

        //      C# -> PhysicalHostMetadata? PhysicalHostMetadata
        // GraphQL -> physicalHostMetadata: PhysicalHostMetadata! (type)
        [JsonProperty("physicalHostMetadata")]
        public PhysicalHostMetadata? PhysicalHostMetadata { get; set; }
    ...
    public ExchangeHost Set(
        ...
        ExchangeHostDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        ExchangeHostPhysicalChildTypeConnection? PhysicalChildConnection = null,
        PhysicalHostMetadata? PhysicalHostMetadata = null,
    ...
    ) 
    {
        ...
        if ( PhysicalHostMetadata != null ) {
            this.PhysicalHostMetadata = PhysicalHostMetadata;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> PhysicalHostMetadata? PhysicalHostMetadata
        // GraphQL -> physicalHostMetadata: PhysicalHostMetadata! (type)
        if (this.PhysicalHostMetadata != null) {
            var fspec = this.PhysicalHostMetadata.AsFieldSpec(conf.Child("physicalHostMetadata"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "physicalHostMetadata" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> List<PathNode>? PhysicalPath
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ExchangeHostDescendantTypeConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new ExchangeHostPhysicalChildTypeConnection();
        ...
        //      C# -> PhysicalHostMetadata? PhysicalHostMetadata
        // GraphQL -> physicalHostMetadata: PhysicalHostMetadata! (type)
        if (ec.Includes("physicalHostMetadata",false))
        {
            if(this.PhysicalHostMetadata == null) {

                this.PhysicalHostMetadata = new PhysicalHostMetadata();
                this.PhysicalHostMetadata.ApplyExploratoryFieldSpec(ec.NewChild("physicalHostMetadata"));
        ...
        else if (this.PhysicalHostMetadata != null && ec.Excludes("physicalHostMetadata",false))
        {
            this.PhysicalHostMetadata = null;
        }
        //      C# -> List<PathNode>? PhysicalPath
        // GraphQL -> physicalPath: [PathNode!]! (type)
    ...
    public static class ListExchangeHostExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeHost> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ExchangeHost());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ExchangeHost> list)
        {

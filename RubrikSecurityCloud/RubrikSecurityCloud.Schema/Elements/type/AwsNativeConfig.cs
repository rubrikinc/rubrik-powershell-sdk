...
{
    #region AwsNativeConfig
 
    public class AwsNativeConfig: BaseType, AwsNativeAccountDescendantType, AwsNativeAccountLogicalChildType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public static class ListAwsNativeConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AwsNativeConfig> list,
        ...
        public static List<string> SelectedFields(this List<AwsNativeConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsNativeConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AwsNativeConfig> list)
        {

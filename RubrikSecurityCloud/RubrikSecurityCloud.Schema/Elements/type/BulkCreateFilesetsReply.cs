...
{
    #region BulkCreateFilesetsReply
    public class BulkCreateFilesetsReply: BaseType
    {
        #region members
        ...
        //      C# -> List<FilesetDetail>? Data
        // GraphQL -> data: [FilesetDetail!]! (type)
        [JsonProperty("data")]
        public List<FilesetDetail>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "BulkCreateFilesetsReply";
    }

    public BulkCreateFilesetsReply Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<FilesetDetail>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<FilesetDetail>();
    ...
    } // class BulkCreateFilesetsReply
    
    #endregion

    public static class ListBulkCreateFilesetsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BulkCreateFilesetsReply> list,
        ...
        public static List<string> SelectedFields(this List<BulkCreateFilesetsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BulkCreateFilesetsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BulkCreateFilesetsReply> list)
        {

// GcpProjectThreatAnalyticsEnablement.cs
//
...
{
    #region GcpProjectThreatAnalyticsEnablement
    public class GcpProjectThreatAnalyticsEnablement: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "GcpProjectThreatAnalyticsEnablement";
    }

    public GcpProjectThreatAnalyticsEnablement Set(
    ...
    } // class GcpProjectThreatAnalyticsEnablement
    
    #endregion

    public static class ListGcpProjectThreatAnalyticsEnablementExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpProjectThreatAnalyticsEnablement> list,
        ...
        public static List<string> SelectedFields(this List<GcpProjectThreatAnalyticsEnablement> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpProjectThreatAnalyticsEnablement());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpProjectThreatAnalyticsEnablement> list)
        {

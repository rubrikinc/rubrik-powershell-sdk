...
{
    #region M365BackupStorageOrg
 
    public class M365BackupStorageOrg: BaseType, HierarchyObject, HierarchySnappable, MicrosoftOrg, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public M365BackupStorageOrg()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "M365BackupStorageOrg";
    }
    ...
    } // class M365BackupStorageOrg
    
    #endregion

    public static class ListM365BackupStorageOrgExtensions
    {
        ...
        public static List<string> SelectedFields(this List<M365BackupStorageOrg> list)
        {

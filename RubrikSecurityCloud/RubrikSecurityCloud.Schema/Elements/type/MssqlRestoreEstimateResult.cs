...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MssqlRestoreEstimateResult: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Int64? BytesFromCloud
            // GraphQL -> bytesFromCloud: Long! (scalar)
            if (this.BytesFromCloud == null && Exploration.Includes(parent + ".bytesFromCloud$"))
            {
    ...
    public static class ListMssqlRestoreEstimateResultExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MssqlRestoreEstimateResult();
            list.Add(item);

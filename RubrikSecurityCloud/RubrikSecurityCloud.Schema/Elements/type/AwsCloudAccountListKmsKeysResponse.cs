...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAwsCloudAccountListKmsKeysResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsCloudAccountListKmsKeysResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsCloudAccountListKmsKeysResponse> list)
        {

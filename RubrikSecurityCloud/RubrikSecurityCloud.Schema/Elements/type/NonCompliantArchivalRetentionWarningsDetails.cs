...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListNonCompliantArchivalRetentionWarningsDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NonCompliantArchivalRetentionWarningsDetails> list)
        {
        ...
        public static void SelectForRetrieval(this List<NonCompliantArchivalRetentionWarningsDetails> list)
        {

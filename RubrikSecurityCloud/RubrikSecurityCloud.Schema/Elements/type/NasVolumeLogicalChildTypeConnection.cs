...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolumeLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NasVolumeLogicalChildType> Nodes { get; set; }
    ...
    public NasVolumeLogicalChildTypeConnection Set(
        RscInterface<NasVolumeLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NasVolumeLogicalChildType>();

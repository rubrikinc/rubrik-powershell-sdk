...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolumeLogicalChildTypeConnection: BaseType
    {
        #region members
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NasVolumeLogicalChildType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "NasVolumeLogicalChildTypeConnection";
    }

    public NasVolumeLogicalChildTypeConnection Set(
        RscInterfaceList<NasVolumeLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NasVolumeLogicalChildType>();
    ...
    public static class ListNasVolumeLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasVolumeLogicalChildTypeConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NasVolumeLogicalChildTypeConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NasVolumeLogicalChildTypeConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListMongoSnapshotGroupByConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoSnapshotGroupByConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongoSnapshotGroupByConnection> list)
        {

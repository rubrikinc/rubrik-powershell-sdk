// GetAnomalyDetectionObjectEnablementStatsResponse.cs
//
...
{
    #region GetAnomalyDetectionObjectEnablementStatsResponse
    public class GetAnomalyDetectionObjectEnablementStatsResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "GetAnomalyDetectionObjectEnablementStatsResponse";
    }

    public GetAnomalyDetectionObjectEnablementStatsResponse Set(
    ...
    } // class GetAnomalyDetectionObjectEnablementStatsResponse
    
    #endregion

    public static class ListGetAnomalyDetectionObjectEnablementStatsResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GetAnomalyDetectionObjectEnablementStatsResponse> list,
        ...
        public static List<string> SelectedFields(this List<GetAnomalyDetectionObjectEnablementStatsResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GetAnomalyDetectionObjectEnablementStatsResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GetAnomalyDetectionObjectEnablementStatsResponse> list)
        {

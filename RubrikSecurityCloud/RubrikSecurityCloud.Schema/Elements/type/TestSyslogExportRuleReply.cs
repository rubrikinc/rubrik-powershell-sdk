...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListTestSyslogExportRuleReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TestSyslogExportRuleReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<TestSyslogExportRuleReply> list)
        {

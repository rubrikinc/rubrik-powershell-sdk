...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolumeDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NasVolumeDescendantType> Nodes { get; set; }
    ...
    public NasVolumeDescendantTypeConnection Set(
        RscInterface<NasVolumeDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NasVolumeDescendantType>();

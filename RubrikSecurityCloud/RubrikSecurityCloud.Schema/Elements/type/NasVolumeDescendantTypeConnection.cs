...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasVolumeDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NasVolumeDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "NasVolumeDescendantTypeConnection";
    }

    public NasVolumeDescendantTypeConnection Set(
        RscInterfaceList<NasVolumeDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NasVolumeDescendantType>();
    ...
    public static class ListNasVolumeDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasVolumeDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<NasVolumeDescendantTypeConnection> list)
        {

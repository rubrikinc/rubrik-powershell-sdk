...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListFailoverClusterAppConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FailoverClusterAppConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<FailoverClusterAppConnection> list)
        {

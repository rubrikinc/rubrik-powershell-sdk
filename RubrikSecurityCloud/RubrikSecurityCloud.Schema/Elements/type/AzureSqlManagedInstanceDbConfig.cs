...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAzureSqlManagedInstanceDbConfigExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureSqlManagedInstanceDbConfig> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureSqlManagedInstanceDbConfig> list)
        {

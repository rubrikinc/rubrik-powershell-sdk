...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostShareDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HostShareDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HostShareDescendantType));
    ...
    public static class ListHostShareDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HostShareDescendantTypeEdge();
            list.Add(item);

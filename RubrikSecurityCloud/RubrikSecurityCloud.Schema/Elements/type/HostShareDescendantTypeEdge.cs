...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HostShareDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HostShareDescendantType> Node { get; set; }
    ...
    public HostShareDescendantTypeEdge Set(
        RscInterface<HostShareDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HostShareDescendantType>();
    ...
    public static class ListHostShareDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HostShareDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<HostShareDescendantTypeEdge> list)
        {

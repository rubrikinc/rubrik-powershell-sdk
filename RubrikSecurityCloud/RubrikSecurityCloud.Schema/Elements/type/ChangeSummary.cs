...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.PerDayChangeSummary != null) {
            var fspec = this.PerDayChangeSummary.AsFieldSpec(conf.Child("perDayChangeSummary"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<DailyChangeSummary>? PerDayChangeSummary
        // GraphQL -> perDayChangeSummary: [DailyChangeSummary!]! (type)
        if (ec.Includes("perDayChangeSummary",false))
        {
            if(this.PerDayChangeSummary == null) {
        ...
        else if (this.PerDayChangeSummary != null && ec.Excludes("perDayChangeSummary",false))
        {
            this.PerDayChangeSummary = null;
        }
    }
    ...
    public static class ListChangeSummaryExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ChangeSummary> list)
        {
        ...
        public static void SelectForRetrieval(this List<ChangeSummary> list)
        {

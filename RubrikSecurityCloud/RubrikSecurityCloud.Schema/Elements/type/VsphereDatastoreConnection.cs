...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereDatastoreConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatastoreConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereDatastoreConnection> list)
        {

...
{
    #region GlueIcebergDatabase
 
    public class GlueIcebergDatabase: BaseType, AwsNativeAccountDescendantType, AwsNativeHierarchyObject, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public GlueIcebergDatabase()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "GlueIcebergDatabase";
    }

    public GlueIcebergDatabase Set(
    ...
    } // class GlueIcebergDatabase
    
    #endregion

    public static class ListGlueIcebergDatabaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GlueIcebergDatabase> list,
        ...
        public static List<string> SelectedFields(this List<GlueIcebergDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GlueIcebergDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GlueIcebergDatabase> list)
        {

...
{
    #region AzureMountDiskDetails
    public class AzureMountDiskDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureMountDiskDetails";
    }

    public AzureMountDiskDetails Set(
    ...
    } // class AzureMountDiskDetails
    
    #endregion

    public static class ListAzureMountDiskDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureMountDiskDetails> list,
            int indent=0)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureMountDiskDetails());
            }

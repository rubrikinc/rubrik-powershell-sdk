// NutanixContainerListResponse.cs
//
...
{
    #region NutanixContainerListResponse
    public class NutanixContainerListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<NutanixContainer>? Data
        // GraphQL -> data: [NutanixContainer!]! (type)
        [JsonProperty("data")]
        public List<NutanixContainer>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "NutanixContainerListResponse";
    }

    public NutanixContainerListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<NutanixContainer>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<NutanixContainer>();
    ...
    } // class NutanixContainerListResponse
    
    #endregion

    public static class ListNutanixContainerListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<NutanixContainerListResponse> list,
        ...
        public static List<string> SelectedFields(this List<NutanixContainerListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NutanixContainerListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NutanixContainerListResponse> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AzureNetworkSubnetResp: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Boolean? Valid
            // GraphQL -> valid: Boolean! (scalar)
            if (this.Valid == null && Exploration.Includes(parent + ".valid$"))
            {
                this.Valid = new System.Boolean();
            }
        }
    ...
    public static class ListAzureNetworkSubnetRespExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new AzureNetworkSubnetResp();
            list.Add(item);

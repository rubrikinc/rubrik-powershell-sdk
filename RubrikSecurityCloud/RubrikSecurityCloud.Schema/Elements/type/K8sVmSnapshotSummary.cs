...
{
    #region K8sVmSnapshotSummary
    public class K8sVmSnapshotSummary: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "K8sVmSnapshotSummary";
    }

    public K8sVmSnapshotSummary Set(
    ...
    } // class K8sVmSnapshotSummary
    
    #endregion

    public static class ListK8sVmSnapshotSummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<K8sVmSnapshotSummary> list,
        ...
        public static List<string> SelectedFields(this List<K8sVmSnapshotSummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new K8sVmSnapshotSummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<K8sVmSnapshotSummary> list)
        {

...
{
    #region AddMysqldbInstanceResponse
    public class AddMysqldbInstanceResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AddMysqldbInstanceResponse";
    }
    ...
    } // class AddMysqldbInstanceResponse
    
    #endregion

    public static class ListAddMysqldbInstanceResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AddMysqldbInstanceResponse> list,
        ...
        public static List<string> SelectedFields(this List<AddMysqldbInstanceResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddMysqldbInstanceResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddMysqldbInstanceResponse> list)
        {

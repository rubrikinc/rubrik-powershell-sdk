...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAwsNativeEc2InstanceConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeEc2InstanceConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsNativeEc2InstanceConnection> list)
        {

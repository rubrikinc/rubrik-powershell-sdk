...
namespace RubrikSecurityCloud.Types
{
    ...
    public class K8sNamespaceEdge: BaseType
    {
        #region members
    ...
    public static class ListK8sNamespaceEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<K8sNamespaceEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new K8sNamespaceEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<K8sNamespaceEdge> list)
        {

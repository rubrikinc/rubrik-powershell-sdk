...
{
    #region GcpNativeRoot
    public class GcpNativeRoot: BaseType
    {
        #region members

        //      C# -> GcpNativeHierarchyObjectConnection? ObjectTypeDescendantConnection
        // GraphQL -> objectTypeDescendantConnection: GcpNativeHierarchyObjectConnection! (type)
        [JsonProperty("objectTypeDescendantConnection")]
        public GcpNativeHierarchyObjectConnection? ObjectTypeDescendantConnection { get; set; }
    ...
    public GcpNativeRoot()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "GcpNativeRoot";
    }

    public GcpNativeRoot Set(
        GcpNativeHierarchyObjectConnection? ObjectTypeDescendantConnection = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("objectTypeDescendantConnection",false))
        {
            if(this.ObjectTypeDescendantConnection == null) {
                ...
                this.ObjectTypeDescendantConnection = new GcpNativeHierarchyObjectConnection();
    ...
    public static class ListGcpNativeRootExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GcpNativeRoot> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpNativeRoot());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpNativeRoot> list)
        {

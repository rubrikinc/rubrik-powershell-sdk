...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListReportMigrationStatusConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReportMigrationStatusConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReportMigrationStatusConnection> list)
        {

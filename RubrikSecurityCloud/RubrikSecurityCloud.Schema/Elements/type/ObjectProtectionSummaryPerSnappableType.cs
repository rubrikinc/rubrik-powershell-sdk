...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ObjectProtectionSummaryPerSnappableType: BaseType
    {
        ...
        //      C# -> FailedScanSummary? FailedScanSummary
        // GraphQL -> failedScanSummary: FailedScanSummary (type)
        [JsonProperty("failedScanSummary")]
        public FailedScanSummary? FailedScanSummary { get; set; }
    ...
    public ObjectProtectionSummaryPerSnappableType Set(
        ...
        FailedScanSummary? FailedScanSummary = null,
    ...
    ) 
    {
        ...
        if ( FailedScanSummary != null ) {
            this.FailedScanSummary = FailedScanSummary;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> FailedScanSummary? FailedScanSummary
        // GraphQL -> failedScanSummary: FailedScanSummary (type)
        if (this.FailedScanSummary != null) {
            var fspec = this.FailedScanSummary.AsFieldSpec(conf.Child("failedScanSummary"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "failedScanSummary" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> List<ObjectProtectionSummarySensitivityData>? ObjectProtectionSummarySensitivityData
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> FailedScanSummary? FailedScanSummary
        // GraphQL -> failedScanSummary: FailedScanSummary (type)
        if (ec.Includes("failedScanSummary",false))
        {
            if(this.FailedScanSummary == null) {

                this.FailedScanSummary = new FailedScanSummary();
                this.FailedScanSummary.ApplyExploratoryFieldSpec(ec.NewChild("failedScanSummary"));
        ...
        else if (this.FailedScanSummary != null && ec.Excludes("failedScanSummary",false))
        {
            this.FailedScanSummary = null;
        }
        //      C# -> List<ObjectProtectionSummarySensitivityData>? ObjectProtectionSummarySensitivityData
        // GraphQL -> objectProtectionSummarySensitivityData: [ObjectProtectionSummarySensitivityData!]! (type)

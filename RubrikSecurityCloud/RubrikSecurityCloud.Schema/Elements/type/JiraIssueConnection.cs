...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListJiraIssueConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<JiraIssueConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<JiraIssueConnection> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListWorkloadGroupBySecondaryGroupByItemExtensions
    {
        ...
        public static List<string> SelectedFields(this List<WorkloadGroupBySecondaryGroupByItem> list)
        {
        ...
        public static void SelectForRetrieval(this List<WorkloadGroupBySecondaryGroupByItem> list)
        {

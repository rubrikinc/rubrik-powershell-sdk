...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateVappsInstantRecoveryReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateVappsInstantRecoveryReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateVappsInstantRecoveryReply> list)
        {

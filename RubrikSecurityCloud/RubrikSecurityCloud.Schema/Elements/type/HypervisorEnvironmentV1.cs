...
{
    #region HypervisorEnvironmentV1
 
    public class HypervisorEnvironmentV1: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        // GraphQL -> hypervisorEnvironmentId: String! (scalar)
        ...
        //      C# -> HypervisorEnvironment? HypervisorInfo
        // GraphQL -> hypervisorInfo: HypervisorEnvironment! (type)
        [JsonProperty("hypervisorInfo")]
        public HypervisorEnvironment? HypervisorInfo { get; set; }

        //      C# -> HypervisorSpecificDetails? HypervisorSpecificDetails
        // GraphQL -> hypervisorSpecificDetails: HypervisorSpecificDetails! (type)
        [JsonProperty("hypervisorSpecificDetails")]
        public HypervisorSpecificDetails? HypervisorSpecificDetails { get; set; }
        ...
        //      C# -> CdmHierarchyObjectConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: CdmHierarchyObjectConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public CdmHierarchyObjectConnection? PhysicalChildConnection { get; set; }
    ...
    public HypervisorEnvironmentV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "HypervisorEnvironmentV1";
    }

    public HypervisorEnvironmentV1 Set(
        ...
        HypervisorEnvironment? HypervisorInfo = null,
        HypervisorSpecificDetails? HypervisorSpecificDetails = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectBackupWindowStatus? ObjectBackupWindow = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        CdmHierarchyObjectConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( HypervisorSpecificDetails != null ) {
            this.HypervisorSpecificDetails = HypervisorSpecificDetails;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.HypervisorInfo != null) {
            var fspec = this.HypervisorInfo.AsFieldSpec(conf.Child("hypervisorInfo"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "hypervisorInfo" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> HypervisorSpecificDetails? HypervisorSpecificDetails
        // GraphQL -> hypervisorSpecificDetails: HypervisorSpecificDetails! (type)
        if (this.HypervisorSpecificDetails != null) {
            var fspec = this.HypervisorSpecificDetails.AsFieldSpec(conf.Child("hypervisorSpecificDetails"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "hypervisorSpecificDetails" + " " + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> LatestUserNote? LatestUserNote
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> HypervisorEnvironment? HypervisorInfo
        // GraphQL -> hypervisorInfo: HypervisorEnvironment! (type)
        if (ec.Includes("hypervisorInfo",false))
        {
            if(this.HypervisorInfo == null) {

                this.HypervisorInfo = new HypervisorEnvironment();
                this.HypervisorInfo.ApplyExploratoryFieldSpec(ec.NewChild("hypervisorInfo"));
        ...
        else if (this.HypervisorInfo != null && ec.Excludes("hypervisorInfo",false))
        {
            this.HypervisorInfo = null;
        }
        //      C# -> HypervisorSpecificDetails? HypervisorSpecificDetails
        // GraphQL -> hypervisorSpecificDetails: HypervisorSpecificDetails! (type)
        if (ec.Includes("hypervisorSpecificDetails",false))
        {
            if(this.HypervisorSpecificDetails == null) {

                this.HypervisorSpecificDetails = new HypervisorSpecificDetails();
                this.HypervisorSpecificDetails.ApplyExploratoryFieldSpec(ec.NewChild("hypervisorSpecificDetails"));
        ...
        else if (this.HypervisorSpecificDetails != null && ec.Excludes("hypervisorSpecificDetails",false))
        {
            this.HypervisorSpecificDetails = null;
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new CdmHierarchyObjectConnection();
    ...
    } // class HypervisorEnvironmentV1
    
    #endregion

    public static class ListHypervisorEnvironmentV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<HypervisorEnvironmentV1> list,
        ...
        public static List<string> SelectedFields(this List<HypervisorEnvironmentV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HypervisorEnvironmentV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HypervisorEnvironmentV1> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class FailoverClusterTopLevelDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (FailoverClusterTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FailoverClusterTopLevelDescendantType));
    ...
    public static class ListFailoverClusterTopLevelDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new FailoverClusterTopLevelDescendantTypeEdge();
            list.Add(item);

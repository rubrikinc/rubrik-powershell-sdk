...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FailoverClusterTopLevelDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<FailoverClusterTopLevelDescendantType> Node { get; set; }
    ...
    public FailoverClusterTopLevelDescendantTypeEdge Set(
        RscInterface<FailoverClusterTopLevelDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<FailoverClusterTopLevelDescendantType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateVappSnapshotsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateVappSnapshotsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateVappSnapshotsReply> list)
        {

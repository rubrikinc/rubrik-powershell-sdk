...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.SkippedItems != null) {
            var fspec = this.SkippedItems.AsFieldSpec(conf.Child("skippedItems"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<SkippedItemInfo>? SkippedItems
        // GraphQL -> skippedItems: [SkippedItemInfo!]! (type)
        if (ec.Includes("skippedItems",false))
        {
            if(this.SkippedItems == null) {
        ...
        else if (this.SkippedItems != null && ec.Excludes("skippedItems",false))
        {
            this.SkippedItems = null;
        }
    }
    ...
    public static class ListSkippedItemInfoResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SkippedItemInfoResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<SkippedItemInfoResponse> list)
        {

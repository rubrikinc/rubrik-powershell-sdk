...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HypervTopLevelDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HypervTopLevelDescendantType> Node { get; set; }
    ...
    public HypervTopLevelDescendantTypeEdge Set(
        RscInterface<HypervTopLevelDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HypervTopLevelDescendantType>();

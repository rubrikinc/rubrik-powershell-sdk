...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HypervTopLevelDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HypervTopLevelDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(HypervTopLevelDescendantType));
    ...
    public static class ListHypervTopLevelDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HypervTopLevelDescendantTypeEdge();
            list.Add(item);

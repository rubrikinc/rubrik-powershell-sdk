...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.Int64? UnusedAddr
        // GraphQL -> unusedAddr: Long! (scalar)
        if (ec.Includes("unusedAddr",true))
        {
            if(this.UnusedAddr == null) {
        ...
        else if (this.UnusedAddr != null && ec.Excludes("unusedAddr",true))
        {
            this.UnusedAddr = null;
        }
    }
    ...
    public static class ListAzureNetworkSubnetUnusedAddrRespExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureNetworkSubnetUnusedAddrResp> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureNetworkSubnetUnusedAddrResp> list)
        {

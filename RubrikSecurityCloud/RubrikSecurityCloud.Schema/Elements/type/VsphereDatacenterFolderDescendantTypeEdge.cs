...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereDatacenterFolderDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterFolderDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereDatacenterFolderDescendantTypeEdge> list)
        {

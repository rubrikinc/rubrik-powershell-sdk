...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ActivityChart: BaseType, ReportChartType
    {
        #region members
    ...
    public static class ListActivityChartExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ActivityChart> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ActivityChart());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ActivityChart> list)
        {

...
{
    #region KubernetesLabel
 
    public class KubernetesLabel: BaseType, CdmHierarchyObject, HierarchyObject, KubernetesClusterDescendant
    {
        #region members
        ...
        //      C# -> KubernetesLabelDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: KubernetesLabelDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public KubernetesLabelDescendantConnection? DescendantConnection { get; set; }
    ...
    public KubernetesLabel Set(
        ...
        KubernetesLabelDescendantConnection? DescendantConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new KubernetesLabelDescendantConnection();
    ...
    public static class ListKubernetesLabelExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesLabel> list,
        ...
        public static List<string> SelectedFields(this List<KubernetesLabel> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesLabel());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KubernetesLabel> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDissolveLegalHoldReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DissolveLegalHoldReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DissolveLegalHoldReply> list)
        {

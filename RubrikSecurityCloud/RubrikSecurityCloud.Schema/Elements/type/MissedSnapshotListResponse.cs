...
{
    #region MissedSnapshotListResponse
    public class MissedSnapshotListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<MissedSnapshot>? Data
        // GraphQL -> data: [MissedSnapshot!]! (type)
        [JsonProperty("data")]
        public List<MissedSnapshot>? Data { get; set; }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<MissedSnapshot>();
    ...
    } // class MissedSnapshotListResponse
    
    #endregion

    public static class ListMissedSnapshotListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MissedSnapshotListResponse> list,
        ...
        public static List<string> SelectedFields(this List<MissedSnapshotListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MissedSnapshotListResponse());
            }

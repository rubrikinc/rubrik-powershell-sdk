...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSnapshotFileDeltaEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnapshotFileDeltaEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<SnapshotFileDeltaEdge> list)
        {

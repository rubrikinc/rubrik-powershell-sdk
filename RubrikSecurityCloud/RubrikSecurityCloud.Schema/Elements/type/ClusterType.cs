...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListClusterTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ClusterType> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ClusterType());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ClusterType> list)
        {

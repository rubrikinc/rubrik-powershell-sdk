...
{
    #region ProxmoxDetails
    public class ProxmoxDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ProxmoxDetails";
    }

    public ProxmoxDetails Set(
    ...
    } // class ProxmoxDetails
    
    #endregion

    public static class ListProxmoxDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ProxmoxDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProxmoxDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProxmoxDetails> list)
        {

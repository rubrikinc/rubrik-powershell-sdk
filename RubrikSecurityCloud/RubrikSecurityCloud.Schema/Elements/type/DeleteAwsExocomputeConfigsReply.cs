...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class DeleteAwsExocomputeConfigsReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.DeletionStatus != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.DeletionStatus.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.DeletionStatus == null && Exploration.Includes(parent + ".deletionStatus"))
            {
                ...
                this.DeletionStatus.ApplyExploratoryFragment(parent + ".deletionStatus");
            }
        }
    ...
    public static class ListDeleteAwsExocomputeConfigsReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new DeleteAwsExocomputeConfigsReply();
            list.Add(item);

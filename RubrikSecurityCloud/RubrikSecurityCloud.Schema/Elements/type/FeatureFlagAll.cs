...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        // GraphQL -> flags: [FeatureFlag!]! (type)
        if (this.Flags != null) {
            var fspec = this.Flags.AsFieldSpec(conf.Child("flags"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.Flags != null && ec.Excludes("flags",false))
        {
            this.Flags = null;
        }
    }
    ...
    public static class ListFeatureFlagAllExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FeatureFlagAll> list)
        {
        ...
        public static void SelectForRetrieval(this List<FeatureFlagAll> list)
        {

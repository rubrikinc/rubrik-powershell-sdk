...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "HypervHostSummaryListResponse";
    }
    ...
    public static class ListHypervHostSummaryListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HypervHostSummaryListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<HypervHostSummaryListResponse> list)
        {

...
{
    #region RelatedObjectsType
    public class RelatedObjectsType: BaseType
    {
        #region members
    ...
    public static class ListRelatedObjectsTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RelatedObjectsType> list)
        {

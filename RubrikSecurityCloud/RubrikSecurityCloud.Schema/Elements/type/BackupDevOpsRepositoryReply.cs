// BackupDevOpsRepositoryReply.cs
//
...
{
    #region BackupDevOpsRepositoryReply
    public class BackupDevOpsRepositoryReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "BackupDevOpsRepositoryReply";
    }

    public BackupDevOpsRepositoryReply Set(
    ...
    } // class BackupDevOpsRepositoryReply
    
    #endregion

    public static class ListBackupDevOpsRepositoryReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BackupDevOpsRepositoryReply> list,
        ...
        public static List<string> SelectedFields(this List<BackupDevOpsRepositoryReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BackupDevOpsRepositoryReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BackupDevOpsRepositoryReply> list)
        {

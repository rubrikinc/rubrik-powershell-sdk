...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateGlobalCertificateReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateGlobalCertificateReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateGlobalCertificateReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCdmUserExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmUser> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmUser());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmUser> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class K8sClusterDescendantEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (K8sClusterDescendant)InterfaceHelper.CreateInstanceOfFirstType(typeof(K8sClusterDescendant));
    ...
    public static class ListK8sClusterDescendantEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new K8sClusterDescendantEdge();
            list.Add(item);

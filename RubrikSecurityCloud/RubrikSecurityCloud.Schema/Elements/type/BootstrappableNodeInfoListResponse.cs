// BootstrappableNodeInfoListResponse.cs
//
...
{
    #region BootstrappableNodeInfoListResponse
    public class BootstrappableNodeInfoListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<BootstrappableNodeInfo>? Data
        // GraphQL -> data: [BootstrappableNodeInfo!]! (type)
        [JsonProperty("data")]
        public List<BootstrappableNodeInfo>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "BootstrappableNodeInfoListResponse";
    }

    public BootstrappableNodeInfoListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<BootstrappableNodeInfo>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<BootstrappableNodeInfo>();
    ...
    } // class BootstrappableNodeInfoListResponse
    
    #endregion

    public static class ListBootstrappableNodeInfoListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BootstrappableNodeInfoListResponse> list,
        ...
        public static List<string> SelectedFields(this List<BootstrappableNodeInfoListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BootstrappableNodeInfoListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BootstrappableNodeInfoListResponse> list)
        {

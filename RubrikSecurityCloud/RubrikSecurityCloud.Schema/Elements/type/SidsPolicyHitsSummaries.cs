...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.SidSummaries != null) {
            var fspec = this.SidSummaries.AsFieldSpec(conf.Child("sidSummaries"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<SidPolicyHitsSummary>? SidSummaries
        // GraphQL -> sidSummaries: [SidPolicyHitsSummary!]! (type)
        if (ec.Includes("sidSummaries",false))
        {
            if(this.SidSummaries == null) {
        ...
        else if (this.SidSummaries != null && ec.Excludes("sidSummaries",false))
        {
            this.SidSummaries = null;
        }
    }
    ...
    public static class ListSidsPolicyHitsSummariesExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SidsPolicyHitsSummaries> list)
        {
        ...
        public static void SelectForRetrieval(this List<SidsPolicyHitsSummaries> list)
        {

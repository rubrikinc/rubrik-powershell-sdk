...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListJiraProjectConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<JiraProjectConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<JiraProjectConnection> list)
        {

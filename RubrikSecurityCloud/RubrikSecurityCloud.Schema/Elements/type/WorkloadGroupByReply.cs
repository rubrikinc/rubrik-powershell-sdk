...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.PrimaryGroupBys != null) {
            var fspec = this.PrimaryGroupBys.AsFieldSpec(conf.Child("primaryGroupBys"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<WorkloadGroupByPrimaryGroupByItem>? PrimaryGroupBys
        // GraphQL -> primaryGroupBys: [WorkloadGroupByPrimaryGroupByItem!]! (type)
        if (ec.Includes("primaryGroupBys",false))
        {
            if(this.PrimaryGroupBys == null) {
        ...
        else if (this.PrimaryGroupBys != null && ec.Excludes("primaryGroupBys",false))
        {
            this.PrimaryGroupBys = null;
        }
    }
    ...
    public static class ListWorkloadGroupByReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<WorkloadGroupByReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<WorkloadGroupByReply> list)
        {

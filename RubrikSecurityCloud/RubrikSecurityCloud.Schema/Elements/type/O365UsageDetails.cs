...
{
    #region O365UsageDetails
    public class O365UsageDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "O365UsageDetails";
    }

    public O365UsageDetails Set(
    ...
    } // class O365UsageDetails
    
    #endregion

    public static class ListO365UsageDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<O365UsageDetails> list,
        ...
        public static List<string> SelectedFields(this List<O365UsageDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365UsageDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365UsageDetails> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Int64? TotalStorageInBytes
        // GraphQL -> totalStorageInBytes: Long! (scalar)
        if (this.TotalStorageInBytes == null && Exploration.Includes(parent + ".totalStorageInBytes", true))
        {
            this.TotalStorageInBytes = new System.Int64();
        }
        //      C# -> System.Int64? UsedStorageInBytes
        // GraphQL -> usedStorageInBytes: Long! (scalar)
        if (this.UsedStorageInBytes == null && Exploration.Includes(parent + ".usedStorageInBytes", true))
        {
        ...
        //      C# -> System.String? UserPrincipalName
        // GraphQL -> userPrincipalName: String! (scalar)
        if (this.UserPrincipalName == null && Exploration.Includes(parent + ".userPrincipalName", true))
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class O365Onedrive: IFragment, HierarchyObject, HierarchySnappable, O365OrgDescendant, O365UserDescendant, O365UserDescendantMetadata, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        //      C# -> System.String? Id
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int64? TotalStorageInBytes
            // GraphQL -> totalStorageInBytes: Long! (scalar)
            if (this.TotalStorageInBytes == null && Exploration.Includes(parent + ".totalStorageInBytes$"))
            {
                this.TotalStorageInBytes = new System.Int64();
            }
            //      C# -> System.Int64? UsedStorageInBytes
            // GraphQL -> usedStorageInBytes: Long! (scalar)
            if (this.UsedStorageInBytes == null && Exploration.Includes(parent + ".usedStorageInBytes$"))
            {

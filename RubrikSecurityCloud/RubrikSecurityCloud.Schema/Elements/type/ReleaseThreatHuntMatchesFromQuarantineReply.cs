...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "ReleaseThreatHuntMatchesFromQuarantineReply";
    }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.IsReleaseFromQuarantineSuccessful != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isReleaseFromQuarantineSuccessful\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> System.Boolean? IsReleaseFromQuarantineSuccessful
        // GraphQL -> isReleaseFromQuarantineSuccessful: Boolean! (scalar)
        if (ec.Includes("isReleaseFromQuarantineSuccessful",true))
        {
            if(this.IsReleaseFromQuarantineSuccessful == null) {
        ...
        else if (this.IsReleaseFromQuarantineSuccessful != null && ec.Excludes("isReleaseFromQuarantineSuccessful",true))
        {
            this.IsReleaseFromQuarantineSuccessful = null;
        }
    }
    ...
    public static class ListReleaseThreatHuntMatchesFromQuarantineReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReleaseThreatHuntMatchesFromQuarantineReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReleaseThreatHuntMatchesFromQuarantineReply> list)
        {

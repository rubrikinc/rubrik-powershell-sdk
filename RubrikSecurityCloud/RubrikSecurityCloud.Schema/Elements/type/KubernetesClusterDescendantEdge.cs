...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KubernetesClusterDescendantEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<KubernetesClusterDescendant> Node { get; set; }
    ...
    public KubernetesClusterDescendantEdge Set(
        RscInterface<KubernetesClusterDescendant> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<KubernetesClusterDescendant>();
    ...
    public static class ListKubernetesClusterDescendantEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<KubernetesClusterDescendantEdge> list)
        {

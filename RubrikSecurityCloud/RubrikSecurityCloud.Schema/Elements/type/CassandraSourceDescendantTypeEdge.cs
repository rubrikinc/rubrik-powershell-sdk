...
namespace RubrikSecurityCloud.Types
{
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "CassandraSourceDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public static class ListCassandraSourceDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourceDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<CassandraSourceDescendantTypeEdge> list)
        {

// ClassificationPolicySummary.cs
//
...
{
    #region ClassificationPolicySummary
    public class ClassificationPolicySummary: BaseType
    {
        #region members
    ...
    public static class ListClassificationPolicySummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ClassificationPolicySummary> list,
        ...
        public static List<string> SelectedFields(this List<ClassificationPolicySummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ClassificationPolicySummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ClassificationPolicySummary> list)
        {

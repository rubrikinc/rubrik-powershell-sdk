...
{
    #region KubernetesProtectionSet
 
    public class KubernetesProtectionSet: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, KubernetesClusterDescendant
    {
        #region members
        ...
        //      C# -> System.String? RsName
        // GraphQL -> rsName: String! (scalar)
        [JsonProperty("rsName")]
        public System.String? RsName { get; set; }
    ...
    public KubernetesProtectionSet()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "KubernetesProtectionSet";
    }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.RsName != null && ec.Excludes("rsName",true))
        {
            this.RsName = null;
        }
        //      C# -> System.String? RsType
    ...
    } // class KubernetesProtectionSet
    
    #endregion

    public static class ListKubernetesProtectionSetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesProtectionSet> list,
        ...
        public static List<string> SelectedFields(this List<KubernetesProtectionSet> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesProtectionSet());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KubernetesProtectionSet> list)
        {

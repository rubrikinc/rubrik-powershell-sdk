...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.ActiveDirectoryDomain != null) {
            s += ind + "activeDirectoryDomain {\n" + this.ActiveDirectoryDomain.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        if (this.AdServiceStatus != null) {
            s += ind + "adServiceStatus {\n" + this.AdServiceStatus.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        if (this.RbsStatus != null) {
            s += ind + "rbsStatus {\n" + this.RbsStatus.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> Snappable? ReportWorkload
        // GraphQL -> reportWorkload: Snappable (type)
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> List<FsmoRoles>? FsmoRoles
        // GraphQL -> fsmoRoles: [FsmoRoles!]! (enum)
        if (this.FsmoRoles == null && Exploration.Includes(parent + ".fsmoRoles", true))
        {
        ...
        //      C# -> List<ServerRoles>? ServerRoles
        // GraphQL -> serverRoles: [ServerRoles!]! (enum)
        if (this.ServerRoles == null && Exploration.Includes(parent + ".serverRoles", true))
        {
        ...
        {
            this.AgentUuid = new System.String("FETCH");
        }
        //      C# -> System.String? CdmId
        // GraphQL -> cdmId: String! (scalar)
        ...
        //      C# -> ActiveDirectoryDomain? ActiveDirectoryDomain
        // GraphQL -> activeDirectoryDomain: ActiveDirectoryDomain! (type)
        if (this.ActiveDirectoryDomain == null && Exploration.Includes(parent + ".activeDirectoryDomain"))
        {
            this.ActiveDirectoryDomain = new ActiveDirectoryDomain();
            this.ActiveDirectoryDomain.ApplyExploratoryFieldSpec(parent + ".activeDirectoryDomain");
        }
        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        if (this.AdServiceStatus == null && Exploration.Includes(parent + ".adServiceStatus"))
        {
            this.AdServiceStatus = new ActiveDirectoryServiceStatus();
            this.AdServiceStatus.ApplyExploratoryFieldSpec(parent + ".adServiceStatus");
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        //      C# -> HostConnectionStatus? RbsStatus
        // GraphQL -> rbsStatus: HostConnectionStatus! (type)
        if (this.RbsStatus == null && Exploration.Includes(parent + ".rbsStatus"))
        {
            this.RbsStatus = new HostConnectionStatus();
            this.RbsStatus.ApplyExploratoryFieldSpec(parent + ".rbsStatus");
        }
        //      C# -> Snappable? ReportWorkload
        // GraphQL -> reportWorkload: Snappable (type)

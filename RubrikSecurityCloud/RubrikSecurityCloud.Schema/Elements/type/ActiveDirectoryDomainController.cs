// ActiveDirectoryDomainController.cs
//
...
{
    #region ActiveDirectoryDomainController
 
    public class ActiveDirectoryDomainController: BaseType, ActiveDirectoryDomainDescendantType, ActiveDirectoryDomainPhysicalChildType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable
    {
        #region members
        ...
        //      C# -> List<ServerRoles>? ServerRoles
        // GraphQL -> serverRoles: [ServerRoles!]! (enum)
        ...
        //      C# -> List<System.String>? MacAddresses
        // GraphQL -> macAddresses: [String!]! (scalar)
        [JsonProperty("macAddresses")]
        public List<System.String>? MacAddresses { get; set; }
        ...
        [JsonProperty("activeDirectoryDomain")]
        public ActiveDirectoryDomain? ActiveDirectoryDomain { get; set; }

        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        [JsonProperty("adServiceStatus")]
        public ActiveDirectoryServiceStatus? AdServiceStatus { get; set; }
        ...
        //      C# -> CdmSnapshot? NewestCleanSnapshot
        // GraphQL -> newestCleanSnapshot: CdmSnapshot (type)
        [JsonProperty("newestCleanSnapshot")]
        public CdmSnapshot? NewestCleanSnapshot { get; set; }
        ...
        //      C# -> HostConnectionStatus? RbsStatus
        // GraphQL -> rbsStatus: HostConnectionStatus! (type)
        [JsonProperty("rbsStatus")]
        public HostConnectionStatus? RbsStatus { get; set; }
    ...
    public ActiveDirectoryDomainController Set(
        ...
        List<ServerRoles>? ServerRoles = null,
        ...
        ActiveDirectoryServiceStatus? AdServiceStatus = null,
        ...
        CdmSnapshot? NewestCleanSnapshot = null,
        ...
        HostConnectionStatus? RbsStatus = null,
    ...
    ) 
    {
        ...
        if ( NewestCleanSnapshot != null ) {
            this.NewestCleanSnapshot = NewestCleanSnapshot;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> ActiveDirectoryDomain? ActiveDirectoryDomain
        // GraphQL -> activeDirectoryDomain: ActiveDirectoryDomain! (type)
        if (this.ActiveDirectoryDomain != null) {
            var fspec = this.ActiveDirectoryDomain.AsFieldSpec(conf.Child("activeDirectoryDomain"));
        ...
        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        if (this.AdServiceStatus != null) {
            var fspec = this.AdServiceStatus.AsFieldSpec(conf.Child("adServiceStatus"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        //      C# -> CdmSnapshot? NewestCleanSnapshot
        // GraphQL -> newestCleanSnapshot: CdmSnapshot (type)
        if (this.NewestCleanSnapshot != null) {
            var fspec = this.NewestCleanSnapshot.AsFieldSpec(conf.Child("newestCleanSnapshot"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        if (this.RbsStatus != null) {
            var fspec = this.RbsStatus.AsFieldSpec(conf.Child("rbsStatus"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> List<ServerRoles>? ServerRoles
        // GraphQL -> serverRoles: [ServerRoles!]! (enum)
        if (ec.Includes("serverRoles",true))
        {
            if(this.ServerRoles == null) {

                this.ServerRoles = new List<ServerRoles>();
        ...
        else if (this.ServerRoles != null && ec.Excludes("serverRoles",true))
        {
        ...
        else if (this.AgentUuid != null && ec.Excludes("agentUuid",true))
        {
            this.AgentUuid = null;
        }
        //      C# -> System.String? CdmId
        ...
        //      C# -> System.String? DcLocation
        // GraphQL -> dcLocation: String (scalar)
        if (ec.Includes("dcLocation",true))
        {
            if(this.DcLocation == null) {
        ...
        //      C# -> List<System.String>? MacAddresses
        // GraphQL -> macAddresses: [String!]! (scalar)
        if (ec.Includes("macAddresses",true))
        {
            if(this.MacAddresses == null) {

                this.MacAddresses = new List<System.String>();
        ...
        else if (this.MacAddresses != null && ec.Excludes("macAddresses",true))
        {
        ...
        //      C# -> ActiveDirectoryDomain? ActiveDirectoryDomain
        // GraphQL -> activeDirectoryDomain: ActiveDirectoryDomain! (type)
        if (ec.Includes("activeDirectoryDomain",false))
        {
            if(this.ActiveDirectoryDomain == null) {

                this.ActiveDirectoryDomain = new ActiveDirectoryDomain();
                this.ActiveDirectoryDomain.ApplyExploratoryFieldSpec(ec.NewChild("activeDirectoryDomain"));
        ...
        else if (this.ActiveDirectoryDomain != null && ec.Excludes("activeDirectoryDomain",false))
        {
            this.ActiveDirectoryDomain = null;
        }
        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        if (ec.Includes("adServiceStatus",false))
        {
            if(this.AdServiceStatus == null) {

                this.AdServiceStatus = new ActiveDirectoryServiceStatus();
                this.AdServiceStatus.ApplyExploratoryFieldSpec(ec.NewChild("adServiceStatus"));
        ...
        else if (this.AdServiceStatus != null && ec.Excludes("adServiceStatus",false))
        {
            this.AdServiceStatus = null;
        }
        //      C# -> List<Org>? AllOrgs
        // GraphQL -> allOrgs: [Org!]! (type)
        ...
        //      C# -> CdmSnapshot? NewestCleanSnapshot
        // GraphQL -> newestCleanSnapshot: CdmSnapshot (type)
        if (ec.Includes("newestCleanSnapshot",false))
        {
            if(this.NewestCleanSnapshot == null) {

                this.NewestCleanSnapshot = new CdmSnapshot();
                this.NewestCleanSnapshot.ApplyExploratoryFieldSpec(ec.NewChild("newestCleanSnapshot"));
        ...
        else if (this.NewestCleanSnapshot != null && ec.Excludes("newestCleanSnapshot",false))
        {
            this.NewestCleanSnapshot = null;
        }
        //      C# -> CdmSnapshot? NewestIndexedSnapshot
        // GraphQL -> newestIndexedSnapshot: CdmSnapshot (type)
        ...
        //      C# -> HostConnectionStatus? RbsStatus
        // GraphQL -> rbsStatus: HostConnectionStatus! (type)
        if (ec.Includes("rbsStatus",false))
        {
            if(this.RbsStatus == null) {

                this.RbsStatus = new HostConnectionStatus();
                this.RbsStatus.ApplyExploratoryFieldSpec(ec.NewChild("rbsStatus"));
        ...
        else if (this.RbsStatus != null && ec.Excludes("rbsStatus",false))
        {
            this.RbsStatus = null;
        }
        //      C# -> Snappable? ReportWorkload
    ...
    public static class ListActiveDirectoryDomainControllerExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ActiveDirectoryDomainController> list,
        ...
        public static List<string> SelectedFields(this List<ActiveDirectoryDomainController> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ActiveDirectoryDomainController());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ActiveDirectoryDomainController> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.ActiveDirectoryDomain != null) {
            var fspec = this.ActiveDirectoryDomain.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        if (this.AdServiceStatus != null) {
            var fspec = this.AdServiceStatus.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        if (this.RbsStatus != null) {
            var fspec = this.RbsStatus.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                s += ind + "rbsStatus {\n" + fspec + ind + "}\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<FsmoRoles>? FsmoRoles
        // GraphQL -> fsmoRoles: [FsmoRoles!]! (enum)
        if (this.FsmoRoles == null && ec.Includes("fsmoRoles",true))
        {
        ...
        //      C# -> List<ServerRoles>? ServerRoles
        // GraphQL -> serverRoles: [ServerRoles!]! (enum)
        if (this.ServerRoles == null && ec.Includes("serverRoles",true))
        {
        ...
        //      C# -> System.String? AgentUuid
        // GraphQL -> agentUuid: String (scalar)
        if (this.AgentUuid == null && ec.Includes("agentUuid",true))
        {
        ...
        //      C# -> System.String? DcLocation
        // GraphQL -> dcLocation: String (scalar)
        if (this.DcLocation == null && ec.Includes("dcLocation",true))
        {
        ...
        //      C# -> ActiveDirectoryDomain? ActiveDirectoryDomain
        // GraphQL -> activeDirectoryDomain: ActiveDirectoryDomain! (type)
        if (this.ActiveDirectoryDomain == null && ec.Includes("activeDirectoryDomain",false))
        {
        ...
        //      C# -> ActiveDirectoryServiceStatus? AdServiceStatus
        // GraphQL -> adServiceStatus: ActiveDirectoryServiceStatus! (type)
        if (this.AdServiceStatus == null && ec.Includes("adServiceStatus",false))
        {
        ...
        //      C# -> HostConnectionStatus? RbsStatus
        // GraphQL -> rbsStatus: HostConnectionStatus! (type)
        if (this.RbsStatus == null && ec.Includes("rbsStatus",false))
        {
    ...
    public static class ListActiveDirectoryDomainControllerExtensions
    {
        ...
        public static void Fetch(this List<ActiveDirectoryDomainController> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListNtpServerConfigurationListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NtpServerConfigurationListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<NtpServerConfigurationListResponse> list)
        {

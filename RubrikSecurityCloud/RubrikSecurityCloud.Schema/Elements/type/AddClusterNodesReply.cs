...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AddClusterNodesReply: BaseType
    {
        #region members
    ...
    public static class ListAddClusterNodesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddClusterNodesReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddClusterNodesReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddClusterNodesReply> list)
        {

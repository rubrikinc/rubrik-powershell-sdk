...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "AzureNativeVirtualMachineConnection";
    }
    ...
    public static class ListAzureNativeVirtualMachineConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureNativeVirtualMachineConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureNativeVirtualMachineConnection> list)
        {

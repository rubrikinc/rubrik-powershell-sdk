...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateOrgNetworkReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateOrgNetworkReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateOrgNetworkReply> list)
        {

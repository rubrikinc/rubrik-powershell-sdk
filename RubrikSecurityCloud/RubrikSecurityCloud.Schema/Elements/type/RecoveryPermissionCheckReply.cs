...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRecoveryPermissionCheckReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RecoveryPermissionCheckReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<RecoveryPermissionCheckReply> list)
        {

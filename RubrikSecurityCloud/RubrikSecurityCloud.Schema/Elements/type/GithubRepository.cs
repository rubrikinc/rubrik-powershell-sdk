...
namespace RubrikSecurityCloud.Types
{
    ...
    public class GithubRepository: BaseType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public static class ListGithubRepositoryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GithubRepository> list,
        ...
        public static List<string> SelectedFields(this List<GithubRepository> list)
        {
        ...
        public static void SelectForRetrieval(this List<GithubRepository> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListO365TeamsChannelEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamsChannelEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365TeamsChannelEdge> list)
        {

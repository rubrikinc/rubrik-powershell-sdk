...
{
    #region PartialSlaSummary
    public class PartialSlaSummary: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PartialSlaSummary";
    }

    public PartialSlaSummary Set(
    ...
    } // class PartialSlaSummary
    
    #endregion

    public static class ListPartialSlaSummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PartialSlaSummary> list,
        ...
        public static List<string> SelectedFields(this List<PartialSlaSummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PartialSlaSummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PartialSlaSummary> list)
        {

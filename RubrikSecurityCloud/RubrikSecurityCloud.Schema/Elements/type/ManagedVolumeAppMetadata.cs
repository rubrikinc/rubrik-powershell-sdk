...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "ManagedVolumeAppMetadata";
    }
    ...
    public static class ListManagedVolumeAppMetadataExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeAppMetadata> list)
        {
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeAppMetadata> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> ProxySettings? ArchivalProxySettings
        // GraphQL -> archivalProxySettings: ProxySettings (type)
        if (this.ArchivalProxySettings == null && Exploration.Includes(parent + ".archivalProxySettings"))
        {
            this.ArchivalProxySettings = new ProxySettings();
            this.ArchivalProxySettings.ApplyExploratoryFieldSpec(parent + ".archivalProxySettings");
        }
        //      C# -> Cluster? Cluster
        // GraphQL -> cluster: Cluster! (type)

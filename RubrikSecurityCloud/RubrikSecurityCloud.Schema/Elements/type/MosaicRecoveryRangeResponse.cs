// MosaicRecoveryRangeResponse.cs
//
...
{
    #region MosaicRecoveryRangeResponse
    public class MosaicRecoveryRangeResponse: BaseType
    {
        #region members
        ...
        //      C# -> MosaicRecoveryRangeObject? Data
        // GraphQL -> data: MosaicRecoveryRangeObject (type)
        [JsonProperty("data")]
        public MosaicRecoveryRangeObject? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MosaicRecoveryRangeResponse";
    }

    public MosaicRecoveryRangeResponse Set(
        System.String? Message = null,
        System.Int64? ReturnCode = null,
        System.Boolean? Status = null,
        MosaicRecoveryRangeObject? Data = null
    ) 
    {
        if ( Message != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new MosaicRecoveryRangeObject();
    ...
    } // class MosaicRecoveryRangeResponse
    
    #endregion

    public static class ListMosaicRecoveryRangeResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MosaicRecoveryRangeResponse> list,
        ...
        public static List<string> SelectedFields(this List<MosaicRecoveryRangeResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MosaicRecoveryRangeResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MosaicRecoveryRangeResponse> list)
        {

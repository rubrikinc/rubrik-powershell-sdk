...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlInstanceDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MssqlInstanceDescendantType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MssqlInstanceDescendantTypeEdge";
    }

    public MssqlInstanceDescendantTypeEdge Set(
        RscInterface<MssqlInstanceDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MssqlInstanceDescendantType>();
    ...
    public static class ListMssqlInstanceDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlInstanceDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<MssqlInstanceDescendantTypeEdge> list)
        {

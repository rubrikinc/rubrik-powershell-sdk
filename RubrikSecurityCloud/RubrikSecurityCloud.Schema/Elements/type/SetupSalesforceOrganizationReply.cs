// SetupSalesforceOrganizationReply.cs
//
...
{
    #region SetupSalesforceOrganizationReply
    public class SetupSalesforceOrganizationReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SetupSalesforceOrganizationReply";
    }

    public SetupSalesforceOrganizationReply Set(
    ...
    } // class SetupSalesforceOrganizationReply
    
    #endregion

    public static class ListSetupSalesforceOrganizationReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SetupSalesforceOrganizationReply> list,
        ...
        public static List<string> SelectedFields(this List<SetupSalesforceOrganizationReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SetupSalesforceOrganizationReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SetupSalesforceOrganizationReply> list)
        {

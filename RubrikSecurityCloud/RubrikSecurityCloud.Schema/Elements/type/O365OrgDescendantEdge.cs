...
{
    #region O365OrgDescendantEdge
    public class O365OrgDescendantEdge: BaseType
    {
        #region members
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365OrgDescendantEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class O365OrgDescendantEdge
    
    #endregion

    public static class ListO365OrgDescendantEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<O365OrgDescendantEdge> list,
        ...
        public static List<string> SelectedFields(this List<O365OrgDescendantEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365OrgDescendantEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365OrgDescendantEdge> list)
        {

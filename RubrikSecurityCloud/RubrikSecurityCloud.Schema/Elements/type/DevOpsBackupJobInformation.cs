...
{
    #region DevOpsBackupJobInformation
    public class DevOpsBackupJobInformation: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DevOpsBackupJobInformation";
    }

    public DevOpsBackupJobInformation Set(
    ...
    } // class DevOpsBackupJobInformation
    
    #endregion

    public static class ListDevOpsBackupJobInformationExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DevOpsBackupJobInformation> list,
        ...
        public static List<string> SelectedFields(this List<DevOpsBackupJobInformation> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DevOpsBackupJobInformation());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DevOpsBackupJobInformation> list)
        {

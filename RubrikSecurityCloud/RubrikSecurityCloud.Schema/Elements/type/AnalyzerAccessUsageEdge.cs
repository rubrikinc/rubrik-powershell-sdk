...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "AnalyzerAccessUsageEdge";
    }
    ...
    public static class ListAnalyzerAccessUsageEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnalyzerAccessUsageEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<AnalyzerAccessUsageEdge> list)
        {

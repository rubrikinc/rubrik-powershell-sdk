...
{
    #region BulkRegisterHostReply
    public class BulkRegisterHostReply: BaseType
    {
        #region members
        ...
        //      C# -> List<HostDetail>? Data
        // GraphQL -> data: [HostDetail!]! (type)
        [JsonProperty("data")]
        public List<HostDetail>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "BulkRegisterHostReply";
    }

    public BulkRegisterHostReply Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<HostDetail>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    } // class BulkRegisterHostReply
    
    #endregion

    public static class ListBulkRegisterHostReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BulkRegisterHostReply> list,
        ...
        public static List<string> SelectedFields(this List<BulkRegisterHostReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BulkRegisterHostReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BulkRegisterHostReply> list)
        {

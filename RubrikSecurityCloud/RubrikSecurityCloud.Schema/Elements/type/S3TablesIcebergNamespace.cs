...
{
    #region S3TablesIcebergNamespace
 
    public class S3TablesIcebergNamespace: BaseType, AwsNativeAccountDescendantType, AwsNativeHierarchyObject, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public S3TablesIcebergNamespace()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "S3TablesIcebergNamespace";
    }

    public S3TablesIcebergNamespace Set(
    ...
    } // class S3TablesIcebergNamespace
    
    #endregion

    public static class ListS3TablesIcebergNamespaceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<S3TablesIcebergNamespace> list,
        ...
        public static List<string> SelectedFields(this List<S3TablesIcebergNamespace> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new S3TablesIcebergNamespace());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<S3TablesIcebergNamespace> list)
        {

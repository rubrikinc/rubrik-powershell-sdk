...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HostDiagnosisSummary: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.Connectivity != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.Connectivity.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.Connectivity == null && Exploration.Includes(parent + ".connectivity"))
            {
                ...
                this.Connectivity.ApplyExploratoryFragment(parent + ".connectivity");
            }
        }
    ...
    public static class ListHostDiagnosisSummaryExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HostDiagnosisSummary();
            list.Add(item);

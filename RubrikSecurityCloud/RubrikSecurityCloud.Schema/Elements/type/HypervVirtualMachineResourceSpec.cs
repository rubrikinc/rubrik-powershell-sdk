// HypervVirtualMachineResourceSpec.cs
//
...
{
    #region HypervVirtualMachineResourceSpec
    public class HypervVirtualMachineResourceSpec: BaseType
    {
        #region members
        ...
        //      C# -> List<HypervVirtualMachineNic>? NetworkInterfaces
        // GraphQL -> networkInterfaces: [HypervVirtualMachineNic!]! (type)
        [JsonProperty("networkInterfaces")]
        public List<HypervVirtualMachineNic>? NetworkInterfaces { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "HypervVirtualMachineResourceSpec";
    }

    public HypervVirtualMachineResourceSpec Set(
        ...
        List<HypervVirtualMachineNic>? NetworkInterfaces = null
    ) 
    {
        if ( IsArchived != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("networkInterfaces",false))
        {
            if(this.NetworkInterfaces == null) {
                ...
                this.NetworkInterfaces = new List<HypervVirtualMachineNic>();
    ...
    } // class HypervVirtualMachineResourceSpec
    
    #endregion

    public static class ListHypervVirtualMachineResourceSpecExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<HypervVirtualMachineResourceSpec> list,
        ...
        public static List<string> SelectedFields(this List<HypervVirtualMachineResourceSpec> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HypervVirtualMachineResourceSpec());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HypervVirtualMachineResourceSpec> list)
        {

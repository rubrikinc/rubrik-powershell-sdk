...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "MosaicRecoverableRangeObject";
    }
    ...
    public static class ListMosaicRecoverableRangeObjectExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MosaicRecoverableRangeObject> list)
        {
        ...
        public static void SelectForRetrieval(this List<MosaicRecoverableRangeObject> list)
        {

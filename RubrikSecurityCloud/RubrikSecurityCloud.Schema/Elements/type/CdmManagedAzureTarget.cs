...
{
    #region CdmManagedAzureTarget
 
    public class CdmManagedAzureTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedAzureTarget";
    }

    public CdmManagedAzureTarget Set(
    ...
    } // class CdmManagedAzureTarget
    
    #endregion

    public static class ListCdmManagedAzureTargetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmManagedAzureTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedAzureTarget());
            }

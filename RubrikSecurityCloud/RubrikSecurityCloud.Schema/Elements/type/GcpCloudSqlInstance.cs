...
{
    #region GcpCloudSqlInstance
 
    public class GcpCloudSqlInstance: BaseType, GcpNativeHierarchyObject, GcpNativeProjectDescendantType, GcpNativeProjectLogicalChildType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> GcpCloudSqlAvailabilityType? AvailabilityType
        // GraphQL -> availabilityType: GcpCloudSqlAvailabilityType! (enum)
        ...
        public GcpCloudSqlEngineType? EngineType { get; set; }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.AvailabilityType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "availabilityType\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> GcpCloudSqlAvailabilityType? AvailabilityType
        // GraphQL -> availabilityType: GcpCloudSqlAvailabilityType! (enum)
        if (ec.Includes("availabilityType",true))
        {
            if(this.AvailabilityType == null) {

                this.AvailabilityType = new GcpCloudSqlAvailabilityType();
        ...
        else if (this.AvailabilityType != null && ec.Excludes("availabilityType",true))
        {
        ...
        if (ec.Includes("engineType",true))
        {
            if(this.EngineType == null) {
                ...
                this.EngineType = new GcpCloudSqlEngineType();
        ...
        else if (this.EngineType != null && ec.Excludes("engineType",true))
        {
    ...
    public static class ListGcpCloudSqlInstanceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpCloudSqlInstance> list,
        ...
        public static List<string> SelectedFields(this List<GcpCloudSqlInstance> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpCloudSqlInstance());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpCloudSqlInstance> list)
        {

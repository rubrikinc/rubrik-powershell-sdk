...
{
    #region DataCategoryStats
    public class DataCategoryStats: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DataCategoryStats";
    }

    public DataCategoryStats Set(
    ...
    } // class DataCategoryStats
    
    #endregion

    public static class ListDataCategoryStatsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DataCategoryStats> list,
        ...
        public static List<string> SelectedFields(this List<DataCategoryStats> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DataCategoryStats());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DataCategoryStats> list)
        {

...
{
    #region CdmManagedDcaTarget
 
    public class CdmManagedDcaTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedDcaTarget";
    }

    public CdmManagedDcaTarget Set(
    ...
    } // class CdmManagedDcaTarget
    
    #endregion

    public static class ListCdmManagedDcaTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CdmManagedDcaTarget> list,
        ...
        public static List<string> SelectedFields(this List<CdmManagedDcaTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedDcaTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmManagedDcaTarget> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AzureSqlManagedInstanceServer: IFragment, PolarisHierarchyObject, HierarchyObject
    {
        #region members
        //      C# -> System.String? Id
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.String? InstancePoolName
            // GraphQL -> instancePoolName: String! (scalar)
            if (this.InstancePoolName == null && Exploration.Includes(parent + ".instancePoolName$"))
            {
                this.InstancePoolName = new System.String("FETCH");
            }
            //      C# -> System.String? Name
            // GraphQL -> name: String! (scalar)
            ...
            //      C# -> System.Int64? StorageSizeGib
            // GraphQL -> storageSizeGib: Long! (scalar)
            if (this.StorageSizeGib == null && Exploration.Includes(parent + ".storageSizeGib$"))
            {
            ...
            //      C# -> System.Int32? VcoresCount
            // GraphQL -> vCoresCount: Int! (scalar)
            if (this.VcoresCount == null && Exploration.Includes(parent + ".vCoresCount$"))
            {
                this.VcoresCount = new System.Int32();
            }
            //      C# -> System.String? VnetName
            // GraphQL -> vnetName: String! (scalar)
    ...
    public static class ListAzureSqlManagedInstanceServerExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new AzureSqlManagedInstanceServer();
            list.Add(item);

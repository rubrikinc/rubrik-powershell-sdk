...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.AzureNativeResourceGroup != null) {
            var fspec = this.AzureNativeResourceGroup.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        if (this.BackupSetupSourceObject != null) {
            var fspec = this.BackupSetupSourceObject.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? InstancePoolName
        // GraphQL -> instancePoolName: String! (scalar)
        if (this.InstancePoolName == null && ec.Includes("instancePoolName",true))
        {
        ...
        //      C# -> System.Int64? StorageSizeGib
        // GraphQL -> storageSizeGib: Long! (scalar)
        if (this.StorageSizeGib == null && ec.Includes("storageSizeGib",true))
        {
        ...
        //      C# -> System.Int32? VcoresCount
        // GraphQL -> vCoresCount: Int! (scalar)
        if (this.VcoresCount == null && ec.Includes("vCoresCount",true))
        {
        ...
        //      C# -> AzureNativeResourceGroup? AzureNativeResourceGroup
        // GraphQL -> azureNativeResourceGroup: AzureNativeResourceGroup! (type)
        if (this.AzureNativeResourceGroup == null && ec.Includes("azureNativeResourceGroup",false))
        {
        ...
        //      C# -> PathNode? BackupSetupSourceObject
        // GraphQL -> backupSetupSourceObject: PathNode (type)
        if (this.BackupSetupSourceObject == null && ec.Includes("backupSetupSourceObject",false))
        {
    ...
    public static class ListAzureSqlManagedInstanceServerExtensions
    {
        ...
        public static void Fetch(this List<AzureSqlManagedInstanceServer> list)
        {

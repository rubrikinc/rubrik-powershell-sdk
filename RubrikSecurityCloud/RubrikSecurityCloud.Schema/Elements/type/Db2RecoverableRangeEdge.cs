...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2RecoverableRangeEdge: BaseType
    {
        #region members
    ...
    public static class ListDb2RecoverableRangeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2RecoverableRangeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new Db2RecoverableRangeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<Db2RecoverableRangeEdge> list)
        {

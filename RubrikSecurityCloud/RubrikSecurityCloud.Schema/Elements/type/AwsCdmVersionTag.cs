...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAwsCdmVersionTagExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsCdmVersionTag> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsCdmVersionTag> list)
        {

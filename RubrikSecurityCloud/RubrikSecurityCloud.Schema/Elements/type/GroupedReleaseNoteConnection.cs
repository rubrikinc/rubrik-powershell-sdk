...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "GroupedReleaseNoteConnection";
    }
    ...
    public static class ListGroupedReleaseNoteConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GroupedReleaseNoteConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<GroupedReleaseNoteConnection> list)
        {

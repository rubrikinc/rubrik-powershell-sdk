...
{
    #region AzureExoTaskImageBundle
    public class AzureExoTaskImageBundle: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureExoTaskImageBundle";
    }

    public AzureExoTaskImageBundle Set(
    ...
    } // class AzureExoTaskImageBundle
    
    #endregion

    public static class ListAzureExoTaskImageBundleExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureExoTaskImageBundle> list,
        ...
        public static List<string> SelectedFields(this List<AzureExoTaskImageBundle> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureExoTaskImageBundle());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureExoTaskImageBundle> list)
        {

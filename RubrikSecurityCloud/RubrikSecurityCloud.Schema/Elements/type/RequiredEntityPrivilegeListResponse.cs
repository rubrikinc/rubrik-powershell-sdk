// RequiredEntityPrivilegeListResponse.cs
//
...
{
    #region RequiredEntityPrivilegeListResponse
    public class RequiredEntityPrivilegeListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<RequiredEntityPrivilege>? Data
        // GraphQL -> data: [RequiredEntityPrivilege!]! (type)
        [JsonProperty("data")]
        public List<RequiredEntityPrivilege>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "RequiredEntityPrivilegeListResponse";
    }

    public RequiredEntityPrivilegeListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int32? Total = null,
        List<RequiredEntityPrivilege>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<RequiredEntityPrivilege>();
    ...
    } // class RequiredEntityPrivilegeListResponse
    
    #endregion

    public static class ListRequiredEntityPrivilegeListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RequiredEntityPrivilegeListResponse> list,
        ...
        public static List<string> SelectedFields(this List<RequiredEntityPrivilegeListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RequiredEntityPrivilegeListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RequiredEntityPrivilegeListResponse> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDb2RecoverableRangeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2RecoverableRangeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<Db2RecoverableRangeConnection> list)
        {

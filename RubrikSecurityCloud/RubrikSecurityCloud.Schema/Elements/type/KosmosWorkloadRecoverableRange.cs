...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KosmosWorkloadRecoverableRange: BaseType
    {
        ...
        //      C# -> KosmosWorkloadRecoverableRangeType? RrType
        // GraphQL -> rrType: KosmosWorkloadRecoverableRangeType! (enum)
        [JsonProperty("rrType")]
        public KosmosWorkloadRecoverableRangeType? RrType { get; set; }
    ...
    public KosmosWorkloadRecoverableRange Set(
        KosmosWorkloadRecoverableRangeType? RrType = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        //      C# -> KosmosWorkloadRecoverableRangeType? RrType
        // GraphQL -> rrType: KosmosWorkloadRecoverableRangeType! (enum)
        if (ec.Includes("rrType",true))
        {
            if(this.RrType == null) {

                this.RrType = new KosmosWorkloadRecoverableRangeType();
        ...
        else if (this.RrType != null && ec.Excludes("rrType",true))
        {
            this.RrType = null;
        }
        //      C# -> System.String? BaseFullSnapshotId

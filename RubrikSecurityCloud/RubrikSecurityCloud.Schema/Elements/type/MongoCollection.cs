...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollection_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollection_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollection_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollection_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MongoCollection_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        if (this.CollectionSet != null) {
            var fspec = this.CollectionSet.AsFieldSpec(conf.Child("collectionSet"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        if (this.Database != null) {
            var fspec = this.Database.AsFieldSpec(conf.Child("database"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        if (this.MongoSnapshotGroupByConnection != null) {
            var fspec = this.MongoSnapshotGroupByConnection.AsFieldSpec(conf.Child("mongoSnapshotGroupByConnection"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> MongoCollectionSet? CollectionSet
        // GraphQL -> collectionSet: MongoCollectionSet! (type)
        if (ec.Includes("collectionSet",false))
        {
            if(this.CollectionSet == null) {
        ...
        else if (this.CollectionSet != null && ec.Excludes("collectionSet",false))
        {
            this.CollectionSet = null;
        }
        //      C# -> MongoDatabase? Database
        // GraphQL -> database: MongoDatabase! (type)
        if (ec.Includes("database",false))
        {
            if(this.Database == null) {
        ...
        else if (this.Database != null && ec.Excludes("database",false))
        {
            this.Database = null;
        }
        //      C# -> PathNode? EffectiveSlaSourceObject
        ...
        //      C# -> MongoSnapshotGroupByConnection? MongoSnapshotGroupByConnection
        // GraphQL -> mongoSnapshotGroupByConnection: MongoSnapshotGroupByConnection (type)
        if (ec.Includes("mongoSnapshotGroupByConnection",false))
        {
            if(this.MongoSnapshotGroupByConnection == null) {
        ...
        else if (this.MongoSnapshotGroupByConnection != null && ec.Excludes("mongoSnapshotGroupByConnection",false))
        {
            this.MongoSnapshotGroupByConnection = null;
        }
        //      C# -> CdmSnapshot? NewestSnapshot
        // GraphQL -> newestSnapshot: CdmSnapshot (type)
    ...
    public static class ListMongoCollectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongoCollection> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongoCollection: IFragment, HierarchyObject, CdmHierarchyObject, MongoSourceDescendantType, MongoDatabaseDescendantType, MongoCollectionSetDescendantType, MongoCollectionSetPhysicalChildType
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.CollectionSet != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.CollectionSet.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> MongoDatabase? Database
            // GraphQL -> database: MongoDatabase! (type)
            ...
            if (this.MongoSnapshotGroupByConnection != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.MongoSnapshotGroupByConnection.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> CdmSnapshot? NewestSnapshot
            // GraphQL -> newestSnapshot: CdmSnapshot (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.CollectionSet == null && Exploration.Includes(parent + ".collectionSet"))
            {
                ...
                this.CollectionSet.ApplyExploratoryFragment(parent + ".collectionSet");
            }
            //      C# -> MongoDatabase? Database
            // GraphQL -> database: MongoDatabase! (type)
            ...
            if (this.MongoSnapshotGroupByConnection == null && Exploration.Includes(parent + ".mongoSnapshotGroupByConnection"))
            {
                ...
                this.MongoSnapshotGroupByConnection.ApplyExploratoryFragment(parent + ".mongoSnapshotGroupByConnection");
            }
            //      C# -> CdmSnapshot? NewestSnapshot
            // GraphQL -> newestSnapshot: CdmSnapshot (type)

...
{
    #region VmPathPoint
    public class VmPathPoint: BaseType
    {
        #region members
    ...
    public static class ListVmPathPointExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VmPathPoint> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VmPathPoint());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VmPathPoint> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.ManagedVolume != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.ManagedVolume.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
            // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int64? LogicalUsedSize
            // GraphQL -> logicalUsedSize: Long! (scalar)
            if (this.LogicalUsedSize == null && Exploration.Includes(parent + ".logicalUsedSize$"))
            {
            ...
            if (this.ManagedVolume == null && Exploration.Includes(parent + ".managedVolume"))
            {
                ...
                this.ManagedVolume.ApplyExploratoryFragment(parent + ".managedVolume");
            }
            //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
            // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
    ...
    public static class ListManagedVolumeMountExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new ManagedVolumeMount();
            list.Add(item);

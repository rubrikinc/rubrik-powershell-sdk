...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.Channels != null) {
            s += ind + "channels {\n" + this.Channels.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> Cluster? Cluster
        // GraphQL -> cluster: Cluster! (type)
        ...
        if (this.ManagedVolume != null) {
            s += ind + "managedVolume {\n" + this.ManagedVolume.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Int64? LogicalUsedSize
        // GraphQL -> logicalUsedSize: Long! (scalar)
        if (this.LogicalUsedSize == null && Exploration.Includes(parent + ".logicalUsedSize", true))
        {
        ...
        //      C# -> ManagedVolume? ManagedVolume
        // GraphQL -> managedVolume: ManagedVolume! (type)
        if (this.ManagedVolume == null && Exploration.Includes(parent + ".managedVolume"))
        {
            this.ManagedVolume = new ManagedVolume();
            this.ManagedVolume.ApplyExploratoryFieldSpec(parent + ".managedVolume");
        }
        //      C# -> PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus
        // GraphQL -> pendingObjectDeletionStatus: PendingSnapshotsOfObjectDeletion (type)

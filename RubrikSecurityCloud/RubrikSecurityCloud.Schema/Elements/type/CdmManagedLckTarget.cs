...
{
    #region CdmManagedLckTarget
 
    public class CdmManagedLckTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedLckTarget";
    }

    public CdmManagedLckTarget Set(
    ...
    } // class CdmManagedLckTarget
    
    #endregion

    public static class ListCdmManagedLckTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CdmManagedLckTarget> list,
        ...
        public static List<string> SelectedFields(this List<CdmManagedLckTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedLckTarget());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CdmManagedLckTarget> list)
        {

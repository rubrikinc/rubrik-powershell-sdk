...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "MssqlLogShippingTargetEdge";
    }
    ...
    public static class ListMssqlLogShippingTargetEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlLogShippingTargetEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<MssqlLogShippingTargetEdge> list)
        {

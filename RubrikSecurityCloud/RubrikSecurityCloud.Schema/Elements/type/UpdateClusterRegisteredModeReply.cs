...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "UpdateClusterRegisteredModeReply";
    }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.NewRegisteredMode != null) {
            if (conf.Flat) {
                s += conf.Prefix + "newRegisteredMode\n" ;
            } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> RegisteredMode? NewRegisteredMode
        // GraphQL -> newRegisteredMode: RegisteredMode! (enum)
        if (ec.Includes("newRegisteredMode",true))
        {
            if(this.NewRegisteredMode == null) {
        ...
        else if (this.NewRegisteredMode != null && ec.Excludes("newRegisteredMode",true))
        {
            this.NewRegisteredMode = null;
        }
    }
    ...
    public static class ListUpdateClusterRegisteredModeReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateClusterRegisteredModeReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateClusterRegisteredModeReply> list)
        {

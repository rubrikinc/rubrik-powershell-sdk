...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "LinuxFileset_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "LinuxFileset_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "LinuxFileset_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "LinuxFileset_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "LinuxFileset_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        if (this.FailoverClusterApp != null) {
            var fspec = this.FailoverClusterApp.AsFieldSpec(conf.Child("failoverClusterApp"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        if (this.FilesetTemplate != null) {
            var fspec = this.FilesetTemplate.AsFieldSpec(conf.Child("filesetTemplate"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<System.String>? PathExceptions
        // GraphQL -> pathExceptions: [String!]! (scalar)
        if (ec.Includes("pathExceptions",true))
        {
            if(this.PathExceptions == null) {
        ...
        else if (this.PathExceptions != null && ec.Excludes("pathExceptions",true))
        {
            this.PathExceptions = null;
        }
        //      C# -> List<System.String>? PathExcluded
        // GraphQL -> pathExcluded: [String!]! (scalar)
        if (ec.Includes("pathExcluded",true))
        {
            if(this.PathExcluded == null) {
        ...
        else if (this.PathExcluded != null && ec.Excludes("pathExcluded",true))
        {
            this.PathExcluded = null;
        }
        //      C# -> List<System.String>? PathIncluded
        // GraphQL -> pathIncluded: [String!]! (scalar)
        if (ec.Includes("pathIncluded",true))
        {
            if(this.PathIncluded == null) {
        ...
        else if (this.PathIncluded != null && ec.Excludes("pathIncluded",true))
        {
            this.PathIncluded = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        //      C# -> FailoverClusterApp? FailoverClusterApp
        // GraphQL -> failoverClusterApp: FailoverClusterApp (type)
        if (ec.Includes("failoverClusterApp",false))
        {
            if(this.FailoverClusterApp == null) {
        ...
        else if (this.FailoverClusterApp != null && ec.Excludes("failoverClusterApp",false))
        {
            this.FailoverClusterApp = null;
        }
        //      C# -> FilesetTemplate? FilesetTemplate
        // GraphQL -> filesetTemplate: FilesetTemplate (type)
        if (ec.Includes("filesetTemplate",false))
        {
            if(this.FilesetTemplate == null) {
    ...
    public static class ListLinuxFilesetExtensions
    {
        ...
        public static List<string> SelectedFields(this List<LinuxFileset> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new LinuxFileset());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<LinuxFileset> list)
        {

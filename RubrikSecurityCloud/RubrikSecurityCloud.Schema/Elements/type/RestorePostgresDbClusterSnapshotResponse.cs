// RestorePostgresDbClusterSnapshotResponse.cs
//
...
{
    #region RestorePostgresDbClusterSnapshotResponse
    public class RestorePostgresDbClusterSnapshotResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RestorePostgresDbClusterSnapshotResponse";
    }

    public RestorePostgresDbClusterSnapshotResponse Set(
    ...
    } // class RestorePostgresDbClusterSnapshotResponse
    
    #endregion

    public static class ListRestorePostgresDbClusterSnapshotResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RestorePostgresDbClusterSnapshotResponse> list,
        ...
        public static List<string> SelectedFields(this List<RestorePostgresDbClusterSnapshotResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RestorePostgresDbClusterSnapshotResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RestorePostgresDbClusterSnapshotResponse> list)
        {

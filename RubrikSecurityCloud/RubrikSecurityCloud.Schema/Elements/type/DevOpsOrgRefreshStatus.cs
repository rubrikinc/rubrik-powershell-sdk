...
{
    #region DevOpsOrgRefreshStatus
    public class DevOpsOrgRefreshStatus: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DevOpsOrgRefreshStatus";
    }

    public DevOpsOrgRefreshStatus Set(
    ...
    } // class DevOpsOrgRefreshStatus
    
    #endregion

    public static class ListDevOpsOrgRefreshStatusExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DevOpsOrgRefreshStatus> list,
        ...
        public static List<string> SelectedFields(this List<DevOpsOrgRefreshStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DevOpsOrgRefreshStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DevOpsOrgRefreshStatus> list)
        {

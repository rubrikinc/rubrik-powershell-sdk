...
{
    #region FusionComputeHost
 
    public class FusionComputeHost: BaseType, CdmHierarchyObject, FusionComputeClusterDescendant, FusionComputeClusterPhysicalChildType, FusionComputeSiteDescendant, FusionComputeSitePhysicalChildType, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? FcHostId
        // GraphQL -> fcHostId: String! (scalar)
        [JsonProperty("fcHostId")]
        public System.String? FcHostId { get; set; }
        ...
        //      C# -> FusionComputeHostDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: FusionComputeHostDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public FusionComputeHostDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> FusionComputeHostPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: FusionComputeHostPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public FusionComputeHostPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public FusionComputeHost()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeHost";
    }

    public FusionComputeHost Set(
        ...
        System.String? FcHostId = null,
        System.String? HostName = null,
        System.String? Id = null,
        System.String? IpAddresses = null,
        ...
        FusionComputeHostDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        FusionComputeHostPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? FcHostId
        // GraphQL -> fcHostId: String! (scalar)
        if (this.FcHostId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "fcHostId\n" ;
            } else {
                s += ind + "fcHostId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.FcHostId != null && ec.Excludes("fcHostId",true))
        {
            this.FcHostId = null;
        }
        //      C# -> System.String? HostName
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new FusionComputeHostDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new FusionComputeHostPhysicalChildTypeConnection();
    ...
    } // class FusionComputeHost
    
    #endregion

    public static class ListFusionComputeHostExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeHost> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeHost> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeHost());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeHost> list)
        {

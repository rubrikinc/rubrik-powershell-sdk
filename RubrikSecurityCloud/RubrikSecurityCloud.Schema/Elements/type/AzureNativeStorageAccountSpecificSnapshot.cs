// AzureNativeStorageAccountSpecificSnapshot.cs
//
...
{
    #region AzureNativeStorageAccountSpecificSnapshot
 
    public class AzureNativeStorageAccountSpecificSnapshot: BaseType, PolarisSpecificSnapshot
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureNativeStorageAccountSpecificSnapshot";
    }

    public AzureNativeStorageAccountSpecificSnapshot Set(
    ...
    } // class AzureNativeStorageAccountSpecificSnapshot
    
    #endregion

    public static class ListAzureNativeStorageAccountSpecificSnapshotExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureNativeStorageAccountSpecificSnapshot> list,
        ...
        public static List<string> SelectedFields(this List<AzureNativeStorageAccountSpecificSnapshot> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureNativeStorageAccountSpecificSnapshot());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureNativeStorageAccountSpecificSnapshot> list)
        {

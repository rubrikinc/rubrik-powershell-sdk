...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class EnableDisableAppConsistencyReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> List<System.String>? FailedWorkloadIds
            // GraphQL -> failedWorkloadIds: [UUID!]! (scalar)
            if (this.FailedWorkloadIds == null && Exploration.Includes(parent + ".failedWorkloadIds$"))
            {
                this.FailedWorkloadIds = new List<System.String>();
            }
            //      C# -> List<System.String>? SuccessWorkloadIds
            // GraphQL -> successWorkloadIds: [UUID!]! (scalar)
            if (this.SuccessWorkloadIds == null && Exploration.Includes(parent + ".successWorkloadIds$"))
            {
    ...
    public static class ListEnableDisableAppConsistencyReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new EnableDisableAppConsistencyReply();
            list.Add(item);

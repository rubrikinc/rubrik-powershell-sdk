...
{
    #region RekeyArchivalLocationReply
    public class RekeyArchivalLocationReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RekeyArchivalLocationReply";
    }

    public RekeyArchivalLocationReply Set(
    ...
    } // class RekeyArchivalLocationReply
    
    #endregion

    public static class ListRekeyArchivalLocationReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RekeyArchivalLocationReply> list,
        ...
        public static List<string> SelectedFields(this List<RekeyArchivalLocationReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RekeyArchivalLocationReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RekeyArchivalLocationReply> list)
        {

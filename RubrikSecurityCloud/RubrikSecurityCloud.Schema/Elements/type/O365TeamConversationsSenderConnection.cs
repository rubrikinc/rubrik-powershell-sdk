...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListO365TeamConversationsSenderConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamConversationsSenderConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365TeamConversationsSenderConnection> list)
        {

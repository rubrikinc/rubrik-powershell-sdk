...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class GroupCountListWithTotal: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.GroupList != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.GroupList.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.GroupList == null && Exploration.Includes(parent + ".groupList"))
            {
                ...
                this.GroupList.ApplyExploratoryFragment(parent + ".groupList");
            }
        }
    ...
    public static class ListGroupCountListWithTotalExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new GroupCountListWithTotal();
            list.Add(item);

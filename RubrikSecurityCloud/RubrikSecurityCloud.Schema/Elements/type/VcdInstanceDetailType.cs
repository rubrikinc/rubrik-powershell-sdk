...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVcdInstanceDetailTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdInstanceDetailType> list)
        {
        ...
        public static void SelectForRetrieval(this List<VcdInstanceDetailType> list)
        {

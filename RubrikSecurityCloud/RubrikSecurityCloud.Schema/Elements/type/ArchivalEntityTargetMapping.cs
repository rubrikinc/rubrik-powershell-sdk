...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListArchivalEntityTargetMappingExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ArchivalEntityTargetMapping> list)
        {
        ...
        public static void SelectForRetrieval(this List<ArchivalEntityTargetMapping> list)
        {

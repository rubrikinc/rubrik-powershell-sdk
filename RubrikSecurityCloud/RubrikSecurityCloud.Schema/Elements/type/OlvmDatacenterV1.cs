...
{
    #region OlvmDatacenterV1
 
    public class OlvmDatacenterV1: BaseType, CdmHierarchyObject, HierarchyObject, OlvmManagerDescendant, OlvmManagerPhysicalChildType
    {
        #region members
        ...
        //      C# -> OlvmDatacenterDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: OlvmDatacenterDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public OlvmDatacenterDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> OlvmDatacenterPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: OlvmDatacenterPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public OlvmDatacenterPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public OlvmDatacenterV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "OlvmDatacenterV1";
    }

    public OlvmDatacenterV1 Set(
        ...
        OlvmDatacenterDescendantConnection? DescendantConnection = null,
        ...
        OlvmDatacenterPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new OlvmDatacenterDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new OlvmDatacenterPhysicalChildTypeConnection();
    ...
    } // class OlvmDatacenterV1
    
    #endregion

    public static class ListOlvmDatacenterV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmDatacenterV1> list,
        ...
        public static List<string> SelectedFields(this List<OlvmDatacenterV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmDatacenterV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmDatacenterV1> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListNonCompliantArchivalTierWarningDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NonCompliantArchivalTierWarningDetails> list)
        {
        ...
        public static void SelectForRetrieval(this List<NonCompliantArchivalTierWarningDetails> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVscvmmDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<HyperVscvmmDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "HyperVSCVMMDescendantTypeConnection";
    }

    public HyperVscvmmDescendantTypeConnection Set(
        RscInterfaceList<HyperVscvmmDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<HyperVscvmmDescendantType>();
    ...
    public static class ListHyperVscvmmDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVscvmmDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<HyperVscvmmDescendantTypeConnection> list)
        {

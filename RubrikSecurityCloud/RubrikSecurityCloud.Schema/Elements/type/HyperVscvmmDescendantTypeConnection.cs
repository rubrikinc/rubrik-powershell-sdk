...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVscvmmDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<HyperVscvmmDescendantType> Nodes { get; set; }
    ...
    public HyperVscvmmDescendantTypeConnection Set(
        RscInterface<HyperVscvmmDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<HyperVscvmmDescendantType>();

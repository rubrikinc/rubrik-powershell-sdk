...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListGlobalFileSearchReplyTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GlobalFileSearchReplyType> list)
        {
        ...
        public static void SelectForRetrieval(this List<GlobalFileSearchReplyType> list)
        {

...
{
    #region RecoverySubStep
    public class RecoverySubStep: BaseType
    {
        #region members

        //      C# -> RecoveryStepStatus? SubstepStatus
        // GraphQL -> substepStatus: RecoveryStepStatus! (enum)
        [JsonProperty("substepStatus")]
        public RecoveryStepStatus? SubstepStatus { get; set; }
        ...
        //      C# -> List<RecoveryEvent>? Events
        // GraphQL -> events: [RecoveryEvent!]! (type)
        [JsonProperty("events")]
        public List<RecoveryEvent>? Events { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "RecoverySubStep";
    }

    public RecoverySubStep Set(
        RecoveryStepStatus? SubstepStatus = null,
        System.Int64? ElapsedTime = null,
        System.Int64? EndTime = null,
        System.String? Message = null,
        System.Int32? Seq = null,
        System.Int64? StartTime = null,
        List<RecoveryEvent>? Events = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        //      C# -> RecoveryStepStatus? SubstepStatus
        // GraphQL -> substepStatus: RecoveryStepStatus! (enum)
        if (ec.Includes("substepStatus",true))
        {
            if(this.SubstepStatus == null) {

                this.SubstepStatus = new RecoveryStepStatus();
        ...
        else if (this.SubstepStatus != null && ec.Excludes("substepStatus",true))
        {
        ...
        if (ec.Includes("events",false))
        {
            if(this.Events == null) {
                ...
                this.Events = new List<RecoveryEvent>();
    ...
    } // class RecoverySubStep
    
    #endregion

    public static class ListRecoverySubStepExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RecoverySubStep> list,
        ...
        public static List<string> SelectedFields(this List<RecoverySubStep> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RecoverySubStep());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RecoverySubStep> list)
        {

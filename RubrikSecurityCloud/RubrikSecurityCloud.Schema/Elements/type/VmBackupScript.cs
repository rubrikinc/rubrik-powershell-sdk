...
{
    #region VmBackupScript
    public class VmBackupScript: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "VmBackupScript";
    }

    public VmBackupScript Set(
        VmBackupScriptFailureHandling? FailureHandling = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("failureHandling",true))
        {
            if(this.FailureHandling == null) {
                ...
                this.FailureHandling = new VmBackupScriptFailureHandling();
    ...
    } // class VmBackupScript
    
    #endregion

    public static class ListVmBackupScriptExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VmBackupScript> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VmBackupScript());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VmBackupScript> list)
        {

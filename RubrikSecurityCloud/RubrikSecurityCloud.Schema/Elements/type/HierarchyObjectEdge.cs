...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HierarchyObjectEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<HierarchyObject> Node { get; set; }
    ...
    public HierarchyObjectEdge Set(
        RscInterface<HierarchyObject> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<HierarchyObject>();
    ...
    public static class ListHierarchyObjectEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HierarchyObjectEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<HierarchyObjectEdge> list)
        {

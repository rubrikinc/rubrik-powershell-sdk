...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class HierarchyObjectEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (HierarchyObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(HierarchyObject));
    ...
    public static class ListHierarchyObjectEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new HierarchyObjectEdge();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ValidateAzureNativeSqlDatabaseDbNameForExportReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ValidateAzureNativeSqlDatabaseDbNameForExportReply";
    }
    ...
    public static class ListValidateAzureNativeSqlDatabaseDbNameForExportReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ValidateAzureNativeSqlDatabaseDbNameForExportReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ValidateAzureNativeSqlDatabaseDbNameForExportReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ValidateAzureNativeSqlDatabaseDbNameForExportReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBulkRefreshHostsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BulkRefreshHostsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BulkRefreshHostsReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateTunnelStatusReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateTunnelStatusReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateTunnelStatusReply> list)
        {

...
{
    #region TprPublicConfiguration
    public class TprPublicConfiguration: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "TprPublicConfiguration";
    }

    public TprPublicConfiguration Set(
    ...
    } // class TprPublicConfiguration
    
    #endregion

    public static class ListTprPublicConfigurationExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<TprPublicConfiguration> list,
        ...
        public static List<string> SelectedFields(this List<TprPublicConfiguration> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TprPublicConfiguration());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TprPublicConfiguration> list)
        {

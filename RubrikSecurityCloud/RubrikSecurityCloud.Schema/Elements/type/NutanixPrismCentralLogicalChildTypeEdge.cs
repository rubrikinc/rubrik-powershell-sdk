...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NutanixPrismCentralLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<NutanixPrismCentralLogicalChildType> Node { get; set; }
    ...
    public NutanixPrismCentralLogicalChildTypeEdge Set(
        RscInterface<NutanixPrismCentralLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<NutanixPrismCentralLogicalChildType>();

...
{
    #region DocumentTypeStats
    public class DocumentTypeStats: BaseType
    {
        #region members
    ...
    public static class ListDocumentTypeStatsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DocumentTypeStats> list,
        ...
        public static List<string> SelectedFields(this List<DocumentTypeStats> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DocumentTypeStats());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DocumentTypeStats> list)
        {

...
{
    #region IntunePolicyAssignment
    public class IntunePolicyAssignment: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "IntunePolicyAssignment";
    }

    public IntunePolicyAssignment Set(
    ...
    } // class IntunePolicyAssignment
    
    #endregion

    public static class ListIntunePolicyAssignmentExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<IntunePolicyAssignment> list,
        ...
        public static List<string> SelectedFields(this List<IntunePolicyAssignment> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new IntunePolicyAssignment());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<IntunePolicyAssignment> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class O365SharepointObjectEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (O365SharepointObject)InterfaceHelper.CreateInstanceOfFirstType(typeof(O365SharepointObject));
    ...
    public static class ListO365SharepointObjectEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new O365SharepointObjectEdge();
            list.Add(item);

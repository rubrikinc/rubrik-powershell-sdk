...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListFailoverTargetSiteExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FailoverTargetSite> list)
        {
        ...
        public static void SelectForRetrieval(this List<FailoverTargetSite> list)
        {

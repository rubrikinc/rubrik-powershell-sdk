...
{
    #region CrossAccountCluster
    public class CrossAccountCluster: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CrossAccountCluster";
    }

    public CrossAccountCluster Set(
    ...
    } // class CrossAccountCluster
    
    #endregion

    public static class ListCrossAccountClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CrossAccountCluster> list,
        ...
        public static List<string> SelectedFields(this List<CrossAccountCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CrossAccountCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CrossAccountCluster> list)
        {

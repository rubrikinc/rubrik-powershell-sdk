...
{
    #region CreateWebhookV2Reply
    public class CreateWebhookV2Reply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CreateWebhookV2Reply";
    }

    public CreateWebhookV2Reply Set(
    ...
    } // class CreateWebhookV2Reply
    
    #endregion

    public static class ListCreateWebhookV2ReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CreateWebhookV2Reply> list,
        ...
        public static List<string> SelectedFields(this List<CreateWebhookV2Reply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CreateWebhookV2Reply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CreateWebhookV2Reply> list)
        {

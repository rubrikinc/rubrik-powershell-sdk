...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "UpdateGuestCredentialReply";
    }
    ...
    public static class ListUpdateGuestCredentialReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateGuestCredentialReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateGuestCredentialReply> list)
        {

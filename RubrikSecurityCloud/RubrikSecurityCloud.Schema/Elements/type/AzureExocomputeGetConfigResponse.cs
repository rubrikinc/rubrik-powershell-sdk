...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAzureExocomputeGetConfigResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureExocomputeGetConfigResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureExocomputeGetConfigResponse> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereTagCategoryTagChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereTagCategoryTagChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereTagCategoryTagChildType));
    ...
    public static class ListVsphereTagCategoryTagChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereTagCategoryTagChildTypeEdge();
            list.Add(item);

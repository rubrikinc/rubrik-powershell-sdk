...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereTagCategoryTagChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereTagCategoryTagChildType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereTagCategoryTagChildTypeEdge";
    }

    public VsphereTagCategoryTagChildTypeEdge Set(
        RscInterface<VsphereTagCategoryTagChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereTagCategoryTagChildType>();
    ...
    public static class ListVsphereTagCategoryTagChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereTagCategoryTagChildTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereTagCategoryTagChildTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.SecondaryGroupByInfo != null) {
            var fspec = this.SecondaryGroupByInfo.AsFieldSpec(conf.Child("secondaryGroupByInfo"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> List<UserAuditGroupByBase>? SecondaryGroupByInfo
        // GraphQL -> secondaryGroupByInfo: [UserAuditGroupByBase!]! (type)
        if (ec.Includes("secondaryGroupByInfo",false))
        {
            if(this.SecondaryGroupByInfo == null) {
        ...
        else if (this.SecondaryGroupByInfo != null && ec.Excludes("secondaryGroupByInfo",false))
        {
            this.SecondaryGroupByInfo = null;
        }
    }
    ...
    public static class ListUserAuditGroupByInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserAuditGroupByInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<UserAuditGroupByInfo> list)
        {

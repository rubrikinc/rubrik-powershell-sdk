...
{
    #region RecoveryEvent
    public class RecoveryEvent: BaseType
    {
        #region members
    ...
    public static class ListRecoveryEventExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RecoveryEvent> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RecoveryEvent());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RecoveryEvent> list)
        {

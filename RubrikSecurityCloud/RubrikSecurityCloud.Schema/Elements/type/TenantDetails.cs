...
namespace RubrikSecurityCloud.Types
{
    ...
    public class TenantDetails: BaseType
    {
        #region members
    ...
    public static class ListTenantDetailsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TenantDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new TenantDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<TenantDetails> list)
        {

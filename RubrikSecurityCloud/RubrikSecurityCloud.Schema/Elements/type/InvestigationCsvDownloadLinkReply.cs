...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListInvestigationCsvDownloadLinkReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<InvestigationCsvDownloadLinkReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<InvestigationCsvDownloadLinkReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListStartBulkRecoveryReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<StartBulkRecoveryReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<StartBulkRecoveryReply> list)
        {

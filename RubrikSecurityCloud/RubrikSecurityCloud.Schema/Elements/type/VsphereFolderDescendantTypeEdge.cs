...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereFolderDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereFolderDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereFolderDescendantType));
    ...
    public static class ListVsphereFolderDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereFolderDescendantTypeEdge();
            list.Add(item);

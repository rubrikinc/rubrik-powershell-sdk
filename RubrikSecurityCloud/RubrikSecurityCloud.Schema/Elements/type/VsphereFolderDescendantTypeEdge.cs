...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereFolderDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereFolderDescendantType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereFolderDescendantTypeEdge";
    }

    public VsphereFolderDescendantTypeEdge Set(
        RscInterface<VsphereFolderDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereFolderDescendantType>();
    ...
    public static class ListVsphereFolderDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereFolderDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereFolderDescendantTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDeleteVcdInstancesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DeleteVcdInstancesReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DeleteVcdInstancesReply> list)
        {

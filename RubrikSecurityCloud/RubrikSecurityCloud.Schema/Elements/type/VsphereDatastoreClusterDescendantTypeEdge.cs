...
namespace RubrikSecurityCloud.Types
{
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatastoreClusterDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public static class ListVsphereDatastoreClusterDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatastoreClusterDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereDatastoreClusterDescendantTypeEdge> list)
        {

...
{
    #region CcesUsage
    public class CcesUsage: BaseType
    {
        #region members
        ...
        //      C# -> List<CcesCloudUsage>? PerCloudUsage
        // GraphQL -> perCloudUsage: [CcesCloudUsage!]! (type)
        [JsonProperty("perCloudUsage")]
        public List<CcesCloudUsage>? PerCloudUsage { get; set; }
    ...
    public CcesUsage Set(
        System.Int64? FrontEndBytesConsumed = null,
        List<CcesCloudUsage>? PerCloudUsage = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("perCloudUsage",false))
        {
            if(this.PerCloudUsage == null) {
                ...
                this.PerCloudUsage = new List<CcesCloudUsage>();
    ...
    public static class ListCcesUsageExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CcesUsage> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CcesUsage());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CcesUsage> list)
        {

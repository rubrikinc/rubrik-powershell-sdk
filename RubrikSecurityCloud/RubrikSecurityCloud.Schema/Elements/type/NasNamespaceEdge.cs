...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasNamespaceEdge: BaseType
    {
        #region members
    ...
    public static class ListNasNamespaceEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasNamespaceEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NasNamespaceEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NasNamespaceEdge> list)
        {

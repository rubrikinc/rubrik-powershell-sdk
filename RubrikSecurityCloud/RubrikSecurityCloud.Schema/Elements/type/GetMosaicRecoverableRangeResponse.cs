...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "GetMosaicRecoverableRangeResponse";
    }
    ...
    public static class ListGetMosaicRecoverableRangeResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GetMosaicRecoverableRangeResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<GetMosaicRecoverableRangeResponse> list)
        {

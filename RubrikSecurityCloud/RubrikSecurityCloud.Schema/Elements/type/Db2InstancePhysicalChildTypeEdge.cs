// Db2InstancePhysicalChildTypeEdge.cs
//
...
{
    #region Db2InstancePhysicalChildTypeEdge
    public class Db2InstancePhysicalChildTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "Db2InstancePhysicalChildTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "Db2InstancePhysicalChildTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class Db2InstancePhysicalChildTypeEdge
    
    #endregion

    public static class ListDb2InstancePhysicalChildTypeEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<Db2InstancePhysicalChildTypeEdge> list,
        ...
        public static List<string> SelectedFields(this List<Db2InstancePhysicalChildTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new Db2InstancePhysicalChildTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<Db2InstancePhysicalChildTypeEdge> list)
        {

// NotificationSettingSummaryListResponse.cs
//
...
{
    #region NotificationSettingSummaryListResponse
    public class NotificationSettingSummaryListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<NotificationSettingSummary>? Data
        // GraphQL -> data: [NotificationSettingSummary!]! (type)
        [JsonProperty("data")]
        public List<NotificationSettingSummary>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "NotificationSettingSummaryListResponse";
    }

    public NotificationSettingSummaryListResponse Set(
        System.Boolean? HasMore = null,
        System.Int64? Total = null,
        List<NotificationSettingSummary>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<NotificationSettingSummary>();
    ...
    } // class NotificationSettingSummaryListResponse
    
    #endregion

    public static class ListNotificationSettingSummaryListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NotificationSettingSummaryListResponse> list)
        {

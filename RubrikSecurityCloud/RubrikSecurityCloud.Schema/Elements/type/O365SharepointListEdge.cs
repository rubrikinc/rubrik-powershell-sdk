...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365SharepointListEdge: BaseType
    {
        #region members
    ...
    public static class ListO365SharepointListEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365SharepointListEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365SharepointListEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365SharepointListEdge> list)
        {

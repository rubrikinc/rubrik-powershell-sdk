...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlInstanceLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<MssqlInstanceLogicalChildType> Nodes { get; set; }
    ...
    public MssqlInstanceLogicalChildTypeConnection Set(
        RscInterfaceList<MssqlInstanceLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<MssqlInstanceLogicalChildType>();
    ...
    public static class ListMssqlInstanceLogicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlInstanceLogicalChildTypeConnection> list)
        {

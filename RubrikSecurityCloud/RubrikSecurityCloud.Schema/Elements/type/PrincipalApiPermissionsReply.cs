// PrincipalApiPermissionsReply.cs
//
...
{
    #region PrincipalApiPermissionsReply
    public class PrincipalApiPermissionsReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "PrincipalApiPermissionsReply";
    }

    public PrincipalApiPermissionsReply Set(
    ...
    } // class PrincipalApiPermissionsReply
    
    #endregion

    public static class ListPrincipalApiPermissionsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PrincipalApiPermissionsReply> list,
        ...
        public static List<string> SelectedFields(this List<PrincipalApiPermissionsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PrincipalApiPermissionsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PrincipalApiPermissionsReply> list)
        {

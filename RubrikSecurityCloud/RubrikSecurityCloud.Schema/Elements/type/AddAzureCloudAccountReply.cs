...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AddAzureCloudAccountReply: BaseType
    {
        #region members
    ...
    public static class ListAddAzureCloudAccountReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddAzureCloudAccountReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddAzureCloudAccountReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddAzureCloudAccountReply> list)
        {

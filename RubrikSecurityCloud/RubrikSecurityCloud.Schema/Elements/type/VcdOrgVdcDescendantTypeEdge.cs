...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdOrgVdcDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VcdOrgVdcDescendantType> Node { get; set; }
    ...
    public VcdOrgVdcDescendantTypeEdge Set(
        RscInterface<VcdOrgVdcDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VcdOrgVdcDescendantType>();

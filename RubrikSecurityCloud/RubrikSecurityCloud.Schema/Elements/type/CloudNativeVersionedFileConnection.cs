...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "CloudNativeVersionedFileConnection";
    }
    ...
    public static class ListCloudNativeVersionedFileConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CloudNativeVersionedFileConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<CloudNativeVersionedFileConnection> list)
        {

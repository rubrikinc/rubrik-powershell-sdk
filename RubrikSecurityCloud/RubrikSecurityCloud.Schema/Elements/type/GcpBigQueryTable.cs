...
{
    #region GcpBigQueryTable
    public class GcpBigQueryTable: BaseType
    {
        #region members
    ...
    } // class GcpBigQueryTable
    
    #endregion

    public static class ListGcpBigQueryTableExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpBigQueryTable> list,
        ...
        public static List<string> SelectedFields(this List<GcpBigQueryTable> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpBigQueryTable());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpBigQueryTable> list)
        {

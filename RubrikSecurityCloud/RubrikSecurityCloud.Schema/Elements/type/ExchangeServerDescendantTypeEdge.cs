...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ExchangeServerDescendantTypeEdge: BaseType
    {
        #region members
        ...
        [JsonProperty("node")]
        public RscInterface<ExchangeServerDescendantType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "ExchangeServerDescendantTypeEdge";
    }

    public ExchangeServerDescendantTypeEdge Set(
        RscInterface<ExchangeServerDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<ExchangeServerDescendantType>();
    ...
    public static class ListExchangeServerDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeServerDescendantTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ExchangeServerDescendantTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ExchangeServerDescendantTypeEdge> list)
        {

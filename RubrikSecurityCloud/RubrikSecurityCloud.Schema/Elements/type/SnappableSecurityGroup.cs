...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSnappableSecurityGroupExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnappableSecurityGroup> list)
        {
        ...
        public static void SelectForRetrieval(this List<SnappableSecurityGroup> list)
        {

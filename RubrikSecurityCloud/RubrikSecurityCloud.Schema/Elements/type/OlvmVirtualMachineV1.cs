...
{
    #region OlvmVirtualMachineV1
 
    public class OlvmVirtualMachineV1: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, OlvmComputeClusterDescendant, OlvmComputeClusterPhysicalChildType, OlvmDatacenterDescendant, OlvmDatacenterPhysicalChildType, OlvmManagerDescendant, OlvmManagerPhysicalChildType, OlvmTagDescendant, OlvmTagLogicalChild
    {
        #region members
        ...
        //      C# -> OlvmSnapshotConsistencyMandate? SnapshotConsistencyMandate
        // GraphQL -> snapshotConsistencyMandate: OlvmSnapshotConsistencyMandate! (enum)
        [JsonProperty("snapshotConsistencyMandate")]
        public OlvmSnapshotConsistencyMandate? SnapshotConsistencyMandate { get; set; }
        ...
        //      C# -> System.String? Disks
        // GraphQL -> disks: String! (scalar)
        [JsonProperty("disks")]
        public System.String? Disks { get; set; }
        ...
        //      C# -> System.String? OlvmId
        // GraphQL -> olvmId: String! (scalar)
        [JsonProperty("olvmId")]
        public System.String? OlvmId { get; set; }

        //      C# -> System.String? OlvmManagerId
        // GraphQL -> olvmManagerId: String! (scalar)
        [JsonProperty("olvmManagerId")]
        public System.String? OlvmManagerId { get; set; }
        ...
        //      C# -> System.String? TemplateType
        // GraphQL -> templateType: String! (scalar)
        ...
        //      C# -> OlvmBackupScript? PostBackupScript
        // GraphQL -> postBackupScript: OlvmBackupScript (type)
        [JsonProperty("postBackupScript")]
        public OlvmBackupScript? PostBackupScript { get; set; }

        //      C# -> OlvmBackupScript? PostSnapScript
        // GraphQL -> postSnapScript: OlvmBackupScript (type)
        [JsonProperty("postSnapScript")]
        public OlvmBackupScript? PostSnapScript { get; set; }

        //      C# -> OlvmBackupScript? PreBackupScript
        // GraphQL -> preBackupScript: OlvmBackupScript (type)
        [JsonProperty("preBackupScript")]
        public OlvmBackupScript? PreBackupScript { get; set; }
    ...
    public OlvmVirtualMachineV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "OlvmVirtualMachineV1";
    }

    public OlvmVirtualMachineV1 Set(
        List<Operation>? AuthorizedOperations = null,
        PendingObjectPauseAssignmentStatus? CdmPendingObjectPauseAssignment = null,
        HierarchyObjectTypeEnum? ObjectType = null,
        SlaAssignmentTypeEnum? SlaAssignment = null,
        OlvmSnapshotConsistencyMandate? SnapshotConsistencyMandate = null,
        ...
        System.String? OlvmId = null,
        System.String? OlvmManagerId = null,
        System.Int32? OnDemandSnapshotCount = null,
        System.String? PrimaryClusterUuid = null,
        System.Int32? ReplicatedObjectCount = null,
        System.String? ResourceSpec = null,
        System.Boolean? SlaPauseStatus = null,
        System.String? TemplateType = null,
        ...
        OlvmBackupScript? PostBackupScript = null,
        OlvmBackupScript? PostSnapScript = null,
        OlvmBackupScript? PreBackupScript = null,
    ...
    ) 
    {
        ...
        if ( OlvmManagerId != null ) {
            this.OlvmManagerId = OlvmManagerId;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? OlvmManagerId
        // GraphQL -> olvmManagerId: String! (scalar)
        if (this.OlvmManagerId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "olvmManagerId\n" ;
            } else {
                s += ind + "olvmManagerId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("snapshotConsistencyMandate",true))
        {
            if(this.SnapshotConsistencyMandate == null) {
                ...
                this.SnapshotConsistencyMandate = new OlvmSnapshotConsistencyMandate();
        ...
        else if (this.Disks != null && ec.Excludes("disks",true))
        {
            this.Disks = null;
        }
        //      C# -> System.String? GuestOsName
        ...
        else if (this.OlvmId != null && ec.Excludes("olvmId",true))
        {
            this.OlvmId = null;
        }
        //      C# -> System.String? OlvmManagerId
        // GraphQL -> olvmManagerId: String! (scalar)
        if (ec.Includes("olvmManagerId",true))
        {
            if(this.OlvmManagerId == null) {

                this.OlvmManagerId = "FETCH";
        ...
        else if (this.OlvmManagerId != null && ec.Excludes("olvmManagerId",true))
        {
            this.OlvmManagerId = null;
        }
        //      C# -> System.Int32? OnDemandSnapshotCount
        // GraphQL -> onDemandSnapshotCount: Int! (scalar)
        ...
        if (ec.Includes("postBackupScript",false))
        {
            if(this.PostBackupScript == null) {
                ...
                this.PostBackupScript = new OlvmBackupScript();
        ...
        if (ec.Includes("postSnapScript",false))
        {
            if(this.PostSnapScript == null) {
                ...
                this.PostSnapScript = new OlvmBackupScript();
        ...
        if (ec.Includes("preBackupScript",false))
        {
            if(this.PreBackupScript == null) {
                ...
                this.PreBackupScript = new OlvmBackupScript();
    ...
    } // class OlvmVirtualMachineV1
    
    #endregion

    public static class ListOlvmVirtualMachineV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<OlvmVirtualMachineV1> list,
        ...
        public static List<string> SelectedFields(this List<OlvmVirtualMachineV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OlvmVirtualMachineV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OlvmVirtualMachineV1> list)
        {

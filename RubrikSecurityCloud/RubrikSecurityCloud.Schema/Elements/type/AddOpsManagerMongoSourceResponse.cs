// AddOpsManagerMongoSourceResponse.cs
//
...
{
    #region AddOpsManagerMongoSourceResponse
    public class AddOpsManagerMongoSourceResponse: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AddOpsManagerMongoSourceResponse";
    }

    public AddOpsManagerMongoSourceResponse Set(
    ...
    } // class AddOpsManagerMongoSourceResponse
    
    #endregion

    public static class ListAddOpsManagerMongoSourceResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AddOpsManagerMongoSourceResponse> list,
        ...
        public static List<string> SelectedFields(this List<AddOpsManagerMongoSourceResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddOpsManagerMongoSourceResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddOpsManagerMongoSourceResponse> list)
        {

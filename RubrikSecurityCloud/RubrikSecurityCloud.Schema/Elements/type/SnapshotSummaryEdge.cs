...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SnapshotSummaryEdge: BaseType
    {
        #region members
    ...
    public static class ListSnapshotSummaryEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnapshotSummaryEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SnapshotSummaryEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SnapshotSummaryEdge> list)
        {

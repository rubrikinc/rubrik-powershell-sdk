...
{
    #region PathBlocker
    public class PathBlocker: BaseType
    {
        #region members
    ...
    public static class ListPathBlockerExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PathBlocker> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PathBlocker());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PathBlocker> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class DocumentTypeDetails: BaseType
    {
        #region members
    ...
    public DocumentTypeDetails Set(
    ...
    public static class ListDocumentTypeDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DocumentTypeDetails> list,
        ...
        public static List<string> SelectedFields(this List<DocumentTypeDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DocumentTypeDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DocumentTypeDetails> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2DatabaseEdge: BaseType
    {
        #region members
    ...
    public static class ListDb2DatabaseEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2DatabaseEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new Db2DatabaseEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<Db2DatabaseEdge> list)
        {

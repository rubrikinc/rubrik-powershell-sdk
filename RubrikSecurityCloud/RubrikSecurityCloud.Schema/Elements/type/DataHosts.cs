...
{
    #region DataHosts
    public class DataHosts: BaseType
    {
        #region members
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("hosts",true))
        {
            if(this.Hosts == null) {
                ...
                this.Hosts = new List<System.String>();
    ...
    public static class ListDataHostsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DataHosts> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DataHosts());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DataHosts> list)
        {

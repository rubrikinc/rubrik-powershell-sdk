...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListTakeOnDemandSnapshotErrorExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TakeOnDemandSnapshotError> list)
        {
        ...
        public static void SelectForRetrieval(this List<TakeOnDemandSnapshotError> list)
        {

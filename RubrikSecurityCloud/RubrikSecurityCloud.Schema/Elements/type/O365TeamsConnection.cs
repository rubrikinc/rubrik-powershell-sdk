...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365TeamsConnection: BaseType
    {
        #region members
    ...
    public static class ListO365TeamsConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamsConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365TeamsConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365TeamsConnection> list)
        {

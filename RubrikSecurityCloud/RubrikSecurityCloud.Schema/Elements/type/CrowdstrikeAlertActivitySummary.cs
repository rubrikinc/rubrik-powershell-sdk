// CrowdstrikeAlertActivitySummary.cs
//
...
{
    #region CrowdstrikeAlertActivitySummary
    public class CrowdstrikeAlertActivitySummary: BaseType
    {
        #region members
        ...
        //      C# -> System.String? RollbackUrl
        // GraphQL -> rollbackUrl: String (scalar)
        [JsonProperty("rollbackUrl")]
        public System.String? RollbackUrl { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "CrowdstrikeAlertActivitySummary";
    }

    public CrowdstrikeAlertActivitySummary Set(
        List<System.String>? ImpactedIdentityProviders = null,
        DateTime? LatestActionTime = null,
        System.String? RollbackUrl = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? RollbackUrl
        // GraphQL -> rollbackUrl: String (scalar)
        if (this.RollbackUrl != null) {
            if (conf.Flat) {
                s += conf.Prefix + "rollbackUrl\n" ;
            } else {
                s += ind + "rollbackUrl\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? RollbackUrl
        // GraphQL -> rollbackUrl: String (scalar)
        if (ec.Includes("rollbackUrl",true))
        {
            if(this.RollbackUrl == null) {

                this.RollbackUrl = "FETCH";
        ...
        else if (this.RollbackUrl != null && ec.Excludes("rollbackUrl",true))
        {
            this.RollbackUrl = null;
        }
        //      C# -> System.Int32? TotalRelatedActions
        // GraphQL -> totalRelatedActions: Int! (scalar)
    ...
    } // class CrowdstrikeAlertActivitySummary
    
    #endregion

    public static class ListCrowdstrikeAlertActivitySummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CrowdstrikeAlertActivitySummary> list,
        ...
        public static List<string> SelectedFields(this List<CrowdstrikeAlertActivitySummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CrowdstrikeAlertActivitySummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CrowdstrikeAlertActivitySummary> list)
        {

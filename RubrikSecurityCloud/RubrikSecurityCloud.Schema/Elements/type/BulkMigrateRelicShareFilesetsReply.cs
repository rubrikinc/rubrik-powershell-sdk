// BulkMigrateRelicShareFilesetsReply.cs
//
...
{
    #region BulkMigrateRelicShareFilesetsReply
    public class BulkMigrateRelicShareFilesetsReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "BulkMigrateRelicShareFilesetsReply";
    }

    public BulkMigrateRelicShareFilesetsReply Set(
    ...
    } // class BulkMigrateRelicShareFilesetsReply
    
    #endregion

    public static class ListBulkMigrateRelicShareFilesetsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BulkMigrateRelicShareFilesetsReply> list,
        ...
        public static List<string> SelectedFields(this List<BulkMigrateRelicShareFilesetsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BulkMigrateRelicShareFilesetsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BulkMigrateRelicShareFilesetsReply> list)
        {

...
{
    #region O365QuarantineInfo
    public class O365QuarantineInfo: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "O365QuarantineInfo";
    }

    public O365QuarantineInfo Set(
    ...
    } // class O365QuarantineInfo
    
    #endregion

    public static class ListO365QuarantineInfoExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<O365QuarantineInfo> list,
        ...
        public static List<string> SelectedFields(this List<O365QuarantineInfo> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365QuarantineInfo());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365QuarantineInfo> list)
        {

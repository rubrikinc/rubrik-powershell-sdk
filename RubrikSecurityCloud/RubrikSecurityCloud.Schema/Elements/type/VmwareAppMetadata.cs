...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VmwareAppMetadata: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.VmConfig != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.VmConfig.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.VmConfig == null && Exploration.Includes(parent + ".vmConfig"))
            {
                ...
                this.VmConfig.ApplyExploratoryFragment(parent + ".vmConfig");
            }
        }
    ...
    public static class ListVmwareAppMetadataExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VmwareAppMetadata();
            list.Add(item);

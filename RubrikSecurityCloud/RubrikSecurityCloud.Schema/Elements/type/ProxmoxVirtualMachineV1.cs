...
{
    #region ProxmoxVirtualMachineV1
 
    public class ProxmoxVirtualMachineV1: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, ProxmoxClusterDescendant, ProxmoxClusterPhysicalChildType, ProxmoxEnvironmentDescendant, ProxmoxEnvironmentPhysicalChildType, ProxmoxNodeDescendant, ProxmoxNodePhysicalChildType
    {
        #region members
        ...
        //      C# -> System.String? ExcludedDiskIds
        // GraphQL -> excludedDiskIds: String! (scalar)
        [JsonProperty("excludedDiskIds")]
        public System.String? ExcludedDiskIds { get; set; }
        ...
        // GraphQL -> proxmoxNodeId: String! (scalar)
        ...
        //      C# -> System.String? SmbiosUuid
        // GraphQL -> smbiosUuid: String! (scalar)
        [JsonProperty("smbiosUuid")]
        public System.String? SmbiosUuid { get; set; }
        ...
        //      C# -> System.String? Volumes
        // GraphQL -> volumes: String! (scalar)
        [JsonProperty("volumes")]
        public System.String? Volumes { get; set; }
    ...
    public ProxmoxVirtualMachineV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "ProxmoxVirtualMachineV1";
    }

    public ProxmoxVirtualMachineV1 Set(
        ...
        System.String? ExcludedDiskIds = null,
        ...
        System.String? SmbiosUuid = null,
        System.Int32? VmId = null,
        System.String? VmName = null,
        System.String? Volumes = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? SmbiosUuid
        // GraphQL -> smbiosUuid: String! (scalar)
        if (this.SmbiosUuid != null) {
            if (conf.Flat) {
                s += conf.Prefix + "smbiosUuid\n" ;
            } else {
                s += ind + "smbiosUuid\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? SmbiosUuid
        // GraphQL -> smbiosUuid: String! (scalar)
        if (ec.Includes("smbiosUuid",true))
        {
            if(this.SmbiosUuid == null) {

                this.SmbiosUuid = "FETCH";
        ...
        else if (this.SmbiosUuid != null && ec.Excludes("smbiosUuid",true))
        {
        ...
        else if (this.Volumes != null && ec.Excludes("volumes",true))
        {
            this.Volumes = null;
        }
        //      C# -> List<Org>? AllOrgs
    ...
    } // class ProxmoxVirtualMachineV1
    
    #endregion

    public static class ListProxmoxVirtualMachineV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxVirtualMachineV1> list,
        ...
        public static List<string> SelectedFields(this List<ProxmoxVirtualMachineV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProxmoxVirtualMachineV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProxmoxVirtualMachineV1> list)
        {

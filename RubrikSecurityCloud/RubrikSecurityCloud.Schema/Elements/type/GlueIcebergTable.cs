...
{
    #region GlueIcebergTable
 
    public class GlueIcebergTable: BaseType, AwsNativeAccountDescendantType, AwsNativeHierarchyObject, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public GlueIcebergTable()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "GlueIcebergTable";
    }

    public GlueIcebergTable Set(
    ...
    public static class ListGlueIcebergTableExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GlueIcebergTable> list,
        ...
        public static List<string> SelectedFields(this List<GlueIcebergTable> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GlueIcebergTable());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GlueIcebergTable> list)
        {

...
{
    #region HypervisorVirtualMachineV1
 
    public class HypervisorVirtualMachineV1: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable
    {
        #region members
        ...
        // GraphQL -> hypervisorVmId: String! (scalar)
        ...
        //      C# -> HypervisorVirtualMachine? HypervisorInfo
        // GraphQL -> hypervisorInfo: HypervisorVirtualMachine! (type)
        [JsonProperty("hypervisorInfo")]
        public HypervisorVirtualMachine? HypervisorInfo { get; set; }
    ...
    public HypervisorVirtualMachineV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "HypervisorVirtualMachineV1";
    }

    public HypervisorVirtualMachineV1 Set(
        ...
        HypervisorVirtualMachine? HypervisorInfo = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("hypervisorInfo",false))
        {
            if(this.HypervisorInfo == null) {
                ...
                this.HypervisorInfo = new HypervisorVirtualMachine();
    ...
    } // class HypervisorVirtualMachineV1
    
    #endregion

    public static class ListHypervisorVirtualMachineV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<HypervisorVirtualMachineV1> list,
        ...
        public static List<string> SelectedFields(this List<HypervisorVirtualMachineV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HypervisorVirtualMachineV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HypervisorVirtualMachineV1> list)
        {

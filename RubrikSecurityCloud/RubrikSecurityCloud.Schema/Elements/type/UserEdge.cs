...
{
    #region UserEdge
    public class UserEdge: BaseType
    {
        #region members
    ...
    public static class ListUserEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UserEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UserEdge> list)
        {

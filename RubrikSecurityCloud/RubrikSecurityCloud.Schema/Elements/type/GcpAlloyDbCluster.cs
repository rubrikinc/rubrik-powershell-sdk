...
{
    #region GcpAlloyDbCluster
 
    public class GcpAlloyDbCluster: BaseType, GcpNativeHierarchyObject, GcpNativeProjectDescendantType, GcpNativeProjectLogicalChildType, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    } // class GcpAlloyDbCluster
    
    #endregion

    public static class ListGcpAlloyDbClusterExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpAlloyDbCluster> list,
        ...
        public static List<string> SelectedFields(this List<GcpAlloyDbCluster> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpAlloyDbCluster());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpAlloyDbCluster> list)
        {

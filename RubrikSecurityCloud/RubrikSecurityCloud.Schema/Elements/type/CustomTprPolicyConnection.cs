...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCustomTprPolicyConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CustomTprPolicyConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<CustomTprPolicyConnection> list)
        {

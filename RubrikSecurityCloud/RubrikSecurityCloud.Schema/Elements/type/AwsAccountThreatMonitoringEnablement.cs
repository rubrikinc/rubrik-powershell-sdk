// AwsAccountThreatMonitoringEnablement.cs
//
...
{
    #region AwsAccountThreatMonitoringEnablement
    public class AwsAccountThreatMonitoringEnablement: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AwsAccountThreatMonitoringEnablement";
    }

    public AwsAccountThreatMonitoringEnablement Set(
    ...
    } // class AwsAccountThreatMonitoringEnablement
    
    #endregion

    public static class ListAwsAccountThreatMonitoringEnablementExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AwsAccountThreatMonitoringEnablement> list,
        ...
        public static List<string> SelectedFields(this List<AwsAccountThreatMonitoringEnablement> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsAccountThreatMonitoringEnablement());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AwsAccountThreatMonitoringEnablement> list)
        {

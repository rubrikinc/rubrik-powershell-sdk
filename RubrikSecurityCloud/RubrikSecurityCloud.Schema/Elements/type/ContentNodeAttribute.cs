...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListContentNodeAttributeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ContentNodeAttribute> list)
        {
        ...
        public static void SelectForRetrieval(this List<ContentNodeAttribute> list)
        {

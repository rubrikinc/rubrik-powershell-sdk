...
{
    #region SalesforceObjectField
    public class SalesforceObjectField: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SalesforceObjectField";
    }

    public SalesforceObjectField Set(
    ...
    public static class ListSalesforceObjectFieldExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SalesforceObjectField> list,
        ...
        public static List<string> SelectedFields(this List<SalesforceObjectField> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SalesforceObjectField());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SalesforceObjectField> list)
        {

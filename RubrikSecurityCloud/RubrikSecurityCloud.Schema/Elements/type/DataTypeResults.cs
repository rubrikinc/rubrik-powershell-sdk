...
{
    #region DataTypeResults
    public class DataTypeResults: BaseType
    {
        #region members
    ...
    } // class DataTypeResults
    
    #endregion

    public static class ListDataTypeResultsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DataTypeResults> list,
        ...
        public static List<string> SelectedFields(this List<DataTypeResults> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DataTypeResults());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DataTypeResults> list)
        {

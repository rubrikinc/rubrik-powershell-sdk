...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.RecoverySpecIds != null) {
            var fspec = this.RecoverySpecIds.AsFieldSpec(conf.Child("recoverySpecIds"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<RecoverySpecId>? RecoverySpecIds
        // GraphQL -> recoverySpecIds: [RecoverySpecId!]! (type)
        if (ec.Includes("recoverySpecIds",false))
        {
            if(this.RecoverySpecIds == null) {
        ...
        else if (this.RecoverySpecIds != null && ec.Excludes("recoverySpecIds",false))
        {
    ...
    public static class ListDeleteBlueprintRecoverySpecReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DeleteBlueprintRecoverySpecReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DeleteBlueprintRecoverySpecReply> list)
        {

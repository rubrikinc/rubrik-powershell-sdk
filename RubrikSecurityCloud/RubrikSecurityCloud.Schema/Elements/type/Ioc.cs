...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Ioc: BaseType
    {
        ...
        //      C# -> IndicatorOfCompromiseInputOutputListType? IocList
        // GraphQL -> iocList: IndicatorOfCompromiseInputOutputListType (type)
        [JsonProperty("iocList")]
        public IndicatorOfCompromiseInputOutputListType? IocList { get; set; }
    ...
    public Ioc Set(
        ...
        IndicatorOfCompromiseInputOutputListType? IocList = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("iocList",false))
        {
            if(this.IocList == null) {
                ...
                this.IocList = new IndicatorOfCompromiseInputOutputListType();

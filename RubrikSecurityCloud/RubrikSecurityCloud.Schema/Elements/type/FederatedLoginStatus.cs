...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class FederatedLoginStatus: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Boolean? InventoryCardEnabled
            // GraphQL -> inventoryCardEnabled: Boolean! (scalar)
            if (this.InventoryCardEnabled == null && Exploration.Includes(parent + ".inventoryCardEnabled$"))
            {
                this.InventoryCardEnabled = new System.Boolean();
            }
        }
    ...
    public static class ListFederatedLoginStatusExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new FederatedLoginStatus();
            list.Add(item);

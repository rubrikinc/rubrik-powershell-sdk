...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FailoverClusterAppDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<FailoverClusterAppDescendantType> Node { get; set; }
    ...
    public FailoverClusterAppDescendantTypeEdge Set(
        RscInterface<FailoverClusterAppDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<FailoverClusterAppDescendantType>();

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class FailoverClusterAppDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (FailoverClusterAppDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(FailoverClusterAppDescendantType));
    ...
    public static class ListFailoverClusterAppDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new FailoverClusterAppDescendantTypeEdge();
            list.Add(item);

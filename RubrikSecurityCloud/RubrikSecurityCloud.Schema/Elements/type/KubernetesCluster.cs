...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KubernetesCluster: BaseType, CdmHierarchyObject, HierarchyObject
    {
        ...
        //      C# -> KubernetesResourceSetConnection? K8sDescendantResourceSets
        // GraphQL -> k8sDescendantResourceSets: KubernetesResourceSetConnection! (type)
        [JsonProperty("k8sDescendantResourceSets")]
        public KubernetesResourceSetConnection? K8sDescendantResourceSets { get; set; }
    ...
    public KubernetesCluster Set(
        ...
        KubernetesResourceSetConnection? K8sDescendantResourceSets = null,
    ...
    ) 
    {
        ...
        if ( K8sDescendantResourceSets != null ) {
            this.K8sDescendantResourceSets = K8sDescendantResourceSets;
        }
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        //      C# -> KubernetesResourceSetConnection? K8sDescendantResourceSets
        // GraphQL -> k8sDescendantResourceSets: KubernetesResourceSetConnection! (type)
        if (this.K8sDescendantResourceSets != null) {
            var fspec = this.K8sDescendantResourceSets.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                s += ind + "k8sDescendantResourceSets {\n" + fspec + ind + "}\n" ;
            }
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? K8sName
        // GraphQL -> k8sName: String! (scalar)
        if (this.K8sName == null && ec.Includes("k8sName",true))
        {
            this.K8sName = "FETCH";
        }
        //      C# -> System.String? Name
        ...
        //      C# -> KubernetesResourceSetConnection? K8sDescendantResourceSets
        // GraphQL -> k8sDescendantResourceSets: KubernetesResourceSetConnection! (type)
        if (this.K8sDescendantResourceSets == null && ec.Includes("k8sDescendantResourceSets",false))
        {
            this.K8sDescendantResourceSets = new KubernetesResourceSetConnection();
            this.K8sDescendantResourceSets.ApplyExploratoryFieldSpec(ec.NewChild("k8sDescendantResourceSets"));
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
    ...
    public static class ListKubernetesClusterExtensions
    {
        ...
        public static void Fetch(this List<KubernetesCluster> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.String? K8sName
        // GraphQL -> k8sName: String! (scalar)
        if (this.K8sName == null && Exploration.Includes(parent + ".k8sName", true))
        {
            this.K8sName = "FETCH";
        }
        //      C# -> System.String? Name
        ...
        //      C# -> KubernetesResourceSetConnection? K8sDescendantResourceSets
        // GraphQL -> k8sDescendantResourceSets: KubernetesResourceSetConnection! (type)
        if (this.K8sDescendantResourceSets == null && Exploration.Includes(parent + ".k8sDescendantResourceSets"))
        {
            this.K8sDescendantResourceSets = new KubernetesResourceSetConnection();
            this.K8sDescendantResourceSets.ApplyExploratoryFieldSpec(parent + ".k8sDescendantResourceSets");
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)

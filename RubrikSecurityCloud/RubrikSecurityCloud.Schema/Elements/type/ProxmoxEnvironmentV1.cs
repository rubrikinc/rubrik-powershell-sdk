...
{
    #region ProxmoxEnvironmentV1
 
    public class ProxmoxEnvironmentV1: BaseType, CdmHierarchyObject, HierarchyObject
    {
        #region members
        ...
        //      C# -> ProxmoxEnvironmentDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: ProxmoxEnvironmentDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public ProxmoxEnvironmentDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> ProxmoxEnvironmentPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: ProxmoxEnvironmentPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public ProxmoxEnvironmentPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public ProxmoxEnvironmentV1()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "ProxmoxEnvironmentV1";
    }

    public ProxmoxEnvironmentV1 Set(
        ...
        ProxmoxEnvironmentDescendantConnection? DescendantConnection = null,
        ...
        ProxmoxEnvironmentPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new ProxmoxEnvironmentDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new ProxmoxEnvironmentPhysicalChildTypeConnection();
    ...
    } // class ProxmoxEnvironmentV1
    
    #endregion

    public static class ListProxmoxEnvironmentV1Extensions
    {
        ...
        public static string AsFieldSpec(
            this List<ProxmoxEnvironmentV1> list,
        ...
        public static List<string> SelectedFields(this List<ProxmoxEnvironmentV1> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ProxmoxEnvironmentV1());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ProxmoxEnvironmentV1> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class TprRequestDetailReply: BaseType
    {
        ...
        //      C# -> System.Boolean? IsPotentialLastApprover
        // GraphQL -> isPotentialLastApprover: Boolean! (scalar)
        [JsonProperty("isPotentialLastApprover")]
        public System.Boolean? IsPotentialLastApprover { get; set; }
    ...
    public TprRequestDetailReply Set(
        ...
        System.Boolean? IsPotentialLastApprover = null,
    ...
    ) 
    {
        ...
        if ( IsPotentialLastApprover != null ) {
            this.IsPotentialLastApprover = IsPotentialLastApprover;
        }
        if ( OrgId != null ) {
            this.OrgId = OrgId;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.Boolean? IsPotentialLastApprover
        // GraphQL -> isPotentialLastApprover: Boolean! (scalar)
        if (this.IsPotentialLastApprover != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isPotentialLastApprover\n" ;
            } else {
                s += ind + "isPotentialLastApprover\n" ;
            }
        }
        //      C# -> System.String? OrgId
        // GraphQL -> orgId: UUID! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.Boolean? IsPotentialLastApprover
        // GraphQL -> isPotentialLastApprover: Boolean! (scalar)
        if (ec.Includes("isPotentialLastApprover",true))
        {
            if(this.IsPotentialLastApprover == null) {

                this.IsPotentialLastApprover = true;
        ...
        else if (this.IsPotentialLastApprover != null && ec.Excludes("isPotentialLastApprover",true))
        {
            this.IsPotentialLastApprover = null;
        }
        //      C# -> System.String? OrgId
        // GraphQL -> orgId: UUID! (scalar)

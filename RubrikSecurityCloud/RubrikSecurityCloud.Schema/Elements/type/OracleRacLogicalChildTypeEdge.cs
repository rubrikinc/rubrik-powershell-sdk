...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleRacLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<OracleRacLogicalChildType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "OracleRacLogicalChildTypeEdge";
    }

    public OracleRacLogicalChildTypeEdge Set(
        RscInterface<OracleRacLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<OracleRacLogicalChildType>();
    ...
    public static class ListOracleRacLogicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleRacLogicalChildTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleRacLogicalChildTypeEdge> list)
        {

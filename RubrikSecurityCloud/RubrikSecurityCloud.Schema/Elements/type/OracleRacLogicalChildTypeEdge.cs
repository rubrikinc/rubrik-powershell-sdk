...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class OracleRacLogicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (OracleRacLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleRacLogicalChildType));
    ...
    public static class ListOracleRacLogicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new OracleRacLogicalChildTypeEdge();
            list.Add(item);

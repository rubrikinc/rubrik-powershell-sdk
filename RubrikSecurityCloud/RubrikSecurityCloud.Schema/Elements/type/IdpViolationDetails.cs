...
{
    #region IdpViolationDetails
 
    public class IdpViolationDetails: BaseType, ViolationDetailsUnion
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "IdpViolationDetails";
    }

    public IdpViolationDetails Set(
    ...
    } // class IdpViolationDetails
    
    #endregion

    public static class ListIdpViolationDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<IdpViolationDetails> list,
        ...
        public static List<string> SelectedFields(this List<IdpViolationDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new IdpViolationDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<IdpViolationDetails> list)
        {

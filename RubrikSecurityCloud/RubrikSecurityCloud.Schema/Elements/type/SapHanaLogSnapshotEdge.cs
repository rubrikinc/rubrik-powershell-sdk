...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SapHanaLogSnapshotEdge: BaseType
    {
        #region members
    ...
    public static class ListSapHanaLogSnapshotEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SapHanaLogSnapshotEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SapHanaLogSnapshotEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SapHanaLogSnapshotEdge> list)
        {

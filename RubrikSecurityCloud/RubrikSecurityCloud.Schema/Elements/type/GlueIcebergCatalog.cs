...
{
    #region GlueIcebergCatalog
 
    public class GlueIcebergCatalog: BaseType, AwsNativeAccountDescendantType, AwsNativeAccountLogicalChildType, AwsNativeHierarchyObject, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public static class ListGlueIcebergCatalogExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GlueIcebergCatalog> list,
        ...
        public static List<string> SelectedFields(this List<GlueIcebergCatalog> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GlueIcebergCatalog());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GlueIcebergCatalog> list)
        {

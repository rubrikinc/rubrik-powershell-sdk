...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdOrgVdc: BaseType, CdmHierarchyObject, HierarchyObject, VcdDescendantType, VcdLogicalChildType, VcdOrgDescendantType, VcdOrgLogicalChildType, VcdTopLevelDescendantType
    {
        #region members
        ...
        //      C# -> VcdOrgVdcDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VcdOrgVdcDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VcdOrgVdcDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VcdOrgVdcLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: VcdOrgVdcLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public VcdOrgVdcLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> VcdOrgVdcLogicalChildTypeConnection? RecoveryLogicalChildConnection
        // GraphQL -> recoveryLogicalChildConnection: VcdOrgVdcLogicalChildTypeConnection! (type)
        [JsonProperty("recoveryLogicalChildConnection")]
        public VcdOrgVdcLogicalChildTypeConnection? RecoveryLogicalChildConnection { get; set; }
    ...
    public VcdOrgVdc Set(
        ...
        VcdOrgVdcDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        VcdOrgVdcLogicalChildTypeConnection? LogicalChildConnection = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        VcdOrgVdcLogicalChildTypeConnection? RecoveryLogicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VcdOrgVdcDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new VcdOrgVdcLogicalChildTypeConnection();
        ...
        if (ec.Includes("recoveryLogicalChildConnection",false))
        {
            if(this.RecoveryLogicalChildConnection == null) {
                ...
                this.RecoveryLogicalChildConnection = new VcdOrgVdcLogicalChildTypeConnection();
    ...
    public static class ListVcdOrgVdcExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdOrgVdc> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VcdOrgVdc());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VcdOrgVdc> list)
        {

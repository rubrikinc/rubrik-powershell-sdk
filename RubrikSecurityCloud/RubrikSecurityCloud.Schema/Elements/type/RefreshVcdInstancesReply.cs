...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "RefreshVcdInstancesReply";
    }
    ...
    public static class ListRefreshVcdInstancesReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RefreshVcdInstancesReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<RefreshVcdInstancesReply> list)
        {

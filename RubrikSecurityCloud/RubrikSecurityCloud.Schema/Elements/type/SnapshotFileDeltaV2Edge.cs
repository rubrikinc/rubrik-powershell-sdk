...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SnapshotFileDeltaV2Edge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SnapshotFileDeltaV2Edge";
    }
    ...
    public static class ListSnapshotFileDeltaV2EdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnapshotFileDeltaV2Edge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SnapshotFileDeltaV2Edge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SnapshotFileDeltaV2Edge> list)
        {

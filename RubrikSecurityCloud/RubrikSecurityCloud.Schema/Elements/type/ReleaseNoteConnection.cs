...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListReleaseNoteConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReleaseNoteConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReleaseNoteConnection> list)
        {

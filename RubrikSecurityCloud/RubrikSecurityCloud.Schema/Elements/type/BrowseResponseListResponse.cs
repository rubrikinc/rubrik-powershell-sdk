...
{
    #region BrowseResponseListResponse
    public class BrowseResponseListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<BrowseResponse>? Data
        // GraphQL -> data: [BrowseResponse!]! (type)
        [JsonProperty("data")]
        public List<BrowseResponse>? Data { get; set; }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<BrowseResponse>();
    ...
    public static class ListBrowseResponseListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BrowseResponseListResponse> list,
        ...
        public static List<string> SelectedFields(this List<BrowseResponseListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BrowseResponseListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BrowseResponseListResponse> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AzureCloudAccountTenant: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.String? AzureCloudAccountTenantRubrikId
            // GraphQL -> azureCloudAccountTenantRubrikId: String! (scalar)
            if (this.AzureCloudAccountTenantRubrikId == null && Exploration.Includes(parent + ".azureCloudAccountTenantRubrikId$"))
            {
    ...
    public static class ListAzureCloudAccountTenantExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new AzureCloudAccountTenant();
            list.Add(item);

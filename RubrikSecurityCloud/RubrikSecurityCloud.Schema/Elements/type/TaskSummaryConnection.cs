...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListTaskSummaryConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TaskSummaryConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<TaskSummaryConnection> list)
        {

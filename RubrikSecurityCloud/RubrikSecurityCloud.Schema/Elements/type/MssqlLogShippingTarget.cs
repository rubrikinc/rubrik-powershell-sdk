...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MssqlLogShippingTarget: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.PrimaryCluster != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.PrimaryCluster.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> MssqlDatabase? PrimaryDatabase
            // GraphQL -> primaryDatabase: MssqlDatabase (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.Int64? LagTimeFromPrimary
            // GraphQL -> lagTimeFromPrimary: Long! (scalar)
            if (this.LagTimeFromPrimary == null && Exploration.Includes(parent + ".lagTimeFromPrimary$"))
            {
            ...
            if (this.PrimaryCluster == null && Exploration.Includes(parent + ".primaryCluster"))
            {
                ...
                this.PrimaryCluster.ApplyExploratoryFragment(parent + ".primaryCluster");
            }
            //      C# -> MssqlDatabase? PrimaryDatabase
            // GraphQL -> primaryDatabase: MssqlDatabase (type)
    ...
    public static class ListMssqlLogShippingTargetExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MssqlLogShippingTarget();
            list.Add(item);

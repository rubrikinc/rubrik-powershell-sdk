...
namespace RubrikSecurityCloud.Types
{
    ...
    public class RequestStatus: BaseType
    {
        #region members
    ...
    public static class ListRequestStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RequestStatus> list)
        {
        ...
        public static void SelectForRetrieval(this List<RequestStatus> list)
        {

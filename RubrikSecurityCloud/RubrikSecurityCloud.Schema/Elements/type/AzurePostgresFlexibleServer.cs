// AzurePostgresFlexibleServer.cs
//
...
namespace RubrikSecurityCloud.Types
{
    ...
    public AzurePostgresFlexibleServer()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "AzurePostgresFlexibleServer";
    }
    ...
    } // class AzurePostgresFlexibleServer
    
    #endregion

    public static class ListAzurePostgresFlexibleServerExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzurePostgresFlexibleServer> list,
        ...
        public static List<string> SelectedFields(this List<AzurePostgresFlexibleServer> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzurePostgresFlexibleServer());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzurePostgresFlexibleServer> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListV1MssqlGetRestoreFilesV1ResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<V1MssqlGetRestoreFilesV1Response> list)
        {
        ...
        public static void SelectForRetrieval(this List<V1MssqlGetRestoreFilesV1Response> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MssqlDbSummary: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.String? AvailabilityGroupId
            // GraphQL -> availabilityGroupId: String (scalar)
            if (this.AvailabilityGroupId == null && Exploration.Includes(parent + ".availabilityGroupId$"))
            {
            ...
            //      C# -> System.Int32? LogBackupRetentionHours
            // GraphQL -> logBackupRetentionHours: Int! (scalar)
            if (this.LogBackupRetentionHours == null && Exploration.Includes(parent + ".logBackupRetentionHours$"))
            {

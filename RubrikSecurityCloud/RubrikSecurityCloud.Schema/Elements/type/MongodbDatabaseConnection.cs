...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbDatabaseConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MongodbDatabaseConnection";
    }
    ...
    public static class ListMongodbDatabaseConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbDatabaseConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongodbDatabaseConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongodbDatabaseConnection> list)
        {

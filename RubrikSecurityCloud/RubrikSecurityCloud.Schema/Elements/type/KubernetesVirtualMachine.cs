...
namespace RubrikSecurityCloud.Types
{
    ...
    public class KubernetesVirtualMachine: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, KubernetesClusterDescendant, KubernetesLabelDescendant, KubernetesNamespaceDescendant
    {
        ...
        //      C# -> System.String? ProtectionSetId
        // GraphQL -> protectionSetId: UUID (scalar)
        [JsonProperty("protectionSetId")]
        public System.String? ProtectionSetId { get; set; }
        ...
        //      C# -> System.String? VirtualizationProvider
        // GraphQL -> virtualizationProvider: String (scalar)
        [JsonProperty("virtualizationProvider")]
        public System.String? VirtualizationProvider { get; set; }
        ...
        [JsonProperty("k8sVirtualMachineDisks")]
        public KubernetesVirtualMachineDiskConnection? K8sVirtualMachineDisks { get; set; }
    ...
    public class InlineVars {
        ...
        public RscGqlVars K8sVirtualMachineDisks { get; set; }
        ...
        public InlineVars() {
            ...
            this.K8sVirtualMachineDisks =
                new RscGqlVars(null, k8sVirtualMachineDisksArgs, null, true);
    ...
    public KubernetesVirtualMachine()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "KubernetesVirtualMachine";
    }

    public KubernetesVirtualMachine Set(
        ...
        System.String? ProtectionSetId = null,
        System.Int32? ReplicatedObjectCount = null,
        System.Boolean? SlaPauseStatus = null,
        System.String? VirtualizationProvider = null,
    ...
    ) 
    {
        ...
        if ( ProtectionSetId != null ) {
            this.ProtectionSetId = ProtectionSetId;
        }
        ...
        if ( VirtualizationProvider != null ) {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? ProtectionSetId
        // GraphQL -> protectionSetId: UUID (scalar)
        if (this.ProtectionSetId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "protectionSetId\n" ;
            } else {
                s += ind + "protectionSetId\n" ;
            }
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        //      C# -> System.String? VirtualizationProvider
        // GraphQL -> virtualizationProvider: String (scalar)
        if (this.VirtualizationProvider != null) {
            if (conf.Flat) {
                s += conf.Prefix + "virtualizationProvider\n" ;
            } else {
                s += ind + "virtualizationProvider\n" ;
            }
        }
        //      C# -> System.String? VmName
        // GraphQL -> vmName: String! (scalar)
        ...
        //      C# -> KubernetesVirtualMachineDiskConnection? K8sVirtualMachineDisks
        // GraphQL -> k8sVirtualMachineDisks: KubernetesVirtualMachineDiskConnection! (type)
        if (this.K8sVirtualMachineDisks != null) {
            var fspec = this.K8sVirtualMachineDisks.AsFieldSpec(conf.Child("k8sVirtualMachineDisks"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
                    s += ind + "k8sVirtualMachineDisks" + "\n(" + this.Vars.K8sVirtualMachineDisks.ToInlineArguments() + ")\n" + "{\n" + fspec + ind + "}\n" ;
                }
            }
        }
        //      C# -> LatestUserNote? LatestUserNote
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? K8sNamespaceId
        // GraphQL -> k8sNamespaceId: UUID! (scalar)
        if (ec.Includes("k8sNamespaceId",true))
        {
            if(this.K8sNamespaceId == null) {

                this.K8sNamespaceId = "FETCH";
        ...
        //      C# -> System.String? ProtectionSetId
        // GraphQL -> protectionSetId: UUID (scalar)
        if (ec.Includes("protectionSetId",true))
        {
            if(this.ProtectionSetId == null) {

                this.ProtectionSetId = "FETCH";
        ...
        else if (this.ProtectionSetId != null && ec.Excludes("protectionSetId",true))
        {
            this.ProtectionSetId = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        //      C# -> System.String? VirtualizationProvider
        // GraphQL -> virtualizationProvider: String (scalar)
        if (ec.Includes("virtualizationProvider",true))
        {
            if(this.VirtualizationProvider == null) {

                this.VirtualizationProvider = "FETCH";
        ...
        else if (this.VirtualizationProvider != null && ec.Excludes("virtualizationProvider",true))
        {
            this.VirtualizationProvider = null;
        }
        //      C# -> System.String? VmName
        // GraphQL -> vmName: String! (scalar)
        ...
        //      C# -> KubernetesVirtualMachineDiskConnection? K8sVirtualMachineDisks
        // GraphQL -> k8sVirtualMachineDisks: KubernetesVirtualMachineDiskConnection! (type)
        if (ec.Includes("k8sVirtualMachineDisks",false))
        {
            if(this.K8sVirtualMachineDisks == null) {

                this.K8sVirtualMachineDisks = new KubernetesVirtualMachineDiskConnection();
                this.K8sVirtualMachineDisks.ApplyExploratoryFieldSpec(ec.NewChild("k8sVirtualMachineDisks"));
        ...
        else if (this.K8sVirtualMachineDisks != null && ec.Excludes("k8sVirtualMachineDisks",false))
        {
            this.K8sVirtualMachineDisks = null;
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
    ...
    public static class ListKubernetesVirtualMachineExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesVirtualMachine> list,
        ...
        public static List<string> SelectedFields(this List<KubernetesVirtualMachine> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesVirtualMachine());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KubernetesVirtualMachine> list)
        {

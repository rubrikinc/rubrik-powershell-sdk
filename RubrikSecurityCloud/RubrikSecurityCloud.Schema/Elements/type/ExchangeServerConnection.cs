...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ExchangeServerConnection: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ExchangeServerConnection";
    }
    ...
    public static class ListExchangeServerConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeServerConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ExchangeServerConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ExchangeServerConnection> list)
        {

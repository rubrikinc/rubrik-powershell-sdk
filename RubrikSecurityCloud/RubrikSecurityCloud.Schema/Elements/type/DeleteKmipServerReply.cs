...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDeleteKmipServerReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DeleteKmipServerReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<DeleteKmipServerReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CdmHierarchyObjectConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<CdmHierarchyObject> Nodes { get; set; }
    ...
    public CdmHierarchyObjectConnection Set(
        RscInterfaceList<CdmHierarchyObject> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<CdmHierarchyObject>();
    ...
    public static class ListCdmHierarchyObjectConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CdmHierarchyObjectConnection> list)
        {

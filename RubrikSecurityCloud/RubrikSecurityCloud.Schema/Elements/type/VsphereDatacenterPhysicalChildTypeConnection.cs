...
namespace RubrikSecurityCloud.Types
{
        ...
        if (this.Nodes != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereDatacenterPhysicalChildTypeConnection_INTERFACE_FIELD_nodes: nodes{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? Count
    ...
    public static class ListVsphereDatacenterPhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterPhysicalChildTypeConnection> list)
        {

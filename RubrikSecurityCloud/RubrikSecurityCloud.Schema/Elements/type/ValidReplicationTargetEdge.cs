...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ValidReplicationTargetEdge: BaseType
    {
        #region members
    ...
    public static class ListValidReplicationTargetEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ValidReplicationTargetEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ValidReplicationTargetEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ValidReplicationTargetEdge> list)
        {

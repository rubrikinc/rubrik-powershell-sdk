...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListUpdateOrgReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateOrgReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<UpdateOrgReply> list)
        {

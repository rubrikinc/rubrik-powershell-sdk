...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVclusterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<HyperVclusterDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "HyperVClusterDescendantTypeConnection";
    }

    public HyperVclusterDescendantTypeConnection Set(
        RscInterfaceList<HyperVclusterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<HyperVclusterDescendantType>();
    ...
    public static class ListHyperVclusterDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVclusterDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<HyperVclusterDescendantTypeConnection> list)
        {

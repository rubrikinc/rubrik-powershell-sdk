...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVclusterDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<HyperVclusterDescendantType> Nodes { get; set; }
    ...
    public HyperVclusterDescendantTypeConnection Set(
        RscInterface<HyperVclusterDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<HyperVclusterDescendantType>();

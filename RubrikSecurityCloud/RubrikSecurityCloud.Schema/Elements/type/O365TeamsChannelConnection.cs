...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "O365TeamsChannelConnection";
    }
    ...
    public static class ListO365TeamsChannelConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamsChannelConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365TeamsChannelConnection> list)
        {

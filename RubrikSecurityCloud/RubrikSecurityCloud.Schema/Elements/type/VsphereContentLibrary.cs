...
{
    #region VsphereContentLibrary
 
    public class VsphereContentLibrary: BaseType, CdmHierarchyObject, HierarchyObject, VsphereVcenterDescendantType, VsphereVcenterLibraryChildType
    {
        #region members
        ...
        //      C# -> VsphereContentLibraryLibraryChildTypeConnection? LibraryChildConnection
        // GraphQL -> libraryChildConnection: VsphereContentLibraryLibraryChildTypeConnection! (type)
        [JsonProperty("libraryChildConnection")]
        public VsphereContentLibraryLibraryChildTypeConnection? LibraryChildConnection { get; set; }
    ...
    public VsphereContentLibrary()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "VsphereContentLibrary";
    }

    public VsphereContentLibrary Set(
        ...
        VsphereContentLibraryLibraryChildTypeConnection? LibraryChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("libraryChildConnection",false))
        {
            if(this.LibraryChildConnection == null) {
                ...
                this.LibraryChildConnection = new VsphereContentLibraryLibraryChildTypeConnection();
    ...
    } // class VsphereContentLibrary
    
    #endregion

    public static class ListVsphereContentLibraryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<VsphereContentLibrary> list,
        ...
        public static List<string> SelectedFields(this List<VsphereContentLibrary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereContentLibrary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereContentLibrary> list)
        {

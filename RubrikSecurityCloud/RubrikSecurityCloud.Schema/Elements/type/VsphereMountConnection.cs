...
{
    #region VsphereMountConnection
    public class VsphereMountConnection: BaseType
    {
        #region members
        ...
        [JsonProperty("edges")]
        public List<VsphereMountEdge>? Edges { get; set; }

        //      C# -> List<VsphereMount>? Nodes
        // GraphQL -> nodes: [VsphereMount!]! (type)
        [JsonProperty("nodes")]
        public List<VsphereMount>? Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VsphereMountConnection";
    }

    public VsphereMountConnection Set(
        System.Int32? Count = null,
        List<VsphereMountEdge>? Edges = null,
        List<VsphereMount>? Nodes = null,
    ...
    } // class VsphereMountConnection
    
    #endregion

    public static class ListVsphereMountConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereMountConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereMountConnection> list)
        {

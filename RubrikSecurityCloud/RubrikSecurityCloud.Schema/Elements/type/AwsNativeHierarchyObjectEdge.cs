// AwsNativeHierarchyObjectEdge.cs
//
...
{
    #region AwsNativeHierarchyObjectEdge
    public class AwsNativeHierarchyObjectEdge: BaseType
    {
        #region members
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "AwsNativeHierarchyObjectEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    } // class AwsNativeHierarchyObjectEdge
    
    #endregion

    public static class ListAwsNativeHierarchyObjectEdgeExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AwsNativeHierarchyObjectEdge> list,
        ...
        public static List<string> SelectedFields(this List<AwsNativeHierarchyObjectEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AwsNativeHierarchyObjectEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AwsNativeHierarchyObjectEdge> list)
        {

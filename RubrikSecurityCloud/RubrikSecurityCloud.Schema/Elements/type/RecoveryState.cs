...
namespace RubrikSecurityCloud.Types
{
    ...
    public class RecoveryState: BaseType
    {
        #region members
    ...
    public static class ListRecoveryStateExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RecoveryState> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RecoveryState());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RecoveryState> list)
        {

...
{
    #region M365AbrRecoveryPlan
    public class M365AbrRecoveryPlan: BaseType
    {
        #region members
    ...
    } // class M365AbrRecoveryPlan
    
    #endregion

    public static class ListM365AbrRecoveryPlanExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<M365AbrRecoveryPlan> list,
        ...
        public static List<string> SelectedFields(this List<M365AbrRecoveryPlan> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new M365AbrRecoveryPlan());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<M365AbrRecoveryPlan> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.VcdClusterSummary != null) {
            var fspec = this.VcdClusterSummary.AsFieldSpec(conf.Child("vcdClusterSummary"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> VcdClusterSummary? VcdClusterSummary
        // GraphQL -> vcdClusterSummary: VcdClusterSummary (type)
        if (ec.Includes("vcdClusterSummary",false))
        {
            if(this.VcdClusterSummary == null) {
        ...
        else if (this.VcdClusterSummary != null && ec.Excludes("vcdClusterSummary",false))
        {
    ...
    public static class ListVcdClusterDetailExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdClusterDetail> list)
        {
        ...
        public static void SelectForRetrieval(this List<VcdClusterDetail> list)
        {

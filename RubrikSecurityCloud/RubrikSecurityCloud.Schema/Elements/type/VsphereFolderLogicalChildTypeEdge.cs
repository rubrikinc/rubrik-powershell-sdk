...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereFolderLogicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereFolderLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereFolderLogicalChildType));
    ...
    public static class ListVsphereFolderLogicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereFolderLogicalChildTypeEdge();
            list.Add(item);

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereFolderLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereFolderLogicalChildType> Node { get; set; }
    ...
    public VsphereFolderLogicalChildTypeEdge Set(
        RscInterface<VsphereFolderLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereFolderLogicalChildType>();
    ...
    public static class ListVsphereFolderLogicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereFolderLogicalChildTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "CloudDirectSnapshotConnection";
    }
    ...
    public static class ListCloudDirectSnapshotConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CloudDirectSnapshotConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<CloudDirectSnapshotConnection> list)
        {

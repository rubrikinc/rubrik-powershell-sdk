// KubernetesVirtualMachineSnapshotsReply.cs
//
...
{
    #region KubernetesVirtualMachineSnapshotsReply
    public class KubernetesVirtualMachineSnapshotsReply: BaseType
    {
        #region members
        ...
        //      C# -> List<K8sVmSnapshotSummary>? Data
        // GraphQL -> data: [K8sVmSnapshotSummary!]! (type)
        [JsonProperty("data")]
        public List<K8sVmSnapshotSummary>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "KubernetesVirtualMachineSnapshotsReply";
    }

    public KubernetesVirtualMachineSnapshotsReply Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int32? Total = null,
        List<K8sVmSnapshotSummary>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<K8sVmSnapshotSummary>();
    ...
    } // class KubernetesVirtualMachineSnapshotsReply
    
    #endregion

    public static class ListKubernetesVirtualMachineSnapshotsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<KubernetesVirtualMachineSnapshotsReply> list,
        ...
        public static List<string> SelectedFields(this List<KubernetesVirtualMachineSnapshotsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new KubernetesVirtualMachineSnapshotsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<KubernetesVirtualMachineSnapshotsReply> list)
        {

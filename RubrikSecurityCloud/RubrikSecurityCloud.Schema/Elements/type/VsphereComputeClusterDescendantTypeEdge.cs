...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereComputeClusterDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereComputeClusterDescendantType> Node { get; set; }
    ...
    public VsphereComputeClusterDescendantTypeEdge Set(
        RscInterface<VsphereComputeClusterDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereComputeClusterDescendantType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereComputeClusterDescendantTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "VsphereComputeClusterDescendantTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VsphereComputeClusterDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<VsphereComputeClusterDescendantType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (VsphereComputeClusterDescendantType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    public static class ListVsphereComputeClusterDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereComputeClusterDescendantTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereComputeClusterDescendantTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereComputeClusterDescendantTypeEdge> list)
        {

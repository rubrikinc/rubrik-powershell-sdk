...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAwsNativeRdsInstanceEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AwsNativeRdsInstanceEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<AwsNativeRdsInstanceEdge> list)
        {

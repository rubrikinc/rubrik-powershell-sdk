...
{
    #region O365TodoTaskFolder
 
    public class O365TodoTaskFolder: BaseType, O365ExchangeObject
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "O365TodoTaskFolder";
    }

    public O365TodoTaskFolder Set(
    ...
    } // class O365TodoTaskFolder
    
    #endregion

    public static class ListO365TodoTaskFolderExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<O365TodoTaskFolder> list,
        ...
        public static List<string> SelectedFields(this List<O365TodoTaskFolder> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365TodoTaskFolder());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365TodoTaskFolder> list)
        {

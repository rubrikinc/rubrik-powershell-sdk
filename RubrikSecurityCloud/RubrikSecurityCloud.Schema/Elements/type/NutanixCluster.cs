...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class NutanixCluster: IFragment, CdmHierarchyObject, HierarchyObject, NutanixTopLevelDescendantType
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            //      C# -> System.String? NosVersion
            // GraphQL -> nosVersion: String (scalar)
            if (this.NosVersion == null && Exploration.Includes(parent + ".nosVersion$"))
            {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongoSourceDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (MongoSourceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongoSourceDescendantType));
    ...
    public static class ListMongoSourceDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MongoSourceDescendantTypeEdge();
            list.Add(item);

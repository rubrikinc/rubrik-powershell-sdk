...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongoSourceDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MongoSourceDescendantType> Node { get; set; }
    ...
    public MongoSourceDescendantTypeEdge Set(
        RscInterface<MongoSourceDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MongoSourceDescendantType>();

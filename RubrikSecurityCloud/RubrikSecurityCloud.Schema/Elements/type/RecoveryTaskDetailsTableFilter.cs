...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRecoveryTaskDetailsTableFilterExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RecoveryTaskDetailsTableFilter> list)
        {
        ...
        public static void SelectForRetrieval(this List<RecoveryTaskDetailsTableFilter> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVsphereBlueprintChildFailoverInstanceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereBlueprintChildFailoverInstance> list)
        {
        ...
        public static void SelectForRetrieval(this List<VsphereBlueprintChildFailoverInstance> list)
        {

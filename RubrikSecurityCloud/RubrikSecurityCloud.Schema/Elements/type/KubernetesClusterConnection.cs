...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListKubernetesClusterConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<KubernetesClusterConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<KubernetesClusterConnection> list)
        {

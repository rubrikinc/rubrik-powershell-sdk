...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListOracleLiveMountEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleLiveMountEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<OracleLiveMountEdge> list)
        {

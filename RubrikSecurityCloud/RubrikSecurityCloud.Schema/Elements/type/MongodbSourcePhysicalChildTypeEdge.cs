...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbSourcePhysicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MongodbSourcePhysicalChildType> Node { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "MongodbSourcePhysicalChildTypeEdge";
    }

    public MongodbSourcePhysicalChildTypeEdge Set(
        RscInterface<MongodbSourcePhysicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MongodbSourcePhysicalChildType>();
    ...
    public static class ListMongodbSourcePhysicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbSourcePhysicalChildTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongodbSourcePhysicalChildTypeEdge> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongodbSourcePhysicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (MongodbSourcePhysicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbSourcePhysicalChildType));
    ...
    public static class ListMongodbSourcePhysicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MongodbSourcePhysicalChildTypeEdge();
            list.Add(item);

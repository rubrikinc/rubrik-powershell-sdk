...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MssqlAvailabilityGroupLogicalChildTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (MssqlAvailabilityGroupLogicalChildType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MssqlAvailabilityGroupLogicalChildType));
    ...
    public static class ListMssqlAvailabilityGroupLogicalChildTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MssqlAvailabilityGroupLogicalChildTypeEdge();
            list.Add(item);

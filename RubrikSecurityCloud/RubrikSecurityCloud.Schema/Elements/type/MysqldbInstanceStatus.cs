...
{
    #region MysqldbInstanceStatus
    public class MysqldbInstanceStatus: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MysqldbInstanceStatus";
    }

    public MysqldbInstanceStatus Set(
    ...
    } // class MysqldbInstanceStatus
    
    #endregion

    public static class ListMysqldbInstanceStatusExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MysqldbInstanceStatus> list,
        ...
        public static List<string> SelectedFields(this List<MysqldbInstanceStatus> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MysqldbInstanceStatus());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MysqldbInstanceStatus> list)
        {

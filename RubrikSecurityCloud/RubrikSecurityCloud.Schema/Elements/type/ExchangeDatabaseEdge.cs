...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListExchangeDatabaseEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ExchangeDatabaseEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<ExchangeDatabaseEdge> list)
        {

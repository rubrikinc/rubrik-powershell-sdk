...
namespace RubrikSecurityCloud.Types
{
    ...
    public class FailoverClusterApp: BaseType, CdmHierarchyObject, FailoverClusterTopLevelDescendantType, HierarchyObject, HostFailoverClusterDescendantType, HostFailoverClusterPhysicalChildType
    {
        #region members
        ...
        //      C# -> System.String? FailoverClusterType
        // GraphQL -> failoverClusterType: String (scalar)
        [JsonProperty("failoverClusterType")]
        public System.String? FailoverClusterType { get; set; }
        ...
        //      C# -> FailoverClusterAppDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: FailoverClusterAppDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public FailoverClusterAppDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        [JsonProperty("hostFailoverCluster")]
        public HostFailoverCluster? HostFailoverCluster { get; set; }
        ...
        //      C# -> FailoverClusterAppPhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: FailoverClusterAppPhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public FailoverClusterAppPhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public FailoverClusterApp()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FailoverClusterApp";
    }

    public FailoverClusterApp Set(
        ...
        System.String? FailoverClusterType = null,
        ...
        FailoverClusterAppDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        HostFailoverCluster? HostFailoverCluster = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        FailoverClusterAppPhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( HostFailoverCluster != null ) {
            this.HostFailoverCluster = HostFailoverCluster;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> HostFailoverCluster? HostFailoverCluster
        // GraphQL -> hostFailoverCluster: HostFailoverCluster! (type)
        if (this.HostFailoverCluster != null) {
            var fspec = this.HostFailoverCluster.AsFieldSpec(conf.Child("hostFailoverCluster"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("failoverClusterType",true))
        {
            if(this.FailoverClusterType == null) {
                ...
                this.FailoverClusterType = "FETCH";
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new FailoverClusterAppDescendantTypeConnection();
        ...
        //      C# -> HostFailoverCluster? HostFailoverCluster
        // GraphQL -> hostFailoverCluster: HostFailoverCluster! (type)
        if (ec.Includes("hostFailoverCluster",false))
        {
            if(this.HostFailoverCluster == null) {

                this.HostFailoverCluster = new HostFailoverCluster();
                this.HostFailoverCluster.ApplyExploratoryFieldSpec(ec.NewChild("hostFailoverCluster"));
        ...
        else if (this.HostFailoverCluster != null && ec.Excludes("hostFailoverCluster",false))
        {
            this.HostFailoverCluster = null;
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new FailoverClusterAppPhysicalChildTypeConnection();
    ...
    } // class FailoverClusterApp
    
    #endregion

    public static class ListFailoverClusterAppExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FailoverClusterApp> list,
        ...
        public static List<string> SelectedFields(this List<FailoverClusterApp> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FailoverClusterApp());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FailoverClusterApp> list)
        {

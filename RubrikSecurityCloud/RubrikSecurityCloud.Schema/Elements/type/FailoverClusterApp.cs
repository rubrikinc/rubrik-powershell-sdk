...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> HostFailoverCluster? HostFailoverCluster
        // GraphQL -> hostFailoverCluster: HostFailoverCluster! (type)
        if (this.HostFailoverCluster == null && Exploration.Includes(parent + ".hostFailoverCluster"))
        {
            this.HostFailoverCluster = new HostFailoverCluster();
            this.HostFailoverCluster.ApplyExploratoryFieldSpec(parent + ".hostFailoverCluster");
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)

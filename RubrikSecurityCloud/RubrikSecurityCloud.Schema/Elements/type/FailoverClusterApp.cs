...
namespace Rubrik.SecurityCloud.Types
{
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.HostFailoverCluster != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.HostFailoverCluster.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            if (this.HostFailoverCluster == null && Exploration.Includes(parent + ".hostFailoverCluster"))
            {
                ...
                this.HostFailoverCluster.ApplyExploratoryFragment(parent + ".hostFailoverCluster");
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
    ...
    public static class ListFailoverClusterAppExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new FailoverClusterApp();
            list.Add(item);

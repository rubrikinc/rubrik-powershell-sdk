// AddPostgreSqlDbClusterReply.cs
//
...
{
    #region AddPostgreSqlDbClusterReply
    public class AddPostgreSqlDbClusterReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AddPostgreSqlDbClusterReply";
    }

    public AddPostgreSqlDbClusterReply Set(
    ...
    } // class AddPostgreSqlDbClusterReply
    
    #endregion

    public static class ListAddPostgreSqlDbClusterReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AddPostgreSqlDbClusterReply> list,
        ...
        public static List<string> SelectedFields(this List<AddPostgreSqlDbClusterReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AddPostgreSqlDbClusterReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AddPostgreSqlDbClusterReply> list)
        {

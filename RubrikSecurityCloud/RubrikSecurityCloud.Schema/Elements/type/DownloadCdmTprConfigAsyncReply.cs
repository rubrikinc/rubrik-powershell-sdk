// DownloadCdmTprConfigAsyncReply.cs
//
...
{
    #region DownloadCdmTprConfigAsyncReply
    public class DownloadCdmTprConfigAsyncReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "DownloadCdmTprConfigAsyncReply";
    }

    public DownloadCdmTprConfigAsyncReply Set(
    ...
    } // class DownloadCdmTprConfigAsyncReply
    
    #endregion

    public static class ListDownloadCdmTprConfigAsyncReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DownloadCdmTprConfigAsyncReply> list,
        ...
        public static List<string> SelectedFields(this List<DownloadCdmTprConfigAsyncReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DownloadCdmTprConfigAsyncReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DownloadCdmTprConfigAsyncReply> list)
        {

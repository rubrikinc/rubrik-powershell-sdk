// M365BackupStorageSetupKickoffReply.cs
//
...
{
    #region M365BackupStorageSetupKickoffReply
    public class M365BackupStorageSetupKickoffReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "M365BackupStorageSetupKickoffReply";
    }

    public M365BackupStorageSetupKickoffReply Set(
    ...
    } // class M365BackupStorageSetupKickoffReply
    
    #endregion

    public static class ListM365BackupStorageSetupKickoffReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<M365BackupStorageSetupKickoffReply> list,
        ...
        public static List<string> SelectedFields(this List<M365BackupStorageSetupKickoffReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new M365BackupStorageSetupKickoffReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<M365BackupStorageSetupKickoffReply> list)
        {

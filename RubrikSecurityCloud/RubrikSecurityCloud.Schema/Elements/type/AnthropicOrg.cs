...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AnthropicOrg: BaseType, HierarchyObject, PolarisHierarchyObject, SaasAppsOrganization
    {
        #region members
    ...
    public static class ListAnthropicOrgExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AnthropicOrg> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AnthropicOrg());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AnthropicOrg> list)
        {

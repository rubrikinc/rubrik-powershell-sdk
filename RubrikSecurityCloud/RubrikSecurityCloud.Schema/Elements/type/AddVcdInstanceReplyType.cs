...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "AddVcdInstanceReplyType";
    }
    ...
    public static class ListAddVcdInstanceReplyTypeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddVcdInstanceReplyType> list)
        {
        ...
        public static void SelectForRetrieval(this List<AddVcdInstanceReplyType> list)
        {

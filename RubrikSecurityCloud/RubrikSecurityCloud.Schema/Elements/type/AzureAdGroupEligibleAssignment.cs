// AzureAdGroupEligibleAssignment.cs
//
...
{
    #region AzureAdGroupEligibleAssignment
    public class AzureAdGroupEligibleAssignment: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureAdGroupEligibleAssignment";
    }

    public AzureAdGroupEligibleAssignment Set(
    ...
    } // class AzureAdGroupEligibleAssignment
    
    #endregion

    public static class ListAzureAdGroupEligibleAssignmentExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureAdGroupEligibleAssignment> list,
        ...
        public static List<string> SelectedFields(this List<AzureAdGroupEligibleAssignment> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureAdGroupEligibleAssignment());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureAdGroupEligibleAssignment> list)
        {

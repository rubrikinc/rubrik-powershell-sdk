...
namespace RubrikSecurityCloud.Types
{
    ...
    public class WorkloadLocation: BaseType, SnappableLocationType
    {
        #region members
    ...
    public static class ListWorkloadLocationExtensions
    {
        ...
        public static List<string> SelectedFields(this List<WorkloadLocation> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new WorkloadLocation());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<WorkloadLocation> list)
        {

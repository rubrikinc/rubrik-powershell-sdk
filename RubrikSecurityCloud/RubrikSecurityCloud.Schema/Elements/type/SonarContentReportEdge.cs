...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SonarContentReportEdge: BaseType
    {
        #region members
    ...
    public static class ListSonarContentReportEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SonarContentReportEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SonarContentReportEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SonarContentReportEdge> list)
        {

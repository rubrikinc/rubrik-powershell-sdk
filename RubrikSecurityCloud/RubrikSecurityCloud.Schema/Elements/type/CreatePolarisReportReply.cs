...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreatePolarisReportReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreatePolarisReportReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreatePolarisReportReply> list)
        {

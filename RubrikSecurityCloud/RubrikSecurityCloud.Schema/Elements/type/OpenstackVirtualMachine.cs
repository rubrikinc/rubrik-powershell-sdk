...
{
    #region OpenstackVirtualMachine
 
    public class OpenstackVirtualMachine: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, OpenstackAvailabilityZoneDescendantType, OpenstackAvailabilityZonePhysicalChildType, OpenstackDomainDescendantType, OpenstackDomainLogicalChildType, OpenstackEnvironmentDescendantType, OpenstackEnvironmentLogicalChildType, OpenstackEnvironmentPhysicalChildType, OpenstackHostDescendantType, OpenstackHostPhysicalChildType, OpenstackProjectDescendantType, OpenstackProjectLogicalChildType, OpenstackRegionDescendantType, OpenstackRegionPhysicalChildType, OpenstackTagDescendantType, OpenstackTagLogicalChildType
    {
        #region members
        ...
        //      C# -> System.String? FlavorName
        // GraphQL -> flavorName: String! (scalar)
        [JsonProperty("flavorName")]
        public System.String? FlavorName { get; set; }
        ...
        //      C# -> System.String? ImageName
        // GraphQL -> imageName: String! (scalar)
        ...
        //      C# -> System.String? SnapshotConsistencyMandate
        // GraphQL -> snapshotConsistencyMandate: String (scalar)
        [JsonProperty("snapshotConsistencyMandate")]
        public System.String? SnapshotConsistencyMandate { get; set; }

        //      C# -> OpenstackVmAgentStatus? AgentStatus
        // GraphQL -> agentStatus: OpenstackVmAgentStatus (type)
        [JsonProperty("agentStatus")]
        public OpenstackVmAgentStatus? AgentStatus { get; set; }
        ...
        //      C# -> List<OpenstackNetworkTags>? NetworkTags
        // GraphQL -> networkTags: [OpenstackNetworkTags!]! (type)
        [JsonProperty("networkTags")]
        public List<OpenstackNetworkTags>? NetworkTags { get; set; }
    ...
    public OpenstackVirtualMachine()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "OpenstackVirtualMachine";
    }

    public OpenstackVirtualMachine Set(
        ...
        System.String? FlavorName = null,
        System.String? Id = null,
        System.String? ImageName = null,
        ...
        System.String? SnapshotConsistencyMandate = null,
        OpenstackVmAgentStatus? AgentStatus = null,
        ...
        List<OpenstackNetworkTags>? NetworkTags = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.NetworkTags != null) {
            var fspec = this.NetworkTags.AsFieldSpec(conf.Child("networkTags"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? FlavorName
        // GraphQL -> flavorName: String! (scalar)
        if (ec.Includes("flavorName",true))
        {
            if(this.FlavorName == null) {

                this.FlavorName = "FETCH";
        ...
        else if (this.FlavorName != null && ec.Excludes("flavorName",true))
        {
        ...
        //      C# -> System.String? ImageName
        // GraphQL -> imageName: String! (scalar)
        if (ec.Includes("imageName",true))
        {
            if(this.ImageName == null) {

                this.ImageName = "FETCH";
        ...
        else if (this.ImageName != null && ec.Excludes("imageName",true))
        {
            this.ImageName = null;
        }
        //      C# -> System.Boolean? IsRelic
        ...
        if (ec.Includes("snapshotConsistencyMandate",true))
        {
            if(this.SnapshotConsistencyMandate == null) {
                ...
                this.SnapshotConsistencyMandate = "FETCH";
        ...
        if (ec.Includes("agentStatus",false))
        {
            if(this.AgentStatus == null) {
                ...
                this.AgentStatus = new OpenstackVmAgentStatus();
        ...
        //      C# -> List<OpenstackNetworkTags>? NetworkTags
        // GraphQL -> networkTags: [OpenstackNetworkTags!]! (type)
        if (ec.Includes("networkTags",false))
        {
            if(this.NetworkTags == null) {

                this.NetworkTags = new List<OpenstackNetworkTags>();
                this.NetworkTags.ApplyExploratoryFieldSpec(ec.NewChild("networkTags"));
        ...
        else if (this.NetworkTags != null && ec.Excludes("networkTags",false))
        {
    ...
    } // class OpenstackVirtualMachine
    
    #endregion

    public static class ListOpenstackVirtualMachineExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OpenstackVirtualMachine> list,
        ...
        public static List<string> SelectedFields(this List<OpenstackVirtualMachine> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OpenstackVirtualMachine());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OpenstackVirtualMachine> list)
        {

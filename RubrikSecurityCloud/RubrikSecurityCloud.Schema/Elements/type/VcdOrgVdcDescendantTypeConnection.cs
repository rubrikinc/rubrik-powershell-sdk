...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdOrgVdcDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<VcdOrgVdcDescendantType> Nodes { get; set; }
    ...
    public VcdOrgVdcDescendantTypeConnection Set(
        RscInterface<VcdOrgVdcDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<VcdOrgVdcDescendantType>();

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdOrgVdcDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VcdOrgVdcDescendantType> Nodes { get; set; }
    ...
    public VcdOrgVdcDescendantTypeConnection Set(
        RscInterfaceList<VcdOrgVdcDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VcdOrgVdcDescendantType>();
    ...
    public static class ListVcdOrgVdcDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdOrgVdcDescendantTypeConnection> list)
        {

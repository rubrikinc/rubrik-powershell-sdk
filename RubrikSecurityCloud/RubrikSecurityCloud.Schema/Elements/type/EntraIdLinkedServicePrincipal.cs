// EntraIdLinkedServicePrincipal.cs
//
...
{
    #region EntraIdLinkedServicePrincipal
    public class EntraIdLinkedServicePrincipal: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "EntraIdLinkedServicePrincipal";
    }

    public EntraIdLinkedServicePrincipal Set(
    ...
    } // class EntraIdLinkedServicePrincipal
    
    #endregion

    public static class ListEntraIdLinkedServicePrincipalExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<EntraIdLinkedServicePrincipal> list,
        ...
        public static List<string> SelectedFields(this List<EntraIdLinkedServicePrincipal> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new EntraIdLinkedServicePrincipal());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<EntraIdLinkedServicePrincipal> list)
        {

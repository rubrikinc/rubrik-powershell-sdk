...
{
    #region IssueEdge
    public class IssueEdge: BaseType
    {
        #region members
    ...
    public static class ListIssueEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<IssueEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<IssueEdge> list)
        {

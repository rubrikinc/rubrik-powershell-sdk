// CloudNativeTagRuleHierarchy.cs
//
...
{
    #region CloudNativeTagRuleHierarchy
 
    public class CloudNativeTagRuleHierarchy: BaseType, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public CloudNativeTagRuleHierarchy()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "CloudNativeTagRuleHierarchy";
    }

    public CloudNativeTagRuleHierarchy Set(
    ...
    } // class CloudNativeTagRuleHierarchy
    
    #endregion

    public static class ListCloudNativeTagRuleHierarchyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CloudNativeTagRuleHierarchy> list,
        ...
        public static List<string> SelectedFields(this List<CloudNativeTagRuleHierarchy> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudNativeTagRuleHierarchy());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudNativeTagRuleHierarchy> list)
        {

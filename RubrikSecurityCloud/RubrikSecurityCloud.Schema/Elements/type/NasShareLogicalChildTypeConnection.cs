...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasShareLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NasShareLogicalChildType> Nodes { get; set; }
    ...
    public NasShareLogicalChildTypeConnection Set(
        RscInterfaceList<NasShareLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NasShareLogicalChildType>();

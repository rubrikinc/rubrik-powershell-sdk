...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasShareLogicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NasShareLogicalChildType> Nodes { get; set; }
    ...
    public NasShareLogicalChildTypeConnection Set(
        RscInterface<NasShareLogicalChildType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NasShareLogicalChildType>();

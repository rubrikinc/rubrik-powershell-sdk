// OracleRecoverableRangeListResponse.cs
//
...
{
    #region OracleRecoverableRangeListResponse
    public class OracleRecoverableRangeListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<OracleRecoverableRange>? Data
        // GraphQL -> data: [OracleRecoverableRange!]! (type)
        [JsonProperty("data")]
        public List<OracleRecoverableRange>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "OracleRecoverableRangeListResponse";
    }

    public OracleRecoverableRangeListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int64? Total = null,
        List<OracleRecoverableRange>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<OracleRecoverableRange>();
    ...
    } // class OracleRecoverableRangeListResponse
    
    #endregion

    public static class ListOracleRecoverableRangeListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<OracleRecoverableRangeListResponse> list,
        ...
        public static List<string> SelectedFields(this List<OracleRecoverableRangeListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OracleRecoverableRangeListResponse());
            }

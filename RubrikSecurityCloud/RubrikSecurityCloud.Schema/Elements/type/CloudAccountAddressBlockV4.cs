...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.CidrBlock != null && ec.Excludes("cidrBlock",true))
        {
            this.CidrBlock = null;
        }
    }
    ...
    public static class ListCloudAccountAddressBlockV4Extensions
    {
        ...
        public static List<string> SelectedFields(this List<CloudAccountAddressBlockV4> list)
        {
        ...
        public static void SelectForRetrieval(this List<CloudAccountAddressBlockV4> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ClusterNodeEdge: BaseType
    {
        #region members
    ...
    public static class ListClusterNodeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ClusterNodeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ClusterNodeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ClusterNodeEdge> list)
        {

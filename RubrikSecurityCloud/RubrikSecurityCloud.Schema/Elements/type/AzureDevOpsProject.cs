...
{
    #region AzureDevOpsProject
 
    public class AzureDevOpsProject: BaseType, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public static class ListAzureDevOpsProjectExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureDevOpsProject> list,
        ...
        public static List<string> SelectedFields(this List<AzureDevOpsProject> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureDevOpsProject());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureDevOpsProject> list)
        {

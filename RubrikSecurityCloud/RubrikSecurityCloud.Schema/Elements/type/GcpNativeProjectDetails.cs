...
{
    #region GcpNativeProjectDetails
    public class GcpNativeProjectDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "GcpNativeProjectDetails";
    }

    public GcpNativeProjectDetails Set(
    ...
    } // class GcpNativeProjectDetails
    
    #endregion

    public static class ListGcpNativeProjectDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpNativeProjectDetails> list,
        ...
        public static List<string> SelectedFields(this List<GcpNativeProjectDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpNativeProjectDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpNativeProjectDetails> list)
        {

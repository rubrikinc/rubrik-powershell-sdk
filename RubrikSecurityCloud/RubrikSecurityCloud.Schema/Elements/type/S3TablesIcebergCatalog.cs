...
{
    #region S3TablesIcebergCatalog
 
    public class S3TablesIcebergCatalog: BaseType, AwsNativeAccountDescendantType, AwsNativeAccountLogicalChildType, AwsNativeHierarchyObject, HierarchyObject, PolarisHierarchyObject
    {
        #region members
    ...
    public S3TablesIcebergCatalog()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "S3TablesIcebergCatalog";
    }

    public S3TablesIcebergCatalog Set(
    ...
    } // class S3TablesIcebergCatalog
    
    #endregion

    public static class ListS3TablesIcebergCatalogExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<S3TablesIcebergCatalog> list,
        ...
        public static List<string> SelectedFields(this List<S3TablesIcebergCatalog> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new S3TablesIcebergCatalog());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<S3TablesIcebergCatalog> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasNamespace: BaseType, CdmHierarchyObject, HierarchyObject, NasSystemDescendantType, NasSystemLogicalChildType
    {
        #region members
        ...
        //      C# -> NasNamespaceDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: NasNamespaceDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public NasNamespaceDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> NasNamespaceLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: NasNamespaceLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public NasNamespaceLogicalChildTypeConnection? LogicalChildConnection { get; set; }
    ...
    public NasNamespace Set(
        ...
        NasNamespaceDescendantTypeConnection? DescendantConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespace_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespace_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespace_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespace_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "NasNamespace_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new NasNamespaceDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new NasNamespaceLogicalChildTypeConnection();
    ...
    public static class ListNasNamespaceExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasNamespace> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new NasNamespace());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<NasNamespace> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "UserActivityResultConnection";
    }
    ...
    public static class ListUserActivityResultConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserActivityResultConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<UserActivityResultConnection> list)
        {

...
{
    #region MicrosoftPurviewConfig
    public class MicrosoftPurviewConfig: BaseType
    {
        #region members
    ...
    } // class MicrosoftPurviewConfig
    
    #endregion

    public static class ListMicrosoftPurviewConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MicrosoftPurviewConfig> list,
        ...
        public static List<string> SelectedFields(this List<MicrosoftPurviewConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MicrosoftPurviewConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MicrosoftPurviewConfig> list)
        {

// QuiesceCandidateListResponse.cs
//
...
{
    #region QuiesceCandidateListResponse
    public class QuiesceCandidateListResponse: BaseType
    {
        #region members
        ...
        //      C# -> List<QuiesceCandidate>? Data
        // GraphQL -> data: [QuiesceCandidate!]! (type)
        [JsonProperty("data")]
        public List<QuiesceCandidate>? Data { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "QuiesceCandidateListResponse";
    }

    public QuiesceCandidateListResponse Set(
        System.Boolean? HasMore = null,
        System.String? NextCursor = null,
        System.Int32? Total = null,
        List<QuiesceCandidate>? Data = null
    ) 
    {
        if ( HasMore != null ) {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("data",false))
        {
            if(this.Data == null) {
                ...
                this.Data = new List<QuiesceCandidate>();
    ...
    } // class QuiesceCandidateListResponse
    
    #endregion

    public static class ListQuiesceCandidateListResponseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<QuiesceCandidateListResponse> list,
        ...
        public static List<string> SelectedFields(this List<QuiesceCandidateListResponse> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new QuiesceCandidateListResponse());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<QuiesceCandidateListResponse> list)
        {

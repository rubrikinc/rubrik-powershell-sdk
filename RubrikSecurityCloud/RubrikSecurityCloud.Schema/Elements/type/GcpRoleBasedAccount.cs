...
{
    #region GcpRoleBasedAccount
 
    public class GcpRoleBasedAccount: BaseType, CloudAccount
    {
        #region members
        ...
        //      C# -> GcpCloudAccountGetProjectReply? Project
        // GraphQL -> project: GcpCloudAccountGetProjectReply! (type)
        [JsonProperty("project")]
        public GcpCloudAccountGetProjectReply? Project { get; set; }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("project",false))
        {
            if(this.Project == null) {
                ...
                this.Project = new GcpCloudAccountGetProjectReply();
    ...
    } // class GcpRoleBasedAccount
    
    #endregion

    public static class ListGcpRoleBasedAccountExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<GcpRoleBasedAccount> list,
        ...
        public static List<string> SelectedFields(this List<GcpRoleBasedAccount> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new GcpRoleBasedAccount());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<GcpRoleBasedAccount> list)
        {

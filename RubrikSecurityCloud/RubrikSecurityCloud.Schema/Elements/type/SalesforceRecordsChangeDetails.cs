// SalesforceRecordsChangeDetails.cs
//
...
{
    #region SalesforceRecordsChangeDetails
    public class SalesforceRecordsChangeDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "SalesforceRecordsChangeDetails";
    }

    public SalesforceRecordsChangeDetails Set(
    ...
    } // class SalesforceRecordsChangeDetails
    
    #endregion

    public static class ListSalesforceRecordsChangeDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<SalesforceRecordsChangeDetails> list,
        ...
        public static List<string> SelectedFields(this List<SalesforceRecordsChangeDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SalesforceRecordsChangeDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SalesforceRecordsChangeDetails> list)
        {

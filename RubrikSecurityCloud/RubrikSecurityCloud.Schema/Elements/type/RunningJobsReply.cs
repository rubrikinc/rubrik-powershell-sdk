...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.RunningJobs != null) {
            var fspec = this.RunningJobs.AsFieldSpec(conf.Child("runningJobs"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<ClusterMetadata>? RunningJobs
        // GraphQL -> runningJobs: [ClusterMetadata!]! (type)
        if (ec.Includes("runningJobs",false))
        {
            if(this.RunningJobs == null) {
        ...
        else if (this.RunningJobs != null && ec.Excludes("runningJobs",false))
        {
    ...
    public static class ListRunningJobsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RunningJobsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<RunningJobsReply> list)
        {

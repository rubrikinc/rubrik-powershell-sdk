...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "AzureSqlDatabaseServerEdge";
    }
    ...
    public static class ListAzureSqlDatabaseServerEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AzureSqlDatabaseServerEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<AzureSqlDatabaseServerEdge> list)
        {

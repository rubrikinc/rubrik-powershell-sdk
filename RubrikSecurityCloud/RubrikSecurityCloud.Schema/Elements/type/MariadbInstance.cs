...
{
    #region MariadbInstance
 
    public class MariadbInstance: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, KosmosDiscoverableEntityType, KosmosHierarchyObjectType, KosmosParentHierarchyObjectType, KosmosSnappableHierarchyObjectType
    {
        #region members
        ...
        //      C# -> MariadbInstanceAdvancedConfig? AdvancedConfig
        // GraphQL -> advancedConfig: MariadbInstanceAdvancedConfig! (type)
        [JsonProperty("advancedConfig")]
        public MariadbInstanceAdvancedConfig? AdvancedConfig { get; set; }
        ...
        //      C# -> MariadbInstanceMetadata? Metadata
        // GraphQL -> metadata: MariadbInstanceMetadata! (type)
        [JsonProperty("metadata")]
        public MariadbInstanceMetadata? Metadata { get; set; }
        ...
        //      C# -> MariadbInstanceStatus? Status
        // GraphQL -> status: MariadbInstanceStatus! (type)
        [JsonProperty("status")]
        public MariadbInstanceStatus? Status { get; set; }

        //      C# -> MariadbInstanceDetails? UserDetails
        // GraphQL -> userDetails: MariadbInstanceDetails! (type)
        [JsonProperty("userDetails")]
        public MariadbInstanceDetails? UserDetails { get; set; }
    ...
    public MariadbInstance Set(
        ...
        MariadbInstanceAdvancedConfig? AdvancedConfig = null,
        ...
        MariadbInstanceMetadata? Metadata = null,
        ...
        MariadbInstanceStatus? Status = null,
        MariadbInstanceDetails? UserDetails = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("advancedConfig",false))
        {
            if(this.AdvancedConfig == null) {
                ...
                this.AdvancedConfig = new MariadbInstanceAdvancedConfig();
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new MariadbInstanceMetadata();
        ...
        if (ec.Includes("status",false))
        {
            if(this.Status == null) {
                ...
                this.Status = new MariadbInstanceStatus();
        ...
        if (ec.Includes("userDetails",false))
        {
            if(this.UserDetails == null) {
                ...
                this.UserDetails = new MariadbInstanceDetails();
    ...
    public static class ListMariadbInstanceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MariadbInstance> list,
        ...
        public static List<string> SelectedFields(this List<MariadbInstance> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MariadbInstance());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MariadbInstance> list)
        {

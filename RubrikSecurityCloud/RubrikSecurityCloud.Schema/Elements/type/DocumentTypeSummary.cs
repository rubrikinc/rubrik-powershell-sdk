...
{
    #region DocumentTypeSummary
    public class DocumentTypeSummary: BaseType
    {
        #region members
    ...
    public DocumentTypeSummary Set(
    ...
    public static class ListDocumentTypeSummaryExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DocumentTypeSummary> list,
        ...
        public static List<string> SelectedFields(this List<DocumentTypeSummary> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DocumentTypeSummary());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<DocumentTypeSummary> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCreateVappSnapshotReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateVappSnapshotReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateVappSnapshotReply> list)
        {

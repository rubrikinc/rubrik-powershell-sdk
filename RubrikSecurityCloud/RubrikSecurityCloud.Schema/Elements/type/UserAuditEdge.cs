...
namespace RubrikSecurityCloud.Types
{
    ...
    public class UserAuditEdge: BaseType
    {
        #region members
    ...
    public static class ListUserAuditEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UserAuditEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UserAuditEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UserAuditEdge> list)
        {

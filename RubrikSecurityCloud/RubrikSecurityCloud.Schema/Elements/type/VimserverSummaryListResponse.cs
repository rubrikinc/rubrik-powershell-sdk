...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListVimserverSummaryListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VimserverSummaryListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<VimserverSummaryListResponse> list)
        {

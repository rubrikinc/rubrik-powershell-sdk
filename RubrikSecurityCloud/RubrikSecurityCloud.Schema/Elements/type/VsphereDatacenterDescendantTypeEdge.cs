...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereDatacenterDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<VsphereDatacenterDescendantType> Node { get; set; }
    ...
    public VsphereDatacenterDescendantTypeEdge Set(
        RscInterface<VsphereDatacenterDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<VsphereDatacenterDescendantType>();
    ...
    public static class ListVsphereDatacenterDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereDatacenterDescendantTypeEdge> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class VsphereDatacenterDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (VsphereDatacenterDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(VsphereDatacenterDescendantType));
    ...
    public static class ListVsphereDatacenterDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new VsphereDatacenterDescendantTypeEdge();
            list.Add(item);

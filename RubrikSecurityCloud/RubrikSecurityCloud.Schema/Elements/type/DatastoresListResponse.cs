...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListDatastoresListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<DatastoresListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<DatastoresListResponse> list)
        {

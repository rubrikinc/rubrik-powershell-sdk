...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlAvailabilityGroupDescendantTypeEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "MssqlAvailabilityGroupDescendantTypeEdge";
    }
        ...
        if (this.Node != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "MssqlAvailabilityGroupDescendantTypeEdge_INTERFACE_FIELD_node: node{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Cursor
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                var impls = new List<MssqlAvailabilityGroupDescendantType>();
                impls.ApplyExploratoryFieldSpec(ec.NewChild("node"));
                this.Node = (MssqlAvailabilityGroupDescendantType)InterfaceHelper.MakeCompositeFromList(impls);
    ...
    public static class ListMssqlAvailabilityGroupDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlAvailabilityGroupDescendantTypeEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MssqlAvailabilityGroupDescendantTypeEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MssqlAvailabilityGroupDescendantTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlAvailabilityGroupDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MssqlAvailabilityGroupDescendantType> Node { get; set; }
    ...
    public MssqlAvailabilityGroupDescendantTypeEdge Set(
        RscInterface<MssqlAvailabilityGroupDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MssqlAvailabilityGroupDescendantType>();

...
{
    #region AzureResourceGroupDetails
    public class AzureResourceGroupDetails: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "AzureResourceGroupDetails";
    }

    public AzureResourceGroupDetails Set(
    ...
    } // class AzureResourceGroupDetails
    
    #endregion

    public static class ListAzureResourceGroupDetailsExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<AzureResourceGroupDetails> list,
        ...
        public static List<string> SelectedFields(this List<AzureResourceGroupDetails> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AzureResourceGroupDetails());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AzureResourceGroupDetails> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.VappNetworkSummary != null) {
            var fspec = this.VappNetworkSummary.AsFieldSpec(conf.Child("vappNetworkSummary"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.NewName != null && ec.Excludes("newName",true))
        {
            this.NewName = null;
        }
        //      C# -> VappNetworkSummary? VappNetworkSummary
        // GraphQL -> vappNetworkSummary: VappNetworkSummary (type)
        if (ec.Includes("vappNetworkSummary",false))
        {
            if(this.VappNetworkSummary == null) {
        ...
        else if (this.VappNetworkSummary != null && ec.Excludes("vappNetworkSummary",false))
        {
            this.VappNetworkSummary = null;
        }
    }
    ...
    public static class ListCreateVappNetworkParamsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CreateVappNetworkParams> list)
        {
        ...
        public static void SelectForRetrieval(this List<CreateVappNetworkParams> list)
        {

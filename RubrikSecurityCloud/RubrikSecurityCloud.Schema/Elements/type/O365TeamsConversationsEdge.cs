...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListO365TeamsConversationsEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365TeamsConversationsEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<O365TeamsConversationsEdge> list)
        {

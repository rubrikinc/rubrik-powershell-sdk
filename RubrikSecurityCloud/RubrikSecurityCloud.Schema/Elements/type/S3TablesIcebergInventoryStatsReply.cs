// S3TablesIcebergInventoryStatsReply.cs
//
...
{
    #region S3TablesIcebergInventoryStatsReply
    public class S3TablesIcebergInventoryStatsReply: BaseType
    {
        #region members
        ...
        //      C# -> System.Int32? NamespacesCount
        // GraphQL -> namespacesCount: Int! (scalar)
        [JsonProperty("namespacesCount")]
        public System.Int32? NamespacesCount { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "S3TablesIcebergInventoryStatsReply";
    }

    public S3TablesIcebergInventoryStatsReply Set(
        System.Int32? AwsAccountsCount = null,
        System.Int32? CatalogsCount = null,
        System.Int32? NamespacesCount = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.NamespacesCount != null) {
            if (conf.Flat) {
                s += conf.Prefix + "namespacesCount\n" ;
            } else {
                s += ind + "namespacesCount\n" ;
            }
        }
        //      C# -> System.Int32? TablesProtectedCount
        // GraphQL -> tablesProtectedCount: Int! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.Int32? NamespacesCount
        // GraphQL -> namespacesCount: Int! (scalar)
        if (ec.Includes("namespacesCount",true))
        {
            if(this.NamespacesCount == null) {

                this.NamespacesCount = Int32.MinValue;
        ...
        else if (this.NamespacesCount != null && ec.Excludes("namespacesCount",true))
        {
    ...
    } // class S3TablesIcebergInventoryStatsReply
    
    #endregion

    public static class ListS3TablesIcebergInventoryStatsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<S3TablesIcebergInventoryStatsReply> list,
        ...
        public static List<string> SelectedFields(this List<S3TablesIcebergInventoryStatsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new S3TablesIcebergInventoryStatsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<S3TablesIcebergInventoryStatsReply> list)
        {

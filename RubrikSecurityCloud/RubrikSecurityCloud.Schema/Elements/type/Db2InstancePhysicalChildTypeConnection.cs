// Db2InstancePhysicalChildTypeConnection.cs
//
...
{
    #region Db2InstancePhysicalChildTypeConnection
    public class Db2InstancePhysicalChildTypeConnection: BaseType
    {
        #region members
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<Db2InstancePhysicalChildType> Nodes { get; set; }
        ...
        //      C# -> List<Db2InstancePhysicalChildTypeEdge>? Edges
        // GraphQL -> edges: [Db2InstancePhysicalChildTypeEdge!]! (type)
        [JsonProperty("edges")]
        public List<Db2InstancePhysicalChildTypeEdge>? Edges { get; set; }
    ...
    public Db2InstancePhysicalChildTypeConnection Set(
        RscInterfaceList<Db2InstancePhysicalChildType> Nodes = null,
        System.Int32? Count = null,
        List<Db2InstancePhysicalChildTypeEdge>? Edges = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<Db2InstancePhysicalChildType>();
        ...
        if (ec.Includes("edges",false))
        {
            if(this.Edges == null) {
                ...
                this.Edges = new List<Db2InstancePhysicalChildTypeEdge>();
    ...
    } // class Db2InstancePhysicalChildTypeConnection
    
    #endregion

    public static class ListDb2InstancePhysicalChildTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2InstancePhysicalChildTypeConnection> list)
        {

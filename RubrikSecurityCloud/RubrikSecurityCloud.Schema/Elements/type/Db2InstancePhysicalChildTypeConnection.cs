...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2InstancePhysicalChildTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public List<Db2InstancePhysicalChildType>? Nodes { get; set; }
        ...
        if (this.Nodes != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "Db2InstancePhysicalChildTypeConnection_INTERFACE_FIELD_nodes: nodes{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? Count
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new List<Db2InstancePhysicalChildType>();

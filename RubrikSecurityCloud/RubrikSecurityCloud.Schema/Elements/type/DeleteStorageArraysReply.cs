...
{
    #region DeleteStorageArraysReply
    public class DeleteStorageArraysReply: BaseType
    {
        #region members
    ...
    } // class DeleteStorageArraysReply
    
    #endregion

    public static class ListDeleteStorageArraysReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<DeleteStorageArraysReply> list,
        ...
        public static List<string> SelectedFields(this List<DeleteStorageArraysReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new DeleteStorageArraysReply());
            }

...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.ExchangeServer != null) {
            var fspec = this.ExchangeServer.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? ActiveCopies
        // GraphQL -> activeCopies: Int! (scalar)
        if (this.ActiveCopies == null && ec.Includes("activeCopies",true))
        {
        ...
        //      C# -> System.Int32? TotalCopies
        // GraphQL -> totalCopies: Int! (scalar)
        if (this.TotalCopies == null && ec.Includes("totalCopies",true))
        {
        ...
        //      C# -> ExchangeServer? ExchangeServer
        // GraphQL -> exchangeServer: ExchangeServer! (type)
        if (this.ExchangeServer == null && ec.Includes("exchangeServer",false))
        {

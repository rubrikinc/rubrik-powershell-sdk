...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Int32? ActiveCopies
        // GraphQL -> activeCopies: Int! (scalar)
        if (this.ActiveCopies == null && Exploration.Includes(parent + ".activeCopies", true))
        {
        ...
        //      C# -> System.Int32? TotalCopies
        // GraphQL -> totalCopies: Int! (scalar)
        if (this.TotalCopies == null && Exploration.Includes(parent + ".totalCopies", true))
        {
        ...
        //      C# -> ExchangeServer? ExchangeServer
        // GraphQL -> exchangeServer: ExchangeServer! (type)
        if (this.ExchangeServer == null && Exploration.Includes(parent + ".exchangeServer"))
        {
            this.ExchangeServer = new ExchangeServer();
            this.ExchangeServer.ApplyExploratoryFieldSpec(parent + ".exchangeServer");
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)

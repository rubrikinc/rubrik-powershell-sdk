    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.ExchangeServer != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.ExchangeServer.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Int32? ActiveCopies
            // GraphQL -> activeCopies: Int! (scalar)
            if (this.ActiveCopies == null && Exploration.Includes(parent + ".activeCopies$"))
            {
            ...
            //      C# -> System.Int32? TotalCopies
            // GraphQL -> totalCopies: Int! (scalar)
            if (this.TotalCopies == null && Exploration.Includes(parent + ".totalCopies$"))
            {
            ...
            if (this.ExchangeServer == null && Exploration.Includes(parent + ".exchangeServer"))
            {
                ...
                this.ExchangeServer.ApplyExploratoryFragment(parent + ".exchangeServer");
            }
            //      C# -> LatestUserNote? LatestUserNote
            // GraphQL -> latestUserNote: LatestUserNote (type)

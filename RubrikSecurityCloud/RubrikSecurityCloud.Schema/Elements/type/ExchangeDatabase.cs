...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ExchangeDatabase: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, ExchangeDagDescendantType, ExchangeServerDescendantType, HierarchyObject
    {
        ...
        // GraphQL -> activeCopies: Int! (scalar)
        [JsonProperty("activeCopies")]
        public System.Int32? ActiveCopies { get; set; }
        ...
        //      C# -> System.Int32? TotalCopies
        // GraphQL -> totalCopies: Int! (scalar)
        [JsonProperty("totalCopies")]
        public System.Int32? TotalCopies { get; set; }
    ...
    public ExchangeDatabase Set(
        ...
        System.Int32? ActiveCopies = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDatabase_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDatabase_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDatabase_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDatabase_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "ExchangeDatabase_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.Int32? ActiveCopies
        // GraphQL -> activeCopies: Int! (scalar)
        if (this.ActiveCopies != null) {
            if (conf.Flat) {
                s += conf.Prefix + "activeCopies\n" ;
            } else {
                s += ind + "activeCopies\n" ;
            }
        }
        ...
        //      C# -> ExchangeServer? ExchangeServer
        // GraphQL -> exchangeServer: ExchangeServer! (type)
        if (this.ExchangeServer != null) {
            var fspec = this.ExchangeServer.AsFieldSpec(conf.Child("exchangeServer"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? ActiveCopies
        // GraphQL -> activeCopies: Int! (scalar)
        if (ec.Includes("activeCopies",true))
        {
            if(this.ActiveCopies == null) {

                this.ActiveCopies = Int32.MinValue;
        ...
        else if (this.ActiveCopies != null && ec.Excludes("activeCopies",true))
        {
            this.ActiveCopies = null;
        }
        //      C# -> System.String? CdmId
        // GraphQL -> cdmId: String! (scalar)
        ...
        //      C# -> System.Int32? TotalCopies
        // GraphQL -> totalCopies: Int! (scalar)
        if (ec.Includes("totalCopies",true))
        {
            if(this.TotalCopies == null) {

                this.TotalCopies = Int32.MinValue;
        ...
        else if (this.TotalCopies != null && ec.Excludes("totalCopies",true))
        {
        ...
        //      C# -> ExchangeServer? ExchangeServer
        // GraphQL -> exchangeServer: ExchangeServer! (type)
        if (ec.Includes("exchangeServer",false))
        {
            if(this.ExchangeServer == null) {

                this.ExchangeServer = new ExchangeServer();
                this.ExchangeServer.ApplyExploratoryFieldSpec(ec.NewChild("exchangeServer"));
    ...
    public static class ListExchangeDatabaseExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ExchangeDatabase> list,
        ...
        public static List<string> SelectedFields(this List<ExchangeDatabase> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ExchangeDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ExchangeDatabase> list)
        {

...
{
    #region IrisdbSlaConfig
    public class IrisdbSlaConfig: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "IrisdbSlaConfig";
    }

    public IrisdbSlaConfig Set(
    ...
    } // class IrisdbSlaConfig
    
    #endregion

    public static class ListIrisdbSlaConfigExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<IrisdbSlaConfig> list,
        ...
        public static List<string> SelectedFields(this List<IrisdbSlaConfig> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new IrisdbSlaConfig());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<IrisdbSlaConfig> list)
        {

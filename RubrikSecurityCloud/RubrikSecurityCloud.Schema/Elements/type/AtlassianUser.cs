...
{
    #region AtlassianUser
    public class AtlassianUser: BaseType
    {
        #region members
    ...
    public static class ListAtlassianUserExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AtlassianUser> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new AtlassianUser());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<AtlassianUser> list)
        {

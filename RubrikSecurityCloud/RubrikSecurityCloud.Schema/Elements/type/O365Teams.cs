...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365Teams: BaseType, HierarchyObject, HierarchySnappable, O365OrgDescendant, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> System.Int32? MembersCount
        // GraphQL -> membersCount: Int! (scalar)
        [JsonProperty("membersCount")]
        public System.Int32? MembersCount { get; set; }
        ...
        //      C# -> System.String? TeamName
        // GraphQL -> teamName: String! (scalar)
    ...
    public O365Teams Set(
        ...
        System.Int32? MembersCount = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Teams_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Teams_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365Teams_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? Id
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? MembersCount
        // GraphQL -> membersCount: Int! (scalar)
        if (ec.Includes("membersCount",true))
        {
            if(this.MembersCount == null) {

                this.MembersCount = Int32.MinValue;
        ...
        else if (this.MembersCount != null && ec.Excludes("membersCount",true))
        {
        ...
        else if (this.TeamName != null && ec.Excludes("teamName",true))
        {
            this.TeamName = null;
        }
        //      C# -> List<Org>? AllOrgs
    ...
    public static class ListO365TeamsExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365Teams> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365Teams());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365Teams> list)
        {

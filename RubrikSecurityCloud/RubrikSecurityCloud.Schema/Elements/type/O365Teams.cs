...
namespace RubrikSecurityCloud.Types
{
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Int32? MembersCount
        // GraphQL -> membersCount: Int! (scalar)
        if (this.MembersCount == null && ec.Includes("membersCount",true))
        {
        ...
        //      C# -> System.String? PreferredDataLocation
        // GraphQL -> preferredDataLocation: String! (scalar)
        if (this.PreferredDataLocation == null && ec.Includes("preferredDataLocation",true))
        {
        ...
        //      C# -> System.String? TeamName
        // GraphQL -> teamName: String! (scalar)
        if (this.TeamName == null && ec.Includes("teamName",true))
        {
            this.TeamName = "FETCH";
        }
        //      C# -> List<Org>? AllOrgs

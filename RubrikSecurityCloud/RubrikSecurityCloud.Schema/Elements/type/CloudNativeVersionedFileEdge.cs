...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CloudNativeVersionedFileEdge: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CloudNativeVersionedFileEdge";
    }
    ...
    public static class ListCloudNativeVersionedFileEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CloudNativeVersionedFileEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CloudNativeVersionedFileEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<CloudNativeVersionedFileEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdVapp: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, HierarchySnappable, VcdCatalogDescendantType, VcdCatalogLogicalChildType, VcdDescendantType, VcdOrgDescendantType, VcdOrgVdcDescendantType, VcdOrgVdcLogicalChildType, VcdTopLevelDescendantType
    {
        #region members
        ...
        //      C# -> List<DuplicatedVapp>? DuplicatedVapps
        // GraphQL -> duplicatedVapps: [DuplicatedVapp!]! (type)
        [JsonProperty("duplicatedVapps")]
        public List<DuplicatedVapp>? DuplicatedVapps { get; set; }
        ...
        //      C# -> VcdVappLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: VcdVappLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public VcdVappLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> List<VcdVmInfo>? VcdVms
        // GraphQL -> vcdVms: [VcdVmInfo!]! (type)
        [JsonProperty("vcdVms")]
        public List<VcdVmInfo>? VcdVms { get; set; }
    ...
    public VcdVapp Set(
        ...
        System.Boolean? IsBestEffortSynchronizationEnabled = null,
        ...
        List<DuplicatedVapp>? DuplicatedVapps = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        VcdVappLogicalChildTypeConnection? LogicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( IsBestEffortSynchronizationEnabled != null ) {
        ...
        if ( DuplicatedVapps != null ) {
            this.DuplicatedVapps = DuplicatedVapps;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VcdVapp_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VcdVapp_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VcdVapp_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? PendingSla
        ...
        if (this.PendingSla != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VcdVapp_INTERFACE_FIELD_pendingSla: pendingSla{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> List<CdmHierarchyObject>? ReplicatedObjects
        ...
        if (this.ReplicatedObjects != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "VcdVapp_INTERFACE_FIELD_replicatedObjects: replicatedObjects{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? CdmId
        ...
        //      C# -> System.Boolean? IsBestEffortSynchronizationEnabled
        // GraphQL -> isBestEffortSynchronizationEnabled: Boolean! (scalar)
        if (this.IsBestEffortSynchronizationEnabled != null) {
            if (conf.Flat) {
                s += conf.Prefix + "isBestEffortSynchronizationEnabled\n" ;
            } else {
                s += ind + "isBestEffortSynchronizationEnabled\n" ;
            }
        }
        //      C# -> System.Boolean? IsRelic
        // GraphQL -> isRelic: Boolean! (scalar)
        ...
        //      C# -> List<DuplicatedVapp>? DuplicatedVapps
        // GraphQL -> duplicatedVapps: [DuplicatedVapp!]! (type)
        if (this.DuplicatedVapps != null) {
            var fspec = this.DuplicatedVapps.AsFieldSpec(conf.Child("duplicatedVapps"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
        ...
        // GraphQL -> vcdVms: [VcdVmInfo!]! (type)
        if (this.VcdVms != null) {
            var fspec = this.VcdVms.AsFieldSpec(conf.Child("vcdVms"));
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
                } else {
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.Boolean? IsBestEffortSynchronizationEnabled
        // GraphQL -> isBestEffortSynchronizationEnabled: Boolean! (scalar)
        if (ec.Includes("isBestEffortSynchronizationEnabled",true))
        {
            if(this.IsBestEffortSynchronizationEnabled == null) {

                this.IsBestEffortSynchronizationEnabled = true;
        ...
        else if (this.IsBestEffortSynchronizationEnabled != null && ec.Excludes("isBestEffortSynchronizationEnabled",true))
        {
        ...
        //      C# -> List<DuplicatedVapp>? DuplicatedVapps
        // GraphQL -> duplicatedVapps: [DuplicatedVapp!]! (type)
        if (ec.Includes("duplicatedVapps",false))
        {
            if(this.DuplicatedVapps == null) {

                this.DuplicatedVapps = new List<DuplicatedVapp>();
                this.DuplicatedVapps.ApplyExploratoryFieldSpec(ec.NewChild("duplicatedVapps"));
        ...
        else if (this.DuplicatedVapps != null && ec.Excludes("duplicatedVapps",false))
        {
            this.DuplicatedVapps = null;
        }
        //      C# -> PathNode? EffectiveSlaSourceObject
        // GraphQL -> effectiveSlaSourceObject: PathNode (type)
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new VcdVappLogicalChildTypeConnection();
        ...
        //      C# -> List<VcdVmInfo>? VcdVms
        // GraphQL -> vcdVms: [VcdVmInfo!]! (type)
        if (ec.Includes("vcdVms",false))
        {
            if(this.VcdVms == null) {

                this.VcdVms = new List<VcdVmInfo>();
                this.VcdVms.ApplyExploratoryFieldSpec(ec.NewChild("vcdVms"));
        ...
        else if (this.VcdVms != null && ec.Excludes("vcdVms",false))
        {
            this.VcdVms = null;
        }
    }
    ...
    public static class ListVcdVappExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdVapp> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VcdVapp());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VcdVapp> list)
        {

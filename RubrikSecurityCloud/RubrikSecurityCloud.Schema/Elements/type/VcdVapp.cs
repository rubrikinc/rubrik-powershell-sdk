...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.DuplicatedVapps != null) {
            var fspec = this.DuplicatedVapps.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
        ...
        // GraphQL -> vcdVms: [VcdVmInfo!]! (type)
        if (this.VcdVms != null) {
            var fspec = this.VcdVms.AsFieldSpec(indent+1);
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                s += ind + "vcdVms {\n" + fspec + ind + "}\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> System.Boolean? IsBestEffortSynchronizationEnabled
        // GraphQL -> isBestEffortSynchronizationEnabled: Boolean! (scalar)
        if (this.IsBestEffortSynchronizationEnabled == null && Exploration.Includes(parent + ".isBestEffortSynchronizationEnabled", true))
        {
        ...
        //      C# -> System.Boolean? IsTemplate
        // GraphQL -> isTemplate: Boolean! (scalar)
        if (this.IsTemplate == null && Exploration.Includes(parent + ".isTemplate", true))
        {
        ...
        //      C# -> List<DuplicatedVapp>? DuplicatedVapps
        // GraphQL -> duplicatedVapps: [DuplicatedVapp!]! (type)
        if (this.DuplicatedVapps == null && Exploration.Includes(parent + ".duplicatedVapps"))
        {
            this.DuplicatedVapps = new List<DuplicatedVapp>();
            this.DuplicatedVapps.ApplyExploratoryFieldSpec(parent + ".duplicatedVapps");
        }
        //      C# -> PathNode? EffectiveSlaSourceObject
        // GraphQL -> effectiveSlaSourceObject: PathNode (type)
        ...
        //      C# -> List<VcdVmInfo>? VcdVms
        // GraphQL -> vcdVms: [VcdVmInfo!]! (type)
        if (this.VcdVms == null && Exploration.Includes(parent + ".vcdVms"))
        {
            this.VcdVms = new List<VcdVmInfo>();
            this.VcdVms.ApplyExploratoryFieldSpec(parent + ".vcdVms");
        }
    }

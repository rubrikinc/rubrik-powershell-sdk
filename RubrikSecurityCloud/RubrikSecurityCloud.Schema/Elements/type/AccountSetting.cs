...
// Generated on 2023-04-13 20:03:00.
...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AccountSetting: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Boolean? IsEmailNotificationEnabled
            // GraphQL -> isEmailNotificationEnabled: Boolean (scalar)
            if (this.IsEmailNotificationEnabled == null && Exploration.Includes(parent + ".isEmailNotificationEnabled$"))
            {
                this.IsEmailNotificationEnabled = new System.Boolean();
            }
            //      C# -> System.Boolean? IsEulaAccepted
            // GraphQL -> isEulaAccepted: Boolean (scalar)
            if (this.IsEulaAccepted == null && Exploration.Includes(parent + ".isEulaAccepted$"))
            {
                this.IsEulaAccepted = new System.Boolean();
            }
        }

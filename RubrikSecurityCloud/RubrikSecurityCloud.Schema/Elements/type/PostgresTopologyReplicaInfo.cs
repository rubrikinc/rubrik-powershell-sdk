// PostgresTopologyReplicaInfo.cs
//
...
{
    #region PostgresTopologyReplicaInfo
    public class PostgresTopologyReplicaInfo: BaseType
    {
        #region members
        ...
        public System.String? PostgresVersion { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "PostgresTopologyReplicaInfo";
    }

    public PostgresTopologyReplicaInfo Set(
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.PostgresVersion != null) {
            if (conf.Flat) {
                s += conf.Prefix + "postgresVersion\n" ;
            } else {
                s += ind + "postgresVersion\n" ;
            }
        }
        //      C# -> System.String? ReplicaId
        // GraphQL -> replicaId: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? PostgresVersion
        // GraphQL -> postgresVersion: String (scalar)
        if (ec.Includes("postgresVersion",true))
        {
            if(this.PostgresVersion == null) {

                this.PostgresVersion = "FETCH";
        ...
        else if (this.PostgresVersion != null && ec.Excludes("postgresVersion",true))
        {
    ...
    } // class PostgresTopologyReplicaInfo
    
    #endregion

    public static class ListPostgresTopologyReplicaInfoExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PostgresTopologyReplicaInfo> list,
        ...
        public static List<string> SelectedFields(this List<PostgresTopologyReplicaInfo> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PostgresTopologyReplicaInfo());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PostgresTopologyReplicaInfo> list)
        {

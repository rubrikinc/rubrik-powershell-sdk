...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "PrincipalObjectSummaryEdge";
    }
    ...
    public static class ListPrincipalObjectSummaryEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PrincipalObjectSummaryEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<PrincipalObjectSummaryEdge> list)
        {

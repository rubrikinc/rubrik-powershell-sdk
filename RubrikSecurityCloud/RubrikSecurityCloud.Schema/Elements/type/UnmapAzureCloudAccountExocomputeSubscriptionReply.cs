...
namespace RubrikSecurityCloud.Types
{
    ...
    public class UnmapAzureCloudAccountExocomputeSubscriptionReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UnmapAzureCloudAccountExocomputeSubscriptionReply";
    }
    ...
    public static class ListUnmapAzureCloudAccountExocomputeSubscriptionReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UnmapAzureCloudAccountExocomputeSubscriptionReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UnmapAzureCloudAccountExocomputeSubscriptionReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UnmapAzureCloudAccountExocomputeSubscriptionReply> list)
        {

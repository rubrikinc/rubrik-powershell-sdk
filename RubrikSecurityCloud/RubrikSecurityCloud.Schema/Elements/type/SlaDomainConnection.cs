...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SlaDomainConnection: BaseType
    {
        #region members
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<SlaDomain> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "SlaDomainConnection";
    }

    public SlaDomainConnection Set(
        RscInterfaceList<SlaDomain> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<SlaDomain>();
    ...
    public static class ListSlaDomainConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SlaDomainConnection> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SlaDomainConnection());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SlaDomainConnection> list)
        {

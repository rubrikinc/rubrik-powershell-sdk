...
{
    #region ReplaceClusterNodeReply
    public class ReplaceClusterNodeReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ReplaceClusterNodeReply";
    }

    public ReplaceClusterNodeReply Set(
    ...
    } // class ReplaceClusterNodeReply
    
    #endregion

    public static class ListReplaceClusterNodeReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ReplaceClusterNodeReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<ReplaceClusterNodeReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbCollectionEdge: BaseType
    {
        #region members
    ...
    public static class ListMongodbCollectionEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbCollectionEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MongodbCollectionEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MongodbCollectionEdge> list)
        {

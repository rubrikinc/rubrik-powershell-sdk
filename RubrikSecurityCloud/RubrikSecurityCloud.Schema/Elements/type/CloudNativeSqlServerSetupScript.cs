...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class CloudNativeSqlServerSetupScript: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.String? Script
            // GraphQL -> script: String! (scalar)
            if (this.Script == null && Exploration.Includes(parent + ".script$"))
            {
    ...
    public static class ListCloudNativeSqlServerSetupScriptExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new CloudNativeSqlServerSetupScript();
            list.Add(item);

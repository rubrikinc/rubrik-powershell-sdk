...
namespace RubrikSecurityCloud.Types
{
    ...
    public class M365BackupStorageGroup: BaseType, HierarchyObject, MicrosoftGroup, PolarisHierarchyObject
    {
        ...
        public O365GroupSubType? GroupSubType { get; set; }
    ...
    public M365BackupStorageGroup()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "M365BackupStorageGroup";
    }

    public M365BackupStorageGroup Set(
        List<Operation>? AuthorizedOperations = null,
        O365GroupSubType? GroupSubType = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> O365GroupSubType? GroupSubType
        // GraphQL -> groupSubType: O365GroupSubType! (enum)
        if (this.GroupSubType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "groupSubType\n" ;
            } else {
                s += ind + "groupSubType\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> O365GroupSubType? GroupSubType
        // GraphQL -> groupSubType: O365GroupSubType! (enum)
        if (ec.Includes("groupSubType",true))
        {
            if(this.GroupSubType == null) {

                this.GroupSubType = new O365GroupSubType();
        ...
        else if (this.GroupSubType != null && ec.Excludes("groupSubType",true))
        {
    ...
    } // class M365BackupStorageGroup
    
    #endregion

    public static class ListM365BackupStorageGroupExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<M365BackupStorageGroup> list,
        ...
        public static List<string> SelectedFields(this List<M365BackupStorageGroup> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new M365BackupStorageGroup());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<M365BackupStorageGroup> list)
        {

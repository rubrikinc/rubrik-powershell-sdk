...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleHostLogicalChildTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<OracleHostLogicalChildType> Node { get; set; }
    ...
    public OracleHostLogicalChildTypeEdge Set(
        RscInterface<OracleHostLogicalChildType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<OracleHostLogicalChildType>();
    ...
    public static class ListOracleHostLogicalChildTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleHostLogicalChildTypeEdge> list)
        {

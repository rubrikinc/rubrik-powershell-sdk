...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VcdDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<VcdDescendantType> Nodes { get; set; }
    ...
    public override string GetGqlTypeName() {
        return "VcdDescendantTypeConnection";
    }

    public VcdDescendantTypeConnection Set(
        RscInterfaceList<VcdDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<VcdDescendantType>();
    ...
    public static class ListVcdDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdDescendantTypeConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<VcdDescendantTypeConnection> list)
        {

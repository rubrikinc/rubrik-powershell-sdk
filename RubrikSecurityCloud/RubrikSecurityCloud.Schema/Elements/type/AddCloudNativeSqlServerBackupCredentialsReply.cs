...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAddCloudNativeSqlServerBackupCredentialsReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddCloudNativeSqlServerBackupCredentialsReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<AddCloudNativeSqlServerBackupCredentialsReply> list)
        {

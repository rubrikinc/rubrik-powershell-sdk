...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.TimelineDetails != null) {
            var fspec = this.TimelineDetails.AsFieldSpec(conf.Child("timelineDetails"));
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        //      C# -> List<DailyTimelineDetails>? TimelineDetails
        // GraphQL -> timelineDetails: [DailyTimelineDetails!]! (type)
        if (ec.Includes("timelineDetails",false))
        {
            if(this.TimelineDetails == null) {
        ...
        else if (this.TimelineDetails != null && ec.Excludes("timelineDetails",false))
        {
    ...
    public static class ListRansomwareMonitoringTimelineAnalysisExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RansomwareMonitoringTimelineAnalysis> list)
        {
        ...
        public static void SelectForRetrieval(this List<RansomwareMonitoringTimelineAnalysis> list)
        {

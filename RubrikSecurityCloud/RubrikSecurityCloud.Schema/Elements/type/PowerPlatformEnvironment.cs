...
{
    #region PowerPlatformEnvironment
 
    public class PowerPlatformEnvironment: BaseType, HierarchyObject, PolarisHierarchyObject, SaasAppsOrganization
    {
        #region members
    ...
    public PowerPlatformEnvironment()
    {
    ...
    public PowerPlatformEnvironment Set(
    ...
    public static class ListPowerPlatformEnvironmentExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<PowerPlatformEnvironment> list,
        ...
        public static List<string> SelectedFields(this List<PowerPlatformEnvironment> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new PowerPlatformEnvironment());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<PowerPlatformEnvironment> list)
        {

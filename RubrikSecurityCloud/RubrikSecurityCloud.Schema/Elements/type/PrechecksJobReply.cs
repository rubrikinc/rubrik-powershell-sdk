...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListPrechecksJobReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<PrechecksJobReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<PrechecksJobReply> list)
        {

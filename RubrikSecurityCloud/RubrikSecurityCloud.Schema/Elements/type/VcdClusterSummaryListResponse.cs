...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "VcdClusterSummaryListResponse";
    }
    ...
    public static class ListVcdClusterSummaryListResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VcdClusterSummaryListResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<VcdClusterSummaryListResponse> list)
        {

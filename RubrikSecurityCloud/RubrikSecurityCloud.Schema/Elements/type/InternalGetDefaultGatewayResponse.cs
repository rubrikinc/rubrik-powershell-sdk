...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListInternalGetDefaultGatewayResponseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<InternalGetDefaultGatewayResponse> list)
        {
        ...
        public static void SelectForRetrieval(this List<InternalGetDefaultGatewayResponse> list)
        {

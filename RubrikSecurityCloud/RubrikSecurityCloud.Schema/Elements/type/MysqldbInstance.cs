...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MysqldbInstance: BaseType, CdmHierarchyObject, HierarchyObject, KosmosDiscoverableEntityType, KosmosHierarchyObjectType, KosmosParentHierarchyObjectType, KosmosSnappableHierarchyObjectType
    {
        ...
        //      C# -> MysqldbInstanceMetadata? Metadata
        // GraphQL -> metadata: MysqldbInstanceMetadata! (type)
        [JsonProperty("metadata")]
        public MysqldbInstanceMetadata? Metadata { get; set; }
        ...
        //      C# -> MysqldbInstanceStatus? Status
        // GraphQL -> status: MysqldbInstanceStatus! (type)
        [JsonProperty("status")]
        public MysqldbInstanceStatus? Status { get; set; }

        //      C# -> MysqldbInstanceDetails? UserDetails
        // GraphQL -> userDetails: MysqldbInstanceDetails! (type)
        [JsonProperty("userDetails")]
        public MysqldbInstanceDetails? UserDetails { get; set; }
    ...
    public MysqldbInstance Set(
        ...
        MysqldbInstanceStatus? Status = null,
        MysqldbInstanceDetails? UserDetails = null
    ) 
    {
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("metadata",false))
        {
            if(this.Metadata == null) {
                ...
                this.Metadata = new MysqldbInstanceMetadata();
        ...
        if (ec.Includes("status",false))
        {
            if(this.Status == null) {
                ...
                this.Status = new MysqldbInstanceStatus();
        ...
        if (ec.Includes("userDetails",false))
        {
            if(this.UserDetails == null) {
                ...
                this.UserDetails = new MysqldbInstanceDetails();
    ...
    public static class ListMysqldbInstanceExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<MysqldbInstance> list,
        ...
        public static List<string> SelectedFields(this List<MysqldbInstance> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MysqldbInstance());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MysqldbInstance> list)
        {

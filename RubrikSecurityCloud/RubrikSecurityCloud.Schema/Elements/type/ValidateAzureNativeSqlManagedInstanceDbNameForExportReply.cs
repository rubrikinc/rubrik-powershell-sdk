...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class ValidateAzureNativeSqlManagedInstanceDbNameForExportReply: IFragment
    {
        #region members
    ...
    public static class ListValidateAzureNativeSqlManagedInstanceDbNameForExportReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new ValidateAzureNativeSqlManagedInstanceDbNameForExportReply();
            list.Add(item);

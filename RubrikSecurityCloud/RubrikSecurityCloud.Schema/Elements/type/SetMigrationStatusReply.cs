...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListSetMigrationStatusReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SetMigrationStatusReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<SetMigrationStatusReply> list)
        {

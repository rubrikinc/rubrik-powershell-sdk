...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class StartTimeAttributes: IFragment
    {
        #region members
        //      C# -> System.Int32? Hour
    ...
    ) 
    {
        ...
        public string AsFragment(int indent=0)
        {
            ...
            if (this.DayOfWeek != null)
            {
                 ...
                 s += ind + "{\n" + 
                 this.DayOfWeek.AsFragment(indent+1) + 
                 ind + "}\n";
            }
            return new string(s);
        }
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> System.Int32? Hour
            // GraphQL -> hour: Int! (scalar)
            if (this.Hour == null && Exploration.Includes(parent + ".hour$"))
            {
            ...
            if (this.DayOfWeek == null && Exploration.Includes(parent + ".dayOfWeek"))
            {
                ...
                this.DayOfWeek.ApplyExploratoryFragment(parent + ".dayOfWeek");
            }
        }
    ...
    public static class ListStartTimeAttributesExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new StartTimeAttributes();
            list.Add(item);

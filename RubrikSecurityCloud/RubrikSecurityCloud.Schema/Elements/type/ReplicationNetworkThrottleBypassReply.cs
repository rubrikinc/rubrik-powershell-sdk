// ReplicationNetworkThrottleBypassReply.cs
//
...
{
    #region ReplicationNetworkThrottleBypassReply
    public class ReplicationNetworkThrottleBypassReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "ReplicationNetworkThrottleBypassReply";
    }

    public ReplicationNetworkThrottleBypassReply Set(
    ...
    } // class ReplicationNetworkThrottleBypassReply
    
    #endregion

    public static class ListReplicationNetworkThrottleBypassReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<ReplicationNetworkThrottleBypassReply> list,
        ...
        public static List<string> SelectedFields(this List<ReplicationNetworkThrottleBypassReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ReplicationNetworkThrottleBypassReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ReplicationNetworkThrottleBypassReply> list)
        {

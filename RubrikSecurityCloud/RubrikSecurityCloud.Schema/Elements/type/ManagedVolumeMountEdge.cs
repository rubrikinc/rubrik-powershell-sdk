...
namespace RubrikSecurityCloud.Types
{
    ...
    public class ManagedVolumeMountEdge: BaseType
    {
        #region members
    ...
    public static class ListManagedVolumeMountEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeMountEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new ManagedVolumeMountEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<ManagedVolumeMountEdge> list)
        {

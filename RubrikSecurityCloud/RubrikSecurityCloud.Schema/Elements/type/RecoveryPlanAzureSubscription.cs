// RecoveryPlanAzureSubscription.cs
//
...
{
    #region RecoveryPlanAzureSubscription
    public class RecoveryPlanAzureSubscription: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "RecoveryPlanAzureSubscription";
    }

    public RecoveryPlanAzureSubscription Set(
    ...
    } // class RecoveryPlanAzureSubscription
    
    #endregion

    public static class ListRecoveryPlanAzureSubscriptionExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<RecoveryPlanAzureSubscription> list,
        ...
        public static List<string> SelectedFields(this List<RecoveryPlanAzureSubscription> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RecoveryPlanAzureSubscription());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RecoveryPlanAzureSubscription> list)
        {

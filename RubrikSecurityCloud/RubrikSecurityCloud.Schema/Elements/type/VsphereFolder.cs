...
namespace RubrikSecurityCloud.Types
{
    ...
    public class VsphereFolder: BaseType, CdmHierarchyObject, HierarchyObject, VsphereDatacenterDescendantType, VsphereDatacenterFolderDescendantType, VsphereDatacenterFolderLogicalChildType, VsphereDatacenterLogicalChildType, VsphereFolderDescendantType, VsphereFolderLogicalChildType, VsphereVcenterDescendantType, VsphereVcenterLogicalChildType
    {
        #region members
        ...
        //      C# -> VsphereFolderDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: VsphereFolderDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public VsphereFolderDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> VsphereFolderLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: VsphereFolderLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public VsphereFolderLogicalChildTypeConnection? LogicalChildConnection { get; set; }
        ...
        //      C# -> VsphereFolderLogicalChildTypeConnection? RecoveryLogicalChildConnection
        // GraphQL -> recoveryLogicalChildConnection: VsphereFolderLogicalChildTypeConnection! (type)
        [JsonProperty("recoveryLogicalChildConnection")]
        public VsphereFolderLogicalChildTypeConnection? RecoveryLogicalChildConnection { get; set; }
    ...
    public VsphereFolder()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "VsphereFolder";
    }
    ...
    public VsphereFolder Set(
        ...
        VsphereFolderLogicalChildTypeConnection? LogicalChildConnection = null,
        List<PathNode>? LogicalPath = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        List<PathNode>? PhysicalPath = null,
        DataLocation? PrimaryClusterLocation = null,
        VsphereFolderLogicalChildTypeConnection? RecoveryLogicalChildConnection = null,
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new VsphereFolderDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new VsphereFolderLogicalChildTypeConnection();
        ...
        if (ec.Includes("recoveryLogicalChildConnection",false))
        {
            if(this.RecoveryLogicalChildConnection == null) {
                ...
                this.RecoveryLogicalChildConnection = new VsphereFolderLogicalChildTypeConnection();
    ...
    public static class ListVsphereFolderExtensions
    {
        ...
        public static List<string> SelectedFields(this List<VsphereFolder> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new VsphereFolder());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<VsphereFolder> list)
        {

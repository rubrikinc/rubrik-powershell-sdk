...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OpenstackTag: BaseType, CdmHierarchyObject, HierarchyObject, OpenstackProjectDescendantType, OpenstackProjectLogicalChildType
    {
        #region members
        ...
        //      C# -> System.String? OpenstackEnvironmentId
        // GraphQL -> openstackEnvironmentId: String! (scalar)
        [JsonProperty("openstackEnvironmentId")]
        public System.String? OpenstackEnvironmentId { get; set; }

        //      C# -> System.String? OpenstackProjectId
        // GraphQL -> openstackProjectId: String! (scalar)
        [JsonProperty("openstackProjectId")]
        public System.String? OpenstackProjectId { get; set; }
        ...
        //      C# -> System.String? TagName
        // GraphQL -> tagName: String! (scalar)
        ...
        //      C# -> OpenstackTagDescendantTypeConnection? DescendantConnection
        // GraphQL -> descendantConnection: OpenstackTagDescendantTypeConnection! (type)
        [JsonProperty("descendantConnection")]
        public OpenstackTagDescendantTypeConnection? DescendantConnection { get; set; }
        ...
        //      C# -> OpenstackTagLogicalChildTypeConnection? LogicalChildConnection
        // GraphQL -> logicalChildConnection: OpenstackTagLogicalChildTypeConnection! (type)
        [JsonProperty("logicalChildConnection")]
        public OpenstackTagLogicalChildTypeConnection? LogicalChildConnection { get; set; }
    ...
    public OpenstackTag Set(
        ...
        System.String? OpenstackEnvironmentId = null,
        System.String? OpenstackProjectId = null,
        ...
        OpenstackTagDescendantTypeConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        OpenstackTagLogicalChildTypeConnection? LogicalChildConnection = null,
    ...
    ) 
    {
        ...
        if ( OpenstackEnvironmentId != null ) {
            this.OpenstackEnvironmentId = OpenstackEnvironmentId;
        }
        if ( OpenstackProjectId != null ) {
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? OpenstackEnvironmentId
        // GraphQL -> openstackEnvironmentId: String! (scalar)
        if (this.OpenstackEnvironmentId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "openstackEnvironmentId\n" ;
            } else {
                s += ind + "openstackEnvironmentId\n" ;
            }
        }
        //      C# -> System.String? OpenstackProjectId
        // GraphQL -> openstackProjectId: String! (scalar)
        if (this.OpenstackProjectId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "openstackProjectId\n" ;
            } else {
                s += ind + "openstackProjectId\n" ;
            }
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.String? OpenstackEnvironmentId
        // GraphQL -> openstackEnvironmentId: String! (scalar)
        if (ec.Includes("openstackEnvironmentId",true))
        {
            if(this.OpenstackEnvironmentId == null) {

                this.OpenstackEnvironmentId = "FETCH";
        ...
        else if (this.OpenstackEnvironmentId != null && ec.Excludes("openstackEnvironmentId",true))
        {
            this.OpenstackEnvironmentId = null;
        }
        //      C# -> System.String? OpenstackProjectId
        // GraphQL -> openstackProjectId: String! (scalar)
        if (ec.Includes("openstackProjectId",true))
        {
            if(this.OpenstackProjectId == null) {

                this.OpenstackProjectId = "FETCH";
        ...
        else if (this.OpenstackProjectId != null && ec.Excludes("openstackProjectId",true))
        {
            this.OpenstackProjectId = null;
        }
        //      C# -> System.Int32? ReplicatedObjectCount
        // GraphQL -> replicatedObjectCount: Int! (scalar)
        ...
        else if (this.TagName != null && ec.Excludes("tagName",true))
        {
            this.TagName = null;
        }
        //      C# -> List<Org>? AllOrgs
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new OpenstackTagDescendantTypeConnection();
        ...
        if (ec.Includes("logicalChildConnection",false))
        {
            if(this.LogicalChildConnection == null) {
                ...
                this.LogicalChildConnection = new OpenstackTagLogicalChildTypeConnection();
    ...
    public static class ListOpenstackTagExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OpenstackTag> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new OpenstackTag());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<OpenstackTag> list)
        {

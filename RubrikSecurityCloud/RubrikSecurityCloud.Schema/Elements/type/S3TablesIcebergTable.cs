...
{
    #region S3TablesIcebergTable
 
    public class S3TablesIcebergTable: BaseType, AwsNativeAccountDescendantType, AwsNativeHierarchyObject, HierarchyObject, HierarchySnappable, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
        ...
        //      C# -> System.Int64? SizeBytes
        // GraphQL -> sizeBytes: Long! (scalar)
        [JsonProperty("sizeBytes")]
        public System.Int64? SizeBytes { get; set; }
    ...
    public S3TablesIcebergTable()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "S3TablesIcebergTable";
    }

    public S3TablesIcebergTable Set(
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        //      C# -> System.Int64? SizeBytes
        // GraphQL -> sizeBytes: Long! (scalar)
        if (ec.Includes("sizeBytes",true))
        {
            if(this.SizeBytes == null) {

                this.SizeBytes = new System.Int64();
        ...
        else if (this.SizeBytes != null && ec.Excludes("sizeBytes",true))
        {
            this.SizeBytes = null;
        }
        //      C# -> System.Boolean? SlaPauseStatus
    ...
    } // class S3TablesIcebergTable
    
    #endregion

    public static class ListS3TablesIcebergTableExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<S3TablesIcebergTable> list,
        ...
        public static List<string> SelectedFields(this List<S3TablesIcebergTable> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new S3TablesIcebergTable());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<S3TablesIcebergTable> list)
        {

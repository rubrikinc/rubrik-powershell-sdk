...
{
    #region FusionComputeSite
 
    public class FusionComputeSite: BaseType, CdmHierarchyObject, FusionComputeVrmDescendant, FusionComputeVrmPhysicalChildType, HierarchyObject
    {
        #region members
        ...
        //      C# -> System.String? FcSiteId
        // GraphQL -> fcSiteId: String! (scalar)
        [JsonProperty("fcSiteId")]
        public System.String? FcSiteId { get; set; }
        ...
        //      C# -> FusionComputeSiteDescendantConnection? DescendantConnection
        // GraphQL -> descendantConnection: FusionComputeSiteDescendantConnection! (type)
        [JsonProperty("descendantConnection")]
        public FusionComputeSiteDescendantConnection? DescendantConnection { get; set; }
        ...
        //      C# -> FusionComputeSitePhysicalChildTypeConnection? PhysicalChildConnection
        // GraphQL -> physicalChildConnection: FusionComputeSitePhysicalChildTypeConnection! (type)
        [JsonProperty("physicalChildConnection")]
        public FusionComputeSitePhysicalChildTypeConnection? PhysicalChildConnection { get; set; }
    ...
    public FusionComputeSite()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "FusionComputeSite";
    }

    public FusionComputeSite Set(
        ...
        FusionComputeSiteDescendantConnection? DescendantConnection = null,
        PathNode? EffectiveSlaSourceObject = null,
        LatestUserNote? LatestUserNote = null,
        List<PathNode>? LogicalPath = null,
        ObjectPauseStatus? ObjectPauseStatus = null,
        PendingSnapshotsOfObjectDeletion? PendingObjectDeletionStatus = null,
        FusionComputeSitePhysicalChildTypeConnection? PhysicalChildConnection = null,
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? FcSiteId
        // GraphQL -> fcSiteId: String! (scalar)
        if (this.FcSiteId != null) {
            if (conf.Flat) {
                s += conf.Prefix + "fcSiteId\n" ;
            } else {
                s += ind + "fcSiteId\n" ;
            }
        }
    ...
    public override void ApplyExploratoryFieldSpec(AutofieldContext ec)
    {
        ...
        else if (this.FcSiteId != null && ec.Excludes("fcSiteId",true))
        {
            this.FcSiteId = null;
        }
        //      C# -> System.String? Id
        ...
        if (ec.Includes("descendantConnection",false))
        {
            if(this.DescendantConnection == null) {
                ...
                this.DescendantConnection = new FusionComputeSiteDescendantConnection();
        ...
        if (ec.Includes("physicalChildConnection",false))
        {
            if(this.PhysicalChildConnection == null) {
                ...
                this.PhysicalChildConnection = new FusionComputeSitePhysicalChildTypeConnection();
    ...
    } // class FusionComputeSite
    
    #endregion

    public static class ListFusionComputeSiteExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<FusionComputeSite> list,
        ...
        public static List<string> SelectedFields(this List<FusionComputeSite> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FusionComputeSite());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FusionComputeSite> list)
        {

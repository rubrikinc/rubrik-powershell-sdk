...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HelpContentSnippetEdge: BaseType
    {
        #region members
    ...
    public static class ListHelpContentSnippetEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HelpContentSnippetEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HelpContentSnippetEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HelpContentSnippetEdge> list)
        {

...
{
    #region FieldDiff
    public class FieldDiff: BaseType
    {
        #region members
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.FieldName != null && ec.Excludes("fieldName",true))
        {
            this.FieldName = null;
        }
        //      C# -> System.String? LeftValue
    ...
    public static class ListFieldDiffExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FieldDiff> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new FieldDiff());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<FieldDiff> list)
        {

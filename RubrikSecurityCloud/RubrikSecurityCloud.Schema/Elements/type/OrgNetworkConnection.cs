...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListOrgNetworkConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OrgNetworkConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<OrgNetworkConnection> list)
        {

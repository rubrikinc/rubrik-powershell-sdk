...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class AddVmAppConsistentSpecsReply: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            //      C# -> List<System.String>? FailedSnappableIds
            // GraphQL -> failedSnappableIds: [String!]! (scalar)
            if (this.FailedSnappableIds == null && Exploration.Includes(parent + ".failedSnappableIds$"))
            {
                this.FailedSnappableIds = new List<System.String>();
            }
            //      C# -> List<System.String>? SuccessSnappableIds
            // GraphQL -> successSnappableIds: [String!]! (scalar)
            if (this.SuccessSnappableIds == null && Exploration.Includes(parent + ".successSnappableIds$"))
            {
    ...
    public static class ListAddVmAppConsistentSpecsReplyExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new AddVmAppConsistentSpecsReply();
            list.Add(item);

...
{
    #region FailoverChart
 
    public class FailoverChart: BaseType, ReportChartType
    {
        #region members
    ...
    public static class ListFailoverChartExtensions
    {
        ...
        public static List<string> SelectedFields(this List<FailoverChart> list)
        {

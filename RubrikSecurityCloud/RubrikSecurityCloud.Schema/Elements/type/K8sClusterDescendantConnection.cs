...
namespace RubrikSecurityCloud.Types
{
    ...
    public class K8sClusterDescendantConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<K8sClusterDescendant> Nodes { get; set; }
    ...
    public K8sClusterDescendantConnection Set(
        RscInterfaceList<K8sClusterDescendant> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<K8sClusterDescendant>();
    ...
    public static class ListK8sClusterDescendantConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<K8sClusterDescendantConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<K8sClusterDescendantConnection> list)
        {

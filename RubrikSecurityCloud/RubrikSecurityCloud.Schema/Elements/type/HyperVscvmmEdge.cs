...
namespace RubrikSecurityCloud.Types
{
    ...
    public class HyperVscvmmEdge: BaseType
    {
        #region members
    ...
    public static class ListHyperVscvmmEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<HyperVscvmmEdge> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new HyperVscvmmEdge());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<HyperVscvmmEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class GcpCmk: BaseType
    {
        ...
        //      C# -> System.String? KeyRingName
        // GraphQL -> keyRingName: String! (scalar)
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? KeyRingName
        // GraphQL -> keyRingName: String! (scalar)
        if (ec.Includes("keyRingName",true))
        {
            if(this.KeyRingName == null) {

                this.KeyRingName = "FETCH";
    ...
    public static class ListGcpCmkExtensions
    {
        ...
        public static List<string> SelectedFields(this List<GcpCmk> list)
        {
        ...
        public static void SelectForRetrieval(this List<GcpCmk> list)
        {

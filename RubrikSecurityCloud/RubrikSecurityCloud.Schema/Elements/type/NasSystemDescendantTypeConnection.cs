...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasSystemDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterface<NasSystemDescendantType> Nodes { get; set; }
    ...
    public NasSystemDescendantTypeConnection Set(
        RscInterface<NasSystemDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterface<NasSystemDescendantType>();

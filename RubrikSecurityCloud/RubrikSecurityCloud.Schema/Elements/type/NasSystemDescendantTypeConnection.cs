...
namespace RubrikSecurityCloud.Types
{
    ...
    public class NasSystemDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<NasSystemDescendantType> Nodes { get; set; }
    ...
    public NasSystemDescendantTypeConnection Set(
        RscInterfaceList<NasSystemDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<NasSystemDescendantType>();
    ...
    public static class ListNasSystemDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<NasSystemDescendantTypeConnection> list)
        {

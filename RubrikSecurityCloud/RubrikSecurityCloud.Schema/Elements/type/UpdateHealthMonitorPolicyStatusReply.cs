...
namespace RubrikSecurityCloud.Types
{
    ...
    public class UpdateHealthMonitorPolicyStatusReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "UpdateHealthMonitorPolicyStatusReply";
    }
    ...
    public static class ListUpdateHealthMonitorPolicyStatusReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<UpdateHealthMonitorPolicyStatusReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new UpdateHealthMonitorPolicyStatusReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<UpdateHealthMonitorPolicyStatusReply> list)
        {

// BulkCopyAutomigratableNasHostsReply.cs
//
...
{
    #region BulkCopyAutomigratableNasHostsReply
    public class BulkCopyAutomigratableNasHostsReply: BaseType
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "BulkCopyAutomigratableNasHostsReply";
    }

    public BulkCopyAutomigratableNasHostsReply Set(
    ...
    } // class BulkCopyAutomigratableNasHostsReply
    
    #endregion

    public static class ListBulkCopyAutomigratableNasHostsReplyExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<BulkCopyAutomigratableNasHostsReply> list,
        ...
        public static List<string> SelectedFields(this List<BulkCopyAutomigratableNasHostsReply> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new BulkCopyAutomigratableNasHostsReply());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<BulkCopyAutomigratableNasHostsReply> list)
        {

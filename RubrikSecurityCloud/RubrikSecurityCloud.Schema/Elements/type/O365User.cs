...
namespace RubrikSecurityCloud.Types
{
    ...
    public class O365User: BaseType, HierarchyObject, O365OrgDescendant, PolarisHierarchyObject
    {
        #region members
        ...
        //      C# -> O365UserDescendantConnection? ChildConnection
        // GraphQL -> childConnection: O365UserDescendantConnection! (type)
        [JsonProperty("childConnection")]
        public O365UserDescendantConnection? ChildConnection { get; set; }
    ...
    public O365User Set(
        ...
        O365UserDescendantConnection? ChildConnection = null,
        ...
        if (this.ConfiguredSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365User_INTERFACE_FIELD_configuredSlaDomain: configuredSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveRetentionSlaDomain
        ...
        if (this.EffectiveRetentionSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365User_INTERFACE_FIELD_effectiveRetentionSlaDomain: effectiveRetentionSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> SlaDomain? EffectiveSlaDomain
        ...
        if (this.EffectiveSlaDomain != null) {
            ...
            if(fspec.Replace(" ", "").Replace("\n", "").Length > 0) {
                if (conf.Flat) {
                    ...
                    s += ind + "O365User_INTERFACE_FIELD_effectiveSlaDomain: effectiveSlaDomain{\n" + fspec + ind + "}\n";
                }
            }
        }
        //      C# -> System.String? EmailAddress
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("childConnection",false))
        {
            if(this.ChildConnection == null) {
                ...
                this.ChildConnection = new O365UserDescendantConnection();
    ...
    public static class ListO365UserExtensions
    {
        ...
        public static List<string> SelectedFields(this List<O365User> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new O365User());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<O365User> list)
        {

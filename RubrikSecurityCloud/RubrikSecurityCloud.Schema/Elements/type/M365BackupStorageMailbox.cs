...
{
    #region M365BackupStorageMailbox
 
    public class M365BackupStorageMailbox: BaseType, HierarchyObject, HierarchySnappable, MicrosoftMailbox, PolarisHierarchyObject, PolarisHierarchySnappable
    {
        #region members
    ...
    public M365BackupStorageMailbox()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "M365BackupStorageMailbox";
    }

    public M365BackupStorageMailbox Set(
    ...
    } // class M365BackupStorageMailbox
    
    #endregion

    public static class ListM365BackupStorageMailboxExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<M365BackupStorageMailbox> list,
        ...
        public static List<string> SelectedFields(this List<M365BackupStorageMailbox> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new M365BackupStorageMailbox());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<M365BackupStorageMailbox> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListAddStorageArraysReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<AddStorageArraysReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<AddStorageArraysReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MssqlAvailabilityGroup: BaseType, CdmHierarchyObject, HierarchyObject, MssqlTopLevelDescendantType
    {
        #region members
    ...
    public MssqlAvailabilityGroup()
    {
        this.Vars = new InlineVars();
    }

    public override string GetGqlTypeName() {
        return "MssqlAvailabilityGroup";
    }
    ...
    public static class ListMssqlAvailabilityGroupExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MssqlAvailabilityGroup> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new MssqlAvailabilityGroup());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<MssqlAvailabilityGroup> list)
        {

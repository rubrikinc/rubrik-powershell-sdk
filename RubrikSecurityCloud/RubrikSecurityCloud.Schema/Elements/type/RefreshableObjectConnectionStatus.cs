...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListRefreshableObjectConnectionStatusExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RefreshableObjectConnectionStatus> list)
        {
        ...
        public static void SelectForRetrieval(this List<RefreshableObjectConnectionStatus> list)
        {

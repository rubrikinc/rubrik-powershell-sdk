...
namespace RubrikSecurityCloud.Types
{
    ...
    public class Db2InstanceDescendantTypeConnection: BaseType
    {
        ...
        [JsonProperty("nodes")]
        public RscInterfaceList<Db2InstanceDescendantType> Nodes { get; set; }
    ...
    public Db2InstanceDescendantTypeConnection Set(
        RscInterfaceList<Db2InstanceDescendantType> Nodes = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("nodes",false))
        {
            if(this.Nodes == null) {
                ...
                this.Nodes = new RscInterfaceList<Db2InstanceDescendantType>();
    ...
    public static class ListDb2InstanceDescendantTypeConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2InstanceDescendantTypeConnection> list)
        {

...
{
    #region RcvRegion
    public class RcvRegion: BaseType
    {
        #region members
    ...
    public static class ListRcvRegionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RcvRegion> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new RcvRegion());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<RcvRegion> list)
        {

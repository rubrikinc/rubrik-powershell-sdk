...
{
    #region CdmManagedAwsTarget
 
    public class CdmManagedAwsTarget: BaseType, Target
    {
        #region members
    ...
    public override string GetGqlTypeName() {
        return "CdmManagedAwsTarget";
    }

    public CdmManagedAwsTarget Set(
    ...
    } // class CdmManagedAwsTarget
    
    #endregion

    public static class ListCdmManagedAwsTargetExtensions
    {
        ...
        public static string AsFieldSpec(
            this List<CdmManagedAwsTarget> list,
        ...
        public static List<string> SelectedFields(this List<CdmManagedAwsTarget> list)
        {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new CdmManagedAwsTarget());
            }

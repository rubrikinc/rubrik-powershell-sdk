...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListBatchMountHypervVmReplyExtensions
    {
        ...
        public static List<string> SelectedFields(this List<BatchMountHypervVmReply> list)
        {
        ...
        public static void SelectForRetrieval(this List<BatchMountHypervVmReply> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListCassandraSourceConnectionExtensions
    {
        ...
        public static List<string> SelectedFields(this List<CassandraSourceConnection> list)
        {
        ...
        public static void SelectForRetrieval(this List<CassandraSourceConnection> list)
        {

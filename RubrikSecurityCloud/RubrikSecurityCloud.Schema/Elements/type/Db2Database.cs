...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.Db2HadrMetadata != null) {
            s += ind + "db2HadrMetadata {\n" + this.Db2HadrMetadata.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> Db2Instance? Db2Instance
        // GraphQL -> db2Instance: Db2Instance (type)
        ...
        if (this.LogSnapshots != null) {
            s += ind + "logSnapshots {\n" + this.LogSnapshots.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)
    ...
    public override void ApplyExploratoryFieldSpec(String parent = "")
    {
        ...
        //      C# -> Db2DatabaseType? Db2DbType
        // GraphQL -> db2DbType: Db2DatabaseType! (enum)
        if (this.Db2DbType == null && Exploration.Includes(parent + ".db2DbType", true))
        {
        ...
        //      C# -> System.String? LogBackupThreshold
        // GraphQL -> logBackupThreshold: String! (scalar)
        if (this.LogBackupThreshold == null && Exploration.Includes(parent + ".logBackupThreshold", true))
        {
            this.LogBackupThreshold = new System.String("FETCH");
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
        ...
        //      C# -> Db2HadrMetadata? Db2HadrMetadata
        // GraphQL -> db2HadrMetadata: Db2HadrMetadata (type)
        if (this.Db2HadrMetadata == null && Exploration.Includes(parent + ".db2HadrMetadata"))
        {
            this.Db2HadrMetadata = new Db2HadrMetadata();
            this.Db2HadrMetadata.ApplyExploratoryFieldSpec(parent + ".db2HadrMetadata");
        }
        //      C# -> Db2Instance? Db2Instance
        // GraphQL -> db2Instance: Db2Instance (type)
        ...
        //      C# -> Db2LogSnapshotConnection? LogSnapshots
        // GraphQL -> logSnapshots: Db2LogSnapshotConnection! (type)
        if (this.LogSnapshots == null && Exploration.Includes(parent + ".logSnapshots"))
        {
            this.LogSnapshots = new Db2LogSnapshotConnection();
            this.LogSnapshots.ApplyExploratoryFieldSpec(parent + ".logSnapshots");
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)

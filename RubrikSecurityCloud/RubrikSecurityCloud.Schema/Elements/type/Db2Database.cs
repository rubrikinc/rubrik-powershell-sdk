...
namespace RubrikSecurityCloud.Types
{
    ...
    public class InlineVars {
        ...
        public InlineVars() {
            Tuple<string, string>[] logSnapshotsArgs = {
            ...
            this.LogSnapshots =
                new RscGqlVars(null, logSnapshotsArgs, null, true);
            ...
            Tuple<string, string>[] recoverableRangesArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
                    Tuple.Create("last", "Int"),
                    Tuple.Create("before", "String"),
            ...
            this.RecoverableRanges =
                new RscGqlVars(null, recoverableRangesArgs, null, true);
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        if (this.LogBackupThreshold != null) {
            if (conf.Flat) {
                s += conf.Prefix + "logBackupThreshold\n" ;
            } else {
        ...
        if (this.Db2HadrMetadata != null) {
            var fspec = this.Db2HadrMetadata.AsFieldSpec(conf.Child("db2HadrMetadata"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
        ...
        if (this.LogSnapshots != null) {
            var fspec = this.LogSnapshots.AsFieldSpec(conf.Child("logSnapshots"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        else if (this.Db2DbType != null && ec.Excludes("db2DbType",true))
        {
            this.Db2DbType = null;
        }
        //      C# -> HierarchyObjectTypeEnum? ObjectType
        ...
        else if (this.LogBackupThreshold != null && ec.Excludes("logBackupThreshold",true))
        {
            this.LogBackupThreshold = null;
        }
        //      C# -> System.String? Name
        // GraphQL -> name: String! (scalar)
        ...
        //      C# -> Db2HadrMetadata? Db2HadrMetadata
        // GraphQL -> db2HadrMetadata: Db2HadrMetadata (type)
        if (ec.Includes("db2HadrMetadata",false))
        {
            if(this.Db2HadrMetadata == null) {
        ...
        else if (this.Db2HadrMetadata != null && ec.Excludes("db2HadrMetadata",false))
        {
            this.Db2HadrMetadata = null;
        }
        //      C# -> Db2Instance? Db2Instance
        // GraphQL -> db2Instance: Db2Instance (type)
        ...
        //      C# -> Db2LogSnapshotConnection? LogSnapshots
        // GraphQL -> logSnapshots: Db2LogSnapshotConnection! (type)
        if (ec.Includes("logSnapshots",false))
        {
            if(this.LogSnapshots == null) {
        ...
        else if (this.LogSnapshots != null && ec.Excludes("logSnapshots",false))
        {
            this.LogSnapshots = null;
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)
    ...
    public static class ListDb2DatabaseExtensions
    {
        ...
        public static List<string> SelectedFields(this List<Db2Database> list)
        {

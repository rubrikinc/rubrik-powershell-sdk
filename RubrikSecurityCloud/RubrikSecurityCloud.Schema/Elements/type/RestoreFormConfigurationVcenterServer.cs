...
namespace RubrikSecurityCloud.Types
{
    ...
    public override string GetGqlTypeName() {
        return "RestoreFormConfigurationVcenterServer";
    }
    ...
    public static class ListRestoreFormConfigurationVcenterServerExtensions
    {
        ...
        public static List<string> SelectedFields(this List<RestoreFormConfigurationVcenterServer> list)
        {
        ...
        public static void SelectForRetrieval(this List<RestoreFormConfigurationVcenterServer> list)
        {

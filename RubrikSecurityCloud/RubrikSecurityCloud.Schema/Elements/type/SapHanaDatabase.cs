...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public override string AsFieldSpec(int indent=0)
    {
        ...
        if (this.DataPathSpec != null) {
            s += ind + "dataPathSpec {\n" + this.DataPathSpec.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> PathNode? EffectiveSlaSourceObject
        // GraphQL -> effectiveSlaSourceObject: PathNode (type)
        ...
        // GraphQL -> info: SapHanaDatabaseInfoObject (type)
        if (this.Info != null) {
            s += ind + "info {\n" + this.Info.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> LatestUserNote? LatestUserNote
        // GraphQL -> latestUserNote: LatestUserNote (type)
        ...
        if (this.LogSnapshotConnection != null) {
            s += ind + "logSnapshotConnection {\n" + this.LogSnapshotConnection.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)
        ...
        if (this.RecoverableRangeConnection != null) {
            s += ind + "recoverableRangeConnection {\n" + this.RecoverableRangeConnection.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> SapHanaSystem? SapHanaSystem
        // GraphQL -> sapHanaSystem: SapHanaSystem! (type)
        if (this.SapHanaSystem != null) {
            s += ind + "sapHanaSystem {\n" + this.SapHanaSystem.AsFieldSpec(indent+1) + ind + "}\n" ;
        }
        //      C# -> CdmSnapshotConnection? SnapshotConnection
        // GraphQL -> snapshotConnection: CdmSnapshotConnection (type)

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class SapHanaDatabase: BaseType, CdmHierarchyObject, CdmHierarchySnappableNew, HierarchyObject, SapHanaSystemDescendantType, SapHanaSystemPhysicalChildType
    {
        ...
        public RscInterface<CdmHierarchyObject> ReplicatedObjects { get; set; }
        ...
        public System.String? DataPathType { get; set; }
        ...
        public SapHanaDataPathSpecObject? DataPathSpec { get; set; }
        ...
        //      C# -> SapHanaDatabaseInfoObject? Info
        // GraphQL -> info: SapHanaDatabaseInfoObject (type)
        [JsonProperty("info")]
        public SapHanaDatabaseInfoObject? Info { get; set; }
        ...
        //      C# -> SapHanaLogSnapshotConnection? LogSnapshotConnection
        // GraphQL -> logSnapshotConnection: SapHanaLogSnapshotConnection! (type)
        [JsonProperty("logSnapshotConnection")]
        public SapHanaLogSnapshotConnection? LogSnapshotConnection { get; set; }
        ...
        //      C# -> SapHanaRecoverableRangeConnection? RecoverableRangeConnection
        // GraphQL -> recoverableRangeConnection: SapHanaRecoverableRangeConnection! (type)
        [JsonProperty("recoverableRangeConnection")]
        public SapHanaRecoverableRangeConnection? RecoverableRangeConnection { get; set; }
    ...
    public class InlineVars {
        ...
        public InlineVars() {
            Tuple<string, string>[] logSnapshotConnectionArgs = {
            ...
            this.LogSnapshotConnection =
                new RscGqlVars(null, logSnapshotConnectionArgs, null, true);
            ...
            Tuple<string, string>[] recoverableRangeConnectionArgs = {
                    Tuple.Create("first", "Int"),
                    Tuple.Create("after", "String"),
                    Tuple.Create("last", "Int"),
                    Tuple.Create("before", "String"),
            ...
            this.RecoverableRangeConnection =
                new RscGqlVars(null, recoverableRangeConnectionArgs, null, true);
    ...
    public SapHanaDatabase Set(
        ...
        RscInterface<CdmHierarchyObject> ReplicatedObjects = null,
        System.String? CdmId = null,
        System.String? CdmLink = null,
        System.String? ClusterUuid = null,
        System.String? DataPathType = null,
        ...
        SapHanaLogSnapshotConnection? LogSnapshotConnection = null,
    ...
    ) 
    {
        ...
        if ( LogSnapshotConnection != null ) {
            this.LogSnapshotConnection = LogSnapshotConnection;
        }
        if ( LogicalPath != null ) {
        ...
        if ( RecoverableRangeConnection != null ) {
            this.RecoverableRangeConnection = RecoverableRangeConnection;
        }
    ...
    public override string AsFieldSpec(FieldSpecConfig? conf=null)
    {
        ...
        //      C# -> System.String? DataPathType
        // GraphQL -> dataPathType: String! (scalar)
        if (this.DataPathType != null) {
            if (conf.Flat) {
                s += conf.Prefix + "dataPathType\n" ;
            } else {
                s += ind + "dataPathType\n" ;
            }
        }
        ...
        //      C# -> SapHanaDataPathSpecObject? DataPathSpec
        // GraphQL -> dataPathSpec: SapHanaDataPathSpecObject (type)
        if (this.DataPathSpec != null) {
            var fspec = this.DataPathSpec.AsFieldSpec(conf.Child("dataPathSpec"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
        ...
        //      C# -> SapHanaLogSnapshotConnection? LogSnapshotConnection
        // GraphQL -> logSnapshotConnection: SapHanaLogSnapshotConnection! (type)
        if (this.LogSnapshotConnection != null) {
            var fspec = this.LogSnapshotConnection.AsFieldSpec(conf.Child("logSnapshotConnection"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
        ...
        //      C# -> SapHanaRecoverableRangeConnection? RecoverableRangeConnection
        // GraphQL -> recoverableRangeConnection: SapHanaRecoverableRangeConnection! (type)
        if (this.RecoverableRangeConnection != null) {
            var fspec = this.RecoverableRangeConnection.AsFieldSpec(conf.Child("recoverableRangeConnection"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
        ...
        //      C# -> SapHanaSystem? SapHanaSystem
        // GraphQL -> sapHanaSystem: SapHanaSystem! (type)
        if (this.SapHanaSystem != null) {
            var fspec = this.SapHanaSystem.AsFieldSpec(conf.Child("sapHanaSystem"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
        ...
        if (this.SourceDatabaseDetails != null) {
            var fspec = this.SourceDatabaseDetails.AsFieldSpec(conf.Child("sourceDatabaseDetails"));
            string trimmedFspec = fspec.Replace(" ", "").Replace("\n", "");
            if(trimmedFspec.Length > 0 ) {
                if (conf.Flat) {
                    s += conf.Prefix + fspec;
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        //      C# -> System.String? DataPathType
        // GraphQL -> dataPathType: String! (scalar)
        if (ec.Includes("dataPathType",true))
        {
            if(this.DataPathType == null) {
        ...
        else if (this.DataPathType != null && ec.Excludes("dataPathType",true))
        {
        ...
        if (ec.Includes("dataPathSpec",false))
        {
            if(this.DataPathSpec == null) {
                ...
                this.DataPathSpec = new SapHanaDataPathSpecObject();
                this.DataPathSpec.ApplyExploratoryFieldSpec(ec.NewChild("dataPathSpec"));
        ...
        else if (this.DataPathSpec != null && ec.Excludes("dataPathSpec",false))
        {
        ...
        if (ec.Includes("info",false))
        {
            if(this.Info == null) {
                ...
                this.Info = new SapHanaDatabaseInfoObject();
        ...
        //      C# -> SapHanaLogSnapshotConnection? LogSnapshotConnection
        // GraphQL -> logSnapshotConnection: SapHanaLogSnapshotConnection! (type)
        if (ec.Includes("logSnapshotConnection",false))
        {
            if(this.LogSnapshotConnection == null) {

                this.LogSnapshotConnection = new SapHanaLogSnapshotConnection();
                this.LogSnapshotConnection.ApplyExploratoryFieldSpec(ec.NewChild("logSnapshotConnection"));
        ...
        else if (this.LogSnapshotConnection != null && ec.Excludes("logSnapshotConnection",false))
        {
            this.LogSnapshotConnection = null;
        }
        //      C# -> List<PathNode>? LogicalPath
        // GraphQL -> logicalPath: [PathNode!]! (type)
        ...
        //      C# -> SapHanaRecoverableRangeConnection? RecoverableRangeConnection
        // GraphQL -> recoverableRangeConnection: SapHanaRecoverableRangeConnection! (type)
        if (ec.Includes("recoverableRangeConnection",false))
        {
            if(this.RecoverableRangeConnection == null) {

                this.RecoverableRangeConnection = new SapHanaRecoverableRangeConnection();
                this.RecoverableRangeConnection.ApplyExploratoryFieldSpec(ec.NewChild("recoverableRangeConnection"));
        ...
        else if (this.RecoverableRangeConnection != null && ec.Excludes("recoverableRangeConnection",false))
        {
            this.RecoverableRangeConnection = null;
        }
        //      C# -> SapHanaSystem? SapHanaSystem
        // GraphQL -> sapHanaSystem: SapHanaSystem! (type)
        if (ec.Includes("sapHanaSystem",false))
        {
            if(this.SapHanaSystem == null) {

                this.SapHanaSystem = new SapHanaSystem();
                this.SapHanaSystem.ApplyExploratoryFieldSpec(ec.NewChild("sapHanaSystem"));
        ...
        //      C# -> SapHanaDatabase? SourceDatabaseDetails
        // GraphQL -> sourceDatabaseDetails: SapHanaDatabase (type)
        if (ec.Includes("sourceDatabaseDetails",false))
        {
            if(this.SourceDatabaseDetails == null) {

                this.SourceDatabaseDetails = new SapHanaDatabase();
                this.SourceDatabaseDetails.ApplyExploratoryFieldSpec(ec.NewChild("sourceDatabaseDetails"));
        ...
        else if (this.SourceDatabaseDetails != null && ec.Excludes("sourceDatabaseDetails",false))
        {
    ...
    public static class ListSapHanaDatabaseExtensions
    {
        ...
        {
            if ( list.Count == 0 ) {
                list.Add(new SapHanaDatabase());
            }
            list[0].ApplyExploratoryFieldSpec(ec);
        }

        public static void SelectForRetrieval(this List<SapHanaDatabase> list)
        {

...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class OracleRacDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (OracleRacDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(OracleRacDescendantType));
    ...
    public static class ListOracleRacDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new OracleRacDescendantTypeEdge();
            list.Add(item);

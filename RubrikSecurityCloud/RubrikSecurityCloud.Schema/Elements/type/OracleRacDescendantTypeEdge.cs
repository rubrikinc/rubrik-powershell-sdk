...
namespace RubrikSecurityCloud.Types
{
    ...
    public class OracleRacDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<OracleRacDescendantType> Node { get; set; }
    ...
    public OracleRacDescendantTypeEdge Set(
        RscInterface<OracleRacDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<OracleRacDescendantType>();
    ...
    public static class ListOracleRacDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<OracleRacDescendantTypeEdge> list)
        {

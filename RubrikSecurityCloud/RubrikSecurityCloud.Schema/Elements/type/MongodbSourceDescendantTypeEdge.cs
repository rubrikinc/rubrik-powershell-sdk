...
namespace Rubrik.SecurityCloud.Types
{
    ...
    public class MongodbSourceDescendantTypeEdge: IFragment
    {
        #region members
    ...
    ) 
    {
        ...
        public void ApplyExploratoryFragment(String parent = "")
        {
            ...
            {
                this.Node = (MongodbSourceDescendantType)InterfaceHelper.CreateInstanceOfFirstType(typeof(MongodbSourceDescendantType));
    ...
    public static class ListMongodbSourceDescendantTypeEdgeExtensions
    {
        ...
        public static void ApplyExploratoryFragment(
            ...
            String parent = "")
        {
            var item = new MongodbSourceDescendantTypeEdge();
            list.Add(item);

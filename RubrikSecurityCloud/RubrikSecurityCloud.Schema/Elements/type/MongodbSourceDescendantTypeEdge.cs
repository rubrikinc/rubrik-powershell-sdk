...
namespace RubrikSecurityCloud.Types
{
    ...
    public class MongodbSourceDescendantTypeEdge: BaseType
    {
        ...
        [JsonProperty("node")]
        public RscInterface<MongodbSourceDescendantType> Node { get; set; }
    ...
    public MongodbSourceDescendantTypeEdge Set(
        RscInterface<MongodbSourceDescendantType> Node = null,
    ...
    public override void ApplyExploratoryFieldSpec(ExplorationContext ec)
    {
        ...
        if (ec.Includes("node",false))
        {
            if(this.Node == null) {
                ...
                this.Node = new RscInterface<MongodbSourceDescendantType>();
    ...
    public static class ListMongodbSourceDescendantTypeEdgeExtensions
    {
        ...
        public static List<string> SelectedFields(this List<MongodbSourceDescendantTypeEdge> list)
        {
        ...
        public static void SelectForRetrieval(this List<MongodbSourceDescendantTypeEdge> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface MosaicSnapshotGroupByInfo: IFieldSpec {} // class MosaicSnapshotGroupByInfo
    #endregion
    ...
    public static class ListMosaicSnapshotGroupByInfoExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (MosaicSnapshotGroupByInfo item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<MosaicSnapshotGroupByInfo> list)
        {
            ...
            AutofieldContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<MosaicSnapshotGroupByInfo>(
                        list, 

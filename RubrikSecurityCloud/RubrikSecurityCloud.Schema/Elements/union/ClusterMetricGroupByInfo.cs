...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface ClusterMetricGroupByInfo: IFieldSpec {} // class ClusterMetricGroupByInfo
    #endregion
    ...
    public static class ListClusterMetricGroupByInfoExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (ClusterMetricGroupByInfo item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<ClusterMetricGroupByInfo> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<ClusterMetricGroupByInfo>(
                        ref list, 
        ...
        public static void SelectForRetrieval(this List<ClusterMetricGroupByInfo> list)
        {

...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListTaskSummaryGroupByInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<TaskSummaryGroupByInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<TaskSummaryGroupByInfo> list)
        {

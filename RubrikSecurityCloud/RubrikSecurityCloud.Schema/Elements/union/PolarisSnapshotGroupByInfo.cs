...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface PolarisSnapshotGroupByInfo: IFieldSpec {} // class PolarisSnapshotGroupByInfo
    #endregion
    ...
    public static class ListPolarisSnapshotGroupByInfoExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (PolarisSnapshotGroupByInfo item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<PolarisSnapshotGroupByInfo> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<PolarisSnapshotGroupByInfo>(
                        ref list, 
        ...
        public static void SelectForRetrieval(this List<PolarisSnapshotGroupByInfo> list)
        {

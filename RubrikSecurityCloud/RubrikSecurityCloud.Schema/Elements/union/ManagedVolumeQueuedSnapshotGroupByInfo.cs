...
namespace RubrikSecurityCloud.Types
{
    ...
    public static class ListManagedVolumeQueuedSnapshotGroupByInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<ManagedVolumeQueuedSnapshotGroupByInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<ManagedVolumeQueuedSnapshotGroupByInfo> list)
        {

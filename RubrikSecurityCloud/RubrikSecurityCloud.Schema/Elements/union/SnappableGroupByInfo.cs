...
{
    #region SnappableGroupByInfo
    public interface SnappableGroupByInfo: IFieldSpec {} // class SnappableGroupByInfo
    #endregion

    public static class ListSnappableGroupByInfoExtensions
    {
        ...
        public static List<string> SelectedFields(this List<SnappableGroupByInfo> list)
        {
        ...
        public static void SelectForRetrieval(this List<SnappableGroupByInfo> list)
        {

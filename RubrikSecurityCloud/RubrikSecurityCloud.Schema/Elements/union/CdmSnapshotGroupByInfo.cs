...
namespace RubrikSecurityCloud.Types
{
    ...
    public interface CdmSnapshotGroupByInfo: IFieldSpec {} // class CdmSnapshotGroupByInfo
    #endregion
    ...
    public static class ListCdmSnapshotGroupByInfoExtensions
    {
            ...
            FieldSpecConfig? conf=null)
        {
            ...
            string fieldspecs = "";
            foreach (CdmSnapshotGroupByInfo item in list) 
            {
        ...
        public static List<string> SelectedFields(this List<CdmSnapshotGroupByInfo> list)
        {
            ...
            ExplorationContext ec)
        {
            if ( list.Count == 0 ) {
                InterfaceHelper
                    .AddInstancesOfImplementingTypes<CdmSnapshotGroupByInfo>(
                        ref list, 

...
{
    public enum IdentityAlertEventType
    {
        ...
        [EnumMember(Value = "EVENT_TYPE_IDENTITY_APP_ROLE_ASSIGNMENT_ADD")]
        EVENT_TYPE_IDENTITY_APP_ROLE_ASSIGNMENT_ADD,

        [EnumMember(Value = "EVENT_TYPE_IDENTITY_APP_ROLE_ASSIGNMENT_REMOVE")]
        EVENT_TYPE_IDENTITY_APP_ROLE_ASSIGNMENT_REMOVE,

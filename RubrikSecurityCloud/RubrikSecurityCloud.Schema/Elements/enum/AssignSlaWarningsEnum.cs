...
namespace RubrikSecurityCloud.Types
{
    public enum AssignSlaWarningsEnum
    {
        ...
        [EnumMember(Value = "CDP_ONLY_SLA_NOT_SUPPOERTED")]
        CDP_ONLY_SLA_NOT_SUPPOERTED,
        ...
        [EnumMember(Value = "CLUSTER_NOT_SOURCE_OF_SLA_REPLICATION_PAIR_WARNING")]
        CLUSTER_NOT_SOURCE_OF_SLA_REPLICATION_PAIR_WARNING,

        [EnumMember(Value = "CROSS_REGION_ARCHIVAL")]
        CROSS_REGION_ARCHIVAL,

        [EnumMember(Value = "DB2_CHANGE_RETENTION_NOT_SUPPORTED_WARNING")]
        DB2_CHANGE_RETENTION_NOT_SUPPORTED_WARNING,

        [EnumMember(Value = "DB2_RETENTION_LOCK_NOT_SUPPORTED_ON_CLUSTER_WARNING")]
        DB2_RETENTION_LOCK_NOT_SUPPORTED_ON_CLUSTER_WARNING,
        ...
        [EnumMember(Value = "INVALID_REPLICATION_TARGET_WARNING")]
        INVALID_REPLICATION_TARGET_WARNING,
        ...
        [EnumMember(Value = "READ_ONLY_SLA_NOT_SUPPORTED_WARNING")]
        READ_ONLY_SLA_NOT_SUPPORTED_WARNING,
        ...
        [EnumMember(Value = "REPLICATION_PAIRING_NOT_DONE_WARNING")]
        REPLICATION_PAIRING_NOT_DONE_WARNING,
        ...
        [EnumMember(Value = "RETENTION_LOCK_MODE_CONSTRAINTS_NOT_RESPECTED")]
        RETENTION_LOCK_MODE_CONSTRAINTS_NOT_RESPECTED,

        [EnumMember(Value = "RETENTION_LOCK_MODE_NOT_SUPPORTED")]
        RETENTION_LOCK_MODE_NOT_SUPPORTED,
        ...
        [EnumMember(Value = "SAP_HANA_STORAGE_SNAPSHOT_NOT_SUPPORTED_ON_CLUSTER_WARNING")]
        SAP_HANA_STORAGE_SNAPSHOT_NOT_SUPPORTED_ON_CLUSTER_WARNING,

        [EnumMember(Value = "SAP_HANA_STORAGE_SNAPSHOT_SLA_ASSIGNMENT_WARNING")]
        SAP_HANA_STORAGE_SNAPSHOT_SLA_ASSIGNMENT_WARNING,

        [EnumMember(Value = "SLA_BLOCK_MODE_ENABLED_WARNING")]
        SLA_BLOCK_MODE_ENABLED_WARNING,

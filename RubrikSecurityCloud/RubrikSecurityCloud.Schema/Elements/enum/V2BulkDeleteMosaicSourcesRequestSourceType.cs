// V2BulkDeleteMosaicSourcesRequestSourceType.cs
//
...
{
    public enum V2BulkDeleteMosaicSourcesRequestSourceType
    {
        [EnumMember(Value = "V2_BULK_DELETE_MOSAIC_SOURCES_REQUEST_SOURCE_TYPE_CASSANDRA")]

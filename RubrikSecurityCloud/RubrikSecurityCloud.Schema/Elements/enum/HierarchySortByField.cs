...
namespace RubrikSecurityCloud.Types
{
    public enum HierarchySortByField
    {
        ...
        [EnumMember(Value = "DB2_DATABASE_HOST_LIST")]
        DB2_DATABASE_HOST_LIST,
        ...
        [EnumMember(Value = "POWER_PLATFORM_APP_LAST_MODIFIED")]
        POWER_PLATFORM_APP_LAST_MODIFIED,

        [EnumMember(Value = "POWER_PLATFORM_APP_TYPE")]
        POWER_PLATFORM_APP_TYPE,

        [EnumMember(Value = "POWER_PLATFORM_FLOW_LAST_MODIFIED")]
        ...
        [EnumMember(Value = "S3_TABLES_ICEBERG_NAMESPACE_CATALOG_NAME")]
        S3_TABLES_ICEBERG_NAMESPACE_CATALOG_NAME,

        [EnumMember(Value = "S3_TABLES_ICEBERG_TABLE_AWS_ACCOUNT_NAME")]
        S3_TABLES_ICEBERG_TABLE_AWS_ACCOUNT_NAME,

        [EnumMember(Value = "S3_TABLES_ICEBERG_TABLE_CATALOG_NAME")]
        S3_TABLES_ICEBERG_TABLE_CATALOG_NAME,

        [EnumMember(Value = "S3_TABLES_ICEBERG_TABLE_NAMESPACE_NAME")]
        ...
        [EnumMember(Value = "UNMANAGED_OBJECTS_DOWNLOADED_SNAPSHOTS_BYTES")]

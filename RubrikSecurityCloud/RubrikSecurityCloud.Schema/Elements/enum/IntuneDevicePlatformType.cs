...
namespace RubrikSecurityCloud.Types
{
    public enum IntuneDevicePlatformType
    {
        ...
        [EnumMember(Value = "INTUNE_DEVICE_PLATFORM_TYPE_WINDOWS_8")]

...
namespace RubrikSecurityCloud.Types
{
    public enum SnapshotCloudStorageTier
    {
        ...
        [EnumMember(Value = "SNAPSHOT_CLOUD_STORAGE_TIER_GCP_ARCHIVE")]
        SNAPSHOT_CLOUD_STORAGE_TIER_GCP_ARCHIVE,

        [EnumMember(Value = "SNAPSHOT_CLOUD_STORAGE_TIER_GCP_COLDLINE")]
        SNAPSHOT_CLOUD_STORAGE_TIER_GCP_COLDLINE,

        [EnumMember(Value = "SNAPSHOT_CLOUD_STORAGE_TIER_GCP_NEARLINE")]

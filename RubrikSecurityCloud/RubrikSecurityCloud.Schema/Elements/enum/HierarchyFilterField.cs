...
namespace RubrikSecurityCloud.Types
{
    public enum HierarchyFilterField
    {
        ...
        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_BLOB_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_BLOB_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_MANAGED_DISK_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_MANAGED_DISK_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_DATABASE_DB_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_DATABASE_DB_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_DATABASE_SERVER_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_DATABASE_SERVER_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_MI_DB_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_MI_DB_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_MI_SERVER_PROTECTION")]
        AZURE_NATIVE_IS_ELIGIBLE_FOR_SQL_MI_SERVER_PROTECTION,

        [EnumMember(Value = "AZURE_NATIVE_IS_ELIGIBLE_FOR_VM_PROTECTION")]
        ...
        [EnumMember(Value = "DOMAIN_CONTROLLER_BY_GUID")]

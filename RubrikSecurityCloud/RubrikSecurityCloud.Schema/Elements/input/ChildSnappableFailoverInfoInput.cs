// ChildSnappableFailoverInfoInput.cs
//
...
{
    #region ChildSnappableFailoverInfoInput

    public class ChildSnappableFailoverInfoInput: IInput
    {
        #region members
    ...
    } // class ChildSnappableFailoverInfoInput
    #endregion

// UpdateManualTargetMappingInput.cs
//
...
{
    #region UpdateManualTargetMappingInput

    public class UpdateManualTargetMappingInput: IInput
    {
        #region members
    ...
    } // class UpdateManualTargetMappingInput
    #endregion

// WebhookEncodedAuthInfoV2Input.cs
//
...
{
    #region WebhookEncodedAuthInfoV2Input

    public class WebhookEncodedAuthInfoV2Input: IInput
    {
        #region members
    ...
    } // class WebhookEncodedAuthInfoV2Input
    #endregion

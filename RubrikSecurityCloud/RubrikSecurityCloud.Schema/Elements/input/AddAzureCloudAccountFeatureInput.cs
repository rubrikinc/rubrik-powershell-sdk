// AddAzureCloudAccountFeatureInput.cs
//
...
{
    #region AddAzureCloudAccountFeatureInput

    public class AddAzureCloudAccountFeatureInput: IInput
    {
        #region members
    ...
    } // class AddAzureCloudAccountFeatureInput
    #endregion

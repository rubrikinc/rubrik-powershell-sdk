// MysqldbAdvancedConfigInfoInput.cs
//
...
{
    #region MysqldbAdvancedConfigInfoInput

    public class MysqldbAdvancedConfigInfoInput: IInput
    {
        #region members
    ...
    } // class MysqldbAdvancedConfigInfoInput
    #endregion

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class TurboThreatHuntConfig: IInput
    {
        ...
        //      C# -> List<ScanObjectsConfig>? ObjectsToScan
        // GraphQL -> objectsToScan: [ScanObjectsConfig!] (input)
        [JsonProperty("objectsToScan")]
        public List<ScanObjectsConfig>? ObjectsToScan { get; set; }

...
{
    #region ConfirmPartUploadInput

    public class ConfirmPartUploadInput: IInput
    {
        #region members
        ...
        //      C# -> System.String? Etag
        // GraphQL -> etag: String (scalar)
        [JsonProperty("etag")]

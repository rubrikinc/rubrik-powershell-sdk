// GetKeyVersionsOfAzureKeyInput.cs
//
...
{
    #region GetKeyVersionsOfAzureKeyInput

    public class GetKeyVersionsOfAzureKeyInput: IInput
    {
        #region members
    ...
    } // class GetKeyVersionsOfAzureKeyInput
    #endregion

// MongoSourceAddRequestConfigInput.cs
//
...
{
    #region MongoSourceAddRequestConfigInput

    public class MongoSourceAddRequestConfigInput: IInput
    {
        #region members
    ...
    } // class MongoSourceAddRequestConfigInput
    #endregion

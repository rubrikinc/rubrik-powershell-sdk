// CheckAzureMarketplaceTermsReq.cs
//
...
{
    #region CheckAzureMarketplaceTermsReq

    public class CheckAzureMarketplaceTermsReq: IInput
    {
        #region members
    ...
    } // class CheckAzureMarketplaceTermsReq
    #endregion

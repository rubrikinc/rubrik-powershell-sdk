// MssqlWindowsClusterUpdateInput.cs
//
...
{
    #region MssqlWindowsClusterUpdateInput

    public class MssqlWindowsClusterUpdateInput: IInput
    {
        #region members
    ...
    } // class MssqlWindowsClusterUpdateInput
    #endregion

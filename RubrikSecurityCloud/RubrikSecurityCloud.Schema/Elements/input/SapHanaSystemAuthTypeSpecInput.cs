// SapHanaSystemAuthTypeSpecInput.cs
//
...
{
    #region SapHanaSystemAuthTypeSpecInput

    public class SapHanaSystemAuthTypeSpecInput: IInput
    {
        #region members
    ...
    } // class SapHanaSystemAuthTypeSpecInput
    #endregion

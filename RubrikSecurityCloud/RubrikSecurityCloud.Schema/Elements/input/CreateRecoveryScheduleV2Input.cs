// CreateRecoveryScheduleV2Input.cs
//
...
{
    #region CreateRecoveryScheduleV2Input

    public class CreateRecoveryScheduleV2Input: IInput
    {
        #region members
    ...
    } // class CreateRecoveryScheduleV2Input
    #endregion

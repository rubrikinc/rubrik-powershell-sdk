// PrivateContainerRegistryInput.cs
//
...
{
    #region PrivateContainerRegistryInput

    public class PrivateContainerRegistryInput: IInput
    {
        #region members
    ...
    } // class PrivateContainerRegistryInput
    #endregion

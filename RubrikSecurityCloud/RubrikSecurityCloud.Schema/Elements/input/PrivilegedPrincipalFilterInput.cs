// PrivilegedPrincipalFilterInput.cs
//
...
{
    #region PrivilegedPrincipalFilterInput

    public class PrivilegedPrincipalFilterInput: IInput
    {
        #region members
    ...
    } // class PrivilegedPrincipalFilterInput
    #endregion

// AzureKeyVaultKeyIdentifierInput.cs
//
...
{
    #region AzureKeyVaultKeyIdentifierInput

    public class AzureKeyVaultKeyIdentifierInput: IInput
    {
        #region members
    ...
    } // class AzureKeyVaultKeyIdentifierInput
    #endregion

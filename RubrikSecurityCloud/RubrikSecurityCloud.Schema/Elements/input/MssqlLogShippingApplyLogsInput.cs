// MssqlLogShippingApplyLogsInput.cs
//
...
{
    #region MssqlLogShippingApplyLogsInput

    public class MssqlLogShippingApplyLogsInput: IInput
    {
        #region members
    ...
    } // class MssqlLogShippingApplyLogsInput
    #endregion

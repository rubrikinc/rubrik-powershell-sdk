// AssignSlasForWorkloadHierarchiesInput.cs
//
...
{
    #region AssignSlasForWorkloadHierarchiesInput

    public class AssignSlasForWorkloadHierarchiesInput: IInput
    {
        #region members
        ...
        //      C# -> List<WorkloadLevelHierarchy>? ApplicableWorkloadTypes
        // GraphQL -> applicableWorkloadTypes: [WorkloadLevelHierarchy!] (enum)
        [JsonProperty("applicableWorkloadTypes")]
        public List<WorkloadLevelHierarchy>? ApplicableWorkloadTypes { get; set; }
    ...
    } // class AssignSlasForWorkloadHierarchiesInput
    #endregion

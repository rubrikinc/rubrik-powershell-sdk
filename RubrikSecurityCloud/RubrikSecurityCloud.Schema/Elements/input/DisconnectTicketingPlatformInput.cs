// DisconnectTicketingPlatformInput.cs
//
...
{
    #region DisconnectTicketingPlatformInput

    public class DisconnectTicketingPlatformInput: IInput
    {
        #region members
    ...
    } // class DisconnectTicketingPlatformInput
    #endregion

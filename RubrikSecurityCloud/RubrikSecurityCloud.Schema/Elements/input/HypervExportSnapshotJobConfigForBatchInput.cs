// HypervExportSnapshotJobConfigForBatchInput.cs
//
...
{
    #region HypervExportSnapshotJobConfigForBatchInput

    public class HypervExportSnapshotJobConfigForBatchInput: IInput
    {
        #region members
        ...
        //      C# -> HypervExportSnapshotJobConfigInput? ExportConfig
        // GraphQL -> exportConfig: HypervExportSnapshotJobConfigInput! (input)
        [Required]
        [JsonRequired]
        [JsonProperty("exportConfig")]
        public HypervExportSnapshotJobConfigInput? ExportConfig { get; set; }
    ...
    } // class HypervExportSnapshotJobConfigForBatchInput
    #endregion

// SmbTrustedDomainToUsersMapInput.cs
//
...
{
    #region SmbTrustedDomainToUsersMapInput

    public class SmbTrustedDomainToUsersMapInput: IInput
    {
        #region members
    ...
    } // class SmbTrustedDomainToUsersMapInput
    #endregion

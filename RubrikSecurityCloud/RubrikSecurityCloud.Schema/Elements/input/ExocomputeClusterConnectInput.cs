// ExocomputeClusterConnectInput.cs
//
...
{
    #region ExocomputeClusterConnectInput

    public class ExocomputeClusterConnectInput: IInput
    {
        #region members
    ...
    } // class ExocomputeClusterConnectInput
    #endregion

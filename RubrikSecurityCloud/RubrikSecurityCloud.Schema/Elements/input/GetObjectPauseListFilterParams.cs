// GetObjectPauseListFilterParams.cs
//
...
{
    #region GetObjectPauseListFilterParams

    public class GetObjectPauseListFilterParams: IInput
    {
        #region members
    ...
    } // class GetObjectPauseListFilterParams
    #endregion

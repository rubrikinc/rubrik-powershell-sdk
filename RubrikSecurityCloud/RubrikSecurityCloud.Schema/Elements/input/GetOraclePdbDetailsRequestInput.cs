// GetOraclePdbDetailsRequestInput.cs
//
...
{
    #region GetOraclePdbDetailsRequestInput

    public class GetOraclePdbDetailsRequestInput: IInput
    {
        #region members
    ...
    } // class GetOraclePdbDetailsRequestInput
    #endregion

...
namespace RubrikSecurityCloud.Types
{
    ...
    public class PostgresDbClusterConfigInput: IInput
    {
        ...
        //      C# -> PostgresHaClusterConfigInput? HaClusterConfig
        // GraphQL -> haClusterConfig: PostgresHaClusterConfigInput (input)
        [JsonProperty("haClusterConfig")]
        public PostgresHaClusterConfigInput? HaClusterConfig { get; set; }

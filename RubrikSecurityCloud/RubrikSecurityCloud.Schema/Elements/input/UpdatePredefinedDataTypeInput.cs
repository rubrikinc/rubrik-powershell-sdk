// UpdatePredefinedDataTypeInput.cs
//
...
{
    #region UpdatePredefinedDataTypeInput

    public class UpdatePredefinedDataTypeInput: IInput
    {
        #region members
    ...
    } // class UpdatePredefinedDataTypeInput
    #endregion

// JiraSettingsChangeDetailsFilter.cs
//
...
{
    #region JiraSettingsChangeDetailsFilter

    public class JiraSettingsChangeDetailsFilter: IInput
    {
        #region members
    ...
    } // class JiraSettingsChangeDetailsFilter
    #endregion

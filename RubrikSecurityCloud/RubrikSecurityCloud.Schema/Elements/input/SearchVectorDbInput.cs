...
{
    #region SearchVectorDbInput

    public class SearchVectorDbInput: IInput
    {
        #region members

        //      C# -> System.String? ChatbotId
        // GraphQL -> chatbotId: UUID! (scalar)
        [Required]
        [JsonRequired]

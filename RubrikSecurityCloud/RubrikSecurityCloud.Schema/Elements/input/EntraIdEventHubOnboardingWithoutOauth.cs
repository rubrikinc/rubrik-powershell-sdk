// EntraIdEventHubOnboardingWithoutOauth.cs
//
...
{
    #region EntraIdEventHubOnboardingWithoutOauth

    public class EntraIdEventHubOnboardingWithoutOauth: IInput
    {
        #region members
        ...
        //      C# -> System.String? EventHubName
        // GraphQL -> eventHubName: String! (scalar)
        [Required]
        [JsonRequired]
        [JsonProperty("eventHubName")]
        public System.String? EventHubName { get; set; }
    ...
    } // class EntraIdEventHubOnboardingWithoutOauth
    #endregion

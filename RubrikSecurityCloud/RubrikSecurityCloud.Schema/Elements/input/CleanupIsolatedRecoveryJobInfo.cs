// CleanupIsolatedRecoveryJobInfo.cs
//
...
{
    #region CleanupIsolatedRecoveryJobInfo

    public class CleanupIsolatedRecoveryJobInfo: IInput
    {
        #region members
    ...
    } // class CleanupIsolatedRecoveryJobInfo
    #endregion

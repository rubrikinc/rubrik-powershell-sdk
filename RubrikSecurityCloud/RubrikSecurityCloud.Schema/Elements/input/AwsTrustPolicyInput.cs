...
{
    #region AwsTrustPolicyInput

    public class AwsTrustPolicyInput: IInput
    {
        #region members
        ...
        //      C# -> List<AwsNativeAccountInput>? AwsNativeAccounts
        // GraphQL -> awsNativeAccounts: [AwsNativeAccountInput!]! (input)
        [Required]
        [JsonRequired]

// FilesetExportSnapshotFilesInput.cs
//
...
{
    #region FilesetExportSnapshotFilesInput

    public class FilesetExportSnapshotFilesInput: IInput
    {
        #region members
    ...
    } // class FilesetExportSnapshotFilesInput
    #endregion

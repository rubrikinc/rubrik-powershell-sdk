// DownloadManagedVolumeFilesInput.cs
//
...
{
    #region DownloadManagedVolumeFilesInput

    public class DownloadManagedVolumeFilesInput: IInput
    {
        #region members
    ...
    } // class DownloadManagedVolumeFilesInput
    #endregion

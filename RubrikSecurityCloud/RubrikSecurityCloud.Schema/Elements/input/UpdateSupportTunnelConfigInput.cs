// UpdateSupportTunnelConfigInput.cs
//
...
{
    #region UpdateSupportTunnelConfigInput

    public class UpdateSupportTunnelConfigInput: IInput
    {
        #region members
    ...
    } // class UpdateSupportTunnelConfigInput
    #endregion

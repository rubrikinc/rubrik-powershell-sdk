...
{
    #region MariadbSlaConfigInput

    public class MariadbSlaConfigInput: IInput
    {
        #region members
        ...
        //      C# -> SlaDurationInput? DifferentialRetention
        // GraphQL -> differentialRetention: SlaDurationInput (input)
        [JsonProperty("differentialRetention")]
        public SlaDurationInput? DifferentialRetention { get; set; }

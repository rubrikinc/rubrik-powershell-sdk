// DeleteSnapshotsOfObjectsInput.cs
//
...
{
    #region DeleteSnapshotsOfObjectsInput

    public class DeleteSnapshotsOfObjectsInput: IInput
    {
        #region members
    ...
    } // class DeleteSnapshotsOfObjectsInput
    #endregion

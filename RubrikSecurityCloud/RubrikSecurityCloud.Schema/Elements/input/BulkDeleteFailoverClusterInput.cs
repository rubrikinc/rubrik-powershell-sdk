// BulkDeleteFailoverClusterInput.cs
//
...
{
    #region BulkDeleteFailoverClusterInput

    public class BulkDeleteFailoverClusterInput: IInput
    {
        #region members
    ...
    } // class BulkDeleteFailoverClusterInput
    #endregion

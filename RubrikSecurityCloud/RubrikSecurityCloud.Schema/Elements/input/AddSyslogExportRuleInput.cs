...
namespace RubrikSecurityCloud.Types
{
    ...
    public class AddSyslogExportRuleInput: IInput
    {
        ...
        //      C# -> SyslogExportRuleFullInput? SyslogExportRuleV94
        // GraphQL -> syslogExportRuleV94: SyslogExportRuleFullInput (input)
        [JsonProperty("syslogExportRuleV94")]
        public SyslogExportRuleFullInput? SyslogExportRuleV94 { get; set; }

        //      C# -> SyslogExportRuleFullInput? SyslogExportRuleV95
        // GraphQL -> syslogExportRuleV95: SyslogExportRuleFullInput (input)
        [JsonProperty("syslogExportRuleV95")]
        public SyslogExportRuleFullInput? SyslogExportRuleV95 { get; set; }

        //      C# -> SyslogExportRuleFullInput? SyslogExportRuleV96
        // GraphQL -> syslogExportRuleV96: SyslogExportRuleFullInput (input)
        [JsonProperty("syslogExportRuleV96")]
        public SyslogExportRuleFullInput? SyslogExportRuleV96 { get; set; }

        //      C# -> SyslogExportRuleFullInput? SyslogExportRuleV97
        // GraphQL -> syslogExportRuleV97: SyslogExportRuleFullInput (input)
        [JsonProperty("syslogExportRuleV97")]
        public SyslogExportRuleFullInput? SyslogExportRuleV97 { get; set; }

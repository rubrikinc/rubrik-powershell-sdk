// AzureNativeSubscriptionFilters.cs
//
...
{
    #region AzureNativeSubscriptionFilters

    public class AzureNativeSubscriptionFilters: IInput
    {
        #region members
    ...
    } // class AzureNativeSubscriptionFilters
    #endregion

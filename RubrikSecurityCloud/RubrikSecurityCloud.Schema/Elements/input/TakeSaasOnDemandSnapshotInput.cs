// TakeSaasOnDemandSnapshotInput.cs
//
...
{
    #region TakeSaasOnDemandSnapshotInput

    public class TakeSaasOnDemandSnapshotInput: IInput
    {
        #region members
    ...
    } // class TakeSaasOnDemandSnapshotInput
    #endregion

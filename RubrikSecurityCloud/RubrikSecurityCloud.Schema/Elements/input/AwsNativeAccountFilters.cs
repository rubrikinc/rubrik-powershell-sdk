...
{
    #region AwsNativeAccountFilters

    public class AwsNativeAccountFilters: IInput
    {
        #region members
        ...
        //      C# -> AwsCloudTypeFilter? CloudTypeFilter
        // GraphQL -> cloudTypeFilter: AwsCloudTypeFilter (input)

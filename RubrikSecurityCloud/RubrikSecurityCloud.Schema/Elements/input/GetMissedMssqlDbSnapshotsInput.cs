// GetMissedMssqlDbSnapshotsInput.cs
//
...
{
    #region GetMissedMssqlDbSnapshotsInput

    public class GetMissedMssqlDbSnapshotsInput: IInput
    {
        #region members
    ...
    } // class GetMissedMssqlDbSnapshotsInput
    #endregion

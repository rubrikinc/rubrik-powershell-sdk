// NutanixMountSnapshotJobConfigForBatchInput.cs
//
...
{
    #region NutanixMountSnapshotJobConfigForBatchInput

    public class NutanixMountSnapshotJobConfigForBatchInput: IInput
    {
        #region members
        ...
        //      C# -> NutanixVmMountSnapshotJobConfigInput? MountConfig
        // GraphQL -> mountConfig: NutanixVmMountSnapshotJobConfigInput! (input)
        [Required]
        [JsonRequired]
        [JsonProperty("mountConfig")]
        public NutanixVmMountSnapshotJobConfigInput? MountConfig { get; set; }
    ...
    } // class NutanixMountSnapshotJobConfigForBatchInput
    #endregion

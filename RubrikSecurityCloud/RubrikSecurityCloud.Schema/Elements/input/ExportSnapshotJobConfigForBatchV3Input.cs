// ExportSnapshotJobConfigForBatchV3Input.cs
//
...
{
    #region ExportSnapshotJobConfigForBatchV3Input

    public class ExportSnapshotJobConfigForBatchV3Input: IInput
    {
        #region members
        ...
        //      C# -> ExportSnapshotJobConfigV3Input? Config
        // GraphQL -> config: ExportSnapshotJobConfigV3Input! (input)
        [Required]
        [JsonRequired]
        [JsonProperty("config")]
        public ExportSnapshotJobConfigV3Input? Config { get; set; }
    ...
    } // class ExportSnapshotJobConfigForBatchV3Input
    #endregion

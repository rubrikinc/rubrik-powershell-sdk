// VsphereVmRecoveryRangeStatusReq.cs
//
...
{
    #region VsphereVmRecoveryRangeStatusReq

    public class VsphereVmRecoveryRangeStatusReq: IInput
    {
        #region members
    ...
    } // class VsphereVmRecoveryRangeStatusReq
    #endregion

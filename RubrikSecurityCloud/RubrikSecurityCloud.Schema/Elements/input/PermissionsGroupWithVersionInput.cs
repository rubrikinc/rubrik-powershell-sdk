// PermissionsGroupWithVersionInput.cs
//
...
{
    #region PermissionsGroupWithVersionInput

    public class PermissionsGroupWithVersionInput: IInput
    {
        #region members
    ...
    } // class PermissionsGroupWithVersionInput
    #endregion

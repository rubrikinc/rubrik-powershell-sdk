// CompleteAzureAdAppUpdateInput.cs
//
...
{
    #region CompleteAzureAdAppUpdateInput

    public class CompleteAzureAdAppUpdateInput: IInput
    {
        #region members
    ...
    } // class CompleteAzureAdAppUpdateInput
    #endregion

// ListWorkloadResourceSpecsInput.cs
//
...
{
    #region ListWorkloadResourceSpecsInput

    public class ListWorkloadResourceSpecsInput: IInput
    {
        #region members
    ...
    } // class ListWorkloadResourceSpecsInput
    #endregion

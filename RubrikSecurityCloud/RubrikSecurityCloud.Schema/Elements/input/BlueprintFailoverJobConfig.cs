...
namespace RubrikSecurityCloud.Types
{
    ...
    public class BlueprintFailoverJobConfig: IInput
    {
        ...
        //      C# -> SourceWorkloadActionAfterFailover? SourceWorkloadActionAfterFailover
        // GraphQL -> sourceWorkloadActionAfterFailover: SourceWorkloadActionAfterFailover (enum)
        [JsonProperty("sourceWorkloadActionAfterFailover")]
        public SourceWorkloadActionAfterFailover? SourceWorkloadActionAfterFailover { get; set; }

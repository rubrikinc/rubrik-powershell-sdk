// UpdateConfigProtectionSetupInput.cs
//
...
{
    #region UpdateConfigProtectionSetupInput

    public class UpdateConfigProtectionSetupInput: IInput
    {
        #region members
    ...
    } // class UpdateConfigProtectionSetupInput
    #endregion

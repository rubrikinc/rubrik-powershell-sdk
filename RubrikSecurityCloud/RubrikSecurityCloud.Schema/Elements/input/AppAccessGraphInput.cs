...
{
    #region AppAccessGraphInput

    public class AppAccessGraphInput: IInput
    {
        #region members
        ...
        //      C# -> System.String? GroupFilter
        // GraphQL -> groupFilter: String (scalar)
        [JsonProperty("groupFilter")]
        public System.String? GroupFilter { get; set; }

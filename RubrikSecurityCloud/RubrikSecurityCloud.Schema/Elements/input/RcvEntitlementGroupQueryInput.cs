// RcvEntitlementGroupQueryInput.cs
//
...
{
    #region RcvEntitlementGroupQueryInput

    public class RcvEntitlementGroupQueryInput: IInput
    {
        #region members
    ...
    } // class RcvEntitlementGroupQueryInput
    #endregion

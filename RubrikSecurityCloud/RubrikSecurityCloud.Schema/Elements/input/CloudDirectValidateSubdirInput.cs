// CloudDirectValidateSubdirInput.cs
//
...
{
    #region CloudDirectValidateSubdirInput

    public class CloudDirectValidateSubdirInput: IInput
    {
        #region members
    ...
    } // class CloudDirectValidateSubdirInput
    #endregion

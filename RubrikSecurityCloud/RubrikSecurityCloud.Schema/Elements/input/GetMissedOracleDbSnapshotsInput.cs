// GetMissedOracleDbSnapshotsInput.cs
//
...
{
    #region GetMissedOracleDbSnapshotsInput

    public class GetMissedOracleDbSnapshotsInput: IInput
    {
        #region members
    ...
    } // class GetMissedOracleDbSnapshotsInput
    #endregion

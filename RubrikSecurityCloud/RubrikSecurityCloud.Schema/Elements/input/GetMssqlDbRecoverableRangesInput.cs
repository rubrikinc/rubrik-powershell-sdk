// GetMssqlDbRecoverableRangesInput.cs
//
...
{
    #region GetMssqlDbRecoverableRangesInput

    public class GetMssqlDbRecoverableRangesInput: IInput
    {
        #region members
    ...
    } // class GetMssqlDbRecoverableRangesInput
    #endregion

// CreateOnDemandNutanixBackupInput.cs
//
...
{
    #region CreateOnDemandNutanixBackupInput

    public class CreateOnDemandNutanixBackupInput: IInput
    {
        #region members
    ...
    } // class CreateOnDemandNutanixBackupInput
    #endregion

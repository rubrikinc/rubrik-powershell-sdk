// CompleteSaasAppAuthConsentInput.cs
//
...
{
    #region CompleteSaasAppAuthConsentInput

    public class CompleteSaasAppAuthConsentInput: IInput
    {
        #region members
    ...
    } // class CompleteSaasAppAuthConsentInput
    #endregion

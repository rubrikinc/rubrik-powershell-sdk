// SapHanaOnDemandBackupConfigInput.cs
//
...
{
    #region SapHanaOnDemandBackupConfigInput

    public class SapHanaOnDemandBackupConfigInput: IInput
    {
        #region members
    ...
    } // class SapHanaOnDemandBackupConfigInput
    #endregion

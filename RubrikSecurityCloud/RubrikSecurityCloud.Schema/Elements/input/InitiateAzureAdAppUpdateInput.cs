// InitiateAzureAdAppUpdateInput.cs
//
...
{
    #region InitiateAzureAdAppUpdateInput

    public class InitiateAzureAdAppUpdateInput: IInput
    {
        #region members
    ...
    } // class InitiateAzureAdAppUpdateInput
    #endregion

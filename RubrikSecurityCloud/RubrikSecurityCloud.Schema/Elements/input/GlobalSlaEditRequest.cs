...
{
    #region GlobalSlaEditRequest

    public class GlobalSlaEditRequest: IInput
    {
        #region members
        ...
        //      C# -> ArchivalSpecInput? ArchivalSpecInput
        // GraphQL -> archivalSpecInput: ArchivalSpecInput (input)
        [JsonProperty("archivalSpecInput")]
        public ArchivalSpecInput? ArchivalSpecInput { get; set; }
        ...
        //      C# -> List<ReplicationSpecV2Input>? ReplicationSpecV2List
        // GraphQL -> replicationSpecV2List: [ReplicationSpecV2Input!] (input)
        [JsonProperty("replicationSpecV2List")]
        public List<ReplicationSpecV2Input>? ReplicationSpecV2List { get; set; }

        //      C# -> List<ArchivalSpecInput>? ArchivalSpecInputs
        // GraphQL -> archivalSpecInputs: [ArchivalSpecInput!] (input)
        [JsonProperty("archivalSpecInputs")]
        public List<ArchivalSpecInput>? ArchivalSpecInputs { get; set; }

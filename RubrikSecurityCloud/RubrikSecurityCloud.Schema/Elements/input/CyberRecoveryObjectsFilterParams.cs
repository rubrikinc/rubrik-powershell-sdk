...
namespace RubrikSecurityCloud.Types
{
    ...
    public class CyberRecoveryObjectsFilterParams: IInput
    {
        ...
        //      C# -> WorkloadStatus? SnappableStatus
        // GraphQL -> snappableStatus: WorkloadStatus (enum)
        [JsonProperty("snappableStatus")]
        public WorkloadStatus? SnappableStatus { get; set; }

        //      C# -> System.Boolean? ShouldIncludeReplica
        // GraphQL -> shouldIncludeReplica: Boolean (scalar)
        [JsonProperty("shouldIncludeReplica")]
        public System.Boolean? ShouldIncludeReplica { get; set; }

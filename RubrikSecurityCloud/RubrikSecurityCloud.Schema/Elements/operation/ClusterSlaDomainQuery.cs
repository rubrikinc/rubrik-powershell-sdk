...
namespace Rubrik.SecurityCloud.Operations {
    public class ClusterSlaDomainQuery {
      /// <summary>
      /// ClusterSlaDomainQuery.Request 
      /// </summary>
      public static GraphQLRequest Request() {
        return new GraphQLRequest {
          Query = ClusterSlaDomainDocument,
          OperationName = "ClusterSlaDomain"
        };
      }

      
      public static string ClusterSlaDomainDocument = @"

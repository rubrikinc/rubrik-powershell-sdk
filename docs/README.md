# RSC PowerShell SDK Documentation

[API Docs](https://rubrikinc.github.io/rubrik-api-documentation/)

## Start Here

Recommended reading order for new users:

1. [README](../README.md) — install the SDK and connect to RSC
2. [Developer Manual](developer_manual.md) — cmdlet overview, first queries
...
|----------------------------------------------------------------|----------------------------------------------------------------|
| [Developer Manual](developer_manual.md)                        | Getting started, cmdlet overview, working with queries         |
...
| Document                                             | Description                                                |
|------------------------------------------------------|------------------------------------------------------------|
| [Domains and Operations](domains_and_operations.md)  | Auto-generated list of all API domains and their operations |

...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| Entities | Lists all the user-created archival entities. This includes data center archival targets and cloud-native archival target mappings. | `New-RscQueryArchival -Operation Entities`<BR> | [archivalEntities](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| FailoverGroupLocations | Get all archival locations for a given failover group. | `New-RscQueryArchival -Operation FailoverGroupLocations`<BR> | [failoverGroupArchivalLocations](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Migration | Retrieves the current migration status and target location  
details for a given source archival location. | `New-RscQueryArchival -Operation Migration`<BR> | [archivalMigration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| PerObjectInfo | Get archival information for all objects with data archived to the specified location. | `New-RscQueryArchival -Operation PerObjectInfo`<BR> | [archivalPerObjectInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ReaderInfo | GetArchivalReaderInfo returns information about the requested  
...
an owner location or a reader location. | `New-RscQueryArchival -Operation ReaderInfo`<BR> | [archivalReaderInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| FilesetDownloadSnapshotFilesFromLocation | Initiate a job to download files or folders  
...
| FinishMigration | Finishes an archival migration by swapping the source location's  
...
or an inconsistent location state. | `New-RscMutationArchival -Operation FinishMigration`<BR> | [finishArchivalMigration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TerminateMigration | Terminates an in-progress archival migration,  
marking the migration as cancelled. | `New-RscMutationArchival -Operation TerminateMigration`<BR> | [terminateArchivalMigration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BatchSupportedRdsDatabaseInstanceClasses | Batch query to list all the database instance classes supported by AWS RDS database for multiple DB engine and engine version combinations. | `New-RscQueryAws -Operation BatchSupportedRdsDatabaseInstanceClasses`<BR> | [batchSupportedAwsRdsDatabaseInstanceClasses](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| MarketplaceSubscriptionInfo | Check AWS marketplace subscription status for a given CDM version. | `New-RscQueryAws -Operation MarketplaceSubscriptionInfo`<BR> | [awsMarketplaceSubscriptionInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ValidatePermissions | AwsValidatePermissions validates the permissions for the  
given AWS cloud accounts. | `New-RscQueryAws -Operation ValidatePermissions`<BR> | [awsValidatePermissions](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudAccountsMigrateInitiate | Generate CFT for migrating an existing AWS cloud accounts to AWS organizations. | `New-RscMutationAws -Operation CloudAccountsMigrateInitiate`<BR> | [awsCloudAccountsMigrateInitiate](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ExocomputeNetworkSetupTemplate | GetAzureExocomputeNetworkSetupTemplate retrieves the ARM templates for  
creating VNet, Subnet, and NSG in the regions provided in the request. | `New-RscQueryAzure -Operation ExocomputeNetworkSetupTemplate`<BR> | [azureExocomputeNetworkSetupTemplate](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ListManagementGroups | AzureListManagementGroups lists all the management groups that a user  
has read access to. | `New-RscQueryAzure -Operation ListManagementGroups`<BR> | [azureListManagementGroups](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RcvBliMigrationDetails | ListRCVAzureBLIMigrationDetails lists blob immutability migration details  
of RCV Azure locations. | `New-RscQueryAzure -Operation RcvBliMigrationDetails`<BR> | [rcvAzureBliMigrationDetails](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudAccountAddWithCustomerAppInitiate | AzureCloudAccountAddWithCustomerAppInitiate adds a cloud account using customer app  
...
service principal of the Rubrik multi-tenant app. | `New-RscMutationAzure -Operation CloudAccountAddWithCustomerAppInitiate`<BR> | [azureCloudAccountAddWithCustomerAppInitiate](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| KeyVaultsByRegionFromAzure | Retrieves a list of all key vaults in the specified region and subscription. This is required for enabling cross region export of ADE Enabled VMs. For more information, see https://learn.microsoft.com/en-us/azure/key-vault. | `New-RscQueryAzureNative -Operation KeyVaultsByRegionFromAzure`<BR> | [allAzureNativeKeyVaultsByRegionFromAzure](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Regions | Retrieves a paginated list of all Azure Native Regions. | `New-RscQueryAzureNative -Operation Regions`<BR> | [azureNativeRegions](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ResourceGroupForSql | Retrieves an Azure Native Resource Group for SQL Workloads. Refers to a collection of resources in which multiple Azure services can reside. | `New-RscQueryAzureNative -Operation ResourceGroupForSql`<BR> | [azureNativeResourceGroupForSql](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ObjectStoreSnapshotRegexSearch | Searches the object store snapshot using regex pattern matching on the  
directory field. | `New-RscQueryCloudNative -Operation ObjectStoreSnapshotRegexSearch`<BR> | [cloudNativeObjectStoreSnapshotRegexSearch](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TagRulesObjectType | GetCloudNativeTagRulesObjectType returns the object type of the cloud  
native tag rule. | `New-RscQueryCloudNative -Operation TagRulesObjectType`<BR> | [cloudNativeTagRulesObjectType](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateRootThreatMonitoringEnablement | Update Threat Monitoring enablement for cloud native roots. | `New-RscMutationCloudNative -Operation UpdateRootThreatMonitoringEnablement`<BR> | [updateCloudNativeRootThreatMonitoringEnablement](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectClusterLambdaConfig | Query Cloud Direct NAS clusters for Threat Monitoring. | `New-RscQueryCluster -Operation CloudDirectClusterLambdaConfig`<BR> | [cloudDirectClusterLambdaConfig](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Count | Count Rubrik clusters grouped by status. | `New-RscQueryCluster -Operation Count`<BR> | [countClusters](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ExocomputeGetClusterConnectionInfo | Obtains the YAML file needed to connect a customer-managed cluster to RSC. | `New-RscQueryCluster -Operation ExocomputeGetClusterConnectionInfo`<BR> | [exocomputeGetClusterConnectionInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| IsCloudClusterDiskUpgradeAvailable | Check if an upgrade is available for cloud cluster disks. | `New-RscQueryCluster -Operation IsCloudClusterDiskUpgradeAvailable`<BR> | [isCloudClusterDiskUpgradeAvailable](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| IsRemoveClusterTprConfigured | Check if Remove Cluster Authorization policy is set on the  cluster. | `New-RscQueryCluster -Operation IsRemoveClusterTprConfigured`<BR> | [isRemoveClusterTprConfigured](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| AcknowledgeClusterNotification | Acknowledges a cluster notification. | `New-RscMutationCluster -Operation AcknowledgeClusterNotification`<BR> | [acknowledgeClusterNotification](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| AddClusterRoute | Add a new route config to all hosts in a Rubrik cluster. Supported in Rubrik CDM v5.0+ | `New-RscMutationCluster -Operation AddClusterRoute`<BR> | [addClusterRoute](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| DisconnectExocompute | Disconnects a customer-managed Exocompute cluster from RSC. | `New-RscMutationCluster -Operation DisconnectExocompute`<BR> | [disconnectExocomputeCluster](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| ExocomputeClusterConnect | Connects an Exocompute cluster to RSC and retrieves the Kubernetes configuration YAML file. | `New-RscMutationCluster -Operation ExocomputeClusterConnect`<BR> | [exocomputeClusterConnect](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RecoverDatabaseToEndOfBackup | Recover a Db2 database to the end of the last full backup. | `New-RscQueryDb2 -Operation RecoverDatabaseToEndOfBackup`<BR> | [recoverDb2DatabaseToEndOfBackup](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| RecoverDatabaseToPointInTime | Recover a Db2 database to a specified point in time. | `New-RscQueryDb2 -Operation RecoverDatabaseToPointInTime`<BR> | [recoverDb2DatabaseToPointInTime](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| AnomalyDetailsCsv | Trigger asynchronous Anomaly Details CSV file download. | `New-RscMutationDownload -Operation AnomalyDetailsCsv`<BR> | [downloadAnomalyDetailsCsv](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| FromArchiveV2 | Download Microsoft SQL Server Database snapshot from archival location. | `New-RscMutationDownload -Operation FromArchiveV2`<BR> | [downloadFromArchiveV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| OpenstackSnapshotFromLocation | Download a snapshot from a remote target  
  
Supported in v9.4+  
Initiates a job to download a snapshot from the specified location when the snapshot does not exist locally. The specified location has to be a remote target connected to this Rubrik cluster. If no SLA Domain is selected, the snapshot is retained forever. | `New-RscMutationDownload -Operation OpenstackSnapshotFromLocation`<BR> | [downloadOpenstackSnapshotFromLocation](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BulkGenerateBackupReport | BulkGenerateFilesetBackupReport generates backup reports for multiple fileset snapshots. | `New-RscMutationFileset -Operation BulkGenerateBackupReport`<BR> | [bulkGenerateFilesetBackupReport](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| GenerateBackupReport | Generate a success and failure report for a fileset backup  
  
Supported in v9.2+  
Start an asynchronous job to generate success and failure files for a specified fileset backup. The response returns an asynchronous request ID. To get the URL for downloading the ZIP file containing the specific files and folders, send a GET request to 'fileset/request/{id}'. | `New-RscMutationFileset -Operation GenerateBackupReport`<BR> | [generateFilesetBackupReport](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RecoverFilesFromArchivalLocation | Initiate a job to restore files or folders  
  
Supported in v8.0+  
Initiate a job to copy one or more file or folder in a fileset backup from specified archival location to the source host. Returns the job instance ID. | `New-RscMutationFileset -Operation RecoverFilesFromArchivalLocation`<BR> | [filesetRecoverFilesFromArchivalLocation](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| CloudAccountGetProject | GcpCloudAccountGetProject gets the GCP project corresponding to the requested project id. | `New-RscQueryGcp -Operation CloudAccountGetProject`<BR> | [gcpCloudAccountGetProject](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| AddCloudAccountManualAuthProject | Adds a new project based on manual auth setup.The auth key is provided  
either in this API or set separately via setting global credentials. | `New-RscMutationGcp -Operation AddCloudAccountManualAuthProject`<BR> | [addGcpCloudAccountManualAuthProject](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SetExocomputeConfigs | Upsert the exocompute configuration for the given GCP project  
based on the provided configs of cloud account ID, VPC and regional  
subnets. | `New-RscMutationGcp -Operation SetExocomputeConfigs`<BR> | [setGcpExocomputeConfigs](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Root | Root of GCP native hierarchy. | `New-RscQueryGcpNative -Operation Root`<BR> | [gcpNativeRoot](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| FailoverGroup | Get all hosts for a given failover group. | `New-RscQueryHost -Operation FailoverGroup`<BR> | [failoverGroupHosts](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BulkRegisterSecondary | BulkRegisterSecondaryHosts is used to register secondary hosts in bulk. | `New-RscMutationHost -Operation BulkRegisterSecondary`<BR> | [bulkRegisterSecondaryHosts](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| EnableIntegration | Enables the integration with the specified integration ID. | `New-RscMutationIntegration -Operation EnableIntegration`<BR> | [enableIntegration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Cluster | Summary of a Kubernetes Cluster. | `New-RscQueryK8s -Operation Cluster`<BR> | [kubernetesCluster](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| Clusters | Summary of all Kubernetes Clusters. | `New-RscQueryK8s -Operation Clusters`<BR> | [kubernetesClusters](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| K8sCluster | N/A | `New-RscQueryK8s -Operation K8sCluster`<BR> | [k8sCluster](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| K8sClusters | N/A | `New-RscQueryK8s -Operation K8sClusters`<BR> | [k8sClusters](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ProtectionSet | Summary of a Kubernetes Protection Set. | `New-RscQueryK8s -Operation ProtectionSet`<BR> | [kubernetesProtectionSet](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ProtectionSets | Summary of all Kubernetes Protection Sets. | `New-RscQueryK8s -Operation ProtectionSets`<BR> | [kubernetesProtectionSets](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| VirtualMachineSnapshots | Get a list of snapshots of a Kubernetes virtual machine  
  
Supported in v9.3+  
Retrieves summary information for each of the snapshots of a specified Kubernetes virtual machine. | `New-RscQueryK8s -Operation VirtualMachineSnapshots`<BR> | [kubernetesVirtualMachineSnapshots](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| DeleteVmMount | Remove a Live Mount of a Kubernetes virtual machine snapshot  
  
Supported in v9.4+  
Initiates a request to remove a Live Mount of a Kubernetes virtual machine snapshot identified by the ID of the Live Mount. | `New-RscMutationK8s -Operation DeleteVmMount`<BR> | [deleteK8sVmMount](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ExportVirtualMachineSnapshot | Create a job to export a Kubernetes virtual machine snapshot  
  
Supported in v9.3+  
Launches a job to export the Kubernetes resources from a virtual machine snapshot to a namespace in a target Kubernetes cluster. | `New-RscMutationK8s -Operation ExportVirtualMachineSnapshot`<BR> | [exportK8sVirtualMachineSnapshot](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
Supported in v9.4+  
Initiate a job to live mount a Kubernetes virtual machine from a snapshot to a target Kubernetes cluster and namespace. | `New-RscMutationK8s -Operation StartVmMountJob`<BR> | [startK8sVmMountJob](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| BackupStorageLicenseUsage | Returns usage of Microsoft backups storage for an account. | `New-RscQueryM365 -Operation BackupStorageLicenseUsage`<BR> | [m365BackupStorageLicenseUsage](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| BackupStorageObjectRestorePoints | Lists the Microsoft 365 backup storage object restore points. | `New-RscQueryM365 -Operation BackupStorageObjectRestorePoints`<BR> | [m365BackupStorageObjectRestorePoints](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SearchBackupStorageObjectRestorePoints | Searches the M365 Backup Storage object restore points. | `New-RscQueryM365 -Operation SearchBackupStorageObjectRestorePoints`<BR> | [searchM365BackupStorageObjectRestorePoints](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Activities | List of activities. | `New-RscQueryMisc -Operation Activities`<BR> | [activities](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CcProvisionMetadata | Retrieves ccprovision metadata. | `New-RscQueryMisc -Operation CcProvisionMetadata`<BR> | [ccProvisionMetadata](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectNasNamespace | NAS Cloud Direct namespace. | `New-RscQueryMisc -Operation CloudDirectNasNamespace`<BR> | [cloudDirectNasNamespace](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectNasShare | NAS Cloud Direct share. | `New-RscQueryMisc -Operation CloudDirectNasShare`<BR> | [cloudDirectNasShare](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectSiteSettings | ListCloudDirectSiteSettings retrieves site configuration settings  
for Cloud Direct deployments. | `New-RscQueryMisc -Operation CloudDirectSiteSettings`<BR> | [cloudDirectSiteSettings](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CrowdStrikeIngestionStatus | Get CrowdStrike ingestion status. | `New-RscQueryMisc -Operation CrowdStrikeIngestionStatus`<BR> | [crowdStrikeIngestionStatus](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CurrentIpAddress | The IP address of the client making the request. | `New-RscQueryMisc -Operation CurrentIpAddress`<BR> | [currentIpAddress](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| DataPreview | Retrieve the list of data previews. | `New-RscQueryMisc -Operation DataPreview`<BR> | [dataPreview](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ExocomputeGetSupportedHealthChecks | ExocomputeGetSupportedHealthChecks returns the supported health check  
details for the given cloud type for Exocompute. | `New-RscQueryMisc -Operation ExocomputeGetSupportedHealthChecks`<BR> | [exocomputeGetSupportedHealthChecks](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| ExocomputeHealthChecks | ExocomputeHealthChecks returns the health checks for the  
Exocompute configuration. | `New-RscQueryMisc -Operation ExocomputeHealthChecks`<BR> | [exocomputeHealthChecks](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| FailoverGroupWorkloads | Retrieves workloads within a failover group for high-availability management. | `New-RscQueryMisc -Operation FailoverGroupWorkloads`<BR> | [failoverGroupWorkloads](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| IdentityDataLocationsEncryptionInfo | Retrieve the encryption information for identity data locations. | `New-RscQueryMisc -Operation IdentityDataLocationsEncryptionInfo`<BR> | [identityDataLocationsEncryptionInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| IpWhitelist | The IP allowlist for the given organization. | `New-RscQueryMisc -Operation IpWhitelist`<BR> | [ipWhitelist](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| IpWhitelistEntries | Retrieve entries in the IP allowlist. | `New-RscQueryMisc -Operation IpWhitelistEntries`<BR> | [ipWhitelistEntries](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| IpWhitelistSettings | Retrieve settings of the IP allowlist. | `New-RscQueryMisc -Operation IpWhitelistSettings`<BR> | [ipWhitelistSettings](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| IsCloudDirectSharePathValid | IsCloudDirectSharePathValid validates if a share path is  
accessible on the specified system. | `New-RscQueryMisc -Operation IsCloudDirectSharePathValid`<BR> | [isCloudDirectSharePathValid](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| JobInfo | Information about a job running on CDM.  
...
allowed to access the field. | `New-RscQueryMisc -Operation JobInfo`<BR> | [jobInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| LacpConfigurations | Check if the cluster has at least 1 node with its bond interfaces configured with LACP mode. | `New-RscQueryMisc -Operation LacpConfigurations`<BR> | [lacpConfigurations](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ListAllUploadRecords | List all the upload records. | `New-RscQueryMisc -Operation ListAllUploadRecords`<BR> | [listAllUploadRecords](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| MicrosoftGroups | List of Microsoft Groups in the organization. | `New-RscQueryMisc -Operation MicrosoftGroups`<BR> | [microsoftGroups](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ResetTypeOfRemovalJob | Get the reset type of a node removal job. | `New-RscQueryMisc -Operation ResetTypeOfRemovalJob`<BR> | [resetTypeOfRemovalJob](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RscPermsToCdmInfo | Synced cluster information for RSC permissions. | `New-RscQueryMisc -Operation RscPermsToCdmInfo`<BR> | [rscPermsToCdmInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SaasWorkloadMetadataTypes | SaasWorkloadMetadataTypes returns the list of metadata types for a  
specified SaaS app type. | `New-RscQueryMisc -Operation SaasWorkloadMetadataTypes`<BR> | [saasWorkloadMetadataTypes](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| StaticRoutes | Get all existing route configs  
  
Supported in v5.0+  
Lists all existing route configs. | `New-RscQueryMisc -Operation StaticRoutes`<BR> | [staticRoutes](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TaskDetailList | Get task details. | `New-RscQueryMisc -Operation TaskDetailList`<BR> | [taskDetailConnection](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UserAlreadyExists | Determines if the user already exists in the account. | `New-RscQueryMisc -Operation UserAlreadyExists`<BR> | [userAlreadyExists](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UserAuditList | Paginated list of user audit data. Each page of the results will include at most 50 entries unless otherwise specified using the first parameter. Query the pageInfo.hasNextPage field to know whether all audits were returned. | `New-RscQueryMisc -Operation UserAuditList`<BR> | [userAuditConnection](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UserFile | User file. | `New-RscQueryMisc -Operation UserFile`<BR> | [userFile](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ValidRegionsForDynamoDbRecovery | GetValidRegionsForDynamoDBRecovery returns a list of regions where the  
provided cloud accounts have Exocompute configured for DynamoDB recovery. | `New-RscQueryMisc -Operation ValidRegionsForDynamoDbRecovery`<BR> | [allValidRegionsForDynamoDbRecovery](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| AddCloudDirectKerberosCredential | AddCloudDirectKerberosCredential creates a new Kerberos credential for NCD systems. | `New-RscMutationMisc -Operation AddCloudDirectKerberosCredential`<BR> | [addCloudDirectKerberosCredential](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| AddCloudDirectSharesToSystem | Add shares (NFS, NFS4, or SMB) to an existing system. | `New-RscMutationMisc -Operation AddCloudDirectSharesToSystem`<BR> | [addCloudDirectSharesToSystem](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| AddCloudDirectSystem | AddCloudDirectSystem is used to add a new system to the NCD cluster. | `New-RscMutationMisc -Operation AddCloudDirectSystem`<BR> | [addCloudDirectSystem](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BatchQuarantineOperations | Quarantines or releases from quarantine at workload and file version. | `New-RscMutationMisc -Operation BatchQuarantineOperations`<BR> | [batchQuarantineOperations](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| BatchTriggerExocomputeHealthCheck | Initiates an on-demand Exocompute health check for a batch of exocompute configurations across regions. | `New-RscMutationMisc -Operation BatchTriggerExocomputeHealthCheck`<BR> | [batchTriggerExocomputeHealthCheck](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BulkUpdateNasNamespaces | Update NAS namespaces with SMB credentials  
...
| ChangeCurrentUserPassword | Change the password for the current user. | `New-RscMutationMisc -Operation ChangeCurrentUserPassword`<BR> | [changeCurrentUserPassword](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectAddSubdirBackup | CloudDirectAddSubdirBackup is used to add Details of Subdir for backup. | `New-RscMutationMisc -Operation CloudDirectAddSubdirBackup`<BR> | [cloudDirectAddSubdirBackup](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectSetKerberosEnforceConfig | CloudDirectSetKerberosEnforceConfig sets the Kerberos enforcement configuration for a specific protocol. | `New-RscMutationMisc -Operation CloudDirectSetKerberosEnforceConfig`<BR> | [cloudDirectSetKerberosEnforceConfig](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectSetWanThrottleSettings | CloudDirectSetWanThrottleSettings is used to set WAN Throttle Settings for the NCD cluster. | `New-RscMutationMisc -Operation CloudDirectSetWanThrottleSettings`<BR> | [cloudDirectSetWanThrottleSettings](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectSystemDelete | CloudDirectSystemDelete is used to delete the system. | `New-RscMutationMisc -Operation CloudDirectSystemDelete`<BR> | [cloudDirectSystemDelete](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectSystemRescan | CloudDirectSystemRescan is used to rescan a system already  
added to the NCD cluster. | `New-RscMutationMisc -Operation CloudDirectSystemRescan`<BR> | [cloudDirectSystemRescan](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| DeleteCephSetting | Delete a Ceph setting for an OpenStack Availability Zone  
  
Supported in v9.5+  
Delete a specific Ceph storage setting for an OpenStack Availability Zone. | `New-RscMutationMisc -Operation DeleteCephSetting`<BR> | [deleteCephSetting](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| DeleteCloudDirectKerberosCredential | DeleteCloudDirectKerberosCredential deletes an existing Kerberos credential for NCD systems. | `New-RscMutationMisc -Operation DeleteCloudDirectKerberosCredential`<BR> | [deleteCloudDirectKerberosCredential](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| GeneratePresignedUrlForDownload | Generate a presigned URL for downloading a specific package in CDM. | `New-RscMutationMisc -Operation GeneratePresignedUrlForDownload`<BR> | [generatePresignedUrlForDownload](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| GeneratePresignedUrlForPartUpload | Generate a presigned URL for uploading a part of the CDM package. | `New-RscMutationMisc -Operation GeneratePresignedUrlForPartUpload`<BR> | [generatePresignedUrlForPartUpload](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| InitializeUploadSession | Initialize a new upload session for CDM package upload. | `New-RscMutationMisc -Operation InitializeUploadSession`<BR> | [initializeUploadSession](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ManageProtectionForLinkedObjects | Manage protection for linked objects, allowing objects to be linked or unlinked and allow changes in SLA Domain assignment for linked objects. | `New-RscMutationMisc -Operation ManageProtectionForLinkedObjects`<BR> | [manageProtectionForLinkedObjects](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| MigrateVmDataStore | Migrate datastore of a Live Mount  
  
Supported in v9.4+  
Triggers a datastore migration job to migrate the datastore of a Hyper-V virtual machine Live Mount. | `New-RscMutationMisc -Operation MigrateVmDataStore`<BR> | [migrateVmDataStore](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| ModifyDistributionListDigestBatch | Modify distribution list digests. | `New-RscMutationMisc -Operation ModifyDistributionListDigestBatch`<BR> | [modifyDistributionListDigestBatch](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ModifyIdentityProvider | Modify an existing identity provider. | `New-RscMutationMisc -Operation ModifyIdentityProvider`<BR> | [modifyIdentityProvider](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RemoveUploadRecord | Remove the upload record from the database. | `New-RscMutationMisc -Operation RemoveUploadRecord`<BR> | [removeUploadRecord](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SetCephSettings | Set the Ceph settings for an OpenStack Availability Zone  
  
Supported in v9.5+  
Set the Ceph storage settings for an OpenStack Availability Zone. Accepts multiple settings. | `New-RscMutationMisc -Operation SetCephSettings`<BR> | [setCephSettings](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SetCloudDirectNamespaceOverride | SetCloudDirectNamespaceOverride is used to override properties of a  
namespace already added to the NCD cluster. | `New-RscMutationMisc -Operation SetCloudDirectNamespaceOverride`<BR> | [setCloudDirectNamespaceOverride](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SetCloudDirectShareExclusions | Sets exclusions to a specific share. | `New-RscMutationMisc -Operation SetCloudDirectShareExclusions`<BR> | [setCloudDirectShareExclusions](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SetCloudDirectSystemOverride | SetCloudDirectSystemOverride is used to override properties of a  
system already added to the NCD cluster. | `New-RscMutationMisc -Operation SetCloudDirectSystemOverride`<BR> | [setCloudDirectSystemOverride](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SetIpWhitelistEnabled | Enable or disable the IP allowlist for the given organization. | `New-RscMutationMisc -Operation SetIpWhitelistEnabled`<BR> | [setIpWhitelistEnabled](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TriggerBliMigration | TriggerBLIMigration triggers blob immutability migration for a list  
of RCV Azure locations. | `New-RscMutationMisc -Operation TriggerBliMigration`<BR> | [triggerBliMigration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateCloudDirectKerberosCredential | UpdateCloudDirectKerberosCredential updates an existing Kerberos credential for NCD systems. | `New-RscMutationMisc -Operation UpdateCloudDirectKerberosCredential`<BR> | [updateCloudDirectKerberosCredential](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateIpWhitelist | Update the IP allowlist for the given organization. | `New-RscMutationMisc -Operation UpdateIpWhitelist`<BR> | [updateIpWhitelist](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdateIpWhitelistEntry | Update an entry in the IP allowlist. | `New-RscMutationMisc -Operation UpdateIpWhitelistEntry`<BR> | [updateIpWhitelistEntry](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateManagedIdentitiesAsync | Async transition to managed identities. | `New-RscMutationMisc -Operation UpdateManagedIdentitiesAsync`<BR> | [updateManagedIdentitiesAsync](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdateNetworkThrottle | Update a network throttle  
...
| WindowsRbsBulkInstall | Bulk install and register RBS on Windows host. | `New-RscMutationMisc -Operation WindowsRbsBulkInstall`<BR> | [windowsRbsBulkInstall](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| GetMissedCollectionSetSnapshots | Retrieve information on the missed snapshots for a MongoDB collection set  
  
Supported in v9.6  
Retrieve the time of day when the snapshots were missed for a MongoDB collection set. | `New-RscQueryMongo -Operation GetMissedCollectionSetSnapshots`<BR> | [getMissedMongoCollectionSetSnapshots](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| GetMissedOpsManagerManagedSourceSnapshots | Retrieve information on the missed snapshots for a MongoDB source managed by Ops Manager  
  
Supported in v9.6  
Retrieve the time of day when the snapshots were missed for a MongoDB source managed by Ops Manager. | `New-RscQueryMongo -Operation GetMissedOpsManagerManagedSourceSnapshots`<BR> | [getMissedOpsManagerManagedMongoSourceSnapshots](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RestoreTargetsForSnapshot | Get the list of valid restore targets for a snapshot. Supported in v9.3. Retrieve the list of OpsManager-managed MongoDB sources that can be valid restore targets for the specified snapshot. | `New-RscQueryMongo -Operation RestoreTargetsForSnapshot`<BR> | [mongoRestoreTargetsForSnapshot](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| AddOpsManagerManagedSource | Add a new MongoDB source managed by Ops Manager  
  
Supported in v9.2+  
Adds a new MongoDB source which is managed by Ops Manager to the Rubrik Cluster. | `New-RscMutationMongo -Operation AddOpsManagerManagedSource`<BR> | [addOpsManagerManagedMongoSource](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| AddSource | v8.1-v9.2: Add a new MongoDB source  
v9.3+: Add a new MongoDB source for logical backup and recovery  
  
Supported in v8.1+  
v8.1-v9.2: Adds a new MongoDB source to the Rubrik Cluster.  
v9.3+: Adds a new MongoDB source to the Rubrik Cluster which would be managed using logical backup and recovery. | `New-RscMutationMongo -Operation AddSource`<BR> | [addMongoSource](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CreateOnDemandDatabaseBackup | v9.0-v9.2: Take an on-demand snapshot for a MongoDB database  
...
v9.3+: Initiates a job to take an on-demand, full or incremental logical snapshot of the specified MongoDB database. | `New-RscMutationMongo -Operation CreateOnDemandDatabaseBackup`<BR> | [createOnDemandMongoDatabaseBackup](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CreateOnDemandDatabaseBackupV2 | v9.0-v9.2: Take an on-demand snapshot for a MongoDB database  
v9.3+: Take an on-demand logical snapshot for a MongoDB database  
  
Supported in v9.0+  
v9.0-v9.2: Initiates a job to take an on-demand, full or incremental snapshot of the specified MongoDB database.  
v9.3+: Initiates a job to take an on-demand, full or incremental logical snapshot of the specified MongoDB database. | `New-RscMutationMongo -Operation CreateOnDemandDatabaseBackupV2`<BR> | [createOnDemandMongoDatabaseBackupV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CreateOpsManagerManagedSourceOnDemandSnapshot | Take an on-demand snapshot of a MongoDB source managed by Ops Manager  
...
| PatchOpsManagerManagedSource | v9.2: Edit a MongoDB source  
...
v9.3+: Edits the properties of a MongoDB source managed using logical backup and recovery. Hosts, name, and the type of the MongoDB deployment cannot be changed once added. | `New-RscMutationMongo -Operation PatchSource`<BR> | [patchMongoSource](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| RecoverOpsManagerManagedSource | Recover an existing snapshot to the target MongoDB cluster managed by Ops Manager  
...
| RetryAddOpsManagerManagedSource | Update a MongoDB source managed by Ops Manager  
...
v9.3+: Updates a MongoDB source details. You can use this endpoint for updating MongoDB source details managed using logical backup and recovery when the request to add a source fails. | `New-RscMutationMongo -Operation RetryAddSource`<BR> | [retryAddMongoSource](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| BulkExportDatabases | Supported in v9.2+. Create a request to export multiple SQL Server databases to a new location. To check the result of the request, use `mssqlJobStatus` query with the `id` of the request object returned by this API. | `New-RscMutationMssql -Operation BulkExportDatabases`<BR> | [bulkExportMssqlDatabases](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| CloudDirectNasShares | Paginated list of NAS Cloud Direct shares. | `New-RscQueryNas -Operation CloudDirectNasShares`<BR> | [cloudDirectNasShares](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectNasSystem | NAS Cloud Direct system. | `New-RscQueryNas -Operation CloudDirectNasSystem`<BR> | [cloudDirectNasSystem](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectNasSystems | Paginated list of NAS Cloud Direct systems. | `New-RscQueryNas -Operation CloudDirectNasSystems`<BR> | [cloudDirectNasSystems](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
v8.1+: Initiates a job to download one or more files or folders from an archived Nutanix virtual machine snapshot. Returns the job instance ID. | `New-RscMutationNutanix -Operation DownloadFilesSnapshotFromArchivalLocation`<BR> | [downloadFilesNutanixSnapshotFromArchivalLocation](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RestoreVmSnapshotFilesFromArchivalLocation | Initiate a job to restore multiple files or folders  
...
v8.1+: Initiates a job to restore one or more files or folders from an archived Nutanix virtual machine snapshot. Returns the job instance ID. | `New-RscMutationNutanix -Operation RestoreVmSnapshotFilesFromArchivalLocation`<BR> | [restoreNutanixVmSnapshotFilesFromArchivalLocation](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| HasAccessToObjects | HasAccessToO365Objects returns if user has access to any o365 objects. | `New-RscQueryO365 -Operation HasAccessToObjects`<BR> | [hasAccessToO365Objects](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| QueryRecoveryAnalysisResult | QueryO365RecoveryAnalysisResult retrieves the recovery analysis result from  
GCS for a given taskchain ID. This provides per-user analysis of Exchange,  
OneDrive, and SharePoint activity data. | `New-RscQueryO365 -Operation QueryRecoveryAnalysisResult`<BR> | [queryO365RecoveryAnalysisResult](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UserSelfServiceInfo | Returns the self service information for the logged-in user, which includes the user name and the M365 object details. | `New-RscQueryO365 -Operation UserSelfServiceInfo`<BR> | [o365UserSelfServiceInfo](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| AnalyzeMvb | AnalyzeO365Mvb starts an O365 MVB recovery analysis job. | `New-RscMutationO365 -Operation AnalyzeMvb`<BR> | [analyzeO365Mvb](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RestoreFullTeams | Restore the complete Team. | `New-RscMutationO365 -Operation RestoreFullTeams`<BR> | [restoreO365FullTeams](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RecoverableRangesMinimal | Get recoverable ranges of a Oracle database. Unlike oracleRecoverableRanges, retrieve minimal database snapshot details. | `New-RscQueryOracle -Operation RecoverableRangesMinimal`<BR> | [oracleRecoverableRangesMinimal](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateEncryptionKeyForMigration | Updates the encryption key of the source location that will be used for  
migration to RCV. | `New-RscMutationRcv -Operation UpdateEncryptionKeyForMigration`<BR> | [updateEncryptionKeyForRcvMigration](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdatePrivateEndpoint | UpdateRCVPrivateEndpoint updates the name and description of an existing  
RCV private endpoint connection. | `New-RscMutationRcv -Operation UpdatePrivateEndpoint`<BR> | [updateRcvPrivateEndpoint](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdateTarget | Updates the Rubrik Cloud Vault Azure archival location. | `New-RscMutationRcv -Operation UpdateTarget`<BR> | [updateRcvTarget](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| ClusterMigrationCount | Retrieve details of the Rubrik clusters' reports migration. | `New-RscQueryReport -Operation ClusterMigrationCount`<BR> | [clusterReportMigrationCount](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Custom | Retrieves reports created by users with pagination support. | `New-RscQueryReport -Operation Custom`<BR> | [customReports](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CustomReports | Retrieve reports created by users. | `New-RscQueryReport -Operation CustomReports`<BR> | [allCustomReports](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Objects | Get report objects with report-specific filtering and pagination. | `New-RscQueryReport -Operation Objects`<BR> | [reportObjects](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SkippedTeamsSite | GetSkippedTeamsSiteReport returns back a report of the skipped teams  
sites for sharepoint bulk recovery. | `New-RscQueryReport -Operation SkippedTeamsSite`<BR> | [skippedTeamsSiteReport](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TemplatesByCategories | Retrieve all report templates by category. | `New-RscQueryReport -Operation TemplatesByCategories`<BR> | [allReportTemplatesByCategories](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirectDeleteGlobalUser | CloudDirectDeleteGlobalSmbUser is used to delete Global SMB User for the NCD cluster. | `New-RscMutationSmb -Operation CloudDirectDeleteGlobalUser`<BR> | [cloudDirectDeleteGlobalSmbUser](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirectSetGlobalAuth | CloudDirectSetGlobalSmbAuth is used to set Global SMB creds for the NCD  
cluster. | `New-RscMutationSmb -Operation CloudDirectSetGlobalAuth`<BR> | [cloudDirectSetGlobalSmbAuth](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SetCloudDirectGlobalSettings | SetCloudDirectGlobalSmbSettings is used to set Global SMB Settings for  
the NCD cluster. | `New-RscMutationSmb -Operation SetCloudDirectGlobalSettings`<BR> | [setCloudDirectGlobalSmbSettings](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SearchVersionedFiles | List of all files in snapshots whose names match the specified search query. | `New-RscQuerySnappable -Operation SearchVersionedFiles`<BR> | [searchSnappableVersionedFiles](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ByIds | Returns the details for the passed snapshot IDs. | `New-RscQuerySnapshot -Operation ByIds`<BR> | [allSnapshotsByIds](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CloudDirect | Returns a NAS Cloud Direct snapshot by ID. | `New-RscQuerySnapshot -Operation CloudDirect`<BR> | [cloudDirectSnapshot](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| CloudDirects | Returns a list of NAS Cloud Direct snapshots. | `New-RscQuerySnapshot -Operation CloudDirects`<BR> | [cloudDirectSnapshots](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| PossibleLocationsForObjects | GetPossibleSnapshotLocationsForObjects returns all valid  
locations where unexpired snapshots of the objects are present.  
This includes both RSC (MBL archival groups) and CDM snapshot locations. | `New-RscQuerySnapshot -Operation PossibleLocationsForObjects`<BR> | [possibleSnapshotLocationsForObjects](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| SOfCloudDirectBucket | Returns a list of NAS Cloud Direct snapshots for a bucket. | `New-RscQuerySnapshot -Operation SOfCloudDirectBucket`<BR> | [snapshotsOfCloudDirectBucket](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SOfCloudDirectShare | Returns a list of NAS Cloud Direct snapshots for a share. | `New-RscQuerySnapshot -Operation SOfCloudDirectShare`<BR> | [snapshotsOfCloudDirectShare](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| TotalCloudDirectObject | Retrieves the total count of snapshots for a Cloud Direct object.  
The results can be filtered optionally by target ID. | `New-RscQuerySnapshot -Operation TotalCloudDirectObject`<BR> | [totalSnapshotsForCloudDirectObject](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| VappInstantRecoveryOptions | Get Instant Recovery information  
...
| RestoreOpenstackVmFiles | Restore files from an OpenStack virtual machine snapshot  
  
Supported in v9.5+  
Start an asynchronous job to restore files and folders from a specified OpenStack virtual machine snapshot to the source virtual machine or a different target virtual machine. | `New-RscMutationSnapshot -Operation RestoreOpenstackVmFiles`<BR> | [restoreOpenstackVmSnapshotFiles](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UploadOnDemand | UploadSnapshotOnDemand triggers an on-demand upload of a snapshot to  
a new archival location specified by the SLA Domain. | `New-RscMutationSnapshot -Operation UploadOnDemand`<BR> | [uploadSnapshotOnDemand](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| HuntDetailV2 | The details of a threat hunt. | `New-RscQueryThreat -Operation HuntDetailV2`<BR> | [threatHuntDetailV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| HuntMatchedSnapshots | List of matched snapshots for a set of file matches. | `New-RscQueryThreat -Operation HuntMatchedSnapshots`<BR> | [threatHuntMatchedSnapshots](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| HuntObjectMetrics | Aggregated object metrics for a threat hunt. | `New-RscQueryThreat -Operation HuntObjectMetrics`<BR> | [threatHuntObjectMetrics](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| ValidateBulkHunt | Validates a bulk threat hunt request. | `New-RscQueryThreat -Operation ValidateBulkHunt`<BR> | [validateBulkThreatHunt](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| EnableMonitoring | Enable or disable Threat Monitoring on a Rubrik cluster. Supports CDM clusters, Cloud Direct clusters, and Active Directory workload-type enablement. | `New-RscMutationThreat -Operation EnableMonitoring`<BR> | [enableThreatMonitoring](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| QuarantineHuntMatches | Quarantine matches identified during a threat hunt. | `New-RscMutationThreat -Operation QuarantineHuntMatches`<BR> | [quarantineThreatHuntMatches](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| StartBulkHunt | Start a new bulk threat hunt. | `New-RscMutationThreat -Operation StartBulkHunt`<BR> | [startBulkThreatHunt](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateV2 | Update vCenter Server  
  
Supported in v8.1+  
Update the address, username, and password of the specified vCenter Server object. | `New-RscMutationVcenter -Operation UpdateV2`<BR> | [updateVcenterV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| OnDemandSnapshot | Create an on-demand snapshot for a VM  
  
Supported in v5.0+  
Use the ID of a virtual machine to create an on-demand snapshot. | `New-RscMutationVsphere -Operation OnDemandSnapshot`<BR> | [vsphereOnDemandSnapshot](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RecoveryRangeStatuses | Gets the status of the recovery ranges for a virtual machine,  
...
if they are available. | `New-RscQueryVsphereVm -Operation RecoveryRangeStatuses`<BR> | [vsphereVmRecoveryRangeStatuses](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| RefreshAgent | Refresh Rubrik Backup Service  
  
Supported in v9.5  
Refresh the Rubrik Backup Service state for a specified virtual machine. | `New-RscMutationVsphereVm -Operation RefreshAgent`<BR> | [vsphereVmRefreshAgent](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UnregisterAgent | Unregister Rubrik Backup Service  
  
Supported in v9.5  
Unregister the Rubrik Backup Service state for a specified virtual machine. | `New-RscMutationVsphereVm -Operation UnregisterAgent`<BR> | [vsphereVmUnregisterAgent](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| Update | Update VM  
...
| UpdateAgentCertificate | Update certificate for Rubrik Backup Service  
  
Supported in v9.5  
Update the Rubrik Backup Service certificate for a specified virtual machine. | `New-RscMutationVsphereVm -Operation UpdateAgentCertificate`<BR> | [vsphereVmUpdateAgentCertificate](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdateUnmountTime | Update auto unmount time for a virtual machine. | `New-RscMutationVsphereVm -Operation UpdateUnmountTime`<BR> | [vsphereVmUpdateUnmountTime](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| Operation | Description | Invocation | GraphQL Root Field |
| --- | --- | --- | --- |
| ById | Get webhook configuration by ID. | `New-RscQueryWebhook -Operation ById`<BR> | [webhookById](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| MessageTemplateById | Retrieve webhook message template according to ID. | `New-RscQueryWebhook -Operation MessageTemplateById`<BR> | [webhookMessageTemplateById](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| MessageTemplates | Retrieve webhook message templates. | `New-RscQueryWebhook -Operation MessageTemplates`<BR> | [allWebhookMessageTemplates](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| V2 | Retrieve webhook configurations. | `New-RscQueryWebhook -Operation V2`<BR> | [allWebhooksV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| CreateV2 | Create webhook configuration. | `New-RscMutationWebhook -Operation CreateV2`<BR> | [createWebhookV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| DeleteV2 | Delete webhook configuration. | `New-RscMutationWebhook -Operation DeleteV2`<BR> | [deleteWebhookV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| GeneratePreviewMessageForTemplate | Generate a preview message for the webhook message template. | `New-RscMutationWebhook -Operation GeneratePreviewMessageForTemplate`<BR> | [generatePreviewMessageForWebhookTemplate](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SendTestMessageTo | Send test message to webhook. | `New-RscMutationWebhook -Operation SendTestMessageTo`<BR> | [sendTestMessageToWebhook](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| SendTestMessageToExisting | Send test message to existing webhook. | `New-RscMutationWebhook -Operation SendTestMessageToExisting`<BR> | [sendTestMessageToExistingWebhook](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
...
| UpdateStatus | Update the webhook status. | `New-RscMutationWebhook -Operation UpdateStatus`<BR> | [updateWebhookStatus](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |
| UpdateV2 | Update webhook configuration. | `New-RscMutationWebhook -Operation UpdateV2`<BR> | [updateWebhookV2](https://rubrikinc.github.io/rubrik-api-documentation/schema/reference/query.doc.html) |

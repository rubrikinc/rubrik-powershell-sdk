...
- cdmId: System.String
  - ID associated with the Exchange Host in CDM.
- physicalHostMetadata: PhysicalHostMetadata
  - Metadata of the underlying physical host.
- descendantConnection: ExchangeHostDescendantTypeConnection
  - List of descendants.
- physicalChildConnection: ExchangeHostPhysicalChildTypeConnection

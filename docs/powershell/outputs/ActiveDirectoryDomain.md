...
- unregisteredDomainControllers: list of UnregisteredDomainControllerInfos
  - List of auto-discovered domain controllers that are not registered with Rubrik. Empty if there are none.
- cluster: Cluster
  - Rubrik cluster.

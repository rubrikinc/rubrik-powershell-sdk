...
- naturalId: System.String
  - ID of the Anthropic organization at the source.
- status: SaasOrganizationStatus
  - The lifecycle status of the Anthropic organization.
- lastRefreshTime: DateTime
  - The time at which the Anthropic organization was last synced to Rubrik.

...
- allNodes: list of PhysicalHosts
  - The list of Hosts making up this Host Failover Cluster.
- descendantConnection: HostFailoverClusterDescendantTypeConnection
  - List of descendants.
- physicalChildConnection: HostFailoverClusterPhysicalChildTypeConnection

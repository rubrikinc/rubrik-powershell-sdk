...
- cdmId: System.String
  - ID of OLVM manager on Rubrik CDM.
- clusterUuid: System.String
  - UUID of CDM cluster.
- primaryClusterUuid: System.String
  - UUID of primary CDM cluster.
- olvmAddress: System.String
  - Address of the OLVM manager.
- username: System.String
  - Username for the OLVM manager.
- connectionStatus: RefreshableObjectConnectionStatus
  - Connection status of the OLVM manager.
- lastRefreshTime: DateTime
  - Last refresh timestamp of OLVM manager.
- descendantConnection: OlvmManagerDescendantConnection
  - List of descendants.
- physicalChildConnection: OlvmManagerPhysicalChildTypeConnection
  - List of physical children.
- olvmDescendantDatacenters: OlvmManagerDescendantConnection
  - OLVM datacenters belonging to the OLVM manager.

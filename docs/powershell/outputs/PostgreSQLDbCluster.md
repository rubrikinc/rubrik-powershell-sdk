...
- status: PostgreSQLDbClusterStatus
  - The connectivity status of PostgreSQL database cluster.
- metadata: PostgreSQLDbClusterMetadata
  - The metadata field of PostgreSQL database cluster.
...
- postgresHaClusterInfo: PostgresHaClusterInfo
  - HA cluster info including group name and replica topology. Null for standalone clusters.
- id: System.String

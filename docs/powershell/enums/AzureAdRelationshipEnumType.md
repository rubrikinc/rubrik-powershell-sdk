...
- INTUNE_ROLE_ASSIGNMENT_SCOPE - Intune role assignment scope relationship for an Intune role definition.
Targets the resource scope groups the role assignment manages.
- INTUNE_ROLE_ASSIGNMENT_SCOPE_TAG - Intune role assignment scope tag relationship for an Intune role
definition. Targets the scope tags constraining the role.

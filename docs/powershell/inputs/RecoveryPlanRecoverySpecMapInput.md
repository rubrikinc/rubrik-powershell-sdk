...
- targetLocationInfo: RecoveryPlanLocationInput
...
- childRecoverySpecs: list of ChildRecoverySpecMapV2Inputs
...
- sourceLocationInfo: RecoveryPlanLocationInput
...
- config: RecoverySpecConfigInput

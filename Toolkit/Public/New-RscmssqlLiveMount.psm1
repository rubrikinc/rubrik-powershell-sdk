...
function New-RscMssqlLiveMount {
    ...
    Process {
        ...
        #region Create Query
        $query = New-RscGqlMutationCreateMssqlLiveMount   
        ...
        switch ( $PSCmdlet.ParameterSetName){
            "TargetMssqlInstanceId" {
                write-host "am i in TargetMssqlInstanceId"
                $query.Var.input.config.targetInstanceId = "$($TargetMssqlInstanceId)"
            }
            "TargetMssqlInstance" {
                write-host "am i in TargetMssqlInstance"
                write-host ($TargetMssqlInstance)
